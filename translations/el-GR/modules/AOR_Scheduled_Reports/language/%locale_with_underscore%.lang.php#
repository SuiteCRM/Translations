...
$mod_strings = array(
    ...
    'LBL_EMAIL_RECIPIENTS' => 'Παραλήπτες Email',
    'NTC_DELETE_CONFIRMATION' => 'Είστε βέαιοι ότι θέλετε να διαγράψετε αυτήν την εγγραφή;',
    'LBL_LIST_FORM_TITLE' => 'Λίστα Προγραμματισμένων Αναφορών',
    'LBL_MODULE_NAME' => 'Προγραμματισμένες Αναφορές',
    'LBL_MODULE_TITLE' => 'Προγραμματισμένες Αναφορές',
    'LBL_HOMEPAGE_TITLE' => 'Οι Προγραμματισμένες Αναφορές μου',
    'LNK_NEW_RECORD' => 'Δημιουργία Προγραμματισμένων Αναφορών',
    'LNK_LIST' => 'Εμφάνιση Προγραμματισμένων Αναφορών',
    'LBL_SEARCH_FORM_TITLE' => 'Αναζήτηση Προγραμματισμένων Αναφορών',
    'LBL_HISTORY_SUBPANEL_TITLE' => 'Προβολή Ιστορικού',
    'LBL_NEW_FORM_TITLE' => 'Νέες Προγραμματισμένες Αναφορές',
    'LBL_SCHEDULE' => 'Προγραμματισμός',
    'LBL_AOR_REPORT_NAME' => 'Αναφορές',
    'LBL_SCHEDULED_REPORTS_INFORMATION' => 'Προγραμματισμένες Αναφορές',
    'LBL_LAST_RUN' => 'Τελευταία εκτέλεση',
