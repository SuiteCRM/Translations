...
$mod_strings = array(
    ...
    'LBL_LIST_FORM_TITLE' => 'Λίστα Γραφημάτων',
    'LBL_MODULE_NAME' => 'Γραφήματα',
    'LBL_MODULE_TITLE' => 'Γραφήματα',
    'LBL_HOMEPAGE_TITLE' => 'Τα Γραφήματα μου',
    'LNK_NEW_RECORD' => 'Δημιουργία Γραφημάτων',
    'LNK_LIST' => 'Προβολή Γραφημάτων',
    'LBL_SEARCH_FORM_TITLE' => 'Αναζήτηση Γραφημάτων',
    ...
    'LBL_NEW_FORM_TITLE' => 'Νέα γραφήματα',
);
