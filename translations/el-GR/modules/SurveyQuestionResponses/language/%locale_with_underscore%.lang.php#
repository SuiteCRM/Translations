...
$mod_strings = array(
    ...
    'LBL_MODULE_NAME'                                                                    => 'Απαντήσεις σε ερωτήσεις έρευνας',
    'LBL_MODULE_TITLE'                                                                   => 'Απαντήσεις σε ερωτήσεις έρευνας',
    ...
    'LBL_SURVEYQUESTIONRESPONSES_SUBPANEL_TITLE'                                         => 'Απαντήσεις σε ερωτήσεις έρευνας',
    'LBL_NEW_FORM_TITLE'                                                                 => 'New Survey Question Responses',
    'LBL_SURVEYRESPONSES_SURVEYQUESTIONRESPONSES_FROM_SURVEYRESPONSES_TITLE'             => 'Ερευνητικές απαντήσεις',
    'LBL_SURVEYQUESTIONS_SURVEYQUESTIONRESPONSES_FROM_SURVEYQUESTIONS_TITLE'             => 'Ερωτήσεις έρευνας',
    'LBL_SURVEYQUESTIONOPTIONS_SURVEYQUESTIONRESPONSES_FROM_SURVEYQUESTIONOPTIONS_TITLE' => 'Επιλογές ερωτήσεων έρευνας',
);
