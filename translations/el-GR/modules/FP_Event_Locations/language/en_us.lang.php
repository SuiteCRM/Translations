...
$mod_strings = array(
    ...
    'LBL_REMOVE' => 'Αφαίρεση',
    'LBL_LIST_FORM_TITLE' => 'Λίστα Τοποθεσιών',
    'LBL_MODULE_NAME' => 'Τοποθεσίες',
    'LBL_MODULE_TITLE' => 'Τοποθεσίες',
    'LBL_HOMEPAGE_TITLE' => 'Οι Τοποθεσίες μου',
    'LNK_NEW_RECORD' => 'Επεξεργασία Τοποθεσιών',
    'LNK_LIST' => 'View Locations',
    'LBL_SEARCH_FORM_TITLE' => 'Αναζήτηση Τοποθεσιών',
    ...
    'LBL_ADDRESS_POSTALCODE' => 'Ταχυδρομικός Κώδικας',
    'LBL_ADDRESS_STATE' => 'Περιοχή',
    'LBL_CAPACITY' => 'Capacity',
    'LBL_EDITVIEW_PANEL1' => 'Διεύθυνση',
    'LBL_FP_EVENT_LOCATIONS_FP_EVENTS_1_FROM_FP_EVENTS_TITLE' => 'Γεγονότα',
);
