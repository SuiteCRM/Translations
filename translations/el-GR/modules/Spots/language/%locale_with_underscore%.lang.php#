...
$mod_strings = array(
    ...
    'LBL_AN_LEADS_ASSIGNED_USER' => 'Υπεύθυνος',
    ...
    'LBL_AN_SALES_OPPORTUNITY_NAME' => 'Όνομα Ευκαιρίας',
    'LBL_AN_SALES_ASSIGNED_USER' => 'Υπεύθυνος',
    ...
    'LBL_AN_SALES_CAMPAIGN' => 'Εκστρατεία',

    //Analytics labels for service pivot
    'LBL_AN_SERVICE_ACCOUNT_NAME' => 'Όνομα λογαριασμού:',
    'LBL_AN_SERVICE_STATE' => 'Νομός',
    ...
    'LBL_AN_QUOTES_OPPORTUNITY_NAME' => 'Όνομα Ευκαιρίας',
    ...
    'LBL_AN_QUOTES_ASSIGNED_TO' => 'Υπεύθυνος',
    'LBL_AN_QUOTES_DATE_CREATED' => 'Ημ/νία καταχώρησης',
