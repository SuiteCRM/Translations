...
$mod_strings = array(
    ...
    'LBL_REMOVE' => 'Αφαίρεση',
    'LBL_LIST_FORM_TITLE' => 'Λίστα Επαναπρογραμματισμού',
    'LBL_MODULE_NAME' => 'Επαναπρογραμματισμός',
    'LBL_MODULE_TITLE' => 'Επαναπρογραμματισμός',
    'LBL_HOMEPAGE_TITLE' => 'Ο Επαναπρογραμματισμός μου',
    'LNK_NEW_RECORD' => 'Create Reschedule',
    'LNK_LIST' => 'Επαναπρογραμματισμός',
