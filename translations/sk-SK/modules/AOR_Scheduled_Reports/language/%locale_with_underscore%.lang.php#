...
$mod_strings = array(
    ...
    'LBL_EMAIL_RECIPIENTS' => 'Príjemcovia emailu:',
    'NTC_DELETE_CONFIRMATION' => 'Skutočne chcete zmazať tento záznam?',
    'LBL_LIST_FORM_TITLE' => 'Zoznam plánovaných správ',
    'LBL_MODULE_NAME' => 'Naplánovanie Reportu',
    'LBL_MODULE_TITLE' => 'Naplánovanie Reportu',
    'LBL_HOMEPAGE_TITLE' => 'Moje plánované správy',
    'LNK_NEW_RECORD' => 'Vytvoriť plánované správy',
    'LNK_LIST' => 'Zobraziť plánované správy',
    'LBL_SEARCH_FORM_TITLE' => 'Vyhľadať plánovanú správu',
    'LBL_HISTORY_SUBPANEL_TITLE' => 'Zobraziť Históriu',
    'LBL_NEW_FORM_TITLE' => 'Nové plánované správy',
    'LBL_SCHEDULE' => 'Plán',
    'LBL_AOR_REPORT_NAME' => 'Reporty',
    'LBL_SCHEDULED_REPORTS_INFORMATION' => 'Naplánovanie Reportu',
    'LBL_LAST_RUN' => 'Naposledy spustené',
    'LBL_STATUS' => 'Stav',
);
