...
$mod_strings = array(
    ...
    'LBL_SEARCH_RESULT_MODULE' => '模組',
    'LBL_SEARCH_RESULT_NAME' => '名稱',
    'LBL_SEARCH_RESULT_DATE_CREATED' => '建立日期',
    'LBL_SEARCH_RESULT_DATE_MODIFIED' => '修改日期',
    'LBL_SEARCH_RESULT_EMPTY' => 'No results',
    'LBL_SEARCH_RESULT_SUMMARY' => '總結',
    'LBL_NEVER_OPTIMISED' => '從不',
    'LBL_USE_AOD_SEARCH' => '進階搜尋',
    'LBL_USE_VANILLA_SEARCH' => '基本搜尋',
);
