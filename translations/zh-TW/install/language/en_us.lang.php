...
$mod_strings = array(
    ...
    'ERR_DB_LOGIN_FAILURE_SHORT' => '資料庫連線錯誤: 資料庫位址, 使用者名稱, 或是密碼錯誤.',
    ...
    'ERR_SESSION_DIRECTORY_NOT_EXISTS' => '提供的Session目錄不是一個有效的目錄。',
    'ERR_SESSION_DIRECTORY' => '提供的Session目錄不是一個可寫的目錄。',
    ...
    'ERR_UPLOAD_MAX_FILESIZE' => '警告︰ 應更改您的 PHP 配置允許上傳至少 6 MB 的檔案大小。',
    ...
    'LBL_CHECKSYS_OK' => '確定',
    'LBL_CHECKSYS_PHP_INI' => '您的 PHP 設定檔(php.ini) 的位置︰',
    ...
    'LBL_CRON_INSTRUCTIONS_3' => '你只需要在安裝結束後做此動作。',
    'LBL_CRON_CONFIGURATION' => 'CRON CONFIGURATION',
    'LBL_SETUP_CRONTAB' => '設置Crontab',
    ...
    'LBL_DISABLED_DESCRIPTION_2' => '此更改後，你可以點擊"開始"按鈕即可開始安裝。 <i>安裝完畢後，你會想要改變 \'installer_locked\' 的值為 true。</i>',
    'LBL_DISABLED_DESCRIPTION_3' => 'After this change has been made, please revisit / reload this page to continue.',
    'LBL_DISABLED_DESCRIPTION' => '安裝程式已運行一次。為了安全起見，它已被禁用以運行第二次。 如果你確信你想要再次運行它，請到您的 config.php 檔並找到(或添加)變數叫做 \'installer_locked\'，並將它設置為 false。 如下所示︰',
    'LBL_DISABLED_HELP_1' => '安裝説明，請訪問 SuiteCRM',
    'LBL_DISABLED_HELP_LNK' => 'https://community.suitecrm.com',
    'LBL_DISABLED_HELP_2' => '技術支援討論區',
    'LBL_APP_NOT_INSTALLED' => 'SuiteCRM 沒有被安裝. 程式登入需要安裝成功的應用程式, 請先安裝.',
    ...
    'LBL_SILENT_INSTALL_SUCCESS' => 'SuiteCRM 已經被成功安裝.',
    'LBL_SILENT_INSTALL_FAILED' => 'SuiteCRM 安裝失敗.',
    ...
    'LBL_REG_CONF_3' => '感謝您註冊。按一下完成按鈕，登錄到 SuiteCRM。您將需要使用您在步驟 2 中輸入的密碼和使用者名"admin"進行第一次登錄。',
    'LBL_REG_TITLE' => '註冊',
...
$contact_user_link_guid',
    ...
    'LBL_SYS_CHECK_WARNING' => '忽略系統檢查警告.',
    'LBL_PROCEED' => '處理中',
    'LBL_RECHECK' => 'RECHECK',
    'LBL_CONFIG' => '設定',
    'LBL_VALIDATION_ERRORS' => '驗證錯誤，無法執行操作'
);
