...
$mod_strings = array(
    ...
    'LBL_NAME' => 'Navn:',
    'LBL_PROSPECT_INFORMATION' => 'Oversigt', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
    ...
    //For export labels
    'LBL_FP_EVENTS_PROSPECTS_1_FROM_FP_EVENTS_TITLE' => 'Begivenheder',
);
