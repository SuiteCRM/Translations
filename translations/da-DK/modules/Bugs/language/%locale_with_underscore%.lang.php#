...
$mod_strings = array(
    'LBL_MODULE_NAME' => 'Fejlrapport',
    'LBL_MODULE_TITLE' => 'Fejlrapporter: Hjem',
    'LBL_MODULE_ID' => 'Fejlrapport',
    ...
    'LBL_BUG_INFORMATION' => 'Kunde Information', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
