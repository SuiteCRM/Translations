...
$mod_strings = array(
    ...
    'help' => array(
        ...
        ,
            'savebtn' => 'Clique em <b>Guardar e implementar</b> para guardar as alterações efetuadas e torná-las ativas no módulo.',
            'historyBtn' => 'Clique em <b>Ver histórico</b> para exibir e restaurar, a partir do histórico, um esquema guardado anteriormente.<br><br><b>Restaurar</b> a partir do <b>Ver histórico</b> restaura o posicionamento do campo dentro dos esquemas guardados anteriormente. Para alterar as etiquetas de campos, clique no ícone Editar junto a cada campo.',
            'historyDefault' => 'Clicar em <b>Restaurar predefinição</b> para repor a vista para o seu esquema original.<br><br><b>Restaurar predefinição</b> só repõe o posicionamento dos campos do esquema original. Para alterar rótulos dos campos, clique no ícone EDITAR junto a cada um dos campos.',
            'Hidden' => 'Os campos marcados com <b>Oculto</b> não estão atualmente disponíveis para serem visualizados pelos utilizadores nas vistas em lista.',
            'Default' => 'Os campos <b>Predefinidos</b> são exibidos nas vistas em lista que não sejam personalizadas pelos utilizadores.'
        ),
        ...
        'studioWizard' => array(
            ...
            'popupHelp' => 'Aqui são exibidos os esquemas das <b>janelas flutuante</b> que podem ser personalizados.<br>',
            'PopupListViewBtn' => 'A <b>vista em lista por janela flutuante</b> exibe os registos com base em vistas de pesquisa por janela flutuante.',
            'PopupSearchViewBtn' => 'A <b>Pesquisa em janela flutuante</b> exibe registos para a vista em lista por janela flutuante.',
...
//STUDIO2
    ...
    'LBL_POPUP' => 'Vista em janela flutuante',
    'LBL_POPUPLISTVIEW' => 'Vista em lista por janela flutuante',
    'LBL_POPUPSEARCH' => 'Pesquisa em janela flutuante',
...
//STUDIO QUESTIONS
    ...
    'LBL_QUESTION_POPUP' => 'Selecione um esquema de janela flutuante a editar.',
//CUSTOM FIELDS
    'LBL_NAME' => 'Nome',
    'LBL_LABELS' => 'Rótulos',
