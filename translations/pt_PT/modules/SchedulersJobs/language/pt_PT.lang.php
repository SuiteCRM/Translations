...
$mod_strings = array(
    ...
    'LBL_STATUS' => 'Situação do trabalho',
    'LBL_RESOLUTION' => 'Resultados',
    'LBL_MESSAGE' => 'Mensagens',
    'LBL_DATA' => 'Dados do trabalho',
    ...
    'LBL_PERCENT' => 'Percentagem de conclusão',
// Errors
    'ERR_CALL' => "Não é possível chamar a função: %s",
    'ERR_CURL' => "Sem CURL — não pode executar URL de trabalhos",
    'ERR_FAILED' => "Falha inesperada. Por favor, verifique os registos de erros do PHP e do CRM",
    'ERR_PHP' => "%s [%d]: %s em %s na linha %d",
    'ERR_NOUSER' => "Nenhum ID de utilizador especificado para o trabalho",
