...
$mod_strings = array(
    ...
    'ERR_CHECKSYS_FASTCGI_LOGGING' => 'Para uma utilização otimizada do sapi IIS/FastCGI, defina fastcgi.logging para 0 no seu ficheiro php.ini.',
    ...
    'ERR_CHECKSYS_CONFIG_NOT_WRITABLE' => 'O ficheiro de configurações existe, mas não é editável. Por favor, tome as medidas necessárias para tornar o ficheiro editável através das permissões de escrita. Dependendo do seu Sistema Operativo, pode ser necessário alterar as permissões executando o chmod 766, ou clicar com o botão direito do rato sobre o ficheiro para aceder às propriedades e desmarcar a opção de Apenas leitura.',
    'ERR_CHECKSYS_CONFIG_OVERRIDE_NOT_WRITABLE' => 'O ficheiro para a sobreposição de configurações (config override) existe, mas não é editável. Por favor, tome as medidas necessárias para tornar o ficheiro editável através das permissões de escrita. Dependendo do seu Sistema Operativo, pode ser necessário alterar as permissões executando o chmod 766, ou clicar com o botão direito do rato sobre o ficheiro para aceder às propriedades e desmarcar a opção de Apenas leitura.',
    'ERR_CHECKSYS_CUSTOM_NOT_WRITABLE' => 'O diretório personalizado (Custom) existe, mas não é editável. Por favor, tome as medidas necessárias para o tornar editável através das permissões de acesso. Dependendo do seu sistema operativo poderá ser necessário alterar as suas permissões (chmod 766) ou ou clicar com o botão direito do rato sobre o ficheiro para aceder às propriedades e desativar a opção APENAS LEITURA.',
    'ERR_CHECKSYS_FILES_NOT_WRITABLE' => "Os ficheiros ou diretórios abaixo listados não são editáveis (ou estão em falta e não podem ser criados). Dependendo do seu sistema operativo a correção pode exigir que altere as permissões (chmod 755) nos ficheiros ou no diretório superior. Em alternativa clique com o botão direito do rato no diretório superior e desmarque a opção 'apenas leitura' aplicando-a a todas as subpastas.",
    ...
    'LBL_DISABLED_DESCRIPTION_2' => 'Após esta alteração ser efetuada, pode clicar no botão abaixo "Iniciar" para começar a sua instalação.<i>Após a instalação estar concluída, vai querer alterar o valor de \'installer_locked\' para \'true\'.</i>',
    ...
    'LBL_DISABLED_HELP_2' => 'fóruns de ajuda',
