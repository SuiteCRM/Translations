...
//e.g. auf Deutsch 'Contacts'=>'Contakten',
    ...
    'moduleList' => array(
        ...
        'ACLRoles' => 'Funções',
        'InboundEmail' => 'Contas de entrada de correio',
        'Releases' => 'Versões',
        'Prospects' => 'Alvos',
        'Queues' => 'Filas',
        ...
        'UpgradeWizard' => 'Atualização — Assistente',
...
$app_strings = array(
    ...
    'LBL_LOGOUT' => 'Sair',
    'LBL_LOGOUT_SUCCESS' => 'Sessão terminada com sucesso',
    'LBL_LOGGED_OUT_MESSAGE' => 'A sessão foi terminada',
    'LBL_LOGIN_AGAIN' => 'Para se autenticar novamente ',
    ...
    'LBL_VIEW_INLINE' => 'Exibir', /*for 508 compliance fix*/
    'LBL_BASIC_SEARCH' => 'Filtrar', /*for 508 compliance fix*/
    ...
    'LBL_EMAIL_ADDRESS_BOOK_FILTER' => 'Filtrar',
    ...
    'LBL_EMAIL_CHECK' => 'Verificar emails',
    ...
    'LBL_EMAIL_QC_CASES' => 'Ocorrências',
    ...
    'LBL_EMAIL_SAVE_DRAFT' => 'Guardar como rascunho',
    ...
    'ERR_UNAUTHORIZED_PAGE_ACCESS' => 'Você não está autorizado a visualizar esta página. Entre em contacto com o administrador do sistema.',
    'ERR_UNAUTHORIZED_PAGE_ACCESS_TO_HOME_PAGE' => 'Você não está autorizado a visualizar esta página. Será redirecionando para a página de entrada...',
    ...
    'LBL_LOG_ENTRIES_LINK_TITLE' => 'Hiperligação clicável',
    ...
    'LBL_ALERT_DISMISS_ERROR' => 'Erro ao tentar rejeitar um alerta',
    'LBL_ALERT_DISMISS_ALL_SUCCESS' => 'Alertas rejeitados com sucesso',
    'LBL_DISMISS_ALL' => 'Rejeitar tudo',
    'LBL_VERIFY' => 'Verificar',
    'LBL_RESEND' => 'Reenviar',
    'LBL_RECORD_DOES_NOT_EXIST' => 'Erro ao obter um registo. Este registo pode ter sido eliminado ou você poderá não ter permissões para o visualizar.',
    'LBL_PROFILE' => 'Perfil',
    ...
    // fastcgi checks
    'LBL_FASTCGI_LOGGING' => 'Para uma utilização otimizada do sapi IIS/FastCGI, defina fastcgi.logging para 0 no seu ficheiro php.ini.',
...
"5. Clique na opção IMPORTAR no menu AÇÕES da aplicação e selecione o ficheiro a ser carregado"   ',
    ...
    'LBL_TOO_FEW_SELECTED' => 'Número inválido de registos selecionados. Deve selecionar no mínimo {min} registos.',
    'LBL_TOO_MANY_SELECTED' => 'Número inválido de registos selecionados. Deve selecionar no máximo {max} registos.',
    'LBL_SELECT_ALL_NOT_ALLOWED' => 'A seleção de todos os registos não está disponível para esta ação. Por favor, selecione registos individualmente.',
    'LBL_MISSING_HANDLER_DATA' => 'Erro inesperado. Em falta os dados de manipulador da ação em lote a partir da resposta',
    'LBL_MISSING_HANDLER' => 'Erro inesperado. Nenhum manipulador definido para a ação em lote selecionada',
    'LBL_MISSING_HANDLER_DATA_ROUTE' => 'Erro inesperado. Falta de roteamento da ação em lote',
    'LBL_ACTION_ERROR' => 'Erro inesperado ao acionar a ação',
    'LBL_BULK_ACTION_ERROR' => 'Erro inesperado ao acionar a ação em lote',
    'LBL_BULK_ACTION_DELETE_SUCCESS' => 'Registos eliminados com sucesso',
    'LBL_BULK_ACTION_MASS_UPDATE_CONFIRMATION' => 'Tem a certeza de que deseja atualizar os registos selecionados?',
    'LBL_BULK_ACTION_MASS_UPDATE_SUCCESS' => 'Todos os registos atualizados com sucesso',
    'LBL_BULK_ACTION_MASS_UPDATE_PARTIAL_SUCCESS' => 'Sucesso parcial. Alguns registos não foram atualizados. Por favor, verifique o registo de ações',
    'LBL_BULK_ACTION_MASS_UPDATE_NO_FIELDS' => 'Não existem campos a atualizar',
    'LBL_BULK_ACTION_MASS_UPDATE_NO_RECORDS' => 'Não existem registos a atualizar',
    'LBL_BULK_ACTION_MASS_UPDATE_NO_ACLS' => 'Privilégios insuficientes. A ação de Guardar não é permitida',
    'LBL_UNEXPECTED_ERROR' => 'Erro inesperado. Não é possível executar a ação.',
    'LBL_RECORD_DELETE_SUCCESS' => 'Registo eliminado com sucesso',
    'LBL_RECORD_DELETE_ALL_SUCCESS' => 'Registos apagados com sucesso',
    'LBL_RECORD_SNOOZE_SUCCESS' => 'Notificação adiada',
    'LBL_ERROR_SAVING' => 'Ocorreu um erro ao guardar o registo',
    ...
    'PIPELINE_BY_SALES_STAGE' => 'Processo de vendas por fase da venda',
    'LEADS_BY_SOURCE' => 'Pistas por fonte',
    'LEADS_BY_STATUS' => 'Pistas por situação',
    ...
    'ERR_SUHOSIN' => 'Fluxo de carregamento está bloqueado pelo Suhosin. Por favor, adicione &quot;upload&quot; a suhosin.executor.include.whitelist (consulte o ficheiro suitecrm.log para obter mais informações)',
    ...
    'LBL_FILTER_HEADER_TITLE' => 'Filtrar',
    ...
    'LBL_SUITE_DESC1' => 'SuiteCRM foi desenvolvido por <a href="https://salesagility.com">SalesAgility</a>. O programa é fornecido tal como está, sem qualquer garantia. Licenciado sob AGPLv3.',
    ...
    'LBL_SUITE_DESC3' => 'SuiteCRM é uma marca da SalesAgility Ltd. Todos os outros nomes de empresas e produtos podem ser marcas comerciais das respetivas empresas com as quais estejam associados.',
    ...
    'LBL_COLUMN_SELECTOR_SAVE_BUTTON' => 'Guardar alterações',
...
$app_list_strings['aow_process_status_list']['Complete'] = 'Completar';
...
$app_list_strings['map_relate_type_list']['Cases'] = 'Ocorrências';
...
$app_strings['LBL_SUBPANEL_FILTER_LABEL'] = 'Filtrar';
...
$app_list_strings['moduleList']['SurveyResponses'] = 'Respostas do inquérito';
...
$app_strings['LBL_GOOGLE_SYNC_ERR'] = 'Sincronização Google SuiteCRM - Erro';
...
$app_strings['LBL_OPT_OUT'] = 'Solicitar exclusão';
$app_strings['LBL_INVALID_EMAIL'] = 'Inválido';
$app_strings['LBL_PRIMARY'] = 'Principal';
$app_strings['LBL_EMAIL_ADDRESS'] = 'Endereço de email';
...
$app_strings['LBL_INSIGHTS'] = 'Perspetivas';
...
$app_strings['LBL_SELECT_SUBPANEL_BANNER'] = 'Selecionar os subpainéis a visualizar';
$app_strings['LBL_SELECT_ITEM'] = 'Selecionar item';
$app_strings['LBL_ITEMS_SELECTED'] = 'items selected';
$app_strings['LBL_WIDGET_NOT_FOUND'] = 'Miniaplicação não encontrada';
...
$app_strings['LBL_CONFIG_NO_CONFIG'] = 'Configuração incorreta: configuração em falta';
$app_strings['LBL_CONFIG_NO_STATISTICS_KEY'] = 'Configuração incorreta: chave de estatísticas em falta';
$app_strings['LBL_STATISTIC_ERROR'] = 'Erro ao carregar estatísticas';
$app_strings['LBL_STATISTIC_ERROR_DESC'] = 'Erro ao carregar estatísticas';
$app_strings['LBL_STATISTIC_ERROR_DESC_TOOLTIP'] = 'Erro ao carregar estatísticas. Por favor, contacte o administrador';
$app_strings['LBL_AVERAGE_CLOSED_WON_PER_YEAR'] = 'Média de oportunidades ganhas por ano';
$app_strings['LBL_OPPORTUNITIES_TOTAL'] = 'Valor total das oportunidades';
...
$app_strings['LBL_CLOSED_PER_YEAR'] = 'Fechados por ano';
$app_strings['LBL_WAS_OPEN'] = 'Esta ocorrência esteve aberta durante';
$app_strings['LBL_HAS_BEEN_OPEN'] = 'Esta ocorrência está em aberto há';
...
$app_strings['LBL_VALIDATION_ERROR_REQUIRED'] = 'Campo obrigatório em falta: {{fields.field.label}}';
$app_strings['LBL_VALIDATION_ERROR_CURRENCY_FORMAT'] = "Formato de moeda inválido. Esperado: '{{context.expected}}'";
$app_strings['LBL_VALIDATION_ERROR_INT_FORMAT'] = "Formato de número inteiro inválido. Esperado: '{{context.expected}}'";
$app_strings['LBL_VALIDATION_ERROR_FLOAT_FORMAT'] = "Formato de ponto flutuante inválido. Esperado: '{{context.expected}}'";
$app_strings['LBL_VALIDATION_ERROR_DATE_FORMAT'] = "Formato de data inválido. Esperado: '{{context.expected}}'";
$app_strings['LBL_VALIDATION_ERROR_DATETIME_FORMAT'] = "Formato de data e hora inválido. Esperado: '{{context.expected}}'";
...
$app_strings['LBL_VALIDATION_ERROR_EMAIL_FORMAT'] = "Formato de email inválido. Esperado: '{{context.expected}}'";
$app_strings['LBL_VALIDATION_ERROR_PHONE_FORMAT'] = "Formato de n.º de telefone inválido.";
$app_strings['LBL_VALIDATION_ERROR_MIN'] = "Valor inválido. O valor deve ser igual ou maior do que '{{context.min}}'";
$app_strings['LBL_VALIDATION_ERROR_MAX'] = "Valor inválido. O valor deve ser igual ou menor do que '{{context.max}}'";
$app_strings['LBL_MULTIPLE_PRIMARY_EMAIL_VALIDATION_ERROR'] = "Only one Valid Email Address should be marked as primary";
$app_strings['LBL_DUPLICATE_EMAIL_VALIDATION_ERROR'] = "Não são permitidos endereços de email duplicados";
...
$app_strings['LBL_VALIDATION_ERRORS'] = 'Existem erros de validação. Não é possível executar a ação.';
...
$app_strings['LBL_TYPE_TO_SEARCH'] = 'Escreva para pesquisar...';
$app_strings['LBL_SEARCHING'] = 'A procurar...';
$app_strings['LBL_NOT_FOUND'] = 'Não encontrado.';
$app_strings['LBL_SEARCH_ERROR'] = 'Erro na pesquisa.';
$app_strings['LBL_FOUND'] = 'Encontrado';
$app_strings['LBL_GET_RECORD_LIST_ERROR'] = 'Ocorreu um erro ao obter registos';
$app_strings['LBL_NUMBER_OF_RECORDS'] = 'O número de registos';
...
$app_strings['LBL_INVOICES_OVERDUE_TOOLTIP'] = 'Número total de faturas em atraso';
$app_strings['LBL_ACTIVITIES_NEXT_DATE_TOOLTIP'] = 'Data da próxima interação';
$app_strings['LBL_CAMPAIGN_LAST_RECEIVED_TOOLTIP'] = 'Data da campanha recebida mais recente';
$app_strings['LBL_OPEN_CASES_COUNT_TOOLTIP'] = 'Número total de ocorrências em aberto';
...
$app_strings['LBL_QUOTES_EXPIRY_TOOLTIP'] = 'Data do próximo fim de validade da proposta';
$app_strings['LBL_DEFAULT_TOTAL_TOOLTIP'] = 'Número total de registos';
$app_strings['LBL_CONTRACT_RENEWAL'] = 'Data de renovação';
$app_strings['LBL_INVOICES_OVERDUE'] = 'Total vencido';
$app_strings['LBL_ACTIVITIES_NEXT_DATE'] = 'Data da próxima atividade';
$app_strings['LBL_CAMPAIGN_LAST_RECEIVED'] = 'Última participação';
$app_strings['LBL_OPEN_CASES_COUNT'] = 'Ocorrências em aberto';
$app_strings['LBL_EVENTS_LAST_DATE'] = 'Última presença em evento';
$app_strings['LBL_HISTORY_LAST_DATE'] = 'Último ponto de contacto';
$app_strings['LBL_OPPORTUNITIES_TOTAL_SUM'] = 'Valor total';
$app_strings['LBL_QUOTES_EXPIRY'] = 'Próxima data de validade';
$app_strings['LBL_DEFAULT_TOTAL'] = 'Total';
$app_strings['AOS_Contracts'] = 'Contratos';
$app_strings['AOS_Quotes'] = 'Propostas';
$app_strings['AOS_Invoices'] = 'Faturas';
$app_strings['LBL_PHOTO'] = 'Foto';
$app_strings['LBL_CASE_UPDATES'] = 'Atualizações da ocorrência';
$app_strings['LBL_CASE_UPDATE_SUBMITTED'] = 'Atualização da ocorrência enviada';
...
$app_strings['LBL_SAVED_FILTER_SAVED'] = 'Filtro guardado com sucesso';
$app_strings['LBL_FILTER_ID_NOT_DEFINED'] = 'ID de filtro não definido';
$app_strings['LBL_GENERIC_CONFIRMATION'] = 'Pretende avançar com esta ação?';
$app_strings['LBL_SHOW_MORE'] = 'Mostrar mais';
...
$app_strings['LBL_END'] = 'Final';
$app_strings['LBL_LINE_ITEMS_FIELD_CONFIG'] = 'Má configuração';


$app_strings['LBL_ACTION_SUCCESS'] = 'Ação com sucesso';
...
$app_strings['LBL_LINK'] = 'Ligação';
$app_strings['LBL_LINK_UNLINK'] = 'Link / Unlink';
$app_strings['LBL_SAVE'] = 'Guardar';
$app_strings['LBL_UNLINK_RECORD'] = 'Desvincular registo';
$app_strings['LBL_EDIT_RECORD'] = 'Editar registo';
$app_strings['LBL_UNLINK_RELATIONSHIP_CONFIRM'] = 'Tem a certeza de que pretende desvincular este relacionamento? Apenas será removida a relação, o registo não será eliminado.';
$app_strings['LBL_UNLINK_RELATIONSHIP_SUCCESS'] = 'Registo desvinculado com sucesso.';
$app_strings['LBL_UNLINK_RELATIONSHIP_FAILED'] = 'Ocorreu um erro ao desvincular este registo.';
...
$app_strings['LBL_LINK_RELATIONSHIP_SUCCESS'] = 'Relacionamento adicionado com sucesso.';
$app_strings['LBL_LINK_RELATIONSHIP_FAILED'] = 'Ocorreu um erro ao adicionar esta relação.';
$app_strings['LBL_MODULE_NOT_FOUND'] = 'Módulo não encontrado.';
$app_strings['LBL_RECORD_NOT_FOUND'] = 'Não foi possível carregar o registo';
$app_strings['LBL_RELATIONSHIP_LOAD_ERROR'] = 'Não foi possível carregar a relação';
$app_strings['LBL_NOT_LINKED'] = 'Não foi possível desvincular. Os registos não estão vinculados';
$app_strings['LBL_ACCESS_DENIED'] = 'Acesso negado';
$app_strings['LBL_ADD_RECORDS_TO_TARGET_LIST_SUCCESS'] = 'Registos adicionados, com sucesso, à lista de alvos.';
$app_strings['LBL_ADD_RECORDS_TO_TARGET_LIST_FAILED'] = 'Ocorreu um erro ao adicionar registos à lista de alvos.';
$app_strings['LBL_ADD_CONTACTS_TO_TARGET_LIST_SUCCESS'] = 'Contactos adicionados, com sucesso, à lista de alvos.';
$app_strings['LBL_ADD_CONTACTS_TO_TARGET_LIST_FAILED'] = 'Ocorreu um erro ao adicionar contactos à lista de alvos.';
$app_strings['LBL_CHANGED_TO_TEXT'] = 'alterado para';
$app_strings['LBL_RECORD_CHANGED'] = 'Registo atualizado';
$app_strings['LBL_CREATE'] = "Criar";
...
$app_strings['LOGIN_INCORRECT'] = 'Credenciais de autenticação erradas. Por favor, tente novamente.';
$app_strings['LOGIN_TOO_MANY_FAILED'] = 'Demasiadas tentativas de autenticação falhadas. Por favor, tente novamente mais tarde.';
...
$app_strings['LBL_NOTIFICATION_ITEM_DATE'] = 'Prazo: {{fields.date_start.value}}';
...
$app_strings['LBL_RELATED_TO'] = 'Relacionar com';
...
$app_strings['LBL_QUOTE'] = 'Proposta';
...
$app_strings['LBL_MON'] = 'Segunda-feira';
$app_strings['LBL_TUE'] = 'Terça-feira';
$app_strings['LBL_WED'] = 'Quarta-feira';
$app_strings['LBL_THU'] = 'Quinta-feira';
$app_strings['LBL_FRI'] = 'Sexta-feira';
$app_strings['LBL_SAT'] = 'Sábado';
$app_strings['LBL_ALL'] = 'Todos os dias';
$app_strings['LBL_EVERY'] = 'Cada';
$app_strings['LBL_ON_THE'] = 'Em';
$app_strings['LBL_RANGE'] = 'até';
...
$app_strings['LBL_OFTEN'] = 'Sempre que possível.';
$app_strings['LBL_MIN_MARK'] = ' sinal de minutos';
$app_strings['LBL_INBOUND_EMAIL'] = 'Entrada de correio';
...
$app_strings['LBL_INACTIVE'] = 'Inativo';
...
$app_strings['LBL_UPLOAD'] = 'Carregar';
