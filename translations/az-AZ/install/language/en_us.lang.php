...
$mod_strings = array(
    ...
    'ERR_CHECKSYS_CONFIG_NOT_WRITABLE' => 'Konfiqurasiya faylı mövcuddur, lakin yazmaq mümkün deyil. Zəhmət olmasa faylı yazıla bilən etmək üçün lazımi addımları atın.',
    'ERR_CHECKSYS_CONFIG_NOT_FOUND' => 'Sizin config.php mövcud deyil. Bu quraşdırma zamanı yaradılacaq.',
    'ERR_CHECKSYS_CONFIG_OVERRIDE_NOT_WRITABLE' => 'Konfiqurasiyanın ləğvi faylı mövcuddur, lakin yazmaq mümkün deyil. Zəhmət olmasa faylı yazıla bilən etmək üçün lazımi addımları atın. ',
    'ERR_CHECKSYS_CUSTOM_NOT_WRITABLE' => 'Fərdi Kataloq mövcuddur, lakin yazmaq mümkün deyil. Zəhmət olmasa faylı yazıla bilən etmək üçün lazımi addımları atın.',
    'ERR_CHECKSYS_FILES_NOT_WRITABLE' => "Yuxarıda sadalanan fayllar və ya qovluqlar yazıla bilməz və ya yoxdur və yaradıla bilməz. Lütfən, kataloqları yazıla bilən etmək üçün lazımi addımları atın.",
    'ERR_CHECKSYS_LOGS_NOT_WRITABLE' => 'Qeydlər kataloqu hazırda yazıla bilməz',
    'ERR_CHECKSYS_CACHE_NOT_WRITABLE' => 'Cache Directory hazırda yazıla bilməz',
    'ERR_CHECKSYS_EXTENSIONS_NOT_WRITABLE' => 'Genişləndirmələr kataloqu hazırda yazıla bilməz',
    'ERR_CHECKSYS_SECRETS_NOT_WRITABLE' => 'Config/secrets kataloqu hazırda yazıla bilməz',
    'ERR_CHECKSYS_ENV_NOT_WRITABLE' => '.env faylı və ya onun yerləşdiyi kataloq yazıla bilməz.',
    ...
    'ERR_DB_LOGIN_FAILURE_SHORT' => 'Database Connection Xətası: Verilən verilənlər bazası host adı, port, istifadəçi adı və/yaxud şifrə etibarsızdır.',
 ...
 şifrə sahələrinə yenidən daxil edin.',
    ...
    'ERR_UPLOAD_MAX_FILESIZE' => 'Ən azı 6MB olan faylların yüklənməsinə icazə vermək üçün PHP konfiqurasiyanız dəyişdirilməlidir.',
    ...
    'LBL_CHECKSYS_LEGACY_CACHE' => 'Yazıla bilən Köhnə Keş Alt Kataloqları',
    'LBL_CHECKSYS_CACHE' => 'Yazıla bilən Keş Alt Kataloqları',
    'LBL_CHECKSYS_EXTENSIONS' => 'Yazıla bilən uzantılar kataloqu',
    'LBL_CHECKSYS_SECRETS' => 'Yazıla bilən Config/Secrets kataloqu',
    'LBL_CHECKSYS_LOGS' => 'Yazıla bilən Log Directory',
    ...
    'LBL_CHECKSYS_PHP_INI' => 'PHP konfiqurasiya faylınızın yeri (php.ini)',
    ...
    'LBL_CHECKSYS_ENV' => 'Yazıla bilən .env',
    ...
    'LBL_CHECKSYS_INTL_EXTENSIONS' => 'Intl Genişlənmələrdə mövcuddur',
    'LBL_CHECKSYS_JSON_EXTENSIONS' => 'Json Genişlənmələrdə mövcuddur',
    'LBL_CHECKSYS_GD_EXTENSIONS' => 'GD Genişləndirmələrdə mövcuddur',
    'LBL_CHECKSYS_OPENSSL_EXTENSIONS' => 'OpenSSL Genişlənmələrdə mövcuddur',
    'LBL_CHECKSYS_ZIP_EXTENSIONS' => 'Zip Genişlənmələrdə mövcuddur',
    'LBL_CHECKSYS_PDO_MYSQL_EXTENSIONS' => 'PDO MySQL Genişlənmələrdə mövcuddur',
    'LBL_CHECKSYS_CURL_EXTENSIONS' => 'cURL Genişlənmələrdə mövcuddur',
    'LBL_CHECKSYS_MBSTRING_EXTENSIONS' => 'MB sətirləri uzatmalarda mövcuddur',
    'LBL_CHECKSYS_MYSQLI_EXTENSIONS' => 'MySQLi uzatmalarda mövcuddur',
    'LBL_CHECKSYS_SOAP_EXTENSIONS' => 'Soap Uzatmalarda Mövcuddur',
    'LBL_CHECKSYS_XML_EXTENSIONS' => 'XML uzatmalarda mövcuddur',
    'LBL_CHECKSYS_IMAP_EXTENSIONS' => 'IMAP uzatmalarda mövcuddur (İstəyə görə)',
    'LBL_CHECKSYS_LDAP_EXTENSIONS' => 'LDAP uzatmalarda mövcuddur (İstəyə görə)',
    'LBL_PHP_CHECKS' => 'PHP YOXLAMALARI',
    'LBL_SERVER_CHECKS' => 'SERVER YOXLAMALARI',
    'LBL_PERMISSION_CHECKS' => 'İCAZƏ YOXLAMALARI',
    'LBL_CHECK_FAILED' => 'Yoxlama uğursuz oldu: ',
    'ERR_CHECKSYS_INTL' => 'Intl uzantısı quraşdırılmayıb, lütfən, sistem administratorunuzla əlaqə saxlayın',
    'ERR_CHECKSYS_JSON' => 'JSON genişləndirilməsi aktiv deyil, lütfən, sistem administratorunuzla əlaqə saxlayın.',
    'ERR_CHECKSYS_GD' => 'GD genişləndirilməsi aktiv deyil, sistem administratorunuzla əlaqə saxlayın.',
    'ERR_CHECKSYS_OPENSSL' => 'OpenSSL genişləndirilməsi aktiv deyil, sistem administratorunuzla əlaqə saxlayın.',
    'ERR_CHECKSYS_PDO_MYSQL' => 'PDO MySQL genişləndirilməsi aktiv deyil, lütfən sistem administratorunuzla əlaqə saxlayın.',
    'ERR_CHECKSYS_MYSQLI' => 'MySQLi genişləndirilməsi aktiv deyil, sistem administratorunuzla əlaqə saxlayın.',
    'ERR_CHECKSYS_SOAP' => 'Soap genişləndirilməsi aktiv deyil, lütfən, sistem administratorunuzla əlaqə saxlayın.',
    ...
    'LBL_UNWRITABLE_SUB_DIR' => 'Bəzi alt qovluqlar var ki, onlar yazıla bilməz. Lütfən, kataloqları yazıla bilən etmək üçün lazımi addımları atın ',
    'LBL_REFER_TO_LOGS' => 'Quraşdırmadan əvvəl yoxlamalarınızdan birində problem var, lütfən install.log saytına baxın',
    'LBL_NOT_A_VALID_SUITECRM_PAGE' => 'SuiteCRM Başlığını tapmaq mümkün deyil. Bu etibarlı SuiteCRM Səhifəsi deyil.',
    'LBL_NOT_COOKIE_OR_TOKEN' => 'Kukiləri tapmaq mümkün deyil, etibarlı nişan tapılmadı. Əlavə məlumat üçün install.log saytına baxın.',
    'LBL_CURL_JSON_ERROR' => 'Graphql səhifəsinə curl çağırışının nəticəsi boş idi.',
    'LBL_UNABLE_TO_FIND_SYSTEM_CONFIGS' => 'Graphql Səhifəsində Sistem Konfiqurasiyalarını əldə etmək mümkün deyil. Əlavə məlumat üçün install.log saytına baxın.',
    'LBL_CURL_REQUEST_MAIN_PAGE' => 'Əsas Səhifədə Curl Sorğusu',
    'LBL_CURL_REQUEST_API_PAGE' => 'Api-də Curl Sorğusu',
    'LBL_ERROR_DETAILS' => 'Xəta təfərrüatları',
    'LBL_ERROR' => 'Xəta',
    'LBL_WARNING_DETAILS' => 'Xəbərdarlıq Təfərrüatları',
    'LBL_WARNING' => 'Xəbərdarlıq',
    'LBL_SYSTEM_CHECKS' => 'SİSTEM YOXLAMALARI',
    'LBL_CRON_INSTRUCTIONS_1' => 'SuiteCRM Schedulers proqramını işə salmaq üçün veb server istifadəçilərinizin crontab faylını bu əmrlə redaktə edin:',
    'LBL_CRON_INSTRUCTIONS_2' => 'və crontab faylına aşağıdakı sətri əlavə edin:',
    'LBL_CRON_INSTRUCTIONS_3' => 'Bunu yalnız quraşdırma başa çatdıqdan sonra etməlisiniz.',
    'LBL_CRON_CONFIGURATION' => 'CRON konfiqurasiyası',
    'LBL_SETUP_CRONTAB' => 'Crontab qurmaq üçün',
    'LBL_ROUTE_ACCESS_CHECK' => 'MARŞRUTLARA GİRİŞ YOXLANIŞI',
    'LBL_PHP_MEM_1' => 'PHP Yaddaş Limitiniz ',
    'LBL_PHP_MEM_2' => 'Bu minimum olmalıdır ',
    'LBL_PHP_MEM_3' => 'Davam etmək üçün M.',
    'LBL_CLOSE' => 'Bağla',
    'LBL_THREE' => '3',
    ...
    'LBL_DBCONF_DB_PORT' => 'Verilənlər bazası portu',
    ...
    'LBL_DBCONF_HOST_NAME' => 'Şəbəkə adı',
    ...
    'LBL_DISABLED_DESCRIPTION_3' => 'Bu dəyişiklik edildikdən sonra davam etmək üçün bu səhifəyə yenidən baxın/yenidən yükləyin.',
    ...
    'LBL_APP_NOT_INSTALLED' => 'SuiteCRM quraşdırılmayıb. Giriş nöqtəsi quraşdırılmış SuiteCRM tələb edir, əvvəlcə quraşdırın.',
    ...
    'LBL_SILENT_INSTALL_SUCCESS' => 'SuiteCRM uğurla quraşdırılıb.',
    'LBL_SILENT_INSTALL_FAILED' => 'SuiteCRM quraşdırılması uğursuz oldu.',
    ...
    'LBL_PRE_INSTALL_REQ' => 'Quraşdırmadan əvvəl tələblər',
    ...
    'LBL_WELCOME' => 'SuiteCRM-ə xoş gəlmisiniz',
...
Yüklənmiş faylı php.ini-də yükləmə_max_filesize direktivini üstələyir.',
    ...
    'LBL_SYS_CHECK_WARNING' => 'Sistem Yoxlama Xəbərdarlıqlarına məhəl qoymayın',
    'LBL_PROCEED' => 'DAVAM EDİN',
    'LBL_RECHECK' => 'TƏKRAR EDİN',
    'LBL_CONFIG' => 'KONFİQURASİYA',
    'LBL_VALIDATION_ERRORS' => 'Doğrulama xətaları var, əməliyyatı həyata keçirmək mümkün deyil.'
);
