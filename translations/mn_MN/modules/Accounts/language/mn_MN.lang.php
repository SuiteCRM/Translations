...
$mod_strings = array(
    ...
    'LBL_ACCOUNT_INFORMATION' => 'Тойм', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
    ...
    'LBL_PUSH_CONTACTS_BUTTON_LABEL' => 'Харилцагч (хүмүүс)-ийн бүртгэлрүү хуулах',
    'LBL_PUSH_CONTACTS_BUTTON_TITLE' => 'Хуулах...',
    'LBL_RATING' => 'Рейтинг:',
    'LBL_SAVE_ACCOUNT' => 'Аккаунтыг Хадгал',
    'LBL_SEARCH_FORM_TITLE' => 'Харилцагч хайх',
    ...
    'LNK_ACCOUNT_LIST' => 'Харилцагч харах',
    'LNK_NEW_ACCOUNT' => 'Аккаунт Үүсгэх',
    'LNK_IMPORT_ACCOUNTS' => 'Харилцагч импортлох',
    ...
    // SNIP
    'LBL_PRODUCTS_SERVICES_PURCHASED_SUBPANEL_TITLE' => 'Худалдан авсан бараа үйлчлгээ',
