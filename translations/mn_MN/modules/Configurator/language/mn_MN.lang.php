...
$mod_strings = array(
    ...
    'ADVANCED' => 'Ахисан',
    'DEFAULT_CURRENCY_ISO4217' => 'Вальютийн код (ISO 4217, Ж: MNT)',
    'DEFAULT_CURRENCY_NAME' => 'Currency name',
    'DEFAULT_CURRENCY_SYMBOL' => 'Currency symbol',
    'DEFAULT_DATE_FORMAT' => 'Default date format',
    'DEFAULT_DECIMAL_SEP' => 'Аравтын тэмдэгт',
    'DEFAULT_LANGUAGE' => 'Үндсэн хэл',
    'DEFAULT_SYSTEM_SETTINGS' => 'Хэрэглэгчийн интерфэйс',
    'DEFAULT_THEME' => 'Стандарт үзэгдэц',
    'DEFAULT_TIME_FORMAT' => 'Цагын формат',

    'DISPLAY_RESPONSE_TIME' => 'Серверийн хариу өгсөн цаг харуулах',

    'IMAGES' => 'Лого',
    'LBL_ALLOW_USER_TABS' => 'Allow users to hide tabs',
    'LBL_CONFIGURE_SETTINGS_TITLE' => 'System Settings',
    'LBL_LOGVIEW' => 'Лог харах',
    ...
    'LBL_MIN_AUTO_REFRESH_INTERVAL' => 'Самбар автоматаар шинэчлэх хугацаа',
    ...
    'LBL_MODULE_TITLE' => 'Хэрэглэгчийн интерфэйс',
    'LBL_NOTIFY_FROMADDRESS' => 'Илгээгчийн "From" хаяг:',
    'LBL_NOTIFY_SUBJECT' => 'Мэйлын гарчиг:',

    'LBL_PROXY_AUTH' => 'Нэвтрэлт?',
    'LBL_PROXY_HOST' => 'Proxy Host',
    'LBL_PROXY_ON_DESC' => 'Configure proxy server address and authentication settings',
    'LBL_PROXY_ON' => 'Use proxy server?',
    'LBL_PROXY_PASSWORD' => 'Нууц үг',
    'LBL_PROXY_PORT' => 'Порт',
    'LBL_PROXY_TITLE' => 'Proxy Settings',
    'LBL_PROXY_USERNAME' => 'Хэрэглэгчийн Нэр',
    'LBL_RESTORE_BUTTON_LABEL' => 'Сэргээх',
    ...
    'LBL_LDAP_ADMIN_USER' => 'Хэрэглэгчийн нэр:',
    'LBL_LDAP_ADMIN_USER_DESC' => 'Used to search for the LDAP user. This may need to be fully qualified.',
    'LBL_LDAP_ADMIN_PASSWORD' => 'Нууц үг:',
    'LBL_LDAP_AUTHENTICATION' => 'Нэвтрэлт:',
    ...
    'LBL_LDAP_GROUP_NAME' => 'Групын нэр:',
    ...
    'LBL_ALL' => 'Бүгд',
    'LBL_MARK_POINT' => 'Тэмдэглэсэн цэг',
    'LBL_NEXT_' => 'Цааш >>',
    'LBL_REFRESH_FROM_MARK' => 'Тэмдэглэсэн цэгээс хойш шинэчлэх',
    'LBL_SEARCH' => 'Хайх:',
    'LBL_REG_EXP' => 'Reg Exp:',
    'LBL_IGNORE_SELF' => 'Өөрийгөө алгасах:',
    ...
    'LBL_YOUR_IP_ADDRESS' => 'Таны IP хаяг',
    'LBL_IT_WILL_BE_IGNORED' => ' үүнийг алгасах болно ',
    'LBL_LOG_NOT_CHANGED' => 'Лог өөрчлөлт ороогүй',
    ...
    'ERR_ALERT_FILE_UPLOAD' => 'Зураг оруулахад алдаа гарлаа.',
...
// Wizard
    ...
    'LBL_WIZARD_CONTINUE_BUTTON' => 'Үргэлжлүүлэх',
    ...
    'LBL_LOADING' => 'Ачааллаж байна...' /*for 508 compliance fix*/,
    'LBL_DELETE' => 'Устгах' /*for 508 compliance fix*/,
    'LBL_WELCOME' => 'Мэндчилгээ' /*for 508 compliance fix*/,
