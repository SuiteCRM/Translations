...
$mod_strings = array(
    'LBL_BASIC' => 'BASIC',
    'LBL_BASIC_SEARCH' => 'Paspasan nga Filter',
    ...
    'ERR_CHECKSYS_PHP_INVALID_VER' => 'Ang imong bersyon sa PHP kay dili supportado sa SuiteCRM. Kinahanglan ka mag-install og bersyon nga nahiuyon sa SuiteCRM application. Palihug sa pagkonsulta sa Compatibility Matrix sa Release Notes para sa suportado nga mga bersyon sa PHP. Ang imong bersyon kay ',
    ...
    'ERR_CHECKSYS_FASTCGI_LOGGING' => 'Para sa labing hingpit og maayo nga kasinatian gamit ang IIS/FastCGI sapi, i-set ang fastcgi.logging sa 0 sa imong php.ini nga file.',
    ...
    'ERR_DBCONF_VALIDATION' => 'Palihug og ayo sa mga mosunod nga mga error sa dili pa magpadayon:',
    ...
    'ERROR_VERSION_INCOMPATIBLE' => 'Ang gi-upload nga file kay wala nahiuyon sa bersyon sa SuiteCRM: ',
    ...
    'LBL_CONFIRM_DB_TYPE' => 'Matang sa Database',
    'LBL_CONFIRM_NOT' => 'dili',
    'LBL_CONFIRM_TITLE' => 'Kompirmaha ang Settings',
    'LBL_CONFIRM_WILL' => 'mo',
    ...
    'LBL_LANG_BUTTON_COMMIT' => 'I-instalar',
    'LBL_LANG_BUTTON_REMOVE' => 'Tangtanga',
    ...
    'LBL_ML_DESCRIPTION' => 'Paghulagway',
    'LBL_ML_INSTALLED' => 'Petsa sa Pagka-instalar',
    'LBL_ML_NAME' => 'Pangalan',
    'LBL_ML_PUBLISHED' => 'Petsa sa Pagkapatik',
    'LBL_ML_TYPE' => 'Matang',
    'LBL_ML_UNINSTALLABLE' => 'Dili ma-install',
...
<ul><li>Ang administrador sa database kay gikinahanglang makahimo og mga lamesa ug mga tiggamit ug makasuwat ngadto sa database.</li><li>Mamahimo nimong gikinahanglan ang
    ...
    'LBL_INCOMPATIBLE_PHP_VERSION' => 'Kinahanglan ang bersyon sa Php kay 5 o pataas.',
    ...
    'LBL_BACKWARD_COMPATIBILITY_ON' => 'Ang Php Backward Compatibility mode kay gi-on. I-set ang zend.ze1_compatibility_mode sa off para sa pagpadayon',
...
$contact_user_link_guid',
    ...
    'LBL_FROM_NAME' => '"Gigikanan" nga Ngalan:',
    ...
    'LBL_ALLOW_DEFAULT_SELECTION_HELP' => 'Kung kini nga opsyon ang gipili, tanan nga mga user makahimo og padala og email gamit ang outgoing mail account gigamit sa pagpadala og pahibalo sa sistema og pag-alisto. Kung ang opsyon kay wala gipili, ang mga user mamahimo gihapon makagamit sa outgoing mail server pagkahuman sa paghatag sa ilang impormasyon sa ilang account.',
    ...
    'SYSTEM_NAME_WIZARD' => 'Pangan:',
    'SYSTEM_NAME_HELP' => 'Kini ang pangan nga gipakita sa title bar sa imong browser.',
    'NEW_LOGO' => 'Pagpili og logo:',
    'NEW_LOGO_HELP' => 'Ang file format sa imahe pwede naka .png o .jpg. Ang maximum nga gitas-on kay 170px, og ang maximum nga gilapdon kay 450px. Bisag unsa nga imahe ang i-upload nga mas dako pa sa bisan asa nga direksyon kay mascale sa maximum nga mga sukod.',
    ...
    'LBL_NUMBER_GROUPING_SEP' => '1000s nga tigbuwag:',
    ...
    'ERR_UPLOAD_FILE_UPLOAD_ERR_INI_SIZE' => 'Ang gi-upload nga file nilapas sa upload_max_filesize nga naka direktiba sa php.ini.',
    'ERR_UPLOAD_FILE_UPLOAD_ERR_FORM_SIZE' => 'Ang gi-upload nga file nilapas sa MAX_FILE_SIZE nga gidirektiba sa gi-specify sa HTML form.',
    'ERR_UPLOAD_FILE_UPLOAD_ERR_PARTIAL' => 'Ang gi-upload nga file kay partial ra nga na-upload.',
    'ERR_UPLOAD_FILE_UPLOAD_ERR_NO_FILE' => 'Walay file nga gi-upload.',
    'ERR_UPLOAD_FILE_UPLOAD_ERR_NO_TMP_DIR' => 'Nawagtangan og temporary nga folder.',
    'ERR_UPLOAD_FILE_UPLOAD_ERR_CANT_WRITE' => 'Napakyas sa pagsulat sa payl ngadto sa disk.',
