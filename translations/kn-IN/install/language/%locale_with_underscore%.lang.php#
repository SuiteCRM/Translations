...
$mod_strings = array(
    ...
    'LBL_LOCALE_NAME_SALUTATION' => 'ಡಾ.',

    'LBL_ML_ACTION' => 'Action',
    'LBL_ML_DESCRIPTION' => 'ವಿವರಣೆ',
...
$contact_user_link_guid',
    ...
    'LBL_OLD_PHP_MSG' => 'SuiteCRM ಅನ್ನು ಇನ್ಸ್ಟಾಲ್  ಮಾಡಲು PHPಯ ಆವೃತ್ತಿಯು %s ಶಿಫಾರಸು ಮಾಡಲಾಗಿದೆ <br />ಅಗತ್ಯವಿರುವ ಕನಿಷ್ಠ PHP ಆವೃತ್ತಿ %s<br />ನೀವು PHP ಆವೃತ್ತಿ %s ಅನ್ನು ಬಳಸುತ್ತಿರುವಿರಿ, ಅದು EOL: <a href="http://php.net /eol.php">http://php.net/eol.php</a>.<br />ದಯವಿಟ್ಟು ನಿಮ್ಮ PHP ಆವೃತ್ತಿಯನ್ನು ನವೀಕರಿಸುವುದನ್ನು ಪರಿಗಣಿಸಿ.',
    'LBL_OLD_PHP_OK' => 'I\'m aware of the risks and wish to continue.',

    'LBL_DBCONF_TITLE_USER_INFO_LABEL' => 'ಬಳಕೆದಾರ',
