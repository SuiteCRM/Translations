...
$mod_strings = array(
    ...
    'DESC_FILES_QUEUED' => 'Следните модули са готови за инсталиране:',
    'DESC_IFRAME' => 'Добавяне на табулатори за достъп до уеб сайтове',

    'DOWNLOAD_QUESTION' => 'Сигурни ли сте че искате да изтеглите избраните(ят) пакет(и)?',

    'SEARCHING_UPDATES' => 'Преглед за актуализиции...',
    'DOWNLOADING' => 'Изтегляне…',
    'DL_PACKAGES_DOWNLOADING' => 'Сваля се',
    'DL_PACKAGES_OF' => 'of',
    ...
    'ERR_INVALID_LOCALE_NAME_FORMAT_UPGRADE' => '„Name Format“, зададен преди обновяването, вече не се поддържа. Форматът автоматично е зададен по подразбиране. Моля, изберете нов формат и кликнете върху „Запазване“, за да премахнете това съобщение.',

    'ERR_CANNOT_CREATE_RESTORE_FILE' => 'Грешка: Невъзможно е да се създаде файл за възстановяване',
    ...
    'HEARTBEAT_MESSAGE' => "<BR>Механизмът позволява да се направи проверка дали има актуализации на Вашата текуща версия на SuiteCRM.",
    ...
    'LBL_BACKUP_DIRECTORY_WRITABLE' => 'SuiteCRM трябва да има права за писане',
    ...
    'LBL_BACKUP_INSTRUCTIONS_1' => 'От тук можете да създавате резервни копия на системните файлове на SuiteCRM. За възстановяване на функционалността на SuiteCRM при евентуални сривове е необходимо да разполагате и с резервно копие на базата данни на системата. За повече информация как да създадете резервно копие на базата данни трябва да се запознаете с документацията на сървъра за бази данни',
    'LBL_BACKUP_INSTRUCTIONS_2' => 'За да създадете резервно копие на системните файлове на SuiteCRM, въведете следната информация:',
    ...
    'LBL_CALENDAR_SYNC_NEVER' => 'Никога',
    'LBL_CALENDAR_SYNC_ACTIVE' => 'Активирано',
    'LBL_CALENDAR_SYNC_INACTIVE' => 'Забранени модули',
    ...
    'LBL_CALENDAR_SYNC_INTERVAL_15MIN' => 'На всеки 15 минути',
    'LBL_CALENDAR_SYNC_INTERVAL_30MIN' => 'На всеки 30 минути',
    'LBL_CALENDAR_SYNC_INTERVAL_1HOUR' => 'На всеки час',
    ...
    'LBL_CONNECTOR_SETTINGS' => 'Връзки със социални мрежи',
    ...
    'LBL_LDAP_HELP_TXT' => 'Когато LDAP идентификацията е разрешена, паролите могат да се обработват чрез LDAP. Нито едни от останалите настройки на SuiteCRM за управление на паролите няма да се прилага.',
    ...
    'LBL_PASSWORD_SYST_GENERATED_PWD_HELP' => 'Когато тази функция е активирана, потребителите ще получат по електронна поща системно генерираните пароли за достъп. Изискването за тази функция е: 1) Smtp сървърът за изходяща електронна поща трябва да бъде конфигуриран правилно в секция Настройки на електронна поща, и 2) потребителите трябва да имат валидни адреси за електронна поща в техните профили',
    'LBL_PASSWORD_EXP_AFTER' => 'След',
    'LBL_PASSWORD_FORGOT_FEATURE' => 'Функцията за забравена парола е активирана',
    'LBL_PASSWORD_FORGOT_FEATURE_HELP' => 'При разрешена функция, потребителите ще могат да заявят нова парола за достъп до системата от началната страница. Потребителите трябва: 1) да имат валидни адреси за електронна поща в техните профили, и 2) сървърът за изходяща електронна поща да е конфигуриран в секция Настройка на електронна поща.',
    ...
    'LBL_STUDIO' => 'Студио',
    'LBL_SUITE_SCHEDULER_TITLE' => 'Автоматизирани задачи',
    'LBL_SUITE_SCHEDULER' => 'Настройка на автоматизирани задачи',
    ...
    'LBL_SUITEFEED_SETTINGS_DESC' => 'Разрешете потребителските новини и изберете модули за публикация',
    'LBL_UPDATE_CHECK_TYPE' => '<B>Автоматична проверка за актуализации</B> - при маркиране на опцията, сървърът на системата периодично ще проверява дали има актуализации на Вашата текуща версия на SuiteCRM.',
    ...
    'LBL_UW_DESC_MODULES_INSTALLED' => 'Следните разширения на SuiteCRM са инсталирани в системата:',
    'LBL_UW_DESC_MODULES_QUEUED' => 'Следните модули са готови за инсталиране:',
    ...
    'LBL_SAML_LOGIN_URL' => 'Вход URL', //SAML Authentication
    ...
    'LBL_AOP_EMAIL_SETTINGS' => 'Настройки на електронна поща',
    ...
    'LBL_AOP_ADD_STATUS' => 'Добави',
    'LBL_AOP_REMOVE_STATUS' => 'Изтрий',
    ...
    'LBL_BUSINESS_HOURS_FROM' => 'Подател',
    ...
    'LBL_ELASTIC_SEARCH_GENERAL' => 'Базови настройки',
    ...
    'LBL_ELASTIC_SEARCH_USER' => 'Потребителско име',
    'LBL_ELASTIC_SEARCH_PASS' => 'Парола',
    'LBL_ELASTIC_SEARCH_SCHEDULERS' => 'Автоматизирани задачи',
    ...
    'LBL_SEARCH_GENERAL' => 'Базови настройки',

    'LBL_SEARCH_MODULES' => 'Search Modules',
    'LBL_SEARCH_MODULES_HELP' => 'Поставете всеки от модулите в съответната колона, в зависимост от това дали искате опцията Глобално търсене да се прилага за него или не.',
