...
$mod_strings = array(
    ...
    'LBL_AN_ACCOUNTS_ACCOUNT_NAME' => 'Navn',
    ...
    'LBL_AN_LEADS_ASSIGNED_USER' => 'Tildelt bruker',
    'LBL_AN_LEADS_STATUS' => 'Status',
    'LBL_AN_LEADS_LEAD_SOURCE' => 'Kilde',
    'LBL_AN_LEADS_CAMPAIGN_NAME' => 'Kampanje navn',
    'LBL_AN_LEADS_YEAR' => 'År',
    'LBL_AN_LEADS_QUARTER' => 'Kvartal',
    'LBL_AN_LEADS_MONTH' => 'Måned',
    'LBL_AN_LEADS_WEEK' => 'Uke',
    'LBL_AN_LEADS_DAY' => 'Dag',

    //Analytics labels for sales pivot
    'LBL_AN_SALES_ACCOUNT_NAME' => 'Navn på Kunde',
    'LBL_AN_SALES_OPPORTUNITY_NAME' => 'Salgsmulighetens betegnelse',
    'LBL_AN_SALES_ASSIGNED_USER' => 'Tildelt bruker',
    'LBL_AN_SALES_OPPORTUNITY_TYPE' => 'OpportunityType',
    'LBL_AN_SALES_LEAD_SOURCE' => 'Kilde',
    'LBL_AN_SALES_AMOUNT' => 'Beløp',
    'LBL_AN_SALES_STAGE' => 'Salgsfase',
    ...
    'LBL_AN_SALES_CAMPAIGN' => 'Kampanje',

    //Analytics labels for service pivot
    'LBL_AN_SERVICE_ACCOUNT_NAME' => 'Navn på Kunde',
    'LBL_AN_SERVICE_STATE' => 'Fylke:',
    ...
    'LBL_AN_SERVICE_CONTACT_NAME' => 'Kontaktens navn',
    'LBL_AN_SERVICE_ASSIGNED_TO' => 'Tildelt bruker',

    //Analytics labels for the activities pivot
    'LBL_AN_ACTIVITIES_TYPE' => 'Type',
    'LBL_AN_ACTIVITIES_NAME' => 'Navn',
    'LBL_AN_ACTIVITIES_STATUS' => 'Status',
    'LBL_AN_ACTIVITIES_ASSIGNED_TO' => 'Tildelt bruker',

    //Analytics labels for the marketing pivot
    'LBL_AN_MARKETING_STATUS' => 'Status',
    'LBL_AN_MARKETING_TYPE' => 'Type',
    'LBL_AN_MARKETING_BUDGET' => 'Budsjett',
    'LBL_AN_MARKETING_EXPECTED_COST' => 'Expected Cost',
    'LBL_AN_MARKETING_EXPECTED_REVENUE' => 'Forventede inntekter',
    'LBL_AN_MARKETING_OPPORTUNITY_NAME' => 'Salgsmulighetens betegnelse',
    'LBL_AN_MARKETING_OPPORTUNITY_AMOUNT' => 'Forcasted beløp',
    ...
    'LBL_AN_MARKETING_ACCOUNT_NAME' => 'Navn på Kunde',

    //Analytics labels for the marketing activities pivot
    'LBL_AN_MARKETINGACTIVITY_CAMPAIGN_NAME' => 'Kampanje navn',
    'LBL_AN_MARKETINGACTIVITY_ACTIVITY_DATE' => 'Aktivitetsdato',
    'LBL_AN_MARKETINGACTIVITY_ACTIVITY_TYPE' => 'Aktivitetstype',
    'LBL_AN_MARKETINGACTIVITY_RELATED_TYPE' => 'Beslektet type',
    'LBL_AN_MARKETINGACTIVITY_RELATED_ID' => 'Related ID',

    //Analytics labels for the quotes pivot
    'LBL_AN_QUOTES_OPPORTUNITY_NAME' => 'Salgsmulighetens betegnelse',
    ...
    'LBL_AN_QUOTES_ACCOUNT_NAME' => 'Navn på Kunde',
    'LBL_AN_QUOTES_CONTACT_NAME' => 'Kontaktens navn',
    'LBL_AN_QUOTES_ITEM_NAME' => 'Objektnavn',
    ...
    'LBL_AN_QUOTES_ITEM_DISCOUNT_AMOUNT' => 'Avslag',
    'LBL_AN_QUOTES_ITEM_TOTAL' => 'Item Total',
    'LBL_AN_QUOTES_GRAND_TOTAL' => 'Totalsum',
    'LBL_AN_QUOTES_ASSIGNED_TO' => 'Tildelt bruker',
    'LBL_AN_QUOTES_DATE_CREATED' => 'Dato opprettet',
