...
$mod_strings = array(
    ...
    'LBL_TASKS' => 'НАСТРОЙКИ', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
    'LBL_MEETINGS' => 'ВСТРЕЧИ', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
    'LBL_CALLS' => 'ЗВОНКИ', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
    ...
    'LBL_NOTES' => 'ПРИМЕЧАНИЯ', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
    'LBL_PRINT' => 'ПЕЧАТЬ', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
    'LBL_MEETING_TYPE' => 'Встреча',
    'LBL_CALL_TYPE' => 'Звонок',
    'LBL_EMAIL_TYPE' => 'Отправить E-mail',
