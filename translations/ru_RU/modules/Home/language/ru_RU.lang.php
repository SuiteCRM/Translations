...
$mod_strings = array(
    ...
    'LNK_NEW_SEND_EMAIL' => 'Новое письмо',
...
//ABOUT page
    ...
    'LBL_BASIC_SEARCH' => 'Быстрый фильтр' /*for 508 compliance fix*/,
    ...
    'LBL_ELASTIC_SEARCH_EXCEPTION_NO_NODES_AVAILABLE' => 'Не удалось подключиться к серверу Elasticsearch.',
    'LBL_ELASTIC_SEARCH_EXCEPTION_SEARCH' => 'Произошла внутренняя ошибка поиска.',
    'LBL_ELASTIC_SEARCH_EXCEPTION_DEFAULT' => 'При поиске произошла неизвестная ошибка.',
