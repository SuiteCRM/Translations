...
$mod_strings = array(
    ...
    'LBL_BACKUP_CONFIRM' => 'Подтверждение параметров',
    ...
    'LBL_CALENDAR_SYNC_ACTIVE' => 'Доступен',
    'LBL_CALENDAR_SYNC_INACTIVE' => 'Заблокирован',
    ...
    'LBL_CONFIGURE_TABS_AND_SUBPANELS' => 'Отображение закладок модулей и субпанелей',
...
Последняя попытка подключения @ ',
    ...
    'LBL_EMAIL_TITLE' => 'Отправить E-mail',
    ...
    'LBL_HELP_EMAIL' => 'Отправить E-mail',
    'LBL_HELP_PRINT' => 'Печатать...',
    ...
    'LBL_MANAGE_EXTERNAL_OAUTH_CONNECTIONS' => 'Внешние OAuth соединения',
    'LBL_MANAGE_EXTERNAL_OAUTH_CONNECTIONS_DESC' => 'Настройка внешних OAuth соединений',
    ...
    'LBL_UW_BTN_UPLOAD' => 'Загрузка',
    'LBL_UW_CHECK_ALL' => 'Проверить все',
    'LBL_UW_DESC_MODULES_INSTALLED' => 'Модули, установленные в систему:',
    'LBL_UW_DESC_MODULES_QUEUED' => 'Следующие Обновления локально поставлены в очередь для установки:',
    ...
    'LBL_CANNOT_DISABLE_CURRENT_LANGUAGE' => 'Активно использующийся язык не может быть отключен. Пожалуйста, измените на другой язык, чтобы отключить его.',
    ...
    'LBL_MODULE_ADMIN' => 'Настройки модуля',
    'LBL_MODULE_ADMIN_HEADER_DESC' => 'Настроить особенности и настройки модуля',
    'LBL_AOP_ADMIN_MANAGE_AOP' => 'Расширенные настройки OpenPortal',
    'LBL_AOP_ENABLE_AOP' => 'Включить AOP',
    ...
    'LBL_AOP_BUSINESS_HOURS_DESC' => "Ограничьте рабочие процессы 'Только в планировщике' для запуска только в определенные дни и время",
    ...
    'LBL_AOP_SETTINGS' => 'Расширенные настройки OpenPortal',
    ...
    'LBL_AOS_ADMIN_MANAGE_AOS' => 'Расширенные настройки OpenSales',
    ...
    'LBL_AOS_SETTINGS' => 'Расширенные настройки OpenSales',
    'LBL_AOS_DAYS' => 'дней',
    'LBL_CHANGE_SETTINGS' => 'Изменить настройки Продвинутый OpenSales',
    'LBL_CHANGE_SETTINGS_AOD' => 'Изменить настройки Продвинутый OpenDiscovery',
    'LBL_CHANGE_SETTINGS_AOP' => 'Изменить настройки Продвинутый OpenSales',
    ...
    'LBL_ELASTIC_SEARCH_SETTINGS_DESC' => 'Настроить предпочтения Elasticsearch',
    'LBL_ELASTIC_SEARCH_SETTINGS_HELP' => 'Для работы Elasticsearch требуется внешний сервер, настроенный для работы. Прочтите <a href="https://docs.suitecrm.com/admin/administration-panel/search/elasticsearch/">документацию</a> чтобы узнать больше.',
    ...
    'LBL_ELASTIC_SEARCH_TEST_CONNECTION_ERROR' => 'Не удалось выполнить запрос ping.',
    ...
    'LBL_ELASTIC_SEARCH_SCHEDULERS_HELP' => 'Были обнаружены следующие планировщики ElasticSearch:',
    ...
    'LBL_ELASTIC_SEARCH_SCHEDULERS_DESC' => 'Модуль ElasticSearch использует планировщики для синхронизации базы данных и механизма индексирования.',
    ...
    'LBL_ELASTIC_SEARCH_INDEX_SCHEDULE_FULL_SUCCESS' => 'Запланирована полная индексация, которая начнется в ближайшие 60 секунд. Результаты поиска могут быть несовместимыми до завершения процесса.',
    ...
    'LBL_SEARCH_WRAPPER_ENGINES' => 'Поисковые системы',
    'LBL_BASIC_SEARCH_ENGINE' => 'Базовый поиск',
    'LBL_BASIC_AND_AOD_ENGINE' => 'Базовый + расширенный поиск',
    'LBL_ELASTIC_SEARCH_ENGINE' => 'Механизм Elasticsearch',
    'LBL_SIMPLE_SQL_SEARCH_ENGINE' => 'Простая поисковая система SQL',

    // SearchWrapper Settings
    'LBL_PDF_HEADER' => 'Настройки PDF',
    'LBL_CHANGE_PDF_SETTINGS' => 'Изменить настройки PDF',
    'LBL_PDF_HEADER_DESC' => 'Управляйте своими предпочтениями PDF',
    'LBL_PDF_OPTIONS' => 'PDF Механизм',
    'LBL_PDF_OPTIONS_HELP' => 'Выберите механизм PDF, который пользователи смогут использовать.',
    'LBL_PDF_INTERFACE' => 'PDF интерфейс',

    // PDF Engines Translations
    'LBL_PDF_WRAPPER_ENGINES' => 'PDF Механизмы',
    'LBL_MPDF_ENGINE' => 'MPDF Механизм',

    // Ajax Submit
    'LBL_AJAX_SUBMIT_FAIL' => 'При сохранении настроек произошла ошибка.',

    'LBL_ADMIN_TOOLS_TITLE' => 'Инструменты администратора',
    'LBL_ADMIN_TOOLS_HEADER_DESC' => 'Восстановите, обновите и запустите диагностику вашего экземпляра SuiteCRM',
    'LBL_WORKFLOW_MANAGER' => 'Менеджер рабочего процесса',
    'LBL_WORKFLOW_MANAGER_DESC' => 'Управление, добавление, удаление или изменение рабочих процессов',


    'LBL_WARNING' => 'Предупреждение',
    'LBL_ERROR' => 'Ошибка',
    'LBL_SUBMIT' => 'Отправить',
    'LBL_REPAIR_UTF_ENCODING' => 'Восстановить кодировку UTF',
    'LBL_REPAIR_UTF_ENCODING_DESC' => 'Исправить записи с неправильным кодированием UTF-символов',
    'LBL_REPAIR_UTF_ENCODING_DATA_WARNING' => 'Данные о таблицах будут обновлены.',
    'LBL_REPAIR_UTF_ENCODING_BACKUP_WARNING' => 'Пожалуйста, не забудьте сделать резервную копию базы данных перед выполнением этого действия.',
    'LBL_REPAIR_UTF_ENCODING_SYNC_WARNING' => 'По умолчанию это действие добавляет задание в очередь. Задание будет проводить нормализацию записей по нескольку штук за раз. Требуется соответствующая настройка сервиса cron.',
    'LBL_REPAIR_UTF_ENCODING_ASYNC_WARNING' => 'Выполняется в асинхронном режиме. Задача должна уже находиться в очереди. Она будет проводить нормализацию записей по нескольку штук за раз. Требуется соответствующая настройка сервиса cron.',
    'LBL_REPAIR_UTF_ENCODING_ASYNC_PROGRESS_CHECK' => "Для получения информации о процессе обработки найдите задачу в таблице job_queue с названием 'repair utf encoding' ",
    'LBL_REPAIR_UTF_ENCODING_SYNC_PROGRESS_CHECK' => "Запуск в синхронизированном режиме. Действие будет выполняться некоторое время. Информации о процессе выполнения находится в журнале SuiteCRM. Доступ к журналу осуществляется при помощи '[utf-normalize]'",
    'LBL_KEEP_TRACKING_TABLES' => 'Сохранять таблицы отслеживания',
    'LBL_REPAIR_FROM_DATE' => 'Восстанавливать с',
    'LBL_REPAIR_UTF_ENCODING_REPAIR_FROM_INVALID' => 'Недопустимое значение поля "Восстанавливать с"',
    'LBL_SYNC_RUN' => 'Запускать восстановление в синхронном режиме?',
    'LBL_SYNC_RUNNING' => 'Выполняется в синхронном режиме',
    'LBL_SYNC_RUNNING_INFORMATION_OUTPUT' => 'Не уходите с этой страницы. Информация о результате будет показана здесь позже.',
    'LBL_SYNC_RUNNING_INFORMATION_LOGS' => "Вы также можете посмотреть дополнительную информацию в журналах SuiteCRM. Доступ к журналу осуществляется при помощи '[utf-normalize]'",
    'LBL_SYNC_LONG_EXECUTION_WARNING' => 'Это действие займет некоторое время.',
    'LBL_SYNC_RUN_DESC' => 'Установите флажок, если хотите запустить выполнение в синхронизированном режиме. Действие займет некоторое время. Информация о процессе выполнения находится в журналах SuiteCRM. Доступ к журналам осуществляется при помощи \'[utf-normalize]\'',
    'LBL_NORMALIZE_SUCCESS' => 'Нормализация записей успешно выполнена',
    'LBL_NORMALIZE_FAILURE' => 'Произошла ошибка при выполнении нормализации записей',
    'LBL_EXECUTION_STATUS' => 'Состояние исполнения',
    'LBL_EXECUTION_MODE' => 'Режим исполнения',
    'LBL_IN_PROGRESS' => 'В процессе...',
    'LBL_REPAIRED' => 'Восстановлено',
