...
Последняя попытка подключения @ ',
    ...
    // Google Calendar
    'LBL_GOOGLE_AUTH_TITLE' => 'Настройки Google Sync',
    'LBL_GOOGLE_CALENDAR_SETTINGS_TITLE' => 'Настройки календаря Google',
    'LBL_GOOGLE_CALENDAR_SETTINGS_DESC' => 'Параметры конфигурации для настройки вашего Календаря Google',
    'LBL_GOOGLE_CALENDAR_SETTINGS_JSON' => 'Загрузить файл учетных данных Google API',
    'LBL_GOOGLE_CALENDAR_SETTINGS_JSON_HELP' => 'Загрузите файл учетных данных JSON, который вы скачали из Google Developers Console.',
    'LBL_GOOGLE_CALENDAR_GET_API_KEY' => 'Получить учетные данные API',
