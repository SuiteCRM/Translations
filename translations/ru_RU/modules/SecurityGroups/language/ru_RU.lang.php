...
$mod_strings = array(
    ...
    'LNK_LIST' => 'Форма списка',
    'LBL_SEARCH_FORM_TITLE' => 'Управление группами безопасности поиска',
    ...
    'LBL_CONFIRM_END' => ' выбранных записей?',
    ...
    'LBL_ERROR_EXPORT_WHERE_CHANGED' => 'Ошибка обновления, так как фильтр поиска был изменен. Пожалуйста, попробуйте еще раз.',
