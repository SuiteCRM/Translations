...
$mod_strings = array(
    ...
    'LBL_AN_LEADS_ASSIGNED_USER' => 'Назначенный пользователь',
    'LBL_AN_LEADS_STATUS' => 'Статус',
    'LBL_AN_LEADS_LEAD_SOURCE' => 'Источник предварительных контактов',
    'LBL_AN_LEADS_CAMPAIGN_NAME' => 'Название маркет. кампании',
    ...
    'LBL_AN_SALES_OPPORTUNITY_NAME' => 'Название сделки',
    'LBL_AN_SALES_ASSIGNED_USER' => 'Назначенный пользователь',
    'LBL_AN_SALES_OPPORTUNITY_TYPE' => 'OpportunityType',
    'LBL_AN_SALES_LEAD_SOURCE' => 'Источник предварительных контактов',
    ...
    'LBL_AN_SALES_CAMPAIGN' => 'Маркетинг',
    ...
    'LBL_AN_SERVICE_CONTACT_NAME' => 'Контактное лицо',
    'LBL_AN_SERVICE_ASSIGNED_TO' => 'Назначенный пользователь',

    //Analytics labels for the activities pivot
    'LBL_AN_ACTIVITIES_TYPE' => 'Тип',
    'LBL_AN_ACTIVITIES_NAME' => 'Название',
    'LBL_AN_ACTIVITIES_STATUS' => 'Статус',
    'LBL_AN_ACTIVITIES_ASSIGNED_TO' => 'Назначенный пользователь',
    ...
    'LBL_AN_MARKETING_OPPORTUNITY_NAME' => 'Название сделки',
    ...
    'LBL_AN_MARKETINGACTIVITY_CAMPAIGN_NAME' => 'Название маркет. кампании',
    'LBL_AN_MARKETINGACTIVITY_ACTIVITY_DATE' => 'Дата',
    'LBL_AN_MARKETINGACTIVITY_ACTIVITY_TYPE' => 'Состояние',
    'LBL_AN_MARKETINGACTIVITY_RELATED_TYPE' => 'Родительский тип',
    'LBL_AN_MARKETINGACTIVITY_RELATED_ID' => 'Related ID',

    //Analytics labels for the quotes pivot
    'LBL_AN_QUOTES_OPPORTUNITY_NAME' => 'Название сделки',
    ...
    'LBL_AN_QUOTES_CONTACT_NAME' => 'Контактное лицо',
    'LBL_AN_QUOTES_ITEM_NAME' => 'Ключ',
    ...
    'LBL_AN_QUOTES_ITEM_DISCOUNT_AMOUNT' => 'Объём скидки',
    'LBL_AN_QUOTES_ITEM_TOTAL' => 'Item Total',
    'LBL_AN_QUOTES_GRAND_TOTAL' => 'ВСЕГО К ОПЛАТЕ',
    'LBL_AN_QUOTES_ASSIGNED_TO' => 'Назначенный пользователь',
