...
$mod_strings = array(
    ...
    'ERR_UW_CONFIG_WRITE' => 'Ошибка при добавлении в файл config.php информации о новой версии.',
    ...
    'LBL_BUTTON_CANCEL' => 'Отказаться',
    'LBL_BUTTON_DELETE' => 'Удалить пакет',
    'LBL_BUTTON_DONE' => 'Готово',
    'LBL_BUTTON_EXIT' => 'Завершить',
    ...
    'LBL_UW_TITLE_CANCEL' => 'Отказаться',
    ...
    'LBL_UW_TITLE_START' => 'Дoбрo пoжалoвать',
    ...
    'ERROR_SUITECRM_VERSION_INCOMPATIBLE' => 'Загружаемый файл не совместим с установленной версией SuiteCRM: ',
    'LBL_LANGPACKS' => 'Языковые пакеты' /*for 508 compliance fix*/,
    'LBL_MODULELOADER' => 'Загрузчик модулей' /*for 508 compliance fix*/,
    'LBL_PATCHUPGRADES' => 'Обновления' /*for 508 compliance fix*/,
    ...
    'LBL_PASSWORD_EXPIRATON_CHANGED' => 'Предупреждение: срок действия пароля не установлен!',
    'LBL_PASSWORD_EXPIRATON_REDIRECT' => 'Пожалуйста, обновите настройки здесь',
);
