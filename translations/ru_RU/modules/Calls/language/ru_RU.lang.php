...
$mod_strings = array(
    ...
    'LBL_HISTORY_SUBPANEL_TITLE' => 'Описание',
    'LBL_LIST_ASSIGNED_TO_NAME' => 'Ответственное лицо',
    ...
    'LBL_CALL_INFORMATION' => 'Основная информация', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
    'LBL_REMOVE' => 'Удалить',
    ...
    'LBL_REMINDERS_POPUP' => 'Во всплывающем окне',
