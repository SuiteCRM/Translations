...
//e.g. auf Deutsch 'Contacts'=>'Contakten',
    ...
    'moduleList' => array(
        ...
        'ACLRoles' => 'Роли',
        'InboundEmail' => 'Учётные записи исходящей почты',
        'Releases' => 'Версии',
        'Prospects' => 'Адресаты',
        'Queues' => 'Очереди',
...
//       it is the key for the default case_relationship_type_dom value
    ...
    'snooze_alert_timer' => array(
        60 => 'Отложить на 1 минуту',
        300 => 'Отложить на 5 минут',
        600 => 'Отложить на 10 минут',
        900 => 'Отложить на 15 минут',
        1800 => 'Отложить на 30 минут',
        3600 => 'Отложить на 1 час',
        7200 => 'Отложить на 2 часа',
        10800 => 'Отложить на 3 часа',
        18000 => 'Отложить на 5 часов',
        86400 => 'Отложить на 1 день',
    ),
    ...
    'dom_email_body_filtering_option' => [
      'multi' => 'Поиск по нескольким словам',
      'single' => 'Поиск по одному слову',
    ],
...
//prospect list type dom
    ...
    'campainglog_activity_type_dom' => array(
        ...
        'link' => 'Адресаты, перешедшие по ссылкам в полученном сообщении',
        'viewed' => 'Просмотренные сообщения',
        'removed' => 'Адресаты, отписавшиеся от рассылки',
        'lead' => 'Созданные предварительные контакты',
    ...
    'custom_fields_merge_dup_dom' => array(
        ...
        1 => 'Доступен',
        2 => 'Фильтры',
        3 => 'Выбранный фильтр по умолчанию',
        4 => 'Only filter',
    ),
...
$app_strings = array(
    'LBL_SEARCH_RESULTS_TITLE' => 'Результат',
    ...
    'LBL_LOGOUT' => 'Выход',
    'LBL_LOGOUT_SUCCESS' => 'Выход выполнен успешно',
    'LBL_LOGGED_OUT_MESSAGE' => 'Вы вышли из системы',
    'LBL_LOGIN_AGAIN' => 'Войти снова ',
    'LBL_TOUR_NEXT' => 'Вперёд',
    ...
    'LBL_DELETE_INLINE' => 'Удаление', /*for 508 compliance fix*/
    ...
    'LBL_EMAIL_WARNING_MISSING_CREDS' => 'Предупреждение: Отсутствуют учетные данные',
    ...
    'LBL_EMAIL_SELECT' => 'Обзор',

    'LBL_EMAIL_SEND' => 'Отправить',
    'LBL_EMAIL_SENDING_EMAIL' => 'Отправка E-mail',

    'LBL_EMAIL_SETTINGS' => 'Настройка календаря',
    'LBL_EMAIL_SETTINGS_TITLE' => 'Настройка E-mail',
    'LBL_EMAIL_SETTINGS_ACCOUNTS' => 'Учётные записи электронной почты',
    ...
    'LBL_EMAIL_YES' => 'Да',
    'LBL_EMAIL_TEST_OUTBOUND_SETTINGS' => 'Тестирование',
    ...
    'ERR_UNAUTHORIZED_PAGE_ACCESS' => 'У вас нет прав для просмотра этой страницы. Пожалуйста, обратитесь к системному администратору.',
    'ERR_UNAUTHORIZED_PAGE_ACCESS_TO_HOME_PAGE' => 'Вы не авторизованы для просмотра этой страницы. Перенаправление на главную страницу...',
    ...
    'LBL_QUICK_CHARTS' => 'Быстрые диаграммы',
    'LBL_QUICK_HISTORY' => 'Ресурсы',
    ...
    'LBL_OPEN_ITEMS' => 'Открыть элементы',
    ...
    'LBL_LOG_ENTRIES_REMOVED_TITLE' => 'Кол-во отписок',
    'LBL_LOG_ENTRIES_LEAD_TITLE' => 'Созданные предв. контакты',
    ...
    'LBL_DISMISS' => 'Отклонить',
    'LBL_DISMISS_INLINE_CONFIRM' => 'Отклонить?',
    'LBL_DISMISS_ALL_INLINE_CONFIRM' => 'Отклонить все?',
    'LBL_DISMISS_ALL_DRAFTS_CONFIRM' => 'Dismiss all drafts?',
    'NTC_DISMISS_CONFIRMATION' => 'Вы уверены, что хотите отменить это оповещение?',
    'NTC_DISMISS_ALL_CONFIRMATION' => 'Вы уверены, что хотите отменить все оповещения?',
    'LBL_ALERT_DISMISS_SUCCESS' => 'Оповещение успешно отклонено',
    'LBL_ALERT_DISMISS_ERROR' => 'Ошибка при попытке отклонить оповещение',
    'LBL_ALERT_DISMISS_ALL_SUCCESS' => 'Оповещения успешно отклонены',
    'LBL_DISMISS_ALL' => 'Отклонить все',
    'LBL_DISMISS_SUCCESS' => 'Successfully Dismissed',
    'LBL_VERIFY' => 'Проверить',
    'LBL_RESEND' => 'Отправить заново',
    'LBL_RECORD_DOES_NOT_EXIST' => 'Ошибка получения записи. Вероятно, эта запись была удалена или у вас недостаточно прав для её просмотра.',
    'LBL_PROFILE' => 'Профиль',
    'LBL_PROFILE_EDIT' => 'Редактировать профиль',
    ...
    'LBL_TRAINING' => 'Форум сообщества',
    'ERR_MSSQL_DB_CONTEXT' => 'Состояние БД изменилось:',
    'ERR_MSSQL_WARNING' => 'Предупреждение:',
    ...
    'LBL_DASHLET_CONFIGURE_TITLE' => 'Статья',
...
5. Из меню модуля запустите процесс импорта и выберите только что сохранённый файл в качестве источника данных для загрузки
   ...
   ',
    ...
    'ERR_NOTIFICATIONS_MARK_AS_READ' => 'Ошибка при попытке пометить уведомления как прочитанные',
    'ERR_FIELD_LOGIC_BACKEND_CALCULATION' => 'Ошибка при попытке получить значение',
    ...
    'LBL_BULK_ACTION_BUTTON_LABEL' => 'Массовые действия',
    'LBL_BULK_ACTION_BUTTON_LABEL_MOBILE' => 'Действие',
    'LBL_TOO_FEW_SELECTED' => 'Выбрано недопустимое количество записей. Вы должны выбрать минимум {min} записей.',
    'LBL_TOO_MANY_SELECTED' => 'Выбрано недопустимое количество записей. Вы должны выбрать максимум {max} записей.',
    'LBL_SELECT_ALL_NOT_ALLOWED' => 'Выделение всех записей недоступно для этого действия. Пожалуйста, выберите отдельные записи.',
    'LBL_MISSING_HANDLER_DATA' => 'Непредвиденная ошибка. Отсутствуют данные для обработки массовых действий из ответа',
    'LBL_MISSING_HANDLER' => 'Непредвиденная ошибка. Не определён обработчик для массового действия',
    'LBL_MISSING_HANDLER_DATA_ROUTE' => 'Неожиданная ошибка. Отсутствует маршрут для массового действия',
    'LBL_ACTION_ERROR' => 'Непредвиденная ошибка при вызове действия',
    'LBL_BULK_ACTION_ERROR' => 'Непредвиденная ошибка при вызове массовых действий',
    'LBL_BULK_ACTION_DELETE_SUCCESS' => 'Записи успешно удалены',
    'LBL_BULK_ACTION_MASS_UPDATE_CONFIRMATION' => 'Вы уверены, что хотите удалить выбранные записи?',
    'LBL_BULK_ACTION_MASS_UPDATE_SUCCESS' => 'Все записи успешно обновлены',
    'LBL_BULK_ACTION_MASS_UPDATE_PARTIAL_SUCCESS' => 'Частичный успех. Некоторые записи не были обновлены. Пожалуйста, проверьте логи',
    ...
    'LBL_BULK_ACTION_MASS_UPDATE_NO_ACLS' => 'Невозможно сохранить. Недостаточно прав доступа',
    'LBL_UNEXPECTED_ERROR' => 'Непредвиденная ошибка. Действие невозможно.',
    ...
    'LBL_ERROR_SAVING' => 'Произошла ошибка при сохранении записи',
    ...
    'LEADS_BY_SOURCE' => 'Предварительные контакты по источникам',
    'LEADS_BY_STATUS' => 'Предварительные обращения по статусу',
    ...
    'LBL_COLUMN_SELECTOR_DISPLAYED_COLS' => 'ОТОБРАЖАЕТСЯ',
    'LBL_COLUMN_SELECTOR_HIDDEN_COLS' => 'СКРЫТЫЙ',
    'LBL_COLUMN_SELECTOR_CLOSE_BUTTON' => 'Закрытие',
    'LBL_COLUMN_SELECTOR_SAVE_BUTTON' => 'Сохранить изменения',
    'LBL_COLUMN_SELECTOR_MODAL_TITLE' => 'Выберите столбцы',
...
//aop
$app_list_strings['case_state_default_key'] = 'Открыто';
...
$app_list_strings['moduleList']['ExternalOAuthConnection'] = 'Внешнее OAuth соединение';
...
$app_strings['LBL_SUITE_DASHBOARD'] = 'ДОСКА SUITECRM';
...
$app_strings['LBL_OPT_OUT'] = 'Отказаться';
$app_strings['LBL_INVALID_EMAIL'] = 'Недействительно';
$app_strings['LBL_PRIMARY'] = 'Основной ';
$app_strings['LBL_EMAIL_ADDRESS'] = 'Адрес электронной почты';
...
$app_strings['LBL_INSIGHTS'] = 'Прогнозы';
$app_strings['LBL_CHARTS'] = 'Диаграммы';
$app_strings['LBL_CHART_NOT_FOUND'] = 'Диаграмма не найдена';
$app_strings['LBL_NO_DATA'] = 'Данные отсутствуют';
$app_strings['LBL_ERROR_FETCHING_METADATA'] = 'Произошла ошибка при получении метаданных';
$app_strings['LBL_TOTAL'] = 'Итоговая строка';
$app_strings['LBL_ACTIONS'] = 'Действия';
$app_strings['LBL_SELECT_SUBPANEL_BANNER'] = 'Выберите субпанели для просмотра';
$app_strings['LBL_SELECT_ITEM'] = 'Выберите элемент';
$app_strings['LBL_ITEMS_SELECTED'] = 'items selected';
$app_strings['LBL_WIDGET_NOT_FOUND'] = 'Виджет не найден';
$app_strings['LBL_BAD_CONFIG'] = 'Некорректная конфигурация';
$app_strings['LBL_CONFIG_BAD_CONTEXT'] = 'Неверная конфигурация: контекст неправильно настроен';
$app_strings['LBL_CONFIG_NO_CONFIG'] = 'Некорректная конфигурация: отсутствует конфигурация';
$app_strings['LBL_CONFIG_NO_STATISTICS_KEY'] = 'Некорректная конфигурация: отсутствует ключ статистики';
...
$app_strings['LBL_STATISTIC_ERROR_DESC_TOOLTIP'] = 'Ошибка загрузки статистики. Обратитесь к администратору';
$app_strings['LBL_AVERAGE_CLOSED_WON_PER_YEAR'] = 'Средняя вероятность победы в год';
$app_strings['LBL_OPPORTUNITIES_TOTAL'] = 'Общая стоимость сделки';
$app_strings['LBL_CASE_TOTAL_DAYS_OPEN'] = 'Открыто дней всего';
...
$app_strings['LBL_STAT_DAYS'] = 'Дней(дня)';
$app_strings['LBL_CLOSED_PER_YEAR'] = 'Закрыто за год';
$app_strings['LBL_WAS_OPEN'] = 'Это дело было открыто для';
$app_strings['LBL_HAS_BEEN_OPEN'] = 'Это дело открыто для';
$app_strings['LBL_NUMBER_OF_CASES_PER_ACCOUNT'] = 'Количество обращений на аккаунт';
$app_strings['LBL_TOTAL_CASES_FOR_THIS_ACCOUNT'] = 'Total Cases For This Account';
$app_strings['LBL_NONE_OUTSTANDING'] = 'Нет';
$app_strings['LBL_VALIDATION_ERROR_REQUIRED'] = 'Отсутствует обязательное поле: {{fields.field.label}}';
$app_strings['LBL_VALIDATION_ERROR_ATTACHMENT'] = 'File attachment(s) not valid.';
$app_strings['LBL_VALIDATION_ERROR_CURRENCY_FORMAT'] = "Неверный формат валюты. Ожидается: '{{context.expected}}'";
$app_strings['LBL_VALIDATION_ERROR_INT_FORMAT'] = "Неверный формат int. Ожидается: '{{context.expected}}'";
$app_strings['LBL_VALIDATION_ERROR_FLOAT_FORMAT'] = "Неверный формат с плавающей запятой. Ожидается: '{{context.expected}}'";
$app_strings['LBL_VALIDATION_ERROR_DATE_FORMAT'] = "Неверный формат даты. Ожидается: '{{context.expected}}'";
$app_strings['LBL_VALIDATION_ERROR_DATETIME_FORMAT'] = "Неверный формат даты и времени. Ожидается: '{{context.expected}}'";
...
$app_strings['LBL_VALIDATION_ERROR_EMAIL_FORMAT'] = "Неверный формат электронной почты. Ожидается: '{{context.expected}}'";
$app_strings['LBL_VALIDATION_ERROR_PHONE_FORMAT'] = "Неверный формат телефона.";
...
$app_strings['LBL_DUPLICATE_EMAIL_VALIDATION_ERROR'] = "Повторяющиеся адреса электронной почты не допускаются";
...
$app_strings['LBL_VALIDATION_ERRORS'] = 'Есть ошибки проверки, невозможно выполнить действие.';
...
$app_strings['LBL_TYPE_TO_SEARCH'] = 'Введите для поиска...';
$app_strings['LBL_SEARCHING'] = 'Поиск...';
$app_strings['LBL_NOT_FOUND'] = 'Не найден.';
$app_strings['LBL_SEARCH_ERROR'] = 'Ошибка поиска.';
$app_strings['LBL_FOUND'] = 'Найдено';
$app_strings['LBL_GET_RECORD_LIST_ERROR'] = 'Ошибка при получении записей';
...
$app_strings['LBL_CONTRACT_RENEWAL_TOOLTIP'] = 'Дата следующего продления контракта';
...
$app_strings['LBL_CAMPAIGN_LAST_RECEIVED_TOOLTIP'] = 'Дата самой последней полученной кампании';
...
$app_strings['LBL_QUOTES_EXPIRY_TOOLTIP'] = 'Дата следующего истечения котировки';
$app_strings['LBL_DEFAULT_TOTAL_TOOLTIP'] = 'Общее количество записей';
$app_strings['LBL_CONTRACT_RENEWAL'] = 'Дата продления';
$app_strings['LBL_INVOICES_OVERDUE'] = 'Всего просрочено';
$app_strings['LBL_ACTIVITIES_NEXT_DATE'] = 'Дата следующего мероприятия';
$app_strings['LBL_CAMPAIGN_LAST_RECEIVED'] = 'Последний раз участвовал';
$app_strings['LBL_OPEN_CASES_COUNT'] = 'Открытые обращения';
$app_strings['LBL_EVENTS_LAST_DATE'] = 'Последнее посещенное мероприятие';
$app_strings['LBL_HISTORY_LAST_DATE'] = 'Последняя точка соприкосновения';
$app_strings['LBL_OPPORTUNITIES_TOTAL_SUM'] = 'Общая стоимость';
$app_strings['LBL_QUOTES_EXPIRY'] = 'Дата следующего истечения срока';
$app_strings['LBL_DEFAULT_TOTAL'] = 'Итоговая строка';
...
$app_strings['LBL_CASE_UPDATE_SUBMITTED'] = 'Обновление обращения отправлено';
...
$app_strings['LBL_SAVED_FILTER_SAVED'] = 'Фильтр успешно сохранен';
$app_strings['LBL_FILTER_ID_NOT_DEFINED'] = 'ID фильтра не определен';
$app_strings['LBL_GENERIC_CONFIRMATION'] = 'Вы хотите продолжить действие?';
$app_strings['LBL_SHOW_MORE'] = 'Показать больше';
$app_strings['LBL_SHOW_LESS'] = 'Показать меньше';
$app_strings['LBL_LOAD_MORE'] = 'Загрузить ещё';
$app_strings['LBL_EMPTY'] = '-- Empty --';
$app_strings['LBL_OPERATOR'] = 'Оператор сравнения';
$app_strings['LBL_START'] = 'Начало';
$app_strings['LBL_END'] = 'Конец';
$app_strings['LBL_LINE_ITEMS_FIELD_CONFIG'] = 'Плохая конфигурация';


$app_strings['LBL_ACTION_SUCCESS'] = 'Действие выполнено успешно';
...
$app_strings['LBL_LINK'] = 'Ссылка';
$app_strings['LBL_LINK_UNLINK'] = 'Link / Unlink';
$app_strings['LBL_SAVE'] = 'Сохранить';
$app_strings['LBL_UNLINK_RECORD'] = 'Отменить связь с записью';
$app_strings['LBL_DELETE_RECORD'] = 'Delete Record';
$app_strings['LBL_EDIT_RECORD'] = 'Редактировать запись';
$app_strings['LBL_UNLINK_RELATIONSHIP_CONFIRM'] = 'Вы действительно хотите отменить связь с этой записью? Только отношения будут разорваны. Запись не будет удалена.';
$app_strings['LBL_UNLINK_RELATIONSHIP_SUCCESS'] = 'Запись успешно отключена.';
$app_strings['LBL_UNLINK_RELATIONSHIP_FAILED'] = 'При отмене связи с этой записью произошла ошибка.';
...
$app_strings['LBL_LINK_RELATIONSHIP_SUCCESS'] = 'Отношения установились успешно.';
$app_strings['LBL_LINK_RELATIONSHIP_FAILED'] = 'При связывании этого отношения произошла ошибка.';
$app_strings['LBL_MODULE_NOT_FOUND'] = 'Модуль не найден.';
$app_strings['LBL_RECORD_NOT_FOUND'] = 'Невозможно загрузить запись';
$app_strings['LBL_FILE_NOT_FOUND'] = 'Unable to load file';
$app_strings['LBL_RELATIONSHIP_LOAD_ERROR'] = 'Невозможно загрузить отношения';
$app_strings['LBL_NOT_LINKED'] = 'Невозможно отменить связь. Записи не связаны';
$app_strings['LBL_ACCESS_DENIED'] = 'В доступе отказано';
$app_strings['LBL_ADD_RECORDS_TO_TARGET_LIST_SUCCESS'] = 'Записи успешно добавлены в целевой список.';
$app_strings['LBL_ADD_RECORDS_TO_TARGET_LIST_FAILED'] = 'При добавлении записей в целевой список произошла ошибка.';
$app_strings['LBL_ADD_CONTACTS_TO_TARGET_LIST_SUCCESS'] = 'Контакты успешно добавлены в целевой список.';
$app_strings['LBL_ADD_CONTACTS_TO_TARGET_LIST_FAILED'] = 'При добавлении контактов в целевой список произошла ошибка.';
$app_strings['LBL_CHANGED_TO_TEXT'] = 'изменился на';
$app_strings['LBL_RECORD_CHANGED'] = 'Запись обновлена';
$app_strings['LBL_CREATE'] = "Создать";
$app_strings['LBL_USE_ADVANCED_SEARCH'] = 'Использовать расширенный поиск';
$app_strings['LBL_USE_BASIC_SEARCH'] = 'Использовать базовый поиск';
$app_strings['LBL_NO_MODULE_SELECTED'] = 'Модуль не выбран';
$app_strings['LBL_CLOSE_MENU'] = 'Закрыть меню';
$app_strings['LOGIN_INCORRECT'] = 'Неверный пароль. Пожалуйста, попробуйте снова.';
$app_strings['LOGIN_TOO_MANY_FAILED'] = 'Слишком много неудачных попыток входа. Пожалуйста, повторите позже.';

// PDF Engines
$app_strings['LBL_LEGACY_MPDF_ENGINE'] = 'Устаревший механизм MPDF';
$app_strings['LBL_TCPDF_ENGINE'] = 'Механизм TCPDF';


$app_strings['ERR_INVALID_FILE_NAME'] = 'Неверное имя файла';
$app_strings['LBL_LOGGER_VALID_FILENAME_CHARACTERS'] = 'Это может быть только буквенно-цифровые символы, плюс \'.\' , \'-\' и \'_\'';
$app_strings['LBL_LOGGER_INVALID_FILENAME'] = 'Неверное имя файла импорта';

$app_strings['LBL_PASSWORD_SET_NEW_VALUE_TO_RESET'] = 'Пароль установлен. Введите значение для установки нового пароля.';
$app_strings['LBL_VALUE_SET_PLACEHOLDER'] = 'Значение. Введите новое значение для изменения текущего.';

$app_strings['ERR_IMAP_OAUTH_CONNECTION_ERROR'] = 'Не удалось подключиться, используя OAuth логин, с сервером входящей почты. Для подключения: ';
$app_strings['WARN_OAUTH_TOKEN_SESSION_EXPIRED'] = 'Время IMAP OAuth сессии истекло. Пожалуйста, подключитесь снова: ';
...
$app_strings['LBL_OPTIONAL'] = 'Не обязательно';
$app_strings['LBL_OPTIONAL_CONNECTION_STRING'] = 'Необязательно. Используйте специальную строку подключения';
$app_strings['LBL_OUTBOUND_ACCOUNT'] = 'Учётная запись исходящей почты';
$app_strings['LBL_INBOUND_ACCOUNT'] = 'Учётная запись исходящей почты';
$app_strings['LBL_SYSTEM_ACCOUNT'] = 'Системные иконки';
$app_strings['LBL_FROM_SYSTEM'] = 'Отправить из системы';
$app_strings['LBL_SIGNATURE'] = 'Подпись';
$app_strings['LBL_NEW_NOTIFICATION'] = "У вас  {{context.unread}} новых уведомлений";
...
$app_strings['LBL_ALERT_STATUS_FAILED'] = 'Неудачно';
...
$app_strings['LBL_DEFAULT'] = 'Стандартная';
...
$app_strings['LBL_QUOTE'] = 'Предложение';
...
$app_strings['LBL_ATTACH_DOCUMENTS'] = 'Прикрепите документы';
