...
$mod_strings = array(
    ...
    'LBL_CLIENT' => 'Klient będący właścicielem zaplanowanego zadania',
    'LBL_PERCENT' => 'Procent wykonania',
// Errors
    'ERR_CALL' => "Nie można wywołać funkcji: %s",
    'ERR_CURL' => "Brak zainstalowanego modułu CURL - nie można uruchomić zadań URL",
    'ERR_FAILED' => "Nieoczekiwany błąd, proszę sprawdzić w logach PHP i suitecrm.log",
    ...
    'ERR_JOB_FAILED_VERBOSE' => 'Zadanie %1$s (%2$s) w CRON nie powiodło się',
);
