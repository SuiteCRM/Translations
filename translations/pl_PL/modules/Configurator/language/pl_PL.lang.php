...
$mod_strings = array(
    ...
    'LBL_LDAP_LEGACY_WARNING' => 'Ostrzeżenie LDAP',
    'LBL_LDAP_LEGACY_WARNING_MORE' => 'Ta konfiguracja LDAP będzie używana tylko do uwierzytelniania w API v4. Aby skonfigurować login SuiteCRM do korzystania z LDAP, dodaj wymagane konfiguracje do pliku .env.local. Więcej informacji znajdziesz w dokumentacji.',
    ...
    'LBL_LDAP_SERVER_HOSTNAME_DESC' => 'Przykład: ldap.example.com lub ldaps://ldap.example.com for SSL',
    ...
    'LBL_LIST_ENTRIES_PER_MODAL' => 'Popupy rekordów listy',
