...
$mod_strings = array(
    ...
    'LBL_MEETING_INFORMATION' => 'Thông tin Khách hàng', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
