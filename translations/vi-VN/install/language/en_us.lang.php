...
$mod_strings = array(
    ...
    'ERR_PERFORM_NO_TCPIP' => '<b>Chúng tôi không thể nhận biết kết nối Internet.</b>Khi bạn có kết nối, vui lòng truy cập <a href="https://www.suitecrm.com/"> https://www.suitecrm.com/</a> để đăng ký với SuiteCRM. Bằng cách cho chúng tôi biết một chút về cách công ty của bạn lên kế hoạch sử dụng SuiteCRM, chúng tôi có thể đảm bảo chúng tôi luôn cung cấp đúng ứng dụng cho nhu cầu kinh doanh của bạn.',
    ...
    'LBL_CRON_INSTRUCTIONS_3' => 'Bạn nên làm điều này chỉ sau khi tiến trình cài đặt được ký kết.',
    'LBL_CRON_CONFIGURATION' => 'CRON CONFIGURATION',
    'LBL_SETUP_CRONTAB' => 'Để thiết lập Crontab',
...
$contact_user_link_guid',
    ...
    'ERR_UPLOAD_FILE_UPLOAD_ERR_CANT_WRITE' => 'Ghi tệp vào đĩa không thành công.',
