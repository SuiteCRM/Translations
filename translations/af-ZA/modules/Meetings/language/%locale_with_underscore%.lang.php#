...
$mod_strings = array(
    ...
    'LBL_DATE' => 'Start Date:',
    'LBL_DEFAULT_SUBPANEL_TITLE' => 'Vergaderings',
    ...
    'LBL_MINSS_ABBREV' => 'm',
    'LBL_MODIFIED_BY' => 'Gewysig deur',
    'LBL_MODULE_NAME' => 'Vergaderings',
    ...
    'LBL_MEETING_INFORMATION' => 'Oorsig', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
