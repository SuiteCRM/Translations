...
$mod_strings = array(
    ...
    'ERR_UW_LOG_FILE_UNWRITABLE' => './upgradeWizard.log ei saa luua/kirjutada. Palun paranda õigused oma SuiteCRM kataloogis.',
    ...
    'ERR_UW_UPLOAD_ERR' => 'Viga faili üleslaadimisel, palun proovi uuesti!<br>' . PHP_EOL,
    'ERR_UW_VERSION' => 'SuiteCRM Süsteemi versioon: ',
    'ERR_UW_PHP_VERSION' => 'PHP versioon: ',
    'ERR_UW_SUITECRM_VERSION' => 'SuiteCRM Süsteemi versioon: ',
    'ERR_UW_WRONG_TYPE' => 'See leht pole käivitamiseks',
    'LBL_BUTTON_BACK' => '< Tagasi',
    'LBL_BUTTON_CANCEL' => 'Tühista',
    'LBL_BUTTON_DELETE' => 'Kustuta pakett',
    'LBL_BUTTON_DONE' => 'Tehtud',
    'LBL_BUTTON_EXIT' => 'Veri Yükleme Tamamlandı',
    ...
    'LBL_UW_COMMIT_ADD_TASK_OVERVIEW' => 'Palun kasutage ükskõik millist teile tuttavat meetodit nende failide mestimiseks. Seni kuni see valmib on teie SuiteCRM install ebakindlas olekus ja uuendamine puudulik.',
    ...
    'LBL_UW_COMPLIANCE_DB' => 'Minimaalne andmebaasi versioon',
    ...
    'LBL_UW_COMPLIANCE_PCRE_VERSION' => 'PCRE versioon',
    ...
    'LBL_UW_START_DESC' => 'See viisard aitab sul seda SuiteCRM osa uuendada.',
    ...
    'LBL_UW_TITLE' => 'Vaheta viisard võimsamaks',
    ...
    'ERROR_SUITECRM_VERSION_INCOMPATIBLE' => 'Üleslaetud fail ei ühildu selle SuiteCRM versiooniga:',
    'LBL_LANGPACKS' => 'Language Packs' /*for 508 compliance fix*/,
    'LBL_MODULELOADER' => 'Mooduli laadija' /*for 508 compliance fix*/,
    'LBL_PATCHUPGRADES' => 'Patch Upgrades' /*for 508 compliance fix*/,
    'LBL_THEMES' => 'Teemad:' /*for 508 compliance fix*/,
    'LBL_WORKFLOW' => 'Töövoog' /*for 508 compliance fix*/,
    'LBL_UPGRADE' => 'Täienda' /*for 508 compliance fix*/,
    ...
    'ERR_UW_PHP_FILE_ERRORS' => array(
        ...
        4 => 'Ühtegi faili ei laaditud üles.',
        5 => 'Unknown error.',
        6 => 'Ajutiste failide kaust puudub.',
        7 => 'Kettale kirjutamine ebaõnnestus.',
