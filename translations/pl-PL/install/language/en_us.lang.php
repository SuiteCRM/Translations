...
$mod_strings = array(
    ...
    'LBL_SYSOPTS_ERRS_TITLE' => 'Przed ropoczęciem napraw występujące błędy. :',
    ...
    'ERR_CHECKSYS_CONFIG_NOT_WRITABLE' => 'Plik konfiguracyjny istnieje, ale nie jest zapisywalny. Proszę podjąć niezbędne kroki, aby plik mógł być zapisany.',
    'ERR_CHECKSYS_CONFIG_NOT_FOUND' => 'Twój config.php nie istnieje. Zostanie utworzony przy instalacji.',
    'ERR_CHECKSYS_CONFIG_OVERRIDE_NOT_WRITABLE' => 'Plik konfiguracyjny (config override) istnieje, ale nie jest zapisywalny. Proszę podjąć niezbędne kroki, aby plik mógł być zapisany. ',
    'ERR_CHECKSYS_CUSTOM_NOT_WRITABLE' => 'Katalog niestandardowy (custom) istnieje, ale nie jest zapisywalny. Proszę podjąć niezbędne kroki, aby plik mógł być zapisywalny.',
    'ERR_CHECKSYS_FILES_NOT_WRITABLE' => "Pliki lub katalogi wymienione powyżej nie są zapisywalne lub ich brakuje i nie mogą zostać utworzone. Proszę podjąć niezbędne kroki, aby katalogi i pliki mogły być zapisywane.",
    'ERR_CHECKSYS_LOGS_NOT_WRITABLE' => 'Katalog logów nie jest obecnie zapisywalny',
    'ERR_CHECKSYS_CACHE_NOT_WRITABLE' => 'Katalog pamięci podręcznej nie jest obecnie zapisywalny',
    'ERR_CHECKSYS_EXTENSIONS_NOT_WRITABLE' => 'Katalog rozszerzeń nie jest obecnie zapisywalny',
    'ERR_CHECKSYS_SECRETS_NOT_WRITABLE' => 'Katalog config/secrets nie jest obecnie zapisywalny',
    'ERR_CHECKSYS_ENV_NOT_WRITABLE' => 'Plik .env lub katalog z nim nie jest zapisywalny.',
    ...
    'ERR_DB_LOGIN_FAILURE_SHORT' => 'Błąd połączenia z bazą danych: Podana nazwa hosta bazy danych, nazwa użytkownika i/lub hasło są nieprawidłowe.',
    ...
    'ERR_UPLOAD_MAX_FILESIZE' => 'Konfiguracja PHP musi zostać zmieniona tak, aby dozwolona wielkość wysyłanych plików wynosiła co najmniej 6MB.',
    ...
    'LBL_CHECKSYS_LEGACY_CACHE' => 'Zapisywalne podkatalogi pamięci podręcznej Legacy',
    'LBL_CHECKSYS_CACHE' => 'Zapisywalne podkatalogi pamięci podręcznej',
    'LBL_CHECKSYS_EXTENSIONS' => 'Zapisywalny katalog rozszerzeń',
    'LBL_CHECKSYS_SECRETS' => 'Zapisywalny Katalog Config/Secrets',
    'LBL_CHECKSYS_LOGS' => 'Zapisywalny katalog logów',
    ...
    'LBL_CHECKSYS_ENV' => 'Zapisywalny .env',
    ...
    'LBL_CHECKSYS_INTL_EXTENSIONS' => 'Intl istnieje w rozszerzeniach',
    'LBL_CHECKSYS_JSON_EXTENSIONS' => 'Json istnieje w rozszerzeniach',
    'LBL_CHECKSYS_GD_EXTENSIONS' => 'GD istnieje w rozszerzeniach',
    'LBL_CHECKSYS_OPENSSL_EXTENSIONS' => 'OpenSSL istnieje w rozszerzeniach',
    'LBL_CHECKSYS_ZIP_EXTENSIONS' => 'Zip istnieje w rozszerzeniach',
    'LBL_CHECKSYS_PDO_MYSQL_EXTENSIONS' => 'PDO MySQL istnieje w rozszerzeniach',
    'LBL_CHECKSYS_CURL_EXTENSIONS' => 'cURL istnieje w rozszerzeniach',
    'LBL_CHECKSYS_MBSTRING_EXTENSIONS' => 'MB strings istnieje w rozszerzeniach',
    'LBL_CHECKSYS_MYSQLI_EXTENSIONS' => 'MySQLi istnieje w rozszerzeniach',
    'LBL_CHECKSYS_SOAP_EXTENSIONS' => 'Soap istnieje w rozszerzeniach',
    'LBL_CHECKSYS_XML_EXTENSIONS' => 'XML istnieje w rozszerzeniach',
    'LBL_CHECKSYS_IMAP_EXTENSIONS' => 'IMAP istnieje w rozszerzeniach (opcjonalnie)',
    'LBL_CHECKSYS_LDAP_EXTENSIONS' => 'LDAP istnieje w rozszerzeniach (opcjonalnie)',
    'LBL_PHP_CHECKS' => 'KONTROLE PHP',
    'LBL_SERVER_CHECKS' => 'KONTROLE SERWERA',
    'LBL_PERMISSION_CHECKS' => 'KONTROLE UPRAWNIEŃ',
    'LBL_CHECK_FAILED' => 'Sprawdzanie nie powiodło się: ',
    'ERR_CHECKSYS_INTL' => 'Rozszerzenie Intl nie jest zainstalowane, skontaktuj się z administratorem systemu',
    'ERR_CHECKSYS_JSON' => 'Rozszerzenie JSON nie jest włączone, skontaktuj się z administratorem systemu.',
    'ERR_CHECKSYS_GD' => 'Rozszerzenie GD nie jest włączone, skontaktuj się z administratorem systemu.',
    'ERR_CHECKSYS_OPENSSL' => 'Rozszerzenie OpenSSL nie jest włączone, skontaktuj się z administratorem systemu.',
    'ERR_CHECKSYS_PDO_MYSQL' => 'Rozszerzenie PDO MySQL nie jest włączone, skontaktuj się z administratorem systemu.',
    'ERR_CHECKSYS_MYSQLI' => 'Rozszerzenie MySQLi nie jest włączone, skontaktuj się z administratorem systemu.',
    'ERR_CHECKSYS_SOAP' => 'Rozszerzenie Soap nie jest włączone, skontaktuj się z administratorem systemu.',
    ...
    'LBL_UNWRITABLE_SUB_DIR' => 'Istnieją niektóre podkatalogi, które nie są zapisywalne. Proszę podjąć niezbędne kroki, aby katalogi mogły być zapisywane ',
    'LBL_REFER_TO_LOGS' => 'Wystąpił problem w jednej z kontroli przed instalacją, zapoznaj się z install.log',
    'LBL_NOT_A_VALID_SUITECRM_PAGE' => 'Nie można odnaleźć tytułu SuiteCRM. To nie jest prawidłowa strona SuiteCRM.',
    'LBL_NOT_COOKIE_OR_TOKEN' => 'Nie można znaleźć ciasteczek, nie znaleziono poprawnego tokenu. Więcej informacji znajdziesz w pliku install.log.',
    'LBL_CURL_JSON_ERROR' => 'Wynik wywołania curl na stronie graphql był pusty.',
    'LBL_UNABLE_TO_FIND_SYSTEM_CONFIGS' => 'Nie można pobrać konfiguracji systemu na stronie Graphql. Więcej informacji znajdziesz w pliku install.log.',
    'LBL_CURL_REQUEST_MAIN_PAGE' => 'Żądanie Curl na stronie głównej',
    'LBL_CURL_REQUEST_API_PAGE' => 'Żądanie Curl w Api',
    'LBL_ERROR_DETAILS' => 'Szczegóły błędu',
    'LBL_ERROR' => 'Błąd:',
    'LBL_WARNING_DETAILS' => 'Szczegóły ostrzeżenia',
    'LBL_WARNING' => 'Ostrzeżenie',
    'LBL_SYSTEM_CHECKS' => 'KONTROLE SYSTEMOWE',
    'LBL_CRON_INSTRUCTIONS_1' => 'Aby uruchomić Harmonogramy SuiteCRM, edytuj plik crontab dla użytkowników serwera:',
    'LBL_CRON_INSTRUCTIONS_2' => 'i dodaj następujący wiersz do pliku crontab:',
    'LBL_CRON_INSTRUCTIONS_3' => 'Należy to zrobić dopiero po zakończeniu instalacji.',
    'LBL_CRON_CONFIGURATION' => 'KONFIGURACJA CRON',
    'LBL_SETUP_CRONTAB' => 'Aby ustawić Crontab',
    'LBL_ROUTE_ACCESS_CHECK' => 'KONTROLA DOSTĘPU TRAS (route)',
    'LBL_PHP_MEM_1' => 'Limit pamięci PHP: ',
    'LBL_PHP_MEM_2' => '. Musi to być minimum ',
    'LBL_PHP_MEM_3' => 'M aby kontynuować.',
    ...
    'LBL_DISABLED_DESCRIPTION_2' => 'Po dokonaniu zmian kliknij na poniższy przycisk "Start" w celu rozpoczęcia instalacji. Po zakończeniu instalacji zmień wartość z \'installer_locked\' na \'true\'',
    'LBL_DISABLED_DESCRIPTION_3' => 'Po dokonaniu tej zmiany, wejdź ponownie na tę stronę lub odśwież ją, aby kontynuować.',
    ...
    'LBL_APP_NOT_INSTALLED' => 'SuiteCRM nie jest zainstalowany. Punkt wejścia wymaga zainstalowanego SuiteCRM - dokonaj instalacji.',
    ...
    'LBL_SILENT_INSTALL_SUCCESS' => 'SuiteCRM został pomyślnie zainstalowany.',
    'LBL_SILENT_INSTALL_FAILED' => 'Instalacja SuiteCRM nie powiodła się.',
    ...
    'LBL_PRE_INSTALL_REQ' => 'Wymagania przed instalacją',
...
$contact_user_link_guid',
    ...
    'LBL_DBCONFIG_MSG2_LABEL' => 'Host Name / Host Instance',
    ...
    'LBL_SYS_CHECK_WARNING' => 'Ignoruj ostrzeżenia podczas sprawdzania systemu',
    'LBL_PROCEED' => 'DALEJ',
    'LBL_RECHECK' => 'RECHECK',
    'LBL_CONFIG' => 'KONFIGURACJA',
    'LBL_VALIDATION_ERRORS' => 'Istnieją błędy walidacji, nie można wykonać akcji.'
);
