...
$mod_strings = array(
    ...
    'LBL_TASKS' => 'Estayes', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
    'LBL_MEETINGS' => 'Conceyos', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
    'LBL_CALLS' => 'Llamaes', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
    'LBL_EMAILS' => 'Corréu', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
    ...
    'LBL_MEETING_TYPE' => 'Conceyos',
    'LBL_CALL_TYPE' => 'Llamaes',
    'LBL_EMAIL_TYPE' => 'Corréu-e',
    'LBL_NOTE_TYPE' => 'Notes',
    'LBL_DATA_TYPE_START' => 'Start:',
    'LBL_DATA_TYPE_SENT' => 'Sent:',
    'LBL_DATA_TYPE_MODIFIED' => 'Modified:',
    'LBL_LIST_CONTACT' => 'Contautos',
