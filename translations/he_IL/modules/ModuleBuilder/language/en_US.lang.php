...
$mod_strings = array(
    ...
    'help' => array(
        'package' => array(
            ...
            'existing_module' => 'לחץ על הסמל \' <b>מודול</b> \' כדי לערוך את מאפייני ולהתאים את השדות, מערכות יחסים ואת הפריסות המשויכות עם מודול.',
            'new_module' => 'לחץ על <b>מודול חדש</b> כדי ליצור מודול חדש עבור חבילה זו.',
        ...
        'module' => array(
            ...
            'savebtn' => 'לחץ על <b>שמור</b> כדי לשמור את כל הנתונים שהוזנו שקשורים למודול.',
        ...
        'studioWizard' => array(
            ...
            'studioBtn' => 'השתמש <b>סטודיו</b> להתאמה אישית של מודולים שנפרסו.',
...
//STUDIO2
    ...
    'LBL_DROPDOWN_LANGUAGE' => 'שפת מחדל',
    'LBL_DROPDOWN_ITEMS' => 'List Items',
    'LBL_DROPDOWN_ITEM_NAME' => 'שם פריט',
    'LBL_DROPDOWN_ITEM_LABEL' => 'תווית שתוצג',
...
//LIST VIEW EDITOR
    ...
    'LBL_LISTVIEW_EDIT' => 'עורך רשימת תצוגה',
...
//ERRORS
    ...
    'ERROR_GENERIC_TITLE' => 'אירעה שגיאה',
...
//POPUP HELP
    ...
    'LBL_POPHELP_IMPORTABLE' => '<b>כן</b>: השדה ייכלל בפעולת הייבוא.<br><b>לא</b>: השדה לא ייכלל בייבוא.<br><b>חובה</b> b>: יש לספק ערך עבור השדה בכל ייבוא.',
    'LBL_POPHELP_IMAGE_WIDTH' => 'הזן מספר עבור רוחב, בפיקסלים.<br> התמונה שתעלה תותאם לרוחב זה.',
    'LBL_POPHELP_IMAGE_HEIGHT' => 'הזן מספר עבור הגובה, כפי שנמדד בפיקסלים.<br> התמונה שתעלה תותאם לגובה זה.',
    'LBL_POPHELP_DUPLICATE_MERGE' => '<b>מופעל</b>: השדה יופיע בתכונת מיזוג כפילויות, אך לא יהיה זמין לשימוש עבור תנאי הסינון בתכונה מצא כפילויות.<br><b>מושבת</b>: השדה לא יופיע בתכונת מיזוג כפילויות, ולא יהיה זמין לשימוש עבור תנאי הסינון בתכונה מצא כפילויות.',

//Revert Module labels
    'LBL_RESET' => 'Återställ [Alt+R]',
    ...
    'fieldTypes' => array(
        ...
        'bool' => 'Checkbox',
        'enum' => 'DropDown',
        'dynamicenum' => 'רשימה נפתחת דינאמית',
