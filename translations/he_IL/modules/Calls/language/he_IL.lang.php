...
$mod_strings = array(
    ...
    'LBL_LIST_ASSIGNED_TO_NAME' => 'מנה שם משתמש:',
    ...
    'LBL_CALL_INFORMATION' => 'סקירת חשבון', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
    'LBL_REMOVE' => 'הסר',
