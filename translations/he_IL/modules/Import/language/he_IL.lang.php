...
$mod_strings = array(
    'LBL_RECORDS_SKIPPED_DUE_TO_ERROR' => 'השורות לא יובאו בגלל שגיאה',
    'LBL_UPDATE_SUCCESSFULLY' => 'records updated successfully',
    'LBL_SUCCESSFULLY_IMPORTED' => 'רשומות נוצרו',
    'LBL_STEP_4_TITLE' => 'שלב {0}: ייבוא קובץ',
    'LBL_STEP_5_TITLE' => 'שלב {0}: הצגת התוצאות ייבוא',
    ...
    'LBL_IMPORT_TYPE' => 'מה את/ה רוצה לעשות עם הנתונים המיובאים?',
    'LBL_IMPORT_BUTTON' => 'יצירת רשומות חדשות בלבד',
    'LBL_UPDATE_BUTTON' => 'צור רשומות חדשות ועדכן רשומות קיימות',
    'LBL_CREATE_BUTTON_HELP' => 'יש להשתמש באפשרות זו כדי ליצור רשומות חדשות. הערה: שורות בקובץ הייבוא המכילות ערכים התואמים את מזהי הרשומות הקיימות לא ייובאו אם הערכים ממופים לשדה המזהה.',
    'LBL_UPDATE_BUTTON_HELP' => 'יש להשתמש באפשרות זו במקרה ורוצים לעדכן רשומות קיימות. הנתונים בקובץ ליבוא יותאמו לרשומות קיימות על פי "record ID" בקובץ המיובא',
    'LBL_ERROR_INVALID_BOOL' => 'ערך בוליאני לא חוקי',
    'LBL_IMPORT_ERROR' => 'שגיאות ייבוא:',
    'LBL_ERROR' => 'הערה:',
    ...
    'LBL_ERROR_INVALID_NAME' => 'מחרוזת ארוכה מכדי להיכנס בעמודה',
    'LBL_ERROR_INVALID_VARCHAR' => 'מחרוזת ארוכה מכדי להיכנס בעמודה',
    'LBL_ERROR_INVALID_DATE' => 'תאריך לא חוקי',
    'LBL_ERROR_INVALID_DATETIME' => 'תאריך וזמן לא חוקי',
    'LBL_ERROR_INVALID_DATETIMECOMBO' => 'תאריך וזמן לא חוקי',
    'LBL_ERROR_INVALID_TIME' => 'זמן לא חוקי',
    'LBL_ERROR_INVALID_INT' => 'ערך מספר שלם לא חוקי',
    'LBL_ERROR_INVALID_NUM' => 'הערך המספרי לא חוקי',
    'LBL_ERROR_INVALID_EMAIL' => 'כתובת דוא"ל לא חוקית',
    'LBL_ERROR_INVALID_USER' => 'שם משתמש לא חוקי או תעודה מזהה',
    'LBL_ERROR_INVALID_TEAM' => 'שם הקבוצה לא חוקי או תעודה מזהה',
    'LBL_ERROR_INVALID_ACCOUNT' => 'שם החשבון לא חוקי או תעודה מזהה',
    'LBL_ERROR_INVALID_RELATE' => 'Invalid relational field',
    'LBL_ERROR_INVALID_CURRENCY' => 'ערך המטבע לא חוקי',
    ...
    'LBL_STEP_MODULE' => 'נא לבחור מודול אליו ייובאו הנתונים',
    ...
    'LBL_MICROSOFT_OUTLOOK_HELP' => 'המיפוי המותאם אישית עבור Microsoft Outlook מסתמך על קובץ הייבוא המופרד בפסיקים (.csv). אם קובץ הייבוא שלך מופרד באמצעות טאבים, המיפויים לא יחולו כצפוי.',
    ...
    'LBL_ACCOUNTS_NOTE_1' => 'שדה כתובת רחוב 2" ו- "כתובת רחוב 3" ישורשרו ביחד עם כתובת הרחוב הראשית כאשר יקלטו ל- DB.',
    ...
    'LBL_IMPORT_FIELDDEF_DATE' => 'תאריך',
    'LBL_IMPORT_FIELDDEF_ASSIGNED_USER_NAME' => 'User Name or ID',
    'LBL_IMPORT_FIELDDEF_BOOL' => '\'0\' or \'1\'',
    'LBL_IMPORT_FIELDDEF_ENUM' => 'רשימה',
    'LBL_IMPORT_FIELDDEF_EMAIL' => 'כתובת דואר אלקטרוני',
    ...
    'LBL_SHOW_NOTES' => 'תזכורות',
    'LBL_HIDE_NOTES' => 'Hide Notes',
    'LBL_SAVE_MAPPING_AS' => 'ניתן לשמור את הגדרות היבוא. יש לתת שם לטובת שמירת ההגדרות:',
    'LBL_IMPORT_COMPLETE' => 'Exit',
    'LBL_IMPORT_COMPLETED' => 'Import Completed',
    'LBL_IMPORT_RECORDS' => 'Importing Records',
    'LBL_IMPORT_RECORDS_OF' => 'מתוך',
    ...
    'LBL_SAVE_MAPPING_HELP' => 'הזן שם לשמירת הגדרות הייבוא, כולל מיפויי השדות והאינדקסים המשמשים לבדיקת רשומות משוכפלות. הגדרות ייבוא שמורות יכולות לשמש לייבוא עתידי.',
    'LBL_IMPORT_FILE_SETTINGS_HELP' => 'במהלך ההעלאה של קובץ הייבוא שלך, ייתכן שתכונות קובץ מסוימות זוהו באופן אוטומטי. הצג ונהל מאפיינים אלה, כפי <br>שנדרש. הערה: ההגדרות שמופיעות כאן קשורות ליבוא זה <br> ולא יבטלו את הגדרות המשתמש הכוללות.',
    ...
    'LBL_THIRD_PARTY_CSV_SOURCES' => 'אם נתוני קובץ הייבוא יוצאו מכל אחד מהמקורות הבאים, יש לבחור איזה מהם.',
    ...
    'LBL_SELECT_UPLOAD_INSTRUCTION' => 'יש לבחור קובץ במחשב המקומי הכולל את הנתונים אותם רוצים לקלוט, או להוריד את תבנית הנתונים על מנת להכין את הקובץ מראש.',
    'LBL_SELECT_PROPERTY_INSTRUCTION' => 'כך מופיעות השורות הראשונות של קובץ הייבוא עם מאפייני הקובץ שזוהו. אם זוהתה שורת כותרת, היא מוצגת בשורה העליונה של הטבלה. הצג את מאפייני קובץ הייבוא כדי לבצע שינויים במאפיינים שזוהו ולהגדיר מאפיינים נוספים. עדכון ההגדרות יעדכן את הנתונים המופיעים בטבלה.',
    'LBL_SELECT_MAPPING_INSTRUCTION' => 'הטבלה הבאה מכילה את כל השדות במודול שניתן למפות לנתונים בקובץ הייבוא. אם הקובץ מכיל שורת כותרת, העמודות בקובץ ממופות לשדות תואמים. בדוק את המיפוי כדי לוודא שהם תואמים, ניתן וכדאי לבצע שינויים, לפי הצורך. כדי לעזור לך לבדוק את המיפוי, שורה 1 מציגה את הנתונים בקובץ. הקפד למפות לכל השדות ההכרחיים (כפי שצוינו על ידי כוכבית).',
    'LBL_SELECT_DUPLICATE_INSTRUCTION' => 'כדי למנוע יצירת רשומות כפולות, בחר את השדות הממופים שבהם ברצונך להשתמש כדי לבצע בדיקת כפילות בזמן ייבוא הנתונים. הערכים ברשומות הקיימות בשדות שנבחרו ייבדקו מול הנתונים בקובץ הייבוא. אם הנתונים תואמים, השורות בקובץ הייבוא המכילות את הנתונים יוצגו יחד עם תוצאות הייבוא (הדף הבא). לאחר מכן ניתן יהיה לבחור איזו מהשורות האלה תמשיך לייבא.',
