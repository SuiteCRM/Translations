...
$mod_strings = array(
    ...
    'LBL_GROUP_TOTAL_USDOLLAR' => 'Вкупно за група (зададена валута)',
    'LBL_SUBTOTAL_TAX_AMOUNT_USDOLLAR' => 'Меѓузбир + Данок (зададена валута)',
    'LBL_PARENT_ID' => 'Надреден број',

    'AOS_PRODUCT_QUOTES' => 'Понуди за Производот',
);
