...
$mod_strings = array(
    ...
    'LBL_LEAD_SOURCE_BY_OUTCOME' => 'Сите планирани продажби по изворни информации за потенцијални клиенти по исход',
    ...
    'LBL_LEAD_SOURCE_OTHER' => 'Останато',
    'LBL_LEAD_SOURCES' => 'Lead Sources:',
    'LBL_MODULE_NAME' => 'Контролна табла',
    ...
    'LBL_SALES_STAGE_FORM_TITLE' => 'Продажни канали по продажни фази',
    ...
    'LBL_CHART_OUTCOME_BY_MONTH' => 'Месечен резултат',
