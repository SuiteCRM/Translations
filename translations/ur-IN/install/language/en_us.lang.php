...
$mod_strings = array(
    ...
    'ERR_CHECKSYS_CURL' => 'نہیں مل سکا: سیوٹ سی آر ایم شیڈولر محدود فعالیت کے ساتھ چل جائے گا.',
    ...
    'ERR_PERFORM_CONFIG_PHP_2' => 'آپ دستی طور پر config.php فائل بنانے اور نیچے config.php فایل میں ترتیب کی معلومات چسپاں کرکے اس تنصیب کو جاری رکھ سکتے ہیں. حالانکہ، آپ <strong>لازمی طور پر</strong>گلے مرحلے تک جاری رکھنے سے پہلے config.php فایل بنانا ہوگی.',
