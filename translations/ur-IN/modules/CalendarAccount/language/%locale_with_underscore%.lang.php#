...
$mod_strings = [
    ...
    // Email opt-in labels
    'LBL_OPT_IN' => 'میں چنے',
    'LBL_OPT_IN_PENDING_EMAIL_NOT_SENT' => 'منتقلی تصدیق او پی ٹی میں، تصدیق او پی ٹی میں بھیجا نہیں',
    'LBL_OPT_IN_PENDING_EMAIL_SENT' => 'منتقلی تصدیق او پی ٹی میں، تصدیق او پی ٹی میں بھیج دیا',
    'LBL_OPT_IN_CONFIRMED' => 'آپکی مرضی میں',
