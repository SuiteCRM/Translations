...
$mod_strings = array(
    ...
    'LBL_TASKS' => 'Work', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
    'LBL_MEETINGS' => 'Where people gather', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
    ...
    'ERR_DELETE_RECORD' => 'Make you choose one record number to delete de account.',
    ...
    'LBL_HISTORY' => 'History',
    'LBL_NEW_TASK_BUTTON_TITLE' => 'Make you Create Task',
    'LBL_NEW_TASK_BUTTON_LABEL' => 'Make you Create Task',
    'LBL_SCHEDULE_MEETING_BUTTON_TITLE' => 'Make you Schedule Meeting',
    'LBL_SCHEDULE_MEETING_BUTTON_LABEL' => 'Make you Schedule Meeting',
    'LBL_SCHEDULE_CALL_BUTTON_LABEL' => 'Log call',
    'LBL_NEW_NOTE_BUTTON_TITLE' => 'Make you Create Note or Attachment',
    'LBL_NEW_NOTE_BUTTON_LABEL' => 'Make you Create Note or Attachment',
    ...
    'LBL_ACCEPT' => 'Agree' /*for 508 compliance fix*/,
);
