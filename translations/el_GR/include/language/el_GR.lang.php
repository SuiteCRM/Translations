...
$app_strings = array(
    ...
    'PIPELINE_BY_SALES_STAGE' => 'Διαδρομή από Στάδιο Πωλήσεων',
...
$app_strings['LBL_INVALID_EMAIL'] = 'Διαθέσιμη';
$app_strings['LBL_PRIMARY'] = 'Βασική Διεύθυνση Email';
$app_strings['LBL_EMAIL_ADDRESS'] = 'Διευθύνσεις Email';
...
$app_strings['LBL_NONE_OUTSTANDING'] = 'Κανένας';
...
$app_strings['AOS_Contracts'] = 'Συμβάσεις';
$app_strings['AOS_Quotes'] = 'Προσφορές';
...
$app_strings['LBL_CREATE'] = 'Δημιουργία Στόχου';
...
$app_strings['LBL_YES'] = 'Ναί';
$app_strings['LBL_NO'] = 'κανένα';
