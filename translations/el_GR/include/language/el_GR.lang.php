...
//e.g. auf Deutsch 'Contacts'=>'Contakten',
    ...
    'moduleList' => array(
        ...
        'ACLRoles' => 'Ρόλοι',
        'InboundEmail' => 'Λογαριασμοί Εισερχομένων Email',
        ...
        'UpgradeWizard' => 'Αναβάθμιση Οδηγού',
...
$app_strings = array(
    'LBL_SEARCH_RESULTS_TITLE' => 'Αποτελέσματα',
    ...
    'LBL_LOGOUT' => 'Έξοδος',
    'LBL_LOGOUT_SUCCESS' => 'Επιτυχής Αποσύνδεση',
    'LBL_LOGGED_OUT_MESSAGE' => 'Έχετε αποσυνδεθεί',
    'LBL_LOGIN_AGAIN' => 'Για να συνδεθείτε ξανά ',
    'LBL_TOUR_NEXT' => 'Επόμενο',
    'LBL_TOUR_SKIP' => 'Μετάβαση',
    'LBL_TOUR_BACK' => 'Προηγούμενο',
    ...
    'ERR_TIMEOUT' => "Αναγκαστική αποτυχία στο χρονικό όριο",
    'LBL_EMAIL_ADDRESS_BOOK_ADD' => 'Ολοκληρώθηκε',
    'LBL_EMAIL_ADDRESS_BOOK_CLEAR' => 'Εκκαθάριση',
    'LBL_EMAIL_ADDRESS_BOOK_ADD_TO' => 'Προς:',
    ...
    'LBL_EMAIL_ASSIGNMENT' => 'Ανατεθεισα εργασια',
    ...
    'LBL_EMAIL_DELETE_ERROR_DESC' => 'Δεν έχετε πρόσβαση σε αυτή την περιοχή. Παρακαλώ επικοινωνήστε με τον διαχειριστή του προγράμματος αν πιστεύετε πως πρέπει να έχετε πρόσβαση.',
    ...
    'LBL_EMAIL_FOLDERS' => SugarThemeRegistry::current()->getImage('icon_email_folder', 'align=absmiddle border=0', null, null, '.gif', '') . 'Φάκελοι',
    ...
    'LBL_EMAIL_SETTINGS_ACCOUNTS' => 'Λογαριασμοί Mail',
    ...
    'LBL_EMAIL_SETTINGS_FROM_NAME' => 'Όνομα Από',
    ...
    'ERR_UNAUTHORIZED_PAGE_ACCESS' => 'Δεν επιτρέπεται η πρόσβαση σε αυτή τη σελίδα. Παρακαλώ επικοινωνήστε με το διαχειριστή.',
    'ERR_UNAUTHORIZED_PAGE_ACCESS_TO_HOME_PAGE' => 'Δεν επιτρέπεται η πρόσβαση σε αυτή τη σελίδα. Ανακατεύθυνση στην Αρχική Σελίδα...',
    ...
    'LBL_QUICK_CHARTS' => 'Γρήγορα Γραφήματα',
    'LBL_QUICK_HISTORY' => 'Χρονοδιάγραμμα',
    ...
    'LBL_OPEN_ITEMS' => 'Ανοιχτά Αντικείμενα',
    ...
    'LBL_CURRENT_USER_FILTER' => 'Τα αντικείμενα μου',
    ...
    'LBL_LIMIT' => 'Limit: ',
    'LBL_DIRECT_REPORTS' => 'Απευθείας αναφορές',
    ...
    'LBL_EXPORT' => 'Εξαγωγή',
    'LBL_FAVORITES_FILTER' => 'Τα Αγαπημένα μου',
    ...
    'LBL_RECORD_DOES_NOT_EXIST' => 'Λάθος κατά την ανάκτηση εγγραφής. Αυτή η εγγραφή μπορεί να διαγράφηκε ή ίσως δεν επιτρέπεται να την δείτε.',
    'LBL_PROFILE' => 'Προφίλ',
    ...
    'LBL_SCHEDULERS' => 'Χρονοδιαγράμματα',
    ...
    'LBL_BASIC_FILTER' => 'Βασικό Φίλτρο',
    'LBL_QUICK' => 'Γρήγορα',
    ...
    'LBL_CREATE_OPPORTUNITY' => 'Δημιουργία ευκαιρίας πώλησης',
    ...
    'LBL_BULK_ACTION_BUTTON_LABEL' => 'Μαζικές Ενέργειες',
    'LBL_BULK_ACTION_BUTTON_LABEL_MOBILE' => 'Δράση',
    'LBL_TOO_FEW_SELECTED' => 'Μη έγκυρος αριθμός εγγραφών επιλέχθηκαν. Πρέπει να επιλέξετε το ελάχιστο {min} εγγραφές.',
    'LBL_TOO_MANY_SELECTED' => 'Μη έγκυρος αριθμός εγγραφών επιλέχθηκαν. Πρέπει να επιλέξετε το πολύ {max} εγγραφές.',
    'LBL_SELECT_ALL_NOT_ALLOWED' => 'Η επιλογή όλων των εγγραφών δεν είναι διαθέσιμη για αυτή την ενέργεια. Παρακαλώ επιλέξτε μεμονωμένες εγγραφές.',
    'LBL_MISSING_HANDLER_DATA' => 'Αναπάντεχο σφάλμα. Missing bulk action handler data from response',
    'LBL_MISSING_HANDLER' => 'Αναπάντεχο σφάλμα. Δεν ορίστηκε χειριστής για την ενέργεια μαζικής επιλογής',
    'LBL_MISSING_HANDLER_DATA_ROUTE' => 'Αναπάντεχο σφάλμα. Λείπει η διαδρομή μαζικής ενέργειας',
    ...
    'LBL_BULK_ACTION_MASS_UPDATE_NO_FIELDS' => 'Χωρίς πεδία προς ανανέωση',
    'LBL_BULK_ACTION_MASS_UPDATE_NO_RECORDS' => 'Χωρίς εγγραφές προς ανανέωση',
    ...
    'LBL_SEND_DATE' => 'Ημερομηνιία Αποστολής',
    'LBL_SCHEDULE_BUTTON_LABEL' => 'Προγραμματισμός',
    ...
    'PIPELINE_BY_SALES_STAGE' => 'Οι προσφορες μου',
    ...
    'LBL_SUITE_DESC1' => 'Το SuiteCRM έχει κατασκευαστεί από τον <a href="https://salesagility.com"> SalesAgility</a>.  Το πρόγραμμα παρέχεται ΩΣ ΕΧΕΙ, χωρίς καμία εγγύηση.  Υπό την άδεια AGPLv3.',
    ...
    'LBL_SUITE_DESC3' => 'To SuiteCRM είναι εμπορικό σήμα της SalesAgility Ε. Π. Ε. Όλα τα άλλα ονόματα εταιρειών και προϊόντων ενδέχεται να αποτελούν σήματα των αντίστοιχων εταιρειών με τις οποίες συνδέονται.',
    ...
    'LBL_PROSPECT_LIST_NAME' => 'Λίστες Στόχων',

    //List View Column Selector Modal
    'LBL_COLUMN_SELECTOR_DISPLAYED_COLS' => 'DISPLAYED',
    'LBL_COLUMN_SELECTOR_HIDDEN_COLS' => 'HIDDEN',
    'LBL_COLUMN_SELECTOR_CLOSE_BUTTON' => 'Κλείσιμο',
    'LBL_COLUMN_SELECTOR_SAVE_BUTTON' => 'Αποθήκευση Αλλαγών',
...
$app_strings['LBL_OPT_OUT'] = 'Επιλογή εξόδου';
$app_strings['LBL_INVALID_EMAIL'] = 'Άκυρο';
$app_strings['LBL_PRIMARY'] = 'Βασική Διεύθυνση Email';
...
$app_strings['LBL_CHARTS'] = 'Γραφήματα';
$app_strings['LBL_CHART_NOT_FOUND'] = 'Το γράφημα δεν βρέθηκε';
$app_strings['LBL_NO_DATA'] = 'Κανένα Δεδομένο';
$app_strings['LBL_ERROR_FETCHING_METADATA'] = 'Error occurred while fetching metadata';
$app_strings['LBL_TOTAL'] = 'Σύνολο';
$app_strings['LBL_ACTIONS'] = 'Ενέργειες';
...
$app_strings['LBL_STAT_DAYS'] = 'Ημέρα(ες)';
...
$app_strings['LBL_NONE_OUTSTANDING'] = 'Κανένα';
...
$app_strings['LBL_DEFAULT_TOTAL'] = 'Σύνολο';
$app_strings['AOS_Contracts'] = 'Συμβόλαια';
$app_strings['AOS_Quotes'] = 'Υπομνήματα';
$app_strings['AOS_Invoices'] = 'Τιμολόγια ';
$app_strings['LBL_PHOTO'] = 'Φωτογραφία';
$app_strings['LBL_CASE_UPDATES'] = 'Ενημερώσεις Υποθέσεων';
...
$app_strings['LBL_CREATE'] = 'Δημιουργία';
...
$app_strings['LBL_OPERATOR'] = 'Χειριστής';
$app_strings['LBL_START'] = 'Έναρξη';
$app_strings['LBL_END'] = 'Τέλος';
$app_strings['LBL_LINE_ITEMS_FIELD_CONFIG'] = 'Bad config';


$app_strings['LBL_ACTION_SUCCESS'] = 'Action successful';

$app_strings['LBL_YES'] = 'Ναι';
$app_strings['LBL_NO'] = 'Όχι';

$app_list_strings['sort_order'] = [];
$app_list_strings['sort_order']['asc'] = 'Αύξουσα';
$app_list_strings['sort_order']['desc'] = 'Φθίνουσα';

// Labels used by subpanel unlink relationship process
$app_strings['LBL_LINK'] = 'Σύνδεσμος';
$app_strings['LBL_LINK_UNLINK'] = 'Link / Unlink';
$app_strings['LBL_SAVE'] = 'Αποθήκευση';
...
$app_strings['LBL_RELATIONSHIPS'] = 'Σχέσεις';
$app_strings['LBL_SHOW_CC'] = 'Show Cc';
$app_strings['LBL_SHOW_BCC'] = 'Show Bcc';
$app_strings['LBL_CC'] = 'Κοιν';
$app_strings['LBL_BCC'] = 'Κρυφή Κοιν';
$app_strings['LNK_NEW_EMAIL'] = 'Nέο Email';
...
$app_strings['LBL_RELATED_TO'] = 'Σχετικά με';
...
$app_strings['LBL_MEDIUM'] = 'Τηλεόραση';
$app_strings['LBL_NORMAL'] = 'Κανονικό';
$app_strings['LBL_LARGE'] = 'Large';
$app_strings['LBL_HUGE'] = 'Huge';
$app_strings['LBL_DEFAULT'] = 'Προεπιλογή';
...
$app_strings['LBL_QUOTE'] = 'Προσφορά';
$app_strings['LBL_UNQUOTE'] = 'Unquote';
$app_strings['LBL_ALIGN_LEFT'] = 'Αριστερά';
$app_strings['LBL_ALIGN_CENTER'] = 'Center';
$app_strings['LBL_ALIGN_RIGHT'] = 'Δεξιά';
...
// Day and Time labels
$app_strings['LBL_SUN'] = 'Κυριακή';
$app_strings['LBL_MON'] = 'Δευτέρα';
$app_strings['LBL_TUE'] = 'Τρίτη';
$app_strings['LBL_WED'] = 'Τετάρτη';
$app_strings['LBL_THU'] = 'Πέμπτη';
$app_strings['LBL_FRI'] = 'Παρασκευή';
$app_strings['LBL_SAT'] = 'Σάββατο';
$app_strings['LBL_ALL'] = 'Κάθε Μέρα';
$app_strings['LBL_EVERY'] = 'Every';
$app_strings['LBL_ON_THE'] = 'Στις';
$app_strings['LBL_RANGE'] = 'σε';
$app_strings['LBL_FROM'] = 'Από';
$app_strings['LBL_AND'] = 'και';
$app_strings['LBL_MINS'] = 'Λεπτά';
$app_strings['LBL_MINUTES'] = 'λεπτά';
$app_strings['LBL_HOUR'] = 'ώρες';
$app_strings['LBL_HOUR_SING'] = 'ώρα';
$app_strings['LBL_OFTEN'] = 'Όσο το δυνατόν συχνότερα.';
$app_strings['LBL_MIN_MARK'] = 'σήμα λεπτού';
$app_strings['LBL_INBOUND_EMAIL'] = 'Εισερχόμενα Email';
...
$app_strings['LBL_CAMPAIGN_SETTINGS'] = 'Ρυθμίσεις';
...
$app_strings['LBL_INACTIVE'] = 'Ανενεργή';
...
$app_strings['LBL_UPLOAD'] = 'Φορτώνει';
