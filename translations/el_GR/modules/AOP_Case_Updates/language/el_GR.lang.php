...
$mod_strings = array(
    ...
    'LBL_REMOVE' => 'Αφαίρεση',
    'LBL_LIST_FORM_TITLE' => 'Λίστα Ενημερώσεων Περιστατικών',
    'LBL_MODULE_NAME' => 'Ενημερώσεις Υποθέσεων',
    'LBL_MODULE_TITLE' => 'Ενημερώσεις Υποθέσεων',
    'LBL_HOMEPAGE_TITLE' => 'Οι Ενημερώσεις Περιστατικών μου',
    'LNK_NEW_RECORD' => 'Δημιουργία Ενημερώσεων Περιστατικών',
    'LNK_LIST' => 'Εμφάνιση Ενημερώσεων Περιστατικών',
    'LBL_SEARCH_FORM_TITLE' => 'Αναζήτηση Περιπτώσεων Περιστατικών',
    'LBL_HISTORY_SUBPANEL_TITLE' => 'Προβολή Ιστορικού',
    'LBL_ACTIVITIES_SUBPANEL_TITLE' => 'Δραστηριότητες',
    'LBL_NEW_FORM_TITLE' => 'Νέες Ενημερώσεις Περιστατικών',
    'LBL_CASE_NAME' => 'Αίτηση υποστήριξης',
