...
$mod_strings = array(
    ...
    'LBL_MODULE_TITLE' => 'Ροή Δραστηριοτήτων',
    ...
    'LBL_TO' => 'Ορατό στην Ομάδα',
    'LBL_IS' => 'Είναι',
    'LBL_DONE' => 'Ολοκληρώθηκε',
    'LBL_TITLE' => 'Τίτλος',
    'LBL_ROWS' => 'Σειρές',
    'LBL_CATEGORIES' => 'Ενότητες',
    'LBL_TIME_LAST_WEEK' => 'Προηγούμενη εβδομάδα',
    'LBL_TIME_WEEKS' => 'εβδομάδες',
    'LBL_TIME_DAYS' => 'ημέρες',
    'LBL_TIME_YESTERDAY' => 'Χθες',
    'LBL_TIME_HOURS' => 'Ώρες',
    'LBL_TIME_HOUR' => 'Ώρες',
    'LBL_TIME_MINUTES' => 'Λεπτά',
    'LBL_TIME_MINUTE' => 'Λεπτό ',
    'LBL_TIME_SECONDS' => 'Δευτερόλεπτα',
    'LBL_TIME_SECOND' => 'Δευτερόλεπτο',
    'LBL_TIME_AND' => 'και',
    'LBL_TIME_AGO' => 'πριν από',
// Activity stream
    ...
    'FOR' => 'για', // Activity stream for cases
    ...
    'LBL_LINK_TYPE_Link' => 'Σύνδεσμος',
    'LBL_LINK_TYPE_Image' => 'Εικόνα',
    'LBL_LINK_TYPE_YouTube' => 'YouTube&#153;',

    'LBL_SELECT' => 'Επιλογή',
    'LBL_POST' => 'Δημοσίευση',
    'LBL_AUTHENTICATE' => 'Σύνδεση στο',
    ...
    'LBL_SHOW_MORE_OPTIONS' => 'Εμφάνιση Περισσότερων Επιλογών',
    'LBL_HIDE_OPTIONS' => 'Απόκρυψη Επιλογών',
    'LBL_VIEW' => 'Προβολή',
    'LBL_POST_TITLE' => 'Post Status Update for ',
    'LBL_URL_LINK_TITLE' => 'URL σύνδεσμος προς χρήση',
);
