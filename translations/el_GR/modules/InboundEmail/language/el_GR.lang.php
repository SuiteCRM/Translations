...
$mod_strings = array(
    ...
    'LBL_CREATE_TEMPLATE' => 'Δημιουργία Στόχου',
    ...
    'LBL_LIST_NAME' => 'Όνομα Εκστρατείας:',
    ...
    'LBL_MODULE_NAME' => 'Λογαριασμοί Εισερχομένων Email',
    'LBL_BOUNCE_MODULE_NAME' => 'Αναπήδηση Χειρισμού Ταχυδρομικής Θυρίδας',
    'LBL_MODULE_TITLE' => 'Λογαριασμοί Εισερχομένων Email',
    'LBL_NAME' => 'Όνομα',
    'LBL_NONE' => 'Κανένα',
