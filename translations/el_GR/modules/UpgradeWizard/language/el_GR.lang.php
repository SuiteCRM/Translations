...
$mod_strings = array(
    ...
    'LBL_UW_FILE_GROUP' => 'Ομάδα χρήστη',
    ...
    'LBL_UW_TITLE' => 'Αναβάθμιση Οδηγού',
    ...
    'ERROR_SUITECRM_VERSION_INCOMPATIBLE' => 'Το αρχείο που μεταφορτώθηκε δεν είναι συμβατό με το SuiteCRM:',
