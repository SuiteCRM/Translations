...
$mod_strings = array(
    ...
    'LBL_NONINHERITABLE' => 'Μη Κληρονομοποιήσιμο',
    'LBL_LIST_NONINHERITABLE' => 'Μη Κληρονομοποιήσιμο',
    'LBL_NAME' => 'Όνομα',
    'LBL_CREATED_USER' => 'Δημιουργήθηκε από',
    'LBL_MODIFIED_USER' => 'τροποποίηση από',
    'LBL_LIST_FORM_TITLE' => 'Ομάδες Ασφάλειας',
    'LBL_MODULE_NAME' => 'Διαχείριση ασφαλείας Suite',
    'LBL_MODULE_TITLE' => 'Διαχείριση ασφαλείας Suite',
    'LNK_NEW_RECORD' => 'Create a Security Group',
    'LNK_LIST' => 'Προβολή Λίστας',
    ...
    'LBL_CONFIGURE_SETTINGS' => 'Παραμετροποίηση',
    ...
    'LBL_REMOVE_BUTTON_LABEL' => 'Αφαίρεση',
    'LBL_GROUP' => 'Group:',
    'LBL_MODULE' => 'Module:',
    ...
    'LBL_CONFIRM_END' => 'επιλεγμένη(ες) εγγραφή(ές);',
