...
$mod_strings = array(
    ...
    'LNK_SPOT_LIST' => 'Προβολή Σημείων',
    'LNK_SPOT_CREATE' => 'Δημιουργία Τοποθεσίας',

    //Analytics
    'LBL_AN_CONFIGURATION' => 'Ρυθμίσεις παραμέτρων',

    'LBL_AN_UNSUPPORTED_DB' => 'Sorry, Suite Spots are currently configured for MySQL and MS SQL only',

    //Analytics labels for accounts pivot
    'LBL_AN_ACCOUNTS_ACCOUNT_NAME' => 'Όνομα',
    ...
    'LBL_AN_LEADS_ASSIGNED_USER' => 'Υπεύθυνος Χρήστης',
    'LBL_AN_LEADS_STATUS' => 'Κατάσταση',
    'LBL_AN_LEADS_LEAD_SOURCE' => 'Πηγή ερίσματος πώλησης',
    'LBL_AN_LEADS_CAMPAIGN_NAME' => 'Όνομα Εκστρατείας',
    'LBL_AN_LEADS_YEAR' => 'Έτος',
    'LBL_AN_LEADS_QUARTER' => 'Quarter',
    'LBL_AN_LEADS_MONTH' => 'Μήνας',
    'LBL_AN_LEADS_WEEK' => 'Εβδομάδα',
    'LBL_AN_LEADS_DAY' => 'Ημέρα',

    //Analytics labels for sales pivot
    'LBL_AN_SALES_ACCOUNT_NAME' => 'Όνομα λογαριασμού:',
    'LBL_AN_SALES_OPPORTUNITY_NAME' => 'Όνομα ευκαιρίας πώλησης',
    'LBL_AN_SALES_ASSIGNED_USER' => 'Υπεύθυνος Χρήστης',
    'LBL_AN_SALES_OPPORTUNITY_TYPE' => 'OpportunityType',
    'LBL_AN_SALES_LEAD_SOURCE' => 'Πηγή ερίσματος πώλησης',
    'LBL_AN_SALES_AMOUNT' => 'Ποσό ',
    'LBL_AN_SALES_STAGE' => 'Στάδιο πώλησης',
    'LBL_AN_SALES_PROBABILITY' => 'Πιθανότητα',
    'LBL_AN_SALES_DATE' => 'Ημερομηνία Πώλησης',
    ...
    'LBL_AN_SALES_CAMPAIGN' => 'Καμπάνια',

    //Analytics labels for service pivot
    'LBL_AN_SERVICE_ACCOUNT_NAME' => 'Όνομα λογαριασμού:',
    'LBL_AN_SERVICE_STATE' => 'Περιοχή',
    'LBL_AN_SERVICE_STATUS' => 'Κατάσταση',
    'LBL_AN_SERVICE_PRIORITY' => 'Προτεραιότητα',
    ...
    'LBL_AN_SERVICE_CONTACT_NAME' => 'Όνομα Επαφής',
    'LBL_AN_SERVICE_ASSIGNED_TO' => 'Υπεύθυνος Χρήστης',

    //Analytics labels for the activities pivot
    'LBL_AN_ACTIVITIES_TYPE' => 'Τύπος',
    'LBL_AN_ACTIVITIES_NAME' => 'Όνομα',
    'LBL_AN_ACTIVITIES_STATUS' => 'Κατάσταση',
    'LBL_AN_ACTIVITIES_ASSIGNED_TO' => 'Υπεύθυνος Χρήστης',

    //Analytics labels for the marketing pivot
    'LBL_AN_MARKETING_STATUS' => 'Κατάσταση',
    'LBL_AN_MARKETING_TYPE' => 'Τύπος',
    'LBL_AN_MARKETING_BUDGET' => 'Προϋπολογισμός ',
    'LBL_AN_MARKETING_EXPECTED_COST' => 'Expected Cost',
    'LBL_AN_MARKETING_EXPECTED_REVENUE' => 'Αναμενόμενα Έσοδα',
    'LBL_AN_MARKETING_OPPORTUNITY_NAME' => 'Όνομα ευκαιρίας πώλησης',
    'LBL_AN_MARKETING_OPPORTUNITY_AMOUNT' => 'Ποσό',
    ...
    'LBL_AN_MARKETING_ACCOUNT_NAME' => 'Όνομα λογαριασμού:',

    //Analytics labels for the marketing activities pivot
    'LBL_AN_MARKETINGACTIVITY_CAMPAIGN_NAME' => 'Όνομα Εκστρατείας',
    'LBL_AN_MARKETINGACTIVITY_ACTIVITY_DATE' => 'Ημ/νία δραστηριότητας',
    'LBL_AN_MARKETINGACTIVITY_ACTIVITY_TYPE' => 'Τύπος δραστηριότητας',
    'LBL_AN_MARKETINGACTIVITY_RELATED_TYPE' => 'Τύπος συσχετισμού',
    'LBL_AN_MARKETINGACTIVITY_RELATED_ID' => 'Related ID',

    //Analytics labels for the quotes pivot
    'LBL_AN_QUOTES_OPPORTUNITY_NAME' => 'Όνομα ευκαιρίας πώλησης',
    ...
    'LBL_AN_QUOTES_ACCOUNT_NAME' => 'Όνομα λογαριασμού:',
    'LBL_AN_QUOTES_CONTACT_NAME' => 'Όνομα Επαφής',
    'LBL_AN_QUOTES_ITEM_NAME' => 'Όνομα Είδους',
    ...
    'LBL_AN_QUOTES_ITEM_DISCOUNT_AMOUNT' => 'Ποσό Έκπτωσης',
    'LBL_AN_QUOTES_ITEM_TOTAL' => 'Item Total',
    'LBL_AN_QUOTES_GRAND_TOTAL' => 'Γενικό Σύνολο',
    'LBL_AN_QUOTES_ASSIGNED_TO' => 'Υπεύθυνος Χρήστης',
    'LBL_AN_QUOTES_DATE_CREATED' => 'Date Entered',
