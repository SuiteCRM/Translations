...
$mod_strings = array(
    ...
    'LNK_NEW_OPPORTUNITY' => 'Δημιουργία ευκαιρίας πώλησης',
...
//ABOUT page
    ...
    'LBL_TOUR_NOTIFICATIONS' => 'Ειδοποιήσεις',
    ...
    'LBL_FEATURING' => 'Τα πρόσθετα AOS, AOW, AOR, AOP, AOE και Reschedule είναι προσφορά της SalesAgility.',
    ...
    'LBL_CONTRIBUTOR_CONSCIOUS' => 'To Logo του SuiteCRM είναι προσφορά της Conscious Solutions',
    'LBL_CONTRIBUTOR_RESPONSETAP' => 'Συμβολή στην έκδοση SuiteCRM 7.3 από ResponseTap',
