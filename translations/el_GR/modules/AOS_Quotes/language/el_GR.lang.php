...
$mod_strings = array(
    ...
    'LBL_ADDRESS_INFORMATION' => 'Πληροφοριες Διευθυνσης',
    ...
    'LBL_MODULE_NAME' => 'Υπομνήματα',
    'LBL_MODULE_TITLE' => 'Προσφορές: Αρχική',
    'LBL_HOMEPAGE_TITLE' => 'Οι Προσφορές Μου',
    'LNK_NEW_RECORD' => 'Δημιουρία υπομνήματος',
    'LNK_LIST' => 'Προβολή Προσφορών',
    'LBL_SEARCH_FORM_TITLE' => 'Αναζήτηση Προσφορών',
    ...
    'LBL_TEMPLATE_DDOWN_C' => 'Πρότυπο Προσφοράς',
    ...
    'LBL_PRODUCT_NAME' => 'Προϊών',
    'LBL_PART_NUMBER' => 'Όνομα Παρτίδας',
    'LBL_PRODUCT_NOTE' => 'Σημέιωση',
    'LBL_PRODUCT_DESCRIPTION' => 'Περιγραφή',
    'LBL_LIST_PRICE' => 'Κατάλογος',
    ...
    'LBL_SERVICE_LIST_PRICE' => 'Κατάλογος',
    ...
    'LBL_CONVERT_TO_INVOICE' => 'Μετατροπή σε τιμολόγιο',
    'LBL_PRINT_AS_PDF' => 'Εκτύπωση σε PDF',
    'LBL_EMAIL_QUOTE' => 'Αποστολή προσφοράς με e-mail',
    'LBL_CREATE_CONTRACT' => 'Δημιουργία Συμβολαίου',
    'LBL_LIST_NUM' => 'Αριθ',
    'LBL_PDF_NAME' => 'Προσφορά',
    'LBL_EMAIL_NAME' => 'Προσφορά για',
    'LBL_QUOTE_DATE' => 'Ημερομηνία Προσφοράς',
    'LBL_NO_TEMPLATE' => 'ΣΦΑΛΜΑ\nΔεν βρέθηκαν πρότυπα. Εάν δεν έχετε δημιουργήσει ένα πρότυπο προσφοράς, μεταβείτε στο module PDF πρότυπα και δημιουργήστε ένα',
