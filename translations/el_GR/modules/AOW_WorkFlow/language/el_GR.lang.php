...
$mod_strings = array(
    ...
    'LBL_MODULE_NAME' => 'Ροή Εργασίας',
    'LBL_MODULE_TITLE' => 'Ροή Εργασίας',
    'LBL_HOMEPAGE_TITLE' => 'Οι Ροή Εργασίας μου',
    'LNK_NEW_RECORD' => 'Δημιουργία Ροής Εργασίας',
    'LNK_LIST' => 'Ροή Εργασίας',
    'LNK_PROCESSED_LIST' => 'Προβολή Ελέγχου Διαδικασίας',
    ...
    'LBL_NEW_FORM_TITLE' => 'Νέα Ροή Εργασίας',
    'LBL_FLOW_MODULE' => 'Ενότητα Ροής Εργασίας',
    'LBL_STATUS' => 'Κατάσταση',
    'LBL_FLOW_RUN_ON' => 'Εκτέλεση Σε',
    'LBL_CONDITION_LINES' => 'Συνθήκες',
    'LBL_ADD_CONDITION' => 'Προσθήκη Συνθήκης',
    'LBL_ACTION_LINES' => 'Ενέργειες',
