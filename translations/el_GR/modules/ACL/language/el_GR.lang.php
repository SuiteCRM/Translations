...
$mod_strings = array(
    ...
    'LBL_NO_ACCESS' => 'Δεν έχετε πρόσβαση σε αυτή την περιοχή. Παρακαλώ επικοινωνήστε με τον διαχειριστή του προγράμματος αν πιστεύετε πως πρέπει να έχετε πρόσβαση.',
