...
$mod_strings = array(
    ...
    'LBL_MODULE_NAME'                                                                => 'Ερευνητικές απαντήσεις',
    'LBL_MODULE_TITLE'                                                               => 'Ερευνητικές απαντήσεις',
    ...
    'LBL_SURVEYRESPONSES_SUBPANEL_TITLE'                                             => 'Ερευνητικές απαντήσεις',
    'LBL_NEW_FORM_TITLE'                                                             => 'New Survey Responses',
    'LBL_HAPPINESS'                                                                  => 'Happiness',
    'LBL_EMAIL_RESPONSE_SENT'                                                        => 'Email Response Sent',
    'LBL_SURVEYRESPONSES_SURVEYQUESTIONRESPONSES_FROM_SURVEYQUESTIONRESPONSES_TITLE' => 'Απαντήσεις σε ερωτήσεις έρευνας',
    'LBL_SURVEYRESPONSES_CONTACTS_FROM_CONTACTS_TITLE'                               => 'Επαφή',
    'LBL_SURVEYRESPONSES_ACCOUNTS_FROM_ACCOUNTS_TITLE'                               => 'Λογαριασμό',
    'LBL_SURVEYS_SURVEYRESPONSES_FROM_SURVEYS_TITLE'                                 => 'Έρευνα',
    'LBL_QUESTION_RESPONSES_DISPLAY'                                                 => 'Question Responses',
    'LBL_SURVEYRESPONSES_CAMPAIGNS_FROM_CAMPAIGNS_TITLE'                             => 'Εκστρατεία',
