...
$mod_strings = array(
    ...
    'LBL_LIST_FORM_TITLE' => 'Λίστα Συνθηκών',
    'LBL_MODULE_NAME' => 'Συνθήκες',
    'LBL_MODULE_TITLE' => 'Συνθήκες',
    'LBL_HOMEPAGE_TITLE' => 'Οι Συνθήκες μου',
    'LNK_NEW_RECORD' => 'Δημιουργία Συνθηκών',
    'LNK_LIST' => 'Εμφάνιση Συνθηκών',
    'LBL_SEARCH_FORM_TITLE' => 'Αναζήτηση Συνθηκών',
    'LBL_HISTORY_SUBPANEL_TITLE' => 'Προβολή Ιστορικού',
    'LBL_ACTIVITIES_SUBPANEL_TITLE' => 'Δραστηριότητες',
    'LBL_NEW_FORM_TITLE' => 'Νέες Συνθήκες',
    'LBL_LOGIC_OP' => 'Λογική',
    'LBL_MODULE_PATH' => 'Στοιχείο',
    'LBL_FIELD' => 'Πεδίο',
    'LBL_OPERATOR' => 'Χειριστής',
    'LBL_VALUE_TYPE' => 'Τύπος',
    'LBL_VALUE' => 'Τιμή',
    'LBL_ORDER' => 'Ιεραρχία',
    'LBL_CONDITION_OPERATOR' => 'Χειριστής Κατάστασης',
    'LBL_AOR_REPORT_ID' => 'ID Αναφοράς',
    'LBL_PARAMETER' => 'Παράμετρος',
