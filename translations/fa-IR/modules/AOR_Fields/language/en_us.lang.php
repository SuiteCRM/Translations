...
$mod_strings = array(
    ...
    'LBL_LIST_FORM_TITLE' => 'لیست فیلدها',
    'LBL_MODULE_NAME' => 'فیلدها',
    'LBL_MODULE_TITLE' => 'فیلدها',
    'LBL_HOMEPAGE_TITLE' => 'فیلدهای من',
    'LNK_NEW_RECORD' => 'ایجاد فیلدها',
    'LNK_LIST' => 'مشاهده فیلدها',
    'LBL_SEARCH_FORM_TITLE' => 'جستجوی فیلدها',
    'LBL_HISTORY_SUBPANEL_TITLE' => 'مشاهده تاریخچه',
    'LBL_ACTIVITIES_SUBPANEL_TITLE' => 'فعالیت‌ها',
    'LBL_NEW_FORM_TITLE' => 'فیلدهای جدید',
    'LBL_ORDER' => 'ترتیب',
    'LBL_MODULE_PATH' => 'ماژول',
    'LBL_FIELD' => 'فیلد',
    'LBL_DISPLAY' => 'نمایش',
    'LBL_LINK' => 'لینک',
    'LBL_LABEL' => 'عنوان',
    'LBL_FUNCTION' => 'تابع',
    'LBL_SORT' => 'مرتب‌سازی',
    'LBL_SORT_ORDER' => 'ترتیب مرتب سازی',
    'LBL_GROUP' => 'گروه',
    'LBL_GROUP_ORDER' => 'ترتیب گروه',
    'LBL_AUDIT_TABLE' => 'جدول رسیدگی',
    'LBL_TOTAL' => 'مجموع',
    'LBL_FORMAT' => 'گزینه‌های فرمت',
);
