...
$mod_strings = array(
    ...
    'LBL_LIST_FORM_TITLE' => 'لیست شرایط',
    'LBL_MODULE_NAME' => 'شرایط',
    'LBL_MODULE_TITLE' => 'شرایط',
    'LBL_HOMEPAGE_TITLE' => 'شرایط من',
    'LNK_NEW_RECORD' => 'ایجاد شرایط',
    'LNK_LIST' => 'مشاهده شرایط',
    'LBL_SEARCH_FORM_TITLE' => 'جستجوی شرایط',
    'LBL_HISTORY_SUBPANEL_TITLE' => 'مشاهده تاریخچه',
    'LBL_ACTIVITIES_SUBPANEL_TITLE' => 'فعالیت‌ها',
    'LBL_NEW_FORM_TITLE' => 'شرایط جدید',
    'LBL_LOGIC_OP' => 'منطق',
    'LBL_MODULE_PATH' => 'ماژول',
    'LBL_FIELD' => 'فیلد',
    'LBL_OPERATOR' => 'اپراتور',
    'LBL_VALUE_TYPE' => 'نوع',
    'LBL_VALUE' => 'مقدار',
    'LBL_ORDER' => 'ترتیب',
    'LBL_CONDITION_OPERATOR' => 'Condition Operator',
    'LBL_AOR_REPORT_ID' => 'شناسه گزارش',
    'LBL_PARAMETER' => 'پارامتر',
