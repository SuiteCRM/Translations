...
$mod_strings = array(
    ...
    'LBL_ASSIGNED_TO_NAME' => 'کاربر SuiteCRM',
    'LBL_ID' => 'شناسه',
    ...
    'LBL_DELETED' => 'حذف شده',
    'LBL_NAME' => 'نام کاربری اپ',
    'LBL_CREATED_USER' => 'کاربر ایجاد کننده',
    'LBL_MODIFIED_USER' => 'کاربر ویرایش کننده',
    'LBL_LIST_NAME' => 'نام',
    'LBL_LIST_FORM_TITLE' => 'لیست حساب های کاربری خارجی',
    'LBL_MODULE_NAME' => 'حساب های کاربری خارجی',
    'LBL_MODULE_TITLE' => 'حساب های کاربری خارجی',
    'LBL_HOMEPAGE_TITLE' => 'حساب های خارجی من',
    'LNK_NEW_RECORD' => 'ایجاد حساب های کاربری خارجی',
    'LNK_LIST' => 'مشاهده حساب های خارجی',
    'LBL_SEARCH_FORM_TITLE' => 'جستجوی منبع خارجی',
    'LBL_HISTORY_SUBPANEL_TITLE' => 'مشاهده تاریخچه',
    'LBL_ACTIVITIES_SUBPANEL_TITLE' => 'فعالیت‌ها',
    'LBL_NEW_FORM_TITLE' => 'حساب های جدید خارجی',
    'LBL_PASSWORD' => 'گذرواژه App',
    'LBL_USER_NAME' => 'نام کاربری اپ',
    'LBL_URL' => 'URL',
    'LBL_APPLICATION' => 'برنامه',
    'LBL_API_DATA' => 'داده های API',
    'LBL_API_CONSKEY' => 'Consumer Key',
    'LBL_API_CONSSECRET' => 'Consumer Secret',
    'LBL_API_OAUTHTOKEN' => 'توکن OAuth',
    'LBL_AUTH_UNSUPPORTED' => "این روش اجازه توسط نرم افزار پشتیبانی نمی شود",
    'LBL_AUTH_ERROR' => 'تلاش برای اتصال به این حساب انجام نشد.',
    'LBL_VALIDATED' => 'متصل شد',
    'LBL_ACTIVE' => 'فعال',
    'LBL_OAUTH_NAME' => '%s',
    'LBL_CONNECT_BUTTON_TITLE' => 'اتصال',
    'LBL_NOTE' => 'لطفا توجه داشته باشید',
    'LBL_CONNECTED' => 'متصل شد',
    ...
    'LBL_REAUTHENTICATE_LABEL' => 'تشخیص هویت مجدد',
