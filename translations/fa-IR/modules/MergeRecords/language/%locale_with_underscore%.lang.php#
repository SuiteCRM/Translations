...
$mod_strings = array(
    'LBL_MODULE_NAME' => 'ادغام رکوردها',
    'LBL_MODULE_TITLE' => 'ادغام سوابق: صفحه اصلی',
    'LBL_SEARCH_FORM_TITLE' => 'جستجوی ادغام',
    ...
    'LBL_NEXT_STEP_TITLE' => 'رفتن به مرحله بعدی',
    'LBL_NEXT_STEP_BUTTON_LABEL' => 'گام بعدی >',
    ...
    'LBL_CHANGE_PARENT' => 'تنظیم به عنوان اولیه',
    'LBL_REMOVE_FROM_MERGE' => 'حذف',
    'LBL_DIFF_COL_VALUES' => 'ستون متفاوت ارزش که در ردیف های اولیه از ارزش در ردیف ادغام:',
    'LBL_SAME_COL_VALUES' => 'Columns whose value is similar across all rows:',
    'LBL_DELETE_MESSAGE' => 'این اقدام پس از record(s) حذف کنید:',
    'LBL_PROCEED' => 'ادامه می دهید؟',
    'LBL_STEP1_DIRECTIONS' => 'یافتن رکورد تکراری ممکن است. در صورت امکان دو تایی یافت می شوند، که سوابق به ادغام با رکورد جاری را انتخاب کنید.',
);
