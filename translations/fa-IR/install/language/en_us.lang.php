...
$mod_strings = array(
    ...
    'ERR_PERFORM_CONFIG_PHP_1' => 'نمی تواند نوشتن فایل <span class=stop> config.php</span>.',
    ...
    'ERR_UPLOAD_MAX_FILESIZE' => 'اخطار: تنظیمات پی اچ پی شما باید تغییر کند تا اجازه دهد ،فایل هایی با حداقل 6 مگابایت آپلود شوند.',
    ...
    'LBL_DISABLED_DESCRIPTION_2' => 'پس از این تغییر ساخته شده است، شما ممکن است دکمه "شروع" برای شروع نصب در زیر کلیک کنید.  <i>پس از نصب کامل، شما می خواهید به تغییر ارزش برای \'installer_locked\' به \'واقعی\'.</i>',
