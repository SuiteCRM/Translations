...
',
        ...
        'layoutEditor' => array(
            ...
            'historyBtn' => 'Tarixçədən əvvəllər saxlanmış tərtibata baxmaq və bərpa etmək üçün <b>Tarixə Baxın</b> üzərinə klikləyin.<br><br><b>Görünüş Tarixçəsi</b> daxilində <b>bərpa et</b> əvvəllər saxlanmış düzənlərdə sahənin yerləşdirilməsini bərpa edir. Sahə etiketlərini dəyişdirmək üçün hər bir sahənin yanındakı Redaktə et işarəsinə klikləyin.',
            'historyDefault' => 'Tərtibatı orijinal düzəninə qaytarmaq üçün <b>Defoltu bərpa et</b> üzərinə klikləyin.<br><br><b>Defoltunu bərpa et</b> yalnız orijinal tərtibat daxilində sahənin yerləşdirilməsini bərpa edir. Sahə etiketlərini dəyişdirmək üçün hər bir sahənin yanındakı Redaktə et işarəsinə klikləyin.',
...
//BUTTONS
    ...
    'LBL_BTN_ADDFIELD' => 'Sahə əlavə et',
...
//Revert Module labels
    ...
    'fieldTypes' => array(
        ...
        'phone' => 'Telefon',
        'currency' => 'Valyuta',
        'html' => 'Yalnız oxumaq üçün HTML (köhnəlmişdir, TextBlock istifadə edin)',
        'radioenum' => 'Radio',
        'relate' => 'Bağlamaq',
        'address' => 'Ünvan',
        'text' => 'Mətn sahəsi',
        'textblock' => 'Mətn bloku',
        'url' => 'URL',
        'iframe' => 'IFrame',
