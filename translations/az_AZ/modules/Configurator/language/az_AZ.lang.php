...
$mod_strings = array(
    ...
    'LBL_SNOOZE_TIMER' => 'Bildirişlər üçün Mürgüləmə təyin edin',
    'SYSTEM_NAME_HELP' => 'Bu, brauzerinizin başlıq hissəsində görünən addır.',
    'LBL_LDAP_TITLE' => 'LDAP Authentication Support',
    'LBL_LDAP_LEGACY_WARNING' => 'LDAP Xəbərdarlığı',
    'LBL_LDAP_LEGACY_WARNING_MORE' => 'Bu LDAP konfiqurasiyası yalnız v4 API autentifikasiyası üçün istifadə olunacaq. SuiteCRM girişini LDAP-dan istifadə etmək üçün konfiqurasiya etmək üçün lazımi konfiqurasiyaları .env.local faylına əlavə edin. Ətraflı məlumat üçün LDAP konfiqurasiya sənədlərinə baxın.',
