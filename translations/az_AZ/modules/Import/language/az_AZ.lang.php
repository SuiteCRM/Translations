...
$mod_strings = array(
    'LBL_RECORDS_SKIPPED_DUE_TO_ERROR' => 'səhvlər səbəbiylə sıralar idxal edilmədi',
    'LBL_UPDATE_SUCCESSFULLY' => 'qeydlər uğurla yeniləndi',
    'LBL_SUCCESSFULLY_IMPORTED' => 'qeydlər yaradıldı',
    'LBL_STEP_4_TITLE' => 'Addım {0}: İdxal Faylı',
    'LBL_STEP_5_TITLE' => 'Step {0}: View Import Results',
    'LBL_CUSTOM_ENCLOSURE' => 'Fields Qualified By:',
    'LBL_ERROR_UNABLE_TO_PUBLISH' => 'Dərc edə bilmir. Eyni adlı bir başqa dərc edilmiş İdxal xəritəsi var.',
    'LBL_ERROR_UNABLE_TO_UNPUBLISH' => 'Unable to un-publish a map owned by another user. You own an Import map by the same name.',
    'LBL_ERROR_IMPORTS_NOT_SET_UP' => 'Bu modul növü üçün idxal edilmir',
    'LBL_IMPORT_TYPE' => 'What would you like to do with the imported data?',
    'LBL_IMPORT_BUTTON' => 'Create new records only',
    'LBL_UPDATE_BUTTON' => 'Yeni qeydlər yaradın və mövcud qeydləri yeniləyin',
    'LBL_CREATE_BUTTON_HELP' => 'Yeni qeydlər yaratmaq üçün bu seçimi istifadə edin. Qeyd: İdxal faylında mövcud qeydlərin ID\'lərinə uyğun olan dəyərləri ehtiva edən sətrlər, əgər dəyərlər ID sahəsi ilə əlaqələnirsə, idxal edilməyəcəkdir.',
    ...
    'LBL_VALUE' => 'Dəyər',
    'LBL_NONE' => 'Heç nə',
    'LBL_REQUIRED_VALUE' => 'Lazımi dəyər yoxdur',
    'LBL_ERROR_SYNC_USERS' => 'Invalid value to sync to Outlook: ',
    'LBL_ID_EXISTS_ALREADY' => 'ID artıq bu cədvəldə mövcuddur',
    'LBL_ASSIGNED_USER' => 'İstifadəçi mövcud deyilsə, hazırki istifadəçini istifadə edin',
    'LBL_ERROR_DELETING_RECORD' => 'Qeyd silinməsində səhv:',
    'LBL_ERROR_INVALID_ID' => 'Verilən ID sahəyə sığması üçün çox uzundur (ən çox uzunluq 36 simvoldur)',
    'LBL_ERROR_INVALID_PHONE' => 'Etibarsız telefon nömrəsi',
    'LBL_ERROR_INVALID_NAME' => 'String too long to fit in the field',
    'LBL_ERROR_INVALID_VARCHAR' => 'String too long to fit in the field',
    'LBL_ERROR_INVALID_DATE' => 'Etibarsız tarix',
    'LBL_ERROR_INVALID_DATETIME' => 'Etibarsız tarix-vaxt',
    'LBL_ERROR_INVALID_DATETIMECOMBO' => 'Etibarsız tarix-vaxt',
    'LBL_ERROR_INVALID_TIME' => 'Etibarsız vaxt',
    ...
    'LBL_IMPORT_MODULE_ERROR_NO_UPLOAD' => 'Fayl uğurla yüklənmədi. php.ini faylındaki \'upload_max_filesize\' dəyəri çox kiçik sayıda müəyyən edilmiş ola bilər',
    'LBL_MODULE_NAME' => 'İdxal',
    ...
    'ERR_IMPORT_SYSTEM_ADMININSTRATOR' => 'Sistem administrator istifadəçisini idxal edə bilməzsiniz',
    'ERR_MULTIPLE' => 'Bir neçə sütun eyni sahə adı ilə müəyyən edilmişdir.',
    ...
    'LBL_STEP_MODULE' => 'Hansı modula məlumatları idxal etmək istəyirsiniz?',
    ...
    'LBL_' => '',
    'LBL_CANNOT_OPEN' => 'İdxal olunan faylları oxumaq üçün aça bilmir',
    'LBL_NO_LINES' => 'İdxal faylınızda heç bir xətt aşkar edilmədi. Faylınızda boş bir xətt olmadığından əmin olun və yenidən cəhd edin.',
    'LBL_SUCCESS' => 'Success:',
    ...
    'LBL_IMPORT_FIELDDEF_DATE' => 'Tarix',
    'LBL_IMPORT_FIELDDEF_ASSIGNED_USER_NAME' => 'User Name or ID',
    'LBL_IMPORT_FIELDDEF_BOOL' => '\'0\' or \'1\'',
    'LBL_IMPORT_FIELDDEF_ENUM' => 'Siyahı',
    'LBL_IMPORT_FIELDDEF_EMAIL' => 'E-poçt Ünvanları',
    ...
    'LBL_ADD_ROW' => 'Sahə əlavə et',
    'LBL_REMOVE_ROW' => 'Remove Field',
    'LBL_DEFAULT_VALUE' => 'Defolt Dəyər',
    'LBL_SHOW_ADVANCED_OPTIONS' => 'View Import File Properties',
    'LBL_HIDE_ADVANCED_OPTIONS' => 'İdxal Faylının Xüsusiyyətlərini Gizlədin',
    'LBL_SHOW_NOTES' => 'Qeydlərə baxın',
    'LBL_HIDE_NOTES' => 'Hide Notes',
    'LBL_SAVE_MAPPING_AS' => 'İdxal parametrlərini saxlamaq üçün qeyd olunan parametrlər üçün ad verin:',
    'LBL_IMPORT_COMPLETE' => 'Çıxış',
    'LBL_IMPORT_COMPLETED' => 'İdxal Başa Çatdı',
    'LBL_IMPORT_RECORDS' => 'Importing Records',
    'LBL_IMPORT_RECORDS_OF' => 'dair',
    ...
    'LBL_DEFAULT_VALUE_HELP' => 'İdxal faylının sahəsində heç bir məlumat yoxdursa, yaradılmış və ya yenilənmiş qeyddə sahə üçün istifadə olunan dəyəri göstərin.',
