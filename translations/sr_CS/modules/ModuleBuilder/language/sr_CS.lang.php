...
$mod_strings = array(
    ...
    'help' => array(
        ...
        'searchViewEditor' => array(
            'modify' => 'Sva polja koja mogu biti prikazana pri <b>Filtritanju</b> se pojavljuju ovde.<br><br><b>Podrazumevana</b> kolona sadrži polja koja su prikazana u polju za pretragu.<br/><br/><b>Skrivena</b> kolona sadrži polja koja administrator može dodati polju za pretragu.'
        ,
            'savebtn' => 'Kliknite <b>Sačuvaj & Rasporedi</b> da bi ste sačuvali promene koje ste napravili i da ih učinite aktivnim u modulu.',
        ...
        'studioWizard' => array(
            ...
            'sugarPortalBtn' => 'Koristite <b>Izmena SuiteCRMPortal-a</b> da bi upravljali i prilagođavali SuiteCRMPortal.',
            ...
            'portalBtn' => 'Prilagodite <b>Rasporede</b> modula koji se prikazuju u <b>SuiteCRMPortal-u</b>.',
            ...
            'viewBtnDashlet' => 'Prilagodite <b>SuiteCRMDashlet</b> u modulima, uključujući pregled u vidu liste i pretragu SuiteCRMDashleta.<br><br>SuiteCRMDashlet će biti dostupan za dodavanje na stranicu u modulu Početna strana.',
            ...
            'addLayoutHelp' => "Da napravite prilagođeni raspored za Sigurnosnu grupu izaberite odgovarajuću Sigurnosnu grupu i raspored koji želite da kopirate kao početno stanje.",
            'searchHelp' => 'Obrasci <b>Filtera</b> ovde mogu da se prilagode.<br><br>Obrasci filtera sadrže polja za filtriranje zapisa.<br><br>Kliknite na ikonicu da odaberete raspored filtera za izmenu.',
            'dashletHelp' => 'Rasporedi <b>SuiteCRMDashlet-a</b> koji mogu da se prilagode se prikazuju ovde.<br><br>SuiteCRMDashlet će biti dostupan za dodavanje na stranama u modulu Početna strana.',
            'DashletListViewBtn' => '<b>SuiteCRMDashlet pregled u vidu liste</b> prikazuje zapise zasnovane na filterima pretrage SuiteCRMDashlet-a.',
            'DashletSearchViewBtn' => 'Filtrirani zapisi <b>SuiteCRMDashlet Pretrage</b> za pregled u vidu liste SuiteCRMDashlet-a.',
            ...
            'BasicSearchBtn' => 'Prilagodite obrazac <b>Brzog filtera</b> koji se prikazuje na jezičku Brzi Filter u prostoru za filtriranje modula.',
            'AdvancedSearchBtn' => 'Prilagodite obrazac <b>Naprednog filtera</b> koji se prikazuje na jezičku Napredni Filter u prostoru za filtriranje modula.',
            'portalHelp' => 'Upravljajte i prilagodite <b>SuiteCRMPortal</b>.',
            'SPUploadCSS' => 'Uvezite <b>Opis stilova</b> za SuiteCRMPortal.',
            'SPSync' => '<b>Sinhronizujte</b> prilagođavanja SuiteCRMPortal instance.',
            'Layouts' => 'Prilagodite <b>Rasporede</b> SuiteCRMPortal modula.',
            'portalLayoutHelp' => 'Ovde su prikazani moduli SuiteCRMPortala<br><br>Odaberite modul da izmenite <b>Rasporede</b>.',
        ...
        'portalSync' => array(
            'default' => 'Unesite <b>SuiteCRMPortal URL</b> portal instance da bi je ažurirali, i kliknite na <b>Idi</b>.<br><br>Onda unesite validno korisničko ime i lozinku Sugara, i zatim kliknite <b>Započni sinhronizaciju</b>.<br><br>Načinjena prilagođavanja na <b>Rasporedima</b> SuiteCRMportala, sve zajedno sa <b>Stilovima</b> ako su uvedeni, će biti prebačeni na određenu portal instancu.',
        ),
        'portalStyle' => array(
            'default' => 'Možete prilagoditi izgled SuiteCRMPortala koristeći stilove.<br><br>Odaberite <b>Stil</b> za uvoz.<br><br>Sledeći put kada se izvrši sinhronizacija, stilovi će biti implementirani u SuiteCRMportal.',
        ),
    ),
    ...
    'assistantHelp' => array(
        'package' => array(
            ...
            'afterSave' => 'Vaš novi paket treba da sadrži bar jedan modul. Možete da kreirate jedan ili više prilagođenih modula za paket.<br><br>Kliknite <b>Novi modul</b> da bi kreirali prilagođeni modul za ovaj paket.<br><br> Nakon kreiranja bar jednog modula, možete objaviti i rasporediti paket da bi ga učinili dostupnim za vašu instancu ili instance drugih korisnika.<br><br> Da bi rasporedili paket u jednom koraku kroz vašu SuiteCRMinstancu, kliknite <b>Rasporedi</b>.<br><br>Kliknite <b>Objavi</b> da bi sačuvali paket kao .zip fajl. Kada je .zip fajl sačuvan na vaš sistem, koristite <b>Module Loader</b> da uvezete i instalirate paket kroz vašu SuiteCRMinstancu. <br><br>Možete da distribuirate fajl drugim korisnicima da mogu da uvezu i instaliraju kroz njihove SuiteCRMinstance.',
        ...
        'module' => array(
            'somemodules' => "Obzirom da trenutni paket sadrži najmanje jedan modul, možete <b>Rasporediti</b> module u paketu kroz vašu SuiteCRMinstancu ili <b>Objaviti</b> paket da bi bio instaliran u trenutnoj SuiteCRMinstanci ili drugoj instanci koristeći <b>Module Loader</b>.<br><br>Da bi instalirali paket direktno kroz vašu SuiteCRMinstancu, kliknite <b>Rasporedi</b>.<br><br>Da bi kreirali .zip fajl za paket da bi mogao da se učita i instalira kroz tekuću SuiteCRMinstancu i druge instance koristeći <b>Module Loader</b>, kliknite <b>Objavi</b>.<br><br>Možete da kreirate module za ovaj paket u fazama, i objaviti ili rasporediti kada su spremni za to. <br><br>Nakon objavljivanja i raspoređivanja paketa, možete da menjate svojstva paketa i prilagođavate modul dalje. Onda ponovo objavite i ponovo rasporedite paket da bi se primenile promene.",
...
//STUDIO2
    ...
    'LBL_SUITEPORTAL' => 'Editor SuiteCRM portala',
    ...
    'LBL_CURRENCY' => 'Valuta',
    'LBL_DASHLET' => 'SuiteCRMdašlet',
    'LBL_DASHLETLISTVIEW' => 'Pregled SuiteCRMdašleta u vidu liste',
    'LBL_POPUP' => 'Popup pregled',
    'LBL_POPUPLISTVIEW' => 'Pregled popup-a u vidu liste',
    'LBL_POPUPSEARCH' => 'Pretraga popup-a',
    'LBL_DASHLETSEARCHVIEW' => 'Pretraga SuiteCRMdašleta',
    ...
    'LBL_QUICKCREATE' => 'Brzo kreiranje',
...
//ERRORS
    ...
    'ERROR_GENERIC_TITLE' => 'Došlo je do greške',
...
//EXPORT CUSTOMS
    ...
    'LBL_EC_VIEWS' => 'prilagođeni pogled(i)',
    'LBL_EC_SUITEFEEDS' => 'prilagođeni feed(ovi)',
    'LBL_EC_DASHLETS' => 'prilagođeni Dašlet(i)',
    'LBL_EC_CSS' => 'prilagođeni css(ovi)',
    'LBL_EC_TPLS' => 'prilagođeni tpl(ovi)',
    'LBL_EC_IMAGES' => 'prilagođena slika(e)',
    'LBL_EC_JS' => 'prilagođeni js(ovi)',
    'LBL_EC_QTIP' => 'prilagođeni qtip(ovi)',
...
//AJAX STATUS
    ...
    'LBL_AJAX_RESPONSE_MESSAGE' => 'Ove operacija je završena uspešno',
    'LBL_AJAX_LOADING_TITLE' => 'U toku..',
    'LBL_AJAX_LOADING_MESSAGE' => 'Molimo sačekajte, učitavanje..',
...
//Revert Module labels
    ...
    'fieldTypes' => array(
        ...
        'bool' => 'Checkbox',
        'enum' => 'DropDown',
        'dynamicenum' => 'Dinamički padajući meni',
    ...
    'labelTypes' => array(
        "frequently_used" => "Često korišteni tagovi",
        "all" => "Sve labele",
    ),
