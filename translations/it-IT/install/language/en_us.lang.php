...
$mod_strings = array(
    ...
    'ERR_CHECKSYS_CONFIG_NOT_WRITABLE' => 'Il file di configurazione esiste ma non è scrivibile. Si prega di prendere le misure necessarie per rendere il file scrivibile.',
    'ERR_CHECKSYS_CONFIG_NOT_FOUND' => 'Il tuo config.php non esiste. Sarà creato durante l\'installazione.',
    'ERR_CHECKSYS_CONFIG_OVERRIDE_NOT_WRITABLE' => 'Il file config_override esiste ma non è scrivibile. Si prega di adottare le misure necessarie per rendere il file scrivibile. ',
    'ERR_CHECKSYS_CUSTOM_NOT_WRITABLE' => 'La directory custom esiste ma non è scrivibile. Si prega di adottare le misure necessarie per rendere il file scrivibile.',
    'ERR_CHECKSYS_FILES_NOT_WRITABLE' => "I file o le directory sopra elencati non sono scrivibili o mancano e non possono essere creati. Si prega di adottare le misure necessarie per rendere le directory scrivibili.",
    'ERR_CHECKSYS_LOGS_NOT_WRITABLE' => 'La directory di log non è attualmente scrivibile',
    'ERR_CHECKSYS_CACHE_NOT_WRITABLE' => 'La directory cache non è attualmente scrivibile',
    'ERR_CHECKSYS_EXTENSIONS_NOT_WRITABLE' => 'La directory delle estensioni (Extensions) non è attualmente scrivibile',
    'ERR_CHECKSYS_SECRETS_NOT_WRITABLE' => 'La directory config/secrets non è attualmente scrivibile',
    'ERR_CHECKSYS_ENV_NOT_WRITABLE' => 'Il file .env o la directory che lo contiene non è scrivibile.',
    ...
    'ERR_DB_LOGIN_FAILURE_SHORT' => 'Errore di Connessione del Database: L\'hostname, porta, nome utente e/o password del database fornito non è valido.',
    ...
    'LBL_CANCEL' => 'Annulla',
    'LBL_ACCEPT' => 'Accetta',
    'LBL_CHECKSYS_LEGACY_CACHE' => 'Sotto-Directory Cache Legacy Scrivibili',
    'LBL_CHECKSYS_CACHE' => 'Directory Cache Sub scrivibili',
    'LBL_CHECKSYS_EXTENSIONS' => 'Directory Estensioni (Extensions) Scrivibile',
    'LBL_CHECKSYS_SECRETS' => 'Directory Config/Secrets Scrivibili',
    'LBL_CHECKSYS_LOGS' => 'Directory Di Log Scrivibile',
    ...
    'LBL_CHECKSYS_ENV' => 'File .env scrivibile',
    ...
    'LBL_CHECKSYS_INTL_EXTENSIONS' => 'Intl esiste in Extensions',
    'LBL_CHECKSYS_JSON_EXTENSIONS' => 'Json esiste in Extensions',
    'LBL_CHECKSYS_GD_EXTENSIONS' => 'GD esiste in Extensions',
    'LBL_CHECKSYS_OPENSSL_EXTENSIONS' => 'OpenSSL esiste in Extensions',
    'LBL_CHECKSYS_ZIP_EXTENSIONS' => 'Zip esiste in Extensions',
    'LBL_CHECKSYS_PDO_MYSQL_EXTENSIONS' => 'PDO MySQL esiste in Extensions',
    'LBL_CHECKSYS_CURL_EXTENSIONS' => 'cURL esiste in Extensions',
    'LBL_CHECKSYS_MBSTRING_EXTENSIONS' => 'MB Strings esiste in Extensions',
    'LBL_CHECKSYS_MYSQLI_EXTENSIONS' => 'MySQLi esiste in Extensions',
    'LBL_CHECKSYS_SOAP_EXTENSIONS' => 'Soap esiste in Extensions',
    'LBL_CHECKSYS_XML_EXTENSIONS' => 'XML esiste in Extensions',
    'LBL_CHECKSYS_IMAP_EXTENSIONS' => 'IMAP esiste in Extensions (opzionale)',
    'LBL_CHECKSYS_LDAP_EXTENSIONS' => 'LDAP esiste in Extensions (facoltativo)',
    'LBL_PHP_CHECKS' => 'Controlli PHP',
    'LBL_SERVER_CHECKS' => 'Controlli Server',
    'LBL_PERMISSION_CHECKS' => 'Controlli Permessi',
    'LBL_CHECK_FAILED' => 'Controllo Fallito: ',
    'ERR_CHECKSYS_INTL' => 'L\'estensione Intl non è installata, contattare l\'amministratore di sistema',
    'ERR_CHECKSYS_JSON' => 'L\'estensione JSON non è abilitata, si prega di contattare l\'amministratore di sistema.',
    'ERR_CHECKSYS_GD' => 'L\'estensione GD non è abilitata, si prega di contattare l\'amministratore di sistema.',
    'ERR_CHECKSYS_OPENSSL' => 'L\'estensione OpenSSL non è abilitata, si prega di contattare l\'amministratore di sistema.',
    'ERR_CHECKSYS_PDO_MYSQL' => 'L\'estensione PDO MySQL non è abilitata, si prega di contattare l\'amministratore di sistema.',
    'ERR_CHECKSYS_MYSQLI' => 'L\'estensione MySQLi non è abilitata, si prega di contattare l\'amministratore di sistema.',
    'ERR_CHECKSYS_SOAP' => 'L\'estensione Soap non è abilitata, si prega di contattare l\'amministratore di sistema.',
    ...
    'LBL_UNWRITABLE_SUB_DIR' => 'Ci sono alcune sotto-directory che non sono scrivibili. Si prega di prendere le misure necessarie per rendere le directory scrivibili ',
    'LBL_REFER_TO_LOGS' => 'C\'è stato un problema in uno dei controlli di pre-installazione, si prega di fare riferimento all\'install.log',
    'LBL_NOT_A_VALID_SUITECRM_PAGE' => 'Impossibile trovare il titolo SuiteCRM. Questa non è una pagina SuiteCRM valida.',
    'LBL_NOT_COOKIE_OR_TOKEN' => 'Impossibile trovare i cookie, nessun token valido trovato. Si prega di fare riferimento all\'install.log per ulteriori informazioni.',
    'LBL_CURL_JSON_ERROR' => 'Il risultato della chiamata curl alla pagina graphql era vuoto.',
    'LBL_UNABLE_TO_FIND_SYSTEM_CONFIGS' => 'Impossibile recuperare le Configurazioni di sistema sulla pagina di Graphql. Fare riferimento all\'install.log per maggiori informazioni.',
    'LBL_CURL_REQUEST_MAIN_PAGE' => 'Richiesta curl sulla pagina principale',
    'LBL_CURL_REQUEST_API_PAGE' => 'Richiesta curl su Api',
    'LBL_ERROR_DETAILS' => 'Dettagli Errore',
    'LBL_ERROR' => 'Errore',
    'LBL_WARNING_DETAILS' => 'Dettagli Warning',
    'LBL_WARNING' => 'Avviso',
    'LBL_SYSTEM_CHECKS' => 'CONTROLLI DI SISTEMA',
    'LBL_CRON_INSTRUCTIONS_1' => 'Per eseguire SuiteCRM Schedulers, modificare il file crontab degli utenti del server web con questo comando:',
    'LBL_CRON_INSTRUCTIONS_2' => 'e aggiungi la seguente riga al file crontable:',
    'LBL_CRON_INSTRUCTIONS_3' => 'Si dovrebbe fare questo solo dopo che l\'installazione è conclusa.',
    'LBL_CRON_CONFIGURATION' => 'CONFIGURAZIONE CRON',
    'LBL_SETUP_CRONTAB' => 'Per impostare il Crontab',
    'LBL_ROUTE_ACCESS_CHECK' => 'CONTROLLO DI ACCESSO ROUTE',
    'LBL_PHP_MEM_1' => 'Il tuo limite di memoria PHP è ',
    'LBL_PHP_MEM_2' => '. Questo deve essere un minimo di ',
    'LBL_PHP_MEM_3' => 'M per continuare.',
    'LBL_CLOSE' => 'Chiudi',
    'LBL_THREE' => '3',
    ...
    'LBL_DBCONF_DB_PORT' => 'Porta del Database',
    ...
    'LBL_DISABLED_DESCRIPTION_3' => 'Dopo aver apportato questa modifica, si prega di rivedere / ricaricare questa pagina per continuare.',
    ...
    'LBL_APP_NOT_INSTALLED' => 'SuiteCRM non è installato. Il punto d\'entrata necessita di SuiteCRM installato, sei prima pregato d\'installarlo.',
    ...
    'LBL_SILENT_INSTALL_SUCCESS' => 'SuiteCRM disinstallato correttamente.',
    'LBL_SILENT_INSTALL_FAILED' => 'Installazione di SuiteCRM fallita.',
    ...
    'LBL_PRE_INSTALL_REQ' => 'Requisiti pre-installazione',
    ...
    'LBL_WELCOME' => 'Benvenuto in SuiteCRM',
...
$contact_user_link_guid',
    ...
    'LBL_SYS_CHECK_WARNING' => 'Ignora gli Avvisi del Controllo di Sistema',
    'LBL_PROCEED' => 'PROCEDI',
    'LBL_RECHECK' => 'Nuova Verifica',
    'LBL_CONFIG' => 'CONFIGURAZIONE',
    'LBL_VALIDATION_ERRORS' => 'Ci sono errori di convalida, impossibile eseguire l\'azione.'
);
