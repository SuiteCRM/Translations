...
$mod_strings = array(
    ...
    'LBL_TIME_AGO' => 'fa',
// Activity stream
    'CREATED_CONTACT' => 'ha creato un <b>NUOVO</b> {0}', // For fusional (inflected) languages: used in the sentence "Administrator created a new contact"
    'CREATED_OPPORTUNITY' => 'ha creato un <b>NUOVO</b> {0}', // For fusional (inflected) languages: used in the sentence "Administrator created a new opportunity"
    'CREATED_CASE' => 'ha creato un <b>NUOVO</b> {0}', // For fusional (inflected) languages: used in the sentence "Administrator created a new case"
    'CREATED_LEAD' => 'ha creato un <b>NUOVO</b> {0}', // For fusional (inflected) languages: used in sentence "Administrator created a new lead"
