...
$contact_user_link_guid',
    ...
    'NEW_LOGO_HELP' => 'Формат файлу зображення може бути «. png» або. jpg. Максимальна висота-170px, і найбільша ширина-450px. Завантажені зображення, що більші за вказаними параметрами, будуть зменшенні до цих розмірів.',
