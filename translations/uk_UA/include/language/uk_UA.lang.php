...
//e.g. auf Deutsch 'Contacts'=>'Contakten',
    ...
    'moduleList' => array(
        ...
        'Schedulers' => 'Планувальник завдань',
        'Project' => 'Проекти',
        'ProjectTask' => 'Проектні завдання',
        'Campaigns' => 'Маркет. кампанії',
        'CampaignLog' => 'Журнал маркет. кампанії',
        'Documents' => 'Документи',
        'DocumentRevisions' => 'Версії документів',
        ...
        'ACLRoles' => 'Ролі',
        'InboundEmail' => 'Облікові записи вхідної пошти',
        'Releases' => 'Версії',
        'Prospects' => 'Огляд потенційних клієнтів',
        'Queues' => 'Черги',
        'EmailMarketing' => 'Маркетинг через електронну пошту',
...
//       it is the key for the default case_relationship_type_dom value
    ...
    'snooze_alert_timer' => array(
        60 => 'Відкласти на 1 хвилину',
        300 => 'Відкласти на 5 хвилин',
        600 => 'Відкласти на 10 хвилин',
        900 => 'Відкласти на 15 хвилин',
        1800 => 'Відкласти на 30 хвилин',
        3600 => 'Відкласти на 1 годину',
        7200 => 'Відкласти на 2 години',
        10800 => 'Відкласти на 3 години',
        18000 => 'Відкласти на 5 годин',
        86400 => 'Відкласти на 1 день',
    ),
...
//prospect list type dom
    ...
    'campainglog_activity_type_dom' => array(
        ...
        'viewed' => 'Переглянуті',
        'removed' => 'Ті, що відписалися',
        'lead' => 'Створені попер. конт.',
...
$app_strings = array(
    'LBL_SEARCH_RESULTS_TITLE' => 'Результати',
    ...
    'LBL_LOGOUT' => 'Вийти',
    'LBL_LOGOUT_SUCCESS' => 'Вихід здійснено успішно',
    'LBL_LOGGED_OUT_MESSAGE' => 'Ви вийшли з системи',
    'LBL_LOGIN_AGAIN' => 'Увійти знову ',
    'LBL_TOUR_NEXT' => 'Далі',
    ...
    'LBL_DELETE_INLINE' => 'Видалення', /*for 508 compliance fix*/
    ...
    'ERR_TIMEOUT' => "Примусово завершитися з помилкою, якщо виникне тайм-аут",
    ...
    'LBL_EMAIL_ADDRESS_BOOK_FILTER' => 'Пошук',
    ...
    'LBL_EMAIL_OPT_OUT' => 'Ті, що відписалися',
    ...
    'ERR_UNAUTHORIZED_PAGE_ACCESS' => 'У вас немає привілей для перегляду цієї сторінки.',
    'ERR_UNAUTHORIZED_PAGE_ACCESS_TO_HOME_PAGE' => 'Ви не авторизовані для перегляду цієї сторінки. Переспрямування до домашньої сторінки...',
    ...
    'LBL_CHARSET' => 'UTF-8',
    'LBL_CHARTS' => 'Графіки',
    'LBL_QUICK_CHARTS' => 'Швидкі діаграми',
    'LBL_QUICK_HISTORY' => 'Хронологія',
    ...
    'LBL_CURRENT_USER_FILTER' => 'Мої об\'єкти',
    'LBL_CURRENCY' => 'Валюта',
    ...
    'LBL_DELETE_BUTTON' => 'Видалення',
    'LBL_DELETE' => 'Видалення',
    ...
    'LBL_EXPORT' => 'Експорт',
    'LBL_FAVORITES_FILTER' => 'Мої вподобання',
    ...
    'LBL_CAMPAIGNS' => 'Маркет. кампанії',
    'LBL_CAMPAIGNLOG' => 'Журнал маркетингових кампаній',
    'LBL_CAMPAIGN_CONTACT' => 'Маркет. кампанії',
    ...
    'LBL_LOG_ENTRIES_REMOVED_TITLE' => 'Ті, що відписалися',
    'LBL_LOG_ENTRIES_LEAD_TITLE' => 'Створені попер. конт.',
    ...
    'LBL_SNOOZE' => 'Відкласти',
    'LBL_SNOOZE_INLINE_CONFIRM' => 'Відкласти? ({{preferences.snooze_alert_timer|enum:snooze_alert_timer_simple}})',
    ...
    'LBL_ALERT_DISMISS_ERROR' => 'Не вдалося відхилити тривожне сповіщення',
    'LBL_ALERT_DISMISS_ALL_SUCCESS' => 'Тривожні сповіщення були відхилені',
    'LBL_DISMISS_ALL' => 'Відхилити всі',
    'LBL_VERIFY' => 'Перевірка',
    'LBL_RESEND' => 'Надіслати повторно',
    'LBL_RECORD_DOES_NOT_EXIST' => 'Помилка отримання запису. Можливо, запис був видалений, або ви можете не мати дозволу на перегляд.',
    'LBL_PROFILE' => 'Профіль',
    'LBL_PROFILE_EDIT' => 'Редагувати профіль',
    ...
    'LBL_FILTER' => 'Пошук',
    'LBL_CLEAR_FILTER' => 'Очистити фільтр',
    'LBL_FILTER_MODULES' => 'Фільтр модулів',
    'LBL_SEARCH' => 'Знайти',
    'LBL_SEARCH_ALT' => '',
    ...
    'LBL_SCENARIO_MARKETING' => 'Розсилка',
    ...
    'LBL_BASIC_FILTER' => 'Спрощений фільтр',
    'LBL_QUICK' => 'Швидко',
    ...
    'LBL_SCHEDULE_CALL' => 'Призначити дзвінок',
    'LBL_SCHEDULE_MEETING' => 'Призначити зустріч',
    'LBL_CREATE_TASK' => 'Створити завдання',
    //web to lead
...
"5. Натисніть опцію \'Імпорт\' у меню \'Дії\' програми та виберіть файл для завантаження"
   ',
    ...
    'ERR_NOTIFICATIONS_MARK_AS_READ' => 'Помилка при спробі позначити сповіщення, як прочитані',
    'ERR_FIELD_LOGIC_BACKEND_CALCULATION' => 'Помилка при спробі отримати значення',
    ...
    'LBL_DELETE_BUTTON_LABEL' => 'Видалення',
    'LBL_DELETE_BUTTON_TITLE' => 'Видалення',
    'LBL_BULK_ACTION_BUTTON_LABEL' => 'Масова обробка даних',
    'LBL_BULK_ACTION_BUTTON_LABEL_MOBILE' => 'Дія',
    'LBL_TOO_FEW_SELECTED' => 'Недостатня кількість обраних записів, будь ласка, оберіть щонайменше {min} записів.',
    'LBL_TOO_MANY_SELECTED' => 'Забагато обраних записів, будь ласка, оберіть не більше ніж {max} записів.',
    'LBL_SELECT_ALL_NOT_ALLOWED' => 'Дану дію не можна виконати над усіма записами. Будь ласка, оберіть окремі записи.',
    'LBL_MISSING_HANDLER_DATA' => 'Несподівана помилка. Програма масової обробки даних не повернула результат',
    'LBL_MISSING_HANDLER' => 'Несподівана помилка. Для масової обробки не зареєстрована програма, яка буде виконувати цю дію',
    'LBL_MISSING_HANDLER_DATA_ROUTE' => 'Несподівана помилка. Пропущено маршрут даних для масової обробки',
    'LBL_ACTION_ERROR' => 'Несподівана помилка під час виклику дії',
    'LBL_BULK_ACTION_ERROR' => 'Несподівана помилка під час виклику масової обробки',
    'LBL_BULK_ACTION_DELETE_SUCCESS' => 'Записи було видалено',
    'LBL_BULK_ACTION_MASS_UPDATE_CONFIRMATION' => 'Чи бажаєте видалити вибрані записи?',
    'LBL_BULK_ACTION_MASS_UPDATE_SUCCESS' => 'Всі записи було оновлено',
    'LBL_BULK_ACTION_MASS_UPDATE_PARTIAL_SUCCESS' => 'Частковий успіх. Деякі записи не були оновлені. Будь ласка, перевірте журнал звіту',
    'LBL_BULK_ACTION_MASS_UPDATE_NO_FIELDS' => 'Немає полів для оновлення',
    'LBL_BULK_ACTION_MASS_UPDATE_NO_RECORDS' => 'Немає записів для оновлення',
    'LBL_BULK_ACTION_MASS_UPDATE_NO_ACLS' => 'Недостатньо привілей, дія "Збереження" не дозволяється',
    'LBL_UNEXPECTED_ERROR' => 'Несподівана помилка. Не вдалося виконати дію.',
    'LBL_RECORD_DELETE_SUCCESS' => 'Запис успішно видалено',
    'LBL_RECORD_DELETE_ALL_SUCCESS' => 'Записи було видалено',
    'LBL_RECORD_SNOOZE_SUCCESS' => 'Сповіщення було відкладене',
    'LBL_ERROR_SAVING' => 'Сталася помилка під час збереження запису',
    ...
    'ANNUAL_REVENUE_BY_ACCOUNTS' => 'Щорічний дохід по Контрагентах',
    'PIPELINE_BY_SALES_STAGE' => 'Діаграма стадій загальних продажів',
    'LEADS_BY_SOURCE' => 'Ліди за джерелом',
    'LEADS_BY_STATUS' => 'Ліди за статусом',
    'ACCOUNT_TYPES_PER_MONTH' => 'Нові Контрагенти по місяцях',
    ...
    'LBL_SUITE_DESC1' => 'SuiteCRM було записано та зібрано <a href="https://salesagility.com">SalesAgility</a>. Програма надається так, ЯК ВОНА Є, без гарантії. Ліцензія розміщена згідно AGPLv3.',
    ...
    'LBL_SUITE_DESC3' => 'SuiteCRM є торговою маркою компанії SalesAgility Ltd. Всі інші компанії та назви продуктів можуть бути торговими марками відповідних компаній, з якими вони пов\'язані.',
    ...
    'LBL_PROSPECT_LIST_NAME' => 'Цільові списки',

    //List View Column Selector Modal
    'LBL_COLUMN_SELECTOR_DISPLAYED_COLS' => 'ПОКАЗАНЕ',
    'LBL_COLUMN_SELECTOR_HIDDEN_COLS' => 'ПРИХОВАНЕ',
    'LBL_COLUMN_SELECTOR_CLOSE_BUTTON' => 'Закрити',
    'LBL_COLUMN_SELECTOR_SAVE_BUTTON' => 'Зберегти зміни',
    'LBL_COLUMN_SELECTOR_MODAL_TITLE' => 'Виберіть стовпці',
    ...
    'LBL_ENABLE' => 'Включити',
    'LBL_ENABLED' => 'Доступний',
    'LBL_DISABLE' => 'Відключити',
...
$app_list_strings['aor_scheduled_reports_status_dom']['active'] = 'Активний';
...
$app_list_strings['date_time_period_list']['this_month'] = 'Цей місяць';
...
$app_list_strings['aow_status_list']['Active'] = 'Активний';
...
$app_strings['LBL_RESCHEDULE_COUNT'] = 'Спроби дзвінка';
...
$app_strings['LBL_SUBPANEL_FILTER_LABEL'] = 'Пошук';
...
$app_strings['LBL_OPT_IN_OPT_OUT'] = 'Ті, що відписалися';
$app_strings['LBL_OPT_IN_INVALID'] = 'Недійсне';

/** @see SugarEmailAddress */
$app_list_strings['email_settings_opt_in_dom'] = array(
    'not-opt-in' => 'Заблокований',
...
$app_strings['LBL_GOOGLE_SYNC_ERR'] = 'SuiteCRM Google Sync - ПОМИЛКА';
...
$app_strings['LBL_OPT_OUT'] = 'Відмовитися від розсилання';
$app_strings['LBL_INVALID_EMAIL'] = 'Недійсне';
$app_strings['LBL_PRIMARY'] = 'Основний';
$app_strings['LBL_EMAIL_ADDRESS'] = 'Адреса електронної пошти';
...
$app_strings['LBL_INSIGHTS'] = 'Аналітика';
$app_strings['LBL_CHARTS'] = 'Графіки';
$app_strings['LBL_CHART_NOT_FOUND'] = 'Графік не знайдено';
$app_strings['LBL_NO_DATA'] = 'Немає даних';
$app_strings['LBL_ERROR_FETCHING_METADATA'] = 'Сталася помилка при отриманні метаданих';
$app_strings['LBL_TOTAL'] = 'Всього';
$app_strings['LBL_ACTIONS'] = 'Дії';
$app_strings['LBL_SELECT_SUBPANEL_BANNER'] = 'Виберіть, які вкладені панелі показувати';
$app_strings['LBL_SELECT_ITEM'] = 'Оберіть елемент';
$app_strings['LBL_ITEMS_SELECTED'] = 'елементів вибрано';
$app_strings['LBL_WIDGET_NOT_FOUND'] = 'Віджет не знайдено';
$app_strings['LBL_BAD_CONFIG'] = 'Неправильна конфігурація';
$app_strings['LBL_CONFIG_BAD_CONTEXT'] = 'Неправильна конфігурація: контекст не налаштований належним чином';
$app_strings['LBL_CONFIG_NO_CONFIG'] = 'Неправильна конфігурація: відсутня конфігурація';
$app_strings['LBL_CONFIG_NO_STATISTICS_KEY'] = 'Неправильна конфігурація: відсутній ключ від статистики';
$app_strings['LBL_STATISTIC_ERROR'] = 'Помилка при завантаженні статистики';
$app_strings['LBL_STATISTIC_ERROR_DESC'] = 'Помилка при завантаженні статистики';
$app_strings['LBL_STATISTIC_ERROR_DESC_TOOLTIP'] = 'Помилка завантаження статистики. Будь ласка, зверніться до адміністратора';
$app_strings['LBL_AVERAGE_CLOSED_WON_PER_YEAR'] = 'Середня кількість виграних Можливостей на рік';
$app_strings['LBL_OPPORTUNITIES_TOTAL'] = 'Загальна вартість Можливостей';
$app_strings['LBL_CASE_TOTAL_DAYS_OPEN'] = 'Всього відкрито днів';
$app_strings['LBL_DAYS_OPEN'] = 'Відкритих днів';
$app_strings['LBL_DAYS_IN_SALE_STAGE'] = 'DAY(S) THIS OPPORTUNITY HAS BEEN AT THIS SALES STAGE';
$app_strings['LBL_STAT_DAYS'] = 'Днів';
$app_strings['LBL_CLOSED_PER_YEAR'] = 'Закрито протягом року';
$app_strings['LBL_WAS_OPEN'] = 'Це звернення було відкрите протягом';
$app_strings['LBL_HAS_BEEN_OPEN'] = 'Це звернення залишається відкрите протягом';
$app_strings['LBL_NUMBER_OF_CASES_PER_ACCOUNT'] = 'Кількість Звернень по Контрагентах';
$app_strings['LBL_TOTAL_CASES_FOR_THIS_ACCOUNT'] = 'Total Cases For This Account';
$app_strings['LBL_NONE_OUTSTANDING'] = 'Немає';
$app_strings['LBL_VALIDATION_ERROR_REQUIRED'] = 'Відсутнє обов\'язкове поле: {{fields.field.label}}';
$app_strings['LBL_VALIDATION_ERROR_CURRENCY_FORMAT'] = "Невірний формат коду валюти. Очікується: '{{context.expected}}'";
$app_strings['LBL_VALIDATION_ERROR_INT_FORMAT'] = "Невірний формат цілого числа. Очікується: '{{context.expected}}'";
$app_strings['LBL_VALIDATION_ERROR_FLOAT_FORMAT'] = "Невірний формат дійсного числа. Очікується: '{{context.expected}}'";
$app_strings['LBL_VALIDATION_ERROR_DATE_FORMAT'] = "Невірний формат дати. Очікується: '{{context.expected}}'";
$app_strings['LBL_VALIDATION_ERROR_DATETIME_FORMAT'] = "Невірний формат дати та часу. Очікується: '{{context.expected}}'";
...
$app_strings['LBL_VALIDATION_ERROR_EMAIL_FORMAT'] = "Невірний формат електронної поштової адреси. Очікується: '{{context.expected}}'";
$app_strings['LBL_VALIDATION_ERROR_PHONE_FORMAT'] = "Неправильний формат номера телефону.";
$app_strings['LBL_VALIDATION_ERROR_MIN'] = "Неприпустиме значення. Значення має бути більше або рівним '{{context.min}}";
$app_strings['LBL_VALIDATION_ERROR_MAX'] = "Неприпустиме значення. Значення повинно бути менше або рівним '{{context.max}}";
$app_strings['LBL_MULTIPLE_PRIMARY_EMAIL_VALIDATION_ERROR'] = "Only one Valid Email Address should be marked as primary";
$app_strings['LBL_DUPLICATE_EMAIL_VALIDATION_ERROR'] = "Не можна використовувати адресу електронної пошти одну й ту саму двічі";
...
$app_strings['LBL_VALIDATION_ERRORS'] = 'При перевірці були знайдені помилки, дію не вдалося виконати.';
$app_strings['LBL_LOADING_IN_PROGRESS'] = 'Обчислення триває, будь ласка, зачекайте кілька хвилин перед повторною спробою.';
$app_strings['LBL_SELECT_EMAIL_FOR_TEST'] = 'Please Select Targets/ Users or Enter an Email';
$app_strings['LBL_TYPE_TO_SEARCH'] = 'Шукати...';
$app_strings['LBL_SEARCHING'] = 'виконується пошук...';
$app_strings['LBL_NOT_FOUND'] = 'Не знайдено.';
$app_strings['LBL_SEARCH_ERROR'] = 'Помилка пошуку.';
$app_strings['LBL_FOUND'] = 'Знайдено';
$app_strings['LBL_GET_RECORD_LIST_ERROR'] = 'Сталася помилка при отриманні записів';
$app_strings['LBL_NUMBER_OF_RECORDS'] = 'Кількість записів';
...
$app_strings['LBL_CONTRACT_RENEWAL_TOOLTIP'] = 'Дата наступного поновлення угоди';
$app_strings['LBL_INVOICES_OVERDUE_TOOLTIP'] = 'Загальна кількість прострочених рахунків';
$app_strings['LBL_ACTIVITIES_NEXT_DATE_TOOLTIP'] = 'Дата наступної взаємодії';
$app_strings['LBL_CAMPAIGN_LAST_RECEIVED_TOOLTIP'] = 'Дата останньої Маркетингової Кампанії, що була отримана';
$app_strings['LBL_OPEN_CASES_COUNT_TOOLTIP'] = 'Загальна кількість відкритих Звернень';
$app_strings['LBL_EVENTS_LAST_DATE_TOOLTIP'] = 'Дата останньої події';
$app_strings['LBL_HISTORY_LAST_DATE_TOOLTIP'] = 'Дата останньої взаємодії';
$app_strings['LBL_OPPORTUNITIES_TOTAL_SUM_TOOLTIP'] = 'Загальна сума Можливостей';
$app_strings['LBL_QUOTES_EXPIRY_TOOLTIP'] = 'Дата наступного закінчення пропозиції';
$app_strings['LBL_DEFAULT_TOTAL_TOOLTIP'] = 'Загальна кількість записів';
$app_strings['LBL_CONTRACT_RENEWAL'] = 'Дата поновлення';
$app_strings['LBL_INVOICES_OVERDUE'] = 'Загальна кількість прострочених';
$app_strings['LBL_ACTIVITIES_NEXT_DATE'] = 'Дата наступної активності';
$app_strings['LBL_CAMPAIGN_LAST_RECEIVED'] = 'Останній раз брали участь';
$app_strings['LBL_OPEN_CASES_COUNT'] = 'Відкриті звернення';
$app_strings['LBL_EVENTS_LAST_DATE'] = 'Остання подія, що була відвідана';
$app_strings['LBL_HISTORY_LAST_DATE'] = 'Остання точка дотику';
$app_strings['LBL_OPPORTUNITIES_TOTAL_SUM'] = 'Загальна цінність';
$app_strings['LBL_QUOTES_EXPIRY'] = 'Наступна дата закінчення';
$app_strings['LBL_DEFAULT_TOTAL'] = 'Всього';
$app_strings['AOS_Contracts'] = 'Угоди';
$app_strings['AOS_Quotes'] = 'Комерційні пропозиції';
$app_strings['AOS_Invoices'] = 'Рахунок-фактура';
$app_strings['LBL_PHOTO'] = 'Фотографія';
$app_strings['LBL_CASE_UPDATES'] = 'Оновлення у Зверненнях';
$app_strings['LBL_CASE_UPDATE_SUBMITTED'] = 'Оновлення до Звернення відправлено';
...
$app_strings['LBL_CREATE'] = 'Створити';
$app_strings['LBL_CLEAR_FILTER'] = 'Очистити фільтр';
$app_strings['LBL_QUICK_FILTERS'] = 'Швидкі фільтри';
$app_strings['LBL_SAVED_FILTER_SAVED'] = 'Фільтр збережено';
$app_strings['LBL_FILTER_ID_NOT_DEFINED'] = 'Id фільтра не визначено';
$app_strings['LBL_GENERIC_CONFIRMATION'] = 'Ви хочете продовжити дію?';
$app_strings['LBL_SHOW_MORE'] = 'Показати більше';
$app_strings['LBL_SHOW_LESS'] = 'Показати менше';
$app_strings['LBL_LOAD_MORE'] = 'Завантажити ще';
$app_strings['LBL_EMPTY'] = '-- Empty --';
$app_strings['LBL_OPERATOR'] = 'Оператор';
$app_strings['LBL_START'] = 'Вперед';
$app_strings['LBL_END'] = 'Кінець';
$app_strings['LBL_LINE_ITEMS_FIELD_CONFIG'] = 'Помилкові налаштування';


$app_strings['LBL_ACTION_SUCCESS'] = 'Дію виконано';

$app_strings['LBL_YES'] = 'Так';
$app_strings['LBL_NO'] = 'Ні';

$app_list_strings['sort_order'] = [];
$app_list_strings['sort_order']['asc'] = 'За зростанням';
$app_list_strings['sort_order']['desc'] = 'За спаданням';

// Labels used by subpanel unlink relationship process
$app_strings['LBL_LINK'] = 'Посилання';
$app_strings['LBL_LINK_UNLINK'] = 'Link / Unlink';
$app_strings['LBL_SAVE'] = 'Зберегти';
$app_strings['LBL_UNLINK_RECORD'] = 'Від\'єднати запис';
$app_strings['LBL_EDIT_RECORD'] = 'Редагувати запис';
$app_strings['LBL_UNLINK_RELATIONSHIP_CONFIRM'] = 'Ви дійсно бажаєте від\'єднати цей запис? Тільки зв\'язок буде від\'єднано, сам запис залишиться.';
$app_strings['LBL_UNLINK_RELATIONSHIP_SUCCESS'] = 'Запис від\'єднано.';
$app_strings['LBL_UNLINK_RELATIONSHIP_FAILED'] = 'Сталася помилка під час від\'єднання цього запису.';
...
$app_strings['LBL_LINK_RELATIONSHIP_SUCCESS'] = 'Відносини між записами установлені, записи тепер пов\'язані.';
$app_strings['LBL_LINK_RELATIONSHIP_FAILED'] = 'Сталася помилка під час приєднання цього запису.';
$app_strings['LBL_MODULE_NOT_FOUND'] = 'Модуль не знайдено.';
$app_strings['LBL_RECORD_NOT_FOUND'] = 'Не вдалося завантажити запис';
$app_strings['LBL_RELATIONSHIP_LOAD_ERROR'] = 'Не вдалося завантажити відношення між записами';
$app_strings['LBL_NOT_LINKED'] = 'Не вдалося від’єднати записи. На цей час записи не пов’язані між собою';
$app_strings['LBL_ACCESS_DENIED'] = 'Доступ заборонений';
$app_strings['LBL_ADD_RECORDS_TO_TARGET_LIST_SUCCESS'] = 'Записи додано в цільовий список.';
$app_strings['LBL_ADD_RECORDS_TO_TARGET_LIST_FAILED'] = 'Сталася помилка при додаванні записів до списку цілей.';
$app_strings['LBL_ADD_CONTACTS_TO_TARGET_LIST_SUCCESS'] = 'Контактних Осіб додано до списку цілей.';
$app_strings['LBL_ADD_CONTACTS_TO_TARGET_LIST_FAILED'] = 'Сталася помилка при додаванні Контактних осіб до списку цілей.';
$app_strings['LBL_CHANGED_TO_TEXT'] = 'змінено на';
$app_strings['LBL_RECORD_CHANGED'] = 'Запис оновлено';
$app_strings['LBL_CREATE'] = "Створити";
...
$app_strings['LBL_NO_MODULE_SELECTED'] = 'Жодного модуля не обрано';
$app_strings['LBL_CLOSE_MENU'] = 'Закрити меню';
$app_strings['LOGIN_INCORRECT'] = 'Невірні дані для входу, будь ласка, спробуйте ще.';
$app_strings['LOGIN_TOO_MANY_FAILED'] = 'Забагато невдалих спроб входу в систему, спробуйте пізніше.';
...
$app_strings['LBL_NEW_NOTIFICATION'] = "Маєте {{context.unread}} непрочитаних нових сповіщень";
$app_strings['LBL_NOTIFICATION_ITEM_DATE'] = 'Термін до: {{fields.date_start.value}}';
$app_strings['LBL_NOTIFICATION_ITEM_DATE_ENTERED'] = 'Сповіщено: {{fields.snooze.value}}';
$app_strings['LBL_QUICK_ACTIONS'] = 'Швидкі дії';
$app_strings['LBL_RELATIONSHIPS'] = 'Зв’язки';
$app_strings['LBL_SHOW_CC'] = 'Show Cc';
$app_strings['LBL_SHOW_BCC'] = 'Show Bcc';
$app_strings['LBL_CC'] = 'Копія';
$app_strings['LBL_BCC'] = 'Прихована копія';
$app_strings['LNK_NEW_EMAIL'] = 'Написати листа';
...
$app_strings['LBL_RELATED_TO'] = 'Відноситься до:';
...
$app_strings['LBL_MEDIUM'] = 'Середній';
$app_strings['LBL_NORMAL'] = 'Звичайний';
$app_strings['LBL_LARGE'] = 'Large';
$app_strings['LBL_HUGE'] = 'Huge';
$app_strings['LBL_DEFAULT'] = 'За замовчуванням';
$app_strings['LBL_APPLY'] = 'Застосувати';
...
$app_strings['LBL_QUOTE'] = 'Пропозиція';
$app_strings['LBL_UNQUOTE'] = 'Unquote';
$app_strings['LBL_ALIGN_LEFT'] = 'Ліворуч';
$app_strings['LBL_ALIGN_CENTER'] = 'Center';
$app_strings['LBL_ALIGN_RIGHT'] = 'Праворуч';
...
// Day and Time labels
$app_strings['LBL_SUN'] = 'Неділя';
$app_strings['LBL_MON'] = 'Понеділок';
$app_strings['LBL_TUE'] = 'Вівторок';
$app_strings['LBL_WED'] = 'Середа';
$app_strings['LBL_THU'] = 'Четвер';
$app_strings['LBL_FRI'] = 'П\'ятниця';
$app_strings['LBL_SAT'] = 'Субота';
$app_strings['LBL_ALL'] = 'Кожен день';
$app_strings['LBL_EVERY'] = 'Кожен';
$app_strings['LBL_ON_THE'] = 'Раз на';
$app_strings['LBL_RANGE'] = 'у';
$app_strings['LBL_FROM'] = 'Від';
$app_strings['LBL_AND'] = 'і';
$app_strings['LBL_MINS'] = 'хв.';
$app_strings['LBL_MINUTES'] = 'хвилин';
$app_strings['LBL_HOUR'] = 'годин';
$app_strings['LBL_HOUR_SING'] = 'година';
$app_strings['LBL_OFTEN'] = 'Так часто, як можливо.';
$app_strings['LBL_MIN_MARK'] = 'на початку хвилини';
$app_strings['LBL_INBOUND_EMAIL'] = 'Налаштування параметрів вхідної пошти';
...
$app_strings['LBL_CAMPAIGN_SETTINGS'] = 'Налаштування';
...
$app_strings['LBL_UNSUBSCRIBE'] = 'Відписатись';
$app_strings['LBL_INACTIVE'] = 'Неактивна';
...
$app_strings['LBL_UPLOAD'] = 'Завантажити';
