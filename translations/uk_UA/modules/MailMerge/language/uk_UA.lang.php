...
$mod_strings = array(
    ...
    'LBL_ADDIN_NOTICE' => 'Необхідне встановлення додатка SuiteCRM Mail Merge для Microsoft Word, для об\'єднання з поштою SuiteCRM.',
    'LBL_REMOVE' => 'Видалити елементи' /*for 508 compliance fix*/,
    'LBL_ADD' => 'Додати елементи' /*for 508 compliance fix*/,
    'LBL_BROWSER_REQUIREMENT' => 'Для Windows потрібно мати IE 6.0 або вище.',
    'LBL_FORM_SELECT_TEMPLATE' => 'Будь ласка, оберіть шаблон.',
    'LBL_SELECT_ONE' => 'Будь ласка, виберіть принаймні один елемент.',
    'LBL_AVAILABLE' => 'Доступні',
    'LBL_SELECTED' => 'Обрано',
    'LBL_RELATED_INFO_SELECTION' => 'Використовуйте вибор нижче для вказання пов\'язаної інформації, яку ви хочете показувати у вашому об’єднаному документі. Пропустіть цей крок, якщо ваш шаблон не містить пов\'язаної інформації.',
