...
$mod_strings = array(
    ...
    'LBL_AN_ACCOUNTS_ACCOUNT_NAME' => 'Назва',
    ...
    'LBL_AN_LEADS_ASSIGNED_USER' => 'Відповідальна особа',
    'LBL_AN_LEADS_STATUS' => 'Статус',
    'LBL_AN_LEADS_LEAD_SOURCE' => 'Джерело попереднього контакту:',
    'LBL_AN_LEADS_CAMPAIGN_NAME' => 'Назва маркет. кампанії',
    'LBL_AN_LEADS_YEAR' => 'Рік',
    'LBL_AN_LEADS_QUARTER' => 'Квартал',
    'LBL_AN_LEADS_MONTH' => 'Місяць',
    'LBL_AN_LEADS_WEEK' => 'Тиждень',
    'LBL_AN_LEADS_DAY' => 'День',

    //Analytics labels for sales pivot
    'LBL_AN_SALES_ACCOUNT_NAME' => 'Контрагент',
    'LBL_AN_SALES_OPPORTUNITY_NAME' => 'Угода:',
    'LBL_AN_SALES_ASSIGNED_USER' => 'Відповідальна особа',
    'LBL_AN_SALES_OPPORTUNITY_TYPE' => 'OpportunityType',
    'LBL_AN_SALES_LEAD_SOURCE' => 'Джерело попереднього контакту:',
    'LBL_AN_SALES_AMOUNT' => 'Сума',
    'LBL_AN_SALES_STAGE' => 'Стадія продажу',
    ...
    'LBL_AN_SALES_CAMPAIGN' => 'Маркетингова кампанія',

    //Analytics labels for service pivot
    'LBL_AN_SERVICE_ACCOUNT_NAME' => 'Контрагент',
    'LBL_AN_SERVICE_STATE' => 'Область',
    'LBL_AN_SERVICE_STATUS' => 'Статус',
    'LBL_AN_SERVICE_PRIORITY' => 'Пріоритет',
    ...
    'LBL_AN_SERVICE_CONTACT_NAME' => 'Контактна особа',
    'LBL_AN_SERVICE_ASSIGNED_TO' => 'Відповідальна особа',

    //Analytics labels for the activities pivot
    'LBL_AN_ACTIVITIES_TYPE' => 'Тип',
    'LBL_AN_ACTIVITIES_NAME' => 'Назва',
    'LBL_AN_ACTIVITIES_STATUS' => 'Статус',
    'LBL_AN_ACTIVITIES_ASSIGNED_TO' => 'Відповідальна особа',
    ...
    'LBL_AN_MARKETING_EXPECTED_REVENUE' => 'Очікуваний дохід',
    'LBL_AN_MARKETING_OPPORTUNITY_NAME' => 'Угода:',
    'LBL_AN_MARKETING_OPPORTUNITY_AMOUNT' => 'Сума по угоді:',
    ...
    'LBL_AN_MARKETINGACTIVITY_CAMPAIGN_NAME' => 'Назва маркет. кампанії',
    'LBL_AN_MARKETINGACTIVITY_ACTIVITY_DATE' => 'Дата дії',
    'LBL_AN_MARKETINGACTIVITY_ACTIVITY_TYPE' => 'Тип дії',
    'LBL_AN_MARKETINGACTIVITY_RELATED_TYPE' => 'Тип залежності',
    'LBL_AN_MARKETINGACTIVITY_RELATED_ID' => 'Related ID',

    //Analytics labels for the quotes pivot
    'LBL_AN_QUOTES_OPPORTUNITY_NAME' => 'Угода:',
    ...
    'LBL_AN_QUOTES_CONTACT_NAME' => 'Контактна особа',
    'LBL_AN_QUOTES_ITEM_NAME' => 'Значення в базі',
    ...
    'LBL_AN_QUOTES_ITEM_DISCOUNT_AMOUNT' => 'Сума знижки',
    'LBL_AN_QUOTES_ITEM_TOTAL' => 'Item Total',
    'LBL_AN_QUOTES_GRAND_TOTAL' => 'Загалом',
    'LBL_AN_QUOTES_ASSIGNED_TO' => 'Відповідальна особа',
    'LBL_AN_QUOTES_DATE_CREATED' => 'Дата створення',
