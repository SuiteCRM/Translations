...
$mod_strings = array(
    ...
    'NEW_LOGO_HELP_NO_SPACE' => 'Формат файлу зображення може бути «. png» або. jpg. Максимальна висота-170px, і найбільша ширина-450px. Завантажені зображення, що більші за вказаними параметрами, будуть зменшенні до цих розмірів.',
...
// Wizard
    ...
    'LBL_DELETE' => 'Видалення' /*for 508 compliance fix*/,
