...
$mod_strings = array(
    ...
    'LBL_MODULE_NAME' => 'Облікові записи вхідної пошти',
    'LBL_BOUNCE_MODULE_NAME' => 'Обліковий запис для обробки відхиленої електронної пошти',
    'LBL_MODULE_TITLE' => 'Облікові записи вхідної пошти',
    'LBL_NAME' => 'Назва',
    'LBL_NONE' => 'None',
    ...
    'LBL_SSL_DESC' => 'Якщо ваш поштовий сервер підтримує захищене з\'єднання, то при імпортуванні електронної пошти буде використано шифрування SSL.',
    ...
    'LNK_LIST_CREATE_NEW_PERSONAL' => 'Новий особистий обліковий запис',
    'LNK_LIST_CREATE_NEW_GROUP' => 'Новий груповий обліковий запис',
    'LNK_LIST_CREATE_NEW_CASES_TYPE' => 'Новий обліковий запис для Звернень',
    'LNK_LIST_CREATE_NEW_BOUNCE' => 'Новий обліковий запис для відхиленої пошти',
    ...
    'LNK_MY_INBOX' => 'Розсилка електронною поштою',
    'LNK_VIEW_MY_INBOX' => 'Перегляд електронного листа',
