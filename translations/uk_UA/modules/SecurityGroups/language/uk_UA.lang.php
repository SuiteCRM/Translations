...
$mod_strings = array(
    'LBL_ALL_MODULES' => 'Всі відповідні',//rost fix
    ...
    'LBL_NONINHERITABLE' => 'Не успадковується',
    'LBL_LIST_NONINHERITABLE' => 'Не успадковується',
    'LBL_NAME' => 'Назва',
    'LBL_CREATED_USER' => 'Створено користувачем',
    'LBL_MODIFIED_USER' => 'Змінено користувачем',
    'LBL_LIST_FORM_TITLE' => 'Групи Користувачів',
    'LBL_MODULE_NAME' => 'Управління пакетом безпеки',
    'LBL_MODULE_TITLE' => 'Управління пакетом безпеки',
    'LNK_NEW_RECORD' => 'Створити групу безпеки',
    'LNK_LIST' => 'Список',
    'LBL_SEARCH_FORM_TITLE' => 'Пошук в управлінні групами безпеки',
    'LBL_HISTORY_SUBPANEL_TITLE' => 'Історія',
    'LBL_ACTIVITIES_SUBPANEL_TITLE' => 'Заходи',
    'LBL_SECURITYGROUPS_SUBPANEL_TITLE' => 'Управління групами безпеки',
    'LBL_USERS' => 'Користувачі',
    'LBL_USERS_SUBPANEL_TITLE' => 'Користувачі',
    'LBL_ROLES_SUBPANEL_TITLE' => 'Ролі',
    'LBL_ROLES' => 'Ролі',

    'LBL_CONFIGURE_SETTINGS' => 'Налаштування',
    'LBL_ADDITIVE' => 'Адитивні права',
    'LBL_ADDITIVE_DESC' => "Користувач отримує найбільші права з усіх ролей, призначених користувачеві або групі користувача",
    ...
    'LBL_REMOVE_BUTTON_LABEL' => 'Видалити',
    'LBL_GROUP' => 'Group:',
    'LBL_MODULE' => 'Module:',

    'LBL_MASS_ASSIGN' => 'Security Groups: Mass Assign',
    'LBL_ASSIGN' => 'Призначити',
    'LBL_REMOVE' => 'Видалити',
    ...
    'LBL_CONFIRM_END' => ' вибрані записи?',
