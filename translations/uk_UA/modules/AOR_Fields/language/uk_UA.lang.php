...
$mod_strings = array(
    ...
    'LBL_LIST_FORM_TITLE' => 'Список полів',
    'LBL_MODULE_NAME' => 'Поля',
    'LBL_MODULE_TITLE' => 'Поля',
    'LBL_HOMEPAGE_TITLE' => 'Мої поля',
    'LNK_NEW_RECORD' => 'Створення полів',
    'LNK_LIST' => 'Перегляд полів',
    'LBL_SEARCH_FORM_TITLE' => 'Пошук полів',
    'LBL_HISTORY_SUBPANEL_TITLE' => 'Історія',
    'LBL_ACTIVITIES_SUBPANEL_TITLE' => 'Заходи',
    'LBL_NEW_FORM_TITLE' => 'Нові поля',
    'LBL_ORDER' => 'Замовлення',
    'LBL_MODULE_PATH' => 'Модуль',
    'LBL_FIELD' => 'Поле',
    'LBL_DISPLAY' => 'Показати',
    'LBL_LINK' => 'Посилання',
    'LBL_LABEL' => 'Ярлик',
    'LBL_FUNCTION' => 'Функція',
    'LBL_SORT' => 'Сортувати',
    'LBL_SORT_ORDER' => 'Порядок сортування',
    'LBL_GROUP' => 'Група',
    'LBL_GROUP_ORDER' => 'Порядок групування',
    'LBL_AUDIT_TABLE' => 'Таблиця аудиту',
    'LBL_TOTAL' => 'Всього',
    'LBL_FORMAT' => 'Параметри формату',
);
