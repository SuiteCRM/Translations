...
$mod_strings = array(
    ...
    'LBL_GROUP_TOTAL_USDOLLAR' => 'Csoport összesen (alapértelmezett pénznem)',
    'LBL_SUBTOTAL_TAX_AMOUNT_USDOLLAR' => 'Részösszeg + adó (alapértelmezett pénznem)',
    'LBL_PARENT_ID' => 'Szülő ID',

    'AOS_PRODUCT_QUOTES' => 'Termék idézetek',
);
