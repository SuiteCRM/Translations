...
// Activity stream
    'CREATED_CONTACT' => 'egy <b>ÚJ</b> {0} létrehozva', // For fusional (inflected) languages: used in the sentence "Administrator created a new contact"
    'CREATED_OPPORTUNITY' => 'egy <b>ÚJ</b> {0} létrehozva', // For fusional (inflected) languages: used in the sentence "Administrator created a new opportunity"
    'CREATED_CASE' => 'egy <b>ÚJ</b> {0} létrehozva', // For fusional (inflected) languages: used in the sentence "Administrator created a new case"
    'CREATED_LEAD' => 'egy <b>ÚJ</b> {0} létrehozva', // For fusional (inflected) languages: used in sentence "Administrator created a new lead"
