...
$mod_strings = array(
    ...
    'LBL_SYSOPTS_ERRS_TITLE' => 'Molimo ispravite sljedeće greške prije nego što nastavite:',
    ...
    'ERR_DB_MSSQL_DB_NAME_INVALID' => "Naziv baze podataka ne može početi sa brojem,'#', ili '@' i ne može sadržavati razmak, '\"', \"'\", '*', '/', '\\', '?', ':', '<', '>', '&', '!', ili '-'",
    ...
    'ERR_DB_USER_EXISTS' => 'Korisničko ime za SuiteCRM bazu podataka već postoji -- ne mogu kreirati drugo sa istim imenom. Molimo unesite novo ime.',
    'ERR_DB_USER' => 'Unesite korisničko ime za administratora SuiteCRM baze podataka.',
    'ERR_DBCONF_VALIDATION' => 'Molimo ispravite sljedeće greške prije nego što nastavite:',
    ...
    'ERR_PERFORM_CONFIG_PHP_3' => 'Jesi li se sjetio napraviti config.php datoteku?',
    ...
    'ERR_PERFORM_HTACCESS_2' => ' datoteka.',
    ...
    'LBL_CONFIRM_NOT' => 'not',
    'LBL_CONFIRM_TITLE' => 'Potvrdite postavke',
    'LBL_CONFIRM_WILL' => 'će',
    ...
    'LBL_DISABLED_HELP_1' => 'Za pomoć pri instalaciji, molimo posjetite SuiteCRM',
    ...
    'LBL_INSTALL_TYPE_SUBTITLE' => 'Odaberi vrstu instalacije',
    'LBL_INSTALL_TYPE_TYPICAL' => ' <b>Typical Install</b>',
    'LBL_INSTALL_TYPE_CUSTOM' => ' <b>Prilagođena instalacija</b>',
    'LBL_INSTALL_TYPE_MSG2' => 'Zahtjeva osnovne informacije za instalaciju. Preporučeno za nove korisnike.',
    ...
    'LBL_LANG_PACK_INSTALLED' => 'Sljedeći jezički paketi su instalirani: ',
    ...
    'LBL_LICENSE_CHECK_PASSED' => 'Sistem je prošao provjeru za kompatibilnost.',
    'LBL_CREATE_CACHE' => 'Priprema za instalaciju...',
    'LBL_LICENSE_REDIRECT' => 'Preusmjeravanje u ',
    'LBL_LICENSE_I_ACCEPT' => 'Ja prihvatam',
    ...
    'LBL_PERFORM_OUTRO_2' => ' je sad dovršen!',
    ...
    'LBL_PRINT' => 'Štampa',
    'LBL_REG_CONF_1' => 'Molimo ispunite kratki obrazac ispod da primite obavijesti o proizvodima, vijesti o treningu, posebnim ponudama i posebnim događajima iz SuiteCRM. Mi ne prodajemo, iznajmljujemo, dijelimo ili na drugi način distribuiramo informacije koje smo ovdje prikupili trećim stranama.',
    'LBL_REG_CONF_3' => 'Hvala Vam na registraciji. Kliknite na Završi dugme da se prijaviš na SuiteCRM. Trebate se prijaviti prvi put koristeći korisničko ime "admin" i lozinku koju ste unijeli u koraku 2.',
    ...
    'LBL_WELCOME' => 'Dobrodošli u SuiteCRM',
    ...
    'REQUIRED_INSTALLTYPE_MSG' =>
        'After the system check is performed, you can choose either
                      ...
                      This URL should include the web server or machine name or IP address.<br><br></li>
                                ...
                                ',
    'LBL_WELCOME_PLEASE_READ_BELOW' => 'Molimo pročitajte sljedeće važne informacije prije nego što nastavite sa instalacijom. Informacije će Vam pomoći da odlučite jeste li spremni ili ne da u ovom trenutku instalirate aplikaciju.',
    ...
    'LBL_PATCH_1' => 'Ako želite preskočiti ovaj korak, kliknite Dalje.',
    ...
    'advanced_password_new_account_email' => array(
        ...
        'txt_body' =>
            '
Ovo su korisničko ime i privremena lozinka Vašeg računa:
...
Nakon što se prijavite koristeći lozinku iznad, može se tražiti od Vas da resetujete lozinku za onu prema Vašem izboru.',
...
$contact_user_link_guid',
    ...
    'LBL_LICENCE_TOOLTIP' => 'Molimo prvo prihvatite licencu',

    'LBL_MORE_OPTIONS_TITLE' => 'Više opcija',
    'LBL_START' => '',
    'LBL_DB_CONN_ERR' => 'Database error',
    'LBL_OLD_PHP' => 'Otkrivena stara PHP verzija!',
