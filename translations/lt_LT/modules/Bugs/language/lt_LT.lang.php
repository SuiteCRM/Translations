...
$mod_strings = array(
    'LBL_MODULE_NAME' => 'Klaidų fiksavimas',
    'LBL_MODULE_TITLE' => 'Klaidos: Pradžia',
    'LBL_MODULE_ID' => 'Klaidų fiksavimas',
    ...
    'LBL_BUG_INFORMATION' => 'Adresato informacija', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
