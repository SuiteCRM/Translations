...
$mod_strings = array(
    ...
    'ERR_CHECKSYS_CONFIG_NOT_WRITABLE' => 'Yapılandırma dosyası var ancak yazılabilir değil. Lütfen dosyayı yazılabilir yapmak için gerekli adımları uygulayın.',
    'ERR_CHECKSYS_CONFIG_NOT_FOUND' => 'config.php dosyanız yok. Kurulum sırasında oluşturulacak.',
    'ERR_CHECKSYS_CONFIG_OVERRIDE_NOT_WRITABLE' => 'Yapılandırma değişikliği dosyası var ancak yazılabilir değil. Lütfen dosyayı yazılabilir yapmak için gerekli adımları uygulayın. ',
    'ERR_CHECKSYS_CUSTOM_NOT_WRITABLE' => 'Özel klasör var ancak yazılabilir değil. Lütfen klasörü yazılabilir yapmak için gerekli adımları uygulayın.',
    'ERR_CHECKSYS_FILES_NOT_WRITABLE' => "Yukarıda listelenen dosyalar veya klasörler yazılabilir değil veya eksik ancak oluşturulamadı. Lütfen klasörleri yazılabilir yapmak için gerekli adımları uygulayın.",
    ...
    'ERR_CHECKSYS_ENV_NOT_WRITABLE' => '.env dosyası ya da klasörü yazılabilir değil.',
    ...
    'ERR_PERFORM_NO_TCPIP' => '<b>İnternet bağlantısı algılanamadı.</b>Bağlantı kurulduğunda, Bir SuiteCRM hesabı açmak için <a href="https://www.suitecrm.com/">https://www.suitecrm.com/</a> adresine gidin. Kuruluşunuzun SuiteCRM uygulamasını nasıl kullandığı hakkında bilgi edinirsek, gereksinimlerinize uygun özellikler geliştirmeyi sürdürebiliriz.',
    ...
    'LBL_CHECKSYS_LEGACY_CACHE' => 'Eski Cache alt klasörleri yazılabilir',
    'LBL_CHECKSYS_CACHE' => 'Yazılabilir ön bellek alt klasörleri',
    'LBL_CHECKSYS_EXTENSIONS' => 'Extensions klasörü yazılabilir',
    'LBL_CHECKSYS_SECRETS' => 'Config/Secrets klasörü yazılabilir',
    'LBL_CHECKSYS_LOGS' => 'Log klasörü yazılabilir',
    ...
    'LBL_CHECKSYS_ENV' => '.env yazılabilir',
    ...
    'LBL_CHECKSYS_INTL_EXTENSIONS' => 'Eklentiler içinde Intl var',
    'LBL_CHECKSYS_JSON_EXTENSIONS' => 'Eklentiler içinde JSON var',
    'LBL_CHECKSYS_GD_EXTENSIONS' => 'Eklentiler içinde GD var',
    'LBL_CHECKSYS_OPENSSL_EXTENSIONS' => 'Eklentiler içinde OpenSSL var',
    'LBL_CHECKSYS_ZIP_EXTENSIONS' => 'Eklentiler içinde Zip var',
    'LBL_CHECKSYS_PDO_MYSQL_EXTENSIONS' => 'Eklentiler içinde PDO MySQL var',
    'LBL_CHECKSYS_CURL_EXTENSIONS' => 'Eklentiler içinde cURL var',
    'LBL_CHECKSYS_MBSTRING_EXTENSIONS' => 'Eklentiler içinde MB Strings var',
    'LBL_CHECKSYS_MYSQLI_EXTENSIONS' => 'Eklentiler içinde MySQLi var',
    'LBL_CHECKSYS_SOAP_EXTENSIONS' => 'Eklentiler içinde Soap var',
    'LBL_CHECKSYS_XML_EXTENSIONS' => 'Eklentiler içinde XML var',
    'LBL_CHECKSYS_IMAP_EXTENSIONS' => 'Eklentiler içinde IMAP var (isteğe bağlı)',
    'LBL_CHECKSYS_LDAP_EXTENSIONS' => 'Eklentiler içinde LDAP var (isteğe bağlı)',
    ...
    'ERR_CHECKSYS_JSON' => 'JSON eklentisi kurulmamış. Lütfen sistem yöneticiniz ile görüşün.',
    'ERR_CHECKSYS_GD' => 'GD eklentisi kurulmamış. Lütfen sistem yöneticiniz ile görüşün.',
    'ERR_CHECKSYS_OPENSSL' => 'OpenSLL eklentisi kurulmamış. Lütfen sistem yöneticiniz ile görüşün.',
    'ERR_CHECKSYS_PDO_MYSQL' => 'PDO MySQL eklentisi kurulmamış. Lütfen sistem yöneticiniz ile görüşün.',
    'ERR_CHECKSYS_MYSQLI' => 'MySQLi eklentisi kurulmamış. Lütfen sistem yöneticiniz ile görüşün.',
    'ERR_CHECKSYS_SOAP' => 'Soap eklentisi kurulmamış. Lütfen sistem yöneticiniz ile görüşün.',
    ...
    'LBL_UNWRITABLE_SUB_DIR' => 'Yazılamayan bazı alt klasörler var. Lütfen klasörleri yazılabilir yapmak için gerekli adımları uygulayın ',
    'LBL_REFER_TO_LOGS' => 'Kurulum öncesi denetimlerinin birinde sorun çıktı. Lütfen install.log dosyasına bakın.',
    'LBL_NOT_A_VALID_SUITECRM_PAGE' => 'SuiteCRM başlığı bulunamadı. Bu sayfa geçerli bir SuiteCRM sayfası değil.',
    'LBL_NOT_COOKIE_OR_TOKEN' => 'Çerezler bulunamadı. Geçerli bir kod bulunamadı. Ayrıntılı bilgi almak için lütfen install.log dosyasına bakın.',
    'LBL_CURL_JSON_ERROR' => 'Graphql sayfasına yapılan curl çağrısından boş sonuç alındı.',
    'LBL_UNABLE_TO_FIND_SYSTEM_CONFIGS' => 'Graphql sayfasındaki sistem yapılandırmaları alınamadı. Ayrıntılı bilgi almak için lütfen install.log dosyasına bakın.',
    'LBL_CURL_REQUEST_MAIN_PAGE' => 'Ana sayfadan cURL isteği',
    'LBL_CURL_REQUEST_API_PAGE' => 'API üzerinden cURL isteği',
    'LBL_ERROR_DETAILS' => 'Hata ayrıntıları',
    'LBL_ERROR' => 'Hata:',
    'LBL_WARNING_DETAILS' => 'Uyarı ayrıntıları',
    'LBL_WARNING' => 'Uyarı',
    'LBL_SYSTEM_CHECKS' => 'SİSTEM DENETİMLERİ',
    'LBL_CRON_INSTRUCTIONS_1' => 'SuiteCRM zamanlayıcılarını çalıştırmak için şu komutla site sunucusu kullanıcınızın crontab dosyasını düzenleyin:',
    ...
    'LBL_CRON_CONFIGURATION' => 'ZAMANLANMIŞ GÖREV YAPILANDIRMASI',
    'LBL_SETUP_CRONTAB' => 'Zamanlanmış görev kurulumu için',
    'LBL_ROUTE_ACCESS_CHECK' => 'YÖNELTME ERİŞİMİ DENETİMİ',
    'LBL_PHP_MEM_1' => 'PHP bellek sınırınız ',
    'LBL_PHP_MEM_2' => '. En az şu kadar olmalıdır ',
    'LBL_PHP_MEM_3' => 'İlerlemek için M.',
    'LBL_CLOSE' => 'Kapat',
    'LBL_THREE' => '3',
    ...
    'LBL_DISABLED_DESCRIPTION_3' => 'Bu değişiklik yapıldıktan sonra ilerlemek için lütfen bu sayfayı yeniden açın ya da yükleyin.',
    ...
    'LBL_APP_NOT_INSTALLED' => 'SuiteCRM kurulu değil. Başlangıç noktası olarak bir SuiteCRM kurulumu gereklidir. Lütfen önce kurun.',
    ...
    'LBL_PRE_INSTALL_REQ' => 'Kurulum gereksinimleri',
...
Ayrıntılı bilgi almak için kurulum rehberine bakabilirsiniz.                                ',
    ...
    'LBL_SESSION_ERR_DESCRIPTION' => "SuiteCRM, bu site sunucusuna bağlandığında önemli bilgileri depolamak için PHP oturum mekanizmasını kullanır. PHP kurulumunuz için oturum bilgileri doğru şekilde yapılandırılmamış.<br><br>Sık karşılaşılan bir yanlış yapılandırma, <b>'session.save_path'</b> ayarının geçersiz bir klasörü göstermesidir.<br><br>Lütfen aşağıda görüntülenen php.ini dosyasında <a target=_new href=\"http://us2.php.net/manual/en/ref.session.php\">PHP yapılandırmasını</a> düzeltin.",
...
$contact_user_link_guid',
    ...
    'LBL_OLD_PHP_MSG' => 'SuiteCRM için önerilen PHP sürümü %s.<br />Kullanılabilecek en düşük PHP sürümü %s<br />Kullandığınız PHP sürümü %s ve kullanım süresi bitmiş:<a href="http://php.net/eol.php">http://php.net/eol.php</a>.<br />Lütfen PHP sürümünüzü yükseltmeyi değerlendirin. ',
