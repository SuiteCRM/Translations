...
$mod_strings = array(
    ...
    'LBL_RETRY_COUNT' => 'Maksimalno ponavljanja',
...
// Errors
    ...
    'ERR_CURL' => "Nema CURL - ne mogu se pokretati URL radnje.",
    'ERR_FAILED' => "Neočekivani kvar, molim provjerite PHP zapise i suitecrm.log",
    'ERR_PHP' => "%s [%d]: %s in %s on line %d",
    'ERR_NOUSER' => "Niti jedan korisnički ID nije specificiran za posao.",
