...
$mod_strings = array(
    ...
    'ERR_UW_CONFIG_WRITE' => 'Greška pri ažuriranju datoteke config.php sa novim informacijama.',
    'ERR_UW_CONFIG' => 'Molim omogućite zapisivanje datoteci config.php pa ponovno učitajte ovu stranicu.',
    ...
    'ERR_UW_FILE_NOT_READABLE' => 'Datoteka se ne može pročitati.',
    'ERR_UW_FILE_NOT_WRITABLE' => 'Datoteku nije moguće premjestiti ili zapisati u nju.',
    'ERR_UW_FLAVOR_2' => 'Tip Nadogradnje:',
    'ERR_UW_FLAVOR' => 'SuiteCRM System Flavor: ',
    'ERR_UW_LOG_FILE_UNWRITABLE' => '/upgradeWizard.log nije mooa biti kreiran/zapisan. Molim ispravite dozvole u Vašem SuiteCRM direktoriju.',
    'ERR_UW_MBSTRING_FUNC_OVERLOAD' => 'mbstring.func_overload podešen na vrijednosti veću od 1.  Molim promijenite to u Vašoj  php-ini datoteci i ponovo pokrenite web server.',
    ...
    'ERR_UW_UPLOAD_ERR' => 'Dogodila se greška pri učitavanju datoteke, molimo pokušajte opet!<br>' . PHP_EOL,
    ...
    'LBL_BUTTON_DONE' => 'Učinjeno',
    'LBL_BUTTON_EXIT' => 'Izlaz',
    'LBL_BUTTON_NEXT' => 'Sljedeće>',
    'LBL_BUTTON_RECHECK' => 'Ponovno provjeri',
    'LBL_BUTTON_RESTART' => 'Ponovno pokreni',

    'LBL_UPLOAD_UPGRADE' => 'Učitaj paket nadogradnje',
    ...
    'LBL_UW_COMPLIANCE_ALL_OK' => 'Svi sistemski zahtjevi su ispunjeni',
    'LBL_UW_COMPLIANCE_CALLTIME' => 'PHP postavke: Call Time Pass By Reference',
    ...
    'LBL_UW_COMPLIANCE_MEMORY' => 'PHP Postavke: Limit Memorije',
    'LBL_UW_COMPLIANCE_STREAM' => 'PHP postavke: Stream',
    'LBL_UW_COMPLIANCE_DB' => 'Najniža Inačica Baze Podataka',
    'LBL_UW_COMPLIANCE_PHP_INI' => 'Lokacija datoteke php.ini',
    'LBL_UW_COMPLIANCE_PHP_VERSION' => 'Najniža PHP Inačica',
    'LBL_UW_COMPLIANCE_SAFEMODE' => 'PHP Postavke: Siguran Način Rada',
    'LBL_UW_COMPLIANCE_TITLE2' => 'Detektirane Postavke',
    'LBL_UW_COMPLIANCE_XML' => 'XML Analiza Sintakse',
    'LBL_UW_COMPLIANCE_ZIPARCHIVE' => 'Zip Podrška',
    'LBL_UW_COMPLIANCE_PCRE_VERSION' => 'PCRE Inačica',
    ...
    'LBL_UW_DB_NO_ERRORS' => 'Sve privilegije dostupne',
    'LBL_UW_DB_NO_INSERT' => 'INSERT INTO [table]',
    'LBL_UW_DB_NO_SELECT' => 'SELECT [x] FROM [table]',
    'LBL_UW_DB_NO_UPDATE' => 'UPDATE [table]',
    'LBL_UW_DB_PERMS' => 'Nužne privilegije',
    ...
    'LBL_UW_FILES_QUEUED' => 'Sljedeći paketi za nadogradnju su spremni za instaliranje:',
    ...
    'LBL_CURRENT_PHP_VERSION' => 'Vaša trenutna php verzija je: ',
    ...
    'LBL_UPLOAD_SUCCESS' => 'Paket nadogradnje uspješno uploadan. Kliknite Sljedeće za finalnu provjeru.',
    ...
    'LBL_LAYOUT_MERGE_TITLE2' => 'Klikni Sljedeće za dovršetak nadogradnje.',
    ...
    'ERROR_SUITECRM_VERSION_INCOMPATIBLE' => 'Učitana datoteka nije kompatibilna sa ovom verzijom SuiteCRM-a:',
    ...
    'ERR_UW_PHP_FILE_ERRORS' => array(
        ...
        7 => 'Neuspješno zapisivanje datoteke na disk.',
