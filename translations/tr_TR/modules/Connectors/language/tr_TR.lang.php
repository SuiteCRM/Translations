...
$mod_strings = array(
    ...
    'LBL_DISABLED' => 'Kapalı',
    'LBL_ENABLED' => 'Açık',
    'LBL_EXTERNAL' => 'Açıldığında, kullanıcılar bu bağlayıcı için dış hesap kayıtları ekleyebilir.',
    'LBL_EXTERNAL_SET_PROPERTIES' => ' Bu bağlayıcıyı kullanmak için, bağlayıcı özellikleri bölümündeki özellikler de ayarlanmalıdır.',
    'LBL_MERGE' => 'Birleştir',
    'LBL_MODIFY_DISPLAY_TITLE' => 'Bağlayıcıları aç',
    'LBL_MODIFY_DISPLAY_DESC' => 'Her bir bağlayıcı için hangi modüllerin açılacağını seçin.',
    ...
    'LBL_SAVE' => 'Kaydet',
    'LBL_SUMMARY' => 'Özet',
    'LBL_STEP1' => 'Ara ve verileri görüntüle',
    'LBL_STEP2' => 'Kayıtları şununla birleştir',
