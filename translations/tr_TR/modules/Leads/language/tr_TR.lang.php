...
$mod_strings = array(
    ...
    'LBL_CONVERTED_CONTACT' => 'Dönüştürülen ilgili:',
    ...
    'LBL_CONVERTLEAD_WARNING' => 'Uyarı: Dönüştürmek istediğiniz Potansiyelin durumu "Değiştirilmiş". Bu potansiyelden zaten ilgili ve/veya hesap kayıtları eklenmiş olabilir. Potansiyeli dönüştürmeye geçmek istiyorsanız Kaydet üzerine tıklayın. Dönüştürmeden potansiyel kaydına geri dönmek için İptal üzerine tıklayın.',
    'LBL_CONVERTLEAD_WARNING_INTO_RECORD' => ' Olası ilgili: ',
    'LBL_COUNTRY' => 'Ülke:',
    ...
    'LBL_OPPORTUNITY_ID' => 'Fırsat kimliği',
    ...
    'LNK_SELECT_CONTACTS' => ' <b>YA DA</b> ilgili seçin',
    ...
    'NTC_REMOVE_CONFIRMATION' => 'Destek kaydından bu potansiyeli kaldırmak istediğinize emin misiniz?',
...
//Convert lead tooltips
    ...
    'LBL_COPY_TIP' => 'Bu seçenek işaretlendiğinde, potansiyeldeki alanlar yeni eklenen kayıtlardaki aynı adlı alanlara kopyalanır.',
    'LBL_SELECTION_TIP' => 'Potansiyel dönüştürülürken eklenmek yerine ilgililerde ilişkili bir alanı bulunan modüller seçilebilir.',
    'LBL_EDIT_TIP' => 'Bu modül için dönüştürme yerleşimini değiştirir.',
    'LBL_DELETE_TIP' => 'Bu modülü dönüştürme yerleşiminden kaldırır.',
