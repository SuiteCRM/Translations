...
$mod_strings = array(
    ...
    'help' => array(
        'package' => array(
            ...
            'author' => 'Kurulum sırasında paketi oluşturan varlığın adı olarak görüntülenecek <b>Sorumlu</b> bilgisi.<br><br>Sorumlu bir ilgili ya da kuruluş olabilir.',
        ...
        'main' => array(),
        'module' => array(
            'create' => 'Modül için bir <b>Ad</b> belirtin. Belirttiğiniz <b>Etiket</b> gezinme sekmesinde görüntülenir.<br/><br/><b>Gezinme sekmesi</b> kutusunu işaretleyerek modül için bir gezinme sekmesinin görüntülenmesini sağlayabilirsiniz.<br/><br/>Ardından eklemek istediğiniz modül türünü seçin.<br/><br/>Bir kalıp türü seçin. Her kalıpta belirli bir alan kümesinin yanında, modülün temelini oluşturmak için kullanabileceğiniz önceden tanımlanmış yerleşimler bulunur.<br/><br/>Modülü eklemek için <b>Kaydet</b> üzerine tıklayın.',
            'modify' => 'Modül özelliklerini düzenleyebilir ya da bu modül ile ilişkili <b>Alanları</b>, <b>İlişkileri</b> ve <b>Yerleşimleri</b> özelleştirebilirsiniz.',
            'importable' => '<b>İçe aktarılabilir</b> seçeneği açıldığında, bu modülde verileri içe aktarma özelliği kullanılabilir.<br><br>Modülün kısayollar panosuna bir içe aktarma yardımcısı bağlantısı eklenir. İçe aktarma yardımcısı kullanılarak dış kaynaklardan alınan veriler özel modüle aktarılabilir.',
            'team_security' => '<b>Takım güvenliği</b> seçeneği açıldığında, modülde takım güvenliği özellikleri kullanılabilir.<br/><br/>Modüldeki kayıtlarda bir takım seçimi alanı görüntülenir ',
            'reportable' => 'Bu seçenek işaretlendiğinde, modülde raporlama özellikleri kullanılabilir.',
            'assignable' => 'Bu seçenek işaretlendiğinde, modülde bulunan bir kayıt seçilecek bir kullanıcıya atanabilir.',
            'has_tab' => '<b>Gezinme sekmesi</b> seçeneği etkinleştirildiğinde, modül için bir gezinme sekmesi görüntülenir.',
            'acl' => 'Bu seçenek işaretlendiğinde, modülde alan düzeyinde güvenlik sağlayan erişim denetimi özellikleri kullanılabilir.',
            'studio' => 'Bu seçenek işaretlendiğinde, yöneticiler bu modülü Studio kullanarak özelleştirebilir.',
            'audit' => 'Bu seçenek işaretlendiğinde, bu modül için denetim özelliği açılır. Belirli alanlarda yapılan değişiklikler kayıt edilir ve gerektiğinde değişiklik geçmişi yöneticiler tarafından incelenebilir.',
            ...
            'viewlayoutsbtn' => 'Modül yerleşimlerini görüntülemek ve alanların düzenini özelleştirmek için <b>Yerleşimleri görüntüle</b> üzerine tıklayın.',
            ...
            'type_basic' => '<b>Temel</b> kalıp türünde ad, atanmış ilgili, takım, eklenme tarihi ve açıklama gibi temel alanlar bulunur.',
            ...
            'type_person' => '<b>Kişi</b> kalıp türünde hitap, unvan, ad, adres ve telefon numarası gibi kişiye özgü alanlar bulunur.<br/><br/>Standart ilgili ve potansiyel modüllerine benzer modüller eklemek için bu kalıbı kullanabilirsiniz.',
        ...
        ,
            ...
            'historyBtn' => 'Geçmişte kaydedilmiş yerleşimleri görüntülemek ve geri yüklemek için <b>Geçmişi görüntüle</b> üzerine tıklayın.',
            'historyDefault' => 'Bir yerleşimin özgün biçimini geri yüklemek için <b>Varsayılanları geri yükle</b> üzerine tıklayın.',
        ...
        ,
            'savebtn' => 'Yaptığınız değişiklikleri kaydetmek ve modül içinde etkinleştirmek için <b>Kaydedip dağıt</b> üzerine tıklayın.',
            'historyBtn' => 'Daha önce kaydedilmiş yerleşimleri görüntülemek ve geri yüklemek için <b>Geçmişi görüntüle</b> üzerine tıklayın.<br><br><b>Geçmişi görüntüle</b> içindeki <b>Geri yükle</b> üzerine tıklayarak önceden kaydedilmiş yerleşimleri geri yükleyebilirsiniz. Alan etiketlerini düzenlemek için her alanın yanındaki Düzenle simgesine tıklayın.',
            'historyDefault' => 'Bir yerleşimi özgün biçimine geri döndürmek için <b>Varsayılanları geri yükle</b> üzerine tıklayın.<br><br> <b>Varsayılanları geri yükle</b> seçeneği yalnızca özgün yerleşimdeki alan düzenini yükler. Alan etiketlerini düzenlemek için her alanın yanındaki Düzenle simgesine tıklayın.',
        ...
        ,
            'savebtn' => 'Yaptığınız değişiklikleri kaydetmek ve modül içinde etkinleştirmek için <b>Kaydedip dağıt</b> üzerine tıklayın.',
            'historyBtn' => 'Daha önce kaydedilmiş yerleşimleri görüntülemek ve geri yüklemek için <b>Geçmişi görüntüle</b> üzerine tıklayın.<br><br><b>Geçmişi görüntüle</b> içindeki <b>Geri yükle</b> üzerine tıklayarak önceden kaydedilmiş yerleşimleri geri yükleyebilirsiniz. Alan etiketlerini düzenlemek için her alanın yanındaki Düzenle simgesine tıklayın.',
            'historyDefault' => 'Bir yerleşimi özgün biçimine döndürmek için <b>Varsayılanları geri yükle</b> üzerine tıklayın.<br><br> <b>Varsayılanları geri yükle</b> seçeneği yalnızca özgün yerleşimdeki alan düzenini yükler. Alan etiketlerini düzenlemek için her alanın yanındaki Düzenle simgesine tıklayın.',
            'Hidden' => '<b>Gizli</b> alanlar liste görünümlerinde kullanıcılara görüntülenmez.',
            'Default' => '<b>Varsayılan</b> alanlar kullanıcılar tarafından özelleştirilmemiş liste görünümlerinde görüntülenir.'
        ),
        ...
        'layoutEditor' => array(
            'defaultdetailview' => '<b>Yerleşim</b> bölgesinde şu anda <b>Ayrıntı görünümünde</b> görüntülenen alanlar bulunur.<br/><br/><b>Araç kutusunda</b> <b>Çöp kutusu</b> ile yerleşime eklenebilecek alanlar ve yerleşim bileşenleri bulunur.<br><br>Alanları ve yerleşim bileşenlerini <b>Araç kutusu</b> ile <b>Yerleşim</b> arasında sürükleyip bırakarak yerleşimi düzenleyebilirsiniz.<br><br>Herhangi bir alanı görünümden kaldırmak için alanı sürükleyip <b>Çöp kutusuna</b> bırakın. Çöpe atılan alanlar araç kutusunda yeniden yerleşime eklenebilecek şekilde görüntülenir.',
            'defaultquickcreate' => '<b>Yerleşim</b> bölgesinde şu anda <b>Hızlı ekle</b> formunda görüntülenen alanlar bulunur.<br><br>Ekle düğmesine tıklandığında, modülün alt panolarında hızlı ekle formu görüntülenir.<br/><br/><b>Araç kutusunda</b> <b>Çöp kutusu</b> ile yerleşime eklenebilecek alanlar ve yerleşim bileşenleri bulunur.<br><br>Alanları ve yerleşim bileşenlerini <b>Araç kutusu</b> ile <b>Yerleşim</b> arasında sürükleyip bırakarak yerleşimi düzenleyebilirsiniz.<br><br>Herhangi bir alanı yerleşimden kaldırmak için alanı sürükleyip <b>Çöp kutusuna</b> bırakın. Çöpe atılan alanlar araç kutusunda yeniden yerleşime eklenebilecek şekilde görüntülenir.',
            //this default will be used for edit view
            'default' => '<b>Yerleşim</b> bölgesinde şu anda <b>Düzenleme görünümünde</b> görüntülenen alanlar bulunur.<br/><br/><b>Araç kutusunda</b> <b>Çöp kutusu</b> ile yerleşime eklenebilecek alanlar ve yerleşim bileşenleri bulunur.<br><br>Alanları ve yerleşim bileşenlerini <b>Araç kutusu</b> ile <b>Yerleşim</b> arasında sürükleyip bırakarak yerleşimi düzenleyebilirsiniz.<br><br>Herhangi bir alanı görünümden kaldırmak için alanı sürükleyip <b>Çöp kutusuna</b> bırakın. Çöpe atılan alanlar araç kutusunda yeniden yerleşime eklenebilecek şekilde görüntülenir.',
            'saveBtn' => 'Yerleşim üzerinde, son kayıt işleminden sonra yapılan değişiklikleri korumak için <b>Kaydet</b> üzerine tıklayın.<br><br>Kaydedilen değişiklikler dağıtılana kadar modülde görüntülenmez.',
            'historyBtn' => 'Daha önce kaydedilmiş yerleşimleri görüntülemek ve geri yüklemek için <b>Geçmişi görüntüle</b> üzerine tıklayın.<br><br><b>Geçmişi görüntüle</b> içindeki <b>Geri yükle</b> üzerine tıklayarak önceden kaydedilmiş yerleşimleri geri yükleyebilirsiniz. Alan etiketlerini düzenlemek için her alanın yanındaki Düzenle simgesine tıklayın.',
            'historyDefault' => 'Bir yerleşimi özgün biçimine döndürmek için <b>Varsayılanları geri yükle</b> üzerine tıklayın.<br><br> <b>Varsayılanları geri yükle</b> seçeneği yalnızca özgün yerleşimdeki alan düzenini yükler. Alan etiketlerini düzenlemek için her alanın yanındaki Düzenle simgesine tıklayın.',
            'publishBtn' => 'Yerleşim üzerinde, son kayıt işleminden sonra yapılan değişiklikleri korumak ve bu değişiklikleri modül üzerinde etkinleştirmek için <b>Kaydedip dağıt</b> üzerine tıklayın.<br><br>Kaydedilen değişiklikler anında modülde görüntülenir.',
            'toolbox' => '<b>Araç kutusunda</b> <b>Çöp kutusu</b> ve yerleşime eklenebilecek alan ve yerleşim bileşenleri bulunur.<br/><br/>Alanları ve bileşenleri araç kutusu ile yerleşim arasında sürükleyip bırakarak yerleşimi düzenleyebilirsiniz.<br><br>Yerleşim bileşenleri <b>Panolar</b> ve <b>Satırlardır</b>. Yerleşime yeni bir satır ya da pano ekleyerek alanların eklenebileceği yeni bölgeler oluşturulabilir.<br/><br/>. Bir alanı başka bir alanla değişmek istediğinizde yeni alanı sürükleyip değiştirmek istediğiniz alanın üzerine bırakın.<br/><br/><b>Doldurucu</b> alanı sürüklendiği görünümde boş bir alan oluşturmak için kullanılır.',
            'panels' => '<b>Yerleşim</b> bölgesi, yerleşimde yapılan değişikliklerin uygulanmasından sonra, yerleşimin modülde nasıl olacağının görülmesini sağlar.<br/><br/>Alanları, satırları ve panoları istediğiniz konuma sürükleyip bırakarak taşıyabilirsiniz.<br/><br/>Yerleşim bileşenlerini araç kutusu üzerindeki <b>Çöp kutusuna</b> sürükleyip bırakarak silebilir ya da <b>Araç kutusundan</b> yerleşim alanında görüntülenmesini istediğiniz konuma sürükleyip bırakarak ekleyebilirsiniz.',
            'delete' => 'Herhangi bir bileşeni yerleşimden kaldırmak için sürükleyip buraya bırakın',
        ...
        'exportcustom' => array(
            ...
            'author' => 'Kurulum sırasında paketi oluşturan varlığın adı olarak görüntülenecek <b>Sorumlu</b> bilgisi. Sorumlu bir ilgili ya da kuruluş olabilir.',
            'description' => 'Kurulum sırasında görüntülenecek pakete ait <b>Açıklama</b>.',
        ),
        'studioWizard' => array(
            ...
            'layoutsBtn' => 'Modül <b>Yerleşimlerini</b> özelleştirir. Modüldeki alanların farklı şekillerde görüntülenmesini sağlar.<br><br>Hangi alanların görüntüleneceğini ve hangi yerleşimde görüntüleneceği belirlenebilir.',
            'subpanelBtn' => 'Modülde <b>Alt panolarda</b> hangi alanların görüntüleneceğini belirler.',
            'portalBtn' => '<b>SuiteCRM Portal</b> içinde görüntülenecek modül <b>Yerleşimlerini</b> özelleştirir.',
            'layoutsHelp' => 'Özelleştirilebilecek modül <b>Yerleşimleri</b> burada görüntülenir.<br><br> Yerleşimler alanları ve alan verilerini görüntüler.<br><br>Düzenlemek istediğiniz yerleşimi seçmek için bir simgeye tıklayın.',
            ...
            'viewBtnEditView' => 'Modülün <b>Düzenleme görünümü</b> yerleşimini özelleştirir.<br><br>Düzenleme görünümü formunda kullanıcının yazdığı verilerin kaydedileceği alanlar bulunur.',
            'viewBtnDetailView' => 'Modülün <b>Ayrıntı görünümü</b> yerleşimini özelleştirir.<br><br> Ayrıntı görünümünde kullanıcı tarafından yazılmış veriler görüntülenir.',
            ...
            'viewBtnListView' => 'Modülün <b>Liste görünümü</b> yerleşimini özelleştirir.<br><br> Arama sonuçları liste görünümünde görüntülenir.',
            'searchBtn' => 'Modülün <b>Arama</b> yerleşimlerini özelleştirir.<br><br>Liste görünümünde kayıtları süzmek için görüntülenecek alanları belirleyebilirsiniz.',
            'viewBtnQuickCreate' => 'Modülün <b>Hızlı ekle</b> yerleşimini özelleştirir.<br><br>Hızlı ekle formu e-posta modülünde ve alt panolarda görüntülenir.',
            'addLayoutHelp' => "Bir güvenlik grubuna bir özel yerleşim eklemek için ilgili güvenlik grubunu ve başlangıç noktası olarak kopyası kullanılacak yerleşimi seçin.",
            'searchHelp' => 'Özelleştirilebilecek <b>Arama</b> formları burada görüntülenir.<br><br>Arama formlarında kayıtları süzmek için alanlar bulunur.<br><br>Düzenlemek istediğiniz arama yerleşimini seçmek için bir simgeye tıklayın.',
            'dashletHelp' => 'Özelleştirilebilecek <b>SuiteCRM pano bileşeni</b> yerleşimleri burada görüntülenir.<br><br>SuiteCRM pano bileşeni, giriş modülüne eklenmek üzere görüntülenir.',
            ...
            'popupHelp' => 'Özelleştirilebilecek <b>Açılan pencere</b> yerleşimleri burada görüntülenir.<br>',
            ...
            'Layouts' => 'SuiteCRM Portal modüllerinin <b>Yerleşimlerini</b> özelleştirir.',
            'portalLayoutHelp' => 'Modüller SuiteCRM Portal içinde bu alanda görüntülenir.<br><br><b>Yerleşimini</b> düzenlemek istediğiniz bir modül seçin.',
            ...
            'convertLeadHelp' => 'Bu bölümden dönüştürme yerleşimine yeni modüller ekleyebilir ya da var olan modülleri düzenleyebilirsiniz.<br/>		İlgili satırı sürükleyip bırakarak tablodaki modül sıralamasını değiştirebilirsiniz.<br/><br/>		<b>Modül:</b> Modülün adı.<br/><br/>		<b>Zorunlu:</b> Potansiyel dönüştürülmeden önce eklenmesi ya da seçilmesi zorunlu olan modüller.<br/><br/>		<b>Verileri kopyala:</b> İşaretlendiğinde, potansiyel kaydındaki alanlar, yeni eklenen kayıtlardaki aynı adlı alanlara kopyalanır.<br/><br/>		<b>Seçilebilsin:</b>Potansiyel dönüştürme işlemi sırasında İlgili kayıtlarında ilişkili alanı olan modüller eklenmek yerine seçilebilir.<br/><br/>		<b>Düzenle:</b> Bu modülün dönüştürme yerleşimini düzenler.<br/><br/>		<b>Sil:</b>Bu modülü dönüştürme yerleşiminden kaldırır.<br/><br/>',
        ...
        'portalSync' => array(
            'default' => 'Güncellemek için <b>SuiteCRM Portal Adresine</b> giderek <b>Git</b> üzerine tıklayın.<br><br>Geçerli bir SuiteCRM kullanıcı adı ve parolası yazıp <b>Eşitlemeyi başlat</b> üzerine tıklayın.<br><br>Böylece SuiteCRM Portal <b>Yerleşimlerindeki</b> özelleştirmeler ve yüklenmiş ise, <b>Biçem dosyası</b> belirtilen portal kopyasına aktarılır.',
        ),
        'portalStyle' => array(
    ...
    'assistantHelp' => array(
        ...
        'module' => array(
            ...
            'create' => 'Eklemek istediğiniz modülün <b>Türünü</b> modülde bulunmasını istediğiniz alanların türlerine göre seçin.<br/><br/>Her modül kalıbında, başlığında belirtilen alan türleri bulunur.<br/><br/><b>Temel</b> - Ad, atanmış ilgili, takım, eklenme tarihi ve açıklama gibi standart modüllere özgü alan türleri bulunur.<br/><br/><b>Kuruluş</b> - Kuruluş adı, iş ve fatura adresi gibi kuruluşa özgü alanlar bulunur. Bu kalıbı standart hesap modülüne benzer modüller oluşturmak için kullanabilirsiniz.<br/><br/><b>Kişi</b> - Hitap, unvan, ad, adres ve telefon numarası gibi kişiye özgü alanlar bulunur. Bu kalıbı standart ilgililer ve potansiyeller modüllerine benzer modüller oluşturmak için kullanabilirsiniz.<br/><br/><b>Sorun</b> - Numara, durum, öncelik, açıklama gibi destek kaydı ve hata bildirimine özgü alanlar bulunur. Bu kalıbı standart destek kayıtları ve hata bildirimleri modüllerine benzer modüller oluşturmak için kullanabilirsiniz.<br/><br/>Not: Modülü oluşturduktan sonra kalıp tarafından sağlanan alan etiketlerini düzenleyebilir ve modül yerleşimine özel alanlar ekleyebilirsiniz.',
            'afterSave' => 'Yeni alanlar ekleyerek, var olan alanları düzenleyerek, modüller arasında ilişkiler kurarak ve yerleşimlerdeki alanları düzenleyerek bir modülü özelleştirebilirsiniz.<br/><br/>Kalıp alanlarını görüntülemek ve modüldeki özel alanları yönetmek için <b>Alanları görüntüle</b> üzerine tıklayın.<br/><br/>Modül ile diğer modüller arasında ilişkiler eklemek ya da düzenlemek için <b>İlişkileri görüntüle</b> üzerine tıklayın.<br/><br/>Modül yerleşimlerini düzenlemek için <b>Yerleşimleri görüntüle</b> üzerine tıklayın. Modülün ayrıntı, düzenleme ve liste görünümlerini uygulamada var olan diğer modüller gibi Studio aracını kullanarak düzenleyebilirsiniz.<br/><br/>Var olan modüllere benzer özelliklerde yeni bir modül oluşturmak için <b>Kopyala</b> üzerine tıklayın. Ardından yeni modülü özelleştirebilirsiniz.',
            'viewfields' => 'Modüldeki alanları isteklerinize göre özelleştirebilirsiniz.<br/><br/>Standart alanlar silinemez ancak Yerleşim sayfalarından kaldırılabilir.<br/><br/>Var olan alanlara benzer özelliklerde alanlar eklemek için <b>Özellikler</b> formunda <b>Kopyala</b> üzerine tıklayabilirsiniz. Yeni özellikleri ekledikten sonra <b>Kaydet</b> üzerine tıklayın.<br/><br/>Özel modülün bulunduğu paketi yayınlamadan ya da kurmadan önce tüm standart ve özel alanların özelliklerini ayarlamış olmanız önerilir.',
            ...
            'viewlayouts' => '<b>Düzenleme görünümünde</b> veri girişi için kullanılacak alanları yönetebilirsiniz. <b>Ayrıntı görünümünde</b> hangi bilgilerin görüntüleneceğini yönetebilirsiniz. Bu iki görünümün aynı olması şart değildir.<br/><br/>Bir modül alt panosunda <b>Ekle</b> üzerine tıklandığında hızlı ekleme formu görüntülenir. Varsayılan olarak <b>Hızlı ekleme</b> formu yerleşimi ile <b>Düzenleme görünümü</b> yerleşimi aynıdır. Hızlı ekleme formunu düzenleme görünümü yerleşiminden farklı alanlar bulunacak şekilde özelleştirebilirsiniz.<br><br>Modül güvenliğini <b>Rol yönetimi</b> ile yerleşim özelleştirmesini kullanarak sağlayabilirsiniz.<br><br>',
        ...
        'listViewEditor' => array(
            'modify' => 'Sol tarafta üç sütun görüntülenir. "Varsayılan" sütununda liste görünümünde varsayılan olarak görüntülenen alanlar bulunur, "Kullanılabilir" sütununda özel liste görünümü oluşturmak için kullanıcının seçebileceği alanlar bulunur. "Gizli" sütununda şu anda kullanıcılar için kapalı olan, ancak yönetici olarak kullanıcıların kullanabilmesi için Varsayılan ya da Kullanılabilir sütunlarına ekleyebileceğiniz alanlar bulunur.',
            ...
            'Available' => 'Kullanılabilir alanlar ilk varsayılan olarak görüntülenmez ancak kullanıcılar tarafından açılabilir.',
        ...
        'layoutEditor' => array(
            'default' => 'Solda iki sütun görüntülenir. Sağdaki sütunda geçerli yerleşim ya da yerleşim ön izlemesi görüntülenir ve modül yerleşimi buradan değiştirilebilir. Soldaki sütunda araç kutusu bulunur ve yerleşimi düzenlemek için gerekli bileşen ve araçlar bulunur.<br/><br/>Yerleşim bölgesinin adı geçerli yerleşim ise, şu anda modül tarafından kullanılan yerleşimin bir kopyası üzerinde çalışıyorsunuz demektir.<br/><br/>Yerleşim bölgesinin adı yerleşim ön izlemesi ise, daha önce Kaydet düğmesine tıklanarak oluşturulmuş ve bu modülün kullanıcılarına görüntülenenden farklı olabilecek bir yerleşim sürümü üzerinde çalışıyorsunuz demektir.',
            'saveBtn' => 'Bu düğmeye tıklandığında, yerleşim kaydedilerek değişiklikler korunur. Bu modüle geri geldiğinizde bu kaydedilmiş yerleşimden başlarsınız. Bununla birlikte Kaydedip yayınla düğmesine tıklanmadan bu yerleşim modül kullanıcılarına görüntülenmez.',
            'publishBtn' => 'Yerleşimi dağıtmak için bu düğmeye tıklayın. Böylece bu yerleşim bu modülün kullanıcılarına anında görüntülenir.',
            'toolbox' => 'Araç kutusunda, kullanılabilecek alanlar, ek bileşenler ve çöp kutusu gibi yerleşimleri düzenlemek için kullanılan çeşitli araçlar bulunur. Bu araçlar sürüklenip bırakılarak yerleşim düzenlenebilir.',
            'panels' => 'Bu modülün dağıtıldıktan sonra yerleşimin kullanıcılara nasıl görüntüleneceği.<br/><br/>Alanları, satırları ve panoları istediğiniz konuma sürükleyip bırakarak taşıyabilirsiniz. Yerleşim bileşenlerini araç kutusu üzerindeki çöp kutusuna sürükleyip bırakarak silebilir ya da araç kutusundan yerleşim alanında görüntülenmesini istediğiniz konuma sürükleyip bırakarak ekleyebilirsiniz.'
        ),
        ...
        'exportcustom' => array(
            ...
            'author' => 'Paketi oluşturan varlığın adı olan <b>Sorumlu</b> bilgisi. Sorumlu bir ilgili ya da kuruluş olabilir.<br><br>Sorumlu bilgisi paketin kurulum için Studio aracına yüklenmesinden sonra modül yükleyicide görüntülenir.',
        ...
        'studioWizard' => array(
            ...
            'layoutsBtn' => 'Düzenleme, ayrıntı, liste ve arama görünümlerinin <b>Yerleşimlerini</b> özelleştirin.',
            'subpanelBtn' => 'Bu modülün alt panolarında görüntülenecek bilgileri düzenleyebilirsiniz.',
            'layoutsHelp' => '<b>Düzenlenecek bir yerleşim</b> seçin.<br/><br/>Veri girişi için kullanılacak veri alanlarının bulunduğu yerleşim değiştirmek için <b>Düzenleme görünümü</b> üzerine tıklayın.<br/><br/>Düzenleme görünümünde alanlara yazılan verilerin görüntülendiği yerleşim düzenlemek için <b>Ayrıntı görünümü</b> üzerine tıklayın.<br/><br/>Varsayılan listedeki sütunları düzenlemek için, <b>Liste görünümü</b> üzerine tıklayın.<br/><br/>Temel ve gelişmiş arama formlarının yerleşimlerini düzenlemek için <b>Arama</b> üzerine tıklayın.',
            'subpanelHelp' => 'Düzenlenecek bir <b>Alt pano</b> seçin.',
            'searchHelp' => 'Düzenlenecek bir <b>Arama</b> yerleşimi seçin.',
            'newPackage' => 'Yeni bir paket eklemek için <b>Yeni paket</b> üzerine tıklayın.',
...
//STUDIO2
    ...
    'LBL_LAYOUT_PREVIEW' => 'Yerleşim ön izlemesi',
    ...
    'LBL_TABDEF_TYPE_HELP' => 'Bu bölümün nasıl görüntüleneceğini seçin. Bu seçenek yalnızca bu görünüm için sekmeler açılmış ise etkili olur.',
    'LBL_TABDEF_TYPE_OPTION_TAB' => 'Sekme',
    'LBL_TABDEF_TYPE_OPTION_PANEL' => 'Pano',
    'LBL_TABDEF_TYPE_OPTION_HELP' => 'Bu panonun yerleşim içinde görüntülenmesi için pano olarak seçin. Bu panonun yerleşim içinde ayrı bir sekmede görüntülenmesi için Sekme olarak seçin. Bir pano sekme olarak ayarlandığında, pano olarak ayarlanmış diğer panolar sekme içinde görüntülenir.<br/>Sekme olarak seçilmiş sonraki pano için yeni bir sekme başlatılır. İlk panonun altındaki bir pano sekme olarak ayarlanmış ise ilk pano sekme olmalıdır.',
    'LBL_TABDEF_COLLAPSE' => 'Daralt',
    'LBL_TABDEF_COLLAPSE_HELP' => 'Seçildiğinde, bu panonun varsayılan durumu daraltılmış olarak ayarlanır.',
    ...
    'LBL_SYNC_TO_DETAILVIEW_HELP' => 'Bu seçenek seçildiğinde, bu düzenleme görünümü yerleşimi, ilgili ayrıntı görünümü ile eşitlenir. Düzenleme görünümündeki alanlar ve alan konumları<br>Düzenleme görünümünde kaydet ya da kaydedip dağıt üzerine tıklandığında otomatik olarak ayrıntı görünümü ile eşitlenir ve kaydedilir.<br>Ayrıntı görünümü üzerinde yerleşim değişiklikleri yapılamaz.',
    'LBL_SYNC_TO_DETAILVIEW_NOTICE' => 'Ayrıntı görünümü ilgili düzenleme görünümü ile eşitlenmiş.<br>Bu ayrıntı görünümündeki alanlar ve alan konumları düzenleme görünümündeki alan ve alan konumlarını yansıtır.<br>Ayrıntı görünümündeki değişiklikler bu bölümden kaydedilemez ya da dağıtılamaz. Değişiklikleri düzenleme görünümü üzerinde yapın ya da yerleşimler arasındaki eşitlemeyi kaldırın. ',
...
//STUDIO QUESTIONS
    ...
    'LBL_QUESTION_LAYOUT' => 'Düzenlenecek bir yerleşim seçin.',
    'LBL_QUESTION_SUBPANEL' => 'Düzenlenecek bir alt pano seçin.',
    'LBL_QUESTION_SEARCH' => 'Düzenlenecek bir süzgeç yerleşimi seçin.',
...
//ERRORS
    ...
    'ERROR_MINIMUM_FIELDS' => 'Yerleşimde en az bir alan bulunmalıdır',
    'ERROR_GENERIC_TITLE' => 'Bir sorun çıktı',
    'ERROR_REQUIRED_FIELDS' => 'İlerlemek istediğinize emin misiniz? Aşağıdaki zorunlu alanlar yerleşimde bulunmuyor:  ',
...
//JS
    'LBL_JS_REMOVE_PACKAGE' => 'Bu paketi kaldırmak istediğinize emin misiniz? Bu paket ile ilişkili tüm dosyalar kalıcı olarak silinecek.',
    'LBL_JS_REMOVE_MODULE' => 'Bu modülü kaldırmak istediğinize emin misiniz? Bu modül ile ilişkili tüm dosyalar kalıcı olarak silinecek.',
...
//CONFIRM
    'LBL_CONFIRM_FIELD_DELETE' => 'Bu özel alan silindiğinde özel alandaki ve veri tabanındaki özel alan ile ilgili tüm veriler silinir. Özel alan modül yerleşimlerinde görüntülenmez.\\n\\nİlerlemek istiyor musunuz?',
...
//POPUP HELP
    ...
    'LBL_POPHELP_DUPLICATE_MERGE' => '<b>Açık</b>: Alan, çift kayıtları birleştir özelliğinde görüntülenir, ancak çift kayıtları bul özelliğindeki süzgeç koşulları için kullanılamaz.<br><b>Kapalı</b>: Alan çift kayıtları birleştir özelliğinde görüntülenmez ve çift kayıtları birleştir özelliğindeki süzgeç koşulları için kullanılamaz.<br><b>Süzgeç</b>: Alan, Yinelenenleri Birleştir özelliğinde görüntülenir ve Yinelenenleri Bul özelliğindeki süzgeç koşulları için kullanılabilir.<br><b>Varsayılan olarak seçilmiş süzgeç</b>: Alan, Yinelenenleri Birleştir özelliğinde görüntülenir ve Yinelenenleri Bul özelliğindeki süzgeç koşulları için varsayılan olarak kullanılır.<br><b>Yalnızca süzgeç</b>: Alan, Yinelenenleri Birleştirme özelliğinde görüntülenmez, ancak Yinelenenleri Bul özelliğindeki süzgeç koşulları için kullanılabilir.',
