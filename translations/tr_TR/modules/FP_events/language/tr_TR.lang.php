...
$mod_strings = array(
    ...
    'LBL_SEARCH_FORM_TITLE' => 'Etkinlik ara',
    ...
    'LBL_DEFAULT_SUBPANEL_TITLE' => 'Delegeler',
    ...
    'LBL_ERROR_MSG_1' => 'Bağlantılı tüm ilgililer zaten çağrılmış.',
    'LBL_ERROR_MSG_2' => 'Çağrı e-postaları gönderilemedi! Lütfen e-posta ayarlarınızı denetleyin.',
    'LBL_ERROR_MSG_3' => '10 taneden fazla e-posta gönderilemedi. Lütfen çağırdığınız tüm ilgililerin e-posta adreslerinin geçerli olup olmadığını denetleyin (suitecrm.log dosyasına bakın).',
    'LBL_ERROR_MSG_4' => ' e-posta gönderilemedi. Lütfen çağırdığınız tüm ilgililerin e-posta adreslerinin geçerli olup olmadığını denetleyin (suitecrm.log dosyasına bakın).', // LBL_ERROR_MSG_4 Begins with a number (controller.php line 581) for example 10 emails have failed to send.
