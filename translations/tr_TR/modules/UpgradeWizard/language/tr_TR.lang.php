...
$mod_strings = array(
    ...
    'ERR_UW_WRONG_TYPE' => 'Bu sayfa şunu çalıştırmak için değil ',
    ...
    'LBL_UW_PREFLIGHT_FILES_DESC' => 'Aşağıdaki dosyalar değiştirilmiş. El ile birleştirilmesi gereken ögelerin işaretini kaldırın. <i>Algılanan yerleşim değişikliklerinin işaretleri otomatik olarak kaldırılır. Üzerine yazılması gerekenleri yeniden işaretleyin.',
    ...
    'LBL_LAYOUT_MERGE_DESC' => 'Bu güncellemenin bir parçası olarak eklenmiş yeni alanlar var. Bu alanlar var olan modül yerleşimlerine otomatik olarak eklenebilir. Yeni alanlar ile ilgili ayrıntılı bilgi almak için güncelleyeceğiniz sürümün Yayın notlarına bakabilirsiniz.<br><br>Yeni alanların eklenmesini istemiyorsanız modülün işaretini kaldırın. Böylece özelleştirilmiş yerleşimler üzerinde herhangi bir değişiklik yapılmaz. Güncelleme sonrası bu alanlar Studio üzerinden kullanılabilir.<br><br>',
