...
$mod_strings = array(
    'ERR_DELETE_RECORD' => 'İlgiliyi silmek için kayıt numarasını belirtin.',
    ...
    'LBL_DUPLICATE' => 'Olası çift ilgili',
    ...
    'LBL_EXISTING_CONTACT' => 'Var olan bir ilgili kullanıldı',
    ...
    'LBL_VCARD' => 'vCard',
    'LBL_IMPORT_VCARDTEXT' => 'Aygıtınızdan bir vCard dosyası içe aktararak otomatik olarak yeni bir ilgili kaydı ekleyebilirsiniz.',
    ...
    'LBL_LIST_FORM_TITLE' => 'İlgili listesi',
    ...
    'LBL_REPORTS_TO_ID' => 'Rapor verilecek ilgili kimliği:',
    'LBL_REPORTS_TO' => 'Rapor verilecek ilgili:',
    'LBL_RESOURCE_NAME' => 'Kaynak adı',
    'LBL_SALUTATION' => 'Hitap:',
    'LBL_SAVE_CONTACT' => 'İlgiliyi kaydet',
    'LBL_SEARCH_FORM_TITLE' => 'İlgili arama',
    'LBL_SELECT_CHECKED_BUTTON_LABEL' => 'İşaretlenmiş ilgilileri seç',
    'LBL_SELECT_CHECKED_BUTTON_TITLE' => 'İşaretlenmiş ilgilileri seç',
    'LBL_STATE' => 'İl/Bölge:',
    'LBL_SYNC_CONTACT' => 'Outlook&reg; ile eşitle:',
    'LBL_PROSPECT_LIST' => 'Aday listesi',
    'LBL_TITLE' => 'İş unvanı:',
    'LNK_CONTACT_LIST' => 'İlgilileri görüntüle',
    'LNK_IMPORT_VCARD' => 'vCard ile ilgili ekle',
    ...
    'NTC_REMOVE_CONFIRMATION' => 'Destek kaydından bu ilgiliyi kaldırmak istediğinize emin misiniz?',
    ...
    'LBL_ENABLE_PORTAL_USER' => 'Portal kullanıcısını aç',
    'LBL_DISABLE_PORTAL_USER' => 'Portal kullanıcısını kapat',
    ...
    'LBL_FAILED_TO_CONNECT_JOOMLA' => 'Portal kullanıcısı oluşturulamadı, Joomla! ile bağlantı kurulamadı',
    'LBL_ERROR_CONTACT_ID_OR_EMAIL_EMPTY' => 'İlgili kişi kimliği ya da e-posta adresi boş',
    'LBL_NO_JOOMLA_URL' => 'Portal adresi belirtilmemiş',
    'LBL_PORTAL_USER_TYPE' => 'Portal kullanıcısı türü',
    'LBL_PORTAL_ACCOUNT_DISABLED' => 'Hesap kapatıldı',
    'LBL_JOOMLA_ACCOUNT_ID' => 'Joomla! hesabı kimliği',
    'LBL_AOP_DISABLED' => 'AOP kapalı. Lütfen ayarlar bölümünden açın',

    'LBL_AOS_CONTRACTS' => 'Sözleşmeler',
    'LBL_AOS_INVOICES' => 'Faturalar',
    'LBL_AOS_QUOTES' => 'Fiyat teklifleri',
    'LBL_PROJECT_CONTACTS_1_FROM_PROJECT_TITLE' => 'Proje başlığından proje ile ilgililer',
    'LBL_LAST_MEETING' => 'Bir toplantıda son etkileşime geçtiğiniz zaman:',
    'LBL_LAST_CALL' => 'Bir telefon aramasında son etkileşime geçtiğiniz zaman:',
