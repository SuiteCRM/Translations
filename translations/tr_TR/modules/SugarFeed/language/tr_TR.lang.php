...
$mod_strings = array(
    ...
    'LBL_DASHLET_DISABLED' => 'Uyarı: SuiteCRM akış sistemi kapalı. Yeniden açılana kadar yeni bir akış kaydı gönderilmeyecek',
    'LBL_RECORDS_DELETED' => 'Önceki tüm akış kayıtları kaldırıldı. SuiteCRM akış sistemi açılırsa yeni kayıtlar otomatik olarak eklenir.',
    'LBL_CONFIRM_DELETE_RECORDS' => 'Tüm akış kayıtlarını silmek istediğinize emin misiniz?',
    'LBL_FLUSH_RECORDS' => 'Akış kayıtlarını sil',
    'LBL_ENABLE_FEED' => 'İşlem akışım pano bileşenini aç',
    'LBL_ENABLE_MODULE_LIST' => 'Şunun için akışlar açılsın',
    'LBL_HOMEPAGE_TITLE' => 'İşlem akışım',
    'LNK_NEW_RECORD' => 'Akış ekle',
    'LNK_LIST' => 'Akış',
    'LBL_SEARCH_FORM_TITLE' => 'Akış ara',
    ...
    'LBL_ENABLE_USER_FEED' => 'Kullanıcı akışını aç',
...
// Activity stream
    ...
    'FOR' => 'şunun için', // Activity stream for cases
    'FOR_AMOUNT' => 'şu tutar için', // Activity stream for cases
    ...
    'LBL_AUTHENTICATION_PENDING' => 'Seçtiğiniz dış hesapların tümünün kimliği doğrulanmamış. Dış hesapların kimliğini doğrulamak üzere seçenekler penceresine dönmek için \'İptal\' üzerine tıklayın. Kimlik doğrulamasını yapmadan ilerlemek için \'Tamam\' üzerine tıklayın.',
