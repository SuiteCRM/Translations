...
$mod_strings = array(
    ...
    'LBL_LIST_NONINHERITABLE' => 'Devralınamaz',
    'LBL_NAME' => 'Ad',
    ...
    'LBL_SEARCH_FORM_TITLE' => 'Güvenlik grubu yönetimi ara',
    ...
    'LBL_INHERIT_CREATOR_DESC' => 'Açıldığında, bu kayıt için ekleyen kullanıcıya atanmış tüm gruplar devralınır.',
    'LBL_INHERIT_PARENT' => 'Üst kayıttan devralınsın',
    'LBL_INHERIT_PARENT_DESC' => 'Açıldığında, örneğin bir ilgili için bir destek kaydı eklenirse, ilgili ile ilişkili gruplar devralınır.',
    'LBL_USER_POPUP' => 'Yeni kullanıcı grubu açılır penceresi',
    'LBL_USER_POPUP_DESC' => 'Açıldığında, yeni bir kullanıcı eklenirken, kullanıcıyı gruplara atamak için GüvenlikGrupları açılır penceresi görüntülenir.',
    'LBL_INHERIT_ASSIGNED' => 'Atanmış kullanıcıdan devralınsın',
    'LBL_INHERIT_ASSIGNED_DESC' => 'Açıldığında, kayda atanmış kullanıcının tüm kullanıcı grupları devralınır. Kayda atanmış diğer gruplar KALDIRILMAZ.',
    'LBL_POPUP_SELECT' => 'Ekleyenin grup seçimi kullanılsın',
    'LBL_POPUP_SELECT_DESC' => 'Açıldığında, birden fazla grupta bulunan bir kullanıcı tarafından bir kayıt eklendiğinde, ekleme sayfasında bir grup seçim panosu görüntülenir. Kapatıldığında o bir grup devralınır.',
    ...
    'LBL_REMOVE_BUTTON_LABEL' => 'Kaldır',
    'LBL_GROUP' => 'Grup:',
    'LBL_MODULE' => 'Modül:',
