...
$mod_strings = array(
    ...
    'LBL_STATUS' => 'Durum',
    'LBL_QUEUEING_STATUS' => 'Kuyruğa eklenme durumu',
    'LBL_STATUS_TEXT' => 'Durum:',
    'LBL_TEMPLATE_NAME' => 'Kalıp adı',
    'LBL_DATE_ENTERED' => 'Yazıldığı tarih',
    ...
    'LBL_SCHEDULED_START_DATE' => 'Zamanlanmış yürütülme tarihi',
    'LBL_CHECK_DUPLICATE' => 'Çift kayıtları işleme',
    'LBL_TIME_START' => 'Başlangıç saati',
    'LBL_START_DATE_TIME' => 'Başlangıç tarihi ve saati: ',
    'LBL_TEMPLATE' => 'E-posta kalıbı: ',
    'LBL_TEMPLATE_SELECTED' => 'Kalıp',
    ...
    'LBL_SCHEDULE_BUTTON_LABEL' => 'Zamanla',
    'LBL_ERROR_ON_MARKETING' => 'Zorunlu alanlar doldurulmamış',

    'LBL_CAMPAIGN_ID' => 'Kampanya kimliği',
    'LBL_OUTBOUND_EMAIL_ACOUNT_ID' => 'Giden e-posta hesabı kimliği',
    'LBL_EMAIL_TEMPLATE' => 'E-posta kalıbı',
    'LBL_PROSPECT_LISTS' => 'Aday listeleri',
    'LBL_OVERVIEW' => 'Temel',
    'LBL_EMAIL_CONFIG' => 'E-posta ayarları',
    'LBL_CONFIGS' => 'YAPILANDIRMALAR',
    'LBL_EMAIL' => 'E-POSTA',
    'LBL_BODY' => 'İçerik yazısı',
    'LBL_MARKETING_TYPE' => 'Pazarlama türü',
    'LBL_SURVEY' => 'Anket',
    'LBL_SCHEDULE' => 'Zamanla',
    'LBL_RESUME' => 'Sürdür',
    'LBL_PAUSE_REASON' => 'Duraklatma nedeni',
    'LBL_DELETE_TEST_ENTRIES' => 'Deneme kayıtlarını sil',
    'LBL_UNSCHEDULE' => 'Zamanlamayı kaldır',
    'LBL_ABORT' => 'İptal',
    'LBL_USERS' => 'Kullanıcılar',
    'LBL_SEND_TEST_EMAIL' => 'Deneme e-postası gönder',
    'LBL_SELECT_RECORDS_WITH_EMAILS' => 'Lütfen e-postalar ile kayıtları seçin',
    'LBL_MESSAGE_QUEUE_TITLE' => 'İleti kuyruğu',
    'LBL_SCHEDULED_START_DATE_HELP' => 'Gönderim gruplar halinde yapılacak. Bu işlem dakikalar ya da saatler sürebilir.',
    'LBL_TARGET_LISTS_HELP' => 'Pazarlama alıcıları. Kampanyanın bastırma listelerindeki alıcılar engellenir.',
    'LBL_STATUS_DRAFT_NOT_SEND_HELP' => 'Pazarlama süreci yalnızca zamanlandığında başlar.',
    'LBL_TYPE_MARKETING_HELP' => 'Alıcılar ayrılma doğrulamasını kullanabilir.',
    'LBL_TYPE_LEGACY_HELP' => 'Bu eski bir e-posta pazarlama kaydı ve geçmiş veri amaçları için tutuluyor.',
    'LBL_TYPE_TRANSACTIONAL_HELP' => 'Alıcılar ayrılma doğrulamasını kullanamaz.',
    ...
    'LBL_TRACKERS_ENABLED_FOOTNOTE' => 'Açıldığında, bağlantılar tıklamaları izleyen izleyici bağlantılarıyla değiştirilir.',
    'LBL_TRACKERS_DISABLED_FOOTNOTE' => 'Kapatıldığında, bağlantılar tıklamaları izleyen izleyici bağlantılarıyla değiştirilmez.',
    'LBL_TRACKERS_DISABLED_GLOBALLY_FOOTNOTE' => 'İzleyiciler genel olarak kapatılmış. E-posta görüntülemeleri ve tıklamaları izlenmeyecek.',
    'LBL_HAS_TEST_DATA' => 'Deneme verileri var',
);
