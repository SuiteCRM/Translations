...
$mod_strings = array(
    ...
    'LBL_EMAIL_ENABLE_SEND_OPT_IN' => 'Otomatik abone olma e-postası gönderilsin',
    'LBL_EMAIL_CONFIRM_OPT_IN_TEMPLATE_ID' => 'Abone olma onayı e-posta kalıbı',
    'LBL_DRAFTS_POPUP' => 'Taslaklar iletişim kutusu kullanılsın',
    ...
    'LBL_EMAILS_PER_RUN' => 'Bir toplu işlemde işlenen/gönderilen e-postaların sayısı:',
    'LBL_CAMPAIGN_MAX_RETRIES' => 'Başarısız olduğunda her alıcı için en fazla yeniden gönderme denemesi:',
    'LBL_CAMPAIGN_THRESHOLD' => 'Her toplu iş için hata eşiği (ulaşıldığında kampanya duraklatılır, kapatmak için 0):',
    'LBL_CAMPAIGN_MARKETING_RECORDS_PER_RUN' => 'Bir yürütülmede işlenecek e-posta pazarlama kayıtlarının sayısı:',
    'LBL_TRACKERS_ENABLED' => 'İzleyiciler etkin:',
    'LBL_TRACKER_LINKS_ENABLED' => 'İzleyici bağlantıları açık',
    'LBL_ID' => 'Kimlik',
    ...
    'LBL_CAMP_MESSAGE_COPY_DESC' => 'Bütün kampanyalar sırasında gönderilen <bold>HER</bold> e-postanın kopyasını saklamak ister misiniz? <bold>Varsayılan olarak Hayır seçeneğinin kullanılması önerilir</bold>. Hayır seçildiğinde, yalnızca e-posta kalıbı ve her bir iletinin yeniden oluşturulmasını sağlayacak değişkenler tutulur.',
    ...
    'LBL_NOTIFICATION_ON_DESC' => 'Açıldığında, kullanıcılara bir kayıt atandığında e-posta gönderilir.',
    ...
    'LBL_RELATED_TYPE' => 'İlişkili tür',
    'LBL_SEARCH_FORM_TITLE' => 'Kuyruk ara',
    ...
    'LBL_ALLOW_DEFAULT_SELECTION_HELP' => 'Bu seçenek seçildiğinde, tüm kullanıcılar sistem bildirim ve uyarılarını göndermek için kullanılan giden e-posta hesabını kullanarak e-posta gönderebilir.<br>Seçilmediğinde, kullanıcıların giden e-posta sunucusunu kullanabilmesi için kendi hesap bilgilerini yazması gerekir.',
    'LBL_FROM_ADDRESS_HELP' => 'Açıldığında, e-postanın "Kimden" alanında atanmış kullanıcının adı ve e-posta adresi görüntülenir. Bu özellik sunucu hesabından başka hesaplardan gönderime izin vermeyen SMTP sunucularında çalışmayabilir.',
    'LBL_HELP' => 'Yardım' /*for 508 compliance fix*/,
    'LBL_OUTBOUND_EMAIL_ACCOUNT_VIEW' => 'Giden e-posta hesaplarını görüntüle',
    'LBL_SYSTEM_OUTBOUND_EMAIL_ACCOUNT' => 'Sistem giden e-posta hesabı',
    'LBL_ALLOW_SEND_AS_USER' => 'Kullanıcılar kendileri olarak gönderebilir:',
    'LBL_ALLOW_SEND_AS_USER_DESC' => 'Açıldığında, <b>tüm</b> kullanıcılar e-postanın &quot;Kimden&quot; alanında kendi birincil e-posta adreslerini kullanarak, giden sunucu üzerinden e-posta gönderebilir.<br>Bu özellik sunucu hesabından başka hesaplardan gönderime izin vermeyen SMTP sunucularında çalışmayabilir.',
    'LBL_EMAIL_IMPORT_CONFIGURATION' => 'E-posta içe aktarma yapılandırması',
    'LBL_EMAIL_IMPORT_PER_RUN_THRESHOLD' => 'Bir yürütülmede içe aktarılacak e-posta sayısı eşiği (e-posta kutusu başına)',
    'LBL_EMAIL_IMPORT_PER_RUN_THRESHOLD_DESC' => 'Bir yürütülmede içe aktarılacak e-posta sayısı eşiği. Varsayılan değer: 25. Her yürütülme, en eskiden en yeniye kadar belirlenen zaman dilimi içinde e-posta kutusunda her günü işleyer. Bir yürütülmede içe aktarılan toplam e-posta sayısı eşiği aşılana kadar her günün tüm e-postaları içe aktarılır. Eşik aşıldığında, iş durur ve bir sonraki yürütülmede kaldığı yerden başlayarak içe aktarılan son günü işaretler.',
    'LBL_EMAIL_IMPORT_TIMEFRAME_START' => 'Yeni e-posta kutusu içe aktarmalarının başlangıç noktası',
    'LBL_EMAIL_IMPORT_TIMEFRAME_START_DESC' => 'E-postaların içe aktarılmaya başlayacağı zaman aralığı. Örneğin, 30 Gün seçildiğinde 30 gün önceki e-postalardan başlanır ve ilerlenir.',
    'LBL_EMAIL_IMPORT_FETCH_UNREAD_ONLY' => 'Yalnızca okunmamış e-postalar içe aktarılsın',
);
