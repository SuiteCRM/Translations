...
$mod_strings = array(
    ...
    'LBL_AUTOREPLY_HELP' => 'E-posta gönderenlere iletilerinin alındığını bildirmek için kullanılacak bir otomatik yanıt seçin.',
    ...
    'LBL_ASSIGN_TO_GROUP_FOLDER_DESC' => 'Seçildiğinde, gelen tüm e-postalar için otomatik olarak SuiteCRM üzerinde e-posta kayıtları eklenir.',
    ...
    'LBL_CREATE_CASE_HELP' => 'Seçildiğinde, gelen e-postalardan otomatik olarak SuiteCRM üzerine destek kaydı eklenebilir.',
    ...
    'LNK_LIST_CREATE_NEW_PERSONAL' => 'Yeni kişisel gelen e-posta hesabı',
    'LNK_LIST_CREATE_NEW_GROUP' => 'Yeni grup gelen e-posta hesabı',
    'LNK_LIST_CREATE_NEW_CASES_TYPE' => 'Yeni destek kaydı işleme e-posta hesabı',
    'LNK_LIST_CREATE_NEW_BOUNCE' => 'Yeni geri dönüş işleme e-posta hesabı',
    ...
    'LBL_ALLOW_OUTBOUND_GROUP_USAGE_DESC' => 'Bu seçenek seçildiğinde, grup e-posta hesabına erişebilen kullanıcılar tarafından yeni bir e-posta iletisi oluşturulurken, bu grup e-posta hesabının kimden adı ve adresi, kime alanında bir seçenek olarak görüntülenir.',
    ...
    'LBL_WARNING_CHANGING_AUTO_IMPORT_WITH_CREATE_CASE' => 'Uyarı: Destek kayıtları otomatik olarak oluşturulurken otomatik içe aktarma seçeneği açılmış olmalı.',
