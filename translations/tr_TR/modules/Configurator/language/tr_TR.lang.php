...
$mod_strings = array(
    ...
    'LBL_MIN_AUTO_REFRESH_INTERVAL_HELP' => 'Kullanıcıların pano bileşenlerinin otomatik yenileme aralığı için seçebileceği en küçük değer. \'Asla\' olarak seçilirse pano bileşenlerinin otomatik yenilenmesi kapatılır.',
    ...
    'LBL_USE_REAL_NAMES_DESC' => 'Açıldığında, atama alanlarında kullanıcı adı yerine kullanıcıların ad ve soyadlarından oluşan tam adları görüntülenir.',
    'LBL_DISALBE_CONVERT_LEAD' => 'Dönüştürülmüş potansiyeller için potansiyel dönüştürme işlemi kapatılsın',
    'LBL_DISALBE_CONVERT_LEAD_DESC' => 'Açıldığında, daha önce dönüştürülmüş potansiyeller için potansiyel dönüştürme işlemi kaldırılır.',
    'LBL_ENABLE_ACTION_MENU' => 'İşlemler menüler içinde görüntülensin',
    'LBL_ENABLE_ACTION_MENU_DESC' => 'Açıldığında, ayrıntı görünümü ve alt pano işlemleri bir açılan liste menüsünde görüntülenir. Kapatıldığında işlemler ayrı düğmeler olarak görüntülenir.',
    'LBL_ENABLE_INLINE_EDITING_LIST' => 'Liste görünümünde satır içi düzenleme yapılabilsin',
    'LBL_ENABLE_INLINE_EDITING_LIST_DESC' => 'Açıldıında, liste görünümündeki alanlarda satır içi düzenleme yapılabilir. Kapatıldığında liste görünümünde satır içi düzenleme yapılamaz.',
    'LBL_ENABLE_INLINE_EDITING_DETAIL' => 'Ayrıntı görünümünde satır içi düzenleme yapılabilsin',
    'LBL_ENABLE_INLINE_EDITING_DETAIL_DESC' => 'Açıldığında, ayrıntı görünümündeki alanlarda satır içi düzenleme yapılabilir. Kapatıldığında ayrıntı görünümünde satır içi düzenleme yapılamaz.',
    ...
    'LOCK_HOMEPAGE' => 'Kullanıcılar giriş sayfası yerleşimini özelleştiremesin',
    'LOCK_SUBPANELS' => 'Kullanıcılar alt pano yerleşimini özelleştiremesin',
    ...
    'LBL_LDAP_LEGACY_WARNING' => 'LDAP uyarısı',
    'LBL_LDAP_LEGACY_WARNING_MORE' => 'Bu LDAP yapılandırması yalnızca v4 API kimlik doğrulaması için kullanılır. SuiteCRM oturumunu LDAP kullanacak şekilde yapılandırmak için gerekli ayarları .env.local dosyasına ekleyin. Ayrıntılı bilgi almak için LDAP yapılandırma belgelerine bakabilirsiniz.',
    ...
    'LBL_LDAP_GROUP_DN_DESC' => 'Örnek: <em>ou=groups, dc=sitem, dc=com</em>',
    ...
    'LBL_LDAP_GROUP_USER_ATTR_DESC' => 'Bir kişinin tekil kimliği, o kişinin grup üyesi olup olmadığını denetlemek için kullanılır. Örneğin: <em>uid</em>',
    ...
    'LBL_LDAP_SERVER_HOSTNAME_DESC' => 'Örnek: ldap.sitem.com ya da SSL kullanımı için ldaps://ldap.sitem.com',
    ...
    'LBL_LIST_ENTRIES_PER_MODAL' => 'Açılan pencere kayıt listesi',
    ...
    'SHOW_DOWNLOADS_TAB_HELP' => 'Bu seçenek seçildiğinde, kullanıcı ayarları bölümünde kullanıcıların SuiteCRM uygulama ekleri ve kullanılabilecek diğer dosyalara erişebileceği indirmeler sekmesi görüntülenir',
    ...
    'LBL_YOUR_PROCESS_ID' => 'İşlem kimliğiniz',
    ...
    'LBL_CONFIG_AJAX_DESC' => 'Belirli modüller için AJAX kullanıcı arayüzü kullanımını açın ya da kapatın.',
...
// Wizard
    ...
    'LBL_WIZARD_SYSTEM_TITLE' => 'Markalaşma',
    'LBL_WIZARD_SYSTEM_DESC' => 'SuiteCRM uygulamasının marka ayarlarını yapmak için kuruluşunuzun adını ve logosunu belirtin.',
    'LBL_WIZARD_LOCALE_DESC' => 'Verilerin coğrafi konumunuza göre SuiteCRM üzerinde nasıl görünmesini istediğinizi belirleyin. Burada yapacağınız ayarlar varsayılan ayarlar olur. Kullanıcılar kendi ayarlarını yapabilir.',
    ...
    'LBL_ENABLE_HISTORY_CONTACTS_EMAILS' => 'Modüllerin geçmiş alt panosunda ilgililerin e-postaları görüntülensin',
    'LBL_HISTORY_SUBPANEL' => 'Geçmiş alt panosu',
);
