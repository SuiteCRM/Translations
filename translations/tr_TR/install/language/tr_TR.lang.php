...
$mod_strings = array(
    ...
    'LBL_SYSOPTS_2' => 'Kurmak üzere olduğunuz SuiteCRM için hangi veri tabanı türünü kullanmak istiyorsunuz?',
    'LBL_SYSOPTS_DB' => 'Veri tabanı türünü belirtin',
    'LBL_SYSOPTS_DB_TITLE' => 'Veri tabanı türü',
    'LBL_SYSOPTS_ERRS_TITLE' => 'Lütfen ilerlemeden önce aşağıdaki sorunları giderin:',
    'ERR_DB_VERSION_FAILURE' => 'Veri tabanı sürümü belirlenemedi.',
    'DEFAULT_CHARSET' => 'UTF-8',
    'ERR_ADMIN_USER_NAME_BLANK' => 'SuiteCRM yöneticisi için kullanıcı adını yazın. ',
    ...
    'ERR_CHECKSYS_FASTCGI' => 'PHP için bir FastCGI işleyici eşlemesi kullanılmadığı algılandı. SuiteCRM uygulaması ile uyumlu bir sürümü kurmanız/yapılandırmanız gereklidir. Lütfen yayın notlarındaki uyumluluk matrisinden desteklenen sürümlere bakın. Ayrıntılı bilgi almak için <a href="https://php.iis.net/" target="_blank">https://php.iis.net</a> adresine bakabilirsiniz ',
    'ERR_CHECKSYS_FASTCGI_LOGGING' => 'IIS/FastCGI sapi kullanırken en iyi deneyim için php.ini dosyasında fastcgi.logging değerini 0 olarak ayarlayın.',
    'LBL_DB_UNAVAILABLE' => 'Veri tabanı kullanılamıyor',
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Veri tabanı desteği bulunamadı. Desteklenen veri tabanı türleri için gerekli sürücülerden en azından birine sahip olup olmadığınızı denetleyin: MySQL ya da MS SQLServer. php.ini dosyasından eklenti satırının başındaki yorum karakterlerini kaldırarak satırı etkinleştirmeniz ya da PHP sürümünümüze bağlı olarak PHP kopyasını doğru binary dosyasını yeniden derlemeniz gerekebilir. Veri tabanı desteğinin etkinleştirilmesi ile ilgili ayrıntılı bilgi almak için PHP belgelerine bakabilirsiniz.',
    'LBL_CHECKSYS_XML_NOT_AVAILABLE' => 'SuiteCRM uygulaması tarafından gerek duyulan XML işleme kitaplıkları bulunamadı. PHP sürümünüze bağlı olarak, php.ini dosyasında eklentileri satırlarının başındaki yorum karakterlerini kaldırarak satırları etkinleştirmeniz ya da PHP sürümünüze bağlı olarak PHP kopyasını doğru binary dosyası ile yeniden derlemeniz gerekebilir. Ayrıntılı bilgi almak için kullandığınız PHP sürümünün belgelerine bakabilirsiniz.',
    'ERR_CHECKSYS_MBSTRING' => 'SuiteCRM uygulaması tarafından gerek duyulan Multibyte Strings PHP eklentisi (mbstring) ile ilgili işlevler bulunamadı. mbstring modülü genellikle PHP üzerinde varsayılan olarak etkin değildir ve PHP programı derlenirken --enable-mbstring seçeneği kullanılarak etkinleştirilmelidir. Mbstring desteğinin etkinleştirilmesi ile ilgili ayrıntılı bilgi almak için kullandığınız PHP sürümünün belgelerine bakabilirsiniz.',
    'ERR_CHECKSYS_CONFIG_NOT_WRITABLE' => 'Yapılandırma dosyası var ancak yazılabilir değil. Lütfen dosyayı yazılabilir kılmak için gerekli işlemleri yapın.',
    'ERR_CHECKSYS_CONFIG_NOT_FOUND' => 'Bir config.php dosyası bulunamadı. Kurulum sırasında oluşturulacak.',
    'ERR_CHECKSYS_CONFIG_OVERRIDE_NOT_WRITABLE' => 'Yapılandırma değişikliği dosyası var ancak yazılabilir değil. Lütfen dosyayı yazılabilir kılmak için gerekli işlemleri yapın. ',
    'ERR_CHECKSYS_CUSTOM_NOT_WRITABLE' => 'Custom klasörü var ancak yazılabilir değil. Lütfen klasörü yazılabilir kılmak için gerekli işlemleri yapın.',
    'ERR_CHECKSYS_FILES_NOT_WRITABLE' => "Yukarıda listelenen dosyalar veya klasörler yazılabilir değil veya eksik ve oluşturulamadı. Lütfen klasörleri yazılabilir kılmak için gerekli işlemleri yapın.",
    'ERR_CHECKSYS_LOGS_NOT_WRITABLE' => 'Logs klasörü yazılabilir değil',
    'ERR_CHECKSYS_CACHE_NOT_WRITABLE' => 'Cache klasörü yazılabilir değil',
    'ERR_CHECKSYS_EXTENSIONS_NOT_WRITABLE' => 'Extensions klasörü yazılabilir değil',
    'ERR_CHECKSYS_ROOT_NOT_WRITABLE' => 'Kök klasör yazılabilir değil. Kurulumu sürdüremezsiniz.',
    'ERR_CHECKSYS_SECRETS_NOT_WRITABLE' => 'config/secrets klasörü yazılabilir değil',
    ...
    'ERR_DB_INVALID' => 'Seçilmiş veri tabanı türü geçersiz.',
    'ERR_DB_LOGIN_FAILURE_SHORT' => 'Veri tabanı bağlantı sorunu: Belirtilen veri tabanı sunucu adı, kullanıcı veya parolası geçersiz.',
    'ERR_DB_LOGIN_FAILURE' => 'Belirtilen veri tabanı sunucusu, kullanıcı adı ya da parola geçersiz olduğundan veri tabanı ile bağlantı kurulamadı. Lütfen geçerli bir veri tabanı sunucusu, kullanıcı adı ve parola yazın',
    'ERR_DB_LOGIN_FAILURE_MYSQL' => 'Belirtilen veri tabanı sunucusu, kullanıcı adı ya da parola geçersiz olduğundan veri tabanı ile bağlantı kurulamadı. Lütfen geçerli bir veri tabanı sunucusu, kullanıcı adı ve parola yazın',
    'ERR_DB_LOGIN_FAILURE_MSSQL' => 'Belirtilen veri tabanı sunucusu, kullanıcı adı ya da parola geçersiz olduğundan veri tabanı ile bağlantı kurulamadı. Lütfen geçerli bir veri tabanı sunucusu, kullanıcı adı ve parola yazın',
    ...
    'ERR_DB_NAME' => 'Veri tabanı adı boş olamaz.',
    'ERR_DB_MYSQL_DB_NAME_INVALID' => "Veri tabanı adında '', '\\', '/' ya da '.' karakterleri bulunamaz",
    'ERR_DB_MSSQL_DB_NAME_INVALID' => "Veri tabanı adı rakam, '#' ya da '@' karakterleriyle başlayamaz ve boşluk, '\"', \"'\", '*', '/', '\\', '?', ':', '<', '>', '&', '!' ya da '-' karakterlerini içeremez",
    'ERR_DB_OCI8_DB_NAME_INVALID' => "Veri tabanı adında yalnızca alfa-sayısal karakterler ve '#', '_' ya da '$' karakterleri kullanılabilir",
    'ERR_DB_PASSWORD' => 'SuiteCRM veri tabanı yöneticisi için yazılan parola ile onayı aynı değil. Lütfen parola ve onayı alanlarına aynı parolayı yeniden yazın.',
    'ERR_DB_PRIV_USER' => 'Veri tabanı yöneticisinin kullanıcı adını yazın. Bu kullanıcı veri tabanı bağlantısını kurmak için gereklidir.',
    'ERR_DB_USER_EXISTS' => 'SuiteCRM veri tabanı kullanıcısı zaten var. Aynı adlı başka bir kullanıcı oluşturulamaz. Lütfen başka bir ad yazın.',
    'ERR_DB_USER' => 'SuiteCRM veri tabanı yöneticisi için bir kullanıcı adı yazın.',
    'ERR_DBCONF_VALIDATION' => 'Lütfen ilerlemeden önce aşağıdaki sorunları giderin:',
    'ERR_DBCONF_PASSWORD_MISMATCH' => 'SuiteCRM veri tabanı yöneticisi için yazılan parola ile onayı aynı değil. Lütfen parola ve onayı alanlarına aynı parolayı yeniden yazın.',
    ...
    'ERR_PERFORM_CONFIG_PHP_2' => 'Kurulumu sürdürmek için config.php dosyasını el ile oluşturup aşağıdaki yapılandırma bilgilerini içine kopyalayabilirsiniz. Sonraki adıma geçebilmek için <strong> kesinlikle</strong> config.php dosyasını oluşturmalısınız.',
    'ERR_PERFORM_CONFIG_PHP_3' => 'Config.php dosyasını oluşturmayı anımsadınız mı?',
    ...
    'ERR_PERFORM_HTACCESS_3' => 'Günlük dosyasına tarayıcı ile erişilmesini engellemek istiyorsanız, günlük klasörünüzde aşağıdaki satırı içeren bir .htaccess dosyası oluşturun:',
    'ERR_PERFORM_NO_TCPIP' => '<b>Bir internet bağlantısı bulunamadı.</b>Bağlantı kurulduğunda, Bir SuiteCRM hesabı açmak için <a href="https://www.suitecrm.com/">https://www.suitecrm.com/</a> adresine gidin. Kuruluşunuzun SuiteCRM uygulamasını nasıl kullandığı ile ilgili bilgi edinirsek, gereksinimlerinize uygun özellikler geliştirmeyi sürdürebiliriz.',
    'ERR_PERFORM_NO_TCPIP_SIMPLE' => 'İnternet bağlantısı bulunamadı.',
    ...
    'LBL_CHECKSYS_LEGACY_CACHE' => 'Yazılabilir eski Cache alt klasörleri',
    'LBL_CHECKSYS_CACHE' => 'Yazılabilir ön bellek alt klasörleri',
    'LBL_CHECKSYS_EXTENSIONS' => 'Yazılabilir Extensions klasörü',
    'LBL_CHECKSYS_SECRETS' => 'Yazılabilir Config/Secrets klasörü',
    'LBL_CHECKSYS_LOGS' => 'Yazılabilir Log klasörü',
    'LBL_CHECKSYS_ROOT' => 'Yazılabilir kök klasör',
    ...
    'LBL_CHECKSYS_ENV' => 'Yazılabilir .env dosyası',
    ...
    'LBL_CHECKSYS_INTL_EXTENSIONS' => 'Eklentilerde Intl bulundu',
    'LBL_CHECKSYS_JSON_EXTENSIONS' => 'Eklentilerde JSON bulundu',
    'LBL_CHECKSYS_GD_EXTENSIONS' => 'Eklentilerde GD bulundu',
    'LBL_CHECKSYS_OPENSSL_EXTENSIONS' => 'Eklentilerde OpenSSL bulundu',
    'LBL_CHECKSYS_ZIP_EXTENSIONS' => 'Eklentilerde Zip bulundu',
    'LBL_CHECKSYS_PDO_MYSQL_EXTENSIONS' => 'Eklentilerde PDO MySQL bulundu',
    'LBL_CHECKSYS_CURL_EXTENSIONS' => 'Eklentilerde cURL bulundu',
    'LBL_CHECKSYS_MBSTRING_EXTENSIONS' => 'Eklentilerde MB Strings bulundu',
    'LBL_CHECKSYS_MYSQLI_EXTENSIONS' => 'Eklentilerde MySQLi bulundu',
    'LBL_CHECKSYS_SOAP_EXTENSIONS' => 'Eklentilerde Soap bulundu',
    'LBL_CHECKSYS_XML_EXTENSIONS' => 'Eklentilerde XML bulundu',
    'LBL_CHECKSYS_IMAP_EXTENSIONS' => 'Eklentilerde IMAP bulundu (isteğe bağlı)',
    'LBL_CHECKSYS_LDAP_EXTENSIONS' => 'Eklentilerde LDAP bulundu (isteğe bağlı)',
    'LBL_PHP_CHECKS' => 'PHP DENETİMLERİ',
    'LBL_SERVER_CHECKS' => 'SUNUCU DENETİMLERİ',
    'LBL_PERMISSION_CHECKS' => 'İZİN DENETİMLERİ',
    'LBL_CHECK_FAILED' => 'Denetim başarısız oldu: ',
    'ERR_CHECKSYS_INTL' => 'Intl eklentisi kurulmamış. Lütfen sistem yöneticiniz ile görüşün.',
    'ERR_CHECKSYS_JSON' => 'JSON eklentisi etkinleştirilmemiş. Lütfen sistem yöneticiniz ile görüşün.',
    'ERR_CHECKSYS_GD' => 'GD eklentisi etkinleştirilmemiş. Lütfen sistem yöneticiniz ile görüşün.',
    'ERR_CHECKSYS_OPENSSL' => 'OPENSSL eklentisi etkinleştirilmemiş. Lütfen sistem yöneticiniz ile görüşün.',
    'ERR_CHECKSYS_PDO_MYSQL' => 'PDO MySQL eklentisi etkinleştirilmemiş. Lütfen sistem yöneticiniz ile görüşün.',
    'ERR_CHECKSYS_MYSQLI' => 'MySQLi eklentisi etkinleştirilmemiş. Lütfen sistem yöneticiniz ile görüşün.',
    'ERR_CHECKSYS_SOAP' => 'Soap eklentisi etkinleştirilmemiş. Lütfen sistem yöneticiniz ile görüşün.',
    ...
    'LBL_UNWRITABLE_SUB_DIR' => 'Bazı alt klasörler yazılabilir değil. Lütfen bu klasörleri yazılabilir yapmak için gerekli işlemleri yapın ',
    'LBL_REFER_TO_LOGS' => 'Kurulum öncesi denetimlerin birinde bir sorun çıktı. Lütfen logs/install.log dosyasına bakın',
    'LBL_NOT_A_VALID_SUITECRM_PAGE' => 'SuiteCRM başlığı bulunamadı. Bu geçerli bir SuiteCRM sayfası değil.',
    'LBL_NOT_COOKIE_OR_TOKEN' => 'Tanımlama bilgileri bulunamadı. Geçerli bir kod bulunamadı. Ayrıntılı bilgi almak için lütfen logs/install.log dosyasına bakın.',
    'LBL_CURL_JSON_ERROR' => 'Graphql sayfasına curl çağrısının sonucu boştu.',
    'LBL_UNABLE_TO_FIND_SYSTEM_CONFIGS' => 'Graphql sayfasında sistem yapılandırmaları alınamadı. Ayrıntılı bilgi almak için lütfen logs/install.log dosyasına bakın.',
    'LBL_CURL_REQUEST_MAIN_PAGE' => 'Ana sayfada Curl isteği',
    'LBL_CURL_REQUEST_API_PAGE' => 'API Curl isteği',
    'LBL_ERROR_DETAILS' => 'Hata ayrıntıları',
    'LBL_ERROR' => 'Hata',
    'LBL_WARNING_DETAILS' => 'Uyarı ayrıntıları',
    'LBL_WARNING' => 'Uyarı',
    'LBL_SYSTEM_CHECKS' => 'SİSTEM DENETİMLERİ',
    'LBL_CRON_INSTRUCTIONS_1' => 'SuiteCRM zamanlayıcılarını yürütmek için, şu komutu kullanarak site sunucusu kullanıcınızın crontab dosyasını düzenlemek üzere açın:',
    'LBL_CRON_INSTRUCTIONS_2' => 've crontab dosyasına şu satırı ekleyin:',
    'LBL_CRON_INSTRUCTIONS_3' => 'Bu işlemi yalnızca kurulum tamamlandıktan sonra yapmalısınız.',
    'LBL_CRON_CONFIGURATION' => 'CRON YAPILANDIRMASI',
    'LBL_SETUP_CRONTAB' => 'Zamanlanmış görev kurulumu için',
    'LBL_ROUTE_ACCESS_CHECK' => 'YÖNLENDİRME ERİŞİMİ DENETİMİ',
    'LBL_PHP_MEM_1' => 'PHP bellek sınırınız ',
    'LBL_PHP_MEM_2' => '. İlerleyebilmek için bu değer en az  ',
    'LBL_PHP_MEM_3' => 'M olmalıdır.',
    'LBL_CLOSE' => 'Kapat',
    'LBL_THREE' => '3',
    'LBL_CONFIRM_BE_CREATED' => 'eklenecek',
    'LBL_CONFIRM_DB_TYPE' => 'Veri tabanı türü',
    'LBL_CONFIRM_NOT' => 'olmayacak',
    'LBL_CONFIRM_TITLE' => 'Ayarları onayla',
    'LBL_CONFIRM_WILL' => 'olacak',
    'LBL_DBCONF_DB_DROP' => 'Tablolar silinsin',
    'LBL_DBCONF_DB_NAME' => 'Veri tabanı adı',
    'LBL_DBCONF_DB_PORT' => 'Veri tabanı bağlantı noktası',
    'LBL_DBCONF_DB_PASSWORD' => 'SuiteCRM veri tabanı kullanıcı parolası',
    'LBL_DBCONF_DB_PASSWORD2' => 'SuiteCRM veri tabanı kullanıcı parolası onayı',
    'LBL_DBCONF_DB_USER' => 'SuiteCRM veri tabanı kullanıcı adı',
    'LBL_DBCONF_SUITE_DB_USER' => 'SuiteCRM veri tabanı kullanıcı adı',
    'LBL_DBCONF_DB_ADMIN_USER' => 'Veri tabanı yöneticisinin kullanıcı adı',
    'LBL_DBCONF_DB_ADMIN_PASSWORD' => 'Veri tabanı yöneticisinin parolası',
    'LBL_DBCONF_COLLATION' => 'Karşılaştırma',
    'LBL_DBCONF_CHARSET' => 'Karakter kümesi',
    'LBL_DBCONF_ADV_DB_CFG_TITLE' => 'Gelişmiş veri tabanı yapılandırması',
    'LBL_DBCONF_DEMO_DATA' => 'Veri tabanına örnek veriler yüklensin mi?',
    'LBL_DBCONF_DEMO_DATA_TITLE' => 'Örnek verileri seçin',
    'LBL_DBCONF_HOST_NAME' => 'Sunucu adı',
    'LBL_DBCONF_HOST_INSTANCE' => 'Sunucu kopyası',
    'LBL_DBCONFIG_SECURITY' => 'Güvenlik amacıyla, SuiteCRM veri tabanına bağlanma yetkisi olan bir veri tabanı kullanıcısı belirtebilirsiniz. Bu kullanıcı, bu kurulum için belirlenen veri tabanı üzerinde veri yazma, güncelleme ve okuma işlemleri yapabilmelidir. Bu kullanıcı yukarıda belirtilen veri tabanı yöneticisi olabileceği gibi yeni ya da var olan başka bir kullanıcı da olabilir.',
    ...
    'LBL_DBCONF_TITLE' => 'Veri tabanı yapılandırması',
    'LBL_DBCONF_TITLE_NAME' => 'Veri tabanı adını yazın',
    'LBL_DBCONF_TITLE_USER_INFO' => 'Veri tabanı kullanıcı bilgilerini yazın',
    ...
    'LBL_DISABLED_DESCRIPTION_3' => 'Bu değişiklik yapıldıktan sonra, ilerlemek için lütfen bu sayfayı yeniden ziyaret edin / yeniden yükleyin.',
    ...
    'LBL_INSTALL_TYPE_MSG2' => 'Kurulum sırasında en az bilgiyi gerektirir. Yeni kullanıcılar için önerilir.',
    ...
    'LBL_LAUNCHING_SILENT_INSTALL' => 'SuiteCRM kuruluyor. Bu işlem birkaç dakika sürebilir.',
    ...
    'LBL_PERFORM_CREATE_DB_1' => '<b>Veri tabanı oluşturuluyor</b> ',
    'LBL_PERFORM_CREATE_DB_2' => '<b>üzerinde</b>',
    'LBL_PERFORM_CREATE_DB_USER' => 'Veri tabanı kullanıcı adı ve parolası ekleniyor...',
    'LBL_PERFORM_CREATE_DEFAULT' => 'Varsayılan SuiteCRM verileri ekleniyor',
    'LBL_PERFORM_DEFAULT_SCHEDULER' => 'Varsayılan zamanlayıcılar oluşturuluyor',
    'LBL_PERFORM_DEFAULT_USERS' => 'Varsayılan kullanıcılar ekleniyor',
    'LBL_PERFORM_DEMO_DATA' => 'Veri tabanı tabloları örnek verilerle dolduruluyor (bu işlem biraz zaman alabilir)',
    'LBL_PERFORM_DONE' => 'tamamlandı<br>',
    'LBL_PERFORM_FINISH' => 'Bitti',
    'LBL_PERFORM_OUTRO_1' => 'SuiteCRM ',
    'LBL_PERFORM_OUTRO_2' => ' kurulumu tamamlandı!',
    ...
    'LBL_PERFORM_TITLE' => 'Kurulumu yap',
    'LBL_PRINT' => 'Yazdır',
    ...
    'LBL_REQUIRED' => '* Doldurulması zorunlu alan',
    ...
    'LBL_SITECFG_CUSTOM_ID_DIRECTIONS' => 'Açıldığında, otomatik olarak üretilen kimlik değerinin yerine yazdığınız uygulama kimliği kullanılır. Bu kimlik, açtığınız oturumların başka SuiteCRM kopyalarında kullanılamamasını sağlar. SuiteCRM kopyalarından oluşan bir kümeniz varsa, kümedeki tüm kopyaların aynı uygulama kimliğini kullanması gerekir.',
    'LBL_SITECFG_CUSTOM_ID' => 'Kendi uygulama kimliğinizi yazın',
    'LBL_SITECFG_CUSTOM_LOG_DIRECTIONS' => 'Açıldığında, SuiteCRM günlüklerinin kaydedileceği varsayılan klasör yerine kullanılacak bir klasör belirtmeniz gerekir. Günlük dosyası nerede olursa olsun, dosyaya bir tarayıcı üzerinden erişim .htaccess yönlendirme yöntemiyle engellenir.',
    'LBL_SITECFG_CUSTOM_LOG' => 'Özel günlük klasörü kullanılsın',
    'LBL_SITECFG_CUSTOM_SESSION_DIRECTIONS' => 'Açıldığında, SuiteCRM oturum bilgilerinin kaydedileceği güvenli bir klasör belirtmeniz gerekir. Böylece paylaşılan sunuculara saldırılarak oturum bilgilerinin ele geçirilmesi engellenir.',
    ...
    'LBL_SITECFG_SUITE_UP_DIRECTIONS' => 'Açıldığında, uygulamanın yeni sürümleri belirli aralıklarla denetlenir.',
    'LBL_SITECFG_SUITE_UP' => 'Güncellemeler otomatik olarak denetlensin',
    'LBL_SITECFG_TITLE' => 'Site yapılandırması',
    'LBL_SITECFG_TITLE2' => 'Yönetici kullanıcısını bBelirleme',
    'LBL_SITECFG_SECURITY_TITLE' => 'Site güvenliği',
    'LBL_SITECFG_URL' => 'SuiteCRM kopyasının adresi',
    'LBL_SITECFG_ANONSTATS' => 'Anonim kullanım istatistikleri gönderilsin',
    'LBL_SITECFG_ANONSTATS_DIRECTIONS' => 'Açıldığında, SuiteCRM uygulamasının kullanım bilgileri <b>anonim</b> olarak SuiteCRM kuruluşuna gönderilir. Bu bilgiler, uygulamanın nasıl kullanıldığının daha iyi anlaşılarak ürünün geliştirilmesini sağlar.',
    'LBL_SITECFG_URL_MSG' => 'Kurulumdan sonra SuiteCRM kopyasına erişmek için kullanılacak adresi yazın. Bu adres SuiteCRM uygulama sayfalarının için de temel adres olarak kullanılır. Adreste site sunucusunun adı, bilgisayar adı ya da IP adresi bulunmalıdır.',
    'LBL_SITECFG_SYS_NAME_MSG' => 'Sisteminizin adını yazın. Bu ad SuiteCRM sitesine gelen kullanıcılara tarayıcının başlık çubuğunda görüntülenir.',
    ...
    'LBL_SITECFG_COLLATION_MSG' => 'Sisteminizin karşılaştırma (sıralama) değerini seçin. Bu ayar veri tabanı tablolarını kullandığınız dile uygun olarak oluşturur. Dilinize özel bir ayar yapılmasının gerekmediği durumlarda varsayılan değeri kullanın.',
    ...
    'LBL_PRE_INSTALL_REQ' => 'Kurulum öncesi gereksinimleri',
    'LBL_HIDDEN' => '<i>(gizli)</i>',
    'LBL_STEP1' => 'Adım 1 / 2 - Kurulum öncesi gereksinimler',
    'LBL_STEP2' => 'Adım 2 / 2 - Yapılandırma',
    'LBL_STEP' => 'Adım',
    'LBL_CHECKS_PASSED' => 'Tüm denetimlerden geçti!',
    'LBL_WARNINGS_FOUND' => 'Uyarılar bulundu: İlerlemeden önce bunları kontrol edin.',
    'LBL_ERRORS_FOUND' => ' Hatalar bulundu: İlerlemeden önce bunları çözmeniz önerilir.',
    'LBL_ERRORS_AND_WARNINGS_FOUND' => 'Hatalar ve Uyarılar bulundu: İlerlemeden önce bunları kontrol etmeniz ve çözmeniz önerilir.',
    'LBL_TITLE_WELCOME' => 'SuiteCRM uygulamasına hoş geldiniz ',
    'LBL_WELCOME' => 'SuiteCRM uygulamasına hoş geldiniz',
...
<ul>
<li> Veri tabanı/Veri tabanı yönetim sistemi (Örnekler: MariaDB, MySQL ya da SQL Server)</li>
<li> Site sunucusu (Apache, IIS)</li>
</ul>
Kurulumunu gerçekleştirdiğiniz SuiteCRM sürümü ile uyumlu bileşenleri yayın notları içindeki uyumluluk matrisinde bulabilirsiniz.<br>',
    ...
    'REQUIRED_SYS_CHK_MSG' =>
        'Kurulum işlemi başlatıldığında, kurulumun sorunsuz yapılabilmesi için SuiteCRM dosyalarının bulunduğu site sunucusunda bir sistem denetimi yapılarak
...
<li><b>Veri tabanı desteği</b> &#8211; MariaDB, MySQL ya da SQL Server desteği var olmalıdır</li>
...
Denetim sırasında bir sorun çıkarsa kurulumu sürdüremezsiniz.
Sorunun ne olduğunu açıklayan bir hata iletisi görüntülenir.
Sorunu giderdikten sonra, sistem denetimini yeniden yaparak kurulumu sürdürebilirsiniz.<br>',


    'REQUIRED_INSTALLTYPE' => 'Normal ya da özel kurulum',
...
<ul>
<li>SuiteCRM verisini tutacak <b>Veri tabanı türü</b> <ul><li>Uyumlu veri tabanı
türleri: MariaDB, MySQL ya da SQL Server.<br><br></li></ul></li>
<li> Veri tabanının bulunduğu <b>Site sunucusunun</b> ya da bilgisayarın (sunucu) adı
<ul><li>Veri tabanı, SuiteCRM dosyalarının bulunduğu site sunucusu ile aynı sunucu üzerinde bulunuyorsa <i>localhost</i> olabilir.<br><br></li></ul></li>
<li>SuiteCRM verilerinin kaydedileceği <b>veri tabanının adı</b></li>
<ul>
<li> Var olan bir veri tabanını kullanmak isteyebilirsiniz.
Var olan bir veri tabanının adını yazarsanız var olan veri tabanındaki tablolar 
kurulum sırasında SuiteCRM veri tabanının şeması belirtildiğinde silinir.</li>
<li> Veri tabanı yoksa belirttiğiniz yeni veri tabanı adı kurulum sırasında
oluşturulan kopya için kullanılır.<br><br></li>
</ul>
<li><b>Veri tabanı yöneticisi kullanıcı adı ve parolası</b> <ul><li>Veri tabanı yönetici kullanıcısı tablo ve kullanıcılar ekleyebilmeli ve veri tabanına yazabilmelidir.</li><li>Veri tabanınız 
yerel bilgisayarınızda kurulu değil ise ve veri tabanı yöneticisi değilseniz
buraya yazılacak bilgileri öğrenmek için sistem yöneticiniz ile görüşebilirsiniz.<br><br></ul></li></li>
<li> <b>SuiteCRM veri tabanı kullanıcı adı ve parolası</b>
</li>
<ul>
<li> Kullanıcı veri tabanı yöneticisi ya da var olan başka bir veri tabanı 
kullanıcısı olabilir.</li>
<li> Bu amaçla yeni bir veri tabanı kullanıcısı oluşturmak isterseniz, 
...
Bu adres site sunucusunun adı, bilgisayar adı ya da IP adresini içermelidir.<br><br></li>
...
Ayrıntılı bilgi almak için kurulum rehberine bakabilirsiniz.                                ',
    ...
    'LBL_PATCH_READY' => 'Şu yama(lar) kurulmaya hazır:',
    'LBL_SESSION_ERR_DESCRIPTION' => "SuiteCRM, bu site sunucusuna bağlandığında önemli bilgileri depolamak için PHP oturum mekanizmasını kullanır. PHP kurulumunuz için oturum bilgileri doğru şekilde yapılandırılmamış.
											<br><br>Sık karşılaşılan bir yanlış yapılandırma, <b>'session.save_path'</b> ayarının geçersiz bir klasörü göstermesidir.<br>
											<br>Lütfen aşağıda görüntülenen php.ini dosyasında <a target=_new href=\"http://us2.php.net/manual/en/ref.session.php\">PHP yapılandırmasını</a> düzeltin.",
    'LBL_SESSION_ERR_TITLE' => 'PHP oturum yapılandırması hatalı',
    'LBL_SYSTEM_NAME' => 'Sistem adı',
    'LBL_COLLATION' => 'Karşılaştırma ayarları',
    'LBL_REQUIRED_SYSTEM_NAME' => 'Bu SuiteCRM kopyasının sistem adını yazın.',
...
$contact_user_link_guid',
    ...
    'LBL_ALLOW_DEFAULT_SELECTION_HELP' => 'Bu seçenek seçildiğinde, tüm kullanıcılar sistem bildirim ve uyarılarını göndermek için kullanılan giden e-posta hesabını kullanarak e-posta gönderebilir. Seçilmediğinde, kullanıcıların giden e-posta sunucusunu kullanabilmesi için kendi hesap bilgilerini yazması gerekir.',
    ...
    'NEW_LOGO_HELP' => 'Görsel dosyası .png ya da .jpg biçiminde olabilir. Yüksekliği en fazla 170 piksel, genişliği en fazla 450 piksel olmalıdır. Herhangi bir boyutu daha büyük olan görseller bu ölçülere göre yeniden boyutlandırılır. Görsel dosyasının adında boşluk karakteri bulunmamalıdır.',
    ...
    'UPLOAD_LOGO' => 'Lütfen logo yüklenirken bekleyin...',
    ...
    'ERR_UPLOAD_FILE_UPLOAD_ERR_PARTIAL' => 'Dosyanın yalnızca bir bölümü yüklenebildi.',
    ...
    'ERR_SITE_URL' => 'Site adresinin doldurulması zorunludur.',

    'STAT_CONFIGURATION' => 'İlişkiler ayarlanıyor...',
    'STAT_CREATE_DB' => 'Veri tabanı ekleniyor...',
    ...
    'LBL_START' => '',
    'LBL_DB_CONN_ERR' => 'Veri tabanı sorunu',
    'LBL_OLD_PHP' => 'Eski PHP sürümü algılandı!',
    'LBL_OLD_PHP_MSG' => 'SuiteCRM için önerilen PHP sürümü %s.<br />Kullanılabilecek en düşük PHP sürümü %s<br />Kullandığınız PHP sürümü %s ve kullanım süresi bitmiş:<a href="https://www.php.net/eol.php">http://php.net/eol.php</a>.<br />Lütfen PHP sürümünüzü yükseltmeyi değerlendirin. ',
    'LBL_OLD_PHP_OK' => 'Risklerin farkındayım ve kuruluma başlamak istiyorum.',

    'LBL_DBCONF_TITLE_USER_INFO_LABEL' => 'Kullanıcı',
    'LBL_DBCONFIG_MSG3_LABEL' => 'Veri tabanı adı',
    'LBL_DBCONFIG_MSG3' => 'Kurmak üzere olduğunuz SuiteCRM kopyasının verilerinin kaydedileceği veri tabanının adı.',
    'LBL_DBCONFIG_MSG2_LABEL' => 'Sunucu adı',
    'LBL_DBCONFIG_MSG2' => 'Veri tabanının bulunduğu site sunucusunun adı ya da bilgisayarın (sunucu) adı (www.sitem.com gibi). Yerel bir kurulum yapıyorsanız, başarım açısından \'127.0.0.1\' yerine \'localhost\' kullanmanız daha iyi olur.',
    'LBL_DBCONFIG_B_MSG1_LABEL' => '', // this label dynamically needed in install/installConfig.php:293
    'LBL_DBCONFIG_B_MSG1' => 'SuiteCRM veri tabanını kurmak için, veri tabanına tablo ve kullanıcı ekleyebilecek ve veri yazabilecek bir yönetici kullanıcı adı ve parolası gereklidir.',
    'LBL_SYS_CHECK_WARNING' => 'Sistem denetimi uyarıları yok sayılsın',
    'LBL_PROCEED' => 'İLERLE',
    'LBL_PROCEED_WITH_WARNINGS' => 'UYARILARI YOK SAY VE İLERLE',
    'LBL_PROCEED_WITH_ERRORS' => 'HATALARI YOK SAY VE İLERLE',
    'LBL_PROCEED_WITH_ERRORS_AND_WARNINGS' => 'İLERLEMEK İÇİN HATALARI VE UYARILARI YOK SAY',
    'LBL_RECHECK' => 'YENİDEN DENETLE',
    'LBL_VIEW_FULL_ERROR' => 'Tam hatayı görüntüle',
    'LBL_CLOSE_DESCRIPTION' => 'Açıklamayı kapat',
    'LBL_CONFIG' => 'YAPILANDIRMA',
    'LBL_VALIDATION_ERRORS' => 'Doğrulama sorunları olduğundan işlem yapılamaz.',
    'LBL_CRON_UNRECOMMENDED_USER' => 'Şu anda root olarak çalışıyorsunuz. Bunu yapmanız önerilmez, ilerlemek istiyor musunuz (y,n)? '
);
