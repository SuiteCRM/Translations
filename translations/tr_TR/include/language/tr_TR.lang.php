...
//e.g. auf Deutsch 'Contacts'=>'Contakten',
    ...
    'moduleList' => array(
        ...
        'Sync' => 'Eşitle',
        'CalendarAccount' => 'Takvim hesapları',
        'Users' => 'Kullanıcılar',
        'Employees' => 'Çalışanlar',
        'Administration' => 'Yönetim',
        'ACLRoles' => 'Roller',
        'InboundEmail' => 'Gelen e-posta hesapları',
        'Releases' => 'Yayınlar',
        'Prospects' => 'Hedefler',
        'Queues' => 'Kuyruklar',
        ...
        'OAuth2AuthCodes' => 'OAuth kimlik doğrulama kodları',
    ),
...
//       it is the key for the default case_relationship_type_dom value
    'case_relationship_type_default_key' => 'Birincil ilgili',
    'case_relationship_type_dom' => array(
        '' => '',
        'Primary Contact' => 'Birincil ilgili',
    ...
    'snooze_alert_timer' => array(
        60 => '1 dakika ertele',
        300 => '5 dakika ertele',
        600 => '10 dakika ertele',
        900 => '15 dakika ertele',
        1800 => '30 dakika ertele',
        3600 => '1 saat ertele',
        7200 => '2 saat ertele',
        10800 => '3 saat ertele',
        18000 => '5 saat ertele',
    ...
    'file_field_storage_type_dom' => [
        'private-documents' => 'Kişisel belgeler',
        'public-documents' => 'Herkese açık belgeler',
        'archived-documents' => 'Arşivlenmiş belgeler',
    ],


    'image_field_storage_type_dom' => [
        'private-images' => 'Kişisel görseller',
        'public-images' => 'Herkese açık görseller',
    ],
    ...
    'dom_email_body_filtering_option' => [
      'multi' => 'Birkaç sözcük ara',
      'single' => 'Tek sözcük ara',
    ],
...
//prospect list type dom
    ...
    'email_marketing_status_dom' => array(
        ...
        'pending_send' => 'Gönderim bekletiliyor',
    ...
    'email_marketing_duplicate_dom' => [
        'email' => 'Çift kayıtlara ve e-posta adreslerine gönderim engellensin',
        'record' => 'Çift kayıtlara gönderim engellensin',
    ],
...
$app_strings = array(
    'LBL_SEARCH_RESULTS_TITLE' => 'Sonuçlar',
    'ERR_SEARCH_INVALID_QUERY' => 'Arama sırasında bir sorun çıktı. Sorgu söz dizimi geçersiz olabilir.',
    ...
    'LBL_LOGOUT_SUCCESS' => 'Oturum kapatıldı',
    'LBL_LOGGED_OUT_MESSAGE' => 'Oturumunuz kapatıldı',
    'LBL_LOGIN_AGAIN' => 'Yeniden oturum açmak için ',
    ...
    'LBL_ID_FF_REMOVE' => 'Kaldır', /*for 508 compliance fix*/
    ...
    'ERR_TIMEOUT' => "Zaman aşımı nedeniyle yapılamadı",
    ...
    'LBL_EMAIL_COMPOSE_NO_BODY' => 'Bu e-postanın içerik yazısı yok. Yine de gönderilsin mi?',
    ...
    'LBL_EMAIL_EDIT_CONTACT_WARN' => 'İlgililer ile çalışılırken yalnızca birincil adres kullanılır.',
    ...
    'LBL_EMAIL_ERROR_MESSAGE_DELETED' => 'İleti sunucudan kaldırıldı',
    'LBL_EMAIL_ERROR_IMAP_MESSAGE_DELETED' => 'İleti sunucudan kaldırılmış ya da başka bir klasöre taşınmış',
    ...
    'LBL_EMAIL_MENU_COMPOSE' => 'Şu alıcıya gönder',
    ...
    'LBL_EMAIL_OPTIONS' => 'Ayarlar',
    'LBL_EMAIL_QUICK_COMPOSE' => 'Hızlı e-posta',
    'LBL_EMAIL_OPT_OUT' => 'Abonelikten ayrılan',
    ...
    'LBL_EMAIL_SETTINGS_TITLE' => 'E-posta ayarları',
    ...
    'LBL_EMAIL_TEMPLATE_EDIT_PLAIN_TEXT' => 'E-posta kalıbının içerik yazısı boş',
    ...
    'LBL_DEFAULT_LINK_TEXT' => 'Varsayılan bağlantı yazısı.',
    'LBL_EMAIL_YES' => 'Evet',
    ...
    'ERR_AJAX_LOAD_FOOTER' => 'Bu sorun sürerse, yöneticinizden bu modülde AJAX özelliğini kapatmasını isteyin',
    ...
    'ERR_DELETE_RECORD' => 'Bir ilgiliyi silmek için bir kayıt numarası belirtilmelidir.',
    'ERR_EXPORT_DISABLED' => 'Dışa aktarmalar kapatılmış.',
    ...
    'ERR_UNAUTHORIZED_PAGE_ACCESS' => 'Bu sayfayı görüntüleme izniniz yok. Lütfen sistem yöneticiniz ile görüşün.',
    'ERR_UNAUTHORIZED_PAGE_ACCESS_TO_HOME_PAGE' => 'Bu sayfayı görüntüleme izniniz yok. Giriş sayfasına yönlendiriliyorsunuz...',
    ...
    'ERR_EXISTING_PORTAL_USERNAME' => 'Hata: Portal adı zaten başka bir ilgiliye atanmış.',
    ...
    'LBL_ADD_TO_PROSPECT_LIST_BUTTON_LABEL_ACCOUNTS_CONTACTS' => 'İlgilileri hedef listesine ekle',
    ...
    'LBL_CAMPAIGNS_SEND_NEXT_BATCH' => 'Kuyrukta sonraki toplu e-postaları gönder',
    'LBL_SENT_NEXT_BATCH' => 'Toplu e-postalar gönderildi',
    ...
    'LBL_QUICK_CHARTS' => 'Hızlı çizelgeler',
    'LBL_QUICK_HISTORY' => 'Zaman tüneli',
    ...
    'LBL_CONTACT_LIST' => 'İlgili listesi',
    'LBL_CONTACT' => 'İlgili',
    ...
    'LBL_LAST_VIEWED_NO_RESULT' => 'Son görüntülenen bir öge yok',
    ...
    'LBL_CAMPAIGN_CHARTS' => 'Kampanya çizelgeleri',
    'LBL_EMAIL_MARKETING_CHARTS' => 'E-posta ile pazarlama çizelgeleri',
    'LBL_MESSAGE_QUEUE_TITLE' => 'İleti kuyruğu',
    'LBL_CAMPAIGN_SEND_STATUS' => 'Kampanya gönderim durumu',
    'LBL_CAMPAIGN_SEND_ERROR_THRESHOLD_EXCEEDED' => 'Bir toplu işlemin hata eşiğine (%d) ulaşıldı: %s',
    'LBL_CAMPAIGN_SEND_FAILURE_THRESHOLD_EXCEEDED' => 'Bir toplu işlem için %d sorun eşiği aşıldı',
    'LBL_EMAIL_MARKETING_SEND_STATUS' => 'E-posta pazarlama gönderim durumu',
    'LBL_CAMPAIGN_RESPONSE_BY_RECIPIENT_ACTIVITY' => 'Alıcı işlemlerine göre kampanya yanıtı',
    'LBL_EMAIL_MARKETING_RESPONSE_BY_RECIPIENT_ACTIVITY' => 'Alıcı işlemlerine göre e-posta ile pazarlama yanıtı',
    'LBL_LOG_ENTRIES_TARGETED_TITLE' => 'Gönderilen/Denenen',
    'LBL_LOG_ENTRIES_SEND_ERROR_TITLE' => 'Geri dönen iletiler, diğer',
    'LBL_LOG_ENTRIES_BOUNCED_TITLE' => 'Geri dönen iletiler',
    'LBL_LOG_ENTRIES_INVALID_EMAIL_TITLE' => 'Geri dönen iletiler, geçersiz e-posta',
    'LBL_LOG_ENTRIES_LINK_TITLE' => 'Bağlantıya tıklanan',
    'LBL_LOG_ENTRIES_VIEWED_TITLE' => 'Açılan ileti',
    ...
    'LBL_LOG_ENTRIES_CONTACT_TITLE' => 'İlgili kişiler eklendi',
    'LBL_LOG_ENTRIES_BLOCKED_TITLE' => 'Bastırılan/Engellenen',
    'LBL_THEME' => 'Tema:',
    'LBL_FOUND_IN_RELEASE' => 'Bulunduğu sürüm',
    'LBL_FIXED_IN_RELEASE' => 'Düzeltildiği sürüm',
    'LBL_IN_EVERYWHERE' => 'Her yerde',
    ...
    'LBL_CONFIRM' => 'Onayla',
    'LBL_SNOOZE' => 'Ertele',
    'LBL_SNOOZE_INLINE_CONFIRM' => 'Ertelensin mi? ({{preferences.snooze_alert_timer|enum:snooze_alert_timer_simple}})',
    'LBL_DISMISS' => 'Yok say',
    ...
    'LBL_ALERT_DISMISS_ERROR' => 'Uyarı yok sayılırken sorun çıktı',
    'LBL_ALERT_DISMISS_ALL_SUCCESS' => 'Uyarılar yok sayıldı',
    'LBL_DISMISS_ALL' => 'Tümünü yok say',
    'LBL_DISMISS_SUCCESS' => 'Yok sayıldı',
    'LBL_VERIFY' => 'Doğrula',
    'LBL_RESEND' => 'Yeniden gönder',
    'LBL_RECORD_DOES_NOT_EXIST' => 'Kayıt alınırken sorun çıktı. Bu kayıt silinmiş olabilir ya da görüntüleme izniniz yok.',
    'LBL_PROFILE' => 'Profil',
    'LBL_PROFILE_EDIT' => 'Profil düzenle',
    ...
    'LBL_REMOVE' => 'Kaldır',
    'LBL_REPORTS_TO' => 'Rapor verilecek ilgili',
    'LBL_REQUIRED_SYMBOL' => '*',
    ...
    'LBL_FILTER' => 'Süzgeç',
    'LBL_CLEAR_FILTER' => 'Süzgeci temizle',
    'LBL_FILTER_MODULES' => 'Modülleri süz',
    'LBL_SEARCH' => 'Ara',
    'LBL_SEARCH_ALT' => '',
    ...
    'LBL_SELECT_CONTACT_BUTTON_KEY' => 'D',
    'LBL_SELECT_CONTACT_BUTTON_LABEL' => 'İlgili seçin',
    'LBL_SELECT_CONTACT_BUTTON_TITLE' => 'İlgili seçin',
    ...
    'LBL_ACCESSKEY_SELECT_CONTACTS_KEY' => 'K',
    'LBL_ACCESSKEY_SELECT_CONTACTS_TITLE' => 'İlgili seçin',
    'LBL_ACCESSKEY_SELECT_CONTACTS_LABEL' => 'İlgili seçin',
    'LBL_ACCESSKEY_CLEAR_CONTACTS_KEY' => ' ',
    'LBL_ACCESSKEY_CLEAR_CONTACTS_TITLE' => 'İlgiliyi bırak',
    'LBL_ACCESSKEY_CLEAR_CONTACTS_LABEL' => 'İlgiliyi bırak',
    'LBL_ACCESSKEY_SELECT_TEAMSET_KEY' => 'T',
    'LBL_ACCESSKEY_SELECT_TEAMSET_TITLE' => 'Takımı seç',
    'LBL_ACCESSKEY_SELECT_TEAMSET_LABEL' => 'Takım seçin',
    ...
    'LBL_TOO_MANY_ADDRESSES' => 'Çok fazla sayıda e-posta adresi seçtiniz.',
    'LBL_NO_ADDRESSES_SELECTED' => 'Lütfen gönderilecek bir e-posta adresi seçin.',
    'LBL_NOT_ALL_SENT' => 'Tüm e-postalar gönderilmedi. Ayrıntılı bilgi almak için günlük kayıtlarına bakın.',
    'LBL_NOT_VALID_TARGETS' => 'Gönderilecek bir doğrulanmış hedef yok.',
    'LBL_ALL_EMAILS_SENT' => 'Tüm deneme e-postaları gönderildi',
    ...
    'NTC_SEND_QUEUED_CAMPAIGN_EMAILS' => 'Sıradaki kampanya e-postaları grubu gönderilsin mi?',
    ...
    'NTC_ABORT_CONFIRMATION' => 'İptal etmek istediğinize emin misiniz?',
    'LBL_EMAIL_MARKETING_NOT_SENT' => 'E-posta pazarlama durumu Gönderilmemiş. Yeniden zamanlanamıyor',
    'NTC_RESUME_CONFIRMATION' => 'İlerlediğinizde, gönderilemeyen alıcıları yeniden sıraya alınacak ve gönderim sürdürülecek.',
    'LBL_EMAIL_MARKETING_NOT_PAUSED' => 'E-posta pazarlama durumu Duraklatılmış değil. Sürdürülemiyor',
    'LBL_CAMPAIGN_PAUSED_THRESHOLD' => 'Bu kampanya duraklatılmış -',
    'LBL_CAMPAIGN_PAUSED_DYNAMIC_LABEL' => '{{ fields.email-marketing-pause-reason.value }}',
    'NTC_SCHEDULE_CONFIRMATION' => "Zamanlandığında, Gönderme süreci zamanlanmış yürütülme zamanında başlar.",
    'NTC_DELETE_TEST_ENTRIES' => 'Zamanlama, deneme kayıtlarını siler.',
    'NTC_DELETE_TEST_ENTRIES_CONFIRMATION' => 'Deneme kayıtlarını silmek istediğinize emin misiniz?',
    'NTC_PROCEED' => 'İlerlemek istiyor musunuz?',
    'NTC_UNSCHEDULE_CONFIRMATION' => 'Zamanlama kaldırıldığında durum "Taslak" olarak ayarlanır.',
    'NTC_UNSCHEDULE_CONFIRMATION_OTHER' => 'Yeniden zamanlanmadıkça gönderim süreci başlamaz.',
    ...
    'NTC_DELETE_SELECTED_RECORDS' => ' seçilmiş kayıt(lar)?',
    ...
    'LBL_TEMPLATE_CONFIRMATION' => 'Yeni e-posta kalıbı uygulansın mı? (Bu işlem, var olan e-posta içeriğinizi ve konu alanınızı değiştirir)',
    ...
    'LBL_CREATE_CONTACT' => 'İlgili ekle',
    ...
    'LBL_ASSIGNED_TO_REQUIRED' => 'Zorunlu alan eksik: Atanmış ilgili',
    ...
    'LBL_SEARCH_HELP_TEXT' => '<p><br /><strong>Birden çok seçim denetimleri</strong></p><ul><li>Bir özniteliği seçmek için değerlerin üzerine tıklayın.</li><li>Ctrl tuşuna basarken tıklayarak birden fazla seçim yapabilirsiniz. Mac kullanıcıları CMD tuşuna basarken tıklayabilir.</li><li>İki öznitelik arasındaki bütün değerleri seçmek için, ilk değere tıkladıktan sonra, Shift tuşuna basarken son değere tıklayın.</li></ul><p><strong>Gelişmiş arama ve yerleşim ayarları</strong><br><br><b>Kaydedilmiş arama ve yerleşim</b> seçeneği ile çeşitli arama parametrelerini ve özelleştirilmiş liste yerleşimini kaydederek arama sonuçlarını istediğiniz zaman hızlıca görebilirsiniz. Sınırsız sayıda özelleştirilmiş arama ve yerleşim kaydedebilirsiniz. Kaydedilen tüm aramalar, son kullanılan kaydedilen arama en üstte olacak şekilde kaydedilen aramalar listesinde adlarına göre görüntülenir.<br><br>Gizlenecek sütunlar ve görüntülenecek sütunlar alanlarını kullanarak arama sonucu liste yerleşimini istediğiniz verileri görüntüleyecek şekilde özelleştirebilirsiniz. Örneğin, Kayıt adı, Atanmış kullanıcı, Atanmış takım gibi verileri arama sonucuna ekleyebilir ya da kaldırabilirsiniz. Liste yerleşimine yeni bir sütun eklemek için, ilgili sütunu gizlenecek sütunlar listesinden seçip sol ok üzerine tıklayarak görüntülenecek sütunlar listesine taşıyın. Liste yerleşiminden bir sütun kaldırmak için, ilgili sütunu görüntülenecek sütunlar listesinden seçip sağ ok üzerine tıklayarak gizlenecek sütunlar listesine taşıyın.<br><br>Yerleşim ayarlarını kaydederseniz, arama sonuçlarını özelleştirilmiş yerleşimde istediğiniz zaman görüntüleyebilirsiniz.<br><br>Bir aramayı ya da yerleşimi kaydetmek ya da güncellemek için:<ol><li><b>Bu aramayı farklı kaydet</b> alanına bir ad yazarak <b>Kaydet</b> üzerine tıklayın. Yazdığınız ad <b>Temizle</b> düğmesinin yanındaki kaydedilmiş aramalar listesinde görüntülenir.</li><li>Kaydedilmiş arama sonuçlarını görüntülemek için, kaydedilmiş aramalar listesinden bir ad seçin. Arama sonuçları liste yerleşiminde görüntülenir.</li><li>Kaydedilmiş bir aramanın özelliklerini güncellemek için, listeden kaydedilmiş aramayı seçin. Gelişmiş arama bölümünden yeni arama ölçütü ve yerleşim ayarlarını seçip <b>Geçerli aramayı değiştir</b> yanındaki <b>Güncelle</b> üzerine tıklayın.</li><li>Kaydedilmiş bir aramayı silmek için, kaydedilmiş aramalar listesinden seçin, <b>Geçerli aramayı değiştir</b> yanındaki <b>Sil</b> üzerine tıklayın ve <b>Tamam</b> üzerine tıklayarak onaylayın.</li></ol><p><strong>İpuçları</strong><br><br>% genel arama karakterini kullanarak daha çok sonuç elde edebilirsiniz. Örneğin yalnızca "Elma" sözcüğünün olduğu sonuçlar yerine "Elma%" ile arama yaparsanız "Elmalı" gibi Elma sözcüğü ile başlayan tüm sonuçları görebilirsiniz.</p>',
...
"2. Şu anda okuduğunuz yardım yazısını kaldırın." 
...
" 5. Uygulamada İşlemler menüsünden içe aktar üzerine tıklayın ve yüklenecek dosyayı seçin "   ',
    ...
    'ERR_NOTIFICATIONS_MARK_AS_READ' => 'Bildirimler okunmuş olarak işaretlenirken sorun çıktı',
    'ERR_FIELD_LOGIC_BACKEND_CALCULATION' => 'Değer alınırken sorun çıktı',
    'LBL_FAILED_TO_UPDATE_TEMPLATE_VARIABLES' => 'Kalıp değişkenleri güncellenemedi',
    ...
    'LBL_DISABLE_USER_2FA' => 'İki adımlı doğrulamayı kapat',
    'LBL_DELETE_BUTTON_KEY' => 'd',
    'LBL_DELETE_BUTTON_LABEL' => 'Sil',
    'LBL_DELETE_BUTTON_TITLE' => 'Sil',
    'LBL_BULK_ACTION_BUTTON_LABEL' => 'Toplu işlem',
    'LBL_BULK_ACTION_BUTTON_LABEL_MOBILE' => 'İŞLEM',
    'LBL_TOO_FEW_SELECTED' => 'Seçilmiş kayıt sayısı geçersiz. En az {min} kayıt seçmelisiniz.',
    'LBL_TOO_MANY_SELECTED' => 'Seçilmiş kayıt sayısı geçersiz. En fazla {max} kayıt seçmelisiniz.',
    'LBL_SELECT_ALL_NOT_ALLOWED' => 'Bu işlem için tüm kayıtlar seçilemez. Lütfen kayıtları tek tek seçin.',
    'LBL_MISSING_HANDLER_DATA' => 'Beklenmeyen bir sorun çıktı. Yanıt içinde toplu işlem işleyici verileri eksik',
    'LBL_MISSING_HANDLER' => 'Beklenmeyen bir sorun çıktı. Seçilmiş toplu işlem için bir işleyici belirtilmemiş',
    'LBL_MISSING_HANDLER_DATA_ROUTE' => 'Beklenmeyen bir sorun çıktı. Toplu işlem yolu eksik',
    'LBL_ACTION_ERROR' => 'İşlem çağrılırken beklenmeyen bir sorun çıktı',
    'LBL_BULK_ACTION_ERROR' => 'Toplu işlem çağrılırken beklenmeyen bir sorun çıktı',
    'LBL_BULK_ACTION_DELETE_SUCCESS' => 'Kayıtlar silindi',
    'LBL_BULK_ACTION_MASS_UPDATE_CONFIRMATION' => 'Seçilmiş kayıtları güncellemek istediğinize emin misiniz?',
    'LBL_BULK_ACTION_MASS_UPDATE_SUCCESS' => 'Tüm kayıtlar güncellendi',
    'LBL_BULK_ACTION_MASS_UPDATE_PARTIAL_SUCCESS' => 'İşlem eksikliklerle tamamlandı. Bazı kayıtlar güncellenmedi. Ayrıntılı bilgi almak için günlüğe bakabilirsiniz',
    ...
    'LBL_ERROR_SAVING' => 'Kayıt kaydedilirken sorun çıktı',
    'LBL_SAVE_BUTTON_KEY' => 'a',
    'LBL_SAVE_BUTTON_LABEL' => 'Kaydet',
    'LBL_NEW_EM_SURVEY' => 'Yeni anket e-postası',
    'LBL_NEW_EM_TRANSACTIONAL' => 'Yeni işlemsel e-posta',
    'LBL_NEW_EM_MARKETING' => 'Yeni pazarlama e-postası',
    'LBL_NEW_SURVEY' => 'Yeni anket',
    'LBL_WEB_TO_LEAD' => 'Yeni internetten kişiye form',
    'LBL_TYPE' => 'Tür',
    'LBL_DATE_START' => 'Başlangıç tarihi',
    'LBL_SEND_DATE' => 'Gönderim tarihi',
    'LBL_SCHEDULE_BUTTON_LABEL' => 'Zamanlama',
    'LBL_UNABLE_TO_UNSCHEDULE' => 'Zamanlanmış olmadığından zamanlama kaldırılamadı',
    'LBL_SAVE_BUTTON_TITLE' => 'Kaydet',
    'LBL_SAVE_CONTINUE_LABEL' => 'Kaydedip ilerle',
    ...
    'ANNUAL_REVENUE_BY_ACCOUNTS' => 'Hesaplara göre yıllık gelir',
    'PIPELINE_BY_SALES_STAGE' => 'Satış aşamalarına göre satış olasılıkları',
    'LEADS_BY_SOURCE' => 'Kaynağa göre potansiyeller',
    'LEADS_BY_STATUS' => 'Duruma göre potansiyeller',
    'ACCOUNT_TYPES_PER_MONTH' => 'Aya göre yeni hesaplar',

    'ERR_CONNECTOR_NOT_ARRAY' => '{0} içindeki bağlantı dizisi hatalı tanımlanmış ya da boş olduğundan kullanılamıyor.',
    'ERR_SUHOSIN' => 'Yükleme akışı Suhosin tarafından engellendi, lütfen suhosin.executor.include.whitelist içine &quot;upload&quot; ifadesini ekleyin. (Ayrıntılı bilgi almak için suitecrm.log dosyasına bakın)',
    ...
    'LBL_CONFIRM_APPLY_EMAIL_TEMPLATE_BODY' => 'Bu işlem e-postanın içerik yazısını ve konu bölümlerini değiştirecek. İlerlemek istiyor musunuz?',
    ...
    'ERR_OPT_IN_RELATION_INCORRECT' => 'Abone olmak için e-postanın Hesap/İlgili/Potansiyel/Hedef ile ilişkilendirilmiş olması gerekir',
    ...
    'LBL_SUITE_DESC1' => 'SuiteCRM <a href="https://suitecrm.com/">SuiteCRM Ltd</a> tarafından geliştirilmiş ve bir araya getirilmiştir. Bu program herhangi bir garanti verilmeden OLDUĞU GİBİ sunulmaktadır. AGPLv3 koşulları altında lisanslanmıştır.',
    ...
    'LBL_SUITE_DESC3' => 'SuiteCRM, SuiteCRM Ltd kuruluşunun ticari markasıdır. Diğer tüm kuruluş ve ürün adları ilgili kuruluşların ticari markaları olabilir.',
    'LBL_GENERATE_PASSWORD_BUTTON_TITLE' => 'Parolayı sıfırla',
    'LBL_SEND_CONFIRM_OPT_IN_EMAIL' => 'Abone olma onayı e-postası gönderildi',
    'LBL_CONFIRM_OPT_IN_ONLY_FOR_PERSON' => 'Abone olma onayı e-postası yalnızca Hesaplar/İlgililer/Potansiyeller/Adaylara gönderilsin',
    'LBL_CONFIRM_OPT_IN_IS_DISABLED' => 'Abone olma onayı e-postasının gönderilmesi kapatılmış. E-posta ayarları bölümünden abone olma onayı seçeneğini açın ya da yöneticiniz ile görüşün.',
    'LBL_CONTACT_HAS_NO_PRIMARY_EMAIL' => 'İlgilinin birincil e-posta adresi olmadığından abone olma onayı e-postası gönderilemiyor',
    ...
    'LBL_SEND_TEST_EMAIL_DESC' => 'Lütfen gönderim yapılacak e-posta adreslerini / kullanıcıları ve/veya hedef listelerini seçin.',
    'LBL_EMAIL_SENT_SUCCESSFULLY' => 'E-posta gönderildi',
    ...
    'LBL_ENTER_AUTH_APP_2FA_CODE' => 'Lütfen kimlik doğrulayıcı uygulamanızdan alacağınız doğrulama kodunu yazın',
    'LBL_ENABLE_2FA_LABEL' => 'İki adımlı doğrulamayı aç',
    'LBL_BACKUP_CODES' => 'Kurtarma/Yedek kodları',
    'LBL_BACKUP_CODES_INFO' => 'Yedek kodlar, Authenticator uygulamanızı kullanamadığında kullanabileceğiniz tek seferlik parolalardır.',
    'LBL_BACKUP_CODES_WARN' => 'UYARI: Bu kodlar yalnızca bir kez oluşturulur. Bunlar yeniden görüntülenmeyeceği için lütfen doğrulamadan ÖNCE kopyalayın.',
    'LBL_PROBLEMS_GENERATING_CODE' => 'Kod oluşturmakta sorun mu yaşıyorsunuz?',
    'LBL_BACKUP_CODES_FALLBACK_INSTRUCTIONS' => 'Yedek kodlardan birini kullanın (kullanıldıktan sonra geçersiz olur)',
    'LBL_OTP_SETUP' => 'İki adımlı doğrulamayı açmak için cep telefonunuzda veya bilgisayarınızda bir tek kullanımlık parola ile kimlik doğrulama uygulaması kullanın',
    'LBL_QR_CODE_HELP' => "Henüz yapmadıysanız, lütfen bir kimlik doğrulama uygulaması (FreeOTP veya Google Authenticator gibi) indirin. Kare kodu taramak için bu uygulamayı kullanın.",
    'LBL_USE_SECRET' => "Kare kodu tarayamıyor musunuz?",
    'LBL_USE_SECRET_DESC' => "Kare kodu tarayamıyorsanız, lütfen aşağıdaki parolayı kimlik doğrulayıcı uygulamanıza el ile yazın.",
    'LBL_HIDE_SECRET' => "Tek kullanılık parolayı gizle",
    'LBL_2FA_LOGIN_CANCEL' => 'İki adımlı doğrulama iptal edildi',

    'LBL_FACTOR_AUTH_DISABLE' => 'İki adımlı doğrulama kapalı',
    'LBL_FACTOR_AUTH_SUCCESS' => 'İki adımlı doğrulama başarılı',
    'LBL_FACTOR_AUTH_FAIL' => "İki adımlı doğrulama yapılamadı. Yeniden deneyin.",

    'LBL_VERIFY_2FA' => 'Kodu doğrula',
    'LBL_TWO_FACTOR_AUTH' => 'İki adımlı doğrulama',
    'LBL_TWO_FACTOR_AUTH_APP_METHOD' => 'Kimlik doğrulama uygulaması',
    'LBL_TWO_FACTOR_AUTH_APP_METHOD_DESCRIPTION' => 'İstendiğinde iki adımlı doğrulama kodları oluşturmak için bir kimlik doğrulama uygulaması kullanın',
    'LBL_ENABLE' => 'Aç',
    'LBL_ENABLED' => 'Açık',
    'LBL_DISABLE' => 'Kapat',
    'LBL_GENERATED' => 'Oluşturuldu',
    'LBL_REGENERATE_CODES' => 'Yeniden oluştur',
    'LBL_REGENERATED_BACKUP_CODES' => 'Yedek kodları yeniden oluşturuldu'
...
$app_list_strings['case_status_default_key'] = 'Yeni_Ac';
...
$app_list_strings['aos_quotes_type_dom']['Integrator'] = 'Bütünleştirici';
...
$app_list_strings['aos_invoices_type_dom']['Integrator'] = 'Bütünleştirici';
...
$app_string['LBL_PDF_GENERATION_FAILED'] = 'PDF belgesi oluşturulamadı. Ayrıntılı bilgi almak için günlük kayıtlarına bakın.';
...
$app_list_strings['moduleList']['ManualMigrationTasks'] = 'Aktarımlar';
$app_list_strings['moduleList']['Processes'] = 'Süreçler';
$app_list_strings['moduleList']['AsyncTaskItems'] = 'Eşitlenmemiş görev ögesi';

$app_strings['LNK_USER_MENU_PROCESSES'] = 'Süreçler';
...
$app_strings['LBL_DELETE_DASHBOARD_PAGE'] = 'Geçerli pano sayfasını kaldır';
...
$app_strings['LBL_OPT_IN_OPT_OUT'] = 'Abonelikten ayrılan';
...
$app_list_strings['sync_attempt_message_list'] = [
    '' => '',
    'sync_complete' => 'Tüm toplantılar eşitlenmiş.',
    'up_to_date' => 'Eşitlenecek yeni bir toplantı yok.',
    'meetings_failed' => 'Bazı toplantılar eşitlenemedi. Günlük kayıtlarına bakın.',
    'sync_partial' => 'Bazı toplantılar eşitlendi. Diğerleri sınırlar nedeniyle bekliyor.',
    'sync_failed' => 'Hiçbir toplantı eşitlenmedi. Günlük kayıtlarına bakın.',
];
...
$app_strings['MSG_BROWSER_NOTIFICATIONS_ENABLED'] = 'Bu tarayıcı için bildirimler açıldı.';
$app_strings['MSG_BROWSER_NOTIFICATIONS_DISABLED'] = 'Bu tarayıcı için bildirimler kapatılmış. Yeniden açmak için tarayıcı ayarlarına bakabilirsiniz.';
...
$app_strings['LBL_OPT_OUT'] = 'Abonelikten ayrıl';
$app_strings['LBL_INVALID_EMAIL'] = 'Geçersiz';
$app_strings['LBL_PRIMARY'] = 'Birincil';
$app_strings['LBL_EMAIL_ADDRESS'] = 'E-posta adresi';
...
$app_strings['LBL_SEARCH_TITLE']                   = 'Ara';
$app_strings['LBL_SEARCH_TEXT_FIELD_TITLE_ATTR']   = 'Arama ölçütünü yazın';
$app_strings['LBL_SEARCH_SUBMIT_FIELD_TITLE_ATTR'] = 'Ara';
$app_strings['LBL_SEARCH_SUBMIT_FIELD_VALUE']      = 'Ara';
...
$app_strings['LBL_INSIGHTS'] = 'İçgörüler';
$app_strings['LBL_CHARTS'] = 'Çizelgeler';
$app_strings['LBL_CHART_NOT_FOUND'] = 'Çizelge bulunamadı';
$app_strings['LBL_NO_DATA'] = 'Herhangi bir veri yok';
$app_strings['LBL_ERROR_FETCHING_METADATA'] = 'Üst veriler alınırken sorun çıktı';
$app_strings['LBL_TOTAL'] = 'Toplam';
$app_strings['LBL_ACTIONS'] = 'İşlemler';
$app_strings['LBL_SELECT_SUBPANEL_BANNER'] = 'Görüntülenecek alt panoları seçin';
$app_strings['LBL_SELECT_ITEM'] = 'Bir öge seçin';
$app_strings['LBL_ITEMS_SELECTED'] = 'öge seçildi';
$app_strings['LBL_WIDGET_NOT_FOUND'] = 'Pano gereci bulunamadı';
$app_strings['LBL_BAD_CONFIG'] = 'Yapılandırma hatalı';
$app_strings['LBL_CONFIG_BAD_CONTEXT'] = 'Yapılandırma hatalı: Bağlam doğru yapılandırılmamış';
$app_strings['LBL_CONFIG_NO_CONFIG'] = 'Yapılandırma hatalı: Yapılandırma eksik';
$app_strings['LBL_CONFIG_NO_STATISTICS_KEY'] = 'Yapılandırma hatalı: İstatistikler anahtarı eksik';
$app_strings['LBL_STATISTIC_ERROR'] = 'İstatistikler yüklenirken sorun çıktı';
$app_strings['LBL_STATISTIC_ERROR_DESC'] = 'İstatistikler yüklenirken sorun çıktı';
$app_strings['LBL_STATISTIC_ERROR_DESC_TOOLTIP'] = 'İstatistikler yüklenirken sorun çıktı. Lütfen yöneticiniz ile görüşün';
$app_strings['LBL_AVERAGE_CLOSED_WON_PER_YEAR'] = 'Her yıl ortalama kazanma fırsatı';
$app_strings['LBL_OPPORTUNITIES_TOTAL'] = 'Fırsat değeri toplamı';
$app_strings['LBL_CASE_TOTAL_DAYS_OPEN'] = 'Açık gün toplamı';
$app_strings['LBL_DAYS_OPEN'] = 'Açık gün';
$app_strings['LBL_DAYS_IN_SALE_STAGE'] = 'BU FIRSATIN BU SATIŞ AŞAMASINDA OLDUĞU GÜN SAYISI';
$app_strings['LBL_STAT_DAYS'] = 'Gün';
$app_strings['LBL_CLOSED_PER_YEAR'] = 'Her yıl kapatılan';
$app_strings['LBL_WAS_OPEN'] = 'Bu destek kaydı şu kadar zamandır açıktı';
$app_strings['LBL_HAS_BEEN_OPEN'] = 'Bu destek kaydı şu kadar zamandır açık';
$app_strings['LBL_NUMBER_OF_CASES_PER_ACCOUNT'] = 'Her hesabın destek kaydı sayısı';
$app_strings['LBL_TOTAL_CASES_FOR_THIS_ACCOUNT'] = 'Bu hesabın toplam destek kaydı sayısı';
$app_strings['LBL_NONE_OUTSTANDING'] = 'Hiçbiri';
$app_strings['LBL_VALIDATION_ERROR_REQUIRED'] = 'Doldurulması zorunlu alan eksik: {{fields.field.label}}';
$app_strings['LBL_VALIDATION_ERROR_ATTACHMENT'] = 'Ek dosyalar geçersiz.';
$app_strings['LBL_VALIDATION_ERROR_CURRENCY_FORMAT'] = "Para birimi biçimi geçersiz. Beklenen: '{{context.expected}}'";
$app_strings['LBL_VALIDATION_ERROR_INT_FORMAT'] = "Tam sayı biçimi geçersiz. Beklenen: '{{context.expected}}'";
$app_strings['LBL_VALIDATION_ERROR_FLOAT_FORMAT'] = "Float biçimi geçersiz. Beklenen: '{{context.expected}}'";
$app_strings['LBL_VALIDATION_ERROR_DATE_FORMAT'] = "Tarih biçimi geçersiz. Beklenen: '{{context.expected}}'";
$app_strings['LBL_VALIDATION_ERROR_DATETIME_FORMAT'] = "TarihSaat biçimi geçersiz. Beklenen: '{{context.expected}}";
$app_strings['LBL_VALIDATION_ERROR_UNSUBSCRIBE_LINK'] = "İşlemsel olmayan e-postalarda bir abonelikten ayrılma bağlantısı bulunmalıdır. Lütfen bir abonelikten ayrılma izleyici, '{{ unsubscribe_link }}' ekleyin ya da simgeyi seçin: ";
$app_strings['LBL_VALIDATION_ERROR_REMOVE_UNSUBSCRIBE_LINK'] = "İşlemsel e-postalarda bir abonelikten ayrılma bağlantısı bulunmamalıdır. Lütfen '{{ unsubscribe_link }}' bileşenini kaldırın";
$app_strings['LBL_VALIDATION_ERROR_EMAIL_FORMAT'] = "E-posta biçimi geçersiz. Beklenen: '{{context.expected}}'";
$app_strings['LBL_VALIDATION_ERROR_PHONE_FORMAT'] = "Telefon biçimi geçersiz.";
$app_strings['LBL_VALIDATION_ERROR_MIN'] = "Değer geçersiz. '{{context.min}}' değerinden büyük ya da eşit olmalı";
$app_strings['LBL_VALIDATION_ERROR_VERSIONING'] = "Biçim geçersiz. Beklenen: '{{context.expected}}'";
$app_strings['LBL_VALIDATION_ERROR_MAX'] = "Değer geçersiz. '{{context.max}}' değerinden küçük ya da eşit olmalı";
$app_strings['LBL_MULTIPLE_PRIMARY_EMAIL_VALIDATION_ERROR'] = "Yalnızca bir geçerli e-posta adresi birincil olarak işaretlenmelidir";
$app_strings['LBL_DUPLICATE_EMAIL_VALIDATION_ERROR'] = "Çift e-posta adreslerine izin verilmiyor";
$app_strings['LBL_NO_PRIMARY_EMAIL_VALIDATION_ERROR'] = "Geçerli bir e-posta adresi birincil olarak işaretlenmelidir";
...
$app_strings['LBL_SELECT_EMAIL_FOR_TEST'] = 'Lütfen hedefleri/kullanıcıları seçin ya da bir e-posta adresi yazın';
$app_strings['LBL_TYPE_TO_SEARCH'] = 'Aramak için yazın...';
$app_strings['LBL_SEARCHING'] = 'aranıyor...';
$app_strings['LBL_NOT_FOUND'] = 'Bulunamadı.';
$app_strings['LBL_SEARCH_ERROR'] = 'Arama sorunu.';
$app_strings['LBL_FOUND'] = 'Bulunan';
$app_strings['LBL_GET_RECORD_LIST_ERROR'] = 'Kayıtlar alınırken sorun çıktı';
$app_strings['LBL_NUMBER_OF_RECORDS'] = 'Kayıt sayısı';
...
$app_strings['LBL_CONTRACT_RENEWAL_TOOLTIP'] = 'Sonraki sözleşme yenileme tarihi';
$app_strings['LBL_INVOICES_OVERDUE_TOOLTIP'] = 'Ödeme süresi geçmiş faturaların toplam sayısı';
$app_strings['LBL_ACTIVITIES_NEXT_DATE_TOOLTIP'] = 'Sonraki etkileşim tarihi';
$app_strings['LBL_CAMPAIGN_LAST_RECEIVED_TOOLTIP'] = 'Alınan son kampanya tarihi';
$app_strings['LBL_OPEN_CASES_COUNT_TOOLTIP'] = 'Açık destek kayıtlarının toplam sayısı';
$app_strings['LBL_EVENTS_LAST_DATE_TOOLTIP'] = 'Son etkinlik tarihi';
$app_strings['LBL_HISTORY_LAST_DATE_TOOLTIP'] = 'Son etkileşim tarihi';
$app_strings['LBL_OPPORTUNITIES_TOTAL_SUM_TOOLTIP'] = 'Fırsat tutarları toplamı';
$app_strings['LBL_QUOTES_EXPIRY_TOOLTIP'] = 'Sonraki fiyat teklifi sona erme tarihi';
$app_strings['LBL_DEFAULT_TOTAL_TOOLTIP'] = 'Toplam kayıt sayısı';
$app_strings['LBL_CONTRACT_RENEWAL'] = 'Yenileme tarihi';
$app_strings['LBL_INVOICES_OVERDUE'] = 'Süresi geçen toplamı';
$app_strings['LBL_ACTIVITIES_NEXT_DATE'] = 'Sonraki işlem tarihi';
$app_strings['LBL_CAMPAIGN_LAST_RECEIVED'] = 'Son yanıtlanan';
$app_strings['LBL_OPEN_CASES_COUNT'] = 'Açık destek kayıtları';
$app_strings['LBL_EVENTS_LAST_DATE'] = 'Katınılan son etkinlik';
$app_strings['LBL_HISTORY_LAST_DATE'] = 'Son iletişim noktası';
$app_strings['LBL_OPPORTUNITIES_TOTAL_SUM'] = 'Toplam değer';
$app_strings['LBL_QUOTES_EXPIRY'] = 'Sonraki sona erme tarihi';
$app_strings['LBL_DEFAULT_TOTAL'] = 'Toplam';
$app_strings['AOS_Contracts'] = 'Sözleşmeler';
$app_strings['AOS_Quotes'] = 'Teklifler';
$app_strings['AOS_Invoices'] = 'Faturalar';
$app_strings['LBL_PHOTO'] = 'Fotoğraf';
$app_strings['LBL_CASE_UPDATES'] = 'Destek kaydı güncellemeleri';
$app_strings['LBL_CASE_UPDATE_SUBMITTED'] = 'Destek kaydı güncellemesi gönderildi';
...
$app_strings['LBL_LOAD_MORE'] = 'Diğerlerini yükle';
$app_strings['LBL_EMPTY'] = '-- Boş --';
$app_strings['LBL_OPERATOR'] = 'İşlem';
$app_strings['LBL_START'] = 'İlk';
$app_strings['LBL_END'] = 'Bitiş';
$app_strings['LBL_LINE_ITEMS_FIELD_CONFIG'] = 'Yapılandırma hatalı';


$app_strings['LBL_ACTION_SUCCESS'] = 'İşlem başarılı';

$app_strings['LBL_YES'] = 'Evet';
$app_strings['LBL_NO'] = 'Hayır';

$app_list_strings['sort_order'] = [];
$app_list_strings['sort_order']['asc'] = 'Artan';
$app_list_strings['sort_order']['desc'] = 'Azalan';

// Labels used by subpanel unlink relationship process
$app_strings['LBL_LINK'] = 'Bağlantı';
$app_strings['LBL_LINK_UNLINK'] = 'Bağlantı kur / kaldır';
$app_strings['LBL_SAVE'] = 'Kaydet';
$app_strings['LBL_UNLINK_RECORD'] = 'Kaydın bağlantısını kaldır';
$app_strings['LBL_DELETE_RECORD'] = 'Kaydı sil';
$app_strings['LBL_EDIT_RECORD'] = 'Kaydı düzenle';
$app_strings['LBL_UNLINK_RELATIONSHIP_CONFIRM'] = 'Bu kaydın bağlantısını kaldırmak istediğinize emin misiniz? Yalnızca ilişki kaldırılır. Kayıt silinmez.';
$app_strings['LBL_UNLINK_RELATIONSHIP_SUCCESS'] = 'Kayıt bağlantısı kaldırıldı.';
$app_strings['LBL_UNLINK_RELATIONSHIP_FAILED'] = 'Kayıt bağlantısı kaldırılırken bir sorun çıktı.';
$app_strings['LBL_ALL_RECORDS_UNLINKED'] = 'Tüm kayıtların bağlantısı kaldırıldı';
$app_strings['LBL_SOME_RECORDS_UNLINKED_FAILED'] = 'Bazı kayıtların bağlantısı kaldırılırken bir sorun çıktı. Ayrıntılı bilgi almak için günlük kayıtlarına bakın.';
$app_strings['LBL_LINK_RELATIONSHIP_SUCCESS'] = 'İlişki bağlantısı kuruldu.';
$app_strings['LBL_LINK_RELATIONSHIP_FAILED'] = 'İlişki bağlantısı kurulurken bir sorun çıktı.';
$app_strings['LBL_MODULE_NOT_FOUND'] = 'Modül bulunamadı.';
$app_strings['LBL_RECORD_NOT_FOUND'] = 'Kayıt yüklenemedi';
$app_strings['LBL_FILE_NOT_FOUND'] = 'Dosya yüklenemedi';
$app_strings['LBL_RELATIONSHIP_LOAD_ERROR'] = 'İlişki yüklenemedi';
$app_strings['LBL_NOT_LINKED'] = 'Bağlantı kesilemedi. Kayıtlar bağlantılı değil';
$app_strings['LBL_ACCESS_DENIED'] = 'Erişim reddedildi';
$app_strings['LBL_ADD_RECORDS_TO_TARGET_LIST_SUCCESS'] = 'Kayıtlar hedef listesine eklendi.';
$app_strings['LBL_ADD_RECORDS_TO_TARGET_LIST_FAILED'] = 'Kayıtlar hedef listesine eklenirken sorun çıktı.';
$app_strings['LBL_ADD_CONTACTS_TO_TARGET_LIST_SUCCESS'] = 'Kişiler hedef listesine eklendi.';
$app_strings['LBL_ADD_CONTACTS_TO_TARGET_LIST_FAILED'] = 'Kişiler hedef listesine eklenirken sorun çıktı.';
$app_strings['LBL_CHANGED_TO_TEXT'] = 'şu olarak değiştirildi';
$app_strings['LBL_RECORD_CHANGED'] = 'Kayıt güncellendi';
$app_strings['LBL_CREATE'] = "Ekle";
$app_strings['LBL_USE_ADVANCED_SEARCH'] = 'Gelişmiş arama kullanılsın';
$app_strings['LBL_USE_BASIC_SEARCH'] = 'Basit arama kullanılsın';
$app_strings['LBL_NO_MODULE_SELECTED'] = 'Herhangi bir modül seçilmemiş';
$app_strings['LBL_CLOSE_MENU'] = 'Menüyü kapat';
$app_strings['LOGIN_INCORRECT'] = 'Oturum açma bilgileri doğru değil. Lütfen yeniden deneyin.';
$app_strings['LOGIN_TOO_MANY_FAILED'] = 'Çok sayıda başarısız oturum açma girişiminde bulunuldu. Lütfen bir süre sonra yeniden deneyin.';
...
$app_strings['LBL_NEW_NOTIFICATION'] = "{{context.unread}} yeni bildiriminiz var";
$app_strings['LBL_ALERT_STATUS_COMPLETED'] = 'Tamamlandı';
$app_strings['LBL_ALERT_STATUS_COMPLETED_WITH_FAILURES'] = 'Sorunlar ile tamamlandı';
$app_strings['LBL_ALERT_STATUS_FAILED'] = 'Tamamlanamadı';
$app_strings['LBL_NOTIFICATION_ITEM_DATE'] = 'Bitiş: {{fields.date_start.value}}';
$app_strings['LBL_NOTIFICATION_ITEM_DATE_ENTERED'] = 'Bildirilme: {{fields.snooze.value}}';
$app_strings['LBL_QUICK_ACTIONS'] = 'Hızlı işlemler';
$app_strings['LBL_RELATIONSHIPS'] = 'İlişkiler';
$app_strings['LBL_SHOW_CC'] = 'Kopya görüntülensin';
$app_strings['LBL_SHOW_BCC'] = 'Gizli kopya görüntülensin';
$app_strings['LBL_CC'] = 'Kopya';
$app_strings['LBL_BCC'] = 'Gizli kopya';
$app_strings['LNK_NEW_EMAIL'] = 'Yeni e-posta';
$app_strings['LBL_INSERT_TEMPLATE'] = 'Kalıp ekle';
$app_strings['LBL_MISSING_RECORD_DATA'] = 'Kayıt verileri eksik';
$app_strings['LBL_MISSING_FIELDS_DATA'] = 'Alanlar verileri eksik';
$app_strings['LBL_WRONG_MODULE_PROVIDED'] = 'Belirtilen modül yanlış';
$app_strings['LBL_NO_TEMPLATE_ID_PROVIDED'] = 'Kalıp kimliği belirtilmemiş';
$app_strings['LBL_TEMPLATE_NOT_FOUND'] = 'Kalıp bulunamadı';
$app_strings['LBL_EMAIL_MODAL_DYNAMIC_TITLE'] = 'Yeni e-posta{{fields.name.value|prefix:\' - \'}}';
$app_strings['LBL_EMAIL_MODAL_DRAFT_DYNAMIC_TITLE'] = 'Taslak{{fields.name.value|prefix:\' - \'}}';
$app_strings['LBL_CLOSE_EMAIL_MODAL'] = 'Bu e-postayı silmek istediğinize emin misiniz? (değişiklikler kaybolacak)';
$app_strings['LBL_RELATED_TO_DYNAMIC'] = '{{fields.parent_type.value|uppercase}}';
$app_strings['LBL_RELATED_TO'] = 'İlişkili öge';
...
$app_strings['LBL_SMALL'] = 'Küçük';
$app_strings['LBL_MEDIUM'] = 'Orta';
$app_strings['LBL_NORMAL'] = 'Normal';
$app_strings['LBL_LARGE'] = 'Büyük';
$app_strings['LBL_HUGE'] = 'Çok büyük';
$app_strings['LBL_DEFAULT'] = 'Varsayılan';
$app_strings['LBL_APPLY'] = 'Uygula';
$app_strings['LBL_INSERT_LINK_URL_DESCRIPTION'] = 'Adresi ya da e-posta adresini yazın:';
$app_strings['LBL_INSERT_LINK_PLACEHOLDER'] = 'Örnek: https://www.ornek.com';

$app_strings['LBL_COLOR_BLACK'] = 'Siyah';
$app_strings['LBL_COLOR_FIREBRICK'] = 'Tuğla kırmızısı';
$app_strings['LBL_COLOR_RED'] = 'Kırmızı';
$app_strings['LBL_COLOR_SALMON'] = 'Somon';
$app_strings['LBL_COLOR_BLUSH'] = 'Uçuk pembe';
$app_strings['LBL_COLOR_DARK_RED'] = 'Koyu kırmızı';
$app_strings['LBL_COLOR_BROWN'] = 'Kahverengi';
$app_strings['LBL_COLOR_DARK_ORANGE'] = 'Koyu turuncu';
$app_strings['LBL_COLOR_ORANGE'] = 'Turuncu';
$app_strings['LBL_COLOR_ANTIQUE_WHITE'] = 'Antik Beyaz';
$app_strings['LBL_COLOR_SADDLE_BROWN'] = 'Kahverengi deri';
$app_strings['LBL_COLOR_GOLDENROD'] = 'Altın çubuk';
$app_strings['LBL_COLOR_GOLD'] = 'Altın';
$app_strings['LBL_COLOR_YELLOW'] = 'Sarı';
$app_strings['LBL_COLOR_LIGHT_YELLOW'] = 'Açık sarı';
$app_strings['LBL_COLOR_DARK_SLATE_GRAY'] = 'Mavimsi yeşil';
$app_strings['LBL_COLOR_DARK_GREEN'] = 'Koyu yeşil';
$app_strings['LBL_COLOR_GREEN'] = 'Yeşil';
$app_strings['LBL_COLOR_LIME'] = 'Açık yeşil';
$app_strings['LBL_COLOR_HONEYDEW'] = 'Bal damlası';
$app_strings['LBL_COLOR_TEAL'] = 'Camgöbeği';
$app_strings['LBL_COLOR_TURQUOISE'] = 'Turkuaz';
$app_strings['LBL_COLOR_AQUA'] = 'Su mavi';
$app_strings['LBL_COLOR_PALE_TURQUOISE'] = 'Uçuk turkuaz';
$app_strings['LBL_COLOR_AZURE'] = 'Azure mavi';
$app_strings['LBL_COLOR_NAVY_BLUE'] = 'Denizci mavisi';
$app_strings['LBL_COLOR_MEDIUM_BLUE'] = 'Orta mavi';
$app_strings['LBL_COLOR_BLUE'] = 'Mavi';
$app_strings['LBL_COLOR_LIGHT_BLUE'] = 'Açık mavi';
$app_strings['LBL_COLOR_ALICE_BLUE'] = 'Uçuk mavi';
$app_strings['LBL_COLOR_INDIGO'] = 'Çivit mavi';
$app_strings['LBL_COLOR_PATRIARCH_PURPLE'] = 'Papaz mor';
$app_strings['LBL_COLOR_VIOLET_PURPLE'] = 'Menekşe mor';
$app_strings['LBL_COLOR_PLUM'] = 'Erik mor';
$app_strings['LBL_COLOR_LAVENDER'] = 'Lavanta mor';
$app_strings['LBL_COLOR_DIM_GRAY'] = 'Soluk gri';
$app_strings['LBL_COLOR_GRAY'] = 'Gri';
$app_strings['LBL_COLOR_DARK_GRAY'] = 'Koyu gri';
$app_strings['LBL_COLOR_LIGHT_GRAY'] = 'Açık gri';
$app_strings['LBL_COLOR_WHITE'] = 'Beyaz';

$app_strings['LBL_BOLD'] = 'Kalın';
$app_strings['LBL_ITALIC'] = 'Yatık';
$app_strings['LBL_INSERT_TEMPLATE_VARIABLE'] = 'Değişken ekle';
$app_strings['LBL_UNDERLINE'] = 'Altı çizili';
$app_strings['LBL_STRIKETHROUGH'] = 'Üstü çizili';
$app_strings['LBL_FONT_FACE'] = 'Yazı türü';
$app_strings['LBL_TEXT_SIZE'] = 'Yazı boyutu';
$app_strings['LBL_TEXT_COLOR'] = 'Yazı rengi';
$app_strings['LBL_TEXT_HIGHLIGHT'] = 'Yazı vurgusu';
$app_strings['LBL_LINK'] = 'Bağlantı';
$app_strings['LBL_UNORDERED_LIST'] = 'Sırasız liste';
$app_strings['LBL_ORDERED_LIST'] = 'Numaralı liste';
$app_strings['LBL_QUOTE'] = 'Teklif';
$app_strings['LBL_UNQUOTE'] = 'Alıntıyı kaldır';
$app_strings['LBL_ALIGN'] = 'Hizala';
$app_strings['LBL_ALIGN_LEFT'] = 'Sol';
$app_strings['LBL_ALIGN_CENTER'] = 'Ortala';
$app_strings['LBL_ALIGN_RIGHT'] = 'Sağ';
$app_strings['LBL_JUSTIFY'] = 'Sağa ve sola';
$app_strings['LBL_TEXT_LEFT_TO_RIGHT'] = 'Yazı yönü: Soldan sağa';
$app_strings['LBL_TEXT_RIGHT_TO_LEFT'] = 'Yazı yönü: Sağdan sola';
$app_strings['LBL_CLEAR_FORMATTING'] = 'Biçimlendirmeyi temizle';
$app_strings['LBL_INJECT_UNSUBSCRIBE'] = 'Abonelikten ayrılma bağlantısı';
$app_strings['LBL_TEXT_INDENT_LEFT'] = 'Yazıyı soldan içe kaydır';
$app_strings['LBL_TEXT_INDENT_RIGHT'] = 'Yazıyı sağdan içe kaydır';

// Day and Time labels
$app_strings['LBL_SUN'] = 'Pazar';
$app_strings['LBL_MON'] = 'Pazartesi';
$app_strings['LBL_TUE'] = 'Salı';
$app_strings['LBL_WED'] = 'Çarşamba';
$app_strings['LBL_THU'] = 'Perşembe';
$app_strings['LBL_FRI'] = 'Cuma';
$app_strings['LBL_SAT'] = 'Cumartesi';
$app_strings['LBL_ALL'] = 'Her gün';
$app_strings['LBL_EVERY'] = 'Her';
$app_strings['LBL_ON_THE'] = 'Şu tarihte';
$app_strings['LBL_RANGE'] = 'kime';
$app_strings['LBL_FROM'] = 'Başlangıç';
$app_strings['LBL_AND'] = 've';
$app_strings['LBL_MINS'] = 'Dak';
$app_strings['LBL_MINUTES'] = 'dakika';
$app_strings['LBL_HOUR'] = 'saat';
$app_strings['LBL_HOUR_SING'] = 'saat';
$app_strings['LBL_OFTEN'] = 'Olabildiğince sık.';
$app_strings['LBL_MIN_MARK'] = 'dakika işareti';
$app_strings['LBL_INBOUND_EMAIL'] = 'Gelen e-posta';

$app_strings['LBL_LEGEND'] = 'İşaretler';

$app_strings['LBL_EMAIL_MARKETING_NOT_UNSCHEDULED'] = 'E-posta pazarlaması zamanlanmamış olmadığından zamanlanamıyor';
$app_strings['LBL_INCORRECT_RECORD_ID'] = 'Kayıt kimliği geçersiz';

$app_strings['LBL_TEST_ENTRIES_DELETED'] = 'Deneme kayıtları silindi.';
$app_strings['LBL_UNABLE_TO_GET_ID'] = 'E-posta pazarlama kimliği alınamadı';
$app_strings['LBL_UNABLE_TO_DELETE_TEST_ENTRIES'] = 'Deneme kayıtları silinirken sorun çıktı. Ayrıntılı bilgi almak için günlük kayıtlarına bakın';
$app_strings['LBL_SECTION_KEY_NOT_DEFINED'] = 'Bölüm anahtarı tanımlanmamış';
$app_strings['LBL_DOES_BOUNCE_EXIST'] = 'Geri dönen bir e-posta var mı?';
$app_strings['LBL_IS_OUTBOUND_CONNECTED'] = 'Giden e-posta bağlı mı?';
$app_strings['LBL_CAMPAIGN_SETTINGS'] = 'Ayarlar';
...
$app_strings['LBL_RUN_USER_INVALID'] = 'Bu kullanıcı `allowed_cron_users` yapılandırma ayarının bir parçası değil. Bu nedenle son yürütme başarılı olmadı';
...
$app_strings['LBL_EMAILS_MAX_RETRIES'] = 'Kampanya e-postalarını en fazla yeniden deneme sayısı';
$app_strings['LBL_EMAILS_MAX_RETRIES_DYNAMIC_LABEL'] = '{{ fields.campaign_emails_max_retries.value }}';
$app_strings['LBL_EMAILS_THRESHOLD'] = 'Bir toplu iş için kampanya e-postaları hata eşiği';
...
$app_strings['LBL_UNSUBSCRIBE'] = 'Abonelikten ayrıl';
$app_strings['LBL_INACTIVE'] = 'Etkin değil';
$app_strings['LBL_DISPLAYING_TEST_EMAIL_MARKETING_DATA'] = 'Şu anda deneme e-postalarından oluşturulan verileri gösteren çizelgeler ve alt panolar.';
$app_strings['LBL_DASH_SYMBOL'] = '-';
$app_strings['LBL_FIELD_STORAGE_NOT_SET'] = 'Alan için dosya depolama türü ayarlanmamış. Dosya yüklenemedi.';
$app_strings['LBL_FIELD_STORAGE_INVALID_TYPE'] = 'Alan için dosya depolama türü geçerli değil. Dosya yüklenemedi.';
$app_strings['LBL_UPLOAD'] = 'Yükle';
$app_strings['LBL_UPLOAD_FAILED'] = 'Yüklenemedi. Lütfen bir süre sonra yeniden deneyin';
$app_strings['LBL_UPLOADING'] = 'Yükleniyor';
$app_strings['LBL_UPLOAD_FROM_FILES'] = 'Dosyalardan yükle';
$app_strings['LBL_ATTACH_DOCUMENTS'] = 'Belge ekle';
$app_strings['LBL_FILE_FIELD_UPLOAD_BUTTON_DESCRIPTION'] = 'Bir dosya yüklemek için sürükleyip buraya bırakın ya da tıklayın';
$app_strings['LBL_ATTACHMENTS_FIELD_UPLOAD_BUTTON_DESCRIPTION'] = 'Bir dosya yüklemek için sürükleyip buraya bırakın';
$app_strings['LBL_SOME_ATTACHMENTS_FAILED'] = 'Bazı ek dosyalar yüklenemedi. Ayrıntılı bilgi almak için günlük kayıtlarına bakın.';
$app_strings['LBL_UPLOAD_IMAGE'] = 'Görsel yükle';
$app_strings['LBL_DOWNLOAD_IMAGE'] = 'Görseli indir';
$app_strings['LBL_PREVIEW_IMAGE'] = 'Görsel ön izlemesi';
$app_strings['LBL_UPLOAD_IMAGE_DESCRIPTION'] = 'Bir görsel yüklemek için sürükleyip buraya bırakın ya da tıklayın';
$app_strings['LBL_INVALID_PROCESS_OPTIONS'] = 'Süreç seçenekleri geçersiz. Ayrıntılı bilgi almak için günlük kayıtlarına bakın.';
$app_strings['LBL_TEMPORARY'] = 'Geçici';
$app_strings['LBL_MAX_FILE_SIZE_EXCEEDED'] = 'Dosya izin verilen en büyük boyutu aşıyor.';
$app_strings['LBL_UNSUPPORTED_IMAGE_TYPE'] = 'Görsel türü desteklenmiyor.';
$app_strings['LBL_UNSUPPORTED_FILE_TYPE'] = 'Dosya türü desteklenmiyor.';
$app_strings['LBL_UNSUPPORTED_IMAGE_FILE_TYPE'] = 'Bu görsel türü desteklenmiyor.';
$app_strings['LBL_MALWARE_DETECTED'] = 'Yüklenen dosyada kötü amaçlı yazılım bulundu. Yükleme reddedildi.';

$app_strings['LBL_DEFAULT_OUTBOUND_NOT_SET'] = 'Varsayılan giden e-posta alınamadı';
$app_strings['LBL_SMTP_UNABLE_TO_CONNECT']='Var olan giden e-posta ayarlarıyla SMTP sunucusuna bağlanılamadı.';
$app_strings['LBL_DEFAULT_OUTBOUND_NOT_CONFIGURED'] = 'Giden e-posta hesabı doğru yapılandırılmamış.';

$app_strings['LBL_CRON_UNRECOMMENDED_USER'] = 'Şu anda root olarak çalışıyorsunuz. Bunu yapmanız önerilmez, ilerlemek istiyor musunuz (y,n)? ';
$app_strings['LBL_UNKNOWN_USER'] = 'Kullanıcı bilinmiyor';

$app_strings['LBL_DRAFTS'] = 'Taslaklar';
$app_strings['LBL_DRAFT_ITEM_LAST_MODIFIED'] = '{{fields.date_modified.value}}';
$app_strings['LBL_DRAFT_ITEM_TO_EMPTY'] = 'Alıcı yok';
...
$app_strings['LBL_DRAFTS_DELETED_SUCCESSFULLY'] = 'Taslaklar silindi.';
$app_strings['LBL_DRAFT_DELETED_SUCCESSFULLY'] = 'Taslak silindi.';
$app_strings['LBL_DRAFTS_DELETED_UNSUCCESSFULLY'] = 'Taslaklar silinmedi. Ayrıntılı bilgi almak için günlük kayıtlarına bakın.';
$app_strings['LBL_DRAFT_DELETED_UNSUCCESSFULLY'] = 'Taslak silinmedi. Ayrıntılı bilgi almak için günlük kayıtlarına bakın.';
$app_strings['LBL_OPEN_DRAFT'] = 'Taslağı aç';
$app_strings['LBL_DELETE_DRAFT'] = 'Taslağı sil';
$app_strings['LBL_UNABLE_TO_GET_DRAFT_ID'] = 'Taslak kimliği alınamadı.';
$app_strings['LBL_UNABLE_TO_DELETE_DRAFT'] = 'Taslak silinemedi.';
$app_strings['LBL_EMAIL_NOT_DRAFT'] = 'E-posta artık bir taslak değil.';
$app_strings['LBL_DRAFT_DELETED_SUCCESSFULLY'] = 'Taslak silindi.';
...
$app_strings['LBL_NO_RECORD_ID_PROVIDED'] = 'Silinecek belge sürümü bulunamadı. Kayıt kimliği belirtilmemiş.';
$app_strings['LBL_DELETE_REVISION_CONFIRM'] = 'Bu sürümü silmek istediğinize emin misiniz?';
$app_strings['LBL_DOCUMENT_NOT_FOUND'] = 'Belge bulunamadı.';
$app_strings['LBL_EMAIL_ATTACHMENT_DOCUMENT_DELETED'] = 'Eklenmiş bir ya da birkaç belge silinmiş ve gönderilemez.';

$app_strings['LBL_DISMISS_INVALID_STATUS'] = 'Bu kayıt henüz işlenirken yok sayılamaz.';
$app_strings['LBL_DISMISS_FAILED'] = 'Yok sayılamadı. Lütfen yeniden deneyin.';
$app_strings['LBL_RERUN_NOT_ELIGIBLE'] = 'Bu kayıt yeniden yürütülmeye uygun değil. Sorunlar ile tamamlanmamış olabilir veya yeniden yürütülmesi desteklenmiyor olabilir.';
$app_strings['LBL_RETRY_FAILED_NOT_ELIGIBLE'] = 'Bu kayıt yeniden denenmeye uygun değil. Sorunlar ile tamamlanmamış olabilir veya yeniden denenmesi desteklenmiyor olabilir.';
$app_strings['LBL_ASYNC_TASK_UNSUPPORTED_MODULE'] = 'Bu modül eşitlenmemiş görev işlemlerini desteklemez.';
