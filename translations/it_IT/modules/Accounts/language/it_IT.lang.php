...
$mod_strings = array(
    ...
    'MSG_DUPLICATE' => 'La creazione di questa azienda può potenzialmente creare un duplicato. È possibile selezionare una azienda dalla lista qui sotto, oppure si può cliccare su Salva per continuare la creazione di una nuova azienda con i dati inseriti precedentemente.',
    'MSG_SHOW_DUPLICATES' => 'Creando questa azienda c\'è il rischio di creare un duplicato. Le aziende che contengono nomi simili sono elencate qui sotto.<br>Cliccare Salva per proseguire con la creazione della nuova azienda, oppure cliccare Annulla per ritornare al modulo senza creare la nuova azienda.',
