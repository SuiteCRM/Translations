...
Ultimo tentativo di connessione @ ',
    ...
    // Google Calendar
    'LBL_GOOGLE_AUTH_TITLE' => 'Impostazioni di Sincronizzazione Google',
    'LBL_GOOGLE_CALENDAR_SETTINGS_TITLE' => 'Impostazioni calendario Google',
    'LBL_GOOGLE_CALENDAR_SETTINGS_DESC' => 'Impostazioni di configurazione per regolare il vostro calendario di Google',
    'LBL_GOOGLE_CALENDAR_SETTINGS_JSON' => 'Caricare File credenziali Google API',
    'LBL_GOOGLE_CALENDAR_SETTINGS_JSON_HELP' => 'Caricare il file JSON che è stato scaricato da Console per gli sviluppatori di Google.',
    'LBL_GOOGLE_CALENDAR_GET_API_KEY' => 'Ottenere le credenziali API',
