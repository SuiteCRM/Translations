...
$app_strings = array(
    ...
    'LBL_EMAIL_ACCOUNTS_SMTPDEFAULT' => 'Стандартный',
    ...
    'LBL_EMAIL_OPT_OUT' => 'Кол-во отписок',
    ...
    'LBL_LAST_VIEWED_NO_RESULT' => 'Нет недавно просмотренных элементов',
...
$app_strings['LBL_DAYS_IN_SALE_STAGE'] = 'Эта Сделка была на этом этапе продаж';
...
$app_strings['LBL_TOTAL_CASES_FOR_THIS_ACCOUNT'] = 'Всего обращений для этого аккаунта: ';
$app_strings['LBL_NONE_OUTSTANDING'] = '--не выбрано--';
...
$app_strings['LBL_MULTIPLE_PRIMARY_EMAIL_VALIDATION_ERROR'] = "Только один адрес электронной почты может быть помечен как основной";
$app_strings['LBL_DUPLICATE_EMAIL_VALIDATION_ERROR'] = "Повторяющиеся адреса электронной почты не допускаются";
$app_strings['LBL_NO_PRIMARY_EMAIL_VALIDATION_ERROR'] = "Один адрес электронной почты должен быть помечен как основной";
