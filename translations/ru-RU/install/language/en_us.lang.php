...
$mod_strings = array(
    'LBL_BASIC' => 'Основной',
    'LBL_BASIC_SEARCH' => 'Быстрый фильтр',
    ...
    'LBL_SYSOPTS_ERRS_TITLE' => 'Пожалуйста, исправьте следующие ошибки:',
    ...
    'ERR_CHECKSYS_CALL_TIME' => 'Параметр "Справка по разрешению времени разговора" включен (в php.ini должно быть установлено значение Off)',
    ...
    'ERR_CHECKSYS_JSON_NOT_AVAILABLE' => "Функции, связанные с библиотеками синтаксического анализатора JSON, которые необходимы приложению SuiteCRM, не найдены. Возможно, вам придется раскомментировать расширение в файле php.ini или перекомпилировать с правильным двоичным файлом, в зависимости от вашей версии PHP. Пожалуйста, обратитесь к вашему руководству по PHP для получения дополнительной информации.",
    ...
    'ERR_DB_EXISTS_WITH_CONFIG' => 'База данных с данными конфигурации уже существует. Чтобы запустить установку с выбранной базой данных, повторно запустите установку и выберите: "Удалить и воссоздать существующие таблицы SuiteCRM?". Для обновления используйте мастер обновления в консоли администратора. Прочтите документацию по обновлению, расположенную <a href="https://docs.suitecrm.com/admin/installation-guide/upgrading/" target="_new">здесь</a>.',
    ...
    'ERR_DB_LOGIN_FAILURE_SHORT' => 'Ошибка соединения с базой данных: имя сервера базы данных, имя пользователя и/или пароль неверны.',
    ...
    'ERR_PERFORM_NO_TCPIP' => '<b>Нам не удалось обнаружить подключение к Интернету.</b> Когда подключение все же произойдет, посетите <a href="https://www.suitecrm.com/">https://www.suitecrm.com/</a>, чтобы зарегистрироваться в SuiteCRM. Сообщив нам немного о том, как ваша компания планирует использовать SuiteCRM, мы можем гарантировать, что всегда предоставляем правильное приложение для нужд вашего бизнеса.',
    ...
    'ERR_UPLOAD_MAX_FILESIZE' => 'Предупреждение: конфигурация PHP должна быть изменена, чтобы разрешить загрузку файлов размером не менее 6 МБ.',
    ...
    'LBL_ACCEPT' => 'Я принимаю лицензионное соглашение',
    ...
    'LBL_CHECKSYS_PHP_INI' => 'Расположение вашего файла конфигурации PHP (php.ini):',
    ...
    'LBL_CRON_INSTRUCTIONS_3' => 'Изменения в файл crontab необходимо вносить только после завершения установки системы.',
    'LBL_CRON_CONFIGURATION' => 'CRON CONFIGURATION',
    'LBL_SETUP_CRONTAB' => 'Настройка сrontab',
    ...
    'LBL_DISABLED_DESCRIPTION_2' => 'После внесения этого изменения вы можете нажать кнопку "Пуск" ниже, чтобы начать установку. <i>После завершения установки вы захотите изменить значение для \'installer_locked\' на \'true \'.</i>',
    'LBL_DISABLED_DESCRIPTION_3' => 'После выполнения данных изменений, пожалуйста, повторно перезайдите/перезагрузите эту страницу, чтобы продолжить работу.',
    ...
    'LBL_APP_NOT_INSTALLED' => 'SuiteCRM не установлен. Точка входа требует установки SuiteCRM. Пожалуйста, сперва пройдите процедуру установки SuiteCRM.',
    ...
    'LBL_SILENT_INSTALL_FAILED' => 'Ошибка установки SuiteCRM.',
    ...
    'LBL_LOCALE_NAME_SALUTATION' => 'доц.',
...
$contact_user_link_guid',
    ...
    'CURRENT_LOGO_HELP' => 'Этот логотип отображается в центре экрана входа в приложение SuiteCRM.',
    ...
    'UPLOAD_LOGO' => 'Подождите, логотип загружается...',
    ...
    'ERR_UPLOAD_FILE_UPLOAD_ERR_PARTIAL' => 'Загруженный файл был загружен лишь частично.',
    'ERR_UPLOAD_FILE_UPLOAD_ERR_NO_FILE' => 'Файл не был загружен.',
    'ERR_UPLOAD_FILE_UPLOAD_ERR_NO_TMP_DIR' => 'Отсутствует папка для временных файлов.',
    ...
    'LBL_DBCONFIG_MSG2_LABEL' => 'Хост',
    'LBL_DBCONFIG_MSG2' => 'Имя веб-сервера или компьютера (хоста), на котором расположена база данных (например, www.mydomain.com). При локальной установке по соображениям производительности лучше использовать \'localhost\', чем \'127.0.0.1\'.',
    ...
    'LBL_SYS_CHECK_WARNING' => 'Игнорировать предупреждения проверки системы',
    'LBL_PROCEED' => 'Продолжить',
    'LBL_RECHECK' => 'RECHECK',
    'LBL_CONFIG' => 'НАСТРОЙКА',
    'LBL_VALIDATION_ERRORS' => 'Есть ошибки проверки, невозможно выполнить действие.'
);
