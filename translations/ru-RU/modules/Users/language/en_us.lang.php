...
',
    ...
    'ERR_DELETE_USER' => 'Не разрешается удалять пользователей, вошедших в систему.',
    ...
    'LBL_ADDRESS_STATE' => 'Адрес Штат/регион',
    ...
    'LBL_EXPORT_DELIMITER' => 'Символ разделителя',
    ...
    'LBL_LAYOUT_OPTIONS' => 'Настройка отображения результатов поиска',
    'LBL_SUBTHEMES' => 'Стиль',
    ...
    'LBL_NAVIGATION_PARADIGM_DESCRIPTION' => 'Выберите, чтобы иметь возможность просматривать модули на панели навигации на основе предварительно определенных групп. Если этот параметр выбран, функция "Фильтровать меню по" появится в меню "Еще".',
...
// PROJECT RESOURCES STRINGS
    ...
    'LBL_WIZARD_WELCOME_NOSMTP' => 'Нажмите на кнопку <b>Далее</b> для настройки основных параметров системы, таких как:<br /><br />&bull;&nbsp;Информация о сотруднике.<br />&bull;&nbsp;Параметры отображения даты, времени, валюты, ФИО.<br />&bull;&nbsp;Параметры сервера исходящей почты.<br /><br />',
...
<tr><td><!--not_in_theme!-->Посетите www.suitecrm.com 
<img src=include/images/suitecrm_login.png style="margin-right: 5px;"> 
    ...
    'LBL_CC' => 'Копия',
    'LBL_COMPOSE_MODULE_NAME' => 'Новое письмо',
    ...
    'LBL_REPLY_HEADER_1' => 'Дни повторов',
    ...
    'LBL_COMPOSEEMAIL' => 'Новое письмо' /* for 508 compliance fix */,
    ...
    'LBL_GOOGLE_API_SETTINGS' => 'Синхронизация учетной записи Google',
    'LBL_GOOGLE_API_TOKEN' => 'Google API Token',
    'LBL_GOOGLE_API_TOKEN_HELP' => 'Используйте это, чтобы разрешить SuiteCRM доступ к вашему Календарю Google. Это необходимо для синхронизации. По завершении не забудьте установить флажок "Включить синхронизацию календаря".',
    'LBL_GOOGLE_API_TOKEN_BTN' => 'Get Token',
    'LBL_GSYNC_CAL' => 'Включить синхронизацию календаря',
    // END Google Token/Synchronization settings

    'LNK_LIST_OUTBOUND_EMAIL_ACCOUNTS' => 'Серверы исходящей почты (SMTP)',
