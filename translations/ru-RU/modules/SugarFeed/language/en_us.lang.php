...
$mod_strings = array(
    ...
    'LBL_TIME_AGO' => 'назад',
// Activity stream
    'CREATED_CONTACT' => 'создал(а) <b>НОВЫЙ</b> {0}', // For fusional (inflected) languages: used in the sentence "Administrator created a new contact"
    'CREATED_OPPORTUNITY' => 'создал(а) <b>НОВЫЙ</b> {0}', // For fusional (inflected) languages: used in the sentence "Administrator created a new opportunity"
    'CREATED_CASE' => 'создал(а) <b>НОВЫЙ</b> {0}', // For fusional (inflected) languages: used in the sentence "Administrator created a new case"
    'CREATED_LEAD' => 'создал(а) <b>НОВЫЙ</b> {0}', // For fusional (inflected) languages: used in sentence "Administrator created a new lead"
    'FOR' => 'для', // Activity stream for cases
    'FOR_AMOUNT' => 'на сумму', // Activity stream for cases
