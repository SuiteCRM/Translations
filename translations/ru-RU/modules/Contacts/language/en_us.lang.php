...
$mod_strings = array(
    ...
    'LBL_ID' => 'ID:',
    'LBL_IMPORT_VCARD' => 'Импортировать из vCard',
    ...
    'LNK_NEW_NOTE' => 'Создать примечание',
    ...
    'LBL_LAST_MEETING' => 'Ваше последнее взаимодействие - встреча:',
    'LBL_LAST_CALL' => 'Ваше последнее взаимодействие - звонок:',
    'LBL_LAST_EMAIL' => 'Ваше последнее взаимодействие - отправка электронной почты :',
    'LBL_NO_INTERACTION' => 'Вы еще не взаимодействовали с этим контактом.',
