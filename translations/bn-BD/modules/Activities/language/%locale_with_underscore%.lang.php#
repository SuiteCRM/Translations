...
$mod_strings = array(
    ...
    'LBL_TASKS' => 'কার্য', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
    'LBL_MEETINGS' => 'সভা', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
    'LBL_CALLS' => 'ডাক', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
    'LBL_EMAILS' => 'ই-মেইল', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
    'LBL_NOTES' => 'নোট', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
    'LBL_PRINT' => 'ছাপা', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
    'LBL_MEETING_TYPE' => 'সভা',
    'LBL_CALL_TYPE' => 'ডাক',
    'LBL_EMAIL_TYPE' => 'ই-মেইল',
    'LBL_NOTE_TYPE' => 'নোট',
    'LBL_DATA_TYPE_START' => 'Start:',
    'LBL_DATA_TYPE_SENT' => 'Sent:',
    'LBL_DATA_TYPE_MODIFIED' => 'Modified:',
    'LBL_LIST_CONTACT' => 'যোগাযোগ',
    'LBL_LIST_RELATED_TO' => 'সম্পর্কিত',
    'LBL_LIST_DATE' => 'Date',
    'LBL_LIST_CLOSE' => 'ঘনিষ্ঠ',
    'LBL_SUBJECT' => 'Subject:',
    'LBL_STATUS' => 'স্থিতি:',
    ...
    'LBL_ACCEPT' => 'গ্রহণ করা' /*for 508 compliance fix*/,
);
