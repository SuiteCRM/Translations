...
$mod_strings = array(
    ...
    'ERR_CHECKSYS_PHP_INVALID_VER' => '你安裝的PHP版本不被SuiteCRM支援。你需要安裝一個與SuiteCRM相容的版本。請在Release Notes中參考相容性表格。你的版本是 ',
...
$contact_user_link_guid',
    ...
    'LBL_ALLOW_DEFAULT_SELECTION_HELP' => '選中此選項後，所有使用者都將使用與發送系統通知和警報同一個出站Email帳戶來發送電子郵件。 如果未選中選項，使用者仍然可以提供他們自己的帳戶資訊後，使用出站Email伺服器。',
