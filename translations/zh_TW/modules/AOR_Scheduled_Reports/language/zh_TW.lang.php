...
$mod_strings = array(
    ...
    'LBL_EMAIL_RECIPIENTS' => '電子郵件收件者︰',
    'NTC_DELETE_CONFIRMATION' => '您確定要刪除這些記錄嗎？',
    'LBL_LIST_FORM_TITLE' => '排程報告清單',
    'LBL_MODULE_NAME' => 'DCE 報告',
    'LBL_MODULE_TITLE' => 'DCE 報告',
    'LBL_HOMEPAGE_TITLE' => '我的排程報告',
    'LNK_NEW_RECORD' => '創建排程報告',
    'LNK_LIST' => '查看排程報告',
    'LBL_SEARCH_FORM_TITLE' => '搜尋任務計畫報表',
    'LBL_HISTORY_SUBPANEL_TITLE' => '查看歷史記錄',
    'LBL_NEW_FORM_TITLE' => '新排程報告',
    'LBL_SCHEDULE' => '時間表',
    'LBL_AOR_REPORT_NAME' => '報表',
    'LBL_SCHEDULED_REPORTS_INFORMATION' => 'DCE 報告',
    'LBL_LAST_RUN' => '上一次運行',
    'LBL_STATUS' => '狀態',
);
