...
$mod_strings = array(
    ...
    'LBL_MODULE_NAME' => '入站電子郵件帳戶',
    'LBL_BOUNCE_MODULE_NAME' => '彈回電子郵件處理郵箱',
    'LBL_MODULE_TITLE' => '入站電子郵件帳戶',
    'LBL_NAME' => '名稱',
    'LBL_NONE' => '無',
    ...
    'LBL_TEST_WAIT_MESSAGE' => '請等一會...',
    'LBL_WARN_IMAP_TITLE' => '禁用收件箱',
    'LBL_WARN_IMAP' => '警告:',
    'LBL_WARN_NO_IMAP' => '收件箱功能<b>不能使用</b>如果在編譯PHP的時候未打開IMAPc-client類庫。請聯繫管理員來解決這個問題。',

    'LNK_LIST_CREATE_NEW_PERSONAL' => '新增個人賬戶',
    'LNK_LIST_CREATE_NEW_GROUP' => '新增群組帳戶',
    'LNK_LIST_CREATE_NEW_CASES_TYPE' => '新增案例帳戶',
    'LNK_LIST_CREATE_NEW_BOUNCE' => '新增傳回退信帳戶',
