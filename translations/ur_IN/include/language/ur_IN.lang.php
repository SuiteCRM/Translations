...
//e.g. auf Deutsch 'Contacts'=>'Contakten',
    'language_pack_name' => 'Urdu (India) - ur_IN',
    'moduleList' => array(
        'Home' => 'گھر',
        ...
        'Schedulers' => 'زمان بند',
        'Project' => 'منصوبے',
        'ProjectTask' => 'منصوبہ کے کام',
        'Campaigns' => 'مہمات',
        'CampaignLog' => 'مہم کے لاگ',
        'Documents' => 'دستاویزات',
        ...
        'Trackers' => 'سراغ گیر',
        'TrackerSessions' => 'سراغ گیرکے اجلاس',
        'TrackerQueries' => 'سراغ گیرکی طلبیں',
        'FAQ' => 'اکثر پوچھے گئے سوالات',
        'Newsletters' => 'خبرنامه',
        'SugarFeed' => 'سیوٹ سی آر ایم فیڈ',
        'SugarFavorites' => 'سیوٹ سی آر ایم پسندیدہ',

        'OAuthKeys' => 'OAuth صارف کنجیاں',
        'OAuthTokens' => 'OAuth کے ٹوکن',
        'OAuth2Clients' => 'OAuth صارفین',
        'OAuth2Tokens' => 'OAuth کے ٹوکن',
    ),
...
//       it is the key for the default case_relationship_type_dom value
    ...
    'issue_resolution_dom' => array(
        '' => '',
        'Accepted' => 'تسلیم کیا گیا',
        'Duplicate' => 'نقلی',
        'Closed' => 'بند',
        'Out of Date' => 'تاریخ سے گزر ہوا',
        'Invalid' => 'غلط',
    ),
...
$app_strings = array(
    ...
    'LBL_DELETE_INLINE' => 'ختم کیجیے', /*for 508 compliance fix*/
    'LBL_ID_FF_CLEAR' => 'Clear', /*for 508 compliance fix*/
    'LBL_ID_FF_VCARD' => 'vCard', /*for 508 compliance fix*/
    'LBL_ID_FF_REMOVE' => 'ختم کر دیں', /*for 508 compliance fix*/
    ...
    'LBL_CLOSEINLINE' => 'بند کیجیے',
    'LBL_VIEWINLINE' => 'دیکھیں',
    'LBL_INFOINLINE' => 'Info',
    'LBL_PRINT' => 'پرنٹ کیجیے',
    'LBL_HELP' => 'مدد',
    'LBL_ID_FF_SELECT' => 'منتخب کریں',
    'DEFAULT' => 'BASIC',
    'LBL_SORT' => 'Sort',
    ...
    'LBL_ROUTING_FLAGGED' => 'پرچم لگا ہوا ہے',
    'LBL_ROUTING_TO' => 'کو',
    ...
    'LBL_EMAIL_ACCOUNTS_SUBTITLE' => 'اپنے ای میل اکاؤنٹس سے آنے والے ای میلز کو دیکھنے کیلئے میل اکاؤنٹس کی ترتیب کر لیجیے.',
    'LBL_EMAIL_ACCOUNTS_OUTBOUND_SUBTITLE' => 'میل اکاؤنٹس میں باہر جانے والے ای میل کو استعمال کرنے کے لئے SMTP میل سرور کی معلومات فراہم کر لیجیے.',
    ...
    'LBL_EMAIL_ADDRESS_BOOK_EMAIL_ADDR' => 'ای میل کا پتہ',
    ...
    'LBL_EMAIL_ADDRESS_BOOK_SELECT_TITLE' => 'لینے والے کا ای میل منتخب کرنا',
    ...
    'LBL_EMAIL' => 'ای میل',
    'LBL_EMAIL_ADDRESS_PRIMARY' => 'ای میل کا پتہ',
    ...
    'LBL_EMAIL_ARCHIVE_TO_SUITE' => 'سیوٹ سی آر ایم میں درآمد کیجئے',
    'LBL_EMAIL_ASSIGNMENT' => 'Assignment',
    'LBL_EMAIL_ATTACH_FILE_TO_EMAIL' => 'منسلک کرنا',
    'LBL_EMAIL_ATTACHMENT' => 'منسلک کرنا',
    'LBL_EMAIL_ATTACHMENTS' => 'مقامی نظام سے',
    'LBL_EMAIL_ATTACHMENTS2' => 'سیوٹ سی آر ایم کی دستاویز میں سے',
    'LBL_EMAIL_ATTACHMENTS3' => 'سانچہ منسلک کرنا',
    'LBL_EMAIL_ATTACHMENTS_FILE' => 'فایل',
    'LBL_EMAIL_ATTACHMENTS_DOCUMENT' => 'دستاویز',
    'LBL_EMAIL_BCC' => 'BCC',
    'LBL_EMAIL_CANCEL' => 'منسوخ کیجئے',
    'LBL_EMAIL_CC' => 'CC',
    'LBL_EMAIL_CHARSET' => 'الفاظ کا چناو',
    'LBL_EMAIL_CHECK' => 'ای میل کا جائزہ لیں',
    'LBL_EMAIL_CHECKING_NEW' => 'نئے ای میل کا جائزہ لے رہا ہے',
    'LBL_EMAIL_CHECKING_DESC' => 'ایک لمحے برائے مہربانی... <br><br>اگر یہ میل اکاؤنٹس کی پہلی چیک ہے تو اس میں کچھ وقت لگ سکتا ہے.',
    'LBL_EMAIL_CLOSE' => 'بند کیجیے',
    'LBL_EMAIL_COFFEE_BREAK' => 'ای میل کی جانچ پڑتال ہو رہی ہے. <br><br>بڈے میل اکاؤنٹس کافی وقت لے سکتیں ہیں.',

    'LBL_EMAIL_COMPOSE' => 'ای میل',
    'LBL_EMAIL_COMPOSE_ERR_NO_RECIPIENTS' => 'برائے مہربانی اس ای میل کے لئے وصول کنندہ (س) درج کیجئے.',
    'LBL_EMAIL_COMPOSE_NO_BODY' => 'یہ ای میل اندر سے خالی ہے. کیسے بھی بھیجیں؟',
    'LBL_EMAIL_COMPOSE_NO_SUBJECT' => 'اس ای میل کا کوۂی مضمون نہیں ہے۔ کیسے بھی بھیجیں؟',
    'LBL_EMAIL_COMPOSE_NO_SUBJECT_LITERAL' => '(کوئی عنوان نہیں)',
    'LBL_EMAIL_COMPOSE_INVALID_ADDRESS' => 'براہ کرم، To, CC اور BCC کے شعبوں کے لئے درست ای میل پتہ درج کریں',
    ...
    'LBL_EMAIL_CREATE_NEW' => '--محفوظ کرنے پر بنائیں--',
    'LBL_EMAIL_MULT_GROUP_FOLDER_ACCOUNTS' => 'کثیر',
    'LBL_EMAIL_MULT_GROUP_FOLDER_ACCOUNTS_EMPTY' => 'خالی',
    'LBL_EMAIL_DATE_SENT_BY_SENDER' => 'ارسال کنندہ کی طرف سے بھیجی گئی تاریخ',
    'LBL_EMAIL_DATE_TODAY' => 'آج',
    'LBL_EMAIL_DELETE' => 'ختم کیجیے',
    'LBL_EMAIL_DELETE_CONFIRM' => 'منتخب شدہ پیغامات ختم کریں؟',
    'LBL_EMAIL_DELETE_SUCCESS' => 'ای میل کامیابی سے ختم ہوگئی ہے.',
    'LBL_EMAIL_DELETING_MESSAGE' => 'پیغام ختم کررہا ہے',
    'LBL_EMAIL_DETAILS' => 'تفصیلات',

    'LBL_EMAIL_EDIT_CONTACT_WARN' => 'رابطوں کے ساتھ کام کرنے کے لیے صرف ابتدائی پتہ استعمال کیا جائے گا.',

    'LBL_EMAIL_EMPTYING_TRASH' => 'ٹریش خالی کی جارہی ہے',
    'LBL_EMAIL_DELETING_OUTBOUND' => 'آؤٹ باؤنڈ سرور ختم ہو رہا ہے',
    'LBL_EMAIL_CLEARING_CACHE_FILES' => 'کیشے فائلیں صاف کی جا رہی ہیں',
    ...
    'LBL_EMAIL_ERROR_ADD_GROUP_FOLDER' => 'فولڈر کا نام منفرد ہونا ضروری ہے اور خالی نہیں ہونا چاہیے. دوبارہ کوشش کیجئے.',
    'LBL_EMAIL_ERROR_DELETE_GROUP_FOLDER' => 'فولڈر کو ختم نہیں کر سکتا۔ یا پھر فولڈر یا اسکے بچوں کو ای میل یا اس سے منسلک ایک میل ڈبہ ہے.',
    'LBL_EMAIL_ERROR_CANNOT_FIND_NODE' => 'عبارت سے متعلق مطلوب فولڈر کا تعین نہیں کر سکتا. دوبارہ کوشش کیجئے.',
    ...
    'LBL_EMAIL_DELETE_ERROR_DESC' => 'آپ کو اس جگہ تک رسائی نہیں ہے. رسائی حاصل کرنے کے لئے اپنے سائٹ ایڈمنسٹریٹر سے رابطہ کیجیے.',
    'LBL_EMAIL_ERROR_DUPE_FOLDER_NAME' => 'سیوٹ سی آر ایم فولڈر کے ناموں کا منفرد ہونا ضروری ہے.',
    'LBL_EMAIL_ERROR_EMPTY' => 'برائے مہربانی کچھ تلاش کے معیار درج کر لیجیے.',
    'LBL_EMAIL_ERROR_GENERAL_TITLE' => 'ایک خرابی آگئی ہے',
    'LBL_EMAIL_ERROR_MESSAGE_DELETED' => 'پیغام سرور سے مٹا دیا گیا ہے',
    ...
    'LBL_EMAIL_ERROR_MOVE' => 'اس وقت سرور اور/یا میل اکاؤنٹس کے درمیان منتقل ہونے والی ای میل کی حمایت نہیں کر رہا.',
    'LBL_EMAIL_ERROR_MOVE_TITLE' => 'غلطی کو منتقل کیجئے',
    'LBL_EMAIL_ERROR_NAME' => 'ایک نام کی درکار ہے.',
    ...
    'LBL_EMAIL_ERROR_TIMEOUT' => 'میل سرور کے ساتھ بات چیت کرتے ہوئے ایک خرابی واقع ہوئی ہے.',
    'LBL_EMAIL_ERROR_USER' => 'ایک لاگ ان نام کی درکار ہے.',
    ...
    'LBL_EMAIL_FOLDERS_ADD_DIALOG_TITLE' => 'نئے فولڈر جوڈ لیں',
    'LBL_EMAIL_FOLDERS_RENAME_DIALOG_TITLE' => 'فولڈر کا نیا نام دیں',
    ...
    'LBL_EMAIL_FOLDERS_DELETE_CONFIRM' => 'کیا آپ واقعی یہ فولڈر ختم کرنا چاہتے ہیں؟ \nاور یہ عمل پیچے نہیں کیا جاسکتا.\nاور فولڈر کو ختم کرنے کے تمام موجودہ فولڈرز پر جھرن کریں گے.',
    ...
    'LBL_EMAIL_UPPER_CASE_GROUP' => 'گروہ',
    'LBL_EMAIL_HOME_FOLDER' => 'گھر',
    ...
    'LBL_EMAIL_MENU_CLEAR_CACHE' => 'کیشے فائلیں صاف کریں',
    'LBL_EMAIL_MENU_REMOVE' => 'ختم کر دیں',
    'LBL_EMAIL_MENU_RENAME_FOLDER' => 'فولڈر کا نیا نام دیں',
    'LBL_EMAIL_MENU_RENAMING_FOLDER' => 'فولڈر کو نیا نام دیا جارہا ہے',
    'LBL_EMAIL_MENU_MAKE_SELECTION' => 'اس آپریشن کی کوشش کرنے سے پہلے ایک انتخاب کر لیجیے.',

    'LBL_EMAIL_MENU_HELP_ADD_FOLDER' => 'ایک فولڈر بنائیں (ریموٹ یا سیوٹ سی آر ایم میں)',
    'LBL_EMAIL_MENU_HELP_DELETE_FOLDER' => 'فولڈر کو ختم کریں (ریموٹ یا سیوٹ سی آر ایم میں)',
    ...
    'LBL_EMAIL_MENU_HELP_MARK_UNFLAGGED' => 'ان ای میلز کو غیر نشان زدہ مارک کر لیجیے',
    'LBL_EMAIL_MENU_HELP_RENAME_FOLDER' => 'ایک فولڈر کا نام تبدیل کریں (ریموٹ یا سیوٹ سی آر ایم میں)',

    'LBL_EMAIL_MESSAGES' => 'تبصرے',

    'LBL_EMAIL_ML_NAME' => 'فہرست کا نام',
    'LBL_EMAIL_ML_ADDRESSES_1' => 'منتخب کردہ پتے',
    'LBL_EMAIL_ML_ADDRESSES_2' => 'مجودہ فہرست کا خطاب کرنا',

    'LBL_EMAIL_MULTISELECT' => '<b>Ctrl-Click</b> بہت سارے چننے کے لیے<br />(Mac users use <b>CMD-Click</b>)',

    'LBL_EMAIL_NO' => 'نہيں',
    'LBL_EMAIL_NOT_SENT' => 'نظام آپ کی درخواست پر عملدرآمد کرنے سے قاصر ہے. براہ مہربانی سسٹم منتظم سے رابطہ کر لیجیے.',
    ...
    'LBL_EMAIL_PRIMARY' => 'پہلا',
    'LBL_EMAIL_PRINT' => 'پرنٹ کیجیے',

    'LBL_EMAIL_QC_BUGS' => 'خرابی',
    'LBL_EMAIL_QC_CASES' => 'معاملہ',
    'LBL_EMAIL_QC_LEADS' => 'ممکنہ گاہک',
    'LBL_EMAIL_QC_CONTACTS' => 'رابطہ',
    'LBL_EMAIL_QC_TASKS' => 'کام',
    'LBL_EMAIL_QC_OPPORTUNITIES' => 'موقعہ',
    'LBL_EMAIL_QUICK_CREATE' => 'جلدی سے بنانا',

    'LBL_EMAIL_REBUILDING_FOLDERS' => 'فولڈر کو دوبارہ بنانا',
    'LBL_EMAIL_RELATE_TO' => 'تعلق پیدا کرنا',
    'LBL_EMAIL_VIEW_RELATIONSHIPS' => 'تعلقات دکھائیں',
    'LBL_EMAIL_RECORD' => 'ای میل کو محفوظ کرنا',
    'LBL_EMAIL_REMOVE' => 'ختم کر دیں',
    ...
    'LBL_EMAIL_SETTINGS_FROM_TO_EMAIL_ADDR' => 'ٹیسٹ اطلاع کے لئے ای میل ایڈریس:',
    'LBL_EMAIL_SETTINGS_FROM_ADDR_NOT_SET' => 'From address and/or From name not set',
    'LBL_EMAIL_SETTINGS_FROM_NAME' => 'نام سے',
    'LBL_EMAIL_SETTINGS_REPLY_TO_ADDR' => 'اس ایڈریس کو جواب دیں',
    'LBL_EMAIL_SETTINGS_FULL_SYNC' => 'تمام میل اکاؤنٹس کو سات سات دیکھنا',
    'LBL_EMAIL_TEST_NOTIFICATION_SENT' => 'مہربانی کرکے یہ دیکھنے کے لیے چیک کریں کہ ای میل موصول ہو گۂی تھی تو تصدیق کریں کہ ترتیبات درست ہیں.',
    'LBL_EMAIL_TEST_SEE_FULL_SMTP_LOG' => 'مکمل ایس ایم ٹی پی لوگ کو دیکھیں',
    'LBL_EMAIL_SETTINGS_FULL_SYNC_WARN' => 'مکمل مطابقت پذیریت انجام دیں؟\nاور بڑے میل اکاؤنٹس چند منٹ لے سکتے ہیں.',
    'LBL_EMAIL_SUBSCRIPTION_FOLDER_HELP' => 'ایک سے زیادہ فولڈر منتخب کرنے کیلئے شفٹ کیی یا کنٹرول کیی پر کلک کر لیجیے.',
    'LBL_EMAIL_SETTINGS_GENERAL' => 'جنرل',
    ...
    'LBL_LINK_NONE' => 'کوئی بھی نہیں',
    'LBL_LINK_ALL' => 'سب',
    'LBL_LINK_RECORDS' => 'Records',
    'LBL_LINK_SELECT' => 'منتخب کریں',
    'LBL_LINK_ACTIONS' => 'ACTIONS',
    'LBL_CLOSE_ACTIVITY_HEADER' => 'تصدیق کریں',
    ...
    'ERR_DECIMAL_SEP_EQ_THOUSANDS_SEP' => 'ڈیسیمل الگ الگ ایک جیسے کردار کا استعمال نہیں کرسکتا ہے جیسے ہزاروں الگ الگ ہیں. \\n\\n برائے مہربانی اقدار کو تبدیل کریں.',
    ...
    'ERR_NO_SUCH_FILE' => 'سسٹم میں فایل موجود نہیں ہے',
    'ERR_NO_SINGLE_QUOTE' => 'واحد واوین کے نشان کو استعمال نہیں کر سکتے کہ ',
    'ERR_NOTHING_SELECTED' => 'آگے بڑھنے سے پہلے ایک انتخاب کیجئے.',
    'ERR_SELF_REPORTING' => 'صارف خود کو رپورٹ نہیں کرسکتا یا کرسکتی.',
    'ERR_SQS_NO_MATCH_FIELD' => 'فیلڈ کے لئے کوئی میچ نہیں: ',
    'ERR_SQS_NO_MATCH' => 'کوئی میل نہی',
    'ERR_ADDRESS_KEY_NOT_SPECIFIED' => 'براہ مہربانی میٹا ڈیٹا کی تعریف کے لئے ڈسپلے پرامس کی خصوصیت میں \'کلیدی\' انڈیکس کی وضاحت کیجئے',
    ...
    'ERR_NO_DB' => 'ڈیٹا بیس سے منسلک نہیں ہوسکتا. براہ کرم سوٹ سی آر ایم کو حوالہ دیں۔ لوگ ان تفصیلات کے لئے (0).',
    'ERR_DB_FAIL' => 'ڈیٹابیس کی ناکامی۔ براہ کرم سیوٹ سی آر ایم کو حوالہ دیں۔ لوگ اِن تفصیلات کے لئے.',
    'ERR_DB_VERSION' => 'سیوٹ سی آر ایم {0} فائلوں کو صرف ایک سیوٹ سی آر ایم {1} ڈیٹا بیس کے ساتھ استعمال کیا جا سکتا ہے.',
    ...
    'LBL_ADD_DOCUMENT' => 'دستاویز کو جمع کریں',
    ...
    'LBL_ADDITIONAL_DETAILS_CLOSE_TITLE' => 'منتخب کرنے سے بند کریں',
    'LBL_ADDITIONAL_DETAILS' => 'مزید تفصیلات',
    'LBL_ADMIN' => 'سردار',
    'LBL_ALT_HOT_KEY' => '',
    'LBL_ARCHIVE' => 'محفوظ کریں',
    'LBL_ASSIGNED_TO_USER' => 'مقرر کردہ صارف کو',
    'LBL_ASSIGNED_TO' => 'مقرر کردہ سے:',
    'LBL_BACK' => 'پیچھے',
    'LBL_BILLING_ADDRESS' => 'بلنگ ایڈریس',
    'LBL_QUICK_CREATE' => 'Create ',
    'LBL_BROWSER_TITLE' => 'سویٹ سی آر ایم - اوپن سورس سی آر ایم',
    'LBL_BUGS' => 'مسئلے',
    'LBL_BY' => 'سے',
    'LBL_CALLS' => 'تار',
    ...
    'LBL_CLOSE_BUTTON_TITLE' => 'بند کیجیے',
    ...
    'LBL_SEARCH_DROPDOWN_YES' => 'جی ہاں',
    ...
    'LBL_CREATED_BY_USER' => 'صارف کی طرف سے پیدا کردہ',
    ...
    'LBL_DUPLICATE_BUTTON' => 'نقلی',
    'LBL_DELETE_BUTTON' => 'ختم کیجیے',
    'LBL_DELETE' => 'ختم کیجیے',
    ...
    'LBL_CAMPAIGNS' => 'مہمات',
    'LBL_CAMPAIGNLOG' => 'مہم کے لاگ',
    'LBL_CAMPAIGN_CONTACT' => 'مہمات',
    'LBL_CAMPAIGN_ID' => 'campaign_id',
    'LBL_CAMPAIGN_NONE' => 'کوئی بھی نہیں',
    ...
    'LBL_VERIFY' => 'Verify',
    'LBL_RESEND' => 'Resend',
    'LBL_RECORD_DOES_NOT_EXIST' => 'ریکارڈ کو دوبارہ حاصل کرنے میں خرابی آئی. یہ ریکارڈ ختم ہوسکتا ہے یا آپ اسے دیکھنے کا اختیار نہیں رکھ سکتے ہیں.',
    'LBL_PROFILE' => 'Profile',
    ...
    'LBL_MEETINGS' => 'ملاقاتیں',
    'LBL_MEETING_GO_BACK' => 'Go back to the meeting',
    'LBL_MEMBERS' => 'Members',
    'LBL_MEMBER_OF' => 'Member Of',
    'LBL_MODIFIED_BY_USER' => 'صارف کی طرف سے ترمیم کردہ',
    ...
    'LBL_PRIMARY_ADDRESS_STREET_2' => 'ابتدائی پتہ سڈک 2:',
    'LBL_PRIMARY_ADDRESS_STREET_3' => 'ابتدائی پتہ سڈک 3:',
    'LBL_PRIMARY_ADDRESS_STREET' => 'Primary Address Street:',
    'LBL_PRIMARY_ADDRESS' => 'Primary Address:',

    'LBL_PROSPECTS' => 'Prospects',
    'LBL_PRODUCTS' => 'مصنوعات',
    'LBL_PROJECT_TASKS' => 'منصوبہ کے کام',
    'LBL_PROJECTS' => 'منصوبے',
    ...
    'LNK_PRINT' => 'پرنٹ کیجیے',
    'LNK_BACKTOTOP' => 'Back to top',
    'LNK_REMOVE' => 'ختم کر دیں',
    'LNK_RESUME' => 'Resume',
    ...
    'NTC_DELETE_CONFIRMATION_NUM' => 'کیا آپ واقعی ختم کرنا چاہتے ہیں ',
    ...
    'ERROR_NO_RECORD' => 'ریکارڈ کو دوبارہ حاصل کرنے میں خرابی آئی. یہ ریکارڈ ختم ہوسکتا ہے یا آپ اسے دیکھنے کا اختیار نہیں رکھ سکتے ہیں.',
    ...
    'ERR_CANNOT_FIND_MODULE' => 'غلطی ہے: موڈیول [module] وجود نہی ہے.',
    ...
    'LBL_DASHLET_CONFIGURE_GENERAL' => 'جنرل',
    'LBL_DASHLET_CONFIGURE_FILTERS' => 'فلٹر',
    'LBL_DASHLET_CONFIGURE_MY_ITEMS_ONLY' => 'صرف میری اشیا',
    'LBL_DASHLET_CONFIGURE_TITLE' => 'عنوان، موضع',
    'LBL_DASHLET_CONFIGURE_DISPLAY_ROWS' => 'صفیں دکھائیں',

    // MySugar status strings
    'LBL_MAX_DASHLETS_REACHED' => 'آپ سیوٹ سی آر ایم ڈیشلیٹس کی زیادہ سے زیادہ تعداد تک پہنچ چکے ہیں جو آپ کے منظم نے مقرر کیں ہیں. مزید شامل کرنے کیلئے براہ کرم سویٹ سی آر ایم ڈیشلیٹ کو ہٹا دیں.',
    'LBL_ADDING_DASHLET' => 'سیوٹ سی آر ایم ڈیشلیٹ کو شامل کر رہا ہوں...',
    'LBL_ADDED_DASHLET' => 'سیوٹ سی آر ایم ڈیشلیٹ شامل کر دیا گیا ہے',
    'LBL_REMOVE_DASHLET_CONFIRM' => 'کیا آپ واقعی یہ سیوٹ سی آر ایم ڈیشلیٹ ہٹانا چاہتے ہیں؟',
    'LBL_REMOVING_DASHLET' => 'سویٹ سی آر ایم ڈیشلیٹ کو ہٹا رہے ہیں...',
    'LBL_REMOVED_DASHLET' => 'سیوٹ سی آر ایم ڈیشلیٹ کو ہٹا دیا گیا ہے',
    ...
    'LBL_RELOAD_PAGE' => 'مہربانی کرکے <a href="javascript: window.location.reload()"> ونڈو کو دوبارہ لوڈ کریں اس سیوٹ سی آر ایم کو استعمال کرنے کے لئے.',
    'LBL_ADD_DASHLETS' => 'Add Dashlets',
    'LBL_CLOSE_DASHLETS' => 'بند کیجیے',
    ...
    // fastcgi checks
    'LBL_FASTCGI_LOGGING' => 'IIS / FastCGI SAPI کا استعمال کرتے ہوئے زیادہ سے زیادہ تجربے کے لئے، اپنے php.ini فائل میں fastcgi.logging کو 0 پر مقرر کیجیے.',

    //Collection Field
    'LBL_COLLECTION_NAME' => 'نام',
    'LBL_COLLECTION_PRIMARY' => 'پہلا',
...
"5. Click on the Import option from the Actions menu in the application and choose the file to upload"
   ',
    ...
    'LBL_DUPLICATE_BUTTON_LABEL' => 'نقلی',
    'LBL_DUPLICATE_BUTTON_TITLE' => 'نقلی',
    'LBL_DISABLE_USER_2FA' => 'Disable 2FA',
    'LBL_DELETE_BUTTON_KEY' => 'd',
    'LBL_DELETE_BUTTON_LABEL' => 'ختم کیجیے',
    'LBL_DELETE_BUTTON_TITLE' => 'ختم کیجیے',
    ...
    'LBL_CANCEL_BUTTON_LABEL' => 'منسوخ کیجئے',
    ...
    'LBL_SUITE_DESC3' => 'سیوٹ سی آر ایم سیلز اے گلٹی لمیٹڈ کا ایک تجارتی نشان ہے. تمام دوسری کمپنی اور پروڈکٹ کے نام متعلقہ کمپنیوں کے تجارتی نشان ہو سکتے ہیں جن کے ساتھ وہ منسلک ہیں.',
    'LBL_GENERATE_PASSWORD_BUTTON_TITLE' => 'پاس ورڈ دوبارہ سیٹ کیجیے',
    ...
    'LBL_CONFIRM_OPT_IN_IS_DISABLED' => 'او پی ٹی کی توثیق کریں ای میل بھیجنے میں یہ غیر فعال ہے، ای میل کی ترتیبات میں او پی ٹی آپشن کو فعال کریں یا اپنے منظم سے رابطہ کیجیے.',
    ...
    'LBL_COLUMN_SELECTOR_CLOSE_BUTTON' => 'بند کیجیے',
...
$app_list_strings['moduleList']['EmailAddresses'] = 'ای میل کا پتہ';
...
$app_list_strings['fp_event_status_dom']['Accepted'] = 'تسلیم کیا گیا';
...
//aor
$app_list_strings['moduleList']['AOR_Reports'] = 'شکایات';
...
$app_list_strings['aor_date_type_list']['day'] = 'دن';
...
$app_list_strings['date_time_period_list']['today'] = 'آج';
...
$app_list_strings['aos_quotes_type_dom']['Prospect'] = 'توقع';
$app_list_strings['aos_quotes_type_dom']['Reseller'] = 'دوبارہ بیچنے والا';
...
$app_list_strings['aos_invoices_type_dom']['Prospect'] = 'توقع';
$app_list_strings['aos_invoices_type_dom']['Reseller'] = 'دوبارہ بیچنے والا';
...
$app_list_strings['aow_process_status_list']['Pending'] = 'باقی';
...
$app_list_strings['aow_date_type_list']['day'] = 'دن';
...
$app_list_strings['aow_date_options']['today'] = 'آج';
...
$app_list_strings['duration_unit_dom']['Days'] = 'دن';
...
$app_list_strings['map_module_type_list']['Meetings'] = 'ملاقاتیں';
...
$app_list_strings['map_relate_type_list']['Accounts'] = 'کھاتہ';
...
$app_list_strings['map_relate_type_list']['Opportunities'] = 'موقعہ';
...
$app_list_strings['marker_image_list']['home'] = 'گھر';
...
$app_list_strings['marker_image_list']['monday'] = 'سوموار';
...
$app_list_strings['marker_image_list']['tuesday'] = 'منگلوار';
...
$app_strings['LBL_EDIT_TAB'] = 'ٹیب میں ترمیم کیجیے';
...
$app_list_strings['day_list']['Monday'] = 'سوموار';
$app_list_strings['day_list']['Tuesday'] = 'منگلوار';
...
$app_list_strings['survey_status_list']['Closed'] = 'بند';
...
$app_strings['LBL_OPT_IN_INVALID'] = 'غلط';

/** @see SugarEmailAddress */
$app_list_strings['email_settings_opt_in_dom'] = array(
    'not-opt-in' => 'غیر فعال کیا ہوا',
    'opt-in' => 'میں چنے',
...
$app_strings['LBL_INVALID_EMAIL'] = 'غلط';
$app_strings['LBL_PRIMARY'] = 'پہلا';
$app_strings['LBL_EMAIL_ADDRESS'] = 'ای میل کا پتہ';
...
$app_strings['LBL_SEARCH_TITLE']                   = 'تلاش کیجیے';
$app_strings['LBL_SEARCH_TEXT_FIELD_TITLE_ATTR']   = 'Input Search Criteria';
$app_strings['LBL_SEARCH_SUBMIT_FIELD_TITLE_ATTR'] = 'تلاش کیجیے';
$app_strings['LBL_SEARCH_SUBMIT_FIELD_VALUE']      = 'تلاش کیجیے';
...
$app_strings['LBL_NONE_OUTSTANDING'] = 'کوئی بھی نہیں';
...
$app_strings['AOS_Contracts'] = 'معاہدے';
$app_strings['AOS_Quotes'] = 'حوالہ جات';
$app_strings['AOS_Invoices'] = 'تِجارتی سامان کی فہرِست';
$app_strings['LBL_PHOTO'] = 'تصویر';
...
$app_strings['LBL_YES'] = 'جی ہاں';
$app_strings['LBL_NO'] = 'نہيں';
...
$app_strings['LBL_SAVE'] = 'محفوظ کریں';
...
$app_strings['LBL_MEDIUM'] = 'درمیانہ';
$app_strings['LBL_NORMAL'] = 'عمومی';
...
// Day and Time labels
$app_strings['LBL_SUN'] = 'اتوار';
$app_strings['LBL_MON'] = 'سوموار';
$app_strings['LBL_TUE'] = 'منگلوار';
$app_strings['LBL_WED'] = 'بدھ';
$app_strings['LBL_THU'] = 'جمعرات';
$app_strings['LBL_FRI'] = 'جمعہ';
$app_strings['LBL_SAT'] = 'ہفتہ';
$app_strings['LBL_ALL'] = 'Every Day';
$app_strings['LBL_EVERY'] = 'Every';
$app_strings['LBL_ON_THE'] = 'On the';
$app_strings['LBL_RANGE'] = 'کو';
...
$app_strings['LBL_INBOUND_EMAIL'] = 'اِنباؤنڈ ای میل';
