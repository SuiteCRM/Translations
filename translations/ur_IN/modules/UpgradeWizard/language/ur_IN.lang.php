...
$mod_strings = array(
    ...
    'ERR_UW_CONFIG_WRITE' => 'نئے نسخے کی معلومات کے ساتھ config.php کو اپ ڈیٹ کرنے میں خرابی ہے.',
    ...
    'LBL_UW_TITLE_CANCEL' => 'منسوخ کیجئے',
    ...
    'ERROR_SUITECRM_VERSION_INCOMPATIBLE' => 'اپ لوڈ شدہ فایل سویٹ سی آر ایم کے اس ورژن کے ساتھ مطابقت نہیں رکھتا ہے: ',
