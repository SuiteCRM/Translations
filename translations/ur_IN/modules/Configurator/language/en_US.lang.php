...
$mod_strings = array(
    ...
    'NEW_LOGO_HELP_NO_SPACE' => 'تصویر فایل کا فارمیٹ یا تو. Png یا .jpg ہونا چاہیے. زیادہ سے زیادہ اونچائی 170px ہو، اور زیادہ سے زیادہ چوڑائی 450px ہو. کوۂی بھی بڑی تصویر اپ لوڈ کی گئی ہو یا کہ کسی بھی سمت میں ہو تو اسکے طول و عرض کو چھوٹا کر دیا جائے گا جو آبتایا گیا ہے.',
...
// Wizard
    ...
    'LBL_DELETE' => 'ختم کیجیے' /*for 508 compliance fix*/,
