...
//e.g. auf Deutsch 'Contacts'=>'Contakten',
    ...
    'moduleList' => array(
        ...
        'Connectors' => 'Pengaturan Connector',
        'Roles' => 'Peran',
        ...
        'ACLRoles' => 'Peran',
        'InboundEmail' => 'Akun Email Masuk',
        'Releases' => 'Pers',
        'Prospects' => 'Target',
        'Queues' => 'Antri',
        'EmailMarketing' => 'Email Pemasaran',
...
//       it is the key for the default case_relationship_type_dom value
    ...
    'task_status_dom' => array(
        ...
        'In Progress' => 'Dalam Penyelesaian',
        'Completed' => 'Lengkap',
...
//prospect list type dom
    ...
    'email_marketing_queueing_status_dom' => array(
        ...
        'in_progress' => 'Dalam Penyelesaian',
        'finished' => 'Kembali ke',
    ),
    ...
    'campainglog_activity_type_dom' => array(
        ...
        'link' => 'Klik-thru link',
        'viewed' => 'Pesan yang dilihat',
        'removed' => 'Dihapus',
        'lead' => 'Leads yang Dibuat',
        'contact' => 'Kontak telah dibuat',
...
$app_strings = array(
    'LBL_SEARCH_RESULTS_TITLE' => 'Hasil',
    ...
    'LBL_LOGOUT' => 'Keluar',
    'LBL_LOGOUT_SUCCESS' => 'Berhasil keluar',
    'LBL_LOGGED_OUT_MESSAGE' => 'Anda telah keluar',
    'LBL_LOGIN_AGAIN' => 'Masuk kembali ',
    ...
    'LBL_EMAIL_CHECK' => 'Memeriksa Surat',
    ...
    'LBL_EMAIL_COMPOSE_NO_SUBJECT_LITERAL' => '(Tidak ada subject)',
    ...
    'LBL_EMAIL_DELETE_ERROR_DESC' => 'Anda tidak memiliki akses terhadap area ini. Hubungi administrator untuk mengetahui cara akses terhadap area ini.',
    ...
    'LBL_EMAIL_FOLDERS' => SugarThemeRegistry::current()->getImage('icon_email_folder', 'align=absmiddle border=0', null, null, '.gif', '') . 'Map',
    ...
    'LBL_EMAIL_FOLDERS_ADD_NEW_FOLDER' => 'Simpan [Alt+S]',
    ...
    'LBL_EMAIL_OK' => 'OK',
    'LBL_EMAIL_ONE_MOMENT' => 'Mohon tunggu...',
    ...
    'LBL_EMAIL_QUICK_CREATE' => 'Membuat Cepat',
    ...
    'LBL_EMAIL_SAVE' => 'Simpan [Alt+S]',
    'LBL_EMAIL_SAVE_AND_REPLY' => 'Simpan & Balas',
    'LBL_EMAIL_SAVE_DRAFT' => 'Simpan Konsep [Alt + R]',
    ...
    'ERR_DELETE_RECORD' => 'Nomor Record harus ditentukan untuk menghapus kontak.',
    ...
    'ERR_UNAUTHORIZED_PAGE_ACCESS' => 'Anda tidak diizinkan mengakses halaman ini. Silakan hubungi administrator sistem Anda.',
    'ERR_UNAUTHORIZED_PAGE_ACCESS_TO_HOME_PAGE' => 'Anda tidak diizinkan mengakses halaman ini. Mengarahkan kembali ke Beranda...',
    ...
    'LBL_SUBMIT_BUTTON_LABEL' => 'Kirim',
    'LBL_CASE' => 'Kasus',
    'LBL_CASES' => 'Kasus',
    'LBL_CHANGE_PASSWORD' => 'Ganti kata sandi',
    'LBL_CHARSET' => 'UTF-8',
    'LBL_CHARTS' => 'Bagan',
    'LBL_QUICK_CHARTS' => 'Bagan Cepat',
    'LBL_QUICK_HISTORY' => 'Linimasa',
    'LBL_CHECKALL' => 'Periksa semua',
    'LBL_CITY' => 'Kota',
    ...
    'LBL_OPEN_ITEMS' => 'Buka Item',
    'LBL_COMPOSE_EMAIL_BUTTON_KEY' => 'L',
    'LBL_COMPOSE_EMAIL_BUTTON_LABEL' => 'Tulis Email',
    'LBL_COMPOSE_EMAIL_BUTTON_TITLE' => 'Tulis Email',
    ...
    'LBL_CURRENT_USER_FILTER' => 'Barang-barang Saya',
    ...
    'LBL_EXPORT' => 'Ekspor',
    'LBL_FAVORITES_FILTER' => 'Favorit Saya',
    ...
    'LBL_RECORD_DOES_NOT_EXIST' => 'Error mengakses record.  Record ini mungkin telah dihapus atau Anda tidak memiliki hak akses untuk melihatnya.',
    'LBL_PROFILE' => 'Profil',
    ...
    'LBL_NEW_BUTTON_LABEL' => 'Buat [Alt+N]',
    ...
    'LBL_PRIMARY_ADDRESS_STATE' => 'Alamat negara utama:',
    'LBL_PRIMARY_ADDRESS_STREET_2' => 'Primary Alamat Street 2:',
    'LBL_PRIMARY_ADDRESS_STREET_3' => 'Primary Alamat Street 3:',
    'LBL_PRIMARY_ADDRESS_STREET' => 'Primary Alamat Jalan:',
    'LBL_PRIMARY_ADDRESS' => 'Primary Alamat:',
    ...
    'LBL_MANAGE_SUBSCRIPTIONS' => 'Mengelola Langganan',
    ...
    'LBL_PROCESSING_REQUEST' => 'Memproses...',
    'LBL_REQUEST_PROCESSED' => 'Selesai',
    'LBL_AJAX_FAILURE' => 'Ajax Gagal',
    'LBL_MERGE_DUPLICATES' => 'Gabung',
    ...
    'MSG_JS_ALERT_MTG_REMINDER_NO_EVENT_NAME' => 'Peristiwa',
    ...
    'LBL_DATE_LAST_ACTION' => 'Tanggal Terakhir Aktivitas',
    ...
    // fastcgi checks
    'LBL_FASTCGI_LOGGING' => 'Untuk USI pengalaman yang optimal, set fastcgi.logging ke 0 dalam php.ini file.',
...
"5. Klik pada opsi Impor dari menu tindakan dalam aplikasi dan pilih berkas untuk mengunggah"   ',
    ...
    'LBL_EDIT_BUTTON_LABEL' => 'Ubah',
    'LBL_EDIT_BUTTON_TITLE' => 'Ubah',
    ...
    'LBL_BULK_ACTION_BUTTON_LABEL' => 'Tindakan Massal',
    'LBL_BULK_ACTION_BUTTON_LABEL_MOBILE' => 'Aksi',
    'LBL_TOO_FEW_SELECTED' => 'Jumlah catatan yang dipilih tidak valid. Pilih minimum {min} catatan.',
    'LBL_TOO_MANY_SELECTED' => 'Jumlah catatan yang dipilih tidak valid. Pilih maksimum {max} catatan.',
    'LBL_SELECT_ALL_NOT_ALLOWED' => 'Pemilihan semua catatan tidak tersedia untuk tindakan ini. Pilih catatan individual.',
    'LBL_MISSING_HANDLER_DATA' => 'Kesalahan tidak terduga. Data penanganan tindakan massal hilang dari respons',
    'LBL_MISSING_HANDLER' => 'Kesalahan tidak terduga. Tidak ada penanganan yang ditetapkan untuk tindakan massal terpilih',
    'LBL_MISSING_HANDLER_DATA_ROUTE' => 'Kesalahan tidak terduga. Rute tindakan massal tidak ditemukan',
    'LBL_ACTION_ERROR' => 'Kesalahan tidak terduga saat melakukan tindakan',
    'LBL_BULK_ACTION_ERROR' => 'Kesalahan tidak terduga saat melakukan Tindakan Massal',
    'LBL_BULK_ACTION_DELETE_SUCCESS' => 'Catatan berhasil dihapus',
    'LBL_BULK_ACTION_MASS_UPDATE_CONFIRMATION' => 'Apakah Anda yakin ingin memperbarui catatan yang dipilih?',
    'LBL_BULK_ACTION_MASS_UPDATE_SUCCESS' => 'Semua catatan berhasil diperbarui',
    'LBL_BULK_ACTION_MASS_UPDATE_PARTIAL_SUCCESS' => 'Keberhasilan parsial. Beberapa catatan tidak diperbarui. periksa log',
    'LBL_BULK_ACTION_MASS_UPDATE_NO_FIELDS' => 'Tidak ada bidang untuk diperbarui',
    'LBL_BULK_ACTION_MASS_UPDATE_NO_RECORDS' => 'Tidak ada catatan untuk diperbarui',
    'LBL_BULK_ACTION_MASS_UPDATE_NO_ACLS' => 'Hak Istimewa Tidak Cukup, Penyimpanan tidak diizinkan',
    'LBL_UNEXPECTED_ERROR' => 'Kesalahan tidak terduga. Tidak dapat menyelesaikan tindakan.',
    'LBL_RECORD_DELETE_SUCCESS' => 'Catatan berhasil dihapus',
    'LBL_RECORD_DELETE_ALL_SUCCESS' => 'Records deleted successfully',
    'LBL_RECORD_SNOOZE_SUCCESS' => 'Notification Snoozed',
    'LBL_ERROR_SAVING' => 'Kesalahan terjadi saat menyimpan catatan',
    ...
    'ANNUAL_REVENUE_BY_ACCOUNTS' => 'Pendapatan Tahunan Berdasarkan Akun',
    'PIPELINE_BY_SALES_STAGE' => 'Pipeline Tahap Penjualan',
    'LEADS_BY_SOURCE' => 'Prospek Berdasarkan Sumber',
    'LEADS_BY_STATUS' => 'Prospek Berdasarkan Status',
    'ACCOUNT_TYPES_PER_MONTH' => 'Akun Baru berdasarkan Bulan',
    ...
    'LBL_SUITE_DESC1' => 'SuiteCRM yang telah ditulis dan disusun oleh <a href="https://salesagility.com">SalesAgility</a>. Program ini disediakan sebagaimana adanya, tanpa jaminan. Berlisensi di bawah AGPLv3.',
    ...
    'LBL_SUITE_DESC3' => 'SuiteCRM adalah merek dagang SalesAgility Ltd. Semua nama perusahaan dan produk lain mungkin merupakan merek dagang dari masing-masing perusahaan yang terkait dengannya.',
    ...
    'LBL_PROSPECT_LIST_NAME' => 'Daftar Sasaran',

    //List View Column Selector Modal
    'LBL_COLUMN_SELECTOR_DISPLAYED_COLS' => 'DITAMPILKAN',
    'LBL_COLUMN_SELECTOR_HIDDEN_COLS' => 'DISEMBUNYIKAN',
    'LBL_COLUMN_SELECTOR_CLOSE_BUTTON' => 'Tutup',
    'LBL_COLUMN_SELECTOR_SAVE_BUTTON' => 'Simpan Perubahan',
    'LBL_COLUMN_SELECTOR_MODAL_TITLE' => 'Pilih Kolom',
    ...
    'LBL_ENABLE' => 'Mengaktifkan',
    'LBL_ENABLED' => 'Diaktifkan',
    'LBL_DISABLE' => 'Menonaktifkan',
...
$app_list_strings['aor_scheduled_reports_status_dom']['active'] = 'Email Account Aktif';
$app_list_strings['aor_scheduled_reports_status_dom']['inactive'] = 'Nonaktif';
$app_list_strings['aor_email_type_list']['Email Address'] = 'Surel';
$app_list_strings['aor_email_type_list']['Specify User'] = 'Pemakai';
$app_list_strings['aor_email_type_list']['Users'] = 'Pengguna';
...
$app_list_strings['aos_quotes_type_dom']['Other'] = 'Lain';
...
$app_list_strings['aos_invoices_type_dom']['Other'] = 'Lain';
...
$app_list_strings['contract_status_list']['In Progress'] = 'Dalam Penyelesaian';
...
$app_list_strings['aow_status_list']['Active'] = 'Email Account Aktif';
$app_list_strings['aow_status_list']['Inactive'] = 'Nonaktif';
...
$app_list_strings['aow_email_type_list']['Users'] = 'Pengguna';
$app_list_strings['aow_email_to_list']['to'] = 'Untuk';
...
$app_strings['LBL_SUBPANEL_FILTER_LABEL'] = 'Cari';
...
$app_strings['LBL_OPT_IN_INVALID'] = 'Tidak Valid';
...
$app_strings['LBL_GOOGLE_SYNC_ERR'] = 'Sinkronisasi Google SuiteCRM - KESALAHAN';
...
$app_strings['LBL_OPT_OUT'] = 'Opsi Keluar';
$app_strings['LBL_INVALID_EMAIL'] = 'Tidak Valid';
$app_strings['LBL_PRIMARY'] = 'Utama';
$app_strings['LBL_EMAIL_ADDRESS'] = 'Alamat Surel';
...
$app_strings['LBL_INSIGHTS'] = 'Wawasan';
$app_strings['LBL_CHARTS'] = 'Bagan';
$app_strings['LBL_CHART_NOT_FOUND'] = 'Bagan tidak ditemukan';
$app_strings['LBL_NO_DATA'] = 'Tidak Ada Data';
$app_strings['LBL_ERROR_FETCHING_METADATA'] = 'Terjadi kesalahan saat mengambil metadata';
$app_strings['LBL_TOTAL'] = 'Total';
$app_strings['LBL_ACTIONS'] = 'Aksi';
$app_strings['LBL_SELECT_SUBPANEL_BANNER'] = 'Pilih subpanel yang ingin dilihat';
$app_strings['LBL_SELECT_ITEM'] = 'Pilih item';
$app_strings['LBL_ITEMS_SELECTED'] = 'items selected';
$app_strings['LBL_WIDGET_NOT_FOUND'] = 'Widget tidak ditemukan';
$app_strings['LBL_BAD_CONFIG'] = 'Konfigurasi salah';
$app_strings['LBL_CONFIG_BAD_CONTEXT'] = 'Konfigurasi salah: konteks tidak dikonfigurasi dengan benar';
$app_strings['LBL_CONFIG_NO_CONFIG'] = 'Konfigurasi salah: konfigurasi hilang';
$app_strings['LBL_CONFIG_NO_STATISTICS_KEY'] = 'Konfigurasi salah: kunci statistik hilang';
$app_strings['LBL_STATISTIC_ERROR'] = 'Kesalahan pemuatan statistik';
$app_strings['LBL_STATISTIC_ERROR_DESC'] = 'Kesalahan pemuatan statistik';
$app_strings['LBL_STATISTIC_ERROR_DESC_TOOLTIP'] = 'Kesalahan pemuatan statistik. Hubungi administrator Anda';
$app_strings['LBL_AVERAGE_CLOSED_WON_PER_YEAR'] = 'Kesempatan Menang Rata-rata Per Tahun';
$app_strings['LBL_OPPORTUNITIES_TOTAL'] = 'Nilai Kesempatan Total';
$app_strings['LBL_CASE_TOTAL_DAYS_OPEN'] = 'Total Hari Buka';
$app_strings['LBL_DAYS_OPEN'] = 'Hari Buka';
$app_strings['LBL_DAYS_IN_SALE_STAGE'] = 'DAY(S) THIS OPPORTUNITY HAS BEEN AT THIS SALES STAGE';
$app_strings['LBL_STAT_DAYS'] = 'Hari';
$app_strings['LBL_CLOSED_PER_YEAR'] = 'Tutup Per Tahun';
$app_strings['LBL_WAS_OPEN'] = 'Kasus ini Dibuka Selama';
$app_strings['LBL_HAS_BEEN_OPEN'] = 'Kasus ini telah Dibuka Selama';
$app_strings['LBL_NUMBER_OF_CASES_PER_ACCOUNT'] = 'Jumlah Kasus Per Akun';
$app_strings['LBL_TOTAL_CASES_FOR_THIS_ACCOUNT'] = 'Total Cases For This Account';
$app_strings['LBL_NONE_OUTSTANDING'] = 'Tidak ada';
$app_strings['LBL_VALIDATION_ERROR_REQUIRED'] = 'Bidang wajib diisi tidak ada: {{fields.field.label}}';
$app_strings['LBL_VALIDATION_ERROR_CURRENCY_FORMAT'] = "Format mata uang tidak valid. Diharapkan: '{{context.expected}}'";
$app_strings['LBL_VALIDATION_ERROR_INT_FORMAT'] = "Format int tidak valid. Diharapkan: '{{context.expected}}'";
$app_strings['LBL_VALIDATION_ERROR_FLOAT_FORMAT'] = "Format mengambang tidak valid. Diharapkan: '{{context.expected}}'";
$app_strings['LBL_VALIDATION_ERROR_DATE_FORMAT'] = "Format tanggal tidak valid. Diharapkan: '{{context.expected}}'";
$app_strings['LBL_VALIDATION_ERROR_DATETIME_FORMAT'] = "Format tanggalwaktu tidak valid. Diharapkan: '{{context.expected}}'";
...
$app_strings['LBL_VALIDATION_ERROR_EMAIL_FORMAT'] = "Format email tidak valid. Diharapkan: '{{context.expected}}'";
$app_strings['LBL_VALIDATION_ERROR_PHONE_FORMAT'] = "Format telepon tidak valid.";
$app_strings['LBL_VALIDATION_ERROR_MIN'] = "Nilai tidak valid. Nilai harus lebih besar atau sama dengan '{{context.min}}'";
$app_strings['LBL_VALIDATION_ERROR_MAX'] = "Nilai tidak valid. Nilai harus lebih kecil atau sama dengan '{{context.max}}'";
$app_strings['LBL_MULTIPLE_PRIMARY_EMAIL_VALIDATION_ERROR'] = "Only one Valid Email Address should be marked as primary";
$app_strings['LBL_DUPLICATE_EMAIL_VALIDATION_ERROR'] = "Alamat email duplikat tidak diizinkan";
...
$app_strings['LBL_VALIDATION_ERRORS'] = 'Terjadi kesalahan validasi, tidak dapat menyelesaikan tindakan.';
...
$app_strings['LBL_TYPE_TO_SEARCH'] = 'Ketik untuk mencari...';
$app_strings['LBL_SEARCHING'] = 'mencari...';
$app_strings['LBL_NOT_FOUND'] = 'Tidak ditemukan.';
$app_strings['LBL_SEARCH_ERROR'] = 'Kesalahan dalam pencarian.';
$app_strings['LBL_FOUND'] = 'Ditemukan';
$app_strings['LBL_GET_RECORD_LIST_ERROR'] = 'Terjadi kesalahan saat mengambil catatan';
$app_strings['LBL_NUMBER_OF_RECORDS'] = 'Jumlah Catatan';
...
$app_strings['LBL_CONTRACT_RENEWAL_TOOLTIP'] = 'Tanggal Pembaruan Kontrak berikutnya';
$app_strings['LBL_INVOICES_OVERDUE_TOOLTIP'] = 'Total Faktur Terlambat';
$app_strings['LBL_ACTIVITIES_NEXT_DATE_TOOLTIP'] = 'Tanggal interaksi berikutnya';
$app_strings['LBL_CAMPAIGN_LAST_RECEIVED_TOOLTIP'] = 'Tanggal Kampanye diterima terbaru';
$app_strings['LBL_OPEN_CASES_COUNT_TOOLTIP'] = 'Total Kasus Dibuka';
$app_strings['LBL_EVENTS_LAST_DATE_TOOLTIP'] = 'Tanggal Acara terbaru';
$app_strings['LBL_HISTORY_LAST_DATE_TOOLTIP'] = 'Tanggal interaksi terbaru';
$app_strings['LBL_OPPORTUNITIES_TOTAL_SUM_TOOLTIP'] = 'Subtotal Kesempatan';
$app_strings['LBL_QUOTES_EXPIRY_TOOLTIP'] = 'Tanggal Batas Waktu Penawaran berikutnya';
$app_strings['LBL_DEFAULT_TOTAL_TOOLTIP'] = 'Total catatan';
$app_strings['LBL_CONTRACT_RENEWAL'] = 'Tanggal Pembaruan';
$app_strings['LBL_INVOICES_OVERDUE'] = 'Total Terlambat';
$app_strings['LBL_ACTIVITIES_NEXT_DATE'] = 'Tanggal Aktifitas Berikutnya';
$app_strings['LBL_CAMPAIGN_LAST_RECEIVED'] = 'Partisipasi Terakhir';
$app_strings['LBL_OPEN_CASES_COUNT'] = 'Kasus Terbuka';
$app_strings['LBL_EVENTS_LAST_DATE'] = 'Acara Dihadiri Terakhir';
$app_strings['LBL_HISTORY_LAST_DATE'] = 'Titiksentuh Terakhir';
$app_strings['LBL_OPPORTUNITIES_TOTAL_SUM'] = 'Nilai Total';
$app_strings['LBL_QUOTES_EXPIRY'] = 'Tanggal Kedaluwarsa Berikutnya';
$app_strings['LBL_DEFAULT_TOTAL'] = 'Total';
$app_strings['AOS_Contracts'] = 'Kontrak';
$app_strings['AOS_Quotes'] = 'Penawaran';
$app_strings['AOS_Invoices'] = 'Faktur';
$app_strings['LBL_PHOTO'] = 'Foto';
$app_strings['LBL_CASE_UPDATES'] = 'Pembaharuan Kasus';
$app_strings['LBL_CASE_UPDATE_SUBMITTED'] = 'Pembaruan Kasus Dikirim';
...
$app_strings['LBL_CREATE'] = 'Buat [Alt+N]';
$app_strings['LBL_CLEAR_FILTER'] = 'Hapus Filter';
$app_strings['LBL_QUICK_FILTERS'] = 'Filter Cepat';
$app_strings['LBL_SAVED_FILTER_SAVED'] = 'Filter berhasil disimpan';
$app_strings['LBL_FILTER_ID_NOT_DEFINED'] = 'Id filter tidak ditentukan';
$app_strings['LBL_GENERIC_CONFIRMATION'] = 'Apakah Anda ingin melanjutkan tindakan ini?';
$app_strings['LBL_SHOW_MORE'] = 'Tampilkan lebih banyak';
$app_strings['LBL_SHOW_LESS'] = 'Tampilkan lebih sedikit';
$app_strings['LBL_LOAD_MORE'] = 'Muat lebih banyak';
$app_strings['LBL_EMPTY'] = '-- Empty --';
$app_strings['LBL_OPERATOR'] = 'Petugas';
$app_strings['LBL_START'] = 'Mulai';
$app_strings['LBL_END'] = 'Akhir';
$app_strings['LBL_LINE_ITEMS_FIELD_CONFIG'] = 'Konfigurasi buruk';


$app_strings['LBL_ACTION_SUCCESS'] = 'Tindakan berhasil';

$app_strings['LBL_YES'] = 'Ya';
$app_strings['LBL_NO'] = 'Tidak';

$app_list_strings['sort_order'] = [];
$app_list_strings['sort_order']['asc'] = 'Naik';
$app_list_strings['sort_order']['desc'] = 'Turun';

// Labels used by subpanel unlink relationship process
$app_strings['LBL_LINK'] = 'Tautan';
$app_strings['LBL_LINK_UNLINK'] = 'Link / Unlink';
$app_strings['LBL_SAVE'] = 'Simpan [Alt+S]';
$app_strings['LBL_UNLINK_RECORD'] = 'Batalkan tautan Catatan';
$app_strings['LBL_EDIT_RECORD'] = 'Edit Catatan';
$app_strings['LBL_UNLINK_RELATIONSHIP_CONFIRM'] = 'Apakah Anda yakin ingin melepas tautan rekaman? Hanya tautan hubungan yang akan dilepas. Catatan tidak akan dihapus.';
$app_strings['LBL_UNLINK_RELATIONSHIP_SUCCESS'] = 'Pelepasan tautan catatan berhasil.';
$app_strings['LBL_UNLINK_RELATIONSHIP_FAILED'] = 'Terjadi kesalahan saat melepas tautan catatan.';
...
$app_strings['LBL_LINK_RELATIONSHIP_SUCCESS'] = 'Penautan hubungan berhasil.';
$app_strings['LBL_LINK_RELATIONSHIP_FAILED'] = 'Terjadi kesalahan saat menautkan Hubungan.';
$app_strings['LBL_MODULE_NOT_FOUND'] = 'Modul tidak ditemukan.';
$app_strings['LBL_RECORD_NOT_FOUND'] = 'Tidak dapat memuat catatan';
$app_strings['LBL_RELATIONSHIP_LOAD_ERROR'] = 'Tidak dapat memuat hubungan';
$app_strings['LBL_NOT_LINKED'] = 'Tidak dapat melepas tautan. Catatan tidak ditautkan';
$app_strings['LBL_ACCESS_DENIED'] = 'Akses Ditolak';
$app_strings['LBL_ADD_RECORDS_TO_TARGET_LIST_SUCCESS'] = 'Catatan berhasil ditambahkan ke daftar target.';
$app_strings['LBL_ADD_RECORDS_TO_TARGET_LIST_FAILED'] = 'Terjadi kesalahan saat menambahkan catatan ke daftar target.';
$app_strings['LBL_ADD_CONTACTS_TO_TARGET_LIST_SUCCESS'] = 'Kontak berhasil ditambahkan ke daftar target.';
$app_strings['LBL_ADD_CONTACTS_TO_TARGET_LIST_FAILED'] = 'Terjadi kesalahan saat menambahkan kontak ke daftar target.';
$app_strings['LBL_CHANGED_TO_TEXT'] = 'diubah menjadi';
$app_strings['LBL_RECORD_CHANGED'] = 'Catatan Diperbarui';
$app_strings['LBL_CREATE'] = "Buat [Alt+N]";
$app_strings['LBL_USE_ADVANCED_SEARCH'] = 'Gunakan Pencarian Lanjutan';
$app_strings['LBL_USE_BASIC_SEARCH'] = 'Gunakan Pencarian Dasar';
$app_strings['LBL_NO_MODULE_SELECTED'] = 'Tidak ada modul yang dipilih';
$app_strings['LBL_CLOSE_MENU'] = 'Tutup Menu';
$app_strings['LOGIN_INCORRECT'] = 'Kredensial masuk salah, coba lagi.';
$app_strings['LOGIN_TOO_MANY_FAILED'] = 'Terlalu banyak upaya login gagal, coba lagi dalam beberapa menit.';
...
$app_strings['LBL_RELATED_TO'] = 'Terkait Dengan';
...
$app_strings['LBL_BOLD'] = 'Tebal';
$app_strings['LBL_ITALIC'] = 'Miring';
...
$app_strings['LBL_QUOTE'] = 'Kutipan';
$app_strings['LBL_UNQUOTE'] = 'Unquote';
$app_strings['LBL_ALIGN_LEFT'] = 'Ke Kiri';
$app_strings['LBL_ALIGN_CENTER'] = 'Center';
$app_strings['LBL_ALIGN_RIGHT'] = 'Kanan';
...
// Day and Time labels
$app_strings['LBL_SUN'] = 'Minggu';
$app_strings['LBL_MON'] = 'Senin';
$app_strings['LBL_TUE'] = 'Selasa';
$app_strings['LBL_WED'] = 'Rabu';
$app_strings['LBL_THU'] = 'Kamis';
$app_strings['LBL_FRI'] = 'Jum\'at';
$app_strings['LBL_SAT'] = 'Sabtu';
$app_strings['LBL_ALL'] = 'Setiap Hari';
$app_strings['LBL_EVERY'] = 'Setiap';
$app_strings['LBL_ON_THE'] = 'berada di';
$app_strings['LBL_RANGE'] = 'Ke';
$app_strings['LBL_FROM'] = 'Dari';
$app_strings['LBL_AND'] = 'dan';
$app_strings['LBL_MINS'] = 'Menit';
$app_strings['LBL_MINUTES'] = 'Menit';
$app_strings['LBL_HOUR'] = 'Jam';
$app_strings['LBL_HOUR_SING'] = 'Jam';
$app_strings['LBL_OFTEN'] = 'Sesering mungkin';
$app_strings['LBL_MIN_MARK'] = ' tanda menit';
$app_strings['LBL_INBOUND_EMAIL'] = 'Email Masuk';
...
$app_strings['LBL_CAMPAIGN_SETTINGS'] = 'Pengaturan';
...
$app_strings['LBL_INACTIVE'] = 'Nonaktif';
...
$app_strings['LBL_UPLOAD'] = 'Meng-upload';
