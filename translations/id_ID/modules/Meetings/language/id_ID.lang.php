...
$mod_strings = array(
    ...
    'LBL_DEFAULT_SUBPANEL_TITLE' => 'Rapat',
    ...
    'LBL_MEETING_INFORMATION' => 'Informasi account', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
