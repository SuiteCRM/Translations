...
$mod_strings = array(
    ...
    'help' => array(
        ...
        'studioWizard' => array(
            ...
            'layoutsBtn' => 'Customise the module <b>Layouts</b>. The layouts are the different views of the module containing fields.<br><br>You can determine which fields appear and how they are organised in each layout.',
            'subpanelBtn' => 'Determine which fields appear in the <b>Subpanels</b> in the module.',
            'portalBtn' => 'Customse the module <b>Layouts</b> that appear in the <b>SuiteCRM Portal</b>.',
            ...
            'viewBtnDashlet' => 'Customise the module\'s <b>SuiteCRM Dashlet</b>, including the SuiteCRM Dashlet\'s ListView and Search.<br><br>The SuiteCRM Dashlet will be available to add to the pages in the Home module.',
            ...
            'dashletHelp' => 'The <b>SuiteCRM Dashlet</b> layouts that can be customised appear here.<br><br>The SuiteCRM Dashlet will be available to add to the pages in the Home module.',
            ...
            'BasicSearchBtn' => 'Customise the <b>Quick Filter</b> form that appears in the Quick Filter tab in the Search area for the module.',
            'AdvancedSearchBtn' => 'Customise the <b>Advanced Filter</b> form that appears in the Advanced Search tab in the Search area for the module.',
            'portalHelp' => 'Manage and customise the <b>SuiteCRM Portal</b>.',
            ...
            'Layouts' => 'Customise the <b>Layouts</b> of the SuiteCRM Portal modules.',
        ...
        'portalStyle' => array(
            'default' => 'You can customise the look of the SuiteCRM Portal by using a style sheet.<br><br>Select a <b>Style Sheet</b> to upload.<br><br>The style sheet will be implemented in the SuiteCRM Portal the next time a sync is performed.',
        ),
    ),
...
//EXPORT CUSTOMS
    ...
    'LBL_EC_VIEWS' => 'customised view(s)',
    'LBL_EC_SUITEFEEDS' => 'customised feed(s)',
    'LBL_EC_DASHLETS' => 'customised Dashlet(s)',
    'LBL_EC_CSS' => 'customised css(s)',
    'LBL_EC_TPLS' => 'customised tpls(s)',
    'LBL_EC_IMAGES' => 'customised image(s)',
    'LBL_EC_JS' => 'customised js(s)',
    'LBL_EC_QTIP' => 'customised qtip(s)',
