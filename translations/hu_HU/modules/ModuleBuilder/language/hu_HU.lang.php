...
$mod_strings = array(
    ...
    'help' => array(
        ...
        'studioWizard' => array(
            ...
            'mbHelp' => 'Használja a <b>Modul Bildert</b> egyedi csomagok létrehozására, melyek standard vagy egyedi tárgyakon alapulnak.',
            'viewBtnEditView' => 'A modul Szerkesztő Nézet elrendezésének testreszabása.',
            'viewBtnDetailView' => 'A modul Megtekintés-nézet elrendezés testreszabása.<br />Ez a Nézet jeleníti meg a felhasználó által bevitt mező adatot.',
        ...
        'labelsHelp' => array(
            ...
            'saveBtn' => 'Kattintson a <b>mentés</b> gombra a változtatások elmentéséhez.',
    ...
    'assistantHelp' => array(
        ...
        'studioWizard' => array(
            ...
            'subpanelHelp' => 'Válasszon ki egy <b>Alpanelt</b> szerkesztésre.',
            'searchHelp' => 'Válasszon ki egy <b>Keresési</b> nézetet szerkesztésre.',
            'newPackage' => 'Kattintosn az Új Csomagra az új csomag létrehozásához.',
...
//HOME
    'LBL_HOME_EDIT_DROPDOWNS' => 'Lenyíló lista szerkesztő',

//STUDIO2
    'LBL_MODULEBUILDER' => 'Modulépítő',
    'LBL_STUDIO' => 'Stúdió',
    'LBL_DROPDOWNEDITOR' => 'Lenyíló lista szerkesztő',
    'LBL_DEVELOPER_TOOLS' => 'Stúdió',
    'LBL_SUITEPORTAL' => 'SuiteCRM portálszerkesztő',
    ...
    'LBL_DASHLETLISTVIEW' => 'SuiteCRM vezérlőelem lista-nézet',
    'LBL_POPUP' => 'Legördülő Lista-nézet',
    'LBL_POPUPLISTVIEW' => 'Legördülő Lista-nézet',
    'LBL_POPUPSEARCH' => 'Legördülő keresés-nézet',
    'LBL_DASHLETSEARCHVIEW' => 'SuiteCRM vezérlőelem keresés-nézet',
    ...
    'LBL_SUBPANEL_TITLE' => 'Megnevezés:',
    'LBL_SEARCH_FORMS' => 'Keresés-nézet',
    'LBL_SEARCH' => 'Keresés',
    ...
    'LBL_TABDEF_TYPE_HELP' => 'Válassza ki, hogy ez a rész hogyan jelenjen meg. Ennek az opciónak csak akkor lesz ereményes, ha engedélyezte a füleket ebben a nézetben.',
    ...
    'LBL_DROPDOWN_LANGUAGE' => 'Alapértelmezett Nyelv',
    'LBL_DROPDOWN_ITEMS' => 'Lista elemek',
    'LBL_DROPDOWN_ITEM_NAME' => 'Elem neve',
    'LBL_DROPDOWN_ITEM_LABEL' => 'Címke megjelenítése',
    'LBL_SYNC_TO_DETAILVIEW' => 'Megtekintés-nézet szinkronizálása',
    ...
    'LBL_DROPDOWN_KEY_EXISTS' => 'Kulcs már létezik a listában',
...
//BUTTONS
    ...
    'LBL_BTN_RENAME_MODULE' => 'Modul név módosítása',
//TABS
...
//PACKAGE AND MODULE BUILDER
    ...
    'LBL_HISTORY' => 'Előzmény Megtekintése',
...
//EXPORT CUSTOMS
    ...
    'LBL_EC_EXPORTBTN' => 'Exportálás',
    'LBL_MODULE_DEPLOYED' => 'A modul bevezetésre került.',
    'LBL_UNDEFINED' => 'nem definiált',
    'LBL_EC_VIEWS' => 'egyéni nézet(ek)',
    'LBL_EC_SUITEFEEDS' => 'customized Feed(s)',
    'LBL_EC_DASHLETS' => 'customized Dashlet(s)',
    'LBL_EC_CSS' => 'egyedi css',
    'LBL_EC_TPLS' => 'egyedi tpls',
    'LBL_EC_IMAGES' => 'egyedi kép',
    'LBL_EC_JS' => 'egyedi js',
    'LBL_EC_QTIP' => 'egyedi qtip',
...
//AJAX STATUS
    ...
    'LBL_AJAX_RESPONSE_TITLE' => 'Eredmény',
    'LBL_AJAX_RESPONSE_MESSAGE' => 'Ez a művelet sikeresen befejeződött',
    'LBL_AJAX_LOADING_TITLE' => 'Folyamatban..',
    'LBL_AJAX_LOADING_MESSAGE' => 'Kérjük várjon, betöltés..',
...
//POPUP HELP
    ...
    'LBL_POPHELP_IMPORTABLE' => '<b>Igen</b>: A mező az import művelet része lesz.<br><b>Nem</b>: A mező nem lesz az import művelet része.<br><b>Szükséges</b>: A mezőnek értéket kell adni bármilyen import művelethez.',
    'LBL_POPHELP_IMAGE_WIDTH' => 'Adja meg a Szélesség adatát pixelben mérve.<br> A feltöltött képeket erre a szélességre méretezzük.',
    'LBL_POPHELP_IMAGE_HEIGHT' => 'Adja meg a magasság adatát pixelben mérve.<br> A feltöltött képeket erre a magasságra méretezzük.',
    'LBL_POPHELP_DUPLICATE_MERGE' => '<b>Engedélyezve</b>: Ez a mező az Ismétlődések Összefésülése funkciónál jelenik meg, nem használható az Ismétlődések Keresése funkcióban szűrőfeltételként.<br><b>Letiltva</b>: Ez a mező az Ismétlődések Összefésülése funkciónál nem jelenik meg, nem használható az Ismétlődések Keresése funkcióban szűrőfeltételként.',
...
//Revert Module labels
    ...
    'fieldTypes' => array(
        ...
        'phone' => 'Telefon:',
        'currency' => 'Pénznem',
        'html' => 'Csak olvasható HTML (nem fejlesztett, használjon TextBlock-ot)',
        'radioenum' => 'Rádiógomb',
        'relate' => 'Összekapcsol',
        'address' => 'Cím:',
        'text' => 'Szövegterület',
    ...
    'labelTypes' => array(
        "frequently_used" => "Gyakran használt címkék",
        "all" => "minden címke",
    ),
