...
$mod_strings = array(
    ...
    'ERR_CHECKSYS_CONFIG_NOT_WRITABLE' => 'A konfigurációs fájl nem írható. Kérjük, ellenőrizze a fájljogosultságokat.',
    'ERR_CHECKSYS_CONFIG_NOT_FOUND' => 'Nincs config.php fájl. A telepítő automatikusan létrehozza majd.',
    'ERR_CHECKSYS_CONFIG_OVERRIDE_NOT_WRITABLE' => 'A felülíró konfigurációs fájl létezik, de nem írható. Kérjük, tegye meg a szükséges lépéseket a fájl írhatóvá tételéhez.',
    'ERR_CHECKSYS_CUSTOM_NOT_WRITABLE' => 'A Custom könyvtár nem írható. Kérjük, módosítsa a jogosultságokat a folytatáshoz.',
    'ERR_CHECKSYS_FILES_NOT_WRITABLE' => "A listázott fájlok/mappák nem írhatók vagy hiányoznak. Kérjük, biztosítson írási jogosultságot a könyvtárakhoz.",
    'ERR_CHECKSYS_LOGS_NOT_WRITABLE' => 'A Logs könyvtár nem írható',
    'ERR_CHECKSYS_CACHE_NOT_WRITABLE' => 'A Cache könyvtár nem írható',
    'ERR_CHECKSYS_EXTENSIONS_NOT_WRITABLE' => 'Az Extensions könyvtár nem írható',
    'ERR_CHECKSYS_ROOT_NOT_WRITABLE' => 'The Root Directory is currently not writable. You will not be able to proceed with install.',
    'ERR_CHECKSYS_SECRETS_NOT_WRITABLE' => 'A config/secrets mappa jelenleg nem írható',
    'ERR_CHECKSYS_ENV_NOT_WRITABLE' => 'A .env fájl vagy a mappa, amelyben található, nem írható.',
    ...
    'LBL_CHECKSYS_LEGACY_CACHE' => 'Írható legacy gyorsítótár-alkönyvtárak',
    'LBL_CHECKSYS_CACHE' => 'Írható cache alkönyvtárak',
    'LBL_CHECKSYS_EXTENSIONS' => 'Extensions könyvtár írhatósága',
    'LBL_CHECKSYS_SECRETS' => 'Írható config/secrets mappa',
    'LBL_CHECKSYS_LOGS' => 'Log könyvtár írhatósága',
    ...
    'LBL_CHECKSYS_ENV' => 'Írható .env fájl',
    ...
    'LBL_CHECKSYS_INTL_EXTENSIONS' => 'Az Intl megtalálható a bővítmények között',
    'LBL_CHECKSYS_JSON_EXTENSIONS' => 'A Json megtalálható a bővítmények között',
    'LBL_CHECKSYS_GD_EXTENSIONS' => 'A GD megtalálható a bővítmények között',
    'LBL_CHECKSYS_OPENSSL_EXTENSIONS' => 'Az OpenSSL megtalálható a bővítmények között',
    'LBL_CHECKSYS_ZIP_EXTENSIONS' => 'A Zip megtalálható a bővítmények között',
    'LBL_CHECKSYS_PDO_MYSQL_EXTENSIONS' => 'A PDO MySQL megtalálható a bővítmények között',
    'LBL_CHECKSYS_CURL_EXTENSIONS' => 'A cURL megtalálható a bővítmények között',
    'LBL_CHECKSYS_MBSTRING_EXTENSIONS' => 'Az MB Strings megtalálható a bővítmények között
',
    'LBL_CHECKSYS_MYSQLI_EXTENSIONS' => 'A MySQLi megtalálható a bővítmények között',
    'LBL_CHECKSYS_SOAP_EXTENSIONS' => 'A Soap megtalálható a bővítmények között',
    'LBL_CHECKSYS_XML_EXTENSIONS' => 'Az XML megtalálható a bővítmények között',
    'LBL_CHECKSYS_IMAP_EXTENSIONS' => 'Az IMAP megtalálható a bővítmények között (Opcionális)',
    'LBL_CHECKSYS_LDAP_EXTENSIONS' => 'Az LDAP megtalálható a bővítmények között (Opcionális)',
    'LBL_PHP_CHECKS' => 'PHP ELLENŐRZÉSEK',
    'LBL_SERVER_CHECKS' => 'SZERVER ELLENŐRZÉSEK',
    'LBL_PERMISSION_CHECKS' => 'ENGEDÉLYEK ELLENŐRZÉSE',
    'LBL_CHECK_FAILED' => 'Sikertelen ellenőrzés: ',
    'ERR_CHECKSYS_INTL' => 'Az Intl bővítmény nincs telepítve, kérjük, vegye fel a kapcsolatot a rendszergazdával.',
    'ERR_CHECKSYS_JSON' => 'A JSON bővítmény nincs engedélyezve, kérjük, vegye fel a kapcsolatot a rendszergazdával.',
    'ERR_CHECKSYS_GD' => 'A GD bővítmény nincs engedélyezve, kérjük, vegye fel a kapcsolatot a rendszergazdával.',
    'ERR_CHECKSYS_OPENSSL' => 'Az OpenSSL kiterjesztés nincs bekapcsolva, kérjük, forduljon a rendszergazdához.',
    'ERR_CHECKSYS_PDO_MYSQL' => 'A PDO MySQL bővítmény nincs engedélyezve, kérem lépjen kapcsolatba a rendszergazdával.',
    'ERR_CHECKSYS_MYSQLI' => 'A MySQLi bővítmény nincs engedélyezve, kérem lépjen kapcsolatba a rendszergazdábal.',
    'ERR_CHECKSYS_SOAP' => 'A Soap bővítmény nincs engedélyezve, kérem lépjen kapcsolatba a rendszergazával.',
    ...
    'LBL_ERROR_DETAILS' => 'Hiba részletei',
    'LBL_ERROR' => 'Hiba',
    ...
    'LBL_SETUP_CRONTAB' => 'A Crontab beállításához',
    ...
    'LBL_DBCONF_DB_PORT' => 'Adatbázis port',
    ...
    'LBL_APP_NOT_INSTALLED' => 'SuiteCRM nincs telepítve. A belépéshez telepített SuiteCRM-re van szükség, kérjük előbb telepítse.',
    ...
    'LBL_SILENT_INSTALL_SUCCESS' => 'SuiteCRM sikeresen telepítve.',
    'LBL_SILENT_INSTALL_FAILED' => 'SuiteCRM telepítés nem sikerült.',
    ...
    'LBL_WELCOME' => 'Üdvözli Önt a SuiteCRM',
...
$contact_user_link_guid',
    ...
    'COMPANY_LOGO_UPLOAD_BTN' => 'Feltöltése',
    ...
    'LBL_SYS_CHECK_WARNING' => 'Rendszerellenőrző figyelmeztetések mellőzése',
    ...
    'LBL_VALIDATION_ERRORS' => 'Ellenőrzési hibák történtek, nem tudom végrehajtani a műveletet.',
