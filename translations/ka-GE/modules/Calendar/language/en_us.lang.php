...
$mod_strings = array(
    ...
    'LBL_MODULE_NAME' => 'კალენდარი',
    'LBL_MODULE_TITLE' => 'კალენდარი',
    'LNK_NEW_CALL' => 'ზარების განრიგი',
    'LNK_NEW_MEETING' => 'შეხვედრების განრიგი',
    'LNK_NEW_TASK' => 'Create Task',
    'LNK_CALL_LIST' => 'ზარები',
    'LNK_MEETING_LIST' => 'შეხვედრები',
    'LNK_TASK_LIST' => 'დავალებები',
    'LNK_TASK' => 'დავალება',
    ...
    'LBL_NEXT_MONTH' => 'შემდეგი თვე',
    'LBL_NEXT_DAY' => 'Next Day',
    'LBL_NEXT_YEAR' => 'შემდეგი წელი',
    ...
    'LBL_SHARED' => 'Shared',
    'LBL_PREVIOUS_SHARED' => 'წინა',
    'LBL_NEXT_SHARED' => 'შემდეგი',
    'LBL_SHARED_CAL_TITLE' => 'Shared Calendar',
    'LBL_USERS' => 'მომხმარებლები',
    'LBL_REFRESH' => 'განახლება',
    ...
    'LBL_CREATE_MEETING' => 'შეხვედრების განრიგი',
    ...
    'LBL_STYLE_BASIC' => 'საბაზო', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
    'LBL_STYLE_ADVANCED' => 'გაფართოებული პარამეტრები', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
    ...
    'LBL_SETTINGS_TITLE' => 'პარამეტრები',
    ...
    'LBL_REPEAT_END' => 'დასასრული',
    'LBL_REPEAT_END_AFTER' => 'შემდეგ',
