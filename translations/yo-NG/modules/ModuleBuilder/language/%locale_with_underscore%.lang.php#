...
$mod_strings = array(
    ...
    'LBL_HIDEOPTIONS' => 'Toju awon Asayan' /*for 508 compliance fix*/,
    'LBL_DELETE' => 'Paare' /*for 508 compliance fix*/,
    'help' => array(
        'package' => array(
            ...
            'description' => 'Eyi ni <b>Apejuwe</b> ti a o fihan nigba ti a ba instaali pakagi naa.',
        ...
        'exportcustom' => array(
            ...
            'name' => 'Eyi ni <b>Oruko</b> ti pakagi. A o se afihan oruko yi nigba installationi.',
            'author' => 'Eyi ni <b>Onkowe</b> ti a o fihan nigba installationi gegebi oruko eni ti o seda pakagi naa. Onkowe le je eni kan abi ile ise kan.',
            'description' => 'Eyi ni <b>Apejuwe</b> ti a o fihan nigba ti a ba instaali pakagi naa.',
        ),
        'studioWizard' => array(
            'mainHelp' => 'Kaabo si <b>Awon Irinse Olugbeejade</b> aaye. <br/><br/>Lo awon irinse yi laarin lati seda ati sakoso awon standardi ati customu modulu ati awon aaye.',
            'studioBtn' => 'Use <b>Studio</b> to customize deployed modules.',
            'mbBtn' => 'Lo <b>Oluko Modulu</b> lati seda awon modulu titun.',
            ...
            'backBtn' => 'Pada si igbese ti tele.',
            'studioHelp' => 'Use <b>Studio</b> to determine what and how information is displayed in the modules.',
            'moduleBtn' => 'Te lati satunse modulu yii.',
            'moduleHelp' => 'Awon irinse ti o le customisi fun modulu han nibi.<br><br>Te aami kan lati yaan irinse ti o fe tunse.',
            ...
            'addLayoutHelp' => "Lati ṣẹda ifilelẹ aṣa fun Ẹgbẹ Aabo yan Ẹgbẹ Alabojulo ti o yẹ ati ifilelẹ lati eyi lati daakọ lati bi ibẹrẹ.",
    ...
    'assistantHelp' => array(
        ...
        'listViewEditor' => array(
            'modify' => 'Awọn ọwọn mẹta wa ti o han si apa osi. Awọn iwe "aiyipada" ni awọn aaye ti o han ni wiwo akojọ nipasẹ aiyipada, aaye "Wa" wa ni awọn aaye ti olumulo le yan lati lo fun ṣiṣẹda wiwo akojọ aṣa, ati pe "Ifipamọ" ni awọn aaye ti o wa fun ọ bi abojuto kan si boya fi kun si aiyipada tabi Awọn ọwọn ti o wa fun lilo nipasẹ awọn olumulo ṣugbọn ti wa ni alaabo lọwọlọwọ.',
            ...
            'Default' => 'Awọn aaye aiyipada ti wa ni afihan si awon onilo ti ko da akojo awon wiwo eto aṣa.'
        ),

        'searchViewEditor' => array(
            'modify' => 'Awon owon meji wa ti o han si apa osi. Awon iwe "aiyipada" ni awon aaye ti yoo han ni wiwo wiwa, ati pe "Ifarahan" iwe ni awon aaye ti o wa fun ọ gẹgẹbi abojuto lati fi si wiwo.',
            'savebtn' => 'Clicking <b>Save & Deploy</b> will save all changes and make them active.',
            'Hidden' => 'Awọn aaye ipamọ ni awon aaye ti ko ni han ni aye wiwa.',
            'Default' => 'Awon aaye aiyipada yoo han ni ate wiwa.'
        ),
        'layoutEditor' => array(
            ...
            'saveBtn' => 'Tite botini yi fi ifilele na pamo ki o le toju awon ayipada re, nigbati o ba pada si modulu yi, o bere lati ifilele ti o yi pada. ifilele re ko ni se ri fun awon onilo miran lo ri modulu titi ri o fi te botini ifipamo ati atejade.',
            'publishBtn' => 'Te botibi yi lati se ifilele na. Eleyi tumo si pe ifilele yi yi o han lesekese si awon onilo modulu yi.',
            'toolbox' => 'Apo irinse yen kun fun awon orisirisi eya ara to wulo fun sisatunko ifilele pelu agbegbe idoti, awon afikun eroja ati awon aye to wa ni le. Eyikeyi ninu awon eleyi ni o le ti wa ni wo ati ki o lo sile si ifinlele na.',
        ...
        'dropdownEditor' => array(
            'default' => 'There are two columns displayed to the left. The right-hand column, labeled Current Layout or Layout Preview, is where you change the module layout. The left-hand column, entitled Toolbox, contains useful elements and tools for use when editing the layout. <br/><br/>If the layout area is titled Current Layout then you are working on a copy of the layout currently used by the module for display.<br/><br/>If it is titled Layout Preview then you are working on a copy created earlier by a click on the Save button, that might have already been changed from the version seen by users of this module.',
            'dropdownaddbtn' => 'Tite botini yi se afikun ohun titun si akojo asayan.',
        ...
        'studioWizard' => array(
            ...
            'moduleBtn' => 'Te lati satunse modulu yii.',
            'moduleHelp' => 'Ya apakan modulu ti o fe se atunko',
            ...
            'subpanelBtn' => 'Satunko alaye ti o han ninu awon ipin paneli modulu yii.',
...
//STUDIO2
    ...
    'LBL_DEPLOY_FAILED' => 'Asise ti sele nigbati ilana isakoso, packago re le ma ti dori ero daada',
    ...
    'LBL_EDIT' => 'Satunko',
    'LBL_EDIT_LAYOUT' => 'Ṣatunkọ Aṣayan',
    ...
    'LBL_MODULES' => 'Module ti kii sokan',
    'LBL_MODULE_TITLE' => 'Ile isise',
    ...
    'LBL_SUBPANEL_TITLE' => 'Akole:',
    'LBL_SEARCH_FORMS' => 'Filter',
    'LBL_SEARCH' => 'Sawari',
    'LBL_SEARCH_BUTTON' => 'Sawari',
    'LBL_FILTER' => 'Filter',
    'LBL_TOOLBOX' => 'Toolbox',
    'LBL_QUICKCREATE' => 'Seda kiakia',
    ...
    'LBL_TABDEF_TYPE_HELP' => 'Yan bi o se fe ki apakan yi han, Asayan yi nikan ni ipa ti o ba ti sakoso awon tabu lori wiwo yi.',
    ...
    'LBL_TABDEF_COLLAPSE_HELP' => 'Yan lati je ki ipo aiyipada titi paneli yi wo.',
    'LBL_DROPDOWN_TITLE_NAME' => 'Oruko',
    'LBL_DROPDOWN_LANGUAGE' => 'Ede',
    ...
    'LBL_NO_SAVE_ACTION' => 'Ko ri igbese ifipamo fun wiwo yi.',
...
//BUTTONS
    ...
    'LBL_BTN_DUPLICATE' => 'Eda-iwe',
    'LBL_BTN_PUBLISH' => 'Publish',
    'LBL_BTN_DEPLOY' => 'Deploy',
    'LBL_BTN_EXP' => 'Export',
    'LBL_BTN_DELETE' => 'Paare',
...
//ERRORS
    ...
    'ERROR_MINIMUM_FIELDS' => 'Ifilelẹ naa gbọdọ ni okere ju, aye kan',
    'ERROR_GENERIC_TITLE' => 'Asise ti sele',
    'ERROR_REQUIRED_FIELDS' => 'Se o da e loju pe o fe lati tesiwaju? Awon aye ti o bere yi ti sonu lati ifilele naa

Ṣe o da ọ loju pe o fẹ lati tẹsiwaju? Awọn aaye ti o beere wọnyi ti nsọnu lati ifilelẹ naa:  ',
...
//PACKAGE AND MODULE BUILDER
    ...
    'LBL_LIST' => 'Akojo',
    'LBL_VIEW' => 'Wo',
    'LBL_HISTORY' => 'Wo Itan to ti koja',
    'LBL_RESTORE_DEFAULT' => 'Restore Default',
    'LBL_ACTIVITIES' => 'Akitiyan',
    'LBL_NEW' => 'Titun',
    'LBL_TYPE_BASIC' => 'basic',
    'LBL_TYPE_COMPANY' => 'company',
    'LBL_TYPE_PERSON' => 'eyan',
    'LBL_TYPE_ISSUE' => 'issue',
    'LBL_TYPE_SALE' => 'tita',
    'LBL_TYPE_FILE' => 'faili',
    'LBL_RSUB' => 'Eyi ni ipin paneli ti o ma han ninu modulu re',
    'LBL_MSUB' => 'Eyi ni ipin paneli ti modulu re n pese si modulu ti o jọmọ fun ifihan',
...
//AJAX STATUS
    ...
    'LBL_AJAX_LOADING' => 'Ikojopo...',
    'LBL_AJAX_DELETING' => 'Deleting...',
    'LBL_AJAX_BUILDPROGRESS' => 'Build In Progress...',
    'LBL_AJAX_DEPLOYPROGRESS' => 'Deploy In Progress...',

    'LBL_AJAX_RESPONSE_TITLE' => 'E si',
    'LBL_AJAX_RESPONSE_MESSAGE' => 'Isise yi ti pari daada',
    'LBL_AJAX_LOADING_TITLE' => 'Ni ilosiwaju...',
    'LBL_AJAX_LOADING_MESSAGE' => 'Jowo duro akojopo...',

//JS
    'LBL_JS_REMOVE_PACKAGE' => 'Se o da e lo ju pe ofe yo packagi yi kuro? Eyi ma yo gbogbo faili ti o ni nka se pelu package yi patapata

Ṣe o da ọ loju pe o fẹ yọ yiyọ kuro? Eyi yoo pa gbogbo awọn faili ti o ni nkan ṣe pẹlu package yii patapata.',
...
//CONFIRM
    ...
    'LBL_CONFIRM_DONT_SAVE_TITLE' => 'Fi iyipada pa mo?',
    'LBL_CONFIRM_LOWER_LENGTH' => 'Data le logbe ati eleyi kole se dapada, se o da e loju pe ofe tesiwaju?',

//POPUP HELP
    'LBL_POPHELP_FIELD_DATA_TYPE' => 'Yan irufẹ data ti o da lori iru data ti yoo wọ inu aaye naa.',
...
//Revert Module labels
    ...
    'LBL_CLEAR_RELATIONSHIPS' => 'Pa awọn Ibasepo re',
