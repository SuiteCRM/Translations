...
$app_strings = array(
    ...
    'LBL_BASIC_SEARCH' => 'آلہ کے ذریعے الگ کرنا', /*for 508 compliance fix*/
    ...
    'LBL_EMAIL_ACCOUNTS_SMTPDEFAULT' => 'پہلے سے طے شدہ ',
    ...
    'LBL_EMAIL_FOLDERS' => SugarThemeRegistry::current()->getImage('icon_email_folder', 'align=absmiddle border=0', null, null, '.gif', '') . 'فولڈر',
    ...
    'LBL_FAVORITES_FILTER' => 'میری پسند',
    ...
    'LBL_LIST_DATE_ENTERED' => 'تاریخ کی تشکیل',
    ...
    'LBL_RECORD_DOES_NOT_EXIST' => 'ریکارڈ کو دوبارہ حاصل کرنے میں خرابی. یہ ریکارڈ ختم ہوسکتا ہے یا آپ اسے دیکھنے کا اختیار نہیں رکھ سکتے ہیں.',
    ...
    'LBL_FILTER' => 'آلہ کے ذریعے الگ کرنا',
...
"5 امپورٹ آپشن پر کلک کریں اپلیکیشن کے مینیو ردعمل سے اور اوپر ڈالنے کے لیئے اس کو انتخاب کریں   ',
    ...
    'LBL_DUPLICATE_BUTTON_LABEL' => 'ہم شکل',
    'LBL_DUPLICATE_BUTTON_TITLE' => 'ہم شکل',
    'LBL_DISABLE_USER_2FA' => 'Disable 2FA',
    'LBL_DELETE_BUTTON_KEY' => 'd',
    'LBL_DELETE_BUTTON_LABEL' => 'ختم کریں',
    'LBL_DELETE_BUTTON_TITLE' => 'ختم کریں',
    'LBL_BULK_ACTION_BUTTON_LABEL' => 'استعمال کنندہ کے مطابق',
    ...
    'PIPELINE_BY_SALES_STAGE' => 'سیلز اسٹیج کی طرف سے پائپ لائن',
    ...
    'LBL_FILTER_HEADER_TITLE' => 'آلہ کے ذریعے الگ کرنا',
    ...
    'LBL_SUITE_DESC1' => 'SuiteCRM لکھتا ہے اور جمع کرتا ہے<a href="https://salesagility.com">SalesAgility</a>.یہ پروگرام اےایس دیتا ہے بغیر کسی گرنٹی کے AGPLv3 کے تحت لسنس یافتہ ہے.',
    ...
    'LBL_SUITE_DESC3' => 'سویٹ سی آر ایم سیلز اے گلٹی لمیٹڈ کا ایک تجارتی نشان ہے. تمام دوسری کمپنی اور پروڈکٹ کے نام متعلقہ کمپنیوں کے تجارتی نشان ہو سکتے ہیں جن کے ساتھ وہ منسلک ہیں.',
...
$app_list_strings['aor_date_type_list']['business_hours'] = 'کاروباری اوقات';
...
$app_list_strings['aow_date_type_list']['business_hours'] = 'کاروباری اوقات';
...
$app_strings['LBL_SUBPANEL_FILTER_LABEL'] = 'آلہ کے ذریعے الگ کرنا';
...
$app_list_strings['moduleList']['AOBH_BusinessHours'] = 'کاروباری اوقات';
...
$app_strings['LBL_OPT_OUT'] = 'اختیار کو باہر نکالنا';
$app_strings['LBL_INVALID_EMAIL'] = 'درست نہیں';
$app_strings['LBL_PRIMARY'] = 'ابتدا یا پہلا';
...
$app_strings['LBL_NO_DATA'] = 'کوئی مواد نہیں';
$app_strings['LBL_ERROR_FETCHING_METADATA'] = 'Error occurred while fetching metadata';
$app_strings['LBL_TOTAL'] = 'حاصل جمع';
$app_strings['LBL_ACTIONS'] = 'کسی چیز پر رد عمل دینا';
...
$app_strings['LBL_DEFAULT_TOTAL'] = 'حاصل جمع';
...
$app_strings['LBL_CASE_UPDATES'] = 'کیس کی تازہ کاری';
...
$app_strings['LBL_OPERATOR'] = 'عمل کرنے والا';
$app_strings['LBL_START'] = 'شروع کریں';
$app_strings['LBL_END'] = 'آخر';
...
$app_strings['LBL_CC'] = 'کک';
$app_strings['LBL_BCC'] = 'بکک';
$app_strings['LNK_NEW_EMAIL'] = 'نیا ای میل';
...
$app_strings['LBL_RELATED_TO'] = 'سے متعلق';
...
$app_strings['LBL_DEFAULT'] = 'پہلے سے طے شدہ ';
$app_strings['LBL_APPLY'] = 'لاگو کرنا';
...
$app_strings['LBL_QUOTE'] = 'حوصلہ قطار';
$app_strings['LBL_UNQUOTE'] = 'Unquote';
$app_strings['LBL_ALIGN_LEFT'] = 'بایاں';
$app_strings['LBL_ALIGN_CENTER'] = 'Center';
$app_strings['LBL_ALIGN_RIGHT'] = 'ٹھیک';
...
$app_strings['LBL_MON'] = 'پیر';
$app_strings['LBL_TUE'] = 'منگل';
...
$app_strings['LBL_EVERY'] = 'ہر کوئی';
$app_strings['LBL_ON_THE'] = 'On the';
$app_strings['LBL_RANGE'] = 'کرنے کے لئے';
$app_strings['LBL_FROM'] = 'سے';
$app_strings['LBL_AND'] = 'and';
$app_strings['LBL_MINS'] = 'ایک منٹ';
$app_strings['LBL_MINUTES'] = 'منٹ';
$app_strings['LBL_HOUR'] = 'گھنٹے';
$app_strings['LBL_HOUR_SING'] = 'گھنٹہ';
$app_strings['LBL_OFTEN'] = 'As often as possible.';
$app_strings['LBL_MIN_MARK'] = 'minute mark';
$app_strings['LBL_INBOUND_EMAIL'] = 'ان باؤنڈ ای میل';
...
$app_strings['LBL_CAMPAIGN_SETTINGS'] = 'کسی کام کو ترتیب دینا';
...
$app_strings['LBL_INACTIVE'] = 'غیر فعال ہے';
...
$app_strings['LBL_UPLOAD'] = 'اپ لوڈ کریں';
