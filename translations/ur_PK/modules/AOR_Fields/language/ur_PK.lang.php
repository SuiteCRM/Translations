...
$mod_strings = array(
    ...
    'LBL_LIST_FORM_TITLE' => 'فیلڈز کی فہرست',
    'LBL_MODULE_NAME' => 'فیلڈز',
    'LBL_MODULE_TITLE' => 'فیلڈز',
    'LBL_HOMEPAGE_TITLE' => 'میرا فیلڈز',
    'LNK_NEW_RECORD' => 'فیلڈز بنائیں',
    'LNK_LIST' => 'دیکھیں فیلڈز',
    'LBL_SEARCH_FORM_TITLE' => 'تلاش فیلڈز',
    'LBL_HISTORY_SUBPANEL_TITLE' => 'تاریخ دیکھیں',
    'LBL_ACTIVITIES_SUBPANEL_TITLE' => 'سرگرمیاں',
    'LBL_NEW_FORM_TITLE' => 'نیا فیلڈز',
    'LBL_ORDER' => 'حکم',
    ...
    'LBL_FUNCTION' => 'تقریب',
    'LBL_SORT' => 'ترتیب دینا',
    'LBL_SORT_ORDER' => 'ترتیب',
    'LBL_GROUP' => 'گروپ',
    'LBL_GROUP_ORDER' => 'گروپ آرڈر',
    'LBL_AUDIT_TABLE' => 'آڈٹ ٹیبل',
    'LBL_TOTAL' => 'حاصل جمع',
    'LBL_FORMAT' => 'فارمیٹ کے اختیارات',
);
