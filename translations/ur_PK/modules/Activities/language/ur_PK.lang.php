...
$mod_strings = array(
    ...
    'LBL_PRINT' => 'پرنٹ کریں', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
    'LBL_MEETING_TYPE' => 'ملاقات',
    'LBL_CALL_TYPE' => 'کال',
    'LBL_EMAIL_TYPE' => 'ای میل',
    'LBL_NOTE_TYPE' => 'خط',
    'LBL_DATA_TYPE_START' => 'شروع کریں:',
    ...
    'LNK_NEW_NOTE' => 'نوٹ بنائیں یا منسلک شامل کریں',
