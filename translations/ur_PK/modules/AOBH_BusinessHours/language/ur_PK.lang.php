...
$mod_strings = array(
    ...
    'LBL_REMOVE' => 'ہٹا دیں',
    'LBL_LIST_FORM_TITLE' => 'کاروباری گھنٹوں کی فہرست',
    'LBL_MODULE_NAME' => 'کاروباری گھنٹے',
    'LBL_MODULE_TITLE' => 'کاروباری گھنٹے',
    'LBL_HOMEPAGE_TITLE' => 'میرے کاروباری گھنٹے',
    'LNK_NEW_RECORD' => 'کاروباری گھنٹے بنائیں',
    'LNK_LIST' => 'کاروباری گھنٹے دیکھیں',
    'LBL_SEARCH_FORM_TITLE' => 'کاروباری گھنٹے تلاش کریں',
    'LBL_HISTORY_SUBPANEL_TITLE' => 'تاریخ دیکھیں',
    'LBL_ACTIVITIES_SUBPANEL_TITLE' => 'سرگرمیاں',
    'LBL_NEW_FORM_TITLE' => 'نۂے کاروباری گھنٹے',
    'LBL_OPENING_HOURS' => 'کھولنے کا وقت',
    'LBL_CLOSING_HOURS' => 'بند کرنے کے اوقات',
    'LBL_DAY' => 'ایک دن',
    'LBL_OPEN' => 'کھلا ہے',
);
