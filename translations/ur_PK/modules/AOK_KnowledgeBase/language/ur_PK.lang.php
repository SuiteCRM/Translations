...
$mod_strings = array(
    ...
    'LBL_LIST_FORM_TITLE' => 'علم کے بیس کی فہرست',
    'LBL_MODULE_NAME' => 'علم کی بنیاد',
    'LBL_MODULE_TITLE' => 'علم کی بنیاد',
    'LBL_HOMEPAGE_TITLE' => 'میرے علم کی بنیاد',
    'LNK_NEW_RECORD' => 'علم کی بنیاد بناۂیں',
    'LNK_LIST' => 'علم کی بنیاد دیکھیں',
    'LBL_SEARCH_FORM_TITLE' => 'علم کی بنیاد تلاش کریں',
    'LBL_HISTORY_SUBPANEL_TITLE' => 'تاریخ دیکھیں',
    'LBL_ACTIVITIES_SUBPANEL_TITLE' => 'سرگرمیاں',
    'LBL_NEW_FORM_TITLE' => 'نۂے علم کی بنیاد',
    'LBL_STATUS' => 'حیثیت',
    'LBL_REVISION' => 'نظر ثانی',
    'LBL_AUTHOR_USER_ID' => 'مصنف (متعلقہ صارف کی شناخت)',
    'LBL_AUTHOR' => 'مصنف',
    'LBL_APPROVER_USER_ID' => 'منظور کرنے والا(متعلقہ صارف کی شناخت)',
    'LBL_APPROVER' => 'منظور کرنے والا',
);

$mod_strings['LBL_AOK_KB_CATEGORIES_TITLE'] = 'زمرہ جات';
