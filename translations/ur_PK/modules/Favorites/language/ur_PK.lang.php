...
$mod_strings = array(
    ...
    'LBL_REMOVE' => 'ہٹا دیں',
    'LBL_LIST_FORM_TITLE' => 'پسندیدہ فہرست',
    'LBL_MODULE_NAME' => 'پسندیدہ',
    'LBL_MODULE_TITLE' => 'پسندیدہ',
    'LBL_HOMEPAGE_TITLE' => 'میری پسند',
    'LNK_NEW_RECORD' => 'پسندیدہ بنائیں',
    'LNK_LIST' => 'پسندیدہ دیکھیں',
    'LBL_SEARCH_FORM_TITLE' => 'پسندیدہ تلاش کریں',
    'LBL_HISTORY_SUBPANEL_TITLE' => 'تاریخ دیکھیں',
    'LBL_ACTIVITIES_SUBPANEL_TITLE' => 'سرگرمیاں',
    'LBL_NEW_FORM_TITLE' => 'نیا پسندیدہ',
