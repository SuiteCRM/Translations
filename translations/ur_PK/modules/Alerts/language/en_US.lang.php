...
$mod_strings = array(
    ...
    'LBL_REMOVE' => 'ہٹا دیں',
    'LBL_LIST_FORM_TITLE' => 'انتباہ کی فہرست',
    'LBL_MODULE_NAME' => 'انتباہ',
    'LBL_MODULE_TITLE' => 'انتباہ',
    'LBL_HOMEPAGE_TITLE' => 'میری انتباہ',
    'LNK_NEW_RECORD' => 'انتباہ بنائیں',
    'LNK_LIST' => 'انتباہ دیکھیں',
    'LBL_SEARCH_FORM_TITLE' => 'انتباہ تلاش کریں',
    'LBL_HISTORY_SUBPANEL_TITLE' => 'تاریخ دیکھیں',
    'LBL_ACTIVITIES_SUBPANEL_TITLE' => 'سرگرمیاں',
    'LBL_NEW_FORM_TITLE' => 'نیا انتباہ',
    'LBL_IS_READ' => 'پڑھا ہے',
