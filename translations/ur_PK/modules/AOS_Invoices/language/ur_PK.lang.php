...
$mod_strings = array(
    ...
    'LBL_LIST_FORM_TITLE' => 'انوائس فہرست',
    'LBL_MODULE_NAME' => 'تِجارتی سامان کی فہرِست',
    'LBL_MODULE_TITLE' => 'انوائس: گھر',
    'LBL_HOMEPAGE_TITLE' => 'میرا انوائس',
    'LNK_NEW_RECORD' => 'انوائس بنائیں',
    'LNK_LIST' => 'انوائس دیکھیں',
    'LBL_SEARCH_FORM_TITLE' => 'تلاش انوائس',
    'LBL_HISTORY_SUBPANEL_TITLE' => 'تاریخ دیکھیں',
    'LBL_NEW_FORM_TITLE' => 'نیا انوائس',
    'LBL_TERMS_C' => 'وقفه',
    ...
    'LBL_INVOICE_NUMBER' => 'انوائس تعداد',
    'LBL_OPPORTUNITY' => 'مواقع مناسب موضوع',
    'LBL_TEMPLATE_DDOWN_C' => 'انوائس سانچے',
    ...
    'LBL_QUOTE_DATE' => 'بنانا لڑکی ڈیٹ',
    'LBL_INVOICE_DATE' => 'انوائس کی تاریخ',
    'LBL_DUE_DATE' => 'تاریخ کی وجہ سے',
    'LBL_STATUS' => 'حیثیت',
    ...
    'LBL_REMOVE_PRODUCT_LINE' => 'ختم کر دیں',
    'LBL_PRINT_AS_PDF' => 'پرنٹ اس پی ڈی ایف',
    'LBL_EMAIL_INVOICE' => 'ای میل انوائس',
    'LBL_LIST_NUM' => 'نیوم',
    'LBL_PDF_NAME' => 'انوائس',
    'LBL_EMAIL_NAME' => 'انوائس کے لئے',
    'LBL_NO_TEMPLATE' => 'خرابی \ n کسی ٹیمپلیٹس کو مل گیا. اگر آپ نے انوائس ٹیمپلیٹ نہیں بنایا ہے تو، پی ڈی ایف ٹیمپلیٹس ماڈیول پر جائیں اور ایک بنائیں',
