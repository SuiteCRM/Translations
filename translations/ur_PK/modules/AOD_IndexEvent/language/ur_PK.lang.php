...
$mod_strings = array(
    ...
    'LBL_REMOVE' => 'ہٹا دیں',
    'LBL_LIST_FORM_TITLE' => 'انڈیکس ایونٹ کی فہرست',
    'LBL_MODULE_NAME' => 'انڈیکس ایونٹ',
    'LBL_MODULE_TITLE' => 'انڈیکس ایونٹ',
    'LBL_HOMEPAGE_TITLE' => 'میرا انڈیکس ایونٹ',
    'LNK_NEW_RECORD' => 'انڈیکس ایونٹ بنائیں',
    'LNK_LIST' => 'انڈیکس ایونٹ دیکھیں',
    'LBL_SEARCH_FORM_TITLE' => 'انڈیکس ایونٹ تلاش کریں',
    'LBL_HISTORY_SUBPANEL_TITLE' => 'تاریخ دیکھیں',
    'LBL_ACTIVITIES_SUBPANEL_TITLE' => 'سرگرمیاں',
    'LBL_NEW_FORM_TITLE' => 'نۂے انڈیکس ایونٹ',
    'LBL_ERROR' => 'غلطی',
    'LBL_SUCCESS' => 'کامیابی',
    'LBL_RECORD_MODULE' => 'کامیابی',

    'LBL_RECORD_ID' => 'ریکارڈ کی شناخت',
);
