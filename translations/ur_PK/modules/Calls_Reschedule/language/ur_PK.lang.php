...
$mod_strings = array(
    ...
    'LBL_REMOVE' => 'ہٹا دیں',
    'LBL_LIST_FORM_TITLE' => 'فہرست کا تجزیہ کریں',
    'LBL_MODULE_NAME' => 'تجزیہ کریں',
    'LBL_MODULE_TITLE' => 'تجزیہ کریں',
    'LBL_HOMEPAGE_TITLE' => 'میرا معائنہ',
    'LNK_NEW_RECORD' => 'تجزیہ بنائیں',
    'LNK_LIST' => 'تجزیہ دیکھیں',
    'LBL_SEARCH_FORM_TITLE' => 'ریسرچ کریں',
    'LBL_HISTORY_SUBPANEL_TITLE' => 'تاریخ دیکھیں',
    'LBL_ACTIVITIES_SUBPANEL_TITLE' => 'سرگرمیاں',
    'LBL_NEW_FORM_TITLE' => 'نیا تجزیہ',
    'LBL_REASON' => 'وجہ',
    'LBL_CALLS' => 'کال',
);
