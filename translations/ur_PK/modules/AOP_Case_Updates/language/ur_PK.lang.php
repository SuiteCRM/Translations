...
$mod_strings = array(
    ...
    'LBL_REMOVE' => 'ہٹا دیں',
    'LBL_LIST_FORM_TITLE' => 'کیس کی تازہ ترین فہرست',
    'LBL_MODULE_NAME' => 'کیس کی تازہ کاری',
    'LBL_MODULE_TITLE' => 'کیس کی تازہ کاری',
    'LBL_HOMEPAGE_TITLE' => 'میرے کیس کی تازہ کاری',
    'LNK_NEW_RECORD' => 'کیس کی تازہ ترین معلومات بنائیں',
    'LNK_LIST' => 'کیس کی تازہ ترین معلومات دیکھیں',
    'LBL_SEARCH_FORM_TITLE' => 'کیس کی تازہ ترین معلومات تلاش کریں',
    'LBL_HISTORY_SUBPANEL_TITLE' => 'تاریخ دیکھیں',
    'LBL_ACTIVITIES_SUBPANEL_TITLE' => 'سرگرمیاں',
    'LBL_NEW_FORM_TITLE' => 'نۂے کیس کی تازہ ترین معلومات',
    'LBL_CASE_NAME' => 'معاملہ',
