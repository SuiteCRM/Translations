...
$mod_strings = array(
    ...
    'LBL_GROUP_TOTAL_USDOLLAR' => 'گروپ کل (پہلے سے طے شدہ کرنسی)',
    'LBL_SUBTOTAL_TAX_AMOUNT_USDOLLAR' => 'ذیلی کل + ٹیکس (ڈیفالٹ کرنسی)',
    'LBL_PARENT_ID' => 'والدین کی شناخت',

    'AOS_PRODUCT_QUOTES' => 'مصنوعات کی قطار',
);
