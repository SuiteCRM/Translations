...
$mod_strings = array(
    ...
    'LBL_LIST_FORM_TITLE' => 'شرائط کی فہرست',
    'LBL_MODULE_NAME' => 'شرائط',
    'LBL_MODULE_TITLE' => 'شرائط',
    'LBL_HOMEPAGE_TITLE' => 'میری شرائط',
    'LNK_NEW_RECORD' => 'شرائط کو بنائیں',
    'LNK_LIST' => 'شرائط کو دیکھیں',
    'LBL_SEARCH_FORM_TITLE' => 'شرائط کو تلاش کریں',
    'LBL_HISTORY_SUBPANEL_TITLE' => 'تاریخ دیکھیں',
    'LBL_ACTIVITIES_SUBPANEL_TITLE' => 'سرگرمیاں',
    'LBL_NEW_FORM_TITLE' => 'نئی کیٹگری',
    'LBL_LOGIC_OP' => 'منطق',
    'LBL_MODULE_PATH' => 'ماڈیول',
    'LBL_FIELD' => 'فیلڈ',
    'LBL_OPERATOR' => 'عمل کرنے والا',
    'LBL_VALUE_TYPE' => 'قسم',
    'LBL_VALUE' => 'قیمت',
    'LBL_ORDER' => 'حکم',
    'LBL_CONDITION_OPERATOR' => 'Condition Operator',
    'LBL_AOR_REPORT_ID' => 'انفارمیشن کے متعلق شکایت کرنا',
    'LBL_PARAMETER' => 'پیرا میٹر',
