...
//e.g. auf Deutsch 'Contacts'=>'Contakten',
    ...
    'moduleList' => array(
        ...
        'Campaigns' => 'Campagnes',
        'CampaignLog' => 'Campage logboek',
        'Documents' => 'Documenten',
        'DocumentRevisions' => 'Document revisie',
        ...
        'ACLRoles' => 'Rollen',
        'InboundEmail' => 'Inkomende Email Accounts',
        'Releases' => 'Uitgave',
        'Prospects' => 'Doelen',
        'Queues' => 'Wachtrij',
    ...
    'roi_type_dom' => array(
        ...
        'Expected_Revenue' => 'Verwachtte opbrengst',
        'Budget' => 'Budget',
...
//       it is the key for the default case_relationship_type_dom value
    ...
    'snooze_alert_timer' => array(
        60 => 'Uitstellen voor 1 minuut',
        300 => 'Uitstellen voor 5 minuten',
        600 => 'Uitstellen voor 10 minuten',
        900 => 'Uitstellen voor 15 minuten',
        1800 => 'Uitstellen voor 30 minuten',
        3600 => 'Uitstellen voor 1 uur',
        7200 => 'Uitstellen voor 2 uren',
        10800 => 'Uitstellen voor 3 uren',
        18000 => 'Uitstellen voor 5 uren',
        86400 => 'Uitstellen voor 1 dag',
    ),
...
//prospect list type dom
    ...
    'email_marketing_status_dom' => array(
        ...
        'draft' => 'Ontwerp',
        'scheduled' => 'Gepland',
        'pending_send' => 'In afwachting van verzending',
        'aborted' => 'Afgebroken',
    ...
    'email_marketing_duplicate_dom' => [
        ...
        'record' => 'Voorkom verzenden naar dubbele records',
    ],
...
$app_strings = array(
    'LBL_SEARCH_RESULTS_TITLE' => 'Resultaten',
    ...
    'LBL_LOGOUT_SUCCESS' => 'Uitloggen succesvol',
    'LBL_LOGGED_OUT_MESSAGE' => 'U bent uitgelogd',
    'LBL_LOGIN_AGAIN' => 'Om opnieuw in te loggen ',
    ...
    'ERR_TIMEOUT' => "Geforceerde fout bij time-out",
    ...
    'LBL_EMAIL_DELETE_ERROR_DESC' => 'Je hebt geen toegangsrechten tot deze plek. Neem contact op met de beheerder als je toegang zou moeten hebben.',
    ...
    'LBL_EMAIL_SETTINGS_ACCOUNTS' => 'Mailaccounts',
    ...
    'ERR_UNAUTHORIZED_PAGE_ACCESS' => 'U bent niet bevoegd om deze pagina te bekijken. Neem contact op met de systeembeheerder.',
    'ERR_UNAUTHORIZED_PAGE_ACCESS_TO_HOME_PAGE' => 'U bent niet bevoegd om deze pagina te bekijken. Doorsturen naar de startpagina...',
    ...
    'LBL_CAMPAIGNS_SEND_NEXT_BATCH' => 'Verzend volgende batch van in wachtrij geplaatste e-mails',
    'LBL_SENT_NEXT_BATCH' => 'Batch met succes verzonden',
    'LBL_SUBMIT_BUTTON_LABEL' => 'Verstuur',
    'LBL_CASE' => 'Verzoek',
    'LBL_CASES' => 'Verzoeken',
    ...
    'LBL_LAST_VIEWED_NO_RESULT' => 'Geen recent bekeken items',
    'LBL_LEADS' => 'Leads',
    'LBL_LESS' => 'minder',
    ...
    'LBL_CAMPAIGN_CHARTS' => 'Campagne grafieken',
    ...
    'LBL_LOG_ENTRIES_TARGETED_TITLE' => 'Verstuurd/Geprobeerd',
    'LBL_LOG_ENTRIES_SEND_ERROR_TITLE' => 'Bounced Messages, Overig',
    'LBL_LOG_ENTRIES_BOUNCED_TITLE' => 'Bounced berichten',
    'LBL_LOG_ENTRIES_INVALID_EMAIL_TITLE' => 'Bounced berichten, ongeldig e-mailadres',
    'LBL_LOG_ENTRIES_LINK_TITLE' => 'Link klik-thru',
    'LBL_LOG_ENTRIES_VIEWED_TITLE' => 'Bekeken bericht',
    'LBL_LOG_ENTRIES_REMOVED_TITLE' => 'Afgemeld',
    'LBL_LOG_ENTRIES_LEAD_TITLE' => 'Gemaakte Leads',
    'LBL_CAMPAIGN_LEAD_SUBPANEL_TITLE' => 'Leads',
    'LBL_OPPORTUNITY_SUBPANEL_TITLE' => 'Verkoopkansen',
    'LBL_LOG_ENTRIES_CONTACT_TITLE' => 'Contactpersonen aangemaakt',
    'LBL_LOG_ENTRIES_BLOCKED_TITLE' => 'Toegepast/Geblokkeerd',
    'LBL_THEME' => 'Thema:',
    'LBL_FOUND_IN_RELEASE' => 'Gevonden in release',
    'LBL_FIXED_IN_RELEASE' => 'Gefixt in release',
    'LBL_IN_EVERYWHERE' => 'Overal in',
    ...
    'LBL_COPY' => 'Kopiëren',
    'LBL_CANCEL' => 'Annuleer',
    'LBL_SNOOZE' => 'Uitstellen',
    'LBL_SNOOZE_INLINE_CONFIRM' => 'Uitstellen? ({{preferences.snooze_alert_timer|enum:snooze_alert_timer_simple}})',
    ...
    'LBL_PROFILE' => 'Profiel',
    'LBL_PROFILE_EDIT' => 'Profiel bewerken',
    ...
    'LBL_FILTER' => 'Filter',
    'LBL_CLEAR_FILTER' => 'Filter wissen',
    'LBL_FILTER_MODULES' => 'Modules filteren',
    'LBL_SEARCH' => 'Zoeken',
    'LBL_SEARCH_ALT' => '',
    ...
    'LBL_ALL_SCHEDULERS' => 'Alle Schedulers',
    'LBL_LEGACY_SCHEDULERS' => 'Oude Schedulers',
    'LBL_SCHEDULERS' => 'Planners',
    'LBL_RUN_LEGACY_SCHEDULERS' => 'Lopende Legacy Schedulers',
    'LBL_LEGACY_SCHEDULERS_RUN_SUCCESSFULLY' => 'Legacy Schedulers lopen succesvol!',
    'LBL_RUN_SCHEDULERS' => 'Lopende Schedulers',
    'LBL_LEGACY_SCHEDULER_FAILED' => 'Niet alle Schedulers waren succesvol. Zie Logs.',
    'LBL_PASSED' => 'Geslaagd',
    'LBL_FAILED' => 'Mislukt',
    ...
    'LBL_TOO_MANY_ADDRESSES' => 'U heeft te veel e-mailadressen geselecteerd.',
    'LBL_NO_ADDRESSES_SELECTED' => 'Selecteer een adres waarnaar u wilt versturen.',
    'LBL_NOT_ALL_SENT' => 'Niet alle e-mails verzonden. Zie logs voor meer info.',
    'LBL_NOT_VALID_TARGETS' => 'Geen doelen gevalideerd om naar te verzenden.',
    'LBL_ALL_EMAILS_SENT' => 'Alle test e-mails met succes verzonden',
    ...
    'LBL_VIEW_IMAGE' => 'Toon',
    'LBL_CREATE_PORTAL_USER_FAILED' => 'Fout bij het aanmaken van portalgebruiker',
    'LBL_CREATE_PORTAL_USER_SUCCESS' => 'Portaalgebruiker aangemaakt',
    ...
    'LBL_CHANGE_LOG' => 'Logboek wijzigen',
    ...
    'NTC_SEND_QUEUED_CAMPAIGN_EMAILS' => 'Verzend de volgende reeks van in de wachtrij geplaatste campagne e-mails?',
    ...
    'NTC_DELETE_TEST_ENTRIES_CONFIRMATION' => 'Weet u zeker dat u de testitems wilt verwijderen?',
    'NTC_PROCEED' => 'Wilt u doorgaan?',
    'NTC_UNSCHEDULE_CONFIRMATION' => 'Het ontplannen zet de status op "Concept".',
    'NTC_UNSCHEDULE_CONFIRMATION_OTHER' => 'Het proces van verzenden zal niet langer beginnen, tenzij opnieuw is gepland.',
    ...
    'LBL_TEMPLATE_CONFIRMATION' => 'Nieuw E-mail sjabloon toepassen? (Dit overschrijft uw huidige e-mail bericht en onderwerp veld)',
    ...
    'LBL_DATE_LAST_ACTION' => 'Datum laatste aktie',
...
"5. Klik op de importeren optie in het menu Acties in de toepassing en kies het bestand om te uploaden"   ',
    ...
    'LBL_ALT_HIDE_OPTIONS' => 'Verbergen opties',
    ...
    'LBL_DISABLE_USER_2FA' => '2FA uitschakelen',
    'LBL_DELETE_BUTTON_KEY' => 'D',
    'LBL_DELETE_BUTTON_LABEL' => 'Verwijder',
    'LBL_DELETE_BUTTON_TITLE' => 'Verwijder',
    'LBL_BULK_ACTION_BUTTON_LABEL' => 'Bulkactie',
    'LBL_BULK_ACTION_BUTTON_LABEL_MOBILE' => 'Actie',
    'LBL_TOO_FEW_SELECTED' => 'Ongeldig aantal records geselecteerd. U moet een minimum van {min} records selecteren.',
    'LBL_TOO_MANY_SELECTED' => 'Ongeldig aantal records geselecteerd. U moet een minimum van {max} records selecteren.',
    'LBL_SELECT_ALL_NOT_ALLOWED' => 'Selecteren van alle records is niet beschikbaar voor deze actie. Selecteer individuele records.',
    'LBL_MISSING_HANDLER_DATA' => 'Onverwachte fout. Ontbrekende bulk actie gegevensverwerker uit reactie',
    'LBL_MISSING_HANDLER' => 'Onverwachte fout. Geen verwerker gedefinieerd voor de gekozen bulk actie',
    'LBL_MISSING_HANDLER_DATA_ROUTE' => 'Onverwachte fout. Ontbrekende bulk actie route',
    'LBL_ACTION_ERROR' => 'Onverwachte fout bij aanroepen actie',
    'LBL_BULK_ACTION_ERROR' => 'Onverwachte fout bij aanroepen actie',
    'LBL_BULK_ACTION_DELETE_SUCCESS' => 'Record(s) succesvol verwijderd',
    'LBL_BULK_ACTION_MASS_UPDATE_CONFIRMATION' => 'Weet u zeker dat u de geselecteerde records wilt bijwerken?',
    'LBL_BULK_ACTION_MASS_UPDATE_SUCCESS' => 'Alle records met succes bijgewerkt',
    'LBL_BULK_ACTION_MASS_UPDATE_PARTIAL_SUCCESS' => 'Gedeeltelijk succes. Sommige records zijn niet bijgewerkt. Controleer het logboek',
    'LBL_BULK_ACTION_MASS_UPDATE_NO_FIELDS' => 'Geen velden om bij te werken',
    'LBL_BULK_ACTION_MASS_UPDATE_NO_RECORDS' => 'Geen records om te updaten',
    'LBL_BULK_ACTION_MASS_UPDATE_NO_ACLS' => 'Onvoldoende rechten, opslaan actie niet toegestaan',
    'LBL_UNEXPECTED_ERROR' => 'Onverwachte fout. Geen mogelijkheid om actie uit te voeren.',
    'LBL_RECORD_DELETE_SUCCESS' => 'Record succesvol verwijderd',
    'LBL_RECORD_DELETE_ALL_SUCCESS' => 'Records succesvol verwijderd',
    'LBL_RECORD_SNOOZE_SUCCESS' => 'Notificatie uitgesteld',
    'LBL_ERROR_SAVING' => 'Fout opgetreden tijdens het opslaan van record',
    'LBL_SAVE_BUTTON_KEY' => 'S',
    'LBL_SAVE_BUTTON_LABEL' => 'Opslaan',
    'LBL_NEW_EM_SURVEY' => 'Nieuwe enquête e-mail',
    'LBL_NEW_EM_TRANSACTIONAL' => 'Nieuwe transactionele e-mail',
    'LBL_NEW_EM_MARKETING' => 'Nieuwe marketing e-mail',
    'LBL_NEW_SURVEY' => 'Nieuwe enquête',
    'LBL_WEB_TO_LEAD' => 'Nieuw Web naar Persoon Formulier',
    'LBL_TYPE' => 'Type',
    'LBL_DATE_START' => 'Startdatum',
    'LBL_SEND_DATE' => 'Verzend datum',
    'LBL_SCHEDULE_BUTTON_LABEL' => 'Planning',
    'LBL_UNABLE_TO_UNSCHEDULE' => 'Niet mogelijk om te ontplannen als niet gepland',
    'LBL_SAVE_BUTTON_TITLE' => 'Opslaan',
    'LBL_SAVE_CONTINUE_LABEL' => 'Opslaan en doorgaan',
    ...
    'ANNUAL_REVENUE_BY_ACCOUNTS' => 'Jaarlijkse omzet per Account',
    'PIPELINE_BY_SALES_STAGE' => 'Pijplijn per verkoopstadium',
    'LEADS_BY_SOURCE' => 'Leads per bron',
    'LEADS_BY_STATUS' => 'Leads per Status',
    'ACCOUNT_TYPES_PER_MONTH' => 'Nieuwe accounts per maand',

    'ERR_CONNECTOR_NOT_ARRAY' => 'connector matrix in {0} zijn onjuist gedefinieerd of leeg en kan niet gebruikt worden.',
    'ERR_SUHOSIN' => 'Upload stream wordt geblokkeerd door Suhosin, voeg &quot;upload&quot; toe aan suhosin.executor.include.whitelist (Zie suitecrm.log voor meer informatie)',
    ...
    'LBL_SUITE_DESC1' => 'SuiteCRM is geschreven en samengesteld door <a href="https://salesagility.com"> SalesAgility</a>.  Het programma wordt geleverd AS IS, zonder garantie.  Licentie onder  AGPLv3.',
    ...
    'LBL_SUITE_DESC3' => 'SuiteCRM is een handelsmerk van SalesAgility Ltd. Alle andere namen van bedrijfs- en productnamen zijn mogelijk handelsmerken van de respectieve bedrijven waarmee ze in verband worden gebracht.',
    ...
    'LBL_SEND_TEST_EMAIL' => 'Testmail verzenden',
    'LBL_SEND_TEST_EMAIL_DESC' => 'Selecteer de e-mailadressen / gebruiker(s) en/of doelenlijst(en) om naar te verzenden.',
    'LBL_EMAIL_SENT_SUCCESSFULLY' => 'E-mail succesvol verzonden',
    'LBL_PROSPECT_LIST_NAME' => 'Verzendlijsten',

    //List View Column Selector Modal
    'LBL_COLUMN_SELECTOR_DISPLAYED_COLS' => 'GETOOND',
    'LBL_COLUMN_SELECTOR_HIDDEN_COLS' => 'VERBORGEN',
    'LBL_COLUMN_SELECTOR_CLOSE_BUTTON' => 'Afsluiten',
    'LBL_COLUMN_SELECTOR_SAVE_BUTTON' => 'Wijzigingen opslaan',
    'LBL_COLUMN_SELECTOR_MODAL_TITLE' => 'Kolommen kiezen',

    // Two-Factor Authentication
    'LBL_ENTER_AUTH_APP_2FA_CODE' => 'Voer de verificatie code van uw authenticatie app in',
    'LBL_ENABLE_2FA_LABEL' => 'Tweestaps verificatie inschakelen',
    'LBL_BACKUP_CODES' => 'Recovery/Backup Codes',
    'LBL_BACKUP_CODES_INFO' => 'Back-up codes zijn eenmalige wachtwoorden wanneer u niet kunt verifiëren via uw Authenticatie app.',
    'LBL_BACKUP_CODES_WARN' => ' WAARSCHUWING: Deze codes worden slechts één keer gegenereerd. Kopieer VOOR verificatie omdat deze niet opnieuw zal worden weergegeven.',
    'LBL_PROBLEMS_GENERATING_CODE' => 'Problemen bij het genereren van de code?',
    'LBL_BACKUP_CODES_FALLBACK_INSTRUCTIONS' => 'Gebruik een van de back-up codes (het verloopt nadat het is gebruikt)',
    'LBL_OTP_SETUP' => 'Gebruik een OTP (eenmalig wachtwoord) authenticator op je mobiel of computer om 2FA (Two-Factor Authentication) in te schakelen.',
    'LBL_QR_CODE_HELP' => "Als u dat nog niet gedaan heeft, download dan een Authenticator applicatie (zoals FreeOTP of Google Authenticator). Gebruik die app om de QR code te scannen.",
    'LBL_USE_SECRET' => "Niet mogelijk om de QR Code te scannen?",
    'LBL_USE_SECRET_DESC' => "Als u de QR-code niet kunt scannen, vul dan het onderstaande geheim handmatig in uw authenticatie app.",
    'LBL_HIDE_SECRET' => "Verberg TOTP geheim",
    'LBL_2FA_LOGIN_CANCEL' => 'Authenticatie in twee stappen geannuleerd',

    'LBL_FACTOR_AUTH_DISABLE' => 'Authenticatie in twee stappen is uitgeschakeld',
    'LBL_FACTOR_AUTH_SUCCESS' => 'Authenticatie in twee stappen is geslaagd',
    'LBL_FACTOR_AUTH_FAIL' => "Authenticatie in twee stappen mislukt. Probeer het opnieuw.",

    'LBL_VERIFY_2FA' => 'Verifieer code',
    'LBL_TWO_FACTOR_AUTH' => 'Authenticatie in twee stappen',
    'LBL_TWO_FACTOR_AUTH_APP_METHOD' => 'Authenticator app',
    'LBL_TWO_FACTOR_AUTH_APP_METHOD_DESCRIPTION' => 'Gebruik een authenticatie app om 2-factor authenticatie codes te genereren wanneer dit wordt gevraagd',
    'LBL_ENABLE' => 'Inschakelen',
    'LBL_ENABLED' => 'Ingeschakeld',
    'LBL_DISABLE' => 'Uitschakelen',
    'LBL_GENERATED' => 'Gegenereerd',
    'LBL_REGENERATE_CODES' => 'Opnieuw genereren',
    'LBL_REGENERATED_BACKUP_CODES' => 'Reservekopie codes opnieuw gegenereerd'
...
$app_list_strings['moduleList']['SurveyQuestionResponses'] = 'Enquête vraag antwoorden';
...
$app_strings['LBL_GOOGLE_SYNC_ERR'] = 'SuiteCRM Google Sync - Fout';
...
$app_strings['LBL_INVALID_EMAIL'] = 'Ongeldig';
$app_strings['LBL_PRIMARY'] = 'Primair';
$app_strings['LBL_EMAIL_ADDRESS'] = 'Email adres';
...
$app_strings['LBL_INSIGHTS'] = 'Inzichten';
$app_strings['LBL_CHARTS'] = 'Grafieken';
$app_strings['LBL_CHART_NOT_FOUND'] = 'Grafiek niet gevonden';
$app_strings['LBL_NO_DATA'] = 'Geen data';
$app_strings['LBL_ERROR_FETCHING_METADATA'] = 'Fout opgetreden bij het ophalen van metadata';
$app_strings['LBL_TOTAL'] = 'Totaal';
$app_strings['LBL_ACTIONS'] = 'Acties';
$app_strings['LBL_SELECT_SUBPANEL_BANNER'] = 'Selecteer welke subpanelen u wilt bekijken';
$app_strings['LBL_SELECT_ITEM'] = 'Selecteer item';
$app_strings['LBL_ITEMS_SELECTED'] = 'geselecteerde items';
$app_strings['LBL_WIDGET_NOT_FOUND'] = 'Widget niet gevonden';
$app_strings['LBL_BAD_CONFIG'] = 'Onjuiste configuratie';
$app_strings['LBL_CONFIG_BAD_CONTEXT'] = 'Onjuiste configuratie: context niet juist geconfigureerd';
$app_strings['LBL_CONFIG_NO_CONFIG'] = 'Onjuiste configuratie: ontbrekende configuratie';
$app_strings['LBL_CONFIG_NO_STATISTICS_KEY'] = 'Onjuiste configuratie: ontbrekende statistieken sleutel';
$app_strings['LBL_STATISTIC_ERROR'] = 'Fout bij laden statistieken';
$app_strings['LBL_STATISTIC_ERROR_DESC'] = 'Fout bij laden statistieken';
$app_strings['LBL_STATISTIC_ERROR_DESC_TOOLTIP'] = 'Fout bij het laden van statistiek. Neem contact op met uw beheerder';
$app_strings['LBL_AVERAGE_CLOSED_WON_PER_YEAR'] = 'Gemiddelde gewonnen kans per jaar';
$app_strings['LBL_OPPORTUNITIES_TOTAL'] = 'Totale Kans Waarde';
$app_strings['LBL_CASE_TOTAL_DAYS_OPEN'] = 'Totaal aantal open dagen';
$app_strings['LBL_DAYS_OPEN'] = 'Dagen geopend';
$app_strings['LBL_DAYS_IN_SALE_STAGE'] = 'DAG(EN) DAT DEZE OPPORTUNITY IN DEZE VERKOOP FASE IS';
$app_strings['LBL_STAT_DAYS'] = 'Dag(en)';
$app_strings['LBL_CLOSED_PER_YEAR'] = 'Gesloten per jaar';
$app_strings['LBL_WAS_OPEN'] = 'Deze zaak is open voor';
$app_strings['LBL_HAS_BEEN_OPEN'] = 'Deze zaak is open geweest voor';
$app_strings['LBL_NUMBER_OF_CASES_PER_ACCOUNT'] = 'Aantal zaken per account';
...
$app_strings['LBL_VALIDATION_ERROR_DATE_FORMAT'] = "Ongeldig datum formaat. Verwacht: '{{context.expected}}'";
$app_strings['LBL_VALIDATION_ERROR_DATETIME_FORMAT'] = "Ongeldig datumtijd formaat. Verwacht: '{{context.expected}}'";
$app_strings['LBL_VALIDATION_ERROR_UNSUBSCRIBE_LINK'] = "Niet-transactionele e-mails moeten een afmeldlink bevatten. Voeg een opt out tracker toe,{{ unsubscribe_link }}' of selecteer het pictogram: ";
$app_strings['LBL_VALIDATION_ERROR_REMOVE_UNSUBSCRIBE_LINK'] = "Transactionele e-mails mogen geen afmeldlink bevatten. Verwijder{{ unsubscribe_link }}'";
...
$app_strings['LBL_NO_PRIMARY_EMAIL_VALIDATION_ERROR'] = "Een geldig e-mailadres moet worden gemarkeerd als primair";
$app_strings['LBL_NO_EM_ID'] = 'Kan E-mail Marketing ID niet ophalen';
$app_strings['LBL_VALIDATION_ERRORS'] = 'Er zijn validatiefouten, het niet mogelijk om actie uit te voeren.';
$app_strings['LBL_LOADING_IN_PROGRESS'] = 'De berekening is bezig, wacht even voordat u het opnieuw probeert.';
$app_strings['LBL_SELECT_EMAIL_FOR_TEST'] = 'Selecteer Targets/ Gebruikers of voer een e-mail in';
$app_strings['LBL_TYPE_TO_SEARCH'] = 'Type om te zoeken...';
$app_strings['LBL_SEARCHING'] = 'bezig met zoeken...';
$app_strings['LBL_NOT_FOUND'] = 'Niet gevonden.';
$app_strings['LBL_SEARCH_ERROR'] = 'Zoek fout.';
$app_strings['LBL_FOUND'] = 'Gevonden';
$app_strings['LBL_GET_RECORD_LIST_ERROR'] = 'Fout bij het ophalen van records';
$app_strings['LBL_NUMBER_OF_RECORDS'] = 'Het aantal records';
$app_strings['LBL_FORWARD_SLASH'] = '/';
$app_strings['LBL_CASES_INSIGHT'] = ' {{fields.cases.value}} ( {{fields.default.value}} )';
$app_strings['LBL_INVOICES_INSIGHT'] = ' {{fields.cases.value}} ( {{fields.default.value}} )';
$app_strings['LBL_CONTRACT_RENEWAL_TOOLTIP'] = 'Datum van de volgende Contract verlenging';
$app_strings['LBL_INVOICES_OVERDUE_TOOLTIP'] = 'Totaal aantal achterstallige facturen';
$app_strings['LBL_ACTIVITIES_NEXT_DATE_TOOLTIP'] = 'Datum van de volgende interactie';
$app_strings['LBL_CAMPAIGN_LAST_RECEIVED_TOOLTIP'] = 'Datum van de meest recente Campagne ontvangen';
$app_strings['LBL_OPEN_CASES_COUNT_TOOLTIP'] = 'Totaal aantal open zaken';
$app_strings['LBL_EVENTS_LAST_DATE_TOOLTIP'] = 'Datum van het meest recente evenement';
$app_strings['LBL_HISTORY_LAST_DATE_TOOLTIP'] = 'Datum van de meest recente interactie';
$app_strings['LBL_OPPORTUNITIES_TOTAL_SUM_TOOLTIP'] = 'Totaal som van kansen';
$app_strings['LBL_QUOTES_EXPIRY_TOOLTIP'] = 'Datum waarop de volgende offerte vervalt';
$app_strings['LBL_DEFAULT_TOTAL_TOOLTIP'] = 'Totaal aantal Records';
$app_strings['LBL_CONTRACT_RENEWAL'] = 'Verlengingsdatum';
$app_strings['LBL_INVOICES_OVERDUE'] = 'Totaal achterstallig';
$app_strings['LBL_ACTIVITIES_NEXT_DATE'] = 'Volgende activiteit datum';
$app_strings['LBL_CAMPAIGN_LAST_RECEIVED'] = 'Laatst deelgenomen';
$app_strings['LBL_OPEN_CASES_COUNT'] = 'Open Zaken';
$app_strings['LBL_EVENTS_LAST_DATE'] = 'Laatste evenement bezocht';
$app_strings['LBL_HISTORY_LAST_DATE'] = 'Laatste Touchpoint';
$app_strings['LBL_OPPORTUNITIES_TOTAL_SUM'] = 'Totale waarde';
$app_strings['LBL_QUOTES_EXPIRY'] = 'Volgende vervaldatum';
$app_strings['LBL_DEFAULT_TOTAL'] = 'Totaal';
$app_strings['AOS_Contracts'] = 'Contracten';
$app_strings['AOS_Quotes'] = 'Offertes';
$app_strings['AOS_Invoices'] = 'Facturen';
$app_strings['LBL_PHOTO'] = 'Foto';
$app_strings['LBL_CASE_UPDATES'] = 'Verzoek bijwerken';
$app_strings['LBL_CASE_UPDATE_SUBMITTED'] = 'Zaak update verzonden';
...
$app_strings['LBL_CREATE'] = 'Maak aan';
$app_strings['LBL_CLEAR_FILTER'] = 'Filter wissen';
$app_strings['LBL_QUICK_FILTERS'] = 'Quick Filters';
$app_strings['LBL_SAVED_FILTER_SAVED'] = 'Filter succesvol opgeslagen';
$app_strings['LBL_FILTER_ID_NOT_DEFINED'] = 'Filter ID niet gedefinieerd';
$app_strings['LBL_GENERIC_CONFIRMATION'] = 'Wilt u doorgaan met deze actie?';
$app_strings['LBL_SHOW_MORE'] = 'Meer tonen';
$app_strings['LBL_SHOW_LESS'] = 'Minder tonen';
$app_strings['LBL_LOAD_MORE'] = 'Meer laden';
$app_strings['LBL_EMPTY'] = '-- Leeg --';
$app_strings['LBL_OPERATOR'] = 'Operator';
$app_strings['LBL_START'] = 'Start';
$app_strings['LBL_END'] = 'Einde';
$app_strings['LBL_LINE_ITEMS_FIELD_CONFIG'] = 'Verkeerde configuratie';


$app_strings['LBL_ACTION_SUCCESS'] = 'Actie succesvol';

$app_strings['LBL_YES'] = 'Ja';
$app_strings['LBL_NO'] = 'Nee';

$app_list_strings['sort_order'] = [];
$app_list_strings['sort_order']['asc'] = 'Oplopend';
$app_list_strings['sort_order']['desc'] = 'Aflopend';
...
$app_strings['LBL_UNLINK_RELATIONSHIP_FAILED'] = 'Er is een fout opgetreden bij het ontkoppelen van dit record.';
$app_strings['LBL_ALL_RECORDS_UNLINKED'] = 'Alle records zijn met succes ontkoppeld';
$app_strings['LBL_SOME_RECORDS_UNLINKED_FAILED'] = 'Er was een probleem met het ontkoppelen van sommige records. Zie de logs voor meer.';
$app_strings['LBL_LINK_RELATIONSHIP_SUCCESS'] = 'Relationship succesvol gekoppeld.';
...
$app_strings['LBL_ADD_RECORDS_TO_TARGET_LIST_SUCCESS'] = 'Records succesvol aan doellijst toegevoegd.';
$app_strings['LBL_ADD_RECORDS_TO_TARGET_LIST_FAILED'] = 'Er is een fout opgetreden bij het toevoegen van records aan de doellijst.';
$app_strings['LBL_ADD_CONTACTS_TO_TARGET_LIST_SUCCESS'] = 'Contactpersonen met succes aan de doellijst toegevoegd.';
$app_strings['LBL_ADD_CONTACTS_TO_TARGET_LIST_FAILED'] = 'Er is een fout opgetreden bij het toevoegen van contacten aan de doellijst.';
$app_strings['LBL_CHANGED_TO_TEXT'] = 'gewijzigd naar';
$app_strings['LBL_RECORD_CHANGED'] = 'Record bijgewerkt';
$app_strings['LBL_CREATE'] = "Maak aan";
$app_strings['LBL_USE_ADVANCED_SEARCH'] = 'Gebruik geavanceerd zoeken';
$app_strings['LBL_USE_BASIC_SEARCH'] = 'Gebruik standaard zoeken';
$app_strings['LBL_NO_MODULE_SELECTED'] = 'Geen module geselecteerd';
$app_strings['LBL_CLOSE_MENU'] = 'Menu sluiten';
$app_strings['LOGIN_INCORRECT'] = 'Inloggegevens onjuist, probeer het opnieuw.';
$app_strings['LOGIN_TOO_MANY_FAILED'] = 'Te veel mislukte inlogpogingen, probeer het later opnieuw.';
...
$app_strings['LBL_RELATIONSHIPS'] = 'Relaties';
$app_strings['LBL_SHOW_CC'] = 'Toon CC';
$app_strings['LBL_SHOW_BCC'] = 'Toon Bcc';
$app_strings['LBL_CC'] = 'Cc';
$app_strings['LBL_BCC'] = 'Bcc';
$app_strings['LNK_NEW_EMAIL'] = 'Nieuwe e-mail';
$app_strings['LBL_INSERT_TEMPLATE'] = 'Insert Template';
$app_strings['LBL_MISSING_RECORD_DATA'] = 'Ontbrekende Record Data';
$app_strings['LBL_MISSING_FIELDS_DATA'] = 'Ontbrekende veld gegevens';
$app_strings['LBL_WRONG_MODULE_PROVIDED'] = 'Verkeerde module opgegeven';
...
$app_strings['LBL_SMALL'] = 'Klein';
$app_strings['LBL_MEDIUM'] = 'Medium';
$app_strings['LBL_NORMAL'] = 'Normaal';
$app_strings['LBL_LARGE'] = 'Groot';
$app_strings['LBL_HUGE'] = 'Enorme';
$app_strings['LBL_DEFAULT'] = 'Standaard';
$app_strings['LBL_APPLY'] = 'Toepassen';
$app_strings['LBL_INSERT_LINK_URL_DESCRIPTION'] = 'Insert URL or email:';
$app_strings['LBL_INSERT_LINK_PLACEHOLDER'] = 'bijvoorbeeld: https://www.voorbeeld.com';

$app_strings['LBL_COLOR_BLACK'] = 'Zwart';
$app_strings['LBL_COLOR_FIREBRICK'] = 'Firebrick';
$app_strings['LBL_COLOR_RED'] = 'Rood';
$app_strings['LBL_COLOR_SALMON'] = 'Zalm';
$app_strings['LBL_COLOR_BLUSH'] = 'Blush';
$app_strings['LBL_COLOR_DARK_RED'] = 'Donker Rood';
$app_strings['LBL_COLOR_BROWN'] = 'Bruin';
$app_strings['LBL_COLOR_DARK_ORANGE'] = 'Donker Oranje';
$app_strings['LBL_COLOR_ORANGE'] = 'Oranje';
$app_strings['LBL_COLOR_ANTIQUE_WHITE'] = 'Antiek wit';
$app_strings['LBL_COLOR_SADDLE_BROWN'] = 'Zadel Bruin';
$app_strings['LBL_COLOR_GOLDENROD'] = 'Gouden Staaf';
$app_strings['LBL_COLOR_GOLD'] = 'Goud';
$app_strings['LBL_COLOR_YELLOW'] = 'Geel';
$app_strings['LBL_COLOR_LIGHT_YELLOW'] = 'Licht Geel';
$app_strings['LBL_COLOR_DARK_SLATE_GRAY'] = 'Donker Grijs';
$app_strings['LBL_COLOR_DARK_GREEN'] = 'Donker Groen';
$app_strings['LBL_COLOR_GREEN'] = 'Groen';
$app_strings['LBL_COLOR_LIME'] = 'Lichtgroen';
$app_strings['LBL_COLOR_HONEYDEW'] = 'Honeydew';
$app_strings['LBL_COLOR_TEAL'] = 'Groenblauw';
...
$app_strings['LBL_COLOR_NAVY_BLUE'] = 'Marine blauw';
$app_strings['LBL_COLOR_MEDIUM_BLUE'] = 'Middel blauw';
$app_strings['LBL_COLOR_BLUE'] = 'Blauw';
$app_strings['LBL_COLOR_LIGHT_BLUE'] = 'Lichtblauw';
$app_strings['LBL_COLOR_ALICE_BLUE'] = 'Alice blauw';
$app_strings['LBL_COLOR_INDIGO'] = 'Indigo';
$app_strings['LBL_COLOR_PATRIARCH_PURPLE'] = 'Patriarch paars';
$app_strings['LBL_COLOR_VIOLET_PURPLE'] = 'Paars Paars';
$app_strings['LBL_COLOR_PLUM'] = 'Pruim';
$app_strings['LBL_COLOR_LAVENDER'] = 'Lavender';
$app_strings['LBL_COLOR_DIM_GRAY'] = 'Dim Grijs';
$app_strings['LBL_COLOR_GRAY'] = 'Grijs';
$app_strings['LBL_COLOR_DARK_GRAY'] = 'Donker grijs';
$app_strings['LBL_COLOR_LIGHT_GRAY'] = 'Lichtgrijs';
$app_strings['LBL_COLOR_WHITE'] = 'Wit';

$app_strings['LBL_BOLD'] = 'Vet';
$app_strings['LBL_ITALIC'] = 'Italic';
$app_strings['LBL_UNDERLINE'] = 'Onderstrepen';
$app_strings['LBL_STRIKETHROUGH'] = 'Doorhalen';
$app_strings['LBL_FONT_FACE'] = 'Font Face';
$app_strings['LBL_TEXT_SIZE'] = 'Tekstgrootte';
$app_strings['LBL_TEXT_COLOR'] = 'Tekst kleur';
$app_strings['LBL_TEXT_HIGHLIGHT'] = 'Tekst accentuering';
$app_strings['LBL_LINK'] = 'Link';
$app_strings['LBL_UNORDERED_LIST'] = 'Ongeordende lijst';
...
$app_strings['LBL_JUSTIFY'] = 'Uitlijnen';
$app_strings['LBL_TEXT_LEFT_TO_RIGHT'] = 'Tekst richting: links naar rechts';
$app_strings['LBL_TEXT_RIGHT_TO_LEFT'] = 'Tekst richting: van rechts naar links';
$app_strings['LBL_CLEAR_FORMATTING'] = 'Opmaak wissen';
$app_strings['LBL_INJECT_UNSUBSCRIBE'] = 'Link opzeggen';
$app_strings['LBL_TEXT_INDENT_LEFT'] = 'Inspringen tekst links';
$app_strings['LBL_TEXT_INDENT_RIGHT'] = 'Inspringen tekst rechts';

// Day and Time labels
$app_strings['LBL_SUN'] = 'Zondag';
$app_strings['LBL_MON'] = 'Maandag';
$app_strings['LBL_TUE'] = 'Dinsdag';
$app_strings['LBL_WED'] = 'Woensdag';
$app_strings['LBL_THU'] = 'Donderdag';
$app_strings['LBL_FRI'] = 'Vrijdag';
$app_strings['LBL_SAT'] = 'Zaterdag';
$app_strings['LBL_ALL'] = 'Elke dag';
$app_strings['LBL_EVERY'] = 'elke ';
$app_strings['LBL_ON_THE'] = 'Op de';
$app_strings['LBL_RANGE'] = 'naar';
$app_strings['LBL_FROM'] = 'Van';
$app_strings['LBL_AND'] = 'en';
$app_strings['LBL_MINS'] = 'Min';
$app_strings['LBL_MINUTES'] = 'minuten';
$app_strings['LBL_HOUR'] = 'uren';
$app_strings['LBL_HOUR_SING'] = ' uur';
$app_strings['LBL_OFTEN'] = ' Zo vaak mogelijk';
$app_strings['LBL_MIN_MARK'] = ' minuutaanwijzing';
$app_strings['LBL_INBOUND_EMAIL'] = 'Inkomende e-mails';

$app_strings['LBL_LEGEND'] = 'Legenda';

$app_strings['LBL_EMAIL_MARKETING_NOT_UNSCHEDULED'] = 'E-mail Marketing is niet Un Scheduled kan niet plannen';
$app_strings['LBL_INCORRECT_RECORD_ID'] = 'Onjuiste record-id';

$app_strings['LBL_TEST_ENTRIES_DELETED'] = 'Test items verwijderd.';
$app_strings['LBL_UNABLE_TO_GET_ID'] = 'Kan emailmarketing-ID niet ophalen';
...
$app_strings['LBL_CRON_LAST_RUN'] = 'Laatste succesvolle uitgevoering';
$app_strings['LBL_CRON_LAST_USER_TO_RUN'] = 'Laatste gebruiker om schedulers uit te voeren';
$app_strings['LBL_LAST_RUN_VALUE'] = '{{ fields.lastRun.value }}';
$app_strings['LBL_LAST_USER_RUN_VALUE'] = '{{ fields.user.value }}';
$app_strings['LBL_RUN_USER_INVALID'] = 'Deze gebruiker maakt geen deel uit van de `allowed_cron_users` configuratie. Daarom was de laatste uitvoering niet succesvol';
$app_strings['LBL_SCHEDULERS_NEVER_RUN'] = 'Schedulers zijn nog nooit uitgevoerd.';
$app_strings['LBL_MARKETING_ITEMS_PER_RUN'] = 'Campagne marketing items per Run';
$app_strings['LBL_EMAILS_PER_RUN'] = 'Campagne E-mails per Run';
$app_strings['LBL_TRACKERS_ENABLED'] = 'Trackers ingeschakeld';
$app_strings['LBL_TRACKER_LINKS_ENABLED'] = 'Tracker Links Ingeschakeld';
...
$app_strings['LBL_INACTIVE'] = 'Inactief';
$app_strings['LBL_DISPLAYING_TEST_EMAIL_MARKETING_DATA'] = 'Grafieken en subpanelen worden momenteel op basis van test-e-mails weergegeven.';
$app_strings['LBL_DASH_SYMBOL'] = '-';
$app_strings['LBL_FIELD_STORAGE_NOT_SET'] = 'Opslagtype bestand niet ingesteld voor het veld. Kan bestand niet uploaden.';
$app_strings['LBL_FIELD_STORAGE_INVALID_TYPE'] = 'Het bestandsopslag type is niet geldig voor het veld. Kan het bestand niet uploaden.';
...
$app_strings['LBL_UNKNOWN_USER'] = 'Onbekende gebruiker';
