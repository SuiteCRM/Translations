...
$mod_strings = array(
    ...
    'LBL_NAME' => 'Naam: ',
    'LBL_PROSPECT_INFORMATION' => 'OVERZICHT', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
    ...
    'LBL_ALT_ADDRESS_POSTALCODE' => 'Alternatieve adres postcode:',
    ...
    'LBL_OPP_NAME' => 'Naam kans:',
    'LBL_IMPORT_VCARD' => 'Importeer vCard',
    'LBL_IMPORT_VCARDTEXT' => 'Maak automatisch een nieuwe contactpersoon aan door een vCard van uw bestandssysteem te importeren.',
    ...
    'NTC_REMOVE_CONFIRMATION' => 'Weet u zeker dat u deze contactpersoon wilt verwijderen uit het verzoek?',
    'ERR_DELETE_RECORD' => 'Er moet een record nummer zijn gespecificeerd om de contactpersoon te verwijderen.',
    'LBL_SALUTATION' => 'Aanhef',
    'LBL_CREATED_OPPORTUNITY' => 'Nieuwe kans aangemaakt',
    'LNK_SELECT_ACCOUNT' => "Selecteer organisatie",
    ...
    'LBL_SELECT_CHECKED_BUTTON_TITLE' => 'Selecteer aangevinkte doelen',
    ...
    'LBL_CAMPAIGN_LIST_SUBPANEL_TITLE' => 'Campagnelog',
