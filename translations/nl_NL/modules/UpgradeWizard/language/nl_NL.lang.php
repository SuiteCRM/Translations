...
$mod_strings = array(
    ...
    'ERR_UW_CONFIG_WRITE' => 'Fout bij het bijwerken van config.php met nieuwe versie informatie.',
    ...
    'ERR_UW_NO_MANIFEST' => 'In het Zip-bestand ontbreekt een manifest.php bestand. Kan niet doorgaan.',
    ...
    'LBL_BUTTON_BACK' => '< Vorige',
    'LBL_BUTTON_CANCEL' => 'Annuleer',
    'LBL_BUTTON_DELETE' => 'Pakket verwijderen',
    'LBL_BUTTON_DONE' => 'Gereed',
    ...
    'LBL_UW_SHOW_DETAILS' => 'Details tonen',
    ...
    'ERR_CHECKSYS_PHP_INVALID_VER' => 'Uw versie van PHP wordt niet ondersteund door SuiteCRM. U moet een versie hebben die compatibel is met SuiteCRM toepassing. Raadpleeg de Compatibility Matrix in de Release Notes voor ondersteunde PHP-versies. Uw versie is ',
    'LBL_BACKWARD_COMPATIBILITY_ON' => 'Php Backward Compatibility modus is ingeschakeld. Zet zend.ze1_compatibility_mode op Off om verder te gaan',
    //including some strings from moduleinstall that are used in Upgrade
    'LBL_ML_ACTION' => 'Actie',
    'LBL_ML_CANCEL' => 'Annuleer',
    'LBL_ML_COMMIT' => 'Vastleggen',
    'LBL_ML_DESCRIPTION' => 'Omschrijving',
    'LBL_ML_INSTALLED' => 'Datum geinstalleerd',
    'LBL_ML_NAME' => 'Naam',
    'LBL_ML_PUBLISHED' => 'Datum gepubliceerd',
    'LBL_ML_TYPE' => 'Type',
    'LBL_ML_UNINSTALLABLE' => 'De-installeerbaar',
    'LBL_ML_VERSION' => 'Versie',
    'LBL_ML_INSTALL' => 'Installeer',
    ...
    'LBL_LAYOUT_MODULE_TITLE' => 'Schermindelingen',
    ...
    'LBL_UW_CONFIRM_LAYOUTS' => 'Bevestig schermindelingen',
    ...
    'ERROR_VERSION_INCOMPATIBLE' => 'Dit bestand is niet compatibel met deze versie van SuiteCRM: ',
    'ERROR_PHP_VERSION_INCOMPATIBLE' => 'Het geuploade bestand is niet compatibel met deze PHP versie: ',
    'ERROR_SUITECRM_VERSION_INCOMPATIBLE' => 'Dit bestand is niet compatibel met deze versie van SuiteCRM: ',
    ...
    'LBL_THEMES' => 'Thema\'s' /*for 508 compliance fix*/,
    ...
    'ERR_UW_PHP_FILE_ERRORS' => array(
        1 => 'Het geüploade bestand overschrijdt de upload_max_filesize waarde in php.ini.',
        ...
        5 => 'Onbekende fout',
        6 => 'Een tijdelijke map ontbreekt.',
        7 => 'Bestand naar schijf schrijven is mislukt.',
