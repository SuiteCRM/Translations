...
// OOTB Scheduler Job Names:
    ...
    'LBL_OOTB_CLEAN_UP_TEMP_FILES' => 'Opschonen tijdelijke bestanden',
...
// Cron
    ...
    'LBL_CRON_SETUP' => 'Schedulers instellen',
    ...
    'LBL_CRON_LINUX_DESC1' => 'Om SuiteCRM schedulers uit te voeren',
    'LBL_CRON_LINUX_DESC2' => '1. Bewerk het crontab bestand van uw webserver met deze command',
    'LBL_CRON_LINUX_DESC3' => '2. Update en voeg de volgende regel toe aan het crontab bestand:',
    'LBL_CRON_LINUX_DESC4' => 'U moet dit alleen doen als de installatie is afgesloten.',
    'LBL_CRON_LINUX_DESC5' => '2(i). Om de omgevingsvariabelen te definiëren, voeg de volgende regel toe:',
    'LBL_CRON_LINUX_DESC6' => 'Update [path/naar/php] en [path/naar/suite/instance] om uw omgeving te weerspiegelen.',
    'LBL_CRON_WINDOWS_DESC' => 'Om de SuiteCRM planners uit te voeren',
    'LBL_CRON_WINDOWS_DESC2' => '1. Maak een batchbestand aan om uit te voeren met behulp van Windows geplande taken. Het batch-bestand moet de volgende commando\'s bevatten:',
    'LBL_CRON_WINDOWS_DESC3' => 'Update [path\to\php.exe] en [path\to\suite\instance] om uw omgeving te reflecteren.',
    'LBL_SCHEDULERS_INFO' => 'Scheduler Informatie',
    'LBL_SCHEDULERS_NEVER_RUN' => 'Schedulers zijn nog nooit uitgevoerd.',
    // Subpanels
...
//jobstrings
    ...
    'LBL_RUNMASSEMAILCAMPAIGN' => 'Draai nachtelijke massale e-mail campagnes',
    'LBL_POLLMONITOREDINBOXESFORBOUNCEDCAMPAIGNEMAILS' => 'Draai nachtelijke bounced campagne e-mails',
    'LBL_PRUNEDATABASE' => 'Opschonen database op de 1e van de maand',
    'LBL_TRIMTRACKER' => 'Opschonen tracker tabellen',
    'LBL_TRIMSUGARFEEDS' => 'Verwijder SuiteCRM feed tebellen',
    ...
    'LBL_SENDFROMQUEUE' => 'Verstuur e-mails uit de emailwachtrij',
    'LBL_CLEANUPTEMPORARYFILES' => 'Opschonen tijdelijke bestanden',
    'LBL_EMAILTOQUEUE' => 'Verzend geplande e-mails naar e-mail wachtrij',
