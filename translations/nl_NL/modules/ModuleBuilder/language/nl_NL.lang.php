...
$mod_strings = array(
    ...
    'help' => array(
        ...
        'listViewEditor' => array(
            'modify' => 'Alle velden die beschikbaar zijn voor de <b>Lijstweergave</ b> worden hier getoond. <br> <br/>  De <b> Standaard </ b> kolom bevat de velden die in de Lijstweergave standaard worden getoond. <br /> <br/> De <b> Beschikbaar </ b> kolom bevat velden die een gebruiker kan selecteren om zo een eigen listview te maken. <br/> De <b> Verborgen </ b> kolom bevat velden die kunnen worden toegevoegd aan de Standaard- of Beschikbaar kolom, maar niet zichtbaar zijn voor de gebruiker.'
        ,
            'savebtn' => 'Klik op <b>Opslaan & Implementeren</b> om wijzigingen die je hebt aangebracht op te slaan en ze actief te maken binnen de module.',
            'historyBtn' => 'Klik op <b>Bekijk Geschiedenis</b> om eerder opgeslagen lay-outs te bekijken en eventueel te herstellen.',
            'historyDefault' => 'Klik op <b>Herstel Standaard</b> om een lay-out naar het origineel te terug te zetten.',
            'Hidden' => '<b>Verborgen</b> velden zijn niet beschikbaar voor gebruikers in de Lijstweergave.',
            'Available' => '<b>Beschikbaar</b> velden worden standaard niet getoond, maar kunnen wel worden toegevoegd door de gebruiker aan de Lijstweergave.',
            'Default' => '<b>Standaard</b> velden verschijnen in Lijstweergave die niet zijn aangepast door de gebruikers.'
        ),
        'popupListViewEditor' => array(
            'modify' => 'Alle velden die beschikbaar zijn voor de <b> Lijstweergave </ b> worden hier getoond. <br> <br/>  De <b> Standaard </ b> kolom bevat de velden die in de Lijstweergave standaard worden getoond. <br> <br/>  De <b> Verborgen </ b> kolom bevat velden die kunnen worden toegevoegd aan de Standaard- of Beschikbaar kolom, maar niet zichtbaar zijn voor de gebruiker.'
        ,
            'savebtn' => 'Klik op <b>Opslaan & Implementeren</b> om wijzigingen die je hebt aangebracht op te slaan en ze actief te maken binnen de module.',
            'historyBtn' => 'Klik op <b>Bekijk Geschiedenis</b> om een eerder opgeslagen lay-out van de geschiedenis te bekijken en te herstellen.<br><br><b>Herstel</b> binnen <b>Geschiedenis weergeven</b> herstelt de veldplaatsing binnen eerder opgeslagen lay-outs. Om veldlabels te wijzigen, klik op het Bewerken icoon naast elk veld.',
            'historyDefault' => 'Klik op <b>Herstel standaard</b> om een eerder opgeslagen lay-out van de geschiedenis te bekijken en te herstellen.<br><br><b>Herstel standaard</b> herstelt de standaard veldplaatsing. Om veldlabels te wijzigen, klik op het Bewerken icoon naast elk veld.',
            'Hidden' => '<b>Verborgen</b> velden zijn momenteel niet beschikbaar voor gebruikers om te zien in de Lijstweergave.',
            'Default' => '<b>Standaard</b> velden verschijnen in Lijstweergaves die niet zijn aangepast door gebruikers.'
        ),
        'searchViewEditor' => array(
            'modify' => 'Alle velden die kunnen weergegeven worden in het venster <b>Formulierfilter</b> verschijnen hier. <br><br>De kolom <b>Standaard</b> bevat de velden die worden weergegeven in het zoekformulier. <br/> <br/> De <b>Verborgen</b> kolom bevat velden die beschikbaar zijn voor (u) de beheerder om toe te voegen aan het zoekformulier.'
        ,
            'savebtn' => 'Klik op <b>Opslaan & Implementeren </b> om wijzigingen op te slaan en om ze te activeren binnen de module.',
        ...
        'layoutEditor' => array(
            'defaultdetailview' => 'Het <b> lay-out </b> gebied bevat de velden die momenteel worden weergegeven in de <b> Detailweergave </b>. <br/> De <b> Toolbox </b> bevat de <b> Prullenbak </b> en de velden en lay-out elementen die kunnen worden toegevoegd. <br> Wijzig de lay-out door klikken en slepen van elementen en velden tussen de <b> Toolbox </b> en de <b> lay-out </b> Dit kan ook binnen de lay-out zelf. <br> Voor het verwijderen van een veld uit de lay-out, moet men het veld naar de <b> Prullenbak </b> slepen. Het veld zal dan beschikbaar zijn in de Toolbox om opnieuw toe te voegen aan de lay-out.',
            ...
            'default' => 'Het <b> lay-out </b> gebied bevat de velden die momenteel worden weergegeven in de <b> Bewerkweergave </b>. <br/> <br/>De <b> Toolbox </b> bevat de <b> Prullenbak </b> en de velden en lay-out elementen die kunnen worden toegevoegd. <br><br> Wijzig de lay-out door klikken en slepen van elementen en velden tussen de <b> Toolbox </b> en de <b> lay-out </b> Dit kan ook binnen de lay-out zelf. <br><br> Voor het verwijderen van een veld uit de lay-out, moet men het veld naar de <b> Prullenbak </b> slepen. Het veld zal dan beschikbaar zijn in de Toolbox om opnieuw toe te voegen aan de lay-out.',
        ...
        'studioWizard' => array(
            ...
            'viewBtnEditView' => 'Pas de <b>Bewerkweergave</b> van de module aan.<br><br>De Bewerkweergave is de lay-out waar de gebruiker zijn data invoert.',
            'viewBtnDetailView' => 'Pas de <b>Detailweergave</b> van de module aan.<br><br>De Detailweergave is de lay-out waar informatie wordt getoond.',
            'viewBtnDashlet' => 'Pas de <b>SuiteCRM Dashlet</b> layout aan van de module, inclusief de SuiteCRM Dashlet\'s Lijstweergave en Zoekfunctie.<br><br>De SuiteCRM Dashlet wordt beschikbaar om toe te voegen aan de pagina\'s in de Start-module.',
            'viewBtnListView' => 'Pas de <b> Lijstweergave </b> van de module aan. <br><br> Zoekresultaten verschijnen in de Lijstweergave.',
            'searchBtn' => 'Pas de <b> Zoek </b> lay-outs van de module aan. <br><br>Bepaal welke velden kunnen worden gebruikt om records te zoeken die vervolgens worden weergegeven in de Lijstweergave.',
            ...
            'searchHelp' => 'De <b>Zoek</b>-formulieren die kunnen worden aangepast, worden hier weergegeven. <br><br>Zoekformulieren bevatten velden voor het filteren van records.<br><br>Klik op een pictogram om de indeling van de filter te selecteren of te bewerken.',
            ...
            'DashletListViewBtn' => 'De <b>SuiteCRM Dashlets Lijstweergave</b> toont records gebaseerd op de SuiteCRM Dashlets zoekfilters.',
            'DashletSearchViewBtn' => 'De <b>SuiteCRM Dashlet Zoek</b> records voor de SuiteCRM Dashlet Lijstweergave Klantentelefoonlijst filteren.',
            'popupHelp' => 'De <b> Popup </ b> lay-outs die kunnen worden aangepast verschijnen hier. <br>',
            'PopupListViewBtn' => 'De <b> Popup Lijstweergave </b> toont records gebaseerd op de Popup zoekweergaven.',
            'PopupSearchViewBtn' => 'Het <b> Popup Zoeken </b> toont records voor de Popup Lijstweergave.',
            'BasicSearchBtn' => 'Pas de <b>Snelle Filter</b>-formulier die wordt weergegeven in het tabblad Snelle Filter aan in het Zoek-gebied voor de module.',
            'AdvancedSearchBtn' => 'Pas het <b>Geavanceerde Filter</b>-formulier aan dat wordt weergegeven in het tabblad Geavanceerd Zoeken in het Zoek-gebied voor de module.',
            ...
            'convertLeadHelp' => 'Hier kunt u de modules naar de indeling converteren scherm en wijzigen van de lay-outs van bestaande toevoegen. <br/> U kunt de modules opnieuw bestellen door hun rijen in de tabel te slepen. <br/> <br/> <b>Module:</b> De naam van de module. <br/> <br/> <b>Nodig:</b> Vereiste modules moeten worden gemaakt of kan worden geselecteerd voordat het voortouw kan worden geconverteerd. <br/> <br/> <b>Kopiëren van gegevens:</b> Indien aangevinkt, velden van de lead wordt gekopieerd naar de velden met dezelfde naam in de zojuist gemaakte records. <br/> <br/> <b>Selectie toestaan:</b> Modules aan een veld koppelen in contactpersonen kunnen worden geselecteerd in plaats van gemaakt tijdens de lead converteren. <br/> <br/> <b>Bewerken:</b> Wijzigen van de indeling converteren voor deze module. <br/> <br/> <b>Verwijderen:</b> Deze module verwijderen uit de indeling converteren. <br/> <br/>',
        ...
        'relationshipsHelp' => array(
            ...
            'addrelbtn' => 'muis over hulp voor relatie toevoegen...',
    ...
    'assistantHelp' => array(
        ...
        'listViewEditor' => array(
            'modify' => 'Er worden drie kolommen weergegeven aan de linkerkant. De "Standaard" kolom bevat de velden die standaard worden weergegeven in de Lijstweergave, De kolom "Beschikbaar" bevat velden die een gebruiker kan kiezen voor het maken van een aangepaste Lijstweergave. en de "Verborgen" kolom bevat velden die beschikbaar zijn voor u als beheerder om de standaard of beschikbare kolommen toe te voegen voor gebruikers maar is momenteel uitgeschakeld.',
            'savebtn' => 'Klik op  <b>Opslaan & Implementeren</b> om wijzigingen op te slaan en te activeren binnen de module.',
            'Hidden' => '<b>Verborgen</b> velden zijn niet beschikbaar voor gebruikers in de Lijstweergave',
            'Available' => 'Beschikbare velden zijn velden die standaard niet worden weergegeven, maar wel kunnen worden ingeschakeld door gebruikers.',
            'Default' => 'Standaardvelden worden weergegeven aan gebruikers die geen aangepaste lijstweergave-instellingen hebben gemaakt.'
        ),
        ...
        'layoutEditor' => array(
            'default' => 'Er worden twee kolommen aan de linkerkant weergegeven. In de rechterkolom, gelabeld op de lay-out of de lay-out weergave, verandert u de lay-out van de module. De linkerkolom, getiteld Toolbox, bevat nuttige elementen en gereedschappen om te gebruiken bij het bewerken van de lay-out. <br/><br/>Als de lay-outzone is getiteld Huidige lay-out, dan werkt u aan een kopie van de lay-out die momenteel door de module voor weergave wordt gebruikt.<br/><br/>Als het een preview van de lay-out met de titel is, werkt u aan een kopie die eerder is gemaakt door op de knop Opslaan te klikken. dat kan veranderd zijn van de versie die gezien wordt door gebruikers van deze module.',
            'saveBtn' => 'Klik op <b>Opslaan</b> om de wijzigingen te behouden. <br> De veranderingen zullen niet in de module worden weergegeven totdat u <b> Opslaan & Implementeren</b> kiest.',
            'publishBtn' => 'Klik op <b> Opslaan & Implementeren </ b> om alle wijzigingen die u aan de lay-out gemaakt sinds de laatste keer op te slaan, en om de veranderingen te activeren in de module. <br> De lay-out zal onmiddellijk worden weergegeven in de module.',
            'toolbox' => 'De <b> Toolbox </ b> bevat de <b> Prullenbak </ b> ,extra layout-elementen en alle beschikbare velden. <br/> Alle velden en elementen in de toolbox kunnen naar de layout worden gesleept en andersom. <br> De lay-out elementen bestaan uit <b> Panelen </ b> en <b > Rijen </ b>. Het toevoegen van een nieuwe rij of een nieuw paneel aan de lay-out zorgt voor extra ruimte in de lay-out zodat velden kunnen worden toegevoegd. <br/> Sleep een veld van de toolbox naar een bezet veld op de lay-out (en vice versa) om van plaats te wisselen. <br/> Het <b>Filler</b> veld creëert lege ruimte in de lay-out waar hij wordt geplaatst.',
            'panels' => 'Het <b> lay-out </ b> gebied laat zien hoe de lay-out wordt binnen de module wanneer de wijzigingen worden opgeslagen en geïmplementeerd. <br/> U kunt velden, rijen en panelen herpositioneren door te slepen en neer te zetten op de gewenste plaats. <br/> Elementen zijn te verwijderen door ze te slepen naar de <b> Prullenbak </ b> in de Toolbox, of toe te voegen door ze te slepen uit de <b> Toolbox </ b> en ze te los te laten op de gewenste locatie in de lay-out.'
        ...
        'exportcustom' => array(
            'exportHelp' => '<b>Exporteren Aanpassingen</b> via de Studio creëert een maatwerkpakket die in een andere SuiteCRM toepassing geladen kan worden via <b>Module Beheer</b><br><br>  Geef eerst een <b>PakketNaam</b> op.  U kunt daarna de  <b>Auteur</b> en een <b>Beschrijving</b> opgeven.<br><br>Selecteer de modules die de aanpassingen bevatten die u wil exporteren. Alleen aangepaste modules zullen getoond worden om te exporteren.<br><br>Klik dan vervolgens op  <b>Exporteren</b> om een .zip bestand aan te maken die alle wijzigingen bevat.',
            'exportCustomBtn' => 'Klik op <b>Exporteren</b> om een .zip bestand aan te maken met daarin alle aanpassingen die u wil exporteren.',
            'name' => 'Dit is de <b>Naam</b> van het pakket. Deze naam wordt getoond tijdens de installatie.',
            'author' => 'Dit is de <b>Auteur</b> die wordt getoond tijdens de installatie als de naam van de persoon/organisatie die het pakket heeft aangemaakt.',
        ...
        'studioWizard' => array(
            'mainHelp' => 'Welkom bij de <b>Developer Tools</b> omgeving.<br/><br/>Gebruik de gereedschappen in deze omgeving voor het creëren en beheren van standaard en aangepaste modules velden.',
            ...
            'mbBtn' => 'Gebruik de <b>Module Bouwer</b> om nieuwe modules te maken.',
            ...
            'newPackage' => 'Klik <b>Nieuw Pakket</b> om een nieuw pakket aan te maken.',
...
//HOME
    'LBL_HOME_EDIT_DROPDOWNS' => 'Drop-down editor',

//STUDIO2
    'LBL_MODULEBUILDER' => 'Module Bouwer',
    'LBL_STUDIO' => 'Studio',
    'LBL_DROPDOWNEDITOR' => 'Drop-down editor',
    'LBL_DEVELOPER_TOOLS' => 'Hulpmiddelen voor ontwikkelaars',
    'LBL_SUITEPORTAL' => 'SuiteCRM Portaal Editor',
    ...
    'LBL_BASIC' => 'Normaal',
    'LBL_BASIC_SEARCH' => 'Snel filteren',
    'LBL_CURRENT_LAYOUT' => 'lay‐out',
    'LBL_CURRENCY' => 'Valuta',
    'LBL_DASHLET' => 'SuiteCRM Dashlet',
    'LBL_DASHLETLISTVIEW' => 'SuiteCRM Dashlet Lijstweergave',
    ...
    'LBL_EDIT' => 'Bewerk',
    'LBL_EDIT_LAYOUT' => 'Wijzig opmaak',
    'LBL_EDIT_FIELDS' => 'Wijzig velden',
    'LBL_EDITVIEW' => 'Bewerk weergave',
    ...
    'LBL_TABDEF_COLLAPSE_HELP' => 'Selecteer om dit paneel standaard in te klappen.',
    'LBL_DROPDOWN_TITLE_NAME' => 'Naam',
    'LBL_DROPDOWN_LANGUAGE' => 'Taal',
    'LBL_DROPDOWN_ITEMS' => 'Lijst items',
    'LBL_DROPDOWN_ITEM_NAME' => 'Item Naam',
    'LBL_DROPDOWN_ITEM_LABEL' => 'Label weergeven',
    'LBL_SYNC_TO_DETAILVIEW' => 'Synchroniseren met de Detailweergave',
    'LBL_SYNC_TO_DETAILVIEW_HELP' => 'Selecteer deze optie om de Bewerkweergave te synchroniseren met de bijbehorende Detailweergave. Velden en veld-plaatsing van de Bewerkweergave zullen automatisch worden gesynchroniseerd en opgeslagen naar de Detailweergave zodra er op Opslaan of Opslaan&Implementeren wordt gedrukt.<br>Indien u ervoor kiest deze optie aan te zetten is het niet meer mogelijk de Detailweergave zelf aan te passen.',
    'LBL_SYNC_TO_DETAILVIEW_NOTICE' => 'Deze Detailweergave is gesynchroniseerd met de Bewerkweergave. Velden en veld-plaatsing in deze Detailweergave komen overeen met die van de Bewerkweergave. Wijzigingen aan de detailview kunnen niet worden opgeslagen en geimplementeerd in deze pagina.<br>Wijzigingen moeten worden gemaakt in de Bewerkweergave of de optie tot synchronisatie moet worden uitgezet.',
    'LBL_COPY_FROM_EDITVIEW' => 'Kopieer van Bewerkweergave',
...
//CUSTOM FIELDS
    ...
    'LBL_MASS_UPDATE' => 'Groepsgewijs bijwerken',
...
//LIST VIEW EDITOR
    ...
    'LBL_LISTVIEW_DESCRIPTION' => 'Er worden drie kolommen hieronder weergegeven. De <b>Standaard</b> kolom bevat velden die standaard worden weergegeven in de lijst weergave. De <b>Extra</b> kolom bevat velden die een gebruiker kan kiezen om een aangepaste weergave aan te maken. De <b>Beschikbaar</b> kolom toont de velden die beschikbaar zijn voor u als beheerder om toe te voegen aan de standaard of extra kolommen voor gebruik door gebruikers.',
    'LBL_LISTVIEW_EDIT' => 'Lijstweergave bewerken',
...
//BUTTONS
    ...
    'LBL_BTN_EDLABELS' => 'Bewerk etiketten',
    ...
    'LBL_BTN_DUPLICATE' => 'Dupliceer',
    'LBL_BTN_PUBLISH' => 'Publiceer',
    'LBL_BTN_DEPLOY' => 'Implementeer',
    'LBL_BTN_EXP' => 'Exporteer',
    'LBL_BTN_DELETE' => 'Verwijder',
...
//PACKAGE AND MODULE BUILDER
    ...
    'LBL_LIST' => 'Lijst',
    'LBL_VIEW' => 'Bekijk',
    'LBL_HISTORY' => 'Bekijk geschiedenis',
...
// VISIBILITY EDITOR
    'LBL_PACKAGE_WAS_DELETED' => '[[package]] is verwijderd',
...
//EXPORT CUSTOMS
    ...
    'LBL_EC_VIEWS' => 'aangepaste View (s)',
    'LBL_EC_SUITEFEEDS' => 'aangepaste feed(s)',
    'LBL_EC_DASHLETS' => 'aangepaste Dashlet(s)',
    'LBL_EC_CSS' => 'aangepaste css(s)',
    'LBL_EC_TPLS' => 'aangepaste tpls(s)',
    'LBL_EC_IMAGES' => 'aangepaste afbeelding(en)',
    'LBL_EC_JS' => 'aangepaste js(s)',
    'LBL_EC_QTIP' => 'aangepaste qtip(s)',
...
//POPUP HELP
    ...
    'LBL_POPHELP_IMPORTABLE' => '<b>Ja</b>: Het veld zal worden opgenomen in een importbewerking.<br><b>Nee</b>: Het veld wordt niet opgenomen in een import.<br><b>Vereist</b>: Een waarde voor het veld moet worden opgegeven in elke import.',
    'LBL_POPHELP_IMAGE_WIDTH' => 'Voer een nummer in voor de breedte, gemeten in pixels.<br> De geüploade afbeelding wordt naar deze breedte geschaald.',
    'LBL_POPHELP_IMAGE_HEIGHT' => 'Geef een getal op voor de hoogte, gemeten in pixels.<br> De afbeelding die geüpload wordt naar deze hoogte geschaald.',
    'LBL_POPHELP_DUPLICATE_MERGE' => '<b>Ingeschakeld</b>: het veld wordt weergegeven in de functie Duplicaten samenvoegen, maar kan niet worden gebruikt voor de filtervoorwaarden in de functie Duplicaten zoeken.<br><b>Uitgeschakeld</b>: het veld wordt niet weergegeven in de functie Duplicaten samenvoegen en kan niet worden gebruikt voor de filtervoorwaarden in de functie Duplicaten zoeken.<br><b>Filter</b>: het veld verschijnt in de functie Duplicaten samenvoegen en zal beschikbaar zijn voor gebruik voor de filtervoorwaarden in de functie Duplicaten zoeken.<br><b>Standaard geselecteerd filter</b>: het veld verschijnt in de functie Duplicaten samenvoegen en wordt standaard gebruikt voor de filtervoorwaarden in de Functie Duplicaten zoeken.<br><b>Alleen filter</b>: het veld wordt niet weergegeven in de functie Duplicaten samenvoegen, maar kan worden gebruikt voor de filtervoorwaarden in de functie Duplicaten zoeken.',
...
//Revert Module labels
    ...
    'LBL_RESET_LAYOUTS' => 'Reset-indelingen',
    ...
    'fieldTypes' => array(
        ...
        'currency' => 'Valuta',
        'file' => 'Bestand',
        'html' => 'ReadOnly HTML (verouderd, TextBlock gebruiken)',
    ...
    'labelTypes' => array(
        "frequently_used" => "Veel gebruikte omschrijvingen",
        "all" => "Alles",
    ),

    'parent' => 'Flex betrekking hebben',
    ...
    'LBL_RELATED_FIELD_ID_NAME_LABEL' => '{0} (verwant {1} ID)',
);
