...
$mod_strings = array(
    ...
    'LBL_CAT_OR_SUBCAT_UNSPEC' => 'Niet opgegeven',
    ...
    'ERR_DELETE_CONFIRM' => 'Wilt u deze revisie van dit document verwijderen?',
    'ERR_DELETE_LATEST_VERSION' => 'Je hebt geen toestemming om de laatste revisie van een document te verwijderen.',
    ...
    'LBL_DOCUMENT_INFORMATION' => 'OVERZICHT', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
