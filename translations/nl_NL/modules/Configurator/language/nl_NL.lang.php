...
$mod_strings = array(
    ...
    'LBL_ALLOW_DEFAULT_SELECTION' => 'Gebruikers toestaan dit account te gebruiken voor uitgaande e-mail:',
    ...
    'LBL_RESTORE_BUTTON_LABEL' => 'Terugzetten',
    ...
    'LBL_LDAP_ADMIN_USER_DESC' => 'Gebruikt om te zoeken naar de LDAP-gebruiker. Dit moet mogelijk volledig gekwalificeerd zijn.',
    ...
    'LBL_LDAP_GROUP_USER_ATTR_DESC' => 'De unieke identificatie van de persoon die gebruikt wordt om te controleren of ze lid zijn van de groep Voorbeeld: <em>uid</em>',
    'LBL_LDAP_GROUP_ATTR_DESC' => 'Het attribuut van de groep die zal worden gebruikt om te filteren op de gebruiker attribuut Voorbeeld: <em>memberUid</em>',
    ...
    'LBL_LDAP_AUTO_CREATE_USERS_DESC' => 'Als een geverifieerde gebruiker niet bestaat, zal er een worden aangemaakt in SuiteCRM.',
    'LBL_LDAP_ENC_KEY' => 'Encryptiesleutel:',
    ...
    'LBL_LOGGER_DEFAULT_DATE_FORMAT' => 'Standaard datumnotatie',
    ...
    'LBL_CONFIG_AJAX' => 'Configureer AJAX gebruikersinterface',
...
// Wizard
    ...
    'LBL_WIZARD_SYSTEM_TITLE' => 'Huisstijl',
    'LBL_WIZARD_SYSTEM_DESC' => 'Geef uw organisatie\'s naam en het logo om SuiteCRM uw huisstijl te geven.',
    'LBL_WIZARD_LOCALE_DESC' => 'Geef aan hoe u gegevens in SuiteCRM wilt weergeven, op basis van uw geografische locatie. De instellingen die u hier invoert zijn de standaardinstellingen. Gebruikers kunnen hun eigen voorkeuren instellen.',
    'LBL_WIZARD_SMTP_DESC' => 'Geef het e-mailaccount op dat zal worden gebruikt voor het verzenden van e-mails, zoals de toewijzingsmeldingen en nieuwe gebruikerswachtwoorden. Gebruikers ontvangen e-mails van SuiteCRM, verzonden vanaf het opgegeven e-mailaccount.',
    ...
    'LBL_HISTORY_SUBPANEL' => 'Geschiedenis Subpanel',
);
