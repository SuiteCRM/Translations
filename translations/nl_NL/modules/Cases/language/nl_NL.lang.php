...
$mod_strings = array(
    ...
    'LBL_LIST_DATE_CREATED' => 'Aangemaakt op',
    ...
    'LBL_CASE_INFORMATION' => 'OVERZICHT', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template

    // SNIP
    'LBL_UPDATE_TEXT' => 'Bijwerken tekst', //Field for Case updates with text only
    'LBL_INTERNAL' => 'Interne update',
