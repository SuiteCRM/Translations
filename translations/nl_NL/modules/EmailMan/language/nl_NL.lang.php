...
$mod_strings = array(
    ...
    'LBL_CUSTOM_LOCATION' => 'Gedefinieerd door gebruiker',
    ...
    'LBL_DRAFTS_POPUP' => 'Schakel concepten pop-up in',
    ...
    'LBL_EMAILS_PER_RUN' => 'Aantal verwerkte e-mails/verzonden per pakket:',
    'LBL_CAMPAIGN_MAX_RETRIES' => 'Maximale verzendpogingen per ontvanger bij mislukking:',
    'LBL_CAMPAIGN_THRESHOLD' => 'Foutdrempel per batch (campagne pauzeert wanneer bereikt, 0 om uit te schakelen):',
    'LBL_CAMPAIGN_MARKETING_RECORDS_PER_RUN' => 'Aantal e-mails marketing records die per uitvoering worden verwerkt:',
    ...
    'LBL_LIST_FROM_NAME' => 'Naam afzender',
    'LBL_LIST_IN_QUEUE' => 'In behandeling',
    'LBL_LIST_MESSAGE_NAME' => 'Marketing bericht',
    'LBL_LIST_RECIPIENT_EMAIL' => 'E-mailadres ontvanger',
    ...
    'LBL_CAMP_MESSAGE_COPY' => 'Behoud kopieën van campagneberichten:',
    'LBL_CAMP_MESSAGE_COPY_DESC' => 'Wilt u complete kopieën van <bold>ELK</bold> e-mailbericht opslaan dat wordt verzonden tijdens alle campagnes?  <bold>Wij raden aan en zetten dit standaard op nee</bold>. Door geen keuze worden alleen de verzonden sjabloon en de benodigde variabelen opgeslagen om het afzonderlijke bericht opnieuw te maken.',
    ...
    'LBL_MODULE_NAME' => 'Email instellingen',
    ...
    'LBL_SEND_ATTEMPTS' => 'Verzendogingen',
    ...
    'LBL_SYSTEM_OUTBOUND_EMAIL_ACCOUNT' => 'Systeem uitgaande e-mailaccount',
    ...
    'LBL_EMAIL_IMPORT_CONFIGURATION' => 'E-mail import configuratie',
    'LBL_EMAIL_IMPORT_PER_RUN_THRESHOLD' => 'Drempel voor aantal geïmporteerde e-mails per Run (per Mailbox)',
    'LBL_EMAIL_IMPORT_PER_RUN_THRESHOLD_DESC' => 'Drempel van e-mails om te importeren per run. Standaard is 25. Elke uitvoering zal elke dag in de brievenbus doorlopen binnen de ingestelde tijdsperiode, van de oudste tot de meest recent. Het zal alle e-mails op elke dag importeren totdat de totale e-mails die op deze run zijn geïmporteerd de drempel overschrijden. Eenmaal voldaan, zal de job de laatst ingevoerde dag stoppen en markeren, beginnend bij de volgende uitvoering.',
    'LBL_EMAIL_IMPORT_TIMEFRAME_START' => 'Beginpunt voor nieuw-mailbox Imports',
    'LBL_EMAIL_IMPORT_TIMEFRAME_START_DESC' => 'Periode voor het importeren van e-mails. Als je bijvoorbeeld 30 dagen selecteert, begin je met e-mails van 30 dagen geleden en ga je verder daar.',
    'LBL_EMAIL_IMPORT_FETCH_UNREAD_ONLY' => 'Haal alleen ongelezen e-mails op bij het importeren',
);
