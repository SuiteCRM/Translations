...
$mod_strings = array(
    ...
    'ERR_CHECKSYS_CONFIG_NOT_WRITABLE' => 'Het configuratiebestand bestaat maar is niet schrijfbaar. Neem de nodige stappen om het bestand beschrijfbaar te maken. Afhankelijk van uw Operating systeem kunt u de permissies wijzigen door het uitvoeren van chmod 766, of klik met de rechtermuisknop op de bestandsnaam om de eigenschappen te bekijken en het vinkje bij \'alleen-lezen\' uit te schakelen.',
    'ERR_CHECKSYS_CONFIG_OVERRIDE_NOT_WRITABLE' => 'Het configuratieoverschrijvingsbestand bestaat maar is niet schrijfbaar. Neem de nodige stappen om het bestand beschrijfbaar te maken. Afhankelijk van uw Operating systeem kunt u de permissies wijzigen door het uitvoeren van chmod 766, of klik met de rechtermuisknop op de bestandsnaam om de eigenschappen te bekijken en het vinkje bij \'alleen-lezen\' uit te schakelen.',
    'ERR_CHECKSYS_CUSTOM_NOT_WRITABLE' => 'De Custom Directory bestaat maar is niet schrijfbaar. Mogelijk moet u de rechten erop wijzigen (chmod 766) of rechtermuisklik erop en schakel de optie \'alleen-lezen\' uit, Afhankelijk van je besturingssysteem. Neem de nodige stappen om het bestand schrijfbaar te maken.',
    'ERR_CHECKSYS_FILES_NOT_WRITABLE' => "De onderstaande bestanden of mappen zijn niet beschrijfbaar of ontbreken en kunnen niet worden aangemaakt. Afhankelijk van je besturingssysteem kan het wijzigen van de rechten van de bestanden of bovenliggende map (chmod 755), vereist zijn om dit te corrigeren. of klik met de rechtermuisknop op de bovenliggende map en vink de optie 'alleen lezen' uit en pas deze toe op alle submappen.",
    ...
    'ERR_UPLOAD_MAX_FILESIZE' => 'Waarschuwing: Uw PHP configuratie moet worden gewijzigd om bestanden van ten minste 6MB te kunnen uploaden.',
    ...
    'LBL_CHECKSYS_OK' => 'OK',
    'LBL_CHECKSYS_PHP_INI' => 'Locatie van uw PHP configuratiebestand (php.ini):',
    ...
    'LBL_DISABLED_DESCRIPTION_2' => 'Nadat deze wijziging is aangebracht, kunt u hieronder op de "Start" knop klikken om uw installatie te beginnen. <i>Nadat de installatie is voltooid wilt u de waarde voor \'installer_locked\' veranderen naar \'true\'.</i>',
