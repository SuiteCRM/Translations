...
$mod_strings = array(
    ...
    'ERR_CHECKSYS_FASTCGI' => 'We detecteren dat u geen FastCGI-afhandelingsmapping voor PHP gebruikt. U moet een versie installeren of configureren die compatibel is met SuiteCRM toepassing. Raadpleeg de Compatibility Matrix in de Release Notes voor ondersteunde versies. Bekijk <a href="https://php.iis.net/" target="_blank">https://php.iis.net/</a> voor meer informatie ',
    'ERR_CHECKSYS_FASTCGI_LOGGING' => 'Voor een optimale ervaring met IIS/FastCGI sapi, stel fastcgi.logging in op 0 in je php.ini bestand.',
    ...
    'ERR_CHECKSYS_MBSTRING' => 'Functies die gekoppeld zijn aan de Multibyte Strings PHP extensie (mbstring) die nodig zijn door de SuiteCRM applicatie zijn niet gevonden. Over het algemeen is de mbstring module niet standaard ingeschakeld in PHP en moet geactiveerd worden met --enable-mbstring wanneer de PHP binary wordt gebouwd. Raadpleeg uw PHP-handleiding voor meer informatie over het inschakelen van mbstring ondersteuning.',
    'ERR_CHECKSYS_CONFIG_NOT_WRITABLE' => 'De config file bestaat, maar is niet schrijfbaar. Neem de nodige stappen om het bestand schrijfbaar te maken.',
    'ERR_CHECKSYS_CONFIG_NOT_FOUND' => 'Uw config.php bestaat niet. Deze zal aangemaakt worden bij de installatie.',
    'ERR_CHECKSYS_CONFIG_OVERRIDE_NOT_WRITABLE' => 'De config override file bestaat, maar is niet schrijfbaar. Neem de nodige stappen om het bestand schrijfbaar te maken. ',
    'ERR_CHECKSYS_CUSTOM_NOT_WRITABLE' => 'De Custom Directory bestaat, maar is niet beschrijfbaar. Neem de nodige stappen om het bestand schrijfbaar te maken.',
    'ERR_CHECKSYS_FILES_NOT_WRITABLE' => "De bovenstaande bestanden of mappen zijn niet schrijfbaar of ontbreken en kunnen niet worden aangemaakt. Neem de benodigde stappen om de mappen schrijfbaar te maken.",
    'ERR_CHECKSYS_LOGS_NOT_WRITABLE' => 'De Logs Directory is momenteel niet schrijfbaar',
    'ERR_CHECKSYS_CACHE_NOT_WRITABLE' => 'De Cache Directory is momenteel niet schrijfbaar',
    'ERR_CHECKSYS_EXTENSIONS_NOT_WRITABLE' => 'De Extensions directory is momenteel niet schrijfbaar',
    'ERR_CHECKSYS_ROOT_NOT_WRITABLE' => 'De Root Directory is momenteel niet schrijfbaar. U kunt niet doorgaan met installeren.',
    'ERR_CHECKSYS_SECRETS_NOT_WRITABLE' => 'De config/secrets map is momenteel niet schrijfbaar',
    'ERR_CHECKSYS_ENV_NOT_WRITABLE' => 'De .env file of de directory waarin het is, is niet schrijfbaar.',
    ...
    'ERR_DB_LOGIN_FAILURE_SHORT' => 'Database verbindingsfout: De database hostnaam, poort, gebruikersnaam, en/of wachtwoord is ongeldig.',
    ...
    'ERR_DB_LOGIN_FAILURE_MYSQL' => 'De opgegeven database host, gebruikersnaam en/of wachtwoord is ongeldig, en er kon geen verbinding met de database worden gemaakt. Voer een geldige host, gebruikersnaam en wachtwoord in',
    'ERR_DB_LOGIN_FAILURE_MSSQL' => 'De opgegeven database host, gebruikersnaam en/of wachtwoord is ongeldig, en er kon geen verbinding met de database worden gemaakt. Voer een geldige host, gebruikersnaam en wachtwoord in',
    ...
    'ERR_DBCONF_VALIDATION' => 'Corrigeer de volgende fouten voordat u verdergaat:',
    ...
    'ERR_PERFORM_NO_TCPIP_SIMPLE' => 'Een internetverbinding kon niet worden gedetecteerd.',
    ...
    'LBL_CHECKSYS_LEGACY_CACHE' => 'Beschrijfbare Legacy Cache Sub-Directories',
    'LBL_CHECKSYS_CACHE' => 'S§chrijfbare Cache Sub-Directories',
    'LBL_CHECKSYS_EXTENSIONS' => 'Schrijfbare Extensions directory',
    'LBL_CHECKSYS_SECRETS' => 'Schrijfbare Config/Secrets Directory',
    'LBL_CHECKSYS_LOGS' => 'Schrijfbare Log Directory',
    'LBL_CHECKSYS_ROOT' => 'Beschrijfbare Root Directory',
    ...
    'LBL_CHECKSYS_ENV' => 'Schrijfbaar .env',
    ...
    'LBL_CHECKSYS_INTL_EXTENSIONS' => 'Intl bestaat in Extensions',
    'LBL_CHECKSYS_JSON_EXTENSIONS' => 'Json bestaat in Extensions',
    'LBL_CHECKSYS_GD_EXTENSIONS' => 'GD bestaat in Extensions',
    'LBL_CHECKSYS_OPENSSL_EXTENSIONS' => 'OpenSSL bestaat in Extensions',
    'LBL_CHECKSYS_ZIP_EXTENSIONS' => 'Zip bestaat in Extensions',
    'LBL_CHECKSYS_PDO_MYSQL_EXTENSIONS' => 'PDO MySQL bestaat in Extensions',
    'LBL_CHECKSYS_CURL_EXTENSIONS' => 'cURL bestaat in Extensions',
    'LBL_CHECKSYS_MBSTRING_EXTENSIONS' => 'MB Strings bestaat in Extensions',
    'LBL_CHECKSYS_MYSQLI_EXTENSIONS' => 'MySQLi bestaat in Extensions',
    'LBL_CHECKSYS_SOAP_EXTENSIONS' => 'Soap bestaat in Extensions',
    'LBL_CHECKSYS_XML_EXTENSIONS' => 'XML bestaat in Extensions',
    'LBL_CHECKSYS_IMAP_EXTENSIONS' => 'IMAP bestaat in Extensions (Optional)',
    'LBL_CHECKSYS_LDAP_EXTENSIONS' => 'LDAP bestaat in Extensions (Optional)',
    'LBL_PHP_CHECKS' => 'PHP CHECKS',
    'LBL_SERVER_CHECKS' => 'SERVER CHECKS',
    'LBL_PERMISSION_CHECKS' => 'PERMISSION CHECKS',
    'LBL_CHECK_FAILED' => 'Controle mislukt: ',
    'ERR_CHECKSYS_INTL' => 'De Intl extensie is niet geïnstalleerd, neem contact op met uw systeembeheerder',
    'ERR_CHECKSYS_JSON' => 'JSON extensie is niet ingeschakeld, neem contact op met uw systeembeheerder.',
    'ERR_CHECKSYS_GD' => 'De extensie GD is niet ingeschakeld, neem contact op met uw systeembeheerder.',
    'ERR_CHECKSYS_OPENSSL' => 'De extensie OpenSSL is niet ingeschakeld, neem contact op met uw systeembeheerder.',
    'ERR_CHECKSYS_PDO_MYSQL' => 'De PDO MySQL extensie is niet ingeschakeld, neem contact op met uw systeembeheerder.',
    'ERR_CHECKSYS_MYSQLI' => 'MySQLi extensie is niet ingeschakeld, neem contact op met uw systeembeheerder.',
    'ERR_CHECKSYS_SOAP' => 'De extensie Soap is niet ingeschakeld, neem contact op met uw systeembeheerder.',
    'ERR_SUHOSIN' => 'Upload stream wordt geblokkeerd door Suhosin, voeg alstublieft "upload" toe aan suhosin.executor.include.whitelist (Zie suitecrm.log voor meer informatie)',
    'LBL_UNWRITABLE_SUB_DIR' => 'Er zijn een aantal sub directories die niet schrijfbaar zijn. Neem de nodige stappen om de mappen beschrijfbaar te maken ',
    'LBL_REFER_TO_LOGS' => 'Er is een probleem opgetreden bij een van uw pre-installatie controles, raadpleeg de logs/install.log',
    'LBL_NOT_A_VALID_SUITECRM_PAGE' => 'De SuiteCRM titel kan niet worden gevonden. Dit is geen geldige SuiteCRM pagina.',
    'LBL_NOT_COOKIE_OR_TOKEN' => 'Kan cookies niet vinden, geen geldige token gevonden. Raadpleeg de logs/install.log voor meer informatie.',
    'LBL_CURL_JSON_ERROR' => 'Het resultaat van de curl call naar de grafische pagina was leeg.',
    'LBL_UNABLE_TO_FIND_SYSTEM_CONFIGS' => 'Het is niet mogelijk om systeemconfiguratie op te halen op de Graphql pagina. Bekijk de logs/install.log voor meer informatie.',
    'LBL_CURL_REQUEST_MAIN_PAGE' => 'Curl request op hoofdpagina',
    'LBL_CURL_REQUEST_API_PAGE' => 'Curl request op Api',
    'LBL_ERROR_DETAILS' => 'Foutgegevens',
    'LBL_ERROR' => 'Foutmelding',
    'LBL_WARNING_DETAILS' => 'Waarschuwing Details',
    'LBL_WARNING' => 'Waarschuwing',
    'LBL_SYSTEM_CHECKS' => 'SYSTEEM CHECKS',
    'LBL_CRON_INSTRUCTIONS_1' => 'Om de SuiteCRM planners goed te laten werken, pas de gebruikers crontab aan met de volgende instructie:',
    'LBL_CRON_INSTRUCTIONS_2' => 'en voeg de volgende regel toe aan het crontab bestand:',
    'LBL_CRON_INSTRUCTIONS_3' => 'U moet dit alleen doen als de installatie is afgesloten.',
    'LBL_CRON_CONFIGURATION' => 'CRON CONFIGURATIE',
    'LBL_SETUP_CRONTAB' => 'Configureer crontab',
    'LBL_ROUTE_ACCESS_CHECK' => 'ROUTE ACCESS CHECK',
    'LBL_PHP_MEM_1' => 'Uw PHP geheugenlimiet is ',
    'LBL_PHP_MEM_2' => '. Dit moet minimaal zijn vanaf ',
    'LBL_PHP_MEM_3' => 'M om door te gaan.',
    'LBL_CLOSE' => 'Afsluiten',
    'LBL_THREE' => '3',
    ...
    'LBL_DBCONF_DB_PORT' => 'Database poort',
    ...
    'LBL_DISABLED_DESCRIPTION_3' => 'Nadat deze wijziging is aangebracht, gelieve deze pagina opnieuw te bezoeken / opnieuw te laden om door te gaan.',
    ...
    'LBL_APP_NOT_INSTALLED' => 'SuiteCRM is niet geïnstalleerd. Het beginpunt heeft een SuiteCRM geïnstalleerd, gelieve eerst te installeren.',
    ...
    'LBL_SILENT_INSTALL_SUCCESS' => 'SuiteCRM is succesvol geïnstalleerd.',
    'LBL_SILENT_INSTALL_FAILED' => 'SuiteCRM installatie is mislukt.',
    ...
    'LBL_PRE_INSTALL_REQ' => 'Pre-Installatie vereisten',
    'LBL_HIDDEN' => '<i>(verborgen)</i>',
    'LBL_STEP1' => 'Stap 1 van 2 - Pre-Installatie eisen',
    'LBL_STEP2' => 'Stap 2 van 2 - Instellingen',
    'LBL_STEP' => 'Stap',
    'LBL_CHECKS_PASSED' => 'Alle controles voltooid!',
    'LBL_WARNINGS_FOUND' => 'Waarschuwingen gevonden: controleer deze voordat u verder gaat.',
    'LBL_ERRORS_FOUND' => ' Fouten gevonden: het wordt aanbevolen deze op te lossen voordat u verder gaat.',
    'LBL_ERRORS_AND_WARNINGS_FOUND' => 'Fout(en) en waarschuwing(en) gevonden: het wordt aanbevolen deze te controleren en op te lossen voordat u verder gaat.',
    'LBL_TITLE_WELCOME' => 'Welkom bij SuiteCRM ',
    'LBL_WELCOME' => 'Welkom bij SuiteCRM',
    ...
    'LBL_SESSION_ERR_DESCRIPTION' => "SuiteCRM maakt gebruik van PHP-sessies om belangrijke informatie op te slaan terwijl u verbonden bent met deze webserver. Uw PHP-installatie heeft de sessie-informatie niet correct geconfigureerd.
											<br><br>Een veelvoorkomende fout is dat de richtlijn <b>'session.save_path'</b> niet naar een geldige map verwijst.. <br>
											<br> Corrigeer uw <a target=_new href='https://www.php.net/manual/en/ref.session.php'>PHP configuratie</a> in het hieronder vermelde php.ini-bestand.",
...
$contact_user_link_guid',
    ...
    'LBL_OLD_PHP_MSG' => 'De aanbevolen PHP versie om SuiteCRM te installeren is %s <br />De minimum PHP versie die nodig is is %s<br />U gebruikt PHP versie %s, welke EOL is: <a href="https://www.php.net/eol.php">https://www. hp.net/eol.php</a>.<br />Overweeg het upgraden van uw PHP-versie. ',
    ...
    'LBL_SYS_CHECK_WARNING' => 'Negeer systeem controle waarschuwingen',
    'LBL_PROCEED' => 'DOORGAAN',
    'LBL_PROCEED_WITH_WARNINGS' => 'NEGEER WAARSCHUWINGEN EN GA DOOR',
    'LBL_PROCEED_WITH_ERRORS' => 'NEGEER FOUTEN EN GA DOOR',
    'LBL_PROCEED_WITH_ERRORS_AND_WARNINGS' => 'NEGEER FOUTEN EN WAARSCHUWINGEN OM DOOR TE GAAN',
    'LBL_RECHECK' => 'RECHECK',
    'LBL_VIEW_FULL_ERROR' => 'Bekijk volledige fout',
    'LBL_CLOSE_DESCRIPTION' => 'Sluit beschrijving',
    'LBL_CONFIG' => 'CONFIGURATIE',
    'LBL_VALIDATION_ERRORS' => 'Er zijn validatiefouten, het niet mogelijk om actie uit te voeren.',
    'LBL_CRON_UNRECOMMENDED_USER' => 'U draait momenteel als root, dit wordt NIET aanbevolen, wilt u doorgaan (y,n)? '
);
