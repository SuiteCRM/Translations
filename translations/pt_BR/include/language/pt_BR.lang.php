...
//e.g. auf Deutsch 'Contacts'=>'Contakten',
    ...
    'moduleList' => array(
        ...
        'Connectors' => 'Definições do Conector',
        'Roles' => 'Perfis',
        'Notifications' => 'Notificações',
        'Sync' => 'Sincronizar',
        'CalendarAccount' => 'Contas de Calendário',
        'Users' => 'Usuários',
        ...
        'OAuth2AuthCodes' => 'Códigos de Autorização OAuth',
    ),
    ...
    'lead_source_default_key' => 'Auto Gerado',
...
//       it is the key for the default opportunity_relationship_type_dom value
    'opportunity_relationship_type_default_key' => 'Decisor Primário',
    'opportunity_relationship_type_dom' => array(
        '' => '',
        'Primary Decision Maker' => 'Decisor Primário',
...
//prospect list type dom
    ...
    'email_marketing_duplicate_dom' => [
        'email' => 'Impedir o envio de registros duplicados e endereços de email',
        'record' => 'Impedir o envio de registros duplicados',
    ],
...
$app_strings = array(
    ...
    'ERR_TIMEOUT' => "Falha forçada no tempo limite",
    ...
    'LBL_EMAIL_CHECK' => 'Verificar se tem novos E-mails',
    ...
    'LBL_EMAIL_DRAFT_SAVED' => 'O rascunho foi salvo.',
    ...
    'LBL_EMAIL_SETTINGS_TITLE' => 'Configurações de Email',
    ...
    'LBL_EMAIL_SETTINGS_FROM_ADDR_NOT_SET' => 'Endereço do remetente e/ou nome do remetente não definido',
    ...
    'LBL_CAMPAIGNS_SEND_NEXT_BATCH' => 'Deseja enviar o próximo lote de Emails da Campanha',
    'LBL_SENT_NEXT_BATCH' => 'Lote enviado com sucesso',
    ...
    'LBL_CAMPAIGN_CHARTS' => 'Gráficos da Campanha',
    'LBL_EMAIL_MARKETING_CHARTS' => 'Gráficos de Email marketing',
    'LBL_MESSAGE_QUEUE_TITLE' => 'Fila de mensagens',
    'LBL_CAMPAIGN_SEND_STATUS' => 'Status de envio da campanha',
    'LBL_CAMPAIGN_SEND_ERROR_THRESHOLD_EXCEEDED' => 'Erro limite por lote (%d) alcançado: %s',
    'LBL_CAMPAIGN_SEND_FAILURE_THRESHOLD_EXCEEDED' => 'Limite de falhas por lote de %d excedido',
    'LBL_EMAIL_MARKETING_SEND_STATUS' => 'Enviar Status de Marketing de Email',
    'LBL_CAMPAIGN_RESPONSE_BY_RECIPIENT_ACTIVITY' => 'Resposta da Campanha por Atividade de Destinatário',
    'LBL_EMAIL_MARKETING_RESPONSE_BY_RECIPIENT_ACTIVITY' => 'Email Resposta de Marketing por Atividade de Destinatário',
    'LBL_LOG_ENTRIES_TARGETED_TITLE' => 'Enviado/Tentativa',
    'LBL_LOG_ENTRIES_SEND_ERROR_TITLE' => 'Mensagens devolvidas, Outros',
    'LBL_LOG_ENTRIES_BOUNCED_TITLE' => 'Mensagens Devolvidas',
    'LBL_LOG_ENTRIES_INVALID_EMAIL_TITLE' => 'Mensagens devolvidas, Email inválido',
    'LBL_LOG_ENTRIES_LINK_TITLE' => 'Link de Rastreamento de Cliques',
    'LBL_LOG_ENTRIES_VIEWED_TITLE' => 'Mensagem Exibida',
    'LBL_LOG_ENTRIES_REMOVED_TITLE' => 'Optou por sair',
    'LBL_LOG_ENTRIES_LEAD_TITLE' => 'Leads Criado',
    ...
    'LBL_LOG_ENTRIES_BLOCKED_TITLE' => 'Suprimido/Bloqueado',
    'LBL_THEME' => 'Tema:',
    ...
    'LBL_ALERT_DISMISS_ALL_SUCCESS' => 'Alertas descartados com sucesso',
    'LBL_DISMISS_ALL' => 'Descartar tudo',
    'LBL_DISMISS_SUCCESS' => 'Descartado com sucesso',
    'LBL_VERIFY' => 'Verificar',
    'LBL_RESEND' => 'Reenviar',
    'LBL_RECORD_DOES_NOT_EXIST' => 'Erro ao recuperar o registro. Este registro pode ser excluído ou você não está autorizado a visualizá-lo.',
    'LBL_PROFILE' => 'Perfil',
    ...
    'LBL_PRIMARY_ADDRESS_COUNTRY' => 'Principal - País:',
    ...
    'LBL_SAVE_NEW_BUTTON_TITLE' => 'Salvar e Criar Novo',
    ...
    'LBL_ALL_SCHEDULERS' => 'Todos os Agendadores',
    'LBL_LEGACY_SCHEDULERS' => 'Agendadores Legados',
    'LBL_SCHEDULERS' => 'Agendadores',
    'LBL_RUN_LEGACY_SCHEDULERS' => 'Agendadores Legados em Execução',
    'LBL_LEGACY_SCHEDULERS_RUN_SUCCESSFULLY' => 'Agendadores Legados executados com sucesso!',
    'LBL_RUN_SCHEDULERS' => 'Executando Agendadores',
    'LBL_LEGACY_SCHEDULER_FAILED' => 'Nem todos os Agendadores foram bem sucedidos. Veja os Logs.',
    'LBL_PASSED' => 'Passou',
    'LBL_FAILED' => 'Falhou',

    'LBL_SCENARIO_SALES' => 'Vendas',
    'LBL_SCENARIO_MARKETING' => 'Marketing',
    'LBL_SCENARIO_FINANCE' => 'Finanças',
    ...
    'LBL_TOO_MANY_ADDRESSES' => 'Você selecionou muitos endereços de email.',
    'LBL_NO_ADDRESSES_SELECTED' => 'Por favor, selecione um endereço para enviar.',
    'LBL_NOT_ALL_SENT' => 'Nem todos os emails foram enviados. Veja os logs para mais informações.',
    'LBL_NOT_VALID_TARGETS' => 'Nenhum alvo validado para ser enviado.',
    'LBL_ALL_EMAILS_SENT' => 'Todos os emails de teste enviados com sucesso',
    'LBL_UNDELETE_BUTTON_LABEL' => 'Desfazer Exclusão',
    'LBL_UNDELETE_BUTTON_TITLE' => 'Desfazer Exclusão',
    ...
    'NTC_SEND_QUEUED_CAMPAIGN_EMAILS' => 'Deseja enviar o próximo lote de Emails da Campanha?',
    ...
    'NTC_ABORT_CONFIRMATION' => 'Tem certeza que deseja cancelar?',
    'LBL_EMAIL_MARKETING_NOT_SENT' => 'O status do email marketing não é “Enviado”; não é possível reagendar',
    'NTC_RESUME_CONFIRMATION' => 'Retomar irá reenfileirar os destinatários que falharam e continuará enviando.',
    'LBL_EMAIL_MARKETING_NOT_PAUSED' => 'O status do email marketing não é “Pausado”; não é possível reagendar',
    'LBL_CAMPAIGN_PAUSED_THRESHOLD' => 'Esta campanha foi pausada —',
    'LBL_CAMPAIGN_PAUSED_DYNAMIC_LABEL' => '{{ fields.email-marketing-pause-reason.value }}',
    'NTC_SCHEDULE_CONFIRMATION' => "Quando agendado, o processo de envio começará assim que a data de execução agendada for atingida.",
    'NTC_DELETE_TEST_ENTRIES' => 'Agendador excluirá Entradas de Teste.',
    'NTC_DELETE_TEST_ENTRIES_CONFIRMATION' => 'Você tem certeza que deseja excluir as Entradas dos Testes?',
    'NTC_PROCEED' => 'Você gostaria de continuar?',
    'NTC_UNSCHEDULE_CONFIRMATION' => 'Ao remover o agendamento, o status será alterado para "Rascunho".',
    'NTC_UNSCHEDULE_CONFIRMATION_OTHER' => 'O Processo de Envio não começará mais, a menos que seja reagendado.',
    ...
    'LBL_TEMPLATE_CONFIRMATION' => 'Aplicar novo modelo de Email? (Isto irá substituir o seu corpo de email atual e campo de assunto)',
    ...
    'LBL_SHIPPING_STREET' => 'Entrega - Logradouro:',
    ...
    'MSG_JS_ALERT_MTG_REMINDER_MEETING_MSG' => "\nClique em OK para visualizar esta reunião ou clique em Cancelar para descartar esta mensagem.",
    ...
    'LBL_MAX_DASHLET_COLUMNS' => "Máximo de %s colunas pode ser exibido.",
    'LBL_RETRIEVING_XML_DATA' => "Ocorreu um problema ao recuperar os dados do XML:\n",
    ...
    'LBL_COLLECTION_PRIMARY' => 'Primária',
...
"5. Clique na opção Importar do menu Ações na aplicação e escolha o arquivo para carregar"
   ',
    ...
    'LBL_FAILED_TO_UPDATE_TEMPLATE_VARIABLES' => 'Falha ao atualizar variáveis do template',
    ...
    'LBL_DISABLE_USER_2FA' => 'Desativar 2FA',
    ...
    'LBL_NEW_EM_SURVEY' => 'Novo Email de Pesquisa',
    'LBL_NEW_EM_TRANSACTIONAL' => 'Novo Email transacional',
    'LBL_NEW_EM_MARKETING' => 'Novo Email de Marketing',
    'LBL_NEW_SURVEY' => 'Nova Pesquisa',
    'LBL_WEB_TO_LEAD' => 'Novo Formulário Web para Contato',
    'LBL_TYPE' => 'Tipo',
    'LBL_DATE_START' => 'Data de início',
    'LBL_SEND_DATE' => 'Data de Envio',
    'LBL_SCHEDULE_BUTTON_LABEL' => 'Agendar',
    'LBL_UNABLE_TO_UNSCHEDULE' => 'Não é possível desagendar como não agendado',
    'LBL_SAVE_BUTTON_TITLE' => 'Salvar',
    'LBL_SAVE_CONTINUE_LABEL' => 'Salvar e Continuar',
    ...
    'PIPELINE_BY_SALES_STAGE' => 'Pipeline por Fase de Venda',
    ...
    'ERR_SUHOSIN' => 'O fluxo de Upload está bloqueado pelo Suhosin, por favor adicione &quot;upload&quot; para suhosin.executor.include.whitelist (Verifique o arquivo suitecrm.log para obter mais informações)',
    ...
    'LBL_SEND_TEST_EMAIL_DESC' => 'Por favor, selecione os Endereços de Email / Usuário(s) e/ou Lista de Alvo(s) para enviar.',
    'LBL_EMAIL_SENT_SUCCESSFULLY' => 'Email enviado com sucesso',
    'LBL_PROSPECT_LIST_NAME' => 'Listas de Alvos',
    ...
    'LBL_COLUMN_SELECTOR_SAVE_BUTTON' => 'Salvar as alterações',
    'LBL_COLUMN_SELECTOR_MODAL_TITLE' => 'Escolher Colunas',

    // Two-Factor Authentication
    'LBL_ENTER_AUTH_APP_2FA_CODE' => 'Por favor, insira o código de verificação do seu aplicativo de autenticação',
    'LBL_ENABLE_2FA_LABEL' => 'Habilitar autenticação com Dois Fatores',
    'LBL_BACKUP_CODES' => 'Códigos de Recuperação/Backup',
    'LBL_BACKUP_CODES_INFO' => 'Os códigos de backup são códigos de verificação de uma única vez quando você não consegue verificar através de seu app de Autenticação.',
    'LBL_BACKUP_CODES_WARN' => ' AVISO: Estes códigos são gerados apenas uma vez. Por favor, copie ANTES de verificação, pois eles não serão exibidos novamente.',
    'LBL_PROBLEMS_GENERATING_CODE' => 'Problemas ao gerar o código?',
    'LBL_BACKUP_CODES_FALLBACK_INSTRUCTIONS' => 'Use um dos códigos de backup (ele expira após ser usado)',
    'LBL_OTP_SETUP' => 'Use um autenticador OTP (senha única) em seu celular ou computador para ativar a 2FA (Verificação em Duas Etapas)',
    'LBL_QR_CODE_HELP' => "Se você ainda não fez o download de um aplicativo de Autenticador (como FreeOTP ou Google Authenticator). Use esse aplicativo para escanear o código QR.",
    'LBL_USE_SECRET' => "Não é possível escanear o código QR?",
    'LBL_USE_SECRET_DESC' => "Se você não conseguir escanear o código QR, por favor insira o segredo abaixo manualmente no seu aplicativo de autenticação.",
    'LBL_HIDE_SECRET' => "Ocultar Segredo TOTP",
    'LBL_2FA_LOGIN_CANCEL' => 'Autenticação de Dois Fatores Cancelada',

    'LBL_FACTOR_AUTH_DISABLE' => 'A Autenticação em Duas Etapas foi desabilitada',
    'LBL_FACTOR_AUTH_SUCCESS' => 'A Autenticação em Duas Etapas foi bem-sucedida',
    'LBL_FACTOR_AUTH_FAIL' => "Falha na Autenticação em Dois Fatores. Tente novamente.",

    'LBL_VERIFY_2FA' => 'Verificar Código',
    'LBL_TWO_FACTOR_AUTH' => 'Autenticação de Dois Fatores',
    'LBL_TWO_FACTOR_AUTH_APP_METHOD' => 'Aplicativo de Autenticação',
    'LBL_TWO_FACTOR_AUTH_APP_METHOD_DESCRIPTION' => 'Use um aplicativo de autenticação para gerar códigos de autenticação de 2 fatores, quando solicitado',
    'LBL_ENABLE' => 'Habilitar',
    'LBL_ENABLED' => 'Habilitado',
    'LBL_DISABLE' => 'Desabilitar',
    'LBL_GENERATED' => 'Gerado',
    'LBL_REGENERATE_CODES' => 'Regenerar',
    'LBL_REGENERATED_BACKUP_CODES' => 'Códigos de Backup Regenerados'
...
//aop
$app_list_strings['case_state_default_key'] = 'Aberta';
...
$app_list_strings['case_status_dom'] =
    array(
        ...
        'Open_Pending Input' => 'Aguardando informação',
...
$app_list_strings['aor_date_type_list']['hour'] = 'Hora';
...
$app_string['LBL_PDF_GENERATION_FAILED'] = 'Não foi possível gerar o documento PDF. Consulte os logs para obter mais informações.';
...
$app_list_strings['aow_status_list']['Active'] = 'Ativa';
$app_list_strings['aow_status_list']['Inactive'] = 'Inativa';
...
$app_list_strings['aow_date_type_list']['hour'] = 'Hora';
...
$app_list_strings['marker_image_list']['info'] = 'Informações';
...
$app_list_strings['marker_image_list']['monday'] = 'Segunda-Feria';
...
$app_list_strings['moduleList']['ManualMigrationTasks'] = 'Migrações';
$app_list_strings['moduleList']['Processes'] = 'Processos';
$app_list_strings['moduleList']['AsyncTaskItems'] = 'Itens de Tarefas Assíncronas';

$app_strings['LNK_USER_MENU_PROCESSES'] = 'Processos';
...
$app_list_strings['day_list']['Monday'] = 'Segunda-Feria';
...
$app_list_strings['survey_status_list']['Closed'] = 'Fechado';
...
$app_list_strings['surveys_question_type']['Rating'] = 'Pontuação';
...
$app_strings['LBL_OPT_IN_INVALID'] = 'Inválido';
...
$app_list_strings['sync_attempt_message_list'] = [
    '' => '',
    'sync_complete' => 'Todas as reuniões sincronizadas.',
    'up_to_date' => 'Não há novas reuniões para sincronizar.',
    'meetings_failed' => 'Algumas reuniões falharam na sincronização. Verificar os logs.',
    'sync_partial' => 'Algumas reuniões foram sincronizadas. Outras estão pendentes devido a limites.',
    'sync_failed' => 'Não há reuniões sincronizadas. Verifique os logs.',
];
...
$app_strings['LBL_INVALID_EMAIL'] = 'Inválido';
$app_strings['LBL_PRIMARY'] = 'Primária';
...
$app_strings['LBL_SEARCH_RESULTS_PER_PAGE']        = 'Resultados por módulo: ';
$app_strings['LBL_SEARCH_ENGINE']                  = 'Motor: ';
$app_strings['LBL_SEARCH_TOTAL'] = 'Resultado(s) total: ';
$app_strings['LBL_SEARCH_PREV'] = 'Voltar';
...
$app_strings['LBL_DAYS_IN_SALE_STAGE'] = 'DIA(S) QUE ESTA OPORTUNIDADE ESTEVE NESSA FASE DE VENDA';
...
$app_strings['LBL_VALIDATION_ERROR_ATTACHMENT'] = 'Anexo(s) inválido.';
...
$app_strings['LBL_VALIDATION_ERROR_UNSUBSCRIBE_LINK'] = "Emails não transativos devem conter um link de cancelamento. Por favor, adicione um rastreador de desativação, '{{ unsubscribe_link }}' ou selecione o ícone: ";
$app_strings['LBL_VALIDATION_ERROR_REMOVE_UNSUBSCRIBE_LINK'] = "Emails transacionais NÃO devem conter um link de cancelamento. Por favor, remova '{{ unsubscribe_link }}'";
...
$app_strings['LBL_VALIDATION_ERROR_VERSIONING'] = "Formato inválido. Esperado: '{{context.expected}}'";
$app_strings['LBL_VALIDATION_ERROR_MAX'] = "Valor inválido. O valor deve ser menor ou igual a '{{context.max}}'";
$app_strings['LBL_MULTIPLE_PRIMARY_EMAIL_VALIDATION_ERROR'] = "Apenas um endereço de email válido deve ser marcado como principal";
$app_strings['LBL_DUPLICATE_EMAIL_VALIDATION_ERROR'] = "Endereços de e-mail duplicados não são permitidos";
$app_strings['LBL_NO_PRIMARY_EMAIL_VALIDATION_ERROR'] = "Apenas um endereço de email válido deve ser marcado como principal";
$app_strings['LBL_NO_EM_ID'] = 'Não foi possível obter o ID de Marketing do Email';
...
$app_strings['LBL_SELECT_EMAIL_FOR_TEST'] = 'Por favor selecione Alvos/Usuários ou digite um Email';
...
$app_strings['LBL_OPPORTUNITIES_TOTAL_SUM_TOOLTIP'] = 'Soma Total de Oportunidades';
$app_strings['LBL_QUOTES_EXPIRY_TOOLTIP'] = 'Data de expiração da próxima Cotação';
...
$app_strings['LBL_LINK'] = 'Vincular';
$app_strings['LBL_LINK_UNLINK'] = 'Vincular / Desvincular';
$app_strings['LBL_SAVE'] = 'Salvar';
$app_strings['LBL_UNLINK_RECORD'] = 'Desvincular Registro';
$app_strings['LBL_DELETE_RECORD'] = 'Excluir registro';
...
$app_strings['LBL_ALL_RECORDS_UNLINKED'] = 'Todos os registros desvinculados com sucesso';
$app_strings['LBL_SOME_RECORDS_UNLINKED_FAILED'] = 'Houve um problema ao desvincular alguns registros. Veja os logs para mais.';
...
$app_strings['LBL_FILE_NOT_FOUND'] = 'Não foi possível carregar o arquivo';
...
$app_strings['ERR_OAUTH_CONNECTION_ERROR'] = 'Não foi possível conectar usando o login OAuth. Para conexão: ';
...
$app_strings['LBL_ALERT_STATUS_COMPLETED'] = 'Concluída';
$app_strings['LBL_ALERT_STATUS_COMPLETED_WITH_FAILURES'] = 'Concluído com Falhas';
$app_strings['LBL_ALERT_STATUS_FAILED'] = 'Falhou';
...
$app_strings['LBL_RELATIONSHIPS'] = 'Relacionamentos';
$app_strings['LBL_SHOW_CC'] = 'Mostrar Cc';
$app_strings['LBL_SHOW_BCC'] = 'Mostrar Bcc';
$app_strings['LBL_CC'] = 'Cc';
$app_strings['LBL_BCC'] = 'Bcc';
$app_strings['LNK_NEW_EMAIL'] = 'Novo Email';
$app_strings['LBL_INSERT_TEMPLATE'] = 'Inserir Modelo';
$app_strings['LBL_MISSING_RECORD_DATA'] = 'Registro de Dados Faltando';
$app_strings['LBL_MISSING_FIELDS_DATA'] = 'Dados de Campos Faltando';
$app_strings['LBL_WRONG_MODULE_PROVIDED'] = 'Módulo Errado Fornecido';
$app_strings['LBL_NO_TEMPLATE_ID_PROVIDED'] = 'Nenhum Id de modelo fornecido';
$app_strings['LBL_TEMPLATE_NOT_FOUND'] = 'Modelo não encotrado';
$app_strings['LBL_EMAIL_MODAL_DYNAMIC_TITLE'] = 'Novo Email{{fields.name.value|prefix:\' - \'}}';
$app_strings['LBL_EMAIL_MODAL_DRAFT_DYNAMIC_TITLE'] = 'Rascunho{{fields.name.value|prefix:\' - \'}}';
$app_strings['LBL_CLOSE_EMAIL_MODAL'] = 'Você tem certeza que deseja descartar este Email? (As alterações serão perdidas)';
$app_strings['LBL_RELATED_TO_DYNAMIC'] = '{{fields.parent_type.value|uppercase}}';
$app_strings['LBL_RELATED_TO'] = 'Referente a';
...
$app_strings['LBL_SMALL'] = 'Pequeno';
$app_strings['LBL_MEDIUM'] = 'Média';
$app_strings['LBL_NORMAL'] = 'Normal';
$app_strings['LBL_LARGE'] = 'Grande';
$app_strings['LBL_HUGE'] = 'Gigante';
$app_strings['LBL_DEFAULT'] = 'Padrão';
$app_strings['LBL_APPLY'] = 'Aplicar';
$app_strings['LBL_INSERT_LINK_URL_DESCRIPTION'] = 'Inserir URL ou Email:';
$app_strings['LBL_INSERT_LINK_PLACEHOLDER'] = 'Por exemplo: https://www.exemplo.com';

$app_strings['LBL_COLOR_BLACK'] = 'Preto';
$app_strings['LBL_COLOR_FIREBRICK'] = 'Tijolo';
$app_strings['LBL_COLOR_RED'] = 'Vermelho';
$app_strings['LBL_COLOR_SALMON'] = 'Salmão';
$app_strings['LBL_COLOR_BLUSH'] = 'Corado';
$app_strings['LBL_COLOR_DARK_RED'] = 'Vermelho Escuro';
$app_strings['LBL_COLOR_BROWN'] = 'Marrom';
$app_strings['LBL_COLOR_DARK_ORANGE'] = 'Laranja Escuro';
$app_strings['LBL_COLOR_ORANGE'] = 'Laranja';
$app_strings['LBL_COLOR_ANTIQUE_WHITE'] = 'Branco Antigo';
$app_strings['LBL_COLOR_SADDLE_BROWN'] = 'Marrom Sela';
$app_strings['LBL_COLOR_GOLDENROD'] = 'Cajado Dourado';
$app_strings['LBL_COLOR_GOLD'] = 'Ouro';
$app_strings['LBL_COLOR_YELLOW'] = 'Amarelo';
$app_strings['LBL_COLOR_LIGHT_YELLOW'] = 'Amarelo Claro';
$app_strings['LBL_COLOR_DARK_SLATE_GRAY'] = 'Cinza Ardósia Escuro';
$app_strings['LBL_COLOR_DARK_GREEN'] = 'Verde Escuro';
$app_strings['LBL_COLOR_GREEN'] = 'Verde';
$app_strings['LBL_COLOR_LIME'] = 'Verde-Lima';
$app_strings['LBL_COLOR_HONEYDEW'] = 'Melado';
$app_strings['LBL_COLOR_TEAL'] = 'Cerceta';
$app_strings['LBL_COLOR_TURQUOISE'] = 'Turquesa';
$app_strings['LBL_COLOR_AQUA'] = 'Água';
$app_strings['LBL_COLOR_PALE_TURQUOISE'] = 'Turquesa-Claro';
$app_strings['LBL_COLOR_AZURE'] = 'Azul-Celeste';
$app_strings['LBL_COLOR_NAVY_BLUE'] = 'Azul Marinho';
$app_strings['LBL_COLOR_MEDIUM_BLUE'] = 'Azul Médio';
$app_strings['LBL_COLOR_BLUE'] = 'Azul';
$app_strings['LBL_COLOR_LIGHT_BLUE'] = 'Azul claro';
$app_strings['LBL_COLOR_ALICE_BLUE'] = 'Azul-Alice';
$app_strings['LBL_COLOR_INDIGO'] = 'Indigo';
$app_strings['LBL_COLOR_PATRIARCH_PURPLE'] = 'Patriarca Roxo';
$app_strings['LBL_COLOR_VIOLET_PURPLE'] = 'Violeta Roxo';
$app_strings['LBL_COLOR_PLUM'] = 'Ameixa';
$app_strings['LBL_COLOR_LAVENDER'] = 'Lavanda';
$app_strings['LBL_COLOR_DIM_GRAY'] = 'Cinza Escuro';
$app_strings['LBL_COLOR_GRAY'] = 'Cinza';
$app_strings['LBL_COLOR_DARK_GRAY'] = 'Cinza Escuro';
$app_strings['LBL_COLOR_LIGHT_GRAY'] = 'Cinza Claro';
$app_strings['LBL_COLOR_WHITE'] = 'Branco';

$app_strings['LBL_BOLD'] = 'Negrito';
$app_strings['LBL_ITALIC'] = 'Itálico';
$app_strings['LBL_INSERT_TEMPLATE_VARIABLE'] = 'Inserir Variável';
$app_strings['LBL_UNDERLINE'] = 'Sublinhado';
$app_strings['LBL_STRIKETHROUGH'] = 'Tachado';
$app_strings['LBL_FONT_FACE'] = 'Família de Fontes';
$app_strings['LBL_TEXT_SIZE'] = 'Tamanho do Texto';
$app_strings['LBL_TEXT_COLOR'] = 'Cor do Texto';
$app_strings['LBL_TEXT_HIGHLIGHT'] = 'Destaque do Texto';
$app_strings['LBL_LINK'] = 'Vincular';
$app_strings['LBL_UNORDERED_LIST'] = 'Lista não ordenada';
$app_strings['LBL_ORDERED_LIST'] = 'Lista ordenada';
$app_strings['LBL_QUOTE'] = 'Cotação';
$app_strings['LBL_UNQUOTE'] = 'Tirar Citação';
$app_strings['LBL_ALIGN'] = 'Alinhar';
$app_strings['LBL_ALIGN_LEFT'] = 'Esquerda';
$app_strings['LBL_ALIGN_CENTER'] = 'Centralizar';
$app_strings['LBL_ALIGN_RIGHT'] = 'Direita';
$app_strings['LBL_JUSTIFY'] = 'Justificar';
$app_strings['LBL_TEXT_LEFT_TO_RIGHT'] = 'Direção do texto: Esquerda para Direita';
$app_strings['LBL_TEXT_RIGHT_TO_LEFT'] = 'Direção do texto: direita para esquerda';
$app_strings['LBL_CLEAR_FORMATTING'] = 'Limpar Formatação';
$app_strings['LBL_INJECT_UNSUBSCRIBE'] = 'Link para cancelar Assinatura';
$app_strings['LBL_TEXT_INDENT_LEFT'] = 'Identar Texto à Esquerda';
$app_strings['LBL_TEXT_INDENT_RIGHT'] = 'Identar Texto à Direita';

// Day and Time labels
$app_strings['LBL_SUN'] = 'Domingo';
$app_strings['LBL_MON'] = 'Segunda';
$app_strings['LBL_TUE'] = 'Terça';
$app_strings['LBL_WED'] = 'Quarta';
$app_strings['LBL_THU'] = 'Quinta';
$app_strings['LBL_FRI'] = 'Sexta';
$app_strings['LBL_SAT'] = 'Sábado';
$app_strings['LBL_ALL'] = 'Todos os Dias';
$app_strings['LBL_EVERY'] = 'A cada';
$app_strings['LBL_ON_THE'] = 'No(a)';
$app_strings['LBL_RANGE'] = 'a';
$app_strings['LBL_FROM'] = 'De';
...
$app_strings['LBL_OFTEN'] = 'Tão frequente quanto possível.';
$app_strings['LBL_MIN_MARK'] = 'marca de minuto';
$app_strings['LBL_INBOUND_EMAIL'] = 'Email de Entrada';

$app_strings['LBL_LEGEND'] = 'Legenda';

$app_strings['LBL_EMAIL_MARKETING_NOT_UNSCHEDULED'] = 'Email de Marketing não esta Desagendada, não pode agendar';
$app_strings['LBL_INCORRECT_RECORD_ID'] = 'Id do Registro Incorreto';

$app_strings['LBL_TEST_ENTRIES_DELETED'] = 'Entradas de teste excluídas.';
$app_strings['LBL_UNABLE_TO_GET_ID'] = 'Não foi possível recuperar o ID do Email de Marketing';
$app_strings['LBL_UNABLE_TO_DELETE_TEST_ENTRIES'] = 'Erro ao excluir entradas de teste. Veja os logs para mais informações';
$app_strings['LBL_SECTION_KEY_NOT_DEFINED'] = 'Chave de seção não definida';
$app_strings['LBL_DOES_BOUNCE_EXIST'] = 'Existe um Email de Retorno?';
$app_strings['LBL_IS_OUTBOUND_CONNECTED'] = 'O Email de Saída está conectado?';
$app_strings['LBL_CAMPAIGN_SETTINGS'] = 'Configurações';
...
$app_strings['LBL_CRON_LAST_RUN'] = 'Última execução bem-sucedida';
$app_strings['LBL_CRON_LAST_USER_TO_RUN'] = 'Último usuário para executar os agendamentos';
$app_strings['LBL_LAST_RUN_VALUE'] = '{{ fields.lastRun.value }}';
$app_strings['LBL_LAST_USER_RUN_VALUE'] = '{{ fields.user.value }}';
$app_strings['LBL_RUN_USER_INVALID'] = 'Este usuário não faz parte da configuração de configuração `allowed_cron_users`. Portanto, a última execução não foi bem sucedida';
$app_strings['LBL_SCHEDULERS_NEVER_RUN'] = 'Os agendadores nunca foram executados.';
$app_strings['LBL_MARKETING_ITEMS_PER_RUN'] = 'Campanha De Itens De Marketing Por Execução';
$app_strings['LBL_EMAILS_PER_RUN'] = 'Campanha De Emails Por Execução';
$app_strings['LBL_TRACKERS_ENABLED'] = 'Rastreadores Habilitados';
$app_strings['LBL_TRACKER_LINKS_ENABLED'] = 'Links de Rastreadores Ativados';
...
$app_strings['LBL_EMAILS_MAX_RETRIES'] = 'Máximo de tentativas de Emails de Campanha';
$app_strings['LBL_EMAILS_MAX_RETRIES_DYNAMIC_LABEL'] = '{{ fields.campaign_emails_max_retries.value }}';
$app_strings['LBL_EMAILS_THRESHOLD'] = 'Emails de Campanha Erro de Limite por Lote';
...
$app_strings['LBL_UNSUBSCRIBE'] = 'Cancelar assinatura';
$app_strings['LBL_INACTIVE'] = 'Inativa';
$app_strings['LBL_DISPLAYING_TEST_EMAIL_MARKETING_DATA'] = 'Gráficos e Subpainéis exibindo atualmente dados gerados a partir de Emails de Testado.';
$app_strings['LBL_DASH_SYMBOL'] = '-';
$app_strings['LBL_FIELD_STORAGE_NOT_SET'] = 'Tipo de armazenamento de arquivo não definido para campo. Não é possível carregar o arquivo.';
$app_strings['LBL_FIELD_STORAGE_INVALID_TYPE'] = 'Tipo de armazenamento de arquivo não é válido para o campo. Não é possível carregar o arquivo.';
$app_strings['LBL_UPLOAD'] = 'Enviar';
$app_strings['LBL_UPLOAD_FAILED'] = 'Envio falhou. Por favor, tente novamente mais tarde';
$app_strings['LBL_UPLOADING'] = 'Enviando';
$app_strings['LBL_UPLOAD_FROM_FILES'] = 'Carregar Arquivos';
$app_strings['LBL_ATTACH_DOCUMENTS'] = 'Anexar Documentos';
$app_strings['LBL_FILE_FIELD_UPLOAD_BUTTON_DESCRIPTION'] = 'Clique ou arraste um arquivo aqui para enviar';
$app_strings['LBL_ATTACHMENTS_FIELD_UPLOAD_BUTTON_DESCRIPTION'] = 'Arraste e solte os arquivos aqui para fazer o upload';
$app_strings['LBL_SOME_ATTACHMENTS_FAILED'] = 'Alguns anexos não foram enviados. Consulte os logs para obter mais informações.';
$app_strings['LBL_UPLOAD_IMAGE'] = 'Enviar Imagem';
$app_strings['LBL_DOWNLOAD_IMAGE'] = 'Baixar Imagem';
$app_strings['LBL_PREVIEW_IMAGE'] = 'Pré-visualizar a Imagem';
$app_strings['LBL_UPLOAD_IMAGE_DESCRIPTION'] = 'Clique ou arraste um arquivo aqui para enviar';
$app_strings['LBL_INVALID_PROCESS_OPTIONS'] = 'Opções de processo inválidas. Veja os logs para mais informações.';
$app_strings['LBL_TEMPORARY'] = 'Temporário';
$app_strings['LBL_MAX_FILE_SIZE_EXCEEDED'] = 'O arquivo excede o tamanho máximo permitido.';
$app_strings['LBL_UNSUPPORTED_IMAGE_TYPE'] = 'O tipo de imagem não é suportado.';
$app_strings['LBL_UNSUPPORTED_FILE_TYPE'] = 'Este tipo de arquivo não é suportado.';
$app_strings['LBL_UNSUPPORTED_IMAGE_FILE_TYPE'] = 'O tipo de imagem não é suportado.';
$app_strings['LBL_MALWARE_DETECTED'] = 'Malware detectado no arquivo enviado. O upload foi rejeitado.';

$app_strings['LBL_DEFAULT_OUTBOUND_NOT_SET'] = 'Não é possível recuperar o Email de Saída Padrão';
$app_strings['LBL_SMTP_UNABLE_TO_CONNECT']='Não é possível conectar ao servidor SMTP com as configurações atuais de Email de Saída.';
$app_strings['LBL_DEFAULT_OUTBOUND_NOT_CONFIGURED'] = 'Conta de Saída de Email não configurada corretamente.';

$app_strings['LBL_CRON_UNRECOMMENDED_USER'] = 'Você está atualmente executando como root, isto NÃO é recomendado, você gostaria de continuar (y,n)? ';
$app_strings['LBL_UNKNOWN_USER'] = 'Usuário Desconhecido';

$app_strings['LBL_DRAFTS'] = 'Rascunhos';
$app_strings['LBL_DRAFT_ITEM_LAST_MODIFIED'] = '{{fields.date_modified.value}}';
$app_strings['LBL_DRAFT_ITEM_TO_EMPTY'] = 'Nenhum Destinatário(s)';
...
$app_strings['LBL_DRAFTS_DELETED_SUCCESSFULLY'] = 'Rascunhos excluídos com sucesso.';
$app_strings['LBL_DRAFT_DELETED_SUCCESSFULLY'] = 'Rascunho excluído com sucesso.';
$app_strings['LBL_DRAFTS_DELETED_UNSUCCESSFULLY'] = 'Rascunhos não excluídos com sucesso. Veja os logs para mais informações.';
$app_strings['LBL_DRAFT_DELETED_UNSUCCESSFULLY'] = 'Rascunhos não excluídos com sucesso. Veja os logs para mais informações.';
$app_strings['LBL_OPEN_DRAFT'] = 'Abrir Rascunho';
$app_strings['LBL_DELETE_DRAFT'] = 'Excluir Rascunho';
$app_strings['LBL_UNABLE_TO_GET_DRAFT_ID'] = 'Não foi possível recuperar o ID do Rascunho.';
$app_strings['LBL_UNABLE_TO_DELETE_DRAFT'] = 'Não é possível excluir o rascunho.';
$app_strings['LBL_EMAIL_NOT_DRAFT'] = 'O Email não é mais um rascunho.';
$app_strings['LBL_DRAFT_DELETED_SUCCESSFULLY'] = 'Rascunho excluído com sucesso.';

$app_strings['LBL_CANNOT_DELETE_LATEST_REVISION'] = 'Você não pode apagar a última revisão de um documento.';
$app_strings['LBL_NO_DOCUMENT_ID_PROVIDED'] = 'Não foi possível encontrar o documento para excluir a revisão, nenhum Id de documento fornecido.';
$app_strings['LBL_NO_RECORD_ID_PROVIDED'] = 'Não foi possível encontrar a revisão do documento para excluir, nenhum id de registro fornecido.';
$app_strings['LBL_DELETE_REVISION_CONFIRM'] = 'Você tem certeza que deseja excluir esta revisão?';
$app_strings['LBL_DOCUMENT_NOT_FOUND'] = 'Documento não encontrado.';
$app_strings['LBL_EMAIL_ATTACHMENT_DOCUMENT_DELETED'] = 'Um ou mais documentos anexados foram excluídos e não podem ser enviados.';

$app_strings['LBL_DISMISS_INVALID_STATUS'] = 'Este registro não pode ser descartado enquanto ainda estiver em andamento.';
$app_strings['LBL_DISMISS_FAILED'] = 'Falha ao descartar. Por favor, tente novamente.';
$app_strings['LBL_RERUN_NOT_ELIGIBLE'] = 'Este registro não é elegível para reexecução. Ele pode não ter concluído com falhas ou a reexecução pode não ser suportada.';
$app_strings['LBL_RETRY_FAILED_NOT_ELIGIBLE'] = 'Este registro não é elegível para nova tentativa. Ele pode não ter concluído com falhas ou tentar novamente pode não ser suportado.';
$app_strings['LBL_ASYNC_TASK_UNSUPPORTED_MODULE'] = 'Este módulo não suporta tarefas assíncronas.';
$app_strings['LBL_RERUN_SUCCESS'] = 'A tarefa foi re-colocada na fila e será reiniciada desde o início.';
$app_strings['LBL_RETRY_FAILED_SUCCESS'] = 'Itens marcados como Falha foram re-enfileirados para processamento.';

$app_strings['LBL_MIGRATE_GOOGLE_CALENDAR_SYNC_SIBLING_RUNNING'] = 'Não é possível executar essa migração enquanto "Migrar Sincronização de Usuários com o Calendário do Google" está pendente / em execução.';
$app_strings['LBL_MIGRATE_GOOGLE_CALENDAR_SYNC_USERS_SIBLING_RUNNING'] = 'Não é possível executar essa migração enquanto "Migrar Sincronização de Usuários com o Calendário do Google" está pendente / em execução.';
