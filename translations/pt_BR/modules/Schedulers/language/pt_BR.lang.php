...
// OOTB Scheduler Job Names:
    ...
    'LBL_OOTB_CAL_ACC_SYNC' => 'Sincronizar Contas de Calendário',
    'LBL_OOTB_SEND_EMAIL_TO_QUEUE' => 'Fila de Emails de Campanha',
    'LBL_OOTB_SEND_EMAIL_FROM_QUEUE' => 'Enviar Emails de Campanha',
    'LBL_OOTB_CLEAN_UP_TEMP_FILES' => 'Limpar arquivos temporários',
...
// Cron
    ...
    'LBL_CRON_SETUP' => 'Configuração de Agendadores',
    ...
    'LBL_CRON_LINUX_DESC1' => 'Para executar o agendador SuiteCRM',
    'LBL_CRON_LINUX_DESC2' => '1. Edite o arquivo crontab do usuário do servidor web com este comando',
    'LBL_CRON_LINUX_DESC3' => '2. Em seguida, atualize e adicione a seguinte linha ao arquivo crontab:',
    'LBL_CRON_LINUX_DESC4' => 'Você deve fazer isso somente depois que a instalação for concluída.',
    'LBL_CRON_LINUX_DESC5' => '2(i). Para definir as variáveis de ambiente, adicione a seguinte linha:',
    'LBL_CRON_LINUX_DESC6' => 'Por favor atualize [path/to/php] e [path/to/suite/instance] para refletir seu ambiente.',
    'LBL_CRON_WINDOWS_DESC' => 'Para executar o agendador SuiteCRM',
    'LBL_CRON_WINDOWS_DESC2' => '1. Crie um arquivo de lote para executar usando as tarefas agendadas do Windows. O arquivo de lote deve incluir os seguintes comandos:',
    'LBL_CRON_WINDOWS_DESC3' => 'Por favor atualize [path\to\php.exe] e [path\to\suite\instance] para refletir seu ambiente.',
    'LBL_SCHEDULERS_INFO' => 'Informação do Agendador',
    'LBL_SCHEDULERS_NEVER_RUN' => 'Os agendadores nunca foram executados.',
    // Subpanels
...
//jobstrings
    ...
    'LBL_RUNMASSEMAILCAMPAIGN' => 'Executar Campanhas Noturnas de Email em Massa',
    'LBL_POLLMONITOREDINBOXESFORBOUNCEDCAMPAIGNEMAILS' => 'Executar processo noturno de processamento de Emails de campanha devolvidos',
    'LBL_PRUNEDATABASE' => 'Prune Database no 1º dia do Mês',
    'LBL_TRIMTRACKER' => 'Remover Tabelas de Rastreador',
    ...
    'LBL_CALENDARSYNCJOB' => 'Sincronizar Contas de Calendário',
    'LBL_SENDFROMQUEUE' => 'Enviar emails da fila de Email',
    'LBL_CLEANUPTEMPORARYFILES' => 'Limpar arquivos temporários',
    'LBL_EMAILTOQUEUE' => 'Enviar Emails Agendados para a Fila de Email',
