...
$mod_strings = array(
    ...
    'LBL_CONFIGURE_SETTINGS_TITLE' => 'Definições de Sistema',
    ...
    'LBL_ALLOW_DEFAULT_SELECTION' => 'Permitir que esta conta seja selecionada como padrão:',
    'LBL_ALLOW_DEFAULT_SELECTION_HELP' => 'Quando esta opção estiver selecionada, todos os usuários poderão enviar e-mails usando a mesma conta de saída utilizada para enviar notificações e alertas do sistema. Se esta opção não estiver selecionada, os usuários ainda poderão usar o servidor de e-mail de saída após fornecerem as informações de suas próprias contas.',
    ...
    'LBL_MODULE_NAME' => 'Definições de Sistema',
    ...
    'LBL_PROXY_HOST' => 'Servidor de Proxy',
    ...
    'LBL_PROXY_TITLE' => 'Configurações do Proxy',
    ...
    'NEW_LOGO_HELP' => 'O formato do arquivo de imagem pode ser .png ou .jpg. A altura máxima é de 170px, e a largura máxima é de 450px. Qualquer imagem carregada é maior em qualquer direção será dimensionada para essas dimensões máximas.',
    'NEW_LOGO_HELP_NO_SPACE' => 'O formato do arquivo de imagem pode ser .png ou .jpg. A altura máxima é de 170px, e a largura máxima é de 450px. Qualquer imagem carregada é maior em qualquer direção será dimensionada para essas dimensões máximas.',
    ...
    'SYSTEM_NAME_HELP' => 'Este é o nome exibido na barra de título do seu navegador.',
    ...
    'LBL_LDAP_GROUP_MEMBERSHIP' => 'Membros do Grupo:',
    'LBL_LDAP_GROUP_MEMBERSHIP_DESC' => 'Os usuários devem ser membros de um grupo específico',
    ...
    'LBL_LDAP_GROUP_ATTR_DESC' => 'O atributo do Grupo que será usado para filtrar contra o Atributo de Usuário Exemplo: <em>memberUid</em>',
    ...
    'LBL_LOGGER_DEFAULT_DATE_FORMAT' => 'Formato Padrão de Data',
...
// Wizard
    ...
    'LBL_WIZARD_SYSTEM_DESC' => 'Informe o nome e o logotipo da sua organização para personalizar o SuiteCRM com a identidade visual da sua marca.',
    'LBL_WIZARD_LOCALE_DESC' => 'Defina como os dados serão exibidos no SuiteCRM com base na sua localização. Essas configurações serão usadas como padrão, mas cada usuário poderá ajustá-las posteriormente.',
    'LBL_WIZARD_SMTP_DESC' => 'Informe a conta de email que será usada pelo SuiteCRM para enviar mensagens, como notificações de atribuição e senhas de novos usuários.',
    ...
    'LBL_HISTORY_SUBPANEL' => 'Subpainel de História',
);
