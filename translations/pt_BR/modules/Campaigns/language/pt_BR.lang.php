...
$mod_strings = array(
    ...
    'LBL_LIST_EXPECTED_REVENUE' => 'Expectativa de Receita',
    'LBL_LIST_EXPECTED_COST' => 'Custo Estimado',
    ...
    'LBL_TRACKER_URL' => 'URL de Rastreamento:',
    ...
    'LBL_TRACKED_URLS_SUBPANEL_TITLE' => 'URLs de Rastreamento',
    ...
    'LBL_TEST_BUTTON_LABEL' => 'Teste de Envio',
    ...
    'LBL_LOG_ENTRIES_REMOVED_TITLE' => 'Descadastrado',
    ...
    'LBL_SURVEY' => 'Pesquisa',
    'LBL_NEWSLETTER_FORENTRY' => 'Boletim Informativo',
    ...
    'LBL_EDIT_TRACKER_URL' => 'URL de Rastreamento',
    'LBL_EDIT_OPT_OUT_' => 'Link de Descadastramento?',
    ...
    'LBL_CAMPAIGN_MARKETING_RECORDS_PER_RUN' => 'Número de emails de registros de marketing para processar por execução:',
    ...
    'LBL_ROI_CHART_EXPECTED_REVENUE' => 'Receita Prevista',
    ...
    'LBL_SEND ERROR_SUBPANEL_TITLE' => 'Enviar Erro',
    ...
    'LBL_CAMPAIGN_INFORMATION' => 'VISÂO GERAL', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
    ...
    'LBL_SUPPRESSION_LISTS_HELP' => 'Aplicado em todos os registros de marketing enviados para esta campanha.',
    'LBL_SUPPRESSION_LISTS_UNSUBSCRIBED_HELP' => 'Desinscrição (opt-outs) serão adicionadas a uma da lista de supressão de Id.',
    'LBL_SUPPRESSION_LISTS_UNSUBSCRIBED_AUTO_CREATE_HELP' => 'Se nenhuma lista de supressão de id for selecionada, o sistema irá criar uma lista de supressão padrão para esta campanha.',
    'LBL_SUPPRESSION_LISTS_UNSUBSCRIBED_NONE_SELECTED_HELP' => 'Se todas as listas de supressão de id forem removidas, após a desinscrição (opt-out), o endereço de email será globalmente desinscrito.',
    'LBL_SURVEYRESPONSES_CAMPAIGNS_FROM_SURVEYRESPONSES_TITLE' => 'Respostas da pesquisa',
    'LBL_CAMPAIGN_SURVEY' => "Pesquisa",
    'LBL_CAMPAIGN_ACTIONS' => 'Ações de Campanha',
    'LBL_NEW_EM_SURVEY' => 'Criar Pesquisa de Marketing de Email',
    'LBL_TARGET_LISTS_HELP' => 'Listas de alvos que estão disponíveis em registros de marketing.',
    'LBL_CAMPAIGN_START_DATE_HELP' => 'Data de referência para o início da campanha.',
    'LBL_CAMPAIGN_END_DATE_HELP' => 'Data de referência para o fim da campanha. Não afeta o processo de envio de marketing.',
);
