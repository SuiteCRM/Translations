...
$mod_strings = array(
    ...
    'LBL_ALT_ADDRESS_STREET_3' => 'Endereço Alternativo Rua 3:',
    'LBL_ALT_ADDRESS_STREET' => 'Alternativo - Rua:',
    'LBL_ALTERNATE_ADDRESS' => 'Outro Endereço:',
    'LBL_ALT_ADDRESS' => 'Outros Endereços:',
    ...
    'LBL_CONTACT_INFORMATION' => 'VISÂO GERAL', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
    ...
    'LBL_DIRECT_REPORTS_SUBPANEL_TITLE' => 'Subordinados Diretos',
    ...
    'LBL_FAILED_TO_CONNECT_JOOMLA' => 'Falha ao criar usuário do portal, não foi possível conectar ao Joomla',
    'LBL_ERROR_CONTACT_ID_OR_EMAIL_EMPTY' => 'O ID de contato ou Email está vazio',
