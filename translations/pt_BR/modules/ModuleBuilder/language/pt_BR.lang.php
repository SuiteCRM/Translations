...
$mod_strings = array(
    ...
    'LBL_DELETE' => 'Deletar' /*for 508 compliance fix*/,
    'help' => array(
        'package' => array(
        ...
        ,
            'savebtn' => 'Clique em <b>Salvar e Implantar</b> para salvar as alterações feitas e aplicá-las ao módulo.',
        ...
        ,
            'savebtn' => 'Clique em <b>Salvar e Implantar</b> para salvar as alterações feitas e aplicá-las ao módulo.',
            'historyBtn' => 'Clique em <b>Ver Histórico</b> para visualizar e restaurar um layout salvo anteriormente.<br><br>A opção <b>Restaurar</b>, dentro de <b>Ver Histórico</b>, recupera a disposição dos campos de um layout salvo. Para alterar os rótulos dos campos, clique no ícone de edição ao lado de cada campo.',
            'historyDefault' => 'Clique em <b>Restaurar Padrão</b> para restaurar uma visualização ao seu layout original.<br><br><b>Restaurar Padrão</b> restaura apenas a disposição dos campos no layout original. Para alterar os rótulos dos campos, clique no ícone de edição ao lado de cada campo.',
            'Hidden' => 'Campos <b>Ocultos</b> não estão disponíveis para visualização pelos usuários nas Visualizações em Lista.',
            'Default' => 'Campos <b>Padrão</b> aparecem nas Visualizações em Lista que não foram personalizadas pelos usuários.'
        ),
        ...
        ,
            ...
            'historyBtn' => 'Clique em <b>Ver Histórico</b> para visualizar e restaurar um layout salvo anteriormente no histórico.<br><br><b>Restaurar</b>, dentro de <b>Ver Histórico</b>, restaura a disposição dos campos de layouts salvos anteriormente. Para alterar os rótulos dos campos, clique no ícone de edição ao lado de cada campo.',
            'historyDefault' => 'Clique em <b>Restaurar Padrão</b> para restaurar uma visualização ao seu layout original.<br><br><b>Restaurar Padrão</b> restaura apenas a disposição dos campos no layout original. Para alterar os rótulos dos campos, clique no ícone de edição ao lado de cada campo.',
        ...
        'exportcustom' => array(
            ...
            'description' => 'Esta é a <b>Descrição</b> do pacote exibida durante a instalação.',
        ),
        'studioWizard' => array(
...
<b>Excluir:</b> Excluir este módulo do layout de conversão. <br/><br/>',
    ...
    'assistantHelp' => array(
        ...
        'dropdownEditor' => array(
            'default' => 'Há duas colunas exibidas à esquerda. A coluna da direita, identificada como Layout Atual ou Visualização de Layout, é onde você altera o layout do módulo. A coluna da esquerda, chamada Caixa de Ferramentas, contém elementos e ferramentas úteis para edição do layout.<br/><br/>Se a área de layout estiver identificada como Layout Atual, você estará trabalhando em uma cópia do layout atualmente usado pelo módulo para exibição.<br/><br/>Se estiver identificada como Visualização de Layout, você estará trabalhando em uma cópia criada anteriormente ao clicar no botão Salvar, que pode já ter sido alterada em relação à versão visualizada pelos usuários deste módulo.',
        ...
        'exportcustom' => array(
            ...
            'exportCustomBtn' => 'Clique em <b>Exportar</b> para criar um arquivo .zip do pacote contendo as personalizações que você deseja exportar.',
        ...
        'studioWizard' => array(
            'mainHelp' => 'Bem-vindo à área de <b>Ferramentas do Desenvolvedor</b>. <br/><br/>Use as ferramentas desta área para criar e gerenciar módulos e campos padrão ou personalizados.',
...
//STUDIO2
    ...
    'LBL_DEVELOPER_TOOLS' => 'Ferramentas de Desenvolvedor',
    ...
    'LBL_QUICKCREATE' => 'Criar Rapidamente',
