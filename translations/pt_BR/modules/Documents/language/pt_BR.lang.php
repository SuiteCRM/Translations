...
$mod_strings = array(
    ...
    'ERR_DELETE_CONFIRM' => 'Você deseja excluir esta revisão do documento?',
    ...
    'LBL_DOCUMENT_INFORMATION' => 'VISÂO GERAL', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
