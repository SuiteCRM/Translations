...
$mod_strings = array(
    ...
    'ERR_UW_CONFIG_WRITE' => 'Erro ao atualizar config.php com informações da nova versão.',
    ...
    'ERR_UW_NO_MANIFEST' => 'O arquivo zip não possui um arquivo manifest.php. Não é possível prosseguir.',
    ...
    'ERR_UW_ONLY_PATCHES' => 'Você só pode enviar patches nesta página.',
    ...
    'ERR_UW_SUITECRM_VERSION' => 'Versão do Sistema SuiteCRM: ',
    ...
    'LBL_UW_COMPLIANCE_CURL' => 'cURL Módulo',
    ...
    'LBL_UW_COMPLIANCE_XML' => 'Processamento de XML',
    ...
    'LBL_UW_IN_PROGRESS' => 'Em Andamento',
    ...
    'ERR_CHECKSYS_PHP_INVALID_VER' => 'Sua versão de PHP não é suportada pelo SuiteCRM. É necessário instalar uma versão que seja compatível com a aplicação SuiteCRM. Por favor, consulte a Matriz de Compatibilidade nas Notas de Lançamento para Versões de PHP suportadas. Sua versão é ',
    ...
    'LBL_LANGPACKS' => 'Pacote de Idiomas' /*for 508 compliance fix*/,
    'LBL_MODULELOADER' => 'Carregador de Módulo' /*for 508 compliance fix*/,
    'LBL_PATCHUPGRADES' => 'Melhorias de Atualização' /*for 508 compliance fix*/,
    'LBL_THEMES' => 'Temas' /*for 508 compliance fix*/,
    'LBL_WORKFLOW' => 'Workflow' /*for 508 compliance fix*/,
    'LBL_UPGRADE' => 'Melhorar' /*for 508 compliance fix*/,
    ...
    'ERR_UW_PHP_FILE_ERRORS' => array(
        1 => 'O arquivo enviado excede o tamanho maximo permitido por upload_max_filesize no php.ini.',
        2 => 'O arquivo enviado ultrapassa o limite de tamanho MAX_FILE_SIZE definido no formulário HTML.',
