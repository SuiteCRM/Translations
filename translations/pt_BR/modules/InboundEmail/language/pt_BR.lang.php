...
$mod_strings = array(
    ...
    'LBL_CASE_MACRO_DESC2' => 'Defina isto para qualquer valor, mas preserve o <b>"%1"</b>.',
    ...
    'LBL_MODULE_NAME' => 'Conta de Email do Grupo',
    'LBL_BOUNCE_MODULE_NAME' => 'Caixa de Correio de tratamento de devoluções',
    'LBL_MODULE_TITLE' => 'Email de Entrada',
    'LBL_NAME' => 'Nome',
    'LBL_NONE' => 'Nenhum',
    ...
    'LBL_SERVER_TYPE' => 'Protocolo do Servidor de Correio',
    'LBL_SERVER_PORT' => 'Porta do Servidor de Correio',
    'LBL_SERVER_URL' => 'Endereço do Servidor de Correio',
    'LBL_SSL_DESC' => 'Se o seu servidor de email suporta ligações de socket seguras, a ativação irá forçar as conexões SSL ao importar o email.',
    ...
    'LNK_LIST_OUTBOUND_EMAILS' => 'Contas de Email Saída',
    ...
    'LBL_STATUS_ACTIVE' => 'Ativa',
    'LBL_STATUS_INACTIVE' => 'Inativa',
    ...
    'LBL_TYPE_DIFFERENT' => 'O tipo de conexão OAuth externo deve ser o MESMO como tipo de conta de email de entrada',
    ...
    'LBL_LAST_IMPORT_RUN_DATETIME' => 'Última Importação Data/Hora de Execução',
    'LBL_MAILBOX_LAST_IMPORTED_DAYS' => 'Última data importada por caixa de correio',
    'LBL_EMAIL_IMPORT_PER_RUN_THRESHOLD' => 'Emails para importar por execução',
    'LBL_EMAIL_IMPORT_TIMEFRAME_START' => 'Importar Início do Período',
    'LBL_EMAIL_IMPORT_UNREAD_ONLY' => 'Importar Apenas Emails não lidos'
);
