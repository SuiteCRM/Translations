...
$mod_strings = array(
    ...
    'LBL_CALL_INFORMATION' => 'VISÂO GERAL', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
    'LBL_REMOVE' => 'Remover',
    ...
    'LBL_RESCHEDULE_COUNT' => 'Tentativas de Chamada',
