...
$mod_strings = array(
    ...
    'LBL_SEND_ON' => 'Envar em',
    'LBL_IN_QUEUE' => 'Em Andamento',
    ...
    'LBL_DRAFTS_POPUP' => 'Habilitar Popup de Rascunhos',
    ...
    'LBL_EMAILS_PER_RUN' => 'Número de emails processados/enviados por lote:',
    'LBL_CAMPAIGN_MAX_RETRIES' => 'Respostas máximas de envio por destinatário na falha:',
    'LBL_CAMPAIGN_THRESHOLD' => 'Erro limite por lote (campanha pausa quando atingido, 0 para desativar):',
    'LBL_CAMPAIGN_MARKETING_RECORDS_PER_RUN' => 'Número de registros de emails de marketing para processar por execução:',
    ...
    'LBL_CAMP_MESSAGE_COPY' => 'Manter cópias de mensagens de campanha:',
    'LBL_CAMP_MESSAGE_COPY_DESC' => 'Você gostaria de armazenar cópias completas de <bold>CADA</bold> mensagem de email enviada durante todas as campanhas? <bold>Recomendamos e definimos como padrão a opção não</bold>. Ao escolher não, será armazenado apenas o modelo enviado e as variáveis necessárias para recriar cada mensagem individual.',
    ...
    'LBL_MODULE_NAME' => 'Configurações de Email',
    ...
    'LBL_OUTBOUND_EMAIL_ACCOUNT_VIEW' => 'Ver Contas de Saída de Email',
    'LBL_SYSTEM_OUTBOUND_EMAIL_ACCOUNT' => 'Conta de Saída de Email do Sistema',
    ...
    'LBL_EMAIL_IMPORT_CONFIGURATION' => 'Configuração de Importação de Email',
    'LBL_EMAIL_IMPORT_PER_RUN_THRESHOLD' => 'Limite de Emails Importados Por Execução (por Caixa de Correio)',
    'LBL_EMAIL_IMPORT_PER_RUN_THRESHOLD_DESC' => 'Limite de e-mails a serem importados por execução. O padrão é 25. Cada execução percorrerá cada dia da caixa de correio dentro do período definido, do mais antigo ao mais recente. Serão importados todos os e-mails de cada dia até que o total de e-mails importados nesta execução exceda o limite. Quando esse limite for atingido, a tarefa será interrompida e o último dia importado será marcado, retomando a partir dele na próxima execução.',
    'LBL_EMAIL_IMPORT_TIMEFRAME_START' => 'Ponto inicial para importação de novas caixas de e-mail',
    'LBL_EMAIL_IMPORT_TIMEFRAME_START_DESC' => 'Período a partir do qual os emails começarão a ser importados. Por exemplo, selecionando os 30 Dias começará com os emails a partir de 30 dias atrás e avançará a partir daí.',
    'LBL_EMAIL_IMPORT_FETCH_UNREAD_ONLY' => 'Buscar apenas emails não lidos durante a importação',
);
