...
Consulte a documentação do PHP para obter mais informações sobre como habilitar o suporte à extensão mbstring.',
    ...
    'ERR_CHECKSYS_CUSTOM_NOT_WRITABLE' => 'O Diretório Custom existe, mas não é editável. Por favor, tome as medidas necessárias para tornar o diretório editável.',
    'ERR_CHECKSYS_FILES_NOT_WRITABLE' => "Os arquivos ou diretórios listados acima, não são editáveis ou estão ausentes e não podem ser criados. Por favor, tome as medidas necessárias para tornar os diretórios editáveis.",
    ...
    'ERR_DB_LOGIN_FAILURE_MYSQL' => 'O nome do usuário e/ou senha do banco de dados é inválido, e a conexão com o banco de dados não pôde ser estabelecida. Por favor, insira um host válido, nome de usuário e senha',
    'ERR_DB_LOGIN_FAILURE_MSSQL' => 'O nome do usuário e/ou senha do banco de dados é inválido, e a conexão com o banco de dados não pôde ser estabelecida. Por favor, insira um host válido, nome de usuário e senha',
    ...
    'ERR_NO_SINGLE_QUOTE' => 'Não é possível usar apóstrofo para ',
    ...
    'LBL_CHECKSYS_LEGACY_CACHE' => 'Sub-Diretórios de Cache Legado Editáveis',
    ...
    'LBL_CHECKSYS_ENV' => 'Arquivo .env Editável',
    ...
    'LBL_CHECKSYS_INTL_EXTENSIONS' => 'Intl Existe em Extensions',
    ...
    'LBL_CONFIRM_DB_TYPE' => 'Tipo do Banco de Dados',
    'LBL_CONFIRM_NOT' => 'não',
    ...
    'LBL_DBCONF_SUITE_DB_USER' => 'Usuário do Banco de Dados do SuiteCRM',
