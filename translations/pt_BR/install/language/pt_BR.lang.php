...
$mod_strings = array(
    ...
    'ERR_CHECKSYS_CONFIG_NOT_WRITABLE' => 'O arquivo config.php existe mas não é editável. Por favor, tome as medidas necessárias para tornar o arquivo editável. Dependendo do seu sistema operacional, pode ser necessário alterar as permissões executando o chmod 766, ou clique com o botão direito no nome do arquivo para acessar as propriedades e desmarcar a opção de somente leitura.',
    'ERR_CHECKSYS_CONFIG_OVERRIDE_NOT_WRITABLE' => 'O arquivo config_override.php existe mas não é editável. Por favor, tome as medidas necessárias para tornar o arquivo editável. Dependendo do seu sistema operacional, pode ser necessário alterar as permissões executando o chmod 766, ou clique com o botão direito no nome do arquivo para acessar as propriedades e desmarcar a opção de somente leitura.',
    'ERR_CHECKSYS_CUSTOM_NOT_WRITABLE' => 'O Diretório Custom existe mas não é editável. Você pode ter que alterar as permissões nele (chmod 766) ou clicar nele com o botão direito e desmarcar a opção apenas de leitura. dependendo do seu Sistema Operacional. Por favor, tome as medidas necessárias para tornar o arquivo editável.',
    'ERR_CHECKSYS_FILES_NOT_WRITABLE' => "Os arquivos ou diretórios abaixo listados não são editáveis ou estão ausentes e não podem ser criados. Dependendo do seu Sistema Operacional, corrigindo isso pode exigir que você altere as permissões nos arquivos ou na pasta pai (chmod 755), ou clicar com o botão direito no diretório principal e desmarcar a opção 'somente leitura' e aplicá-la a todas as subpastas.",
    ...
    'ERR_UPLOAD_MAX_FILESIZE' => 'Aviso: A configuração do PHP deve ser alterada para permitir o envio de arquivos de pelo menos 6MB.',
    ...
    'LBL_DISABLED_DESCRIPTION_2' => 'Após esta alteração ser feita, você pode clicar no botão "Iniciar" abaixo para começar a sua instalação. <i>Depois que a instalação for concluída, você vai querer alterar o valor de \'installer_locked\' para \'true\'.</i>',
