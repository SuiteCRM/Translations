...
//e.g. auf Deutsch 'Contacts'=>'Contakten',
    ...
    'moduleList' => array(
        'Home' => 'ගෙදර',
        'ResourceCalendar' => 'සම්පත් දින දර්ශනය',
        'Contacts' => 'අප අමතන්න',
        'Accounts' => 'ගිණුම්',
        'Alerts' => 'ඇලර්ට්ස්',
...
//prospect list type dom
    ...
    'campainglog_activity_type_dom' => array(
        ...
        'contact' => 'නිර්මාණය කරන ලද්දේ අප අමතන්න',
...
$app_strings = array(
    'LBL_SEARCH_RESULTS_TITLE' => 'ප්‍රතිඵල',
    ...
    'LBL_TOUR_NEXT' => 'ඊලඟ',
    'LBL_TOUR_SKIP' => 'ඔබ ලොගින් වී නොමැත',
    'LBL_TOUR_BACK' => 'ආපසු',
    ...
    'LBL_ID_FF_ADD' => 'එක් කරන්න', /*for 508 compliance fix*/
    ...
    'LBL_ADD' => 'එක් කරන්න', /*for 508 compliance fix*/
    ...
    'LBL_INFOINLINE' => 'තොරතුරු / * 508 අනුකූල විසඳුමක් සඳහා * /',
    'LBL_PRINT' => 'මුද්රණය',
    'LBL_HELP' => 'උදව්',
    ...
    'LBL_EMAIL_CHECK' => ' තැපැල් පරීක්ෂා',
    ...
    'LBL_EMAIL_FOLDERS_ADD' => 'එක් කරන්න',
    ...
    'LBL_EMAIL_FROM' => 'සිට',
    'LBL_EMAIL_GROUP' => 'කණ්ඩායම',
    'LBL_EMAIL_UPPER_CASE_GROUP' => '  සමූහ',
    'LBL_EMAIL_HOME_FOLDER' => 'ගෙදර',
    ...
    'LBL_EMAIL_INVALID' => 'වලංගු නොවන',
    'LBL_EMAIL_LOADING' => 'පූරණය ......',
    'LBL_EMAIL_MARK' => 'ලකුණ',
    ...
    'LBL_EMAIL_YES' => 'ඔව්',
    'LBL_EMAIL_TEST_OUTBOUND_SETTINGS' => 'අත්හදාබැලීමේ වි-තැපෑල යවන්න',
    ...
    'LBL_SEARCH_DROPDOWN_NO' => 'නැත',
    'LBL_CONTACT_LIST' => ' ඇමතුම් ලැයිස්තුව',
    'LBL_CONTACT' => 'සබඳතාව',
    'LBL_CONTACTS' => 'අප අමතන්න',
    ...
    'LBL_EMAILS' => 'විද්යුත් තැපැල් පණිවුඩ',
    'LBL_EMPLOYEES' => 'සේවක',
    'LBL_ENTER_DATE' => ' දිනය ඇතුලත් කරන්න',
    'LBL_EXPORT' => 'අපනයන',
    'LBL_FAVORITES_FILTER' => 'මාගේ ප්‍රියතමයන්',
    ...
    'LBL_CAMPAIGN_LEAD_SUBPANEL_TITLE' => 'ආදර්ශ',
    'LBL_OPPORTUNITY_SUBPANEL_TITLE' => 'අවස්ථා',
    'LBL_LOG_ENTRIES_CONTACT_TITLE' => 'නිර්මාණය කරන ලද්දේ අප අමතන්න',
    ...
    'LBL_RECORD_DOES_NOT_EXIST' => 'වාර්තා දැන ගැනීම දෝෂ. මෙම වාර්තාව මකා දැමීමට ඉඩ ඇත හෝ ඔබ අවශ්යවේ කිරීමට බලය කළ නොහැකි විය හැක.',
    'LBL_PROFILE' => 'පැතිකඩ',
    ...
    'LBL_SCHEDULERS' => 'සැලසුම් කරණයන් සඳහා',
    ...
    'LBL_TABGROUP_ACTIVITIES' => ' කටයුතු',
    ...
    'LBL_PROCESSING_REQUEST' => 'සකසමින්...',
...
"5. ඉල්ලුම් දී ක්රියා මෙනුවෙහි සිට ආනයන විකල්පය මත ක්ලික් කරන්න හා උඩුගත කිරීමට ගොනුව තෝරා"
   ',
    ...
    'LBL_ALT_SORT' => 'වර්ග',
    'LBL_ALT_SHOW_OPTIONS' => 'විකල්ප පෙන්වන්න',
    ...
    'LBL_SEND_DATE' => 'දිනය යවන්න',
    'LBL_SCHEDULE_BUTTON_LABEL' => 'උපෙල්ඛනෙය්',
    ...
    'PIPELINE_BY_SALES_STAGE' => 'විකුණුම් අදියර වන විට නල',
    ...
    'LBL_SEND_TEST_EMAIL' => 'අත්හදාබැලීමේ වි-තැපෑල යවන්න',
    ...
    'LBL_PROSPECT_LIST_NAME' => 'ඉලක්ක ලැයිස්තු',

    //List View Column Selector Modal
    'LBL_COLUMN_SELECTOR_DISPLAYED_COLS' => 'DISPLAYED',
    'LBL_COLUMN_SELECTOR_HIDDEN_COLS' => 'HIDDEN',
    'LBL_COLUMN_SELECTOR_CLOSE_BUTTON' => 'වසන්න / * 508 අනුකූල විසඳුමක් සඳහා * /',
    'LBL_COLUMN_SELECTOR_SAVE_BUTTON' => 'වෙනස්කම් සුරකින්න',
...
$app_list_strings['aor_date_type_list']['minute'] = 'මිනිත්තු';
...
$app_list_strings['aor_email_type_list']['Users'] = 'පරිශීලකයන්';
...
$app_list_strings['pdf_template_type_dom']['Contacts'] = 'අප අමතන්න';
$app_list_strings['pdf_template_type_dom']['Leads'] = 'ආදර්ශ';
...
$app_list_strings['aow_date_type_list']['minute'] = 'මිනිත්තු';
...
$app_list_strings['aow_email_type_list']['Users'] = 'පරිශීලකයන්';
...
$app_list_strings['map_module_type_list']['Contacts'] = 'අප අමතන්න';
$app_list_strings['map_module_type_list']['Cases'] = 'නඩු';
$app_list_strings['map_module_type_list']['Leads'] = 'ආදර්ශ';
...
$app_list_strings['marker_image_list']['administration'] = 'පරිපාලන';
...
$app_list_strings['marker_image_list']['home'] = 'ගෙදර';
...
$app_list_strings['marker_image_list']['info'] = 'තොරතුරු / * 508 අනුකූල විසඳුමක් සඳහා * /';
...
$app_list_strings['surveys_question_type']['Radio'] = 'ගුවන් විදුලි';
...
$app_strings['LBL_OPT_IN_INVALID'] = 'වලංගු නොවන';
...
$app_strings['LBL_INVALID_EMAIL'] = 'වලංගු නොවන';
$app_strings['LBL_PRIMARY'] = 'ප්රාථමික';
$app_strings['LBL_EMAIL_ADDRESS'] = 'විද්යුත් තැපැල් ලිපිනය';
...
$app_strings['LBL_NONE_OUTSTANDING'] = 'කිසිවක් නැත';
...
$app_strings['LBL_DEFAULT_TOTAL'] = 'මුළු';
$app_strings['AOS_Contracts'] = 'කොන්ත්රාත්';
$app_strings['AOS_Quotes'] = 'මිල කැඳවීම්';
$app_strings['AOS_Invoices'] = 'ඉන්වොයිසි';
$app_strings['LBL_PHOTO'] = 'ඡායාරූපය';
$app_strings['LBL_CASE_UPDATES'] = 'නඩු යාවත්කාලීන';
...
$app_strings['LBL_OPERATOR'] = 'ක්රියාකරු';
$app_strings['LBL_START'] = ' ආරම්භක';
$app_strings['LBL_END'] = ' අවසානය';
$app_strings['LBL_LINE_ITEMS_FIELD_CONFIG'] = 'Bad config';


$app_strings['LBL_ACTION_SUCCESS'] = 'Action successful';

$app_strings['LBL_YES'] = 'ඔව්';
$app_strings['LBL_NO'] = 'නැත';

$app_list_strings['sort_order'] = [];
$app_list_strings['sort_order']['asc'] = 'යද්දි';
$app_list_strings['sort_order']['desc'] = 'බැස';

// Labels used by subpanel unlink relationship process
$app_strings['LBL_LINK'] = 'ලින්ක්';
$app_strings['LBL_LINK_UNLINK'] = 'Link / Unlink';
$app_strings['LBL_SAVE'] = 'සුරකින්න';
...
$app_strings['LBL_RELATED_TO'] = 'සම්බන්දව';
...
$app_strings['LBL_MEDIUM'] = 'මධ්යම';
$app_strings['LBL_NORMAL'] = 'සාමාන්ය';
$app_strings['LBL_LARGE'] = 'Large';
$app_strings['LBL_HUGE'] = 'Huge';
$app_strings['LBL_DEFAULT'] = 'පෙරනිමි';
$app_strings['LBL_APPLY'] = 'අයදුම් කරන්න';
...
$app_strings['LBL_QUOTE'] = 'උපුටා';
$app_strings['LBL_UNQUOTE'] = 'Unquote';
$app_strings['LBL_ALIGN_LEFT'] = 'වමේ';
$app_strings['LBL_ALIGN_CENTER'] = 'Center';
$app_strings['LBL_ALIGN_RIGHT'] = 'රයිට්';
...
// Day and Time labels
$app_strings['LBL_SUN'] = 'ඉරිදා';
$app_strings['LBL_MON'] = 'සඳුදා';
$app_strings['LBL_TUE'] = 'අගහරුවදා';
$app_strings['LBL_WED'] = 'බදාදා';
$app_strings['LBL_THU'] = 'බ්රහස්පතින්දා';
$app_strings['LBL_FRI'] = 'සිකුරාදා';
$app_strings['LBL_SAT'] = 'සෙනසුරාදා';
$app_strings['LBL_ALL'] = 'සෑම දිනම';
$app_strings['LBL_EVERY'] = 'සෑම';
$app_strings['LBL_ON_THE'] = 'මත';
$app_strings['LBL_RANGE'] = 'දක්වා';
$app_strings['LBL_FROM'] = 'සිට';
$app_strings['LBL_AND'] = 'සහ';
$app_strings['LBL_MINS'] = 'අවම';
$app_strings['LBL_MINUTES'] = 'මිනිත්තු';
$app_strings['LBL_HOUR'] = 'පැය';
$app_strings['LBL_HOUR_SING'] = 'පැය';
$app_strings['LBL_OFTEN'] = 'බොහෝ විට හැකිතාක්.';
$app_strings['LBL_MIN_MARK'] = 'විනාඩි ලකුණ';
$app_strings['LBL_INBOUND_EMAIL'] = 'රට තුළට පැමිණෙන සංචාරකයින්ට විද්යුත්';
...
$app_strings['LBL_CAMPAIGN_SETTINGS'] = 'සැකසුම්';
...
$app_strings['LBL_INACTIVE'] = 'අක්රීය ';
