...
$mod_strings = array(
    'LBL_MODULE_NAME' => 'กิจกรรม',
    'LBL_MODULE_TITLE' => 'กิจกรรม: บ้าน',
    'LBL_SEARCH_FORM_TITLE' => 'ค้นหากิจกรรม',
    'LBL_LIST_FORM_TITLE' => 'รายการกิจกรรม',
    'LBL_LIST_SUBJECT' => 'หัวเรื่อง',
    'LBL_OVERVIEW' => 'ภาพรวม', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
    ...
    'LBL_MEETINGS' => 'นัดประชุม', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
    ...
    'LBL_EMAILS' => 'อีเมล', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
    ...
    'LBL_MEETING_TYPE' => 'ประชุม',
    'LBL_CALL_TYPE' => 'การติดต่อ',
    'LBL_EMAIL_TYPE' => 'อีเมล',
    'LBL_NOTE_TYPE' => 'บันทึกย่อ',
    'LBL_DATA_TYPE_START' => 'เริ่มต้น:',
    'LBL_DATA_TYPE_SENT' => 'ส่ง:',
    'LBL_DATA_TYPE_MODIFIED' => 'ถูกแก้ไข:',
    ...
    'LNK_NEW_NOTE' => 'สร้างบันทึก หรือเพิ่มเอกสารแนบ',
    'LNK_NEW_EMAIL' => 'ส่งอีเมล',
    'LNK_CALL_LIST' => 'ดูการโทร',
    'LNK_MEETING_LIST' => 'ประชุม',
    'LNK_TASK_LIST' => 'ดูงาน',
    'LNK_NOTE_LIST' => 'บันทึกย่อ',
    'LBL_DELETE_ACTIVITY' => 'คุณต้องการลบกิจกรรมนี้แน่ใจหรือไม่',
    ...
    'LBL_DEFAULT_SUBPANEL_TITLE' => 'เปิดกิจกรรม',
    'LBL_LIST_ASSIGNED_TO_NAME' => 'ผู้รับผิดชอบ',

    'LBL_ACCEPT' => 'ตกลง' /*for 508 compliance fix*/,
);
