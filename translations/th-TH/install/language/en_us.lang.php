...
$mod_strings = array(
    ...
    'ERR_CHECKSYS_CONFIG_NOT_WRITABLE' => 'มีไฟล์กำหนดค่าอยู่แต่ไม่สามารถเขียนได้ โปรดทำตามขั้นตอนที่จำเป็นเพื่อทำให้ไฟล์สามารถเขียนได้',
    'ERR_CHECKSYS_CONFIG_NOT_FOUND' => 'ไม่มี config.php ของคุณ สิ่งนี้จะถูกสร้างขึ้นเมื่อติดตั้ง',
    'ERR_CHECKSYS_CONFIG_OVERRIDE_NOT_WRITABLE' => 'มีไฟล์แทนที่การกำหนดค่าอยู่แต่ไม่สามารถเขียนได้ โปรดทำตามขั้นตอนที่จำเป็นเพื่อทำให้ไฟล์สามารถเขียนได้ ',
    'ERR_CHECKSYS_CUSTOM_NOT_WRITABLE' => 'มี Custom Directory อยู่แต่ไม่สามารถเขียนได้ โปรดทำตามขั้นตอนที่จำเป็นเพื่อทำให้ไฟล์สามารถเขียนได้',
    'ERR_CHECKSYS_FILES_NOT_WRITABLE' => "ไฟล์หรือไดเร็กทอรีที่แสดงข้างต้นไม่สามารถเขียนได้หรือหายไปและไม่สามารถสร้างได้ โปรดทำตามขั้นตอนที่จำเป็นเพื่อทำให้ไดเร็กทอรีสามารถเขียนได้",
    'ERR_CHECKSYS_LOGS_NOT_WRITABLE' => 'ขณะนี้ Logs Directory ไม่สามารถเขียนได้',
    'ERR_CHECKSYS_CACHE_NOT_WRITABLE' => 'ไดเรกทอรีแคชไม่สามารถเขียนได้ในขณะนี้',
    'ERR_CHECKSYS_EXTENSIONS_NOT_WRITABLE' => 'ขณะนี้ Extensions Directory ไม่สามารถเขียนได้',
    'ERR_CHECKSYS_SECRETS_NOT_WRITABLE' => 'ไดเร็กทอรี config/secrets ไม่สามารถเขียนได้ในขณะนี้',
    'ERR_CHECKSYS_ENV_NOT_WRITABLE' => 'ไฟล์ .env หรือไดเร็กทอรีที่อยู่ในไฟล์ไม่สามารถเขียนได้',
    ...
    'ERR_DB_LOGIN_FAILURE_SHORT' => 'ข้อผิดพลาดในการเชื่อมต่อฐานข้อมูล: ชื่อโฮสต์ของฐานข้อมูล พอร์ต ชื่อผู้ใช้ และ/หรือรหัสผ่านที่ระบุไม่ถูกต้อง',
...
ชื่อฐานข้อมูลสามารถประกอบด้วยตัวอักษรและตัวเลขและสัญลักษณ์ '#', '_' หรือ '$' เท่านั้น",
    ...
    'ERR_LOG_DIRECTORY_NOT_EXISTS' => 'บันทึกไดเรกทอรีที่ให้มาไม่ใช่ไดเรกทอรีที่ถูกต้อง',
    ...
    'LBL_CHECKSYS_LEGACY_CACHE' => 'ไดเรกทอรีย่อยแคชดั้งเดิมที่เขียนได้',
    'LBL_CHECKSYS_CACHE' => 'เขียนแคชไดเรกทอรี่ย่อย',
    'LBL_CHECKSYS_EXTENSIONS' => 'ไดเร็กทอรีส่วนขยายที่เขียนได้',
    'LBL_CHECKSYS_SECRETS' => 'ไดเร็กทอรี Config/Secrets ที่เขียนได้',
    'LBL_CHECKSYS_LOGS' => 'ไดเร็กทอรีบันทึกที่เขียนได้',
    ...
    'LBL_CHECKSYS_INTL_EXTENSIONS' => 'Intl มีอยู่ในส่วนขยาย',
    'LBL_CHECKSYS_JSON_EXTENSIONS' => 'Json มีอยู่ในส่วนขยาย',
    'LBL_CHECKSYS_GD_EXTENSIONS' => 'GD มีอยู่ในส่วนขยาย',
    'LBL_CHECKSYS_OPENSSL_EXTENSIONS' => 'OpenSSL มีอยู่ในส่วนขยาย',
    'LBL_CHECKSYS_ZIP_EXTENSIONS' => 'Zip มีอยู่ในส่วนขยาย',
    'LBL_CHECKSYS_PDO_MYSQL_EXTENSIONS' => 'PDO MySQL มีอยู่ในส่วนขยาย',
    'LBL_CHECKSYS_CURL_EXTENSIONS' => 'cURL มีอยู่ในส่วนขยาย',
    'LBL_CHECKSYS_MBSTRING_EXTENSIONS' => 'MB Strings มีอยู่ในส่วนขยาย',
    'LBL_CHECKSYS_MYSQLI_EXTENSIONS' => 'MySQLi มีอยู่ในส่วนขยาย',
    'LBL_CHECKSYS_SOAP_EXTENSIONS' => 'Soap มีอยู่ในส่วนขยาย',
    'LBL_CHECKSYS_XML_EXTENSIONS' => 'XML มีอยู่ในส่วนขยาย',
    'LBL_CHECKSYS_IMAP_EXTENSIONS' => 'IMAP มีอยู่ในส่วนขยาย (ไม่บังคับ)',
    'LBL_CHECKSYS_LDAP_EXTENSIONS' => 'LDAP มีอยู่ในส่วนขยาย (ไม่บังคับ)',
    'LBL_PHP_CHECKS' => 'การตรวจสอบ PHP',
    'LBL_SERVER_CHECKS' => 'การตรวจสอบเซิร์ฟเวอร์',
    'LBL_PERMISSION_CHECKS' => 'การตรวจสอบสิทธิ์',
    'LBL_CHECK_FAILED' => 'การตรวจสอบล้มเหลว: ',
    'ERR_CHECKSYS_INTL' => 'ไม่ได้ติดตั้งส่วนขยาย Intl โปรดติดต่อผู้ดูแลระบบของคุณ',
    'ERR_CHECKSYS_JSON' => 'ไม่ได้เปิดใช้งานส่วนขยาย JSON โปรดติดต่อผู้ดูแลระบบของคุณ',
    'ERR_CHECKSYS_GD' => 'ไม่ได้เปิดใช้งานส่วนขยาย GD โปรดติดต่อผู้ดูแลระบบของคุณ',
    'ERR_CHECKSYS_OPENSSL' => 'ไม่ได้เปิดใช้งานส่วนขยาย OpenSSL โปรดติดต่อผู้ดูแลระบบของคุณ',
    'ERR_CHECKSYS_PDO_MYSQL' => 'ไม่ได้เปิดใช้งานส่วนขยาย PDO MySQL โปรดติดต่อผู้ดูแลระบบของคุณ',
    'ERR_CHECKSYS_MYSQLI' => 'ไม่ได้เปิดใช้งานส่วนขยาย MySQLi โปรดติดต่อผู้ดูแลระบบของคุณ',
    'ERR_CHECKSYS_SOAP' => 'ไม่ได้เปิดใช้งานส่วนขยาย Soap โปรดติดต่อผู้ดูแลระบบของคุณ',
    ...
    'LBL_UNWRITABLE_SUB_DIR' => 'มีไดเร็กทอรีย่อยบางรายการที่ไม่สามารถเขียนได้ โปรดทำตามขั้นตอนที่จำเป็นเพื่อทำให้ไดเร็กทอรีสามารถเขียนได้ ',
    'LBL_REFER_TO_LOGS' => 'มีปัญหาในการตรวจสอบก่อนการติดตั้งของคุณ โปรดดูที่ install.log',
    'LBL_NOT_A_VALID_SUITECRM_PAGE' => 'ไม่พบชื่อ SuiteCRM นี่ไม่ใช่หน้า SuiteCRM ที่ถูกต้อง',
    'LBL_NOT_COOKIE_OR_TOKEN' => 'ไม่พบคุกกี้ ไม่พบโทเค็นที่ถูกต้อง โปรดดูที่ install.log สำหรับข้อมูลเพิ่มเติม',
    'LBL_CURL_JSON_ERROR' => 'ผลลัพธ์ของการเรียก curl ไปที่หน้า graphql ว่างเปล่า',
    'LBL_UNABLE_TO_FIND_SYSTEM_CONFIGS' => 'ไม่สามารถเรียกข้อมูลการกำหนดค่าระบบบนหน้า Graphql ได้ โปรดดูที่ install.log สำหรับข้อมูลเพิ่มเติม',
    'LBL_CURL_REQUEST_MAIN_PAGE' => 'คำขอ Curl บนหน้าหลัก',
    'LBL_CURL_REQUEST_API_PAGE' => 'คำขอ Curl บน Api',
    'LBL_ERROR_DETAILS' => 'รายละเอียดผิดพลาด',
    'LBL_ERROR' => 'ข้อผิดพลาด',
    'LBL_WARNING_DETAILS' => 'รายละเอียดคำเตือน',
    'LBL_WARNING' => 'คำเตือน',
    'LBL_SYSTEM_CHECKS' => 'การตรวจสอบระบบ',
    ...
    'LBL_CRON_INSTRUCTIONS_3' => 'คุณควรทำเช่นนี้หลังจากที่การติดตั้งเสร็จสิ้น',
    'LBL_CRON_CONFIGURATION' => 'CRON CONFIGURATION',
    'LBL_SETUP_CRONTAB' => 'การตั้งค่า Crontab',
    ...
    'LBL_DBCONF_DB_PORT' => 'พอร์ตของฐานข้อมูล',
    ...
    'LBL_DBCONF_DEMO_DATA' => 'สร้างฐานข้อมูล ด้วยข้อมูลสาธิตหรือไม่',
    ...
    'LBL_APP_NOT_INSTALLED' => 'ไม่ได้ติดตั้ง SuiteCRM จำเป็นต้องมี SuiteCRM ที่ติดตั้งไว้ โปรดติดตั้งก่อน',
    ...
    'LBL_SILENT_INSTALL_SUCCESS' => 'ติดตั้ง SuiteCRM สำเร็จแล้ว',
    'LBL_SILENT_INSTALL_FAILED' => 'การติดตั้ง SuiteCRM ล้มเหลว',
    ...
    'LBL_PERFORM_CONFIG_PHP' => 'การสร้างไฟล์การกำหนดค่า SuiteCRM',
    ...
    'LBL_PERFORM_DEFAULT_SCHEDULER' => 'สร้างค่าเริ่มต้นตัวจัดกำหนดเวลางาน',
    ...
    'LBL_PERFORM_OUTRO_1' => 'การตั้งค่าของ SuiteCRM ',
    ...
    'LBL_REG_CONF_3' => 'ขอบคุณสำหรับการลงทะเบียน. คลิกที่ปุ่ม Finish เพื่อเข้าสู่ระบบ SuiteCRM คุณจะต้องเข้าสู่ระบบเป็นครั้งแรกโดยใช้ชื่อผู้ใช้ "admin" และรหัสผ่านที่คุณป้อนในขั้นตอนที่ 2',
    ...
    'LBL_WELCOME' => 'ยินดีต้อนรับสู่ SuiteCRM',
...
$contact_user_link_guid',
    ...
    'LBL_SYS_CHECK_WARNING' => 'ไม่สนใจคำเตือนการตรวจสอบระบบ',
    'LBL_PROCEED' => 'ดำเนินการต่อ',
    'LBL_RECHECK' => 'RECHECK',
    'LBL_CONFIG' => 'การกำหนดค่า',
    'LBL_VALIDATION_ERRORS' => 'มีข้อผิดพลาดในการตรวจสอบ ไม่สามารถดำเนินการต่อได้'
);
