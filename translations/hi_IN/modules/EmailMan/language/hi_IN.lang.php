...
$mod_strings = array(
    ...
    'LBL_DRAFTS_POPUP' => 'ड्राफ्ट पॉपअप सक्षम करें',
    ...
    'LBL_EMAILS_PER_RUN' => 'प्रति बैच संसाधित/भेजे गए ईमेल की संख्या:',
    'LBL_CAMPAIGN_MAX_RETRIES' => 'विफलता की स्थिति में प्रति प्राप्तकर्ता अधिकतम प्रेषण पुनः प्रयास:',
    'LBL_CAMPAIGN_THRESHOLD' => 'प्रति बैच त्रुटि सीमा (इस सीमा तक पहुँचने पर अभियान रुक जाता है, 0 होने पर निष्क्रिय हो जाता है):',
    'LBL_CAMPAIGN_MARKETING_RECORDS_PER_RUN' => 'प्रति रन संसाधित किए जाने वाले ईमेल मार्केटिंग रिकॉर्ड की संख्या:',
    'LBL_TRACKERS_ENABLED' => 'ट्रैकर सक्षम:',
    ...
    'LBL_LIST_MARKETING_NAME' => 'मार्केटिंग नाम',
    ...
    'LBL_HELP' => 'सहायता' /*for 508 compliance fix*/,
    'LBL_OUTBOUND_EMAIL_ACCOUNT_VIEW' => 'आउटबाउंड ईमेल खाते देखें',
    'LBL_SYSTEM_OUTBOUND_EMAIL_ACCOUNT' => 'सिस्टम आउटबाउंड ईमेल खाता',
    ...
    'LBL_EMAIL_IMPORT_CONFIGURATION' => 'ईमेल आयात कॉन्फ़िगरेशन',
    'LBL_EMAIL_IMPORT_PER_RUN_THRESHOLD' => 'प्रति रन (प्रति मेलबॉक्स) आयातित ईमेल की संख्या के लिए सीमा',
    'LBL_EMAIL_IMPORT_PER_RUN_THRESHOLD_DESC' => 'प्रति रन आयात किए जाने वाले ईमेल की सीमा। डिफ़ॉल्ट मान 25 है। प्रत्येक रन निर्धारित समय सीमा के भीतर मेलबॉक्स में प्रत्येक दिन के ईमेल को सबसे पुराने से लेकर सबसे नए क्रम में देखेगा। यह प्रत्येक दिन के सभी ईमेल को तब तक आयात करेगा जब तक कि इस रन में आयात किए गए ईमेल की कुल संख्या सीमा से अधिक न हो जाए। सीमा पूरी होने पर, कार्य रुक जाएगा और आयात किए गए अंतिम दिन को चिह्नित कर देगा, और अगले रन में वहीं से शुरू होगा।',
    'LBL_EMAIL_IMPORT_TIMEFRAME_START' => 'नए मेलबॉक्स आयात के लिए प्रारंभिक बिंदु',
    'LBL_EMAIL_IMPORT_TIMEFRAME_START_DESC' => 'वह समयावधि जिससे ईमेल आयात होना शुरू होंगे। उदाहरण के लिए, 30 दिन चुनने पर 30 दिन पहले के ईमेल से शुरुआत होगी और फिर आगे के ईमेल आते रहेंगे।',
    'LBL_EMAIL_IMPORT_FETCH_UNREAD_ONLY' => 'ईमेल आयात करते समय केवल अपठित ईमेल ही प्राप्त करें',
);
