...
// OOTB Scheduler Job Names:
    ...
    'LBL_OOTB_CAL_ACC_SYNC' => 'कैलेंडर खातों का सिंक्रोनाइज़ेशन',
    'LBL_OOTB_SEND_EMAIL_TO_QUEUE' => 'क्यू कैंपेन ईमेल',
    'LBL_OOTB_SEND_EMAIL_FROM_QUEUE' => 'अभियान संबंधी ईमेल भेजें',
    'LBL_OOTB_CLEAN_UP_TEMP_FILES' => 'अस्थायी फ़ाइलों को साफ़ करें',
...
// Cron
    ...
    'LBL_CRON_SETUP' => 'शेड्यूलर सेटअप करें',
    ...
    'LBL_CRON_LINUX_DESC1' => 'SuiteCRM शेड्यूलर चलाने के लिए',
    'LBL_CRON_LINUX_DESC2' => '1. इस कमांड का उपयोग करके अपने वेब सर्वर उपयोगकर्ता की क्रोनटैब फ़ाइल को संपादित करें',
    'LBL_CRON_LINUX_DESC3' => '2. फिर क्रोनटैब फ़ाइल में निम्नलिखित पंक्ति को अपडेट करके जोड़ें:',
    'LBL_CRON_LINUX_DESC4' => 'आपको यह कार्य स्थापना प्रक्रिया पूरी होने के बाद ही करना चाहिए।',
    'LBL_CRON_LINUX_DESC5' => '2(i). पर्यावरण चरों को परिभाषित करने के लिए, निम्नलिखित पंक्ति जोड़ें:',
    'LBL_CRON_LINUX_DESC6' => 'कृपया अपने वातावरण के अनुसार [path/to/php] और [path/to/suite/instance] को अपडेट करें।',
    'LBL_CRON_WINDOWS_DESC' => 'SuiteCRM शेड्यूलर चलाने के लिए',
    'LBL_CRON_WINDOWS_DESC2' => '1. विंडोज़ शेड्यूल्ड टास्क का उपयोग करके चलाने के लिए एक बैच फ़ाइल बनाएँ। बैच फ़ाइल में निम्नलिखित कमांड शामिल होने चाहिए:',
    'LBL_CRON_WINDOWS_DESC3' => 'कृपया [path\to\php.exe] और [path\to\suite\instance] को अपने वातावरण के अनुसार अपडेट करें।',
    'LBL_SCHEDULERS_INFO' => 'शेड्यूलर जानकारी',
    'LBL_SCHEDULERS_NEVER_RUN' => 'शेड्यूलर कभी नहीं चलाए गए हैं।',
    // Subpanels
...
//jobstrings
    ...
    'LBL_CALENDARSYNCJOB' => 'कैलेंडर खातों को सिंक करें',
    'LBL_SENDFROMQUEUE' => 'ईमेल कतार से ईमेल भेजें',
    'LBL_CLEANUPTEMPORARYFILES' => 'अस्थायी फ़ाइलों को साफ़ करें',
    'LBL_EMAILTOQUEUE' => 'निर्धारित ईमेल को ईमेल क्यू में भेजें',
