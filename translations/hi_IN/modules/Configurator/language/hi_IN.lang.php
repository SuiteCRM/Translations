...
$mod_strings = array(
    ...
    'LBL_MAIL_SMTPPASS' => 'SMTP पासवर्ड:',
    ...
    'LBL_SNOOZE_TIMER' => 'सूचनाओं के लिए स्नूज़ सेट करें',
    ...
    'LBL_LDAP_LEGACY_WARNING' => 'एलडीएपी चेतावनी',
    'LBL_LDAP_LEGACY_WARNING_MORE' => 'इस एलडीएपी कॉन्फ़िगरेशन का उपयोग केवल v4 एपीआई प्रमाणीकरण के लिए किया जाएगा। एलडीएपी का उपयोग करने के लिए सुइटसीआरएम लॉगिन को कॉन्फ़िगर करने के लिए, .env.local फ़ाइल में आवश्यक कॉन्फ़िगरेशन जोड़ें। अधिक जानकारी के लिए एलडीएपी कॉन्फ़िगरेशन दस्तावेज़ देखें।',
    ...
    'LBL_SET_SUBPANEL_PAGINATION_TYPE' => 'उपपैनल पेजिनेशन प्रकार',
    'LBL_SET_LISTVIEW_PAGINATION_TYPE' => 'सूचीदृश्य पृष्ठांकन प्रकार',
    'LBL_LIST_ENTRIES_PER_MODAL' => 'रिकॉर्ड सूची पॉप अप करें',
    'LBL_SET_RECORD_MODAL_PAGINATION_TYPE' => 'पॉप अप रिकॉर्ड सूची पेजिनेशन प्रकार',
...
// Wizard
    ...
    'LBL_HISTORY_SUBPANEL' => 'इतिहास उपपैनल',
);
