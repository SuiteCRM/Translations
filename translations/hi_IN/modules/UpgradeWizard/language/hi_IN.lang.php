...
$mod_strings = array(
    ...
    'LBL_UW_DB_NO_ADD_COLUMN' => 'तालिका बदलें[table] कॉलम जोड़ें [column]',
    'LBL_UW_DB_NO_CHANGE_COLUMN' => 'तालिका बदलें [table] कॉलम बदलें [column]',
    'LBL_UW_DB_NO_CREATE' => 'CREATE TABLE [table]',
    'LBL_UW_DB_NO_DELETE' => 'से हटाएं [टेबल]',
    'LBL_UW_DB_NO_DROP_COLUMN' => 'तालिका बदलें [table] ड्रॉप कॉलम [column]',
    'LBL_UW_DB_NO_DROP_TABLE' => 'ड्रॉप तालिका [table]',
    'LBL_UW_DB_NO_ERRORS' => 'सभी विशेषाधिकार उपलब्ध',
    'LBL_UW_DB_NO_INSERT' => 'में सम्मिलित करें [table]',
    'LBL_UW_DB_NO_SELECT' => 'चुनना [x] से [table]',
    'LBL_UW_DB_NO_UPDATE' => 'अद्यतन [table]',
