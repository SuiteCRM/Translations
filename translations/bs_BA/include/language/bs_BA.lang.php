...
//e.g. auf Deutsch 'Contacts'=>'Contakten',
    'language_pack_name' => 'Bosanski (Bosnian) - bs_BA',
    'moduleList' => array(
        'Home' => 'Početna',
        ...
        'Accounts' => 'Klijenti',
        'Alerts' => 'Upozorenja',
        'Opportunities' => 'Poslovne prilike',
        'Cases' => 'Slučajevi',
        'Notes' => 'Bilješke',
        'Calls' => 'Pozivi',
    ...
    'lead_source_default_key' => 'Samogenerirano',
    'lead_source_dom' => array(
        '' => '',
        'Cold Call' => 'Hladan poziv',
        'Existing Customer' => 'Postojeći kupac',
        'Self Generated' => 'Samogenerirano',
        'Employee' => 'Zaposlenik',
        'Partner' => 'Partner',
        'Public Relations' => 'Odnosi sa javnosti',
        'Direct Mail' => 'Direktni email',
    ...
    'roi_type_dom' => array(
        ...
        'Expected_Revenue' => 'Očekivani prihodi',
        'Budget' => 'Budžet',
...
//       it is the key for the default opportunity_relationship_type_dom value
    'opportunity_relationship_type_default_key' => 'Primarni donosioc odluke',
    'opportunity_relationship_type_dom' => array(
        '' => '',
        'Primary Decision Maker' => 'Primarni donosioc odluke',
        'Business Decision Maker' => 'Poslovni donosioc odluke',
        'Business Evaluator' => 'Poslovni procijenitelj',
        'Technical Decision Maker' => 'Tehnički donosioc odluke',
...
//       it is the key for the default case_relationship_type_dom value
    ...
    'sales_stage_default_key' => 'Istraživanje',
    'sales_stage_dom' => array(
        ...
        'Proposal/Price Quote' => 'Prijedlog/ponuda',
    ...
    'reminder_time_options' => array(
        60 => '1 minuta ranije',
        300 => '5 minuta ranije',
        600 => '10 minuta ranije',
        900 => '15 minuta ranije',
        1800 => '30 minuta ranije',
        3600 => '1 sat ranije',
        7200 => '2 sata ranije',
        10800 => '3 sata ranije',
        18000 => '5 sati ranije',
    ...
    'call_direction_default' => 'Odlazni',
    ...
    'record_type_default_key' => 'Klijenti',
    ...
    'dom_mailbox_type' => array(/*''           => '--None Specified--',*/
        ...
        'bounce' => 'Bounce upravljanje',
    ),
    'dom_email_distribution' => array(
        '' => '-Nijedan-',
        'direct' => 'Direktno dodijeli',
...
//prospect list type dom
    ...
    'campainglog_activity_type_dom' => array(
        ...
        'removed' => 'Odjavljeno',
        'lead' => 'Kreirani potencijalni kupac',
    ...
    'chart_strings' => array(
        ...
        'stackedchart' => 'Stacked grafikon',
        'barchart' => 'Bar grafikon',
    ...
    'date_range_search_dom' => array(
        ...
        'greater_than' => 'Nakon',
        'less_than' => 'Prije',
        'last_7_days' => 'Zadnji 7 dana',
        'next_7_days' => 'Sljedeći 7 dana',
...
$app_strings = array(
    'LBL_SEARCH_RESULTS_TITLE' => 'Rezultat',
    ...
    'LBL_TOUR_BACK' => 'Nazad',
    'LBL_TOUR_TAKE_TOUR' => 'Započnite obilazak aplikacije',
    'LBL_MOREDETAIL' => 'Više detalja', /*for 508 compliance fix*/
    'LBL_EDIT_INLINE' => 'Uređivanje Inline', /*for 508 compliance fix*/
    ...
    'LBL_ID_FF_ADD_EMAIL' => 'Dodaj email adresu', /*for 508 compliance fix*/
    ...
    'LBL_ID_FF_REMOVE_EMAIL' => 'Ukloni email adresu', /*for 508 compliance fix*/
    'LBL_ID_FF_OPT_OUT' => 'Isključivanje',
    'LBL_ID_FF_INVALID' => 'Napravi nevažećim',
    'LBL_ADD' => 'Dodaj', /*for 508 compliance fix*/
    'LBL_COMPANY_LOGO' => 'Logo kompanije', /*for 508 compliance fix*/
    'LBL_CONNECTORS_POPUPS' => 'Popup prozori konektora',
    ...
    'DEFAULT' => 'Osnovni',
    'LBL_SORT' => 'Sortiraj',
    'LBL_EMAIL_SMTP_SSL_OR_TLS' => 'Omogući SMTP over SSL ili TLS?',
    'LBL_NO_ACTION' => 'Ne postoji akcija pod tim imenom: %s',
    'LBL_NO_SHORTCUT_MENU' => 'Nema dostupnih akcija.',
    'LBL_NO_DATA' => 'Nema podatka',

    'LBL_ROUTING_FLAGGED' => 'postavljen Flag',
    'LBL_ROUTING_TO' => 'prema',
    'LBL_ROUTING_TO_ADDRESS' => 'prema adresi',
    'LBL_ROUTING_WITH_TEMPLATE' => 'sa predloškom',

    'NTC_OVERWRITE_ADDRESS_PHONE_CONFIRM' => 'Ovaj zapis trenutno sadrži vrijednosti u poljima Uredski telefoni i Adrese. Kako bi zapisali preko tih vrijednosti sa sljedećim Uredski telefoni i Adrese od kompanije koju ste odabrali, kliknite "OK". Za zadržati trenutne vrijednosti, kliknite "Odustani".',
    'LBL_DROP_HERE' => '[Spusti ovdje]',
    'LBL_EMAIL_ACCOUNTS_GMAIL_DEFAULTS' => 'Napuni sa Gmail&#153; postavkama',
    ...
    'LBL_EMAIL_ADDRESS_BOOK_ADD' => 'Gotovo',
    ...
    'LBL_EMAIL_REMOVE_SMTP_WARNING' => 'Upozorenje! Izlazni račun koji pokušavate obrisati je povezan sa postojećim ulaznim računom. Jeste li sigurni da želite nastaviti?',
    ...
    'LBL_EMAIL_ATTACHMENTS' => 'Iz lokalnog sistema',
    ...
    'LBL_EMAIL_CHECK' => 'Provjera pošte',
    ...
    'LBL_EMAIL_COMPOSE_ERR_NO_RECIPIENTS' => 'Molimo unesite primaoca(e) za ovaj email.',
    'LBL_EMAIL_COMPOSE_NO_BODY' => 'Tekst ovog emaila je prazan. Ipak ga pošaljite?',
    'LBL_EMAIL_COMPOSE_NO_SUBJECT' => 'Ovaj email nema naslov. Ipak ga pošaljite?',
    'LBL_EMAIL_COMPOSE_NO_SUBJECT_LITERAL' => '(bez naslova)',
    'LBL_EMAIL_COMPOSE_INVALID_ADDRESS' => 'Molim unesite ispravnu adresu e-pošte za To, CC i BCC polja',

    'LBL_EMAIL_CONFIRM_CLOSE' => 'Odbaci ovaj mail?',
    'LBL_EMAIL_CONFIRM_DELETE_SIGNATURE' => 'Jeste li sigurni da želite obrisati ovaj potpis?',
    ...
    'LBL_EMAIL_DELETE_CONFIRM' => 'Obriši odabrane poruke?',
    'LBL_EMAIL_DELETE_SUCCESS' => 'Email uspješno izbrisan.',
    ...
    'LBL_EMAIL_ERROR_ADD_GROUP_FOLDER' => 'Naziv foldera mora biti jedinstven i ne smije biti prazan. Molimo pokušajte ponovo.',
    ...
    'LBL_EMAIL_DELETE_ERROR_DESC' => 'Nemate pristup ovoj oblasti. Kontaktirajte administratora Vaše stranice da biste dobili pristup.',
    'LBL_EMAIL_ERROR_DUPE_FOLDER_NAME' => 'SuiteCRM ime foldera mora biti jedinstveno.',
    ...
    'LBL_EMAIL_ERROR_IMAP_MESSAGE_DELETED' => 'Poruka je ili uklonjena sa servera ili premještena u drugi folder',
    ...
    'LBL_EMAIL_ERROR_NAME' => 'Naziv je obavezan.',
    'LBL_EMAIL_ERROR_FROM_ADDRESS' => 'Polje "Od" je obavezno. Molimo unesti ispravnu adresu e-pošte.',
    ...
    'LBL_EMAIL_ERROR_USER' => 'Potrebno je korisničko ime.',
    'LBL_EMAIL_ERROR_PORT' => 'Port servera e-pošte je obavezan.',
    'LBL_EMAIL_ERROR_PROTOCOL' => 'Protokol servera je obavezan.',
    'LBL_EMAIL_ERROR_MONITORED_FOLDER' => 'Monitored folder je obavezan.',
    'LBL_EMAIL_ERROR_TRASH_FOLDER' => 'Trash folder je obavezan.',
    ...
    'LBL_EMAIL_ERROR_SENDING' => 'Greška tokom slanja e-maila. Molimo kontaktirajte Vašeg administratora za pomoć.',
    'LBL_EMAIL_FOLDERS' => SugarThemeRegistry::current()->getImage('icon_email_folder', 'align=absmiddle border=0', null, null, '.gif', '') . 'Folderi',
    ...
    'LBL_EMAIL_FOLDERS_CHANGE_HOME' => 'Ovaj folder ne može biti promijenjen',
    'LBL_EMAIL_FOLDERS_DELETE_CONFIRM' => 'Jeste li sigurni da želite obrisati ovaj folder?\n Ovaj proces se ne može poništiti.\n Brisanje mape uključuje i brisanje svih foldera unutar iste.',
    'LBL_EMAIL_FOLDERS_NEW_FOLDER' => 'Novo Ime foldera',
    'LBL_EMAIL_FOLDERS_NO_VALID_NODE' => 'Molimo odaberite folder za izvođenje ove akcije.',
    'LBL_EMAIL_FOLDERS_TITLE' => 'Upravljanje folderima',

    'LBL_EMAIL_FORWARD' => 'Proslijedi',
    'LBL_EMAIL_DELIMITER' => '::;::',
    'LBL_EMAIL_DOWNLOAD_STATUS' => 'Preuzeto [[count]] od [[total]] emailova',
    'LBL_EMAIL_FROM' => 'Od',
    ...
    'LBL_EMAIL_IE_DELETE_CONFIRM' => 'Jeste li sigurni da želite obrisati ovaj e-mail račun?',
    'LBL_EMAIL_IE_DELETE_SUCCESSFUL' => 'Brisanje uspješno.',
    ...
    'LBL_EMAIL_MENU_HELP_MARK_READ' => 'Označi ove email(ove) kao pročitane',
    'LBL_EMAIL_MENU_HELP_MARK_UNFLAGGED' => 'Obilježi ovaj e-mail(ove) neoznačenima',
    'LBL_EMAIL_MENU_HELP_RENAME_FOLDER' => 'Preimenuj foldere (daljinski ili u SuiteCRM)',
    ...
    'LBL_EMAIL_OK' => 'U redu',
    'LBL_EMAIL_ONE_MOMENT' => 'Jedan trenutak molim...',
    'LBL_EMAIL_OPEN_ALL' => 'Otvori više poruka',
    'LBL_EMAIL_OPTIONS' => 'Opcije',
    'LBL_EMAIL_QUICK_COMPOSE' => 'Brzo sastavi',
    ...
    'LBL_EMAIL_QC_LEADS' => 'Potencijalni kupac',
    ...
    'LBL_EMAIL_SELECT_ONE_RECORD' => 'Molim odaberite samo jedan email',
    'LBL_EMAIL_RETURN_TO_VIEW' => 'Povratak na prethodni modul?',
    'LBL_EMAIL_REVERT' => 'Vrati',
    'LBL_EMAIL_RELATE_EMAIL' => 'Poveži email',

    'LBL_EMAIL_RULES_TITLE' => 'Upravljanje pravilima',

    'LBL_EMAIL_SAVE' => 'Spremi',
    'LBL_EMAIL_SAVE_AND_REPLY' => 'Spasi i odgovori',
    'LBL_EMAIL_SAVE_DRAFT' => 'Spremite draft',
    'LBL_EMAIL_DRAFT_SAVED' => 'Draft je sačuvan',
    ...
    'LBL_EMAIL_SENDING_EMAIL' => 'Slanje emaila',

    'LBL_EMAIL_SETTINGS' => 'Postavke',
    'LBL_EMAIL_SETTINGS_ACCOUNTS' => 'Računi e-pošte',
    'LBL_EMAIL_SETTINGS_ADD_ACCOUNT' => 'Očistite formu',
    'LBL_EMAIL_SETTINGS_CHECK_INTERVAL' => 'Provjeravanje nove e-pošte',
    ...
    'LBL_EMAIL_SETTINGS_REPLY_TO_ADDR' => 'Odgovori na email adresu',
    ...
    'LBL_EMAIL_TEST_SEE_FULL_SMTP_LOG' => 'Pogledajte cijeli SMTP log',
    'LBL_EMAIL_SETTINGS_FULL_SYNC_WARN' => 'Izvršiti punu sinhronizaciju?\nVeliki računi e-pošte mogu potrajati nekoliko minuta.',
    'LBL_EMAIL_SUBSCRIPTION_FOLDER_HELP' => 'Kliknite Shift tipku ili Ctrl tipku za odabrati više foldera.',
    'LBL_EMAIL_SETTINGS_GENERAL' => 'Opšte',
    'LBL_EMAIL_SETTINGS_GROUP_FOLDERS_CREATE' => 'Kreiraj grupne foldere',

    'LBL_EMAIL_SETTINGS_GROUP_FOLDERS_EDIT' => 'Uredi grupne fodere',

    'LBL_EMAIL_SETTINGS_NAME' => 'Naziv računa e-pošte',
    'LBL_EMAIL_SETTINGS_REQUIRE_REFRESH' => 'Odaberite broj e-mailova po stranici u ulaznoj pošti. Ova postavka može zahtjevati osvježavanje stranice da bi stupila na snagu.',
    'LBL_EMAIL_SETTINGS_RETRIEVING_ACCOUNT' => 'Dohvaćanje računa e-pošte',
    'LBL_EMAIL_SETTINGS_SAVED' => 'Postavke su sačuvane.',
    'LBL_EMAIL_SETTINGS_SEND_EMAIL_AS' => 'Šalji samo email sa običnim tekstom',
    'LBL_EMAIL_SETTINGS_SHOW_NUM_IN_LIST' => 'Emailova po stranici',
    ...
    'LBL_EMAIL_INVALID_SYSTEM_OUTBOUND' => 'Server odlazne pošte nije podešen za slanje e-pošte. Molim konfigurirajte server odlazne e-pošte ili odaberite server odlazne pošte za račun e-pošte koji koristite u Postavke >> Klijent e-pošte.',
    ...
    'LBL_EMAIL_SPACER_LOCAL_FOLDER' => '[ SuiteCRM folderi ]',
    'LBL_EMAIL_SUBJECT' => 'Naziv',
    ...
    'LBL_EMAIL_VIEW_HEADERS' => 'Prikaz zaglavlja',
    ...
    'LBL_EMAIL_YES' => 'Da',
    'LBL_EMAIL_TEST_OUTBOUND_SETTINGS' => 'Pošalji testnu poruku',
    'LBL_EMAIL_TEST_OUTBOUND_SETTINGS_SENT' => 'Testni email poslan',
    ...
    'LBL_CLOSE_ACTIVITY_CONFIRM' => 'Želiš li zatvoriti ovaj #modul#?',
    'LBL_INVALID_FILE_EXTENSION' => 'Pogrešna ekstenzija datoteke',

    'ERR_AJAX_LOAD' => 'Došlo je do greške:',
    'ERR_AJAX_LOAD_FAILURE' => 'Došlo je do greške prilikom obrade Vašeg zahtjeva, molimo pokušajte ponovo kasnije.',
    'ERR_AJAX_LOAD_FOOTER' => 'Ako se greška ponavlja, neka Vaš administrator onemogući Ajax za ovaj modul',
    'ERR_DECIMAL_SEP_EQ_THOUSANDS_SEP' => 'Separator decimala ne može koristiti isti znak kao i separator hiljada.\\n\\n Molimo promijenite vrijednosti.',
    'ERR_DELETE_RECORD' => 'Broj zapisa mora biti određen da bi se obrisao kontakt.',
    'ERR_EXPORT_DISABLED' => 'Izvoz onemogućen.',
    'ERR_EXPORT_TYPE' => 'Greška kod izvoza ',
    'ERR_INVALID_EMAIL_ADDRESS' => 'nije valjana email adresa.',
    'ERR_INVALID_FILE_REFERENCE' => 'Pogrešna referenca datoteke',
    'ERR_NO_HEADER_ID' => 'Ova mogućnost nije dostupna u ovoj temi.',
    'ERR_NOT_ADMIN' => 'Neovlašten pristup administraciji.',
    ...
    'ERR_NO_DB' => 'Nije se moguće povezati sa bazom podataka. Molimo pogledajte suitecrm.log za detalje (0).',
    ...
    'LBL_ADD_TO_PROSPECT_LIST_BUTTON_LABEL_ACCOUNTS_CONTACTS' => 'Dodajte Kontakte na listu Ciljeva',
    ...
    'LBL_BROWSER_TITLE' => 'SuiteCRM - CRM Otvorenog Koda',
    'LBL_BUGS' => 'Bugovi',
    'LBL_BY' => 'od',
    'LBL_CALLS' => 'Pozivi',
    'LBL_CAMPAIGNS_SEND_QUEUED' => 'Pošalji mailove kampanje koji su na čekanju',
    ...
    'LBL_QUICK_HISTORY' => 'Vremenska linija',
    ...
    'LBL_CLOSE_AND_CREATE_BUTTON_LABEL' => 'Zatvori i napravi novi',
    'LBL_CLOSE_AND_CREATE_BUTTON_TITLE' => 'Zatvori i napravi novi',
    'LBL_CLOSE_AND_CREATE_BUTTON_KEY' => 'C',
    'LBL_OPEN_ITEMS' => 'Open Items',
    'LBL_COMPOSE_EMAIL_BUTTON_KEY' => 'L',
    'LBL_COMPOSE_EMAIL_BUTTON_LABEL' => 'Sastavi e-mail',
    'LBL_COMPOSE_EMAIL_BUTTON_TITLE' => 'Sastavi e-mail',
    ...
    'LBL_DUPLICATE_BUTTON' => 'Dupliraj',
    'LBL_DELETE_BUTTON' => 'Obriši',
    'LBL_DELETE' => 'Obriši',
    'LBL_DELETED' => 'Izbrisano',
    'LBL_LIMIT' => 'Limit: ',
    'LBL_DIRECT_REPORTS' => 'Direktno izvještavaju',
    'LBL_DONE_BUTTON_LABEL' => 'Gotovo',
    'LBL_DONE_BUTTON_TITLE' => 'Gotovo',
    ...
    'LBL_EMAIL_PDF_BUTTON_LABEL' => 'Pošalji mailom kao PDF',
    'LBL_EMAIL_PDF_BUTTON_TITLE' => 'Pošalji mailom kao PDF',
    'LBL_EMAILS' => 'Email',
    'LBL_EMPLOYEES' => 'Zaposlenici',
    'LBL_ENTER_DATE' => 'Unesi datum',
    'LBL_EXPORT' => 'Izvoz',
    'LBL_FAVORITES_FILTER' => 'Moji favoriti',
    'LBL_GO_BUTTON_LABEL' => 'Krenite',
    'LBL_HIDE' => 'Sakrij',
    ...
    'LBL_RECORD_DOES_NOT_EXIST' => 'Greška zaprimanja zapisa. Zapis je možda izbrisan ili niste autorizirani kako bi ga vidjeli.',
    'LBL_PROFILE' => 'Profil',
    ...
    'LBL_MEETING_GO_BACK' => 'Vratite se nazad na sastanak',
    'LBL_MEMBERS' => 'Članovi',
    ...
    'LBL_OPPORTUNITY_NAME' => 'Naziv Poslovne prilike',
    ...
    'LBL_EMAIL_DONE_BUTTON_LABEL' => 'Gotovo',
    'LBL_FULL_FORM_BUTTON_KEY' => 'L',
    'LBL_FULL_FORM_BUTTON_LABEL' => 'Puna forma za unos',
    'LBL_FULL_FORM_BUTTON_TITLE' => 'Puna forma za unos',
    ...
    'LBL_ACCESSKEY_CLEAR_RELATE_TITLE' => 'Obriši odabir',
    'LBL_ACCESSKEY_CLEAR_RELATE_LABEL' => 'Obriši odabir',
    'LBL_ACCESSKEY_CLEAR_COLLECTION_KEY' => ' ',
    'LBL_ACCESSKEY_CLEAR_COLLECTION_TITLE' => 'Obriši odabir',
    'LBL_ACCESSKEY_CLEAR_COLLECTION_LABEL' => 'Obriši odabir',
    'LBL_ACCESSKEY_SELECT_FILE_KEY' => 'F',
    'LBL_ACCESSKEY_SELECT_FILE_TITLE' => 'Odaberite fajl',
    'LBL_ACCESSKEY_SELECT_FILE_LABEL' => 'Odaberite fajl',
    'LBL_ACCESSKEY_CLEAR_FILE_KEY' => ' ',
    'LBL_ACCESSKEY_CLEAR_FILE_TITLE' => 'Obrišite fajl',
    'LBL_ACCESSKEY_CLEAR_FILE_LABEL' => 'Obrišite fajl',

    'LBL_ACCESSKEY_SELECT_USERS_KEY' => 'U',
    'LBL_ACCESSKEY_SELECT_USERS_TITLE' => 'Odaberi korisnika',
    'LBL_ACCESSKEY_SELECT_USERS_LABEL' => 'Odaberi korisnika',
    'LBL_ACCESSKEY_CLEAR_USERS_KEY' => ' ',
    'LBL_ACCESSKEY_CLEAR_USERS_TITLE' => 'Obrišite korisnika',
    'LBL_ACCESSKEY_CLEAR_USERS_LABEL' => 'Obrišite korisnika',
    'LBL_ACCESSKEY_SELECT_ACCOUNTS_KEY' => 'A',
    'LBL_ACCESSKEY_SELECT_ACCOUNTS_TITLE' => 'Odaberite klijenta',
    'LBL_ACCESSKEY_SELECT_ACCOUNTS_LABEL' => 'Odaberite klijenta',
    'LBL_ACCESSKEY_CLEAR_ACCOUNTS_KEY' => ' ',
    'LBL_ACCESSKEY_CLEAR_ACCOUNTS_TITLE' => 'Očistite Klijenta',
    'LBL_ACCESSKEY_CLEAR_ACCOUNTS_LABEL' => 'Očistite Klijenta',
    ...
    'LBL_SERVER_RESPONSE_TIME_SECONDS' => 'sekunde.',
    ...
    'LBL_UNDELETE_BUTTON_LABEL' => 'Vrati',
    'LBL_UNDELETE_BUTTON_TITLE' => 'Vrati',
    'LBL_UNDELETE_BUTTON' => 'Vrati',
    'LBL_UNDELETE' => 'Vrati',
    'LBL_UNSYNC' => 'Desinhroniziraj',
    'LBL_UPDATE' => 'Ažuriraj',
    ...
    'LNK_DELETE' => 'Obriši',
    'LNK_EDIT' => 'Uredi',
    'LNK_GET_LATEST' => 'Dobijte najnovije',
    ...
    'LNK_LOAD_SIGNED_TOOLTIP' => 'Zamijenite sa potpisanim dokumentom',
    'LNK_PRINT' => 'Štampa',
    ...
    'NTC_CLICK_BACK' => 'Molimo kliknite dugme za povratak u pregledniku i popravite grešku.',
    'NTC_DATE_FORMAT' => '(gggg-mm-dd)',
    'NTC_DELETE_CONFIRMATION_MULTIPLE' => 'Jeste li sigurni da želite obrisati odabrani zapis(e)?',
    ...
    'NTC_DELETE_CONFIRMATION_NUM' => 'Jeste li sigurni da želite obrisati ',
    'NTC_UPDATE_CONFIRMATION_NUM' => 'Jeste li sigurni da želite ažurirati ',
    'NTC_DELETE_SELECTED_RECORDS' => ' odabrani zapis(e)?',
    'NTC_LOGIN_MESSAGE' => 'Molimo unesite Vaše korisničko ime i lozinku.',
    'NTC_NO_ITEMS_DISPLAY' => 'nijedan',
    'NTC_REMOVE_CONFIRMATION' => 'Jeste li sigurni da želite ukloniti ovu vezu? Samo veza će biti uklonjena. Zapis neće biti obrisan.',
    ...
    'WARN_BROWSER_VERSION_WARNING' => '<b>Upozorenje:</b>Vaša verzija preglednika nije više podržana ili koristite nepodržani preglednik.<p></p>Sljedeće verzije preglednika su preporučene:<p></p><ul><li>Internet Explorer 10 (prikaz kompatibilnosti nije podržan)<li>Firefox 32.0<li>Safari 5.1<li>Chrome 37</ul>
 
Context | Edit Context',
    'WARN_BROWSER_IE_COMPATIBILITY_MODE_WARNING' => '<b>Upozorenje:</b>Vaš preglednik je u IE prikazu kompatibilnosti koji nije podržan.',
    'ERROR_TYPE_NOT_VALID' => 'Greška. Ova vrsta nije važeća.',
    'ERROR_NO_BEAN' => 'Neuspjeli dohvat beana.',
    'LBL_DUP_MERGE' => 'Pronađite duplikate',
    ...
    'LBL_SAVING_LAYOUT' => 'Spremanje layouta...',
    'LBL_SAVED_LAYOUT' => 'Layout spašen.',
    'LBL_SAVED' => 'Spremljeno',
    'LBL_SAVING' => 'Spremanje',
    'LBL_DISPLAY_COLUMNS' => 'Prikaži kolone',
    'LBL_HIDE_COLUMNS' => 'Sakrij kolone',
    'LBL_COLUMNS' => 'Columns',
    'LBL_SEARCH_CRITERIA' => 'Kriteriji pretrage',
    'LBL_SAVED_VIEWS' => 'Spašeni prikazi',
    'LBL_PROCESSING_REQUEST' => 'Procesiranje...',
    'LBL_REQUEST_PROCESSED' => 'Gotovo',
    'LBL_AJAX_FAILURE' => 'Ajax kvar',
    'LBL_MERGE_DUPLICATES' => 'Spoji',
    'LBL_SAVED_FILTER_SHORTCUT' => 'Moji filteri',
    'LBL_SEARCH_POPULATE_ONLY' => 'Izvrši pretragu koristeći pretragu iznad',
    'LBL_DETAILVIEW' => 'Detaljni prikaz',
    'LBL_LISTVIEW' => 'Pregled liste',
    'LBL_EDITVIEW' => 'Pregled za uređivanje',
    'LBL_BILLING_STREET' => 'Ulica:',
    'LBL_SHIPPING_STREET' => 'Ulica:',
    'LBL_SEARCHFORM' => 'Forma za pretraživanje',
    'LBL_SAVED_SEARCH_ERROR' => 'Molimo unesite ime za ovaj pregled.',
    'LBL_DISPLAY_LOG' => 'Prikaži zapisnik',
    'ERROR_JS_ALERT_SYSTEM_CLASS' => 'Sistem',
    'ERROR_JS_ALERT_TIMEOUT_TITLE' => 'Istek sesije',
    'ERROR_JS_ALERT_TIMEOUT_MSG_1' => 'Vaša sesija će završiti za 2 minute. Molimo sačuvajte Vaš rad.',
    ...
    'MSG_JS_ALERT_MTG_REMINDER_NO_LOCATION' => 'Lokacija nije postavljena.',
    'MSG_JS_ALERT_MTG_REMINDER_NO_START_DATE' => 'Datum početka nije određen.',
    'MSG_LIST_VIEW_NO_RESULTS_BASIC' => 'Nema pronađenih rezultata.',
    'MSG_LIST_VIEW_NO_RESULTS_CHANGE_CRITERIA' => 'Nema pronađenih rezultata... Možda promijenite kriterije pretraživanja i pokušajte ponovo?',
    'MSG_LIST_VIEW_NO_RESULTS' => 'Nema pronađenih rezultata za <item1>',
    ...
    'MSG_EMPTY_LIST_VIEW_NO_RESULTS' => 'Vi trenutno nemate spremljenih zapisa. Uradite sljedeće akcije:  <item2> ili <item3> .',
    ...
    'LBL_CREATE_OPPORTUNITY' => 'Kreiraj poslovnu priliku',
    'LBL_SCHEDULE_CALL' => 'Zabilježite tel.poziv',
    'LBL_SCHEDULE_MEETING' => 'Zakaži sastanak',
    'LBL_CREATE_TASK' => 'Kreirajte zadatak',
    //web to lead
    'LBL_GENERATE_WEB_TO_LEAD_FORM' => 'Generirajte formu',
    'LBL_SAVE_WEB_TO_LEAD_FORM' => 'Snimite web formu',
    'LBL_AVAILABLE_FIELDS' => 'Dostupna polja',
    'LBL_FIRST_FORM_COLUMN' => 'Prvia kolona u formi',
    'LBL_SECOND_FORM_COLUMN' => 'Druga kolona u formi',
    'LBL_ASSIGNED_TO_REQUIRED' => 'Nedostaje obvezno polje: Dodijeljeno je',
    'LBL_RELATED_CAMPAIGN_REQUIRED' => 'Nedostaje potrebno polje: Povezana kampanja',
    'LBL_TYPE_OF_PERSON_FOR_FORM' => 'Web forma za izradu ',
    'LBL_TYPE_OF_PERSON_FOR_FORM_DESC' => 'Popunjavanje ove forme stvorit će ',

    'LBL_ADD_ALL_LEAD_FIELDS' => 'Dodaj sva polja',
    'LBL_RESET_ALL_LEAD_FIELDS' => 'Poništite sva polja',
    'LBL_REMOVE_ALL_LEAD_FIELDS' => 'Uklonite sva polja',
    'LBL_NEXT_BTN' => 'Sljedeće',
    'LBL_ONLY_IMAGE_ATTACHMENT' => 'Samo se sljedeći tipovi slikovnih attachmenta mogu dodati: JPG, PNG.',
    ...
    'LBL_MAX_DASHLETS_REACHED' => 'Dostigli Ste maksimalan broj SuiteCRM Dashlet-a koje je Vaš administrator postavio. Molimo uklonite SuiteCRm Dashlet da dodate još.',
    ...
    'LBL_LOADING_PAGE' => 'Učitavanje stranice, molimo pričekajte...',

    'LBL_RELOAD_PAGE' => 'Molimo<a href="javascript: window.location.reload()">ponovo učitajte prozor</a> da koristite ovaj SuiteCRM Dashlet.',
    'LBL_ADD_DASHLETS' => 'Dodajte Dashlets',
    ...
    //jchi #12300
    'LBL_MASSUPDATE_DATE' => 'Odaberite datum',

    'LBL_VALIDATE_RANGE' => 'nije u važećem dometu',
    'LBL_CHOOSE_START_AND_END_DATES' => 'Molimo izaberiti početni i završni vremenski raspon',
    'LBL_CHOOSE_START_AND_END_ENTRIES' => 'Molimo unesite početni i završni raspon unosa',
    ...
    'ERROR_MISSING_COLLECTION_SELECTION' => 'Potrebno polje je prazno',
    ...
    'LBL_CHOOSE_MONTH' => 'Izaberi mjesec',
    'LBL_ENTER_YEAR' => 'Unesi godinu',
    'LBL_ENTER_VALID_YEAR' => 'Molimo unesite važeću godinu',
...
"5. Click on the Import option from the Actions menu in the application and choose the file to upload"
   ',
    ...
    'LBL_NOTIFICATIONS_NONE' => 'Nema trenutnih obavijesti',
    ...
    'LBL_ALT_MOVE_COLUMN_RIGHT' => 'Pomaknite odabrani unos na listi desno',
    ...
    'LBL_EMAIL_INV_TITLE' => 'neispravna email adresa',
    'LBL_EMAIL_PRIM_TITLE' => 'Napravite primarnu adresu e-pošte',
    'LBL_SELECT_ALL_TITLE' => 'Označi sve',
    'LBL_SELECT_THIS_ROW_TITLE' => 'Odaberi ovaj red',

    //for upload errors
    'UPLOAD_ERROR_TEXT' => 'GREŠKA. Došlo je do greške prilikom prijenosa. Kod greške: {0} - {1}',
    'UPLOAD_ERROR_TEXT_SIZEINFO' => 'ERROR: There was an error during upload. Error code: {0} - {1}. The upload_maxsize is {2} ',
    'UPLOAD_ERROR_HOME_TEXT' => 'GREŠKA: Došlo je do greške prilikom Vašeg prijenosa, molimo kontaktirajte administratora za pomoć.',
    'UPLOAD_MAXIMUM_EXCEEDED' => 'Veličina prijenosa ({0} bajta) Prelazi dozvoljeni maksimum: {1} bajta',
    'UPLOAD_REQUEST_ERROR' => 'Došlo je do greške. Molimo osvježite Vašu stranicu i pokušajte opet.',
    ...
    'LBL_DUPLICATE_BUTTON_LABEL' => 'Dupliraj',
    'LBL_DUPLICATE_BUTTON_TITLE' => 'Dupliraj',
    'LBL_DISABLE_USER_2FA' => 'Disable 2FA',
    'LBL_DELETE_BUTTON_KEY' => 'd',
    'LBL_DELETE_BUTTON_LABEL' => 'Obriši',
    'LBL_DELETE_BUTTON_TITLE' => 'Obriši',
    'LBL_BULK_ACTION_BUTTON_LABEL' => 'Masovne akcije',
    ...
    'PIPELINE_BY_SALES_STAGE' => 'Prodajni kanali prema fazama prodaje',
    ...
    'ERR_A_REMINDER_IS_EMPTY_OR_INCORRECT' => 'Podsjetnik je prazan ili netačan.',
    'ERR_REMINDER_IS_NOT_SET_POPUP_OR_EMAIL' => 'Nije postavljen ni popup ni email podsjetnik.',
    ...
    'LBL_DELETE_REMINDER' => 'Obriši podsjetnik',
    'LBL_OK' => 'Ok',
    'LBL_PROCEED' => 'Proceed',

    'LBL_COLUMNS_FILTER_HEADER_TITLE' => 'Odaberite kolone',
    'LBL_COLUMN_CHOOSER' => 'Izbornik kolona',
    'LBL_SAVE_CHANGES_BUTTON_TITLE' => 'Sačuvaj promjene',
    'LBL_DISPLAYED' => 'Prikazano',
    'LBL_HIDDEN' => 'Skriveno',
    'ERR_EMPTY_COLUMNS_LIST' => 'Najmanje, jedan element je potreban',
    ...
    'LBL_CONFIRM_DISREGARD_DRAFT_BODY' => 'Ova operacija će izbrisati ovaj e-mail, želite li nastaviti?',
    ...
    'LBL_SUITE_DESC3' => 'SuiteCRM je zaštitni znak tvrtke SalesAgility Ltd. Sva ostala imena i nazivi proizvoda mogu biti zaštitni znakovi odgovarajućih tvrtki s kojima su povezani.',
    ...
    'LBL_SEND_TEST_EMAIL' => 'Pošalji testnu poruku',
...
$app_list_strings['charset_dom'] = array(
    'BIG-5' => 'Veliki- 5 (Tajvan i Hong Kong)',
    ...
    'ISO-8859-9' => 'ISO-8859-9 (Latinski 5)',
...
$app_list_strings['fp_event_invite_status_dom']['Attended'] = 'Prisustvovao(la)';
$app_list_strings['fp_event_invite_status_dom']['Not Attended'] = 'Nije prisustvovao(la)';
$app_list_strings['fp_event_status_dom']['Accepted'] = 'Prihvaćen';
$app_list_strings['fp_event_status_dom']['Declined'] = 'Odbijeno';
$app_list_strings['fp_event_status_dom']['No Response'] = 'Nema odgovora';

$app_strings['LBL_STATUS_EVENT'] = 'Status pozivnice';
$app_strings['LBL_ACCEPT_STATUS'] = 'Status prihvaćanja';
$app_strings['LBL_LISTVIEW_OPTION_CURRENT'] = 'Odaberite ovu stranicu';
$app_strings['LBL_LISTVIEW_OPTION_ENTIRE'] = 'Odaberi sve';
$app_strings['LBL_LISTVIEW_NONE'] = 'Odznači sve';

$app_list_strings['moduleList']['AOP_Case_Events'] = 'Događaji u slučaju';
$app_list_strings['moduleList']['AOP_Case_Updates'] = 'Ažuriranja slučajeva';
$app_strings['LBL_AOP_EMAIL_REPLY_DELIMITER'] = '========== Molimo odgovorite iznad ove linije ==========';
...
$app_list_strings['moduleList']['AOR_Conditions'] = 'Uslovi izvještaja';
$app_list_strings['moduleList']['AOR_Charts'] = 'Dijagrami izvještaja';
$app_list_strings['moduleList']['AOR_Fields'] = 'Polja izvještaja';
...
$app_list_strings['aor_date_type_list']['week'] = 'Sedmice';
...
$app_list_strings['aor_function_list']['COUNT'] = 'Brojač';
...
$app_list_strings['aor_total_options']['COUNT'] = 'Brojač';
$app_list_strings['aor_total_options']['SUM'] = 'Suma';
$app_list_strings['aor_total_options']['AVG'] = 'Prosjek';
$app_list_strings['aor_chart_types']['bar'] = 'Bar grafikon';
...
$app_list_strings['aor_chart_types']['stacked_bar'] = 'Stacked grafikon';
...
$app_list_strings['date_time_period_list']['this_week'] = 'Ove sedmice';
$app_list_strings['date_time_period_list']['last_week'] = 'Prošle sedmice';
$app_list_strings['date_time_period_list']['last_month'] = 'Prošli mjesec';
$app_list_strings['date_time_period_list']['this_month'] = 'Ovaj mjesec';
...
$app_strings['LBL_CRON_DOW'] = 'Dan u sedmici';
$app_strings['LBL_CRON_DAILY'] = 'Dnevno';
$app_strings['LBL_CRON_WEEKLY'] = 'Sedmično';
...
$app_list_strings['moduleList']['AOS_PDF_Templates'] = 'PDF - Uzorci';
...
$app_list_strings['moduleList']['AOS_Line_Item_Groups'] = 'Grupe stavki';
$app_list_strings['moduleList']['AOS_Quotes'] = 'Ponude';
$app_list_strings['aos_quotes_type_dom'][''] = '';
$app_list_strings['aos_quotes_type_dom']['Analyst'] = 'Analitičar';
$app_list_strings['aos_quotes_type_dom']['Competitor'] = 'Natjecatelj';
...
$app_list_strings['aos_quotes_type_dom']['Press'] = 'Štampa';
...
$app_list_strings['quote_stage_dom']['Negotiation'] = 'Pregovori';
...
$app_list_strings['quote_stage_dom']['Closed Accepted'] = 'Zatvoreno i dobijeno';
$app_list_strings['quote_stage_dom']['Closed Lost'] = 'Zaključeno izgubljeno';
$app_list_strings['quote_stage_dom']['Closed Dead'] = 'Zatvoreno i izgubljeno';
$app_list_strings['quote_term_dom']['Net 15'] = '15 dana';
$app_list_strings['quote_term_dom']['Net 30'] = '30 dana';
$app_list_strings['quote_term_dom'][''] = '';
$app_list_strings['approval_status_dom']['Approved'] = 'Odobreno';
$app_list_strings['approval_status_dom']['Not Approved'] = 'Nije odobreno';
...
$app_list_strings['aos_invoices_type_dom']['Competitor'] = 'Natjecatelj';
...
$app_list_strings['aos_invoices_type_dom']['Press'] = 'Štampa';
...
$app_list_strings['pdf_template_type_dom']['Leads'] = 'Potencijalni kupac';
$app_list_strings['pdf_template_sample_dom'][''] = '';
$app_list_strings['contract_status_list']['Not Started'] = 'Nije počelo';
...
$app_strings['LBL_PRINT_AS_PDF'] = 'Printaj kao PDF';
$app_strings['LBL_SELECT_TEMPLATE'] = 'Molimo odaberite predložak';
...
$app_list_strings['moduleList']['AOW_Conditions'] = 'WorkFlow Uslov';
$app_list_strings['moduleList']['AOW_Processed'] = 'Audit procesa';
$app_list_strings['moduleList']['AOW_Actions'] = 'Workflow Akcije';
...
$app_list_strings['aow_process_status_list']['Pending'] = 'Na čekanju';
$app_list_strings['aow_process_status_list']['Failed'] = 'Neuspješno';
...
$app_list_strings['aow_date_type_list']['week'] = 'Sedmice';
...
$app_list_strings['aow_email_type_list']['Record Email'] = 'Email sa zapisa';
...
$app_list_strings['aow_run_when_list']['In_Scheduler'] = 'Samo u Shceduleru';

//gant
$app_list_strings['moduleList']['AM_ProjectTemplates'] = 'Projekti - uzorci';
$app_list_strings['moduleList']['AM_TaskTemplates'] = 'Uzorci projektnih zadataka';
...
$app_strings['LBL_GANTT_BUTTON_LABEL'] = 'Pogledajte Gantt Chart';
$app_strings['LBL_DETAIL_BUTTON_LABEL'] = 'Pogledajte detalje';
$app_strings['LBL_CREATE_PROJECT'] = 'Kreirajte projekt';
...
$app_list_strings['moduleList']['jjwg_Address_Cache'] = 'Mape- Memorija adresa';
...
$app_list_strings['marker_image_list']['bicycle_parking'] = 'Parking za bicikla';
$app_list_strings['marker_image_list']['big_city'] = 'Veliki grad';
$app_list_strings['marker_image_list']['bridge'] = 'Most';
$app_list_strings['marker_image_list']['bridge_modern'] = 'Savremeni most';
...
$app_list_strings['marker_image_list']['dentist'] = 'Stomatolog';
...
$app_list_strings['marker_image_list']['home'] = 'Početna';
...
$app_list_strings['marker_image_list']['hotel_1_star'] = 'Hotel 1 zvijezdica';
...
$app_list_strings['marker_image_list']['justice'] = 'Pravda';
...
$app_list_strings['marker_image_list']['modern_tower'] = 'Savremeni toranj';
...
$app_list_strings['marker_image_list']['motorcycle'] = 'Motor';
...
$app_list_strings['marker_image_list']['postal'] = 'Poštanski';
...
$app_list_strings['marker_image_list']['sight'] = 'Prizor';
...
$app_list_strings['marker_image_list']['temple_hindu'] = 'Hindu hram';
...
$app_list_strings['marker_image_list']['toilets'] = 'Toaleti';
$app_list_strings['marker_image_list']['toll_station'] = 'Naplatne kućice';
...
$app_list_strings['marker_image_list']['turn_left'] = 'Skreni lijevo';
...
$app_strings['LBL_RESCHEDULE_ERROR2'] = 'Molimo odaberite razlog';
...
$app_strings['LBL_EDIT_TAB'] = 'Uredi tab';
$app_strings['LBL_SUITE_DASHBOARD'] = 'SUITECRM DASHBOARD';
$app_strings['LBL_ENTER_DASHBOARD_NAME'] = 'Unesite naziv Dashboarda:';
$app_strings['LBL_NUMBER_OF_COLUMNS'] = 'Broj kolona:';
$app_strings['LBL_DELETE_DASHBOARD1'] = 'Jeste li sigurni da želite izbrisati';
$app_strings['LBL_DELETE_DASHBOARD2'] = 'dashboard?';
$app_strings['LBL_ADD_DASHBOARD_PAGE'] = 'Dodaj stranicu Dashboarda';
$app_strings['LBL_DELETE_DASHBOARD_PAGE'] = 'Uklonite trenutnu stranicu Dashboarda';
$app_strings['LBL_RENAME_DASHBOARD_PAGE'] = 'Preimenuj stranicu Dashboarda';
...
$app_list_strings['pdf_page_size_dom']['Legal'] = 'Legalno';
...
$app_list_strings['moduleList']['SurveyQuestionResponses'] = 'Odgovori na pitanja ankete';
...
$app_list_strings['surveys_question_type']['Checkbox'] = 'Radio';
$app_list_strings['surveys_question_type']['Radio'] = 'Radio';
$app_list_strings['surveys_question_type']['Dropdown'] = 'Padajući izbornik';
$app_list_strings['surveys_question_type']['Multiselect'] = 'Višestruki odabir';
...
$app_list_strings['surveys_question_type']['Rating'] = 'Rejting';
...
$app_strings['ERR_TWO_FACTOR_FAILED'] = 'Dvostruka provjera autentičnosti nije uspjela';
...
$app_list_strings['oauth2_grant_type_dom'] = array(
    ...
    'client_credentials' => 'Kredencijali klijenta',
    'implicit' => 'Implicitan',
...
$app_strings['MSG_BROWSER_NOTIFICATIONS_UNSUPPORTED'] = 'Ovaj web preglednik ne podržava obavijesti.';

$app_strings['LBL_GOOGLE_SYNC_ERR'] = 'SuiteCRM Google Sync - GREŠKA';
...
$app_strings['LBL_EMAIL_ADDRESS'] = 'Email adresa';
...
$app_strings['LBL_SEARCH_TEXT_FIELD_TITLE_ATTR']   = 'Unesite kriterij pretraživanja';
...
$app_strings['LBL_CHARTS'] = 'Grafikoni';
...
$app_strings['LBL_NONE_OUTSTANDING'] = 'Nijedan';
...
$app_strings['AOS_Invoices'] = 'Fakture';
$app_strings['LBL_PHOTO'] = 'Fotografija';
$app_strings['LBL_CASE_UPDATES'] = 'Ažuriranja slučajeva';
...
$app_strings['LBL_RELATED_TO'] = 'Povezano sa';
...
$app_strings['LBL_ALIGN_LEFT'] = 'Lijevo';
...
// Day and Time labels
$app_strings['LBL_SUN'] = 'Nedjelja';
$app_strings['LBL_MON'] = 'Ponedjeljak';
$app_strings['LBL_TUE'] = 'Utorak';
$app_strings['LBL_WED'] = 'Srijeda';
...
$app_strings['LBL_CAMPAIGN_SETTINGS'] = 'Postavke';
