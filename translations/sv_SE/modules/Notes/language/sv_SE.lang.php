...
$mod_strings = array(
    'ERR_DELETE_RECORD' => 'Du måste ange ett postnummer för att ta bort kontot.',
    ...
    'LBL_NEW_FORM_TITLE' => 'Skapa anteckning eller lägg till bilaga',
    ...
    'LNK_NOTE_LIST' => 'Visa anteckningar',
    ...
    'LBL_NOTE_INFORMATION' => 'ÖVERSIKT', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
