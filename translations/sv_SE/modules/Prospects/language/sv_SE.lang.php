...
$mod_strings = array(
    ...
    'LBL_EXISTING_ACCOUNT' => 'Använde ett befintligt konto',
    'LBL_CREATED_ACCOUNT' => 'Skapade ett nytt konto',
    'LBL_CREATED_CALL' => 'Skapade ett nytt samtal',
    'LBL_CREATED_MEETING' => 'Skapade ett nytt möte',
    'LBL_NAME' => 'Namn:',
    'LBL_PROSPECT_INFORMATION' => 'ÖVERSIKT', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
    ...
    'LBL_ALT_ADDRESS_STATE' => 'Alternativ adress, delstat/region:',
    ...
    'LBL_EMAIL_OPT_OUT' => 'Avregistrerad från e-post:',
    ...
    'LBL_SELECT_CHECKED_BUTTON_TITLE' => 'Välj markerade mål',
    ...
    'LBL_CONVERT_BUTTON_LABEL' => 'Konvertera mål',
    ...
    'LBL_TRACKER_KEY' => 'Spårningsnyckel',
    'LBL_LEAD_ID' => 'Lead-ID',
    'LBL_CONVERTED_LEAD' => 'Konverterad Lead',
    'LBL_ACCOUNT_NAME' => 'Kontonamn',
    'LBL_EDIT_ACCOUNT_NAME' => 'Kontonamn:',
