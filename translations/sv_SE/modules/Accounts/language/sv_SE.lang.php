...
$mod_strings = array(
    ...
    'ERR_DELETE_RECORD' => 'Ett ID för posten måste specificeras för att det ska gå att radera företaget.',
    'LBL_ACCOUNT_INFORMATION' => 'Företagsinformation', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
    ...
    'LBL_LIST_FORM_TITLE' => 'Lista Företag',
