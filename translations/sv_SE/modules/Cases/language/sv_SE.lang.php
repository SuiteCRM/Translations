...
$mod_strings = array(
    ...
    'LBL_CASE_INFORMATION' => 'ÖVERSIKT', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
    ...
    'LBL_CASE_UPDATE_FORM' => 'Uppdateringar – bilageformulär', //Form for attachments on case updates
