...
$mod_strings = array(
    ...
    'LNK_NEW_RECORD' => 'Skapa konto för utgående e-post',

    'LNK_LIST_CREATE_NEW_PERSONAL' => 'Nytt personligt konto för utgående e-post',
    'LNK_LIST_CREATE_NEW_GROUP' => 'Nytt gruppkonto för utgående e-post',
    'LNK_LIST_CREATE_SYSTEM_OVERRIDE_GROUP' => 'Nytt systemkonto för åsidosättning av utgående e-post',

    'LNK_LIST' => 'Utgående e-postkonton',
    'LNK_LIST_INBOUND_EMAIL_ACCOUNTS' => 'Konton för inkommande e-post',
    'LBL_SEARCH_FORM_TITLE' => 'Sök konton för utgående e-post',
    ...
    'LBL_MISSING_DEFAULT_OUTBOUND_SMTP_SETTINGS' => 'Administratören har inte konfigurerat standardkontot för utgående e-post ännu. Det går inte att skicka testmeddelande.',
    ...
    'LBL_MAIL_SMTP_SETTINGS' => 'SMTP-serverspecifikation',
    ...
    'LBL_TYPE' => 'Typ',
    'LBL_MAIL_SENDTYPE' => 'Typ av e-postutskick',
    'LBL_MAIL_SMTPSSL' => 'E-post via SMTP/SSL',
    'LBL_SMTP_FROM_NAME' => 'Avsändarnamn',
    'LBL_SMTP_FROM_ADDR' => 'Avsändaradress',
    'LBL_REPLY_TO_NAME' => 'Svarsnamn',
    'LBL_REPLY_TO_ADDR' => 'Svarsadress',
    ...
    'LBL_ERROR_OUTBOUND_EMAIL_CONNECTION_TYPE_MISMATCH' => 'När du konfigurerar kontot för utgående e-post med OAuth måste du välja en extern OAuth-anslutning av samma typ som e-postkontot (grupp eller personligt).',
);
