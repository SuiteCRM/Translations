...
$mod_strings = array(
    ...
    'ERR_DELETE_RECORD' => 'Du måste ange ett postnummer för att ta bort leaden.',
...
//Convert lead tooltips
    ...
    'LBL_ACTIVITIES_MOVE_HELP' => "Välj den post som leadens aktiviteter ska flyttas till. Uppgifter, samtal, möten, anteckningar och e-post flyttas till den eller de valda posterna.",
    'LBL_ACTIVITIES_COPY_HELP' => "Välj de poster som kopior av leadens aktiviteter ska skapas för. Nya uppgifter, samtal, möten och anteckningar skapas för varje vald post. E-post kopplas till de valda posterna.",
    //For export labels
