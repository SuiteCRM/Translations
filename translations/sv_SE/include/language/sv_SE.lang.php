...
//e.g. auf Deutsch 'Contacts'=>'Contakten',
    ...
    'moduleList' => array(
        ...
        'Sync' => 'Synk',
        'CalendarAccount' => 'Kalenderkonton',
        'Users' => 'Användare',
        'Employees' => 'Anställda',
        'Administration' => 'Administration',
        'ACLRoles' => 'Roller',
        'InboundEmail' => 'Inkommande e-postkonton',
        'Releases' => 'Utgåvor',
        'Prospects' => 'Objekt',
        'Queues' => 'Köer',
        'EmailMarketing' => 'Marknadsföring via E-post',
        ...
        'OAuth2AuthCodes' => 'OAuth-auktoriseringskoder',
    ),
...
//       it is the key for the default case_relationship_type_dom value
    ...
    'snooze_alert_timer' => array(
        60 => 'Skjut upp i 1 minut',
        300 => 'Skjut upp i 5 minuter',
        600 => 'Skjut upp i 10 minuter',
        900 => 'Skjut upp i 15 minuter',
        1800 => 'Skjut upp i 30 minuter',
        3600 => 'Skjut upp i 1 timme',
        7200 => 'Skjut upp i 2 timmar',
        10800 => 'Skjut upp i 3 timmar',
        18000 => 'Skjut upp i 5 timmar',
        86400 => 'Skjut upp i 1 dag',
    ),
...
//prospect list type dom
    ...
    'email_marketing_status_dom' => array(
        ...
        'pending_send' => 'Väntar på att skickas',
        'aborted' => 'Avbruten',
        'sending' => 'Skickar',
        'sent' => 'Skickad',
        'paused' => 'Pausad',
    ...
    'email_marketing_duplicate_dom' => [
        'email' => 'Förhindra utskick till dubblettposter och dubblettadresser',
        'record' => 'Förhindra utskick till dubblettposter',
    ],
...
$app_strings = array(
    'LBL_SEARCH_RESULTS_TITLE' => 'Sökresultat',
    'ERR_SEARCH_INVALID_QUERY' => 'Ett fel uppstod när sökningen utfördes. Frågesyntaxen kanske inte är giltig.',
    ...
    'LBL_LOGOUT' => 'Logga ut',
    'LBL_LOGOUT_SUCCESS' => 'Utloggning lyckades',
    'LBL_LOGGED_OUT_MESSAGE' => 'Du har loggats ut',
    'LBL_LOGIN_AGAIN' => 'För att logga in igen ',
    'LBL_TOUR_NEXT' => 'Nästa',
    ...
    'LBL_OAUTH_CONNECTION_NOT_SET' => 'Ange en extern OAuth-anslutning.',
    'LBL_EMAIL_PASSWORD_NOT_SET' => 'Varning: Inget lösenord har angetts.',
    'LBL_EMAIL_WARNING_MISSING_CREDS' => 'Varning: Inloggningsuppgifter saknas',
    ...
    'ERR_TIMEOUT' => "Tvingade fel vid timeout",
    ...
    'LBL_EMAIL_FOLDERS' => SugarThemeRegistry::current()->getImage('icon_email_folder', 'align=absmiddle border=0', null, null, '.gif', '') . 'Mappar',
    ...
    'LBL_EMAIL_MENU_RENAME_FOLDER' => 'Byt namn på mapp',
    ...
    'LBL_EMAIL_OPT_OUT' => 'Avregistrerad',
    ...
    'LBL_EMAIL_QC_BUGS' => 'Fel',
    'LBL_EMAIL_QC_CASES' => 'Ärende',
    'LBL_EMAIL_QC_LEADS' => 'Kundämne',
    'LBL_EMAIL_QC_CONTACTS' => 'Kontakt',
    'LBL_EMAIL_QC_TASKS' => 'Uppgift',
    'LBL_EMAIL_QC_OPPORTUNITIES' => 'Affär',
    ...
    'LBL_EMAIL_DRAFT_SAVED' => 'Utkastet har sparats.',
    ...
    'LBL_EMAIL_SETTINGS_TITLE' => 'E-postinställningar',
    ...
    'LBL_EMAIL_SETTINGS_FROM_ADDR_NOT_SET' => 'Avsändaradress och/eller avsändarnamn har inte angetts',
    ...
    'ERR_UNAUTHORIZED_PAGE_ACCESS' => 'Du har inte behörighet att se denna sida. Kontakta din systemadministratör.',
    'ERR_UNAUTHORIZED_PAGE_ACCESS_TO_HOME_PAGE' => 'Du har inte behörighet att se denna sida. Omdirigerar till startsidan...',
    ...
    'LBL_ACCUMULATED_HISTORY_BUTTON_TITLE' => 'Visa sammanfattning',
    ...
    'LBL_CAMPAIGNS_SEND_NEXT_BATCH' => 'Skicka nästa batch med e-postmeddelanden i kön',
    'LBL_SENT_NEXT_BATCH' => 'Batchen har skickats',
    ...
    'LBL_CURRENT_USER_FILTER' => 'Mina objekt',
    'LBL_CURRENCY' => 'Valuta:',
    ...
    'LBL_EMAIL_PDF_BUTTON_TITLE' => 'E-posta som PDF',
    ...
    'LBL_LAST_VIEWED_NO_RESULT' => 'Inga nyligen visade objekt',
    'LBL_LEADS' => 'Kundämnen',
    'LBL_LESS' => 'mindre',
    ...
    'LBL_CAMPAIGN_CHARTS' => 'Kampanjdiagram',
    'LBL_EMAIL_MARKETING_CHARTS' => 'Diagram för e-postmarknadsföring',
    'LBL_MESSAGE_QUEUE_TITLE' => 'Meddelandekö',
    'LBL_CAMPAIGN_SEND_STATUS' => 'Skickstatus för kampanj',
    'LBL_CAMPAIGN_SEND_ERROR_THRESHOLD_EXCEEDED' => 'Felgränsen per batch (%d) har uppnåtts: %s',
    'LBL_CAMPAIGN_SEND_FAILURE_THRESHOLD_EXCEEDED' => 'Felgränsen per batch på %d har överskridits',
    'LBL_EMAIL_MARKETING_SEND_STATUS' => 'Skickstatus för e-postmarknadsföring',
    'LBL_CAMPAIGN_RESPONSE_BY_RECIPIENT_ACTIVITY' => 'Kampanjsvar per mottagaraktivitet',
    'LBL_EMAIL_MARKETING_RESPONSE_BY_RECIPIENT_ACTIVITY' => 'Svar på e-postmarknadsföring per mottagaraktivitet',
    'LBL_LOG_ENTRIES_TARGETED_TITLE' => 'Skickade/försökta',
    'LBL_LOG_ENTRIES_SEND_ERROR_TITLE' => 'Studsade meddelanden, övriga',
    'LBL_LOG_ENTRIES_BOUNCED_TITLE' => 'Studsade meddelanden',
    'LBL_LOG_ENTRIES_INVALID_EMAIL_TITLE' => 'Studsade meddelanden, ogiltig e-postadress',
    'LBL_LOG_ENTRIES_LINK_TITLE' => 'Klickad länk',
    'LBL_LOG_ENTRIES_VIEWED_TITLE' => 'Visat meddelande',
    'LBL_LOG_ENTRIES_REMOVED_TITLE' => 'Avregistrerad',
    'LBL_LOG_ENTRIES_LEAD_TITLE' => 'Kundämnen skapade',
    'LBL_CAMPAIGN_LEAD_SUBPANEL_TITLE' => 'Kundämnen',
    'LBL_OPPORTUNITY_SUBPANEL_TITLE' => 'Möjligheter',
    'LBL_LOG_ENTRIES_CONTACT_TITLE' => 'Skapade kontakter',
    'LBL_LOG_ENTRIES_BLOCKED_TITLE' => 'Undertryckta/blockerade',
    'LBL_THEME' => 'Tema:',
    'LBL_FOUND_IN_RELEASE' => 'Funnen i release',
    'LBL_FIXED_IN_RELEASE' => 'Fixad i release',
    'LBL_IN_EVERYWHERE' => 'Överallt',
    ...
    'LBL_SNOOZE' => 'Snooza',
    'LBL_SNOOZE_INLINE_CONFIRM' => 'Snooza? ({{preferences.snooze_alert_timer|enum:snooze_alert_timer_simple}})',
    'LBL_DISMISS' => 'Avfärda',
    ...
    'LBL_ALERT_DISMISS_ERROR' => 'Det gick inte att avfärda aviseringen',
    'LBL_ALERT_DISMISS_ALL_SUCCESS' => 'Aviseringarna har avfärdats',
    'LBL_DISMISS_ALL' => 'Avfärda alla',
    'LBL_DISMISS_SUCCESS' => 'Har avfärdats',
    'LBL_VERIFY' => 'Verifiera',
    'LBL_RESEND' => 'Skicka igen',
    'LBL_RECORD_DOES_NOT_EXIST' => 'Det gick inte att hämta posten. Den kan vara borttagen eller så saknar du behörighet att visa den.',
    'LBL_PROFILE' => 'Profil',
    'LBL_PROFILE_EDIT' => 'Redigera profil',
    ...
    'LBL_OPPORTUNITIES' => 'Möjligheter',
    'LBL_OPPORTUNITY_NAME' => 'Affärsnamn',
    'LBL_OPPORTUNITY' => 'Möjlighet',
    'LBL_OR' => 'Eller',
    ...
    'LBL_FULL_FORM_BUTTON_TITLE' => 'Fullständigt formulär',
    'LBL_SAVE_NEW_BUTTON_LABEL' => 'Spara & skapa ny',
    'LBL_SAVE_NEW_BUTTON_TITLE' => 'Spara och skapa ny',
    'LBL_SAVE_OBJECT' => 'Spara {0}',
    'LBL_SEARCH_BUTTON_KEY' => 'C',
    'LBL_SEARCH_BUTTON_LABEL' => 'Sök',
    'LBL_SEARCH_BUTTON_TITLE' => 'Sök',
    'LBL_FILTER' => 'Filter',
    'LBL_CLEAR_FILTER' => 'Rensa filter',
    'LBL_FILTER_MODULES' => 'Filtrera moduler',
    'LBL_SEARCH' => 'Sök',
    'LBL_SEARCH_ALT' => '',
    ...
    'LBL_ACCESSKEY_SELECT_ACCOUNTS_LABEL' => 'Välj konto',
    ...
    'LBL_ALL_SCHEDULERS' => 'Alla schemaläggare',
    'LBL_LEGACY_SCHEDULERS' => 'Äldre schemaläggare',
    'LBL_SCHEDULERS' => 'Schemaläggare',
    'LBL_RUN_LEGACY_SCHEDULERS' => 'Kör äldre schemaläggare',
    'LBL_LEGACY_SCHEDULERS_RUN_SUCCESSFULLY' => 'Äldre schemaläggare kördes utan fel!',
    'LBL_RUN_SCHEDULERS' => 'Kör schemaläggare',
    'LBL_LEGACY_SCHEDULER_FAILED' => 'Alla schemaläggare lyckades inte. Se loggarna.',
    'LBL_PASSED' => 'Godkänd',
    'LBL_FAILED' => 'Misslyckad',

    'LBL_SCENARIO_SALES' => 'Försäljning',
    'LBL_SCENARIO_MARKETING' => 'Marknadsföring',
    'LBL_SCENARIO_FINANCE' => 'Ekonomi',
    ...
    'LBL_TOO_MANY_ADDRESSES' => 'Du har valt för många e-postadresser.',
    'LBL_NO_ADDRESSES_SELECTED' => 'Välj en adress att skicka till.',
    'LBL_NOT_ALL_SENT' => 'Alla e-postmeddelanden skickades inte. Se loggarna för mer information.',
    'LBL_NOT_VALID_TARGETS' => 'Inga mottagare har validerats för utskick.',
    'LBL_ALL_EMAILS_SENT' => 'Alla testmeddelanden har skickats',
    'LBL_UNDELETE_BUTTON_LABEL' => 'Ångra radera',
    'LBL_UNDELETE_BUTTON_TITLE' => 'Återställ',
    'LBL_UNDELETE_BUTTON' => 'Återställ',
    'LBL_UNDELETE' => 'Återställ',
    ...
    'LBL_BASIC_FILTER' => 'Grundläggande filter',
    'LBL_QUICK' => 'Snabb',
    ...
    'NTC_SEND_QUEUED_CAMPAIGN_EMAILS' => 'Skicka nästa batch med köade kampanjmeddelanden?',
    'NTC_SNOOZE_CONFIRMATION' => 'Vill du snooza?',
    ...
    'NTC_DELETE_CONFIRMATION' => 'Vill du ta bort den här posten?',
    'NTC_ABORT_CONFIRMATION' => 'Vill du avbryta?',
    'LBL_EMAIL_MARKETING_NOT_SENT' => 'Statusen för e-postmarknadsföring är inte Skickad och kan inte schemaläggas om',
    'NTC_RESUME_CONFIRMATION' => 'När utskicket återupptas köas misslyckade mottagare på nytt och sändningen fortsätter.',
    'LBL_EMAIL_MARKETING_NOT_PAUSED' => 'Statusen för e-postmarknadsföring är inte Pausad och kan inte återupptas',
    'LBL_CAMPAIGN_PAUSED_THRESHOLD' => 'Kampanjen har pausats —',
    'LBL_CAMPAIGN_PAUSED_DYNAMIC_LABEL' => '{{ fields.email-marketing-pause-reason.value }}',
    'NTC_SCHEDULE_CONFIRMATION' => "När kampanjen är schemalagd börjar utskicket när det schemalagda kördatumet har uppnåtts.",
    'NTC_DELETE_TEST_ENTRIES' => 'Schemaläggning tar bort testposter.',
    'NTC_DELETE_TEST_ENTRIES_CONFIRMATION' => 'Vill du ta bort testposterna?',
    'NTC_PROCEED' => 'Vill du fortsätta?',
    'NTC_UNSCHEDULE_CONFIRMATION' => 'Om schemaläggningen tas bort sätts statusen till "Utkast".',
    'NTC_UNSCHEDULE_CONFIRMATION_OTHER' => 'Utskicket startar inte igen förrän det har schemalagts på nytt.',
    ...
    'NTC_REQUIRED' => 'Anger obligatoriskt fält',
    ...
    'LBL_TEMPLATE_CONFIRMATION' => 'Använd ny e-postmall? (Detta skriver över den aktuella e-posttexten och ämnesfältet)',
    ...
    'LBL_MAX_DASHLET_COLUMNS' => "Högst %s kolumner kan visas.",
...
"5. Klicka på alternativet Import från åtgärder-menyn i programmet och välj filen att ladda upp"   ',
    ...
    'ERR_NOTIFICATIONS_MARK_AS_READ' => 'Det gick inte att markera aviseringarna som lästa',
    'ERR_FIELD_LOGIC_BACKEND_CALCULATION' => 'Det gick inte att hämta värdet',
    'LBL_FAILED_TO_UPDATE_TEMPLATE_VARIABLES' => 'Det gick inte att uppdatera mallvariablerna',
    ...
    'LBL_DISABLE_USER_2FA' => 'Inaktivera tvåfaktorsautentisering',
    ...
    'LBL_TOO_FEW_SELECTED' => 'Ogiltigt antal poster valda. Du måste välja minst {min} poster.',
    'LBL_TOO_MANY_SELECTED' => 'Ogiltigt antal poster valda. Du måste välja maximalt {max} poster.',
    'LBL_SELECT_ALL_NOT_ALLOWED' => 'Det går inte att välja alla. Välj enstaka.',
    'LBL_MISSING_HANDLER_DATA' => 'Oväntat fel. Data från massåtgärder saknas i svaret',
    'LBL_MISSING_HANDLER' => 'Oväntat fel. Ingen hanterare definierad för vald massåtgärd',
    'LBL_MISSING_HANDLER_DATA_ROUTE' => 'Oväntat fel. Åtgärdsrutt saknas i massåtgärd',
    'LBL_ACTION_ERROR' => 'Oväntat fel vid anrop av åtgärd',
    'LBL_BULK_ACTION_ERROR' => 'Oväntat fel vid anrop av massåtgärd',
    'LBL_BULK_ACTION_DELETE_SUCCESS' => 'Post(er) har raderats',
    'LBL_BULK_ACTION_MASS_UPDATE_CONFIRMATION' => 'Är du säker på att du vill uppdatera alla markerade poster?',
    'LBL_BULK_ACTION_MASS_UPDATE_SUCCESS' => 'Alla poster har uppdaterats',
    'LBL_BULK_ACTION_MASS_UPDATE_PARTIAL_SUCCESS' => 'Delvis lyckad. Vissa poster uppdaterades inte. Kontrollera loggen',
    'LBL_BULK_ACTION_MASS_UPDATE_NO_FIELDS' => 'Inga fält att uppdatera',
    'LBL_BULK_ACTION_MASS_UPDATE_NO_RECORDS' => 'Inga poster att uppdatera',
    'LBL_BULK_ACTION_MASS_UPDATE_NO_ACLS' => 'Otillräcklig behörighet, Spara åtgärd tillåts inte',
    'LBL_UNEXPECTED_ERROR' => 'Oväntat fel. Ingen möjlighet att utföra åtgärd.',
    'LBL_RECORD_DELETE_SUCCESS' => 'Posten har raderats',
    'LBL_RECORD_DELETE_ALL_SUCCESS' => 'Posterna har tagits bort',
    'LBL_RECORD_SNOOZE_SUCCESS' => 'Aviseringen har snoozats',
    'LBL_ERROR_SAVING' => 'Ett fel uppstod när posten skulle sparas',
    'LBL_SAVE_BUTTON_KEY' => 'a',
    'LBL_SAVE_BUTTON_LABEL' => 'Spara',
    'LBL_NEW_EM_SURVEY' => 'Ny e-post för enkät',
    'LBL_NEW_EM_TRANSACTIONAL' => 'Ny transaktionell e-post',
    'LBL_NEW_EM_MARKETING' => 'Ny marknadsförings-e-post',
    'LBL_NEW_SURVEY' => 'Ny enkät',
    'LBL_WEB_TO_LEAD' => 'Nytt webb-till-person-formulär',
    'LBL_TYPE' => 'Typ',
    'LBL_DATE_START' => 'Startdatum',
    'LBL_SEND_DATE' => 'Skickdatum',
    'LBL_SCHEDULE_BUTTON_LABEL' => 'Schema',
    'LBL_UNABLE_TO_UNSCHEDULE' => 'Det går inte att ta bort schemaläggningen eftersom den inte är schemalagd',
    'LBL_SAVE_BUTTON_TITLE' => 'Spara',
    'LBL_SAVE_CONTINUE_LABEL' => 'Spara och fortsätt',
    ...
    'ANNUAL_REVENUE_BY_ACCOUNTS' => 'Årlig intäkt per konto',
    'PIPELINE_BY_SALES_STAGE' => 'Pipeline efter försäljningsfas',
    'LEADS_BY_SOURCE' => 'Leads per källa',
    'LEADS_BY_STATUS' => 'Leads per status',
    'ACCOUNT_TYPES_PER_MONTH' => 'Nya konton per månad',
    ...
    'LBL_SUITE_DESC1' => 'SuiteCRM har utvecklats och sammanställts av <a href="https://suitecrm.com/">SuiteCRM Ltd</a>. Programmet tillhandahålls I BEFINTLIGT SKICK, utan garanti. Licensierat under AGPLv3.',
    ...
    'LBL_SEND_TEST_EMAIL_DESC' => 'Välj de e-postadresser, användare och/eller mållistor som meddelandet ska skickas till.',
    'LBL_EMAIL_SENT_SUCCESSFULLY' => 'E-postmeddelandet har skickats',
    'LBL_PROSPECT_LIST_NAME' => 'Mållistor',

    //List View Column Selector Modal
    'LBL_COLUMN_SELECTOR_DISPLAYED_COLS' => 'VISADE',
    'LBL_COLUMN_SELECTOR_HIDDEN_COLS' => 'DOLDA',
    'LBL_COLUMN_SELECTOR_CLOSE_BUTTON' => 'Stäng',
    'LBL_COLUMN_SELECTOR_SAVE_BUTTON' => 'Spara ändringar',
    'LBL_COLUMN_SELECTOR_MODAL_TITLE' => 'Välj kolumner',

    // Two-Factor Authentication
    'LBL_ENTER_AUTH_APP_2FA_CODE' => 'Ange verifieringskoden från autentiseringsappen',
    'LBL_ENABLE_2FA_LABEL' => 'Aktivera tvåfaktorsautentisering',
    'LBL_BACKUP_CODES' => 'Återställnings-/reservkoder',
    'LBL_BACKUP_CODES_INFO' => 'Reservkoder är engångskoder som kan användas när du inte kan verifiera dig med autentiseringsappen.',
    'LBL_BACKUP_CODES_WARN' => ' VARNING: Koderna genereras bara en gång. Kopiera dem INNAN du verifierar, eftersom de inte visas igen.',
    'LBL_PROBLEMS_GENERATING_CODE' => 'Problem med att generera koden?',
    'LBL_BACKUP_CODES_FALLBACK_INSTRUCTIONS' => 'Använd en av reservkoderna (den upphör att gälla efter användning)',
    'LBL_OTP_SETUP' => 'Använd en OTP-autentiserare (engångslösenord) på mobilen eller datorn för att aktivera 2FA (tvåfaktorsautentisering)',
    'LBL_QR_CODE_HELP' => "Hämta en autentiseringsapp om du inte redan har gjort det, till exempel FreeOTP eller Google Authenticator. Använd appen för att skanna QR-koden.",
    'LBL_USE_SECRET' => "Går det inte att skanna QR-koden?",
    'LBL_USE_SECRET_DESC' => "Om du inte kan skanna QR-koden anger du den hemliga nyckeln nedan manuellt i autentiseringsappen.",
    'LBL_HIDE_SECRET' => "Dölj TOTP-hemlighet",
    'LBL_2FA_LOGIN_CANCEL' => 'Tvåfaktorsautentisering har avbrutits',

    'LBL_FACTOR_AUTH_DISABLE' => 'Tvåfaktorsautentisering har inaktiverats',
    'LBL_FACTOR_AUTH_SUCCESS' => 'Tvåfaktorsautentisering lyckades',
    'LBL_FACTOR_AUTH_FAIL' => "Tvåfaktorsautentisering misslyckades. Försök igen.",

    'LBL_VERIFY_2FA' => 'Verifiera kod',
    'LBL_TWO_FACTOR_AUTH' => 'Tvåfaktorsautentisering',
    'LBL_TWO_FACTOR_AUTH_APP_METHOD' => 'Autentiseringsapp',
    'LBL_TWO_FACTOR_AUTH_APP_METHOD_DESCRIPTION' => 'Använd en autentiseringsapp för att generera koder för tvåfaktorsautentisering när du uppmanas',
    'LBL_ENABLE' => 'Aktivera',
    'LBL_ENABLED' => 'Aktiverad',
    'LBL_DISABLE' => 'Inaktivera',
    'LBL_GENERATED' => 'Genererad',
    'LBL_REGENERATE_CODES' => 'Generera på nytt',
    'LBL_REGENERATED_BACKUP_CODES' => 'Reservkoderna har genererats på nytt'
...
$app_list_strings['aok_status_list']['In_Review'] = 'Under granskning';
...
$app_list_strings['case_status_default_key'] = 'Öppen_ny';
$app_list_strings['case_status_dom'] =
    array(
        'Open_New' => 'Ny',
        'Open_Assigned' => 'Tilldelad',
        'Closed_Closed' => 'Stängd',
        'Open_Pending Input' => 'Väntar på information',
...
$app_list_strings['date_time_period_list']['this_month'] = 'Den här månaden';
...
$app_list_strings['aos_quotes_type_dom']['Other'] = 'Annat';
...
$app_list_strings['aos_invoices_type_dom']['Other'] = 'Annat';
...
$app_string['LBL_PDF_GENERATION_FAILED'] = 'Det gick inte att generera PDF-dokumentet. Mer information finns i loggarna.';
...
$app_list_strings['moduleList']['AOW_Conditions'] = 'Villkor för arbetsflöde';
...
$app_list_strings['aow_date_type_list']['business_hours'] = 'Arbetstid';
...
$app_list_strings['moduleList']['ManualMigrationTasks'] = 'Migreringar';
$app_list_strings['moduleList']['Processes'] = 'Processer';
$app_list_strings['moduleList']['AsyncTaskItems'] = 'Asynkront aktivitetsobjekt';

$app_strings['LNK_USER_MENU_PROCESSES'] = 'Processer';
...
$app_list_strings['moduleList']['AOBH_BusinessHours'] = 'Arbetstid';
...
$app_list_strings['surveys_question_type']['Rating'] = 'Betyg';
...
$app_strings['LBL_OPT_OUT'] = 'Avanmälan';
$app_strings['LBL_INVALID_EMAIL'] = 'Ogiltig';
$app_strings['LBL_PRIMARY'] = 'Primär';
$app_strings['LBL_EMAIL_ADDRESS'] = 'E-postadress';
...
$app_strings['LBL_INSIGHTS'] = 'Insikter';
$app_strings['LBL_CHARTS'] = 'Diagram';
$app_strings['LBL_CHART_NOT_FOUND'] = 'Diagram hittades inte';
$app_strings['LBL_NO_DATA'] = 'Inget data';
$app_strings['LBL_ERROR_FETCHING_METADATA'] = 'Ett fel uppstod vid hämtning av metadata';
$app_strings['LBL_TOTAL'] = 'Summa';
$app_strings['LBL_ACTIONS'] = 'Åtgärder';
$app_strings['LBL_SELECT_SUBPANEL_BANNER'] = 'Välj vilka underpaneler som ska visas';
$app_strings['LBL_SELECT_ITEM'] = 'Välj ett objekt';
$app_strings['LBL_ITEMS_SELECTED'] = 'valda objekt';
$app_strings['LBL_WIDGET_NOT_FOUND'] = 'Sidkomponent kunde inte hittas';
$app_strings['LBL_BAD_CONFIG'] = 'Felaktig konfiguration';
$app_strings['LBL_CONFIG_BAD_CONTEXT'] = 'Felaktig konfiguration: kontexten är inte korrekt konfigurerad';
$app_strings['LBL_CONFIG_NO_CONFIG'] = 'Felaktig konfiguration: saknad konfiguration';
$app_strings['LBL_CONFIG_NO_STATISTICS_KEY'] = 'Felaktig konfiguration: nyckel för saknad statistik';
$app_strings['LBL_STATISTIC_ERROR'] = 'Fel vid inläsning av statistik';
$app_strings['LBL_STATISTIC_ERROR_DESC'] = 'Fel vid inläsning av statistik';
$app_strings['LBL_STATISTIC_ERROR_DESC_TOOLTIP'] = 'Fel vid inläsning av statistik. Kontakta administratören';
$app_strings['LBL_AVERAGE_CLOSED_WON_PER_YEAR'] = 'Genomsnittligt Vunna Möjligheter Per År';
$app_strings['LBL_OPPORTUNITIES_TOTAL'] = 'Totalt Möjlighetsvärde';
$app_strings['LBL_CASE_TOTAL_DAYS_OPEN'] = 'Totalt antal dagar öppna';
$app_strings['LBL_DAYS_OPEN'] = 'Dagar öppna';
$app_strings['LBL_DAYS_IN_SALE_STAGE'] = 'DAG(AR) SOM DEN HÄR AFFÄRSMÖJLIGHETEN HAR VARIT I DET HÄR FÖRSÄLJNINGSSTEGET';
$app_strings['LBL_STAT_DAYS'] = 'Dag(ar)';
$app_strings['LBL_CLOSED_PER_YEAR'] = 'Stängt per år';
$app_strings['LBL_WAS_OPEN'] = 'Detta ärende var öppet för';
$app_strings['LBL_HAS_BEEN_OPEN'] = 'Detta ärende var öppet för';
$app_strings['LBL_NUMBER_OF_CASES_PER_ACCOUNT'] = 'Antal ärenden per konto';
$app_strings['LBL_TOTAL_CASES_FOR_THIS_ACCOUNT'] = 'Totalt antal ärenden för det här kontot';
$app_strings['LBL_NONE_OUTSTANDING'] = 'Ingen';
$app_strings['LBL_VALIDATION_ERROR_REQUIRED'] = 'Obligatoriskt fält saknas: {{fields.field.label}}';
$app_strings['LBL_VALIDATION_ERROR_ATTACHMENT'] = 'En eller flera filbilagor är ogiltiga.';
$app_strings['LBL_VALIDATION_ERROR_CURRENCY_FORMAT'] = "Ogiltigt valutaformat. Förväntat: '{{context.expected}}'";
$app_strings['LBL_VALIDATION_ERROR_INT_FORMAT'] = "Otillåtet heltalsformat. Förväntade: '{{context.expected}}'";
$app_strings['LBL_VALIDATION_ERROR_FLOAT_FORMAT'] = "Otillåtet flyttalsformat. Förväntade: '{{context.expected}}'";
$app_strings['LBL_VALIDATION_ERROR_DATE_FORMAT'] = "Otillåtet datumformat. Förväntade: '{{context.expected}}'";
$app_strings['LBL_VALIDATION_ERROR_DATETIME_FORMAT'] = "Otillåtet datum/tidsformat. Förväntade: '{{context.expected}}'";
$app_strings['LBL_VALIDATION_ERROR_UNSUBSCRIBE_LINK'] = "Icke-transaktionella e-postmeddelanden måste innehålla en avregistreringslänk. Lägg till en spårningslänk för avregistrering, '{{ unsubscribe_link }}' eller välj ikonen: ";
$app_strings['LBL_VALIDATION_ERROR_REMOVE_UNSUBSCRIBE_LINK'] = "Transaktionella e-postmeddelanden får inte innehålla en avregistreringslänk. Ta bort '{{ unsubscribe_link }}'";
$app_strings['LBL_VALIDATION_ERROR_EMAIL_FORMAT'] = "Otillåtet e-postformat. Förväntade: '{{context.expected}}'";
$app_strings['LBL_VALIDATION_ERROR_PHONE_FORMAT'] = "Ogiltigt telefonnummer.";
$app_strings['LBL_VALIDATION_ERROR_MIN'] = "Ogiltigt värde. Värdet måste vara större än eller lika med '{{context.min}}'";
$app_strings['LBL_VALIDATION_ERROR_VERSIONING'] = "Ogiltigt format. Förväntat: '{{context.expected}}'";
$app_strings['LBL_VALIDATION_ERROR_MAX'] = "Ogiltigt värde. Värdet måste vara mindre än eller lika med '{{context.max}}'";
$app_strings['LBL_MULTIPLE_PRIMARY_EMAIL_VALIDATION_ERROR'] = "Endast en giltig e-postadress ska vara markerad som primär";
$app_strings['LBL_DUPLICATE_EMAIL_VALIDATION_ERROR'] = "Flera poster med samma e-postadress är inte tillåtna";
$app_strings['LBL_NO_PRIMARY_EMAIL_VALIDATION_ERROR'] = "En giltig e-postadress ska vara markerad som primär";
$app_strings['LBL_NO_EM_ID'] = 'Det gick inte att hämta e-postmarknadsförings-ID';
$app_strings['LBL_VALIDATION_ERRORS'] = 'Det finns valideringsfel, kan inte utföra åtgärder.';
$app_strings['LBL_LOADING_IN_PROGRESS'] = 'Beräkningen pågår. Vänta en stund innan du försöker igen.';
$app_strings['LBL_SELECT_EMAIL_FOR_TEST'] = 'Välj mål/användare eller ange en e-postadress';
$app_strings['LBL_TYPE_TO_SEARCH'] = 'Skriv för att söka...';
$app_strings['LBL_SEARCHING'] = 'söker...';
$app_strings['LBL_NOT_FOUND'] = 'Hittades inte.';
$app_strings['LBL_SEARCH_ERROR'] = 'Fel vid sökning.';
$app_strings['LBL_FOUND'] = 'Hittad';
$app_strings['LBL_GET_RECORD_LIST_ERROR'] = 'Ett fel uppstod vid hämtning av poster';
$app_strings['LBL_NUMBER_OF_RECORDS'] = 'Antal poster';
...
$app_strings['LBL_CONTRACT_RENEWAL_TOOLTIP'] = 'Datum för nästa kontraktsförnyelse';
$app_strings['LBL_INVOICES_OVERDUE_TOOLTIP'] = 'Totalt antal förfallna fakturor';
$app_strings['LBL_ACTIVITIES_NEXT_DATE_TOOLTIP'] = 'Datum för nästa interaktion';
$app_strings['LBL_CAMPAIGN_LAST_RECEIVED_TOOLTIP'] = 'Datum för den senaste mottagna kampanjen';
$app_strings['LBL_OPEN_CASES_COUNT_TOOLTIP'] = 'Totalt antal öppna fall';
$app_strings['LBL_EVENTS_LAST_DATE_TOOLTIP'] = 'Datum för den senaste händelsen';
$app_strings['LBL_HISTORY_LAST_DATE_TOOLTIP'] = 'Datum för den senaste interaktionen';
$app_strings['LBL_OPPORTUNITIES_TOTAL_SUM_TOOLTIP'] = 'Totalt antal möjligheter';
$app_strings['LBL_QUOTES_EXPIRY_TOOLTIP'] = 'Datum för nästa offerts förfallodatum';
$app_strings['LBL_DEFAULT_TOTAL_TOOLTIP'] = 'Totalt antal poster';
$app_strings['LBL_CONTRACT_RENEWAL'] = 'Förnyelsedatum';
$app_strings['LBL_INVOICES_OVERDUE'] = 'Totalt försenat';
$app_strings['LBL_ACTIVITIES_NEXT_DATE'] = 'Datum för nästa aktivitet';
$app_strings['LBL_CAMPAIGN_LAST_RECEIVED'] = 'Senast medverkande';
$app_strings['LBL_OPEN_CASES_COUNT'] = 'Öppna fall';
$app_strings['LBL_EVENTS_LAST_DATE'] = 'Deltog senast i event';
$app_strings['LBL_HISTORY_LAST_DATE'] = 'Senaste interaktion';
...
$app_strings['LBL_CASE_UPDATES'] = 'Händelse uppdatering';
$app_strings['LBL_CASE_UPDATE_SUBMITTED'] = 'Uppdatering gjord';
...
$app_strings['LBL_CREATE'] = 'Skapa';
$app_strings['LBL_CLEAR_FILTER'] = 'Rensa filter';
$app_strings['LBL_QUICK_FILTERS'] = 'Snabbfilter';
$app_strings['LBL_SAVED_FILTER_SAVED'] = 'Filtret sparats';
$app_strings['LBL_FILTER_ID_NOT_DEFINED'] = 'Filter-id inte definierad';
$app_strings['LBL_GENERIC_CONFIRMATION'] = 'Vill du fortsätta med åtgärden?';
$app_strings['LBL_SHOW_MORE'] = 'Visa mer';
$app_strings['LBL_SHOW_LESS'] = 'Visa mindre';
$app_strings['LBL_LOAD_MORE'] = 'Ladda mer';
$app_strings['LBL_EMPTY'] = '-- Tom --';
$app_strings['LBL_OPERATOR'] = 'Operatör';
$app_strings['LBL_START'] = 'Starta';
$app_strings['LBL_END'] = 'Slut';
$app_strings['LBL_LINE_ITEMS_FIELD_CONFIG'] = 'Felaktig konfiguration';


$app_strings['LBL_ACTION_SUCCESS'] = 'Åtgärden lyckades';

$app_strings['LBL_YES'] = 'Ja';
$app_strings['LBL_NO'] = 'Nej';

$app_list_strings['sort_order'] = [];
$app_list_strings['sort_order']['asc'] = 'Stigande';
$app_list_strings['sort_order']['desc'] = 'Fallande';

// Labels used by subpanel unlink relationship process
$app_strings['LBL_LINK'] = 'Länka';
$app_strings['LBL_LINK_UNLINK'] = 'Länka/avlänka';
$app_strings['LBL_SAVE'] = 'Spara';
$app_strings['LBL_UNLINK_RECORD'] = 'Avlänka post';
$app_strings['LBL_DELETE_RECORD'] = 'Ta bort post';
$app_strings['LBL_EDIT_RECORD'] = 'Redigera post';
$app_strings['LBL_UNLINK_RELATIONSHIP_CONFIRM'] = 'Är du säker på att du vill avlänka denna post? Endast relationen kommer att kopplas bort. Posten kommer inte att raderas.';
$app_strings['LBL_UNLINK_RELATIONSHIP_SUCCESS'] = 'Posterna är inte längre länkade.';
$app_strings['LBL_UNLINK_RELATIONSHIP_FAILED'] = 'Det uppstod ett fel vid avlänkning av posten.';
$app_strings['LBL_ALL_RECORDS_UNLINKED'] = 'Alla poster har avlänkats';
$app_strings['LBL_SOME_RECORDS_UNLINKED_FAILED'] = 'Vissa poster kunde inte avlänkas. Mer information finns i loggarna.';
$app_strings['LBL_LINK_RELATIONSHIP_SUCCESS'] = 'Förhållandet kopplat framgångsrikt.';
$app_strings['LBL_LINK_RELATIONSHIP_FAILED'] = 'Det gick inte att länka denna relation.';
$app_strings['LBL_MODULE_NOT_FOUND'] = 'Modulen hittades inte.';
$app_strings['LBL_RECORD_NOT_FOUND'] = 'Det går inte att ladda post';
$app_strings['LBL_FILE_NOT_FOUND'] = 'Det gick inte att läsa in filen';
$app_strings['LBL_RELATIONSHIP_LOAD_ERROR'] = 'Det går inte att ladda relation';
$app_strings['LBL_NOT_LINKED'] = 'Det går inte att avlänka. Poster är inte länkade';
$app_strings['LBL_ACCESS_DENIED'] = 'Åtkomst nekad';
$app_strings['LBL_ADD_RECORDS_TO_TARGET_LIST_SUCCESS'] = 'Poster lades till i mållistan.';
$app_strings['LBL_ADD_RECORDS_TO_TARGET_LIST_FAILED'] = 'Det gick inte att lägga till poster i mållistan.';
$app_strings['LBL_ADD_CONTACTS_TO_TARGET_LIST_SUCCESS'] = 'Kontakter lades till i mållistan.';
$app_strings['LBL_ADD_CONTACTS_TO_TARGET_LIST_FAILED'] = 'Det gick inte att lägga till kontakter i mållistan.';
$app_strings['LBL_CHANGED_TO_TEXT'] = 'ändrad till';
$app_strings['LBL_RECORD_CHANGED'] = 'Post uppdaterad';
$app_strings['LBL_CREATE'] = "Skapa";
$app_strings['LBL_USE_ADVANCED_SEARCH'] = 'Använd avancerad sök';
$app_strings['LBL_USE_BASIC_SEARCH'] = 'Använd enkel sök';
$app_strings['LBL_NO_MODULE_SELECTED'] = 'Ingen modul markerad';
$app_strings['LBL_CLOSE_MENU'] = 'Stäng menyn';
$app_strings['LOGIN_INCORRECT'] = 'Felaktiga inloggningsuppgifter. Försök igen.';
$app_strings['LOGIN_TOO_MANY_FAILED'] = 'För många misslyckade inloggningsförsök. Försök igen senare.';
...
$app_strings['LBL_NEW_NOTIFICATION'] = "Du har {{context.unread}} nya aviseringar";
$app_strings['LBL_ALERT_STATUS_COMPLETED'] = 'Slutförd';
$app_strings['LBL_ALERT_STATUS_COMPLETED_WITH_FAILURES'] = 'Slutförd med fel';
$app_strings['LBL_ALERT_STATUS_FAILED'] = 'Misslyckades';
$app_strings['LBL_NOTIFICATION_ITEM_DATE'] = 'Förfallodatum: {{fields.date_start.value}}';
$app_strings['LBL_NOTIFICATION_ITEM_DATE_ENTERED'] = 'Aviserad: {{fields.snooze.value}}';
$app_strings['LBL_QUICK_ACTIONS'] = 'Snabbåtgärder';
$app_strings['LBL_RELATIONSHIPS'] = 'Relationer';
$app_strings['LBL_SHOW_CC'] = 'Visa Cc';
$app_strings['LBL_SHOW_BCC'] = 'Visa Bcc';
$app_strings['LBL_CC'] = 'Cc';
$app_strings['LBL_BCC'] = 'Bcc';
$app_strings['LNK_NEW_EMAIL'] = 'Ny e-post';
$app_strings['LBL_INSERT_TEMPLATE'] = 'Infoga mall';
$app_strings['LBL_MISSING_RECORD_DATA'] = 'Saknade postdata';
$app_strings['LBL_MISSING_FIELDS_DATA'] = 'Saknade fältdata';
$app_strings['LBL_WRONG_MODULE_PROVIDED'] = 'Fel modul har angetts';
$app_strings['LBL_NO_TEMPLATE_ID_PROVIDED'] = 'Inget mall-ID har angetts';
$app_strings['LBL_TEMPLATE_NOT_FOUND'] = 'Mallen hittades inte';
$app_strings['LBL_EMAIL_MODAL_DYNAMIC_TITLE'] = 'Ny e-post{{fields.name.value|prefix:\' - \'}}';
$app_strings['LBL_EMAIL_MODAL_DRAFT_DYNAMIC_TITLE'] = 'Utkast{{fields.name.value|prefix:\' - \'}}';
$app_strings['LBL_CLOSE_EMAIL_MODAL'] = 'Vill du kasta det här e-postmeddelandet? (Ändringarna går förlorade)';
$app_strings['LBL_RELATED_TO_DYNAMIC'] = '{{fields.parent_type.value|uppercase}}';
$app_strings['LBL_RELATED_TO'] = 'Relaterad till';
...
$app_strings['LBL_SMALL'] = 'Liten';
$app_strings['LBL_MEDIUM'] = 'Medel';
$app_strings['LBL_NORMAL'] = 'Normal';
$app_strings['LBL_LARGE'] = 'Stor';
$app_strings['LBL_HUGE'] = 'Mycket stor';
$app_strings['LBL_DEFAULT'] = 'Standard';
$app_strings['LBL_APPLY'] = 'Tillämpa';
$app_strings['LBL_INSERT_LINK_URL_DESCRIPTION'] = 'Infoga URL eller e-postadress:';
$app_strings['LBL_INSERT_LINK_PLACEHOLDER'] = 't.ex.: https://www.example.com';

$app_strings['LBL_COLOR_BLACK'] = 'Svart';
$app_strings['LBL_COLOR_FIREBRICK'] = 'Eldtegelröd';
$app_strings['LBL_COLOR_RED'] = 'Röd';
$app_strings['LBL_COLOR_SALMON'] = 'Laxrosa';
$app_strings['LBL_COLOR_BLUSH'] = 'Rosig';
$app_strings['LBL_COLOR_DARK_RED'] = 'Mörkröd';
$app_strings['LBL_COLOR_BROWN'] = 'Brun';
$app_strings['LBL_COLOR_DARK_ORANGE'] = 'Mörkorange';
$app_strings['LBL_COLOR_ORANGE'] = 'Orange';
$app_strings['LBL_COLOR_ANTIQUE_WHITE'] = 'Antikvit';
$app_strings['LBL_COLOR_SADDLE_BROWN'] = 'Sadelbrun';
$app_strings['LBL_COLOR_GOLDENROD'] = 'Gyllene';
$app_strings['LBL_COLOR_GOLD'] = 'Guld';
$app_strings['LBL_COLOR_YELLOW'] = 'Gul';
$app_strings['LBL_COLOR_LIGHT_YELLOW'] = 'Ljusgul';
$app_strings['LBL_COLOR_DARK_SLATE_GRAY'] = 'Mörk skiffergrå';
$app_strings['LBL_COLOR_DARK_GREEN'] = 'Mörkgrön';
$app_strings['LBL_COLOR_GREEN'] = 'Grön';
$app_strings['LBL_COLOR_LIME'] = 'Limegrön';
$app_strings['LBL_COLOR_HONEYDEW'] = 'Honungsdagg';
$app_strings['LBL_COLOR_TEAL'] = 'Blågrön';
$app_strings['LBL_COLOR_TURQUOISE'] = 'Turkos';
$app_strings['LBL_COLOR_AQUA'] = 'Aqua';
$app_strings['LBL_COLOR_PALE_TURQUOISE'] = 'Ljusturkos';
$app_strings['LBL_COLOR_AZURE'] = 'Azurblå';
$app_strings['LBL_COLOR_NAVY_BLUE'] = 'Marinblå';
$app_strings['LBL_COLOR_MEDIUM_BLUE'] = 'Mellanblå';
$app_strings['LBL_COLOR_BLUE'] = 'Blå';
$app_strings['LBL_COLOR_LIGHT_BLUE'] = 'Ljusblå';
$app_strings['LBL_COLOR_ALICE_BLUE'] = 'Aliceblå';
$app_strings['LBL_COLOR_INDIGO'] = 'Indigo';
$app_strings['LBL_COLOR_PATRIARCH_PURPLE'] = 'Patriarklila';
$app_strings['LBL_COLOR_VIOLET_PURPLE'] = 'Violettlila';
$app_strings['LBL_COLOR_PLUM'] = 'Plommonlila';
$app_strings['LBL_COLOR_LAVENDER'] = 'Lavendel';
$app_strings['LBL_COLOR_DIM_GRAY'] = 'Dämpad grå';
$app_strings['LBL_COLOR_GRAY'] = 'Grå';
$app_strings['LBL_COLOR_DARK_GRAY'] = 'Mörkgrå';
$app_strings['LBL_COLOR_LIGHT_GRAY'] = 'Ljusgrå';
$app_strings['LBL_COLOR_WHITE'] = 'Vit';

$app_strings['LBL_BOLD'] = 'Fet';
$app_strings['LBL_ITALIC'] = 'Kursiv';
$app_strings['LBL_INSERT_TEMPLATE_VARIABLE'] = 'Infoga variabel';
$app_strings['LBL_UNDERLINE'] = 'Understruken';
$app_strings['LBL_STRIKETHROUGH'] = 'Genomstruken';
$app_strings['LBL_FONT_FACE'] = 'Typsnitt';
$app_strings['LBL_TEXT_SIZE'] = 'Textstorlek';
$app_strings['LBL_TEXT_COLOR'] = 'Textfärg';
$app_strings['LBL_TEXT_HIGHLIGHT'] = 'Textmarkering';
$app_strings['LBL_LINK'] = 'Länka';
$app_strings['LBL_UNORDERED_LIST'] = 'Punktlista';
$app_strings['LBL_ORDERED_LIST'] = 'Numrerad lista';
$app_strings['LBL_QUOTE'] = 'Citat';
$app_strings['LBL_UNQUOTE'] = 'Ta bort citat';
$app_strings['LBL_ALIGN'] = 'Justera';
$app_strings['LBL_ALIGN_LEFT'] = 'Vänster';
$app_strings['LBL_ALIGN_CENTER'] = 'Centrera';
$app_strings['LBL_ALIGN_RIGHT'] = 'Höger';
$app_strings['LBL_JUSTIFY'] = 'Marginaljustera';
$app_strings['LBL_TEXT_LEFT_TO_RIGHT'] = 'Textriktning: vänster till höger';
$app_strings['LBL_TEXT_RIGHT_TO_LEFT'] = 'Textriktning: höger till vänster';
$app_strings['LBL_CLEAR_FORMATTING'] = 'Rensa formatering';
$app_strings['LBL_INJECT_UNSUBSCRIBE'] = 'Avregistreringslänk';
$app_strings['LBL_TEXT_INDENT_LEFT'] = 'Minska indrag';
$app_strings['LBL_TEXT_INDENT_RIGHT'] = 'Öka indrag';

// Day and Time labels
$app_strings['LBL_SUN'] = 'Söndag';
$app_strings['LBL_MON'] = 'Måndag';
$app_strings['LBL_TUE'] = 'Tisdag';
$app_strings['LBL_WED'] = 'Onsdag';
$app_strings['LBL_THU'] = 'Torsdag';
$app_strings['LBL_FRI'] = 'Fredag';
$app_strings['LBL_SAT'] = 'Lördag';
$app_strings['LBL_ALL'] = 'Varje dag';
$app_strings['LBL_EVERY'] = 'Varje';
$app_strings['LBL_ON_THE'] = 'Den';
$app_strings['LBL_RANGE'] = 'till';
$app_strings['LBL_FROM'] = 'Från';
$app_strings['LBL_AND'] = 'och';
$app_strings['LBL_MINS'] = 'Min';
$app_strings['LBL_MINUTES'] = 'minuter';
$app_strings['LBL_HOUR'] = 'timmar';
$app_strings['LBL_HOUR_SING'] = 'timme';
$app_strings['LBL_OFTEN'] = 'Så ofta som möjligt.';
$app_strings['LBL_MIN_MARK'] = 'minutmarkering';
$app_strings['LBL_INBOUND_EMAIL'] = 'Inkommande e-post';

$app_strings['LBL_LEGEND'] = 'Förklaring';

$app_strings['LBL_EMAIL_MARKETING_NOT_UNSCHEDULED'] = 'E-postmarknadsföringen kan inte schemaläggas eftersom den inte är avschemalagd';
$app_strings['LBL_INCORRECT_RECORD_ID'] = 'Felaktigt post-ID';

$app_strings['LBL_TEST_ENTRIES_DELETED'] = 'Testposter har tagits bort.';
$app_strings['LBL_UNABLE_TO_GET_ID'] = 'Det gick inte att hämta ID:t för e-postmarknadsföringen';
$app_strings['LBL_UNABLE_TO_DELETE_TEST_ENTRIES'] = 'Det gick inte att ta bort testposterna. Mer information finns i loggarna';
$app_strings['LBL_SECTION_KEY_NOT_DEFINED'] = 'Sektionsnyckel har inte definierats';
$app_strings['LBL_DOES_BOUNCE_EXIST'] = 'Finns det ett studsmeddelande?';
$app_strings['LBL_IS_OUTBOUND_CONNECTED'] = 'Är utgående e-post ansluten?';
$app_strings['LBL_CAMPAIGN_SETTINGS'] = 'Inställningar';
...
$app_strings['LBL_CRON_LAST_RUN'] = 'Senaste lyckade körning';
$app_strings['LBL_CRON_LAST_USER_TO_RUN'] = 'Senaste användare som körde schemaläggarna';
$app_strings['LBL_LAST_RUN_VALUE'] = '{{ fields.lastRun.value }}';
$app_strings['LBL_LAST_USER_RUN_VALUE'] = '{{ fields.user.value }}';
$app_strings['LBL_RUN_USER_INVALID'] = 'Den här användaren ingår inte i konfigurationsinställningen `allowed_cron_users`. Därför lyckades inte den senaste körningen';
$app_strings['LBL_SCHEDULERS_NEVER_RUN'] = 'Schemaläggarna har aldrig körts.';
$app_strings['LBL_MARKETING_ITEMS_PER_RUN'] = 'Antal marknadsföringsobjekt per körning';
$app_strings['LBL_EMAILS_PER_RUN'] = 'Antal kampanjmeddelanden per körning';
$app_strings['LBL_TRACKERS_ENABLED'] = 'Spårning aktiverad';
$app_strings['LBL_TRACKER_LINKS_ENABLED'] = 'Spårningslänkar aktiverade';
...
$app_strings['LBL_EMAILS_MAX_RETRIES'] = 'Maximalt antal försök för kampanjmeddelanden';
$app_strings['LBL_EMAILS_MAX_RETRIES_DYNAMIC_LABEL'] = '{{ fields.campaign_emails_max_retries.value }}';
$app_strings['LBL_EMAILS_THRESHOLD'] = 'Feltröskel per batch för kampanjmeddelanden';
...
$app_strings['LBL_UNSUBSCRIBE'] = 'Avregistrera';
$app_strings['LBL_INACTIVE'] = 'Inaktiv';
$app_strings['LBL_DISPLAYING_TEST_EMAIL_MARKETING_DATA'] = 'Diagram och underpaneler visar för närvarande data som genererats från testmeddelanden.';
$app_strings['LBL_DASH_SYMBOL'] = '-';
$app_strings['LBL_FIELD_STORAGE_NOT_SET'] = 'Fillagringstypen är inte angiven för fältet. Det går inte att ladda upp filen.';
$app_strings['LBL_FIELD_STORAGE_INVALID_TYPE'] = 'Fillagringstypen är inte giltig för fältet. Det går inte att ladda upp filen.';
$app_strings['LBL_UPLOAD'] = 'Ladda upp';
$app_strings['LBL_UPLOAD_FAILED'] = 'Uppladdningen misslyckades. Försök igen senare';
$app_strings['LBL_UPLOADING'] = 'Laddar upp';
$app_strings['LBL_UPLOAD_FROM_FILES'] = 'Ladda upp från filer';
$app_strings['LBL_ATTACH_DOCUMENTS'] = 'Bifoga dokument';
$app_strings['LBL_FILE_FIELD_UPLOAD_BUTTON_DESCRIPTION'] = 'Klicka eller dra en fil hit för att ladda upp den';
$app_strings['LBL_ATTACHMENTS_FIELD_UPLOAD_BUTTON_DESCRIPTION'] = 'Dra och släpp en fil här för att ladda upp den';
$app_strings['LBL_SOME_ATTACHMENTS_FAILED'] = 'Vissa bilagor kunde inte laddas upp. Mer information finns i loggarna.';
$app_strings['LBL_UPLOAD_IMAGE'] = 'Ladda upp bild';
$app_strings['LBL_DOWNLOAD_IMAGE'] = 'Hämta bild';
$app_strings['LBL_PREVIEW_IMAGE'] = 'Förhandsvisa bild';
$app_strings['LBL_UPLOAD_IMAGE_DESCRIPTION'] = 'Klicka eller dra en bild hit för att ladda upp den';
$app_strings['LBL_INVALID_PROCESS_OPTIONS'] = 'Ogiltiga processalternativ. Mer information finns i loggarna.';
$app_strings['LBL_TEMPORARY'] = 'Tillfällig';
$app_strings['LBL_MAX_FILE_SIZE_EXCEEDED'] = 'Filen överskrider den högsta tillåtna storleken.';
$app_strings['LBL_UNSUPPORTED_IMAGE_TYPE'] = 'Bildtypen stöds inte.';
$app_strings['LBL_UNSUPPORTED_FILE_TYPE'] = 'Filtypen stöds inte.';
$app_strings['LBL_UNSUPPORTED_IMAGE_FILE_TYPE'] = 'Den här bildtypen stöds inte.';
$app_strings['LBL_MALWARE_DETECTED'] = 'Skadlig programvara upptäcktes i den uppladdade filen. Uppladdningen har avvisats.';

$app_strings['LBL_DEFAULT_OUTBOUND_NOT_SET'] = 'Det gick inte att hämta standardkontot för utgående e-post';
$app_strings['LBL_SMTP_UNABLE_TO_CONNECT']='Det går inte att ansluta till SMTP-servern med de aktuella inställningarna för utgående e-post.';
$app_strings['LBL_DEFAULT_OUTBOUND_NOT_CONFIGURED'] = 'Kontot för utgående e-post är inte korrekt konfigurerat.';

$app_strings['LBL_CRON_UNRECOMMENDED_USER'] = 'Du kör för närvarande som root. Det rekommenderas inte. Vill du fortsätta (y,n)? ';
$app_strings['LBL_UNKNOWN_USER'] = 'Okänd användare';

$app_strings['LBL_DRAFTS'] = 'Utkast';
$app_strings['LBL_DRAFT_ITEM_LAST_MODIFIED'] = '{{fields.date_modified.value}}';
$app_strings['LBL_DRAFT_ITEM_TO_EMPTY'] = 'Inga mottagare';
...
$app_strings['LBL_DRAFTS_DELETED_SUCCESSFULLY'] = 'Utkast har tagits bort.';
$app_strings['LBL_DRAFT_DELETED_SUCCESSFULLY'] = 'Utkastet har tagits bort.';
$app_strings['LBL_DRAFTS_DELETED_UNSUCCESSFULLY'] = 'Det gick inte att ta bort utkasten. Mer information finns i loggarna.';
$app_strings['LBL_DRAFT_DELETED_UNSUCCESSFULLY'] = 'Det gick inte att ta bort utkastet. Mer information finns i loggarna.';
$app_strings['LBL_OPEN_DRAFT'] = 'Öppna utkast';
$app_strings['LBL_DELETE_DRAFT'] = 'Ta bort utkast';
$app_strings['LBL_UNABLE_TO_GET_DRAFT_ID'] = 'Det gick inte att hämta utkastets ID.';
$app_strings['LBL_UNABLE_TO_DELETE_DRAFT'] = 'Det gick inte att ta bort utkastet.';
$app_strings['LBL_EMAIL_NOT_DRAFT'] = 'E-postmeddelandet är inte längre ett utkast.';
$app_strings['LBL_DRAFT_DELETED_SUCCESSFULLY'] = 'Utkastet har tagits bort.';

$app_strings['LBL_CANNOT_DELETE_LATEST_REVISION'] = 'Du kan inte ta bort den senaste revisionen av ett dokument.';
$app_strings['LBL_NO_DOCUMENT_ID_PROVIDED'] = 'Det går inte att hitta dokumentet för att ta bort revisionen eftersom inget dokument-ID har angetts.';
$app_strings['LBL_NO_RECORD_ID_PROVIDED'] = 'Det går inte att hitta dokumentrevisionen att ta bort eftersom inget post-ID har angetts.';
$app_strings['LBL_DELETE_REVISION_CONFIRM'] = 'Vill du ta bort den här revisionen?';
$app_strings['LBL_DOCUMENT_NOT_FOUND'] = 'Dokumentet hittades inte.';
$app_strings['LBL_EMAIL_ATTACHMENT_DOCUMENT_DELETED'] = 'Ett eller flera bifogade dokument har tagits bort och kan inte skickas.';

$app_strings['LBL_DISMISS_INVALID_STATUS'] = 'Den här posten kan inte avfärdas medan den fortfarande pågår.';
$app_strings['LBL_DISMISS_FAILED'] = 'Det gick inte att avfärda. Försök igen.';
$app_strings['LBL_RERUN_NOT_ELIGIBLE'] = 'Den här posten kan inte köras igen. Den har kanske inte slutförts med fel, eller så stöds inte omkörning.';
$app_strings['LBL_RETRY_FAILED_NOT_ELIGIBLE'] = 'Den här posten kan inte försökas igen. Den har kanske inte slutförts med fel, eller så stöds inte nytt försök.';
$app_strings['LBL_ASYNC_TASK_UNSUPPORTED_MODULE'] = 'Den här modulen stöder inte asynkrona aktivitetsåtgärder.';
$app_strings['LBL_RERUN_SUCCESS'] = 'Aktiviteten har köats på nytt och startar om från början.';
$app_strings['LBL_RETRY_FAILED_SUCCESS'] = 'Misslyckade objekt har köats på nytt för bearbetning.';

$app_strings['LBL_MIGRATE_GOOGLE_CALENDAR_SYNC_SIBLING_RUNNING'] = 'Den här migreringen kan inte köras medan "Migrate Google Calendar Users Sync" väntar eller körs.';
$app_strings['LBL_MIGRATE_GOOGLE_CALENDAR_SYNC_USERS_SIBLING_RUNNING'] = 'Den här migreringen kan inte köras medan "Migrate Google Calendar Sync" väntar eller körs.';
