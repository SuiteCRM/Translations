...
$mod_strings = array(
    'LBL_MODULE_NAME' => 'Vaata ülesandeid',
    ...
    'LBL_TASK_COMPLETED' => 'See ülesanne on tehtud',
    ...
    'LBL_TASK_INFORMATION' => 'Ülesande ülevaade', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
    'LBL_EDITLAYOUT' => 'Muuda paigutust' /*for 508 compliance fix*/,
    'LBL_HISTORY_SUBPANEL_TITLE' => 'Märkused',
    //For export labels
    'LBL_DATE_DUE' => 'Tähtajal',
