...
$mod_strings = array(
    ...
    'LBL_TIME_AGO' => 'prieš',
// Activity stream
    'CREATED_CONTACT' => 'sukūrė <b>NAUJĄ</b> {0}', // For fusional (inflected) languages: used in the sentence "Administrator created a new contact"
    'CREATED_OPPORTUNITY' => 'sukūrė <b>NAUJĄ</b> {0}', // For fusional (inflected) languages: used in the sentence "Administrator created a new opportunity"
    'CREATED_CASE' => 'sukūrė <b>NAUJĄ</b> {0}', // For fusional (inflected) languages: used in the sentence "Administrator created a new case"
    'CREATED_LEAD' => 'sukūrė <b>NAUJĄ</b> {0}', // For fusional (inflected) languages: used in sentence "Administrator created a new lead"
