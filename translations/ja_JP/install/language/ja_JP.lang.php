...
$mod_strings = array(
    ...
    'ERR_CHECKSYS_CALL_TIME' => 'Allow Call Time Pass Reference がオンになっています (php.iniでOffに設定する必要があります)',
    ...
    'ERR_CHECKSYS_FASTCGI_LOGGING' => 'IIS/FastCGI sapiを使った際の経験から、php.iniファイルのfastcgi.logging を 0にセットしてください。',
    ...
    'ERR_CHECKSYS_JSON_NOT_AVAILABLE' => "SuiteCRMアプリケーションに必要なJSONパーサライブラリに関連する機能が見つかりません。 php.iniでextensionをコメントアウトするか、お使いのPHPのバージョンに応じて適切なバイナリファイルで再コンパイルする必要があるかもしれません。詳細は、PHPマニュアルを参照してください。",
    ...
    'ERR_PERFORM_NO_TCPIP' => '<b>インターネットの接続が検出できませんでした。</b>インターネットに接続されている場合は<a href="https://www.suitecrm.com/">https://www.suitecrm.com/</a>にアクセスして登録を行ってください。SuiteCRMの用途などをお知らせいただくことによって、今後ご要望に沿ったプロダクトを提供するための参考とさせていただきます。',
    ...
    'LBL_DBCONF_SUITE_DB_USER' => 'SuiteCRM データベース ユーザー',
    'LBL_DBCONF_DB_ADMIN_USER' => 'データベース管理者のユーザー名',
    'LBL_DBCONF_DB_ADMIN_PASSWORD' => 'データベース管理者のパスワード',
    'LBL_DBCONF_COLLATION' => '照合順序',
    'LBL_DBCONF_CHARSET' => '文字コードセット',
    'LBL_DBCONF_ADV_DB_CFG_TITLE' => '高度なデータベースの設定',
    ...
    'LBL_LOCALE_NAME_FIRST' => '名',
    'LBL_LOCALE_NAME_LAST' => '姓',
    ...
    'LBL_SITECFG_SUITE_UP_DIRECTIONS' => '選択した場合、システムは定期的にアプリケーションの更新ファイルを確認します。',
    'LBL_SITECFG_SUITE_UP' => '自動的にアップデートをチェック?',
...
$contact_user_link_guid',
    ...
    'LBL_OLD_PHP_MSG' => 'SuiteCRMをインストールするための推奨PHPバージョンは %s <br />必須のPHPバージョンは %s 以上です。<br />お使いのPHPバージョンは %s であり、EOLです: <a href="http://php.net/eol.php">http://php.net/eol.php</a>。<br />PHPのアップグレードをご検討ください。 ',
    'LBL_OLD_PHP_OK' => '私はリスクを認識したうえで、続行を望みます。',

    'LBL_DBCONF_TITLE_USER_INFO_LABEL' => 'アサイン先',
