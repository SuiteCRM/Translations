...
$mod_strings = array(
    ...
    'LBL_CASE_INFORMATION' => '概要', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
