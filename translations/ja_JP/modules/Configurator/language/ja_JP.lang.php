...
$mod_strings = array(
    ...
    'NEW_LOGO_HELP_NO_SPACE' => '画像のファイル形式は .png ファイルまたは .jpg のいずれでも可能です。高さの最大値は 170px、幅の最大値は 450px です。アップロードされた画像すべて、これらの最大サイズに調整されます。',
    ...
    'LBL_LDAP_LEGACY_WARNING' => 'LDAP警告',
    'LBL_LDAP_LEGACY_WARNING_MORE' => 'このLDAP構成は、v4 API認証にのみ使用されます。 LDAPを使用するようにSuiteCRMログインを構成するには、.env.local file に必要な設定を追加します。詳細は LDAP設定ドキュメントを参照してください。',
    ...
    'LBL_LIST_ENTRIES_PER_MODAL' => 'ポップアップレコードリスト',
...
// Wizard
    ...
    'LBL_LOADING' => '読込中...' /*for 508 compliance fix*/,
