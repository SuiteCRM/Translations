...
$mod_strings = array(
    ...
    'LBL_LIST_ASSIGNED_TO_NAME' => '割り当て先',
    'LBL_LIST_MY_CALLS' => 'コール情報',
    'LBL_ASSIGNED_TO_NAME' => '割り当て先',
    'LBL_ASSIGNED_TO_ID' => 'アサインされたユーザー',
    'NOTICE_DURATION_TIME' => '期間は0以上を設定してください。',
    'LBL_CALL_INFORMATION' => '概要', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
    'LBL_REMOVE' => '削除',
    ...
    'LBL_CALLS_RESCHEDULE' => '電話スケジュールを変更する',
