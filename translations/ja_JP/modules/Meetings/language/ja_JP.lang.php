...
$mod_strings = array(
    ...
    'LBL_MEETING_INFORMATION' => '概要', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
    ...
    // for google sync
    'LBL_GSYNC_ID' => 'Google イベントID',
    'LBL_GSYNC_LASTSYNC' => 'Google の同期の最終タイムスタンプ',
);
