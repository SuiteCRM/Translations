...
//e.g. auf Deutsch 'Contacts'=>'Contakten',
    ...
    'moduleList' => array(
        ...
        'Documents' => 'اسناد',
        'DocumentRevisions' => 'تجدنظرهای اسناد',
    ...
    'subpanel_pagination_type' => [
        ...
        'load-more' => 'بارگذاری نتایج بیشتر'
    ],
...
//       it is the key for the default case_relationship_type_dom value
    ...
    'snooze_alert_timer' => array(
        60 => 'تعویق برای ۱ دقیقه',
        300 => 'تعویق برای ۵ دقیقه',
        600 => 'تعویق برای ۱۰ دقیقه',
        900 => 'تعویق برای ۱۵ دقیقه',
        1800 => 'تعویق برای ۳۰ دقیقه',
        3600 => 'تعویق برای ۱ ساعت',
        7200 => 'تعویق برای ۲ ساعت',
        10800 => 'تعویق برای ۳ ساعت',
        18000 => 'تعویق برای ۵ ساعت',
        86400 => 'تعویق برای ۱ روز',
    ),
...
//prospect list type dom
    ...
    'date_range_search_dom' => array(
        ...
        'greater_than' => 'بعد از',
        'less_than' => 'قبل از',
        'last_7_days' => '7روز گذشته',
        'next_7_days' => '7روز آینده',
...
$app_strings = array(
    'LBL_SEARCH_RESULTS_TITLE' => 'نتایج',
    ...
    'LBL_LOGGED_OUT_MESSAGE' => 'شما از سیستم خارج شده‌اید',
    ...
    'LBL_EMAIL_DELETE_ERROR_DESC' => 'شما به این ناحیه دسترسی ندارید. جهت بدست آوردن دسترسی با مدیر سایت خود تماس بگیرید.',
...
(کاربران مک از دکمه کامند و کلیک استفاده نمایند)',
    ...
    'ERR_UNAUTHORIZED_PAGE_ACCESS' => 'شما مجاز به مشاهده این صفحه نیستید. لطفا با مدیر سیستم خود تماس بگیرید.',
    'ERR_UNAUTHORIZED_PAGE_ACCESS_TO_HOME_PAGE' => 'شما مجاز به مشاهده این صفحه نیستید. در حال هدایت به صفحه اصلی...',
    ...
    'LBL_CHARSET' => 'UTF-8',
    'LBL_CHARTS' => 'نمودارها',
    'LBL_QUICK_CHARTS' => 'نمودارهای سریع',
    ...
    'NTC_DISMISS_CONFIRMATION' => 'آیا مطمئن هستید که می‌خواهید این هشدار را رد کنید؟',
    ...
    'LBL_RECORD_DOES_NOT_EXIST' => 'مشکلی در بازیابی اطلاعات وجود داشت. احتمالاً این اطلاعات حذف شده اند یا شما اجازه دسترسی به آنها را ندارید.',
    'LBL_PROFILE' => 'پروفایل',
    'LBL_PROFILE_EDIT' => 'ویرایش مشخصات',
    ...
    'LBL_FILTER' => 'جستجو',
    'LBL_CLEAR_FILTER' => 'پاک کردن فيلتر',
    'LBL_FILTER_MODULES' => 'فیلتر کردن ماژول‌ها',
    'LBL_SEARCH' => 'جستجو',
    'LBL_SEARCH_ALT' => '',
...
"5. Click on the Import option from the Actions menu in the application and choose the file to upload"
   ',
    ...
    'LBL_SEND_DATE' => 'تاریخ ارسال',
    'LBL_SCHEDULE_BUTTON_LABEL' => 'برنامه‌ریزی',
    ...
    'LBL_PROSPECT_LIST_NAME' => 'لیست‌های هدف',

    //List View Column Selector Modal
    'LBL_COLUMN_SELECTOR_DISPLAYED_COLS' => 'DISPLAYED',
    'LBL_COLUMN_SELECTOR_HIDDEN_COLS' => 'مخفی کردن',
...
$app_list_strings['aor_date_type_list']['business_hours'] = 'ساعات کاری';
...
$app_strings['LBL_GANTT_BUTTON_LABEL'] = 'مشاهده‌ی Gantt';
...
$app_strings['LBL_ITEMS_SELECTED'] = 'آيتم‌های انتخابی';
...
$app_strings['AOS_Quotes'] = 'پیش فاکتور';
...
$app_strings['LBL_CLEAR_FILTER'] = 'پاک کردن فيلتر';
...
$app_strings['LBL_CC'] = 'رونوشت';
$app_strings['LBL_BCC'] = 'رونوشت مخفی';
$app_strings['LNK_NEW_EMAIL'] = 'ایمیل جدید';
...
$app_strings['LBL_RELATED_TO'] = 'مربوط به';
...
$app_strings['LBL_NORMAL'] = 'معمولی';
$app_strings['LBL_LARGE'] = 'Large';
$app_strings['LBL_HUGE'] = 'Huge';
$app_strings['LBL_DEFAULT'] = 'پیش‌فرض ';
$app_strings['LBL_APPLY'] = 'اعمال';
...
$app_strings['LBL_QUOTE'] = 'پیش‌فاکتور';
$app_strings['LBL_UNQUOTE'] = 'Unquote';
$app_strings['LBL_ALIGN_LEFT'] = 'چپ';
$app_strings['LBL_ALIGN_CENTER'] = 'Center';
$app_strings['LBL_ALIGN_RIGHT'] = 'سمت راست';
...
// Day and Time labels
$app_strings['LBL_SUN'] = 'یکشنبه';
$app_strings['LBL_MON'] = 'دوشنبه';
$app_strings['LBL_TUE'] = 'سه‌شنبه';
$app_strings['LBL_WED'] = 'چهارشنبه';
$app_strings['LBL_THU'] = 'پنج‌شنبه';
$app_strings['LBL_FRI'] = 'جمعه';
$app_strings['LBL_SAT'] = 'شنبه';
$app_strings['LBL_ALL'] = 'هر روز';
$app_strings['LBL_EVERY'] = 'هر';
$app_strings['LBL_ON_THE'] = 'در ';
$app_strings['LBL_RANGE'] = 'به';
$app_strings['LBL_FROM'] = 'فرستنده';
$app_strings['LBL_AND'] = ' و ';
$app_strings['LBL_MINS'] = 'دقیقه';
$app_strings['LBL_MINUTES'] = 'دقیقه';
$app_strings['LBL_HOUR'] = ' ساعت';
$app_strings['LBL_HOUR_SING'] = ' ساعت';
$app_strings['LBL_OFTEN'] = 'As often as possible.';
$app_strings['LBL_MIN_MARK'] = 'minute mark';
$app_strings['LBL_INBOUND_EMAIL'] = 'ایمیل‌های ورودی';
...
$app_strings['LBL_CAMPAIGN_SETTINGS'] = 'تنطیمات';
...
$app_strings['LBL_INACTIVE'] = 'غیر فعال';
