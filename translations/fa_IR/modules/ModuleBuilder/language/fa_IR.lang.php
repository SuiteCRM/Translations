...
$mod_strings = array(
    ...
    'LBL_HIDEOPTIONS' => 'پنهان کردن گزینه‌ها' /*for 508 compliance fix*/,
    'LBL_DELETE' => 'حذف' /*for 508 compliance fix*/,
    'help' => array(
        'package' => array(
            'create' => 'برای بسته یک <b>نام</b>فراهم کنید. نام باید از حروف الفبا و اعداد باشد و هیچ فاصله‌ای را شامل نشود. (مثال: HR_Management)<br/><br/> شما می‌توانید اطلاعات <b>نویسنده</b> و<b>توضیحات</b> را برای بسته فراهم کنید. <br/><br/>روی <b>ذخیره</b> کلیک کنید تا بسته ایجاد شود.',
            'modify' => 'خواص و اقدامات ممکن برای <b>بسته</b> اینجا ظاهر می شود. <br><br>شما می توانید تغییر <b>نام</b> <b>نویسنده</b> و <b>شرح</b> های بسته و همچنین مشاهده و تمام ماژول های موجود در بسته سفارشی. <br> <br>کلیک کنید <b>ماژول های جدید</b> برای ایجاد یک ماژول برای بسته. <br><br>اگر بسته حاوی حداقل یک ماژول, شما می توانید <b>منتشر</b> و <b>اعزام</b> بسته و همچنین <b>صادرات</b> ساخته شده برنامه در بسته.',
            'name' => 'این <b>نام</b> بسته کنونی است. <br/> <br/> نام شما را وارد کنید باید عدد و الفبایی، شروع با حرف و بدون فاصله باشد. (مثال: HR_Management)',
            ...
            'deploybtn' => '<b>اعزام</b> برای ذخیره اطلاعات همه وارد شده و برای نصب بسته، از جمله تمام ماژول ها در نسخه فعلی را کلیک کنید.',
            'duplicatebtn' => '<b>تکراری</b> کپی محتویات بسته را به بسته بندی جدید و نمایش بسته جدید را کلیک کنید. <br/> <br/> بسته جدید نامی جدید به طور خودکار توسط appending شماره به انتهای نام بسته مورد استفاده برای ایجاد یک های جدید تولید خواهد شد. شما می توانید بسته جدید جدید <b>نام</b> ورود و کلیک کردن روی <b>ذخیره</b> تغییر نام.',
            'exportbtn' => '<b>صادرات</b> به ایجاد فایل زیپ حاوی برنامه های ساخته شده در بسته را کلیک کنید. فایل <br><br>ایجاد یک نسخه قابل نصب بسته ندارد. <br> <br>استفاده از <b>لودر ماژول</b> برای وارد کردن فایل های زیپ و بسته، برنامه ها، از جمله در ساز ماژول ظاهر می شود.',
            'deletebtn' => '<b>حذف</b> این بسته و تمام فایل های مربوط به این بسته حذف را کلیک کنید.',
            ...
            'new_module' => '<b>ماژول های جدید</b> برای ایجاد یک ماژول جدید برای این بسته را کلیک کنید.',
            'key' => 'این 5 حرف، عدد و الفبایی <b>کلید</b> را می توان به پیشوند همه دایرکتوری ها نام کلاس و جداول پایگاه داده برای تمام ماژول ها در بسته بندی فعلی استفاده می شود. <br><br>کلیدی در تلاش برای رسیدن به جدول نام منحصر به فرد استفاده می شود.',
            'readme' => 'کلیک کنید به <b>صفحهی راهنمای ترجمهها</b> متن برای این بسته اضافه کنید. <br><br>صفحهی راهنمای ترجمهها در زمان نصب موجود می باشد.',

        ),
        'main' => array(),
        'module' => array(
            'create' => 'ارائه یک <b>نام</b> برای ماژول. <b>برچسب</b> که به شما ارائه می شوند در بند ناوبری <br/> <br/> برای نمایش نوار ناوبری برای ماژول با چک کردن گزینه <b>ناوبری زبانه</b> را انتخاب کنید. <br/> <br/> سپس نوع ماژول شما می خواهم برای ایجاد را انتخاب کنید. <br/> <br/> نوع الگو را انتخاب کنید. هر قالب یک مجموعه خاص از زمینه و همچنین پوسته های از پیش تعریف شده برای استفاده به عنوان پایه ای برای ماژول خود را شامل. <br/> <br/> ایجاد ماژول <b>ذخیره</b> را کلیک کنید.',
            ...
            'team_security' => 'چک کردن کادر <b>تیم امنیتی</b> تیم امنیتی برای این ماژول را فعال کنید.  <br/> <br/> اگر تیم امنیتی فعال تیم انتخاب رشته می شوند در سوابق در ماژول ',
            'reportable' => 'این جعبه چک کردن این ماژول به گزارش اجرای برابر آن اجازه خواهد داد.',
            'assignable' => 'گذاشتن در این جعبه یک رکورد را در این ماژول به کاربر انتخاب شده اختصاص داده می باشد.',
            ...
            'studio' => 'چک کردن این کادر مدیران برای سفارشی کردن این ماژول در داخل استودیو اجازه می دهد.',
            'audit' => 'این جعبه چک بازرسی را برای این ماژول قادر می خواهد. طوری که مدیران تا به بررسی تاریخچه تغییر می تواند تغییر در بعضی از زمینه ها ثبت خواهد شد.',
            'viewfieldsbtn' => '<b>مشاهده زمینه</b> برای دیدن رشته های مربوط به ماژول و برای ایجاد و ویرایش زمینه های سفارشی را کلیک کنید.',
            'viewrelsbtn' => '<b>مشاهده روابط</b> روابط مربوط به این ماژول را مشاهده و ایجاد روابط جدید کلیک کنید.',
            ...
            'name' => 'این <b>نام</b> از ماژول های فعلی است. <br/> <br/> نام باید عدد و الفبایی و باید شروع با حرف و بدون فاصله باشد. (مثال: HR_Management)',
            'label' => 'این <b>برچسب</b> که در نوار ناوبری برای ماژول ظاهر می شود است. ',
            'savebtn' => 'کلیک کنید <b>ذخیره</b> برای ذخیره تمام اطلاعات وارد شده مربوط به ماژول.',
            ...
            'type_issue' => 'نوع قالب <b>مشکل</b> زمینه مورد و اشکال خاص مانند شماره، وضعیت، اولویت و توضیحات را فراهم می کند. <br/> <br/> با استفاده از این الگو برای ایجاد ماژول های است که شبیه به ماژول های استاندارد موارد و اشکالات.',
            'type_person' => 'نوع قالب <b>فرد</b> فیلدهای مخصوص و منحصر به فرد مانند عنوان اجتماعی، عنوان شغلی، نام، آدرس و شماره تلفن را فراهم می‌کند. <br/><br/>از این قالب برای ایجاد ماژول‌هایی که شبیه به ماژول های استاندارد مخاط‌ب‌ و سرنخ هستند، استفاده کنید.',
            'type_sale' => '<b>فروش</b> نوع قالب زمینه های خاص مانند سرب منبع مرحله مقدار و احتمال به فرصت فراهم می کند. <br/> <br/> این الگو برای ایجاد ماژول های است که شبیه به ماژول فرصت های استاندارد استفاده کنید.',
            'type_file' => 'قالب <b>فایل</b> سند زمینه خاص، مانند نام فایل نوع سند و تاريخ نشر را فراهم می کند. <br><br>استفاده از این الگو برای ایجاد ماژول های است که شبیه به استاندارد ماژول اسناد.',
        ...
        ,
            'savebtn' => '<b>اعزام & ذخیره</b> تغییرات شما را ذخیره و آنها را در ماژول فعال را کلیک کنید.',
        ...
        'studioWizard' => array(
            ...
            'addLayoutHelp' => "جهت ایجاد چیدمان سفارشی برای گروه امنیتی، برای شروع گروه امینیتی و چیدمان مناسب را به منظور کپی کردن از آنها، انتخاب کنید.",
...
//STUDIO2
    ...
    'LBL_DEVELOPER_TOOLS' => 'ابزارهای توسعه دهنده گان',
    ...
    'LBL_NEW_ROW' => 'سطر جدید',
    'LBL_PACKAGE_DELETED' => 'بسته حذف شده',
    ...
    'LBL_TABDEF_TYPE_OPTION_TAB' => 'زبانه',
    ...
    'LBL_TABDEF_COLLAPSE' => 'بستن و جمع کردن',
    ...
    'LBL_DROPDOWN_ITEM_LABEL' => 'نمایش برچسب',
...
//RELATIONSHIPS
    ...
    'LBL_RELATIONSHIP_EDIT' => 'ویرایش وابستگی',
    'LBL_REL_NAME' => 'نام',
    'LBL_REL_LABEL' => 'عنوان',
    'LBL_REL_TYPE' => 'نوع',
    'LBL_RHS_MODULE' => 'ماژول های مربوط',
    'LBL_NO_RELS' => 'بدون روابط',
    'LBL_RELATIONSHIP_ROLE_ENTRIES' => 'شرایط اختیاری',
    'LBL_RELATIONSHIP_ROLE_COLUMN' => 'ستون',
    'LBL_RELATIONSHIP_ROLE_VALUE' => 'مقدار',
...
//STUDIO QUESTIONS
    ...
    'LBL_QUESTION_EDITOR' => 'ابزار را انتخاب کنید.',
...
//SECTION
    'LBL_SECTION_EDLABELS' => 'ویرایش برچسبها',
    'LBL_SECTION_PACKAGES' => 'Packages',
    'LBL_SECTION_PACKAGE' => 'بسته',
    'LBL_SECTION_MODULES' => 'ماژولها',
    'LBL_SECTION_DROPDOWNS' => 'Dropdowns',
    'LBL_SECTION_PROPERTIES' => 'ویژگیها',
    'LBL_SECTION_DROPDOWNED' => 'Edit Dropdown',
    'LBL_SECTION_HELP' => 'کمک',
    'LBL_SECTION_MAIN' => 'اصلی',
    'LBL_SECTION_FIELDEDITOR' => 'ویرایش فیلد',
    'LBL_SECTION_DEPLOY' => 'استقرار',
    'LBL_SECTION_MODULE' => 'ماژول',
//WIZARDS

//LIST VIEW EDITOR
    'LBL_DEFAULT' => 'پیش‌فرض ',
    'LBL_HIDDEN' => 'مخفی',
    'LBL_AVAILABLE' => 'در دسترس',
...
//Manager Backups History
    'LBL_MB_PREVIEW' => 'پیش نمایش',
    'LBL_MB_RESTORE' => 'بازگرداندن',
    'LBL_MB_DELETE' => 'حذف',
...
//BUTTONS
    'LBL_BTN_ADD' => 'ﺍﻓﺰﻭﺩﻥ',
    'LBL_BTN_SAVE' => 'ذخيره',
    'LBL_BTN_SAVE_CHANGES' => 'ذخیره تغییرات',
    'LBL_BTN_DONT_SAVE' => 'دور ریختن تغییرات',
    'LBL_BTN_CANCEL' => 'لغو',
    'LBL_BTN_CLOSE' => 'بستن',
    'LBL_BTN_SAVEPUBLISH' => 'ذخیره و استقرار',
    'LBL_BTN_CLONE' => 'Clone',
    'LBL_BTN_ADDROWS' => 'اضافه کردن ردیف',
    'LBL_BTN_ADDFIELD' => 'افزودن فیلد',
    'LBL_BTN_ADDDROPDOWN' => 'Add Dropdown',
    'LBL_BTN_SORT_ASCENDING' => 'مرتب سازی صعودی',
    'LBL_BTN_SORT_DESCENDING' => 'مرتب سازی نزولی',
    'LBL_BTN_EDLABELS' => 'ویرایش برچسبها',
    ...
    'LBL_BTN_DUPLICATE' => 'متناظر',
    'LBL_BTN_PUBLISH' => 'انتشار',
    'LBL_BTN_DEPLOY' => 'استقرار',
    'LBL_BTN_EXP' => 'برون‌بری',
    'LBL_BTN_DELETE' => 'حذف',
    'LBL_BTN_VIEW_LAYOUTS' => 'View Layouts',
    'LBL_BTN_VIEW_FIELDS' => 'مشاهده فیلدها',
    'LBL_BTN_VIEW_RELATIONSHIPS' => 'مشاهده روابط',
    'LBL_BTN_ADD_RELATIONSHIP' => 'اضافه کردن رابطه',
    'LBL_BTN_RENAME_MODULE' => 'تغییر نام ماژول',
//TABS
...
//ERRORS
    ...
    'ERROR_NO_HISTORY' => 'هیچ پرونده تاریخچه یافت نشد',
    'ERROR_MINIMUM_FIELDS' => 'چیدمان بایستی شامل حداقل یک فیلد باشد',
    'ERROR_GENERIC_TITLE' => 'یک خطا رخ داده است',
    'ERROR_REQUIRED_FIELDS' => 'Are you sure you wish to continue? The following required fields are missing from the layout:  ',


//PACKAGE AND MODULE BUILDER
    'LBL_PACKAGE_NAME' => 'نام بسته:',
    ...
    'LBL_PACKAGE' => 'بسته:',
    'LBL_TYPE' => 'نوع:',
    'LBL_NAV_TAB' => 'نوار پیمایش',
    'LBL_CREATE' => 'ایجاد',
    'LBL_LIST' => 'فهرست',
    'LBL_VIEW' => 'مشاهده',
    'LBL_HISTORY' => 'مشاهده تاریخچه',
    'LBL_RESTORE_DEFAULT' => 'بازیابی به تنظیمات پیش فرض',
...
//EXPORT CUSTOMS
    ...
    'LBL_EC_NAME' => 'نام بسته:',
    'LBL_EC_AUTHOR' => 'مولف:',
    'LBL_EC_DESCRIPTION' => 'توضیحات:',
    'LBL_EC_CHECKERROR' => 'لطفا یک ماژول را انتخاب کنید.',
    'LBL_EC_CUSTOMFIELD' => 'فیلدهای سفارشی',
    ...
    'LBL_EC_EXPORTBTN' => 'برون‌بری',
    'LBL_MODULE_DEPLOYED' => 'ماژول مستقر شده اند.',
...
//JS
    ...
    'LBL_DEPLOY_IN_PROGRESS' => 'استقرار بسته',
...
//CONFIRM
    ...
    'LBL_CONFIRM_DONT_SAVE_TITLE' => 'ذخیره‌ی تغییرات؟',
...
//Revert Module labels
    ...
    'LBL_RESET_MODULE' => 'تنظیم مجدد ماژول',
    'LBL_REMOVE_CUSTOM' => 'حذف شخصی سازی ها',
    'LBL_CLEAR_RELATIONSHIPS' => 'Clear Relationships',
    'LBL_RESET_LABELS' => 'تنظیم مجدد برچسب',
    'LBL_RESET_LAYOUTS' => 'Reset Layouts',
    'LBL_REMOVE_FIELDS' => 'حذف فیلد های سفارشی',
    'LBL_CLEAR_EXTENSIONS' => 'پاک کردن برنامه های افزودنی',
