...
$mod_strings = array(
    //module
    'LBL_MODULE_NAME' => 'اصلاحیه‌ سند',

    'LNK_NEW_DOCUMENT' => 'ایجاد سند',
    'LNK_DOCUMENT_LIST' => 'مشاهده اسناد',

    //vardef labels
    'LBL_REVISION_NAME' => 'شماره اصلاحیه',
    'LBL_FILENAME' => 'فایل:',
    'LBL_MIME' => 'نوع Mime',
    ...
    //document revisions.
    'LBL_REV_LIST_REVISION' => 'تجدید نظر',
    'LBL_REV_LIST_ENTERED' => 'تاریخ ایجاد',
    'LBL_REV_LIST_CREATED' => 'ایجاد کننده',
    'LBL_REV_LIST_LOG' => 'سوابق تغییرات',
    'LBL_REV_LIST_FILENAME' => 'فایل',

    'LBL_CURRENT_DOC_VERSION' => 'آخزین ثجدید نظر:',
    ...
    'LNK_NEW_MAIL_MERGE' => 'ادغام ایمیل',
