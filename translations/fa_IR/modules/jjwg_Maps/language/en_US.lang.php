...
$mod_strings['LBL_MODULE_TYPE'] = 'نوع ماژول برای نمایش:';
$mod_strings['LBL_DISTANCE'] = 'فاصله (شعاع):';
$mod_strings['LBL_UNIT_TYPE'] = 'نوع واحد:';
...
$mod_strings['LBL_CONFIG_ADDRESS_TYPE_FOR_ACCOUNTS'] = 'نوع نشانی برای مراکز:';
$mod_strings['LBL_CONFIG_ADDRESS_TYPE_FOR_CONTACTS'] = 'نوع آدرس برای مخاطب‌ها:';
$mod_strings['LBL_CONFIG_ADDRESS_TYPE_FOR_LEADS'] = 'نوع آدرس برای سرنخ‌‎ها:';
$mod_strings['LBL_CONFIG_ADDRESS_TYPE_FOR_OPPORTUNITIES'] = 'Address Type for Opportunities:';
$mod_strings['LBL_CONFIG_OF_RELATED_ACCOUNT'] = '(از مرکز مرتبط)';
...
$mod_strings['LBL_CONFIG_OF_RELATED_ACCOUNT_OPPORTUNITY'] = '(از مرکز/فرصت مرتبط)';
...
$mod_strings['LBL_CONFIG_GROUP_FIELD_FOR_LEADS'] = 'گروه‌بندی برای سرنخ‌ها:';
...
$mod_strings['LBL_CONFIG_GEOCODING_SETTINGS_TITLE'] = 'تنظیمات geocoding در گوگل:';
...
$mod_strings['LBL_CONFIG_MARKER_MAPPING_SETTINGS_TITLE'] = 'تنظیمات نشانگر/نقشه برداری:';
