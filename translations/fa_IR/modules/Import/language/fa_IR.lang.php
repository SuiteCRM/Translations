...
$mod_strings = array(
    'LBL_RECORDS_SKIPPED_DUE_TO_ERROR' => 'ردیف‌ها به دلیل خطا درون‌ریزی نشدند',
    'LBL_UPDATE_SUCCESSFULLY' => 'سوابق با موفقیت به روز رسانی شدند',
    'LBL_SUCCESSFULLY_IMPORTED' => 'سوابق ایجاد شدند',
    'LBL_STEP_4_TITLE' => 'گام {0}: درون‌‌ریزی فایل',
    'LBL_STEP_5_TITLE' => '{0} گام: مشاهده نتایج واردات',
    'LBL_CUSTOM_ENCLOSURE' => 'زمینه های واجد شرایط توسط:',
    ...
    'LBL_IMPORT_TYPE' => 'با داده های وارد شده چه می کنید؟',
    'LBL_IMPORT_BUTTON' => 'ایجاد گزارش های جدید فقط',
    'LBL_UPDATE_BUTTON' => 'ایجاد رکوردهای جدید و به روز رسانی رکورد',
    'LBL_CREATE_BUTTON_HELP' => 'با استفاده از این گزینه برای ایجاد رکورد جدید. توجه: اگر مقادیر به فیلد ID تعیین ردیف در فایل حاوی مقادیر که شناسه رکورد وارد نمی شوند.',
    ...
    'LBL_ERROR_INVALID_BOOL' => 'مقدار بولی نامعتبر',
    'LBL_IMPORT_ERROR' => 'درون ریزی خطاها:',
    'LBL_ERROR' => 'خطا',
    'LBL_FIELD_NAME' => 'نام فیلد',
    'LBL_VALUE' => 'مقدار',
    'LBL_NONE' => 'هیچ‌کدام',
    'LBL_REQUIRED_VALUE' => 'Required value missing',
    'LBL_ERROR_SYNC_USERS' => 'Invalid value to sync to Outlook: ',
    'LBL_ID_EXISTS_ALREADY' => 'ID در حال حاضر در این جدول وجود دارد',
    'LBL_ASSIGNED_USER' => 'اگر کاربر وجود ندارد استفاده کاربر فعلی',
    'LBL_ERROR_DELETING_RECORD' => 'خطا در حذف رکورد:',
    'LBL_ERROR_INVALID_ID' => 'ID given is too long to fit in the field (maximum length is 36 characters)',
    'LBL_ERROR_INVALID_PHONE' => 'شماره تلفن نامعتبر',
    'LBL_ERROR_INVALID_NAME' => 'String too long to fit in the field',
    'LBL_ERROR_INVALID_VARCHAR' => 'String too long to fit in the field',
    'LBL_ERROR_INVALID_DATE' => 'تاریخ نامعتبر',
    'LBL_ERROR_INVALID_DATETIME' => 'تاریخ نامعتبر',
    'LBL_ERROR_INVALID_DATETIMECOMBO' => 'تاریخ نامعتبر',
    'LBL_ERROR_INVALID_TIME' => 'زمان نامعتبر',
    'LBL_ERROR_INVALID_INT' => 'عدد صحیح نا معتبر',
    'LBL_ERROR_INVALID_NUM' => 'Invalid numeric value',
    'LBL_ERROR_INVALID_EMAIL' => 'آدرس ایمیل نامعتبر',
    'LBL_ERROR_INVALID_USER' => 'شناسه یا نام کاربر نامعتبر',
    'LBL_ERROR_INVALID_TEAM' => 'شناسه یا نام کاربری نامعتبر',
    'LBL_ERROR_INVALID_ACCOUNT' => 'شناسه یا نام مرکز نامعتبر',
    'LBL_ERROR_INVALID_RELATE' => 'Invalid relational field',
    'LBL_ERROR_INVALID_CURRENCY' => 'مقدار پول نامعتبر',
    ...
    'ERR_SELECT_FILE' => 'برای آپلود یک فایل را انتخاب کنید.',
    'LBL_SELECT_FILE' => 'فایل را انتخاب کنید:',
    'LBL_EXTERNAL_SOURCE' => 'نرم افزار خارجی و یا خدمات',
    ...
    'LBL_CREATED_TAB' => 'سوابق ایجاد شده',
    ...
    'LBL_IMPORT_FIELDDEF_ASSIGNED_USER_NAME' => 'نام یا شناسه کاربر',
    'LBL_IMPORT_FIELDDEF_BOOL' => '\'0\' or \'1\'',
    'LBL_IMPORT_FIELDDEF_ENUM' => 'فهرست',
    'LBL_IMPORT_FIELDDEF_EMAIL' => 'آدرس ایمیل',
    'LBL_IMPORT_FIELDDEF_INT' => 'عددی (دهدهی)',
    'LBL_IMPORT_FIELDDEF_DOUBLE' => 'عددی (دهدهی)',
    'LBL_IMPORT_FIELDDEF_NUM' => 'عددی (دهدهی)',
    'LBL_IMPORT_FIELDDEF_CURRENCY' => 'عددی (ده دهی مجاز)',
    'LBL_IMPORT_FIELDDEF_FLOAT' => 'عددی (ده دهی مجاز)',
    'LBL_DATE_FORMAT' => 'فرمت تاریخ:',
    'LBL_TIME_FORMAT' => 'فرمت زمان:',
    'LBL_TIMEZONE' => 'منطقه زمانی:',
    'LBL_ADD_ROW' => 'افزودن فیلد',
    'LBL_REMOVE_ROW' => 'حذف فیلد',
    ...
    'LBL_SHOW_NOTES' => 'مشاهده یادداشت‌ها',
    ...
    'LBL_IMPORT_COMPLETED' => 'درون ریزی به پایان رسید',
    'LBL_IMPORT_RECORDS' => 'درون ریزی پرونده ها',
    'LBL_IMPORT_RECORDS_OF' => 'از',
    'LBL_IMPORT_RECORDS_TO' => 'به',
    ...
    'LBL_IMPORT_STARTED' => 'درون ریزی آغاز شد:',
    ...
    'LBL_MISSING_HEADER_ROW' => 'ردیف بدون سرصفحه یافت نشد',
    'LBL_CANCEL' => 'لغو',
