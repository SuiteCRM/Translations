...
$mod_strings = array(
    ...
    'LBL_REMOVE' => 'حذف',
    'LBL_LIST_FORM_TITLE' => 'لیست رویدادهای خدمات',
    'LBL_MODULE_NAME' => 'رویدادهای خدمات',
    'LBL_MODULE_TITLE' => 'رویدادهای خدمات',
    'LBL_HOMEPAGE_TITLE' => 'رویدادهای خدمات من',
    'LNK_NEW_RECORD' => 'ایجاد رویدادهای خدمات',
    'LNK_LIST' => 'مشاهده رویدادهای خدمات',
    'LBL_SEARCH_FORM_TITLE' => 'جستجوی رویدادهای خدمات',
    'LBL_HISTORY_SUBPANEL_TITLE' => 'مشاهده تاریخچه',
    'LBL_ACTIVITIES_SUBPANEL_TITLE' => 'فعالیت‌ها',
    'LBL_NEW_FORM_TITLE' => 'رویدادهای خدمات جدید',
    'LBL_CASE_NAME' => 'خدمات',
);
