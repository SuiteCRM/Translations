...
$mod_strings = array(
    'ERR_UW_CANNOT_DETERMINE_GROUP' => 'قادر به تعیین گروه نیست',
    'ERR_UW_CANNOT_DETERMINE_USER' => 'مالک را نمی‌توان نعیین کرد',
    'ERR_UW_CONFIG_WRITE' => 'خطای به روز رسانی config.php با اطلاعات نسخه جدید.',
    'ERR_UW_CONFIG' => 'لطفا فایل config.php را قابل نوشتن و بازنگری این صفحه.',
    'ERR_UW_DIR_NOT_WRITABLE' => 'دایرکتوری قابل نوشتن نیست',
    'ERR_UW_FILE_NOT_COPIED' => 'فایل کپی نشد',
    'ERR_UW_FILE_NOT_DELETED' => 'Problem removing package ',
    'ERR_UW_FILE_NOT_READABLE' => 'فایل قابل خواندن نیست.',
    'ERR_UW_FILE_NOT_WRITABLE' => 'پرونده را نمی تواند منتقل و یا نوشته',
    'ERR_UW_FLAVOR_2' => 'عطر و طعم ارتقا: ',
    'ERR_UW_FLAVOR' => 'طعم SuiteCRM سیستم: ',
    ...
    'ERR_UW_NO_FILE_UPLOADED' => 'لطفا یک فایل را انتخاب نمایید سپس مجددا امتحان کنید!',
    'ERR_UW_NO_FILES' => 'خطایی رخ داده است، هیچ پرونده ای برای بررسی پیدا شد.',
    ...
    'ERR_UW_NO_CREATE_TMP_DIR' => 'قادر به ایجاد فهرست موقتی نیست. بررسی پرونده مجوز.',
    ...
    'ERR_UW_VERSION' => 'نسخه SuiteCRM سیستم: ',
    'ERR_UW_PHP_VERSION' => 'نسخه PHP: ',
    'ERR_UW_SUITECRM_VERSION' => 'نسخه SuiteCRM سیستم: ',
    'ERR_UW_WRONG_TYPE' => 'This page is not for running ',
    'LBL_BUTTON_BACK' => 'بازگشت',
    'LBL_BUTTON_CANCEL' => 'لغو',
    'LBL_BUTTON_DELETE' => 'حذف بسته',
    'LBL_BUTTON_DONE' => 'ﺍﻧﺠﺎﻡ شد',
    'LBL_BUTTON_EXIT' => 'خروج',
    'LBL_BUTTON_NEXT' => 'بعدی >',
    'LBL_BUTTON_RECHECK' => 'بررسی مجدد',
    'LBL_BUTTON_RESTART' => 'شروع مجدد',

    'LBL_UPLOAD_UPGRADE' => 'آپلود بسته ارتقاء ',
    'LBL_UW_BACKUP_FILES_EXIST_TITLE' => 'پشتیبان گیری پرونده',
    ...
    'LBL_UW_COMPLIANCE_IMAP' => 'ماژول های IMAP',
    ...
    'LBL_UW_COMPLIANCE_STREAM' => 'تنظیمات پی اچ پی: جریان',
    ...
    'LBL_UW_COPIED_FILES_TITLE' => 'پرونده ها با موفقیت کپی برداری شدند',

    'LBL_UW_DB_CHOICE1' => 'Upgrade Wizard Runs SQL',
    'LBL_UW_DB_CHOICE2' => 'Manual SQL Queries',
    'LBL_UW_DB_ISSUES_PERMS' => 'دسترسی های پایگاه داده',
    'LBL_UW_DB_METHOD' => 'Database Update Method',
    'LBL_UW_DB_NO_ADD_COLUMN' => 'ALTER TABLE [table] ADD COLUMN [column]',
    'LBL_UW_DB_NO_CHANGE_COLUMN' => 'ALTER TABLE [table] CHANGE COLUMN [column]',
    'LBL_UW_DB_NO_CREATE' => 'ایجاد جدول [table]',
    'LBL_UW_DB_NO_DELETE' => 'DELETE FROM [table]',
    'LBL_UW_DB_NO_DROP_COLUMN' => 'ALTER TABLE [table] DROP COLUMN [column]',
    'LBL_UW_DB_NO_DROP_TABLE' => 'DROP TABLE [table]',
    'LBL_UW_DB_NO_ERRORS' => 'همه امتیازات قابل دسترسی',
    'LBL_UW_DB_NO_INSERT' => 'INSERT INTO [table]',
    'LBL_UW_DB_NO_SELECT' => 'SELECT [x] FROM [table]',
    'LBL_UW_DB_NO_UPDATE' => 'به روز رسانی [table]',
    ...
    'LBL_UW_FILE_DELETED' => ' حذف شده است.<br>',
    'LBL_UW_FILE_GROUP' => 'گروه',
    'LBL_UW_FILE_ISSUES_PERMS' => 'دسترسی های پوشه',
    'LBL_UW_FILE_NO_ERRORS' => '<b>All Files Writable</b>',
    'LBL_UW_FILE_OWNER' => 'مالک',
    'LBL_UW_FILE_PERMS' => 'Permissions',
    'LBL_UW_FILE_UPLOADED' => ' ارسال شده است',
    'LBL_UW_FILE' => 'نام فایل',
    ...
    'LBL_UW_IN_PROGRESS' => 'در حال انجام',
    'LBL_UW_INCLUDING' => 'شامل کردن',
    'LBL_UW_INCOMPLETE' => 'Incomplete',
    'LBL_UW_MANUAL_MERGE' => 'ادغام فایل',
    ...
    'LBL_UW_PREFLIGHT_NOT_NEEDED' => 'مورد نیاز نیست.',
    ...
    'LBL_UW_REBUILD_TITLE' => 'بازسازی نتیجه',
    'LBL_UW_SCHEMA_CHANGE' => 'تغییر طرح کلی',
    ...
    'LBL_UW_TITLE_LAYOUTS' => 'تایید چیدمان',
    'LBL_LAYOUT_MODULE_TITLE' => 'چیدمان',
    ...
    'LBL_LAYOUT_MERGE_TITLE' => 'لطفا بر روی کلید بعدی جهت تایید تغییرات و پایان آپگرید کلیک کنید.',
    'LBL_LAYOUT_MERGE_TITLE2' => 'Click Next to complete the upgrade.',
    'LBL_UW_CONFIRM_LAYOUTS' => 'تایید چیدمان',
    'LBL_UW_CONFIRM_LAYOUT_RESULTS' => 'نتایج تایید چیدمان',
    'LBL_UW_CONFIRM_LAYOUT_RESULTS_DESC' => 'The following layouts were merged successfully:',
    'LBL_SELECT_FILE' => 'Select File:',
    'ERROR_VERSION_INCOMPATIBLE' => 'فایل ارسالی سازگار با این نسخه SuiteCRM نیست: ',
    'ERROR_PHP_VERSION_INCOMPATIBLE' => 'The uploaded file is not compatible with this version of PHP: ',
    'ERROR_SUITECRM_VERSION_INCOMPATIBLE' => 'فایل ارسالی سازگار با این نسخه SuiteCRM نیست: ',
    'LBL_LANGPACKS' => 'بسته های زبان' /*for 508 compliance fix*/,
    'LBL_MODULELOADER' => 'بارگزار ماژول' /*for 508 compliance fix*/,
    'LBL_PATCHUPGRADES' => 'وصله ارتقا' /*for 508 compliance fix*/,
    'LBL_THEMES' => 'تم ها' /*for 508 compliance fix*/,
    'LBL_WORKFLOW' => 'گردش کار' /*for 508 compliance fix*/,
    'LBL_UPGRADE' => 'ارتقاء' /*for 508 compliance fix*/,
    ...
    'ERR_UW_PHP_FILE_ERRORS' => array(
        ...
        4 => 'هیچ فایل آپلود نشده است.',
        5 => 'Unknown error.',
        6 => 'Missing a temporary folder.',
        7 => 'ناتوانی در نوشتن فایل بر روی دیسک.',
