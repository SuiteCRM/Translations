...
$mod_strings = array(
    ...
    'LBL_DELETED' => 'حذف شده',
    'LBL_NAME' => 'نام',
    'LBL_MODULE_NAME' => 'اقدامات گردش کار',
    'LBL_MODULE_TITLE' => 'اقدامات گردش کار',
    'LBL_AOW_WORKFLOW_ID' => 'AOW_WorkFlow Id',
    'LBL_ACTION' => 'عملکرد',
    'LBL_PARAMETERS' => 'پارامترها',
    'LBL_SELECT_ACTION' => 'انتخاب عمل',
    'LBL_CREATE_EMAIL_TEMPLATE' => 'ایجاد',
    'LBL_RECORD_TYPE' => 'نوع رکورد',
    'LBL_SENDEMAIL' => 'ارسال ایمیل',
    'LBL_CREATERECORD' => 'Create Record',
    'LBL_MODIFYRECORD' => 'Modify Record',
    'LBL_ADD_FIELD' => 'افزودن فیلد',
    'LBL_ADD_RELATIONSHIP' => 'اضافه کردن رابطه',
    'LBL_EDIT_EMAIL_TEMPLATE' => 'ویرایش',
    'LBL_EMAIL' => 'ایمیل',
    'LBL_EMAIL_TEMPLATE' => 'قالب ایمیل',
    'LBL_SETAPPROVAL' => 'Set Approval',
    'LBL_RELATE_WORKFLOW' => 'مربوط به ماژول گردش کار',
    'LBL_INDIVIDUAL_EMAILS' => 'ارسال ایمیل های فردی',
    'LBL_COMPUTEFIELD' => 'Calculate Fields',
    'LBL_COMPUTEFIELD_PARAMETERS' => 'پارامترها',
    ...
    'LBL_COMPUTEFIELD_FORMULA' => 'فرمول',
