...
$mod_strings = array(
    ...
    'LBL_BILLING_ADDRESS_STREET_2' => 'ادامه آدرس صورت‌حساب',
    'LBL_BILLING_ADDRESS_STREET_3' => 'ادامه آدرس صورت‌حساب',
    'LBL_BILLING_ADDRESS_STREET_4' => 'ادامه آدرس صورت‌حساب',
    ...
    'LBL_CASES_SUBPANEL_TITLE' => 'موارد',
    'LBL_CITY' => 'شهر:',
    ...
    'LBL_SHIPPING_ADDRESS_STREET' => 'آدرس ارسال کالا:',
    ...
    'MSG_DUPLICATE' => 'مرکزی که در حال ایجاد آن هستید ممکن است تکراری باشد. مراکزی با نام مشابه در ذیل لیست شده‌اند.<br>برای ادامه ایجاد این مرکز روی ایجاد کلیک کنید، یا یکی از مراکز ذیل را انتخاب کنید.',
    'MSG_SHOW_DUPLICATES' => 'مرکزی که در حال ایجاد آن هستید ممکن است تکراری باشد. مراکزی با نام مشابه در ذیل لیست شده‌اند.<br>برای ادامه ایجاد این مرکز جدید روی ذخیره کلیک کنید، یا با کلیک روی لغو بدون ایجاد مرکز به ماژول بازگردید.',
