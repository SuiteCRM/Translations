...
$mod_strings = array(
    ...
    'LBL_REMOVE' => 'حذف',
    'LBL_LIST_FORM_TITLE' => 'لیست تغییرات خدمات',
    'LBL_MODULE_NAME' => 'تغییرات خدمات',
    'LBL_MODULE_TITLE' => 'تغییرات خدمات',
    'LBL_HOMEPAGE_TITLE' => 'تغییرات خدمات من',
    'LNK_NEW_RECORD' => 'ایجاد تغییرات خدمات',
    'LNK_LIST' => 'مشاهده تغییرات خدمات',
    'LBL_SEARCH_FORM_TITLE' => 'جستجوی تغییرات خدمات',
    'LBL_HISTORY_SUBPANEL_TITLE' => 'مشاهده تاریخچه',
    'LBL_ACTIVITIES_SUBPANEL_TITLE' => 'فعالیت‌ها',
    'LBL_NEW_FORM_TITLE' => 'تغییرات خدمات جدید',
    'LBL_CASE_NAME' => 'خدمات',
