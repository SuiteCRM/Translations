...
// OOTB Scheduler Job Names:
    'LBL_OOTB_WORKFLOW' => 'پردازش وظایف گردش کار',
    'LBL_OOTB_REPORTS' => 'اجرای وظایف برنامه‌ریزی شده تولید گزارش',
    'LBL_OOTB_IE' => 'بررسی صندوق پستی ورودی',
    'LBL_OOTB_BOUNCE' => 'اجرای فرایند شبانه Bounced ایمیل های کمپین',
    'LBL_OOTB_CAMPAIGN' => 'اجرای شبانه کمپین ایمیل انبوه',
    'LBL_OOTB_PRUNE' => 'هرس کردن پایگاه داده را در 1 ماه',
    'LBL_OOTB_TRACKER' => 'آلو ردیاب جداول',
    ...
    'LBL_OOTB_CLEANUP_QUEUE' => 'خالی کردن صف کارها',
...
// List Labels
    'LBL_LIST_JOB_INTERVAL' => 'فاصله:',
    'LBL_LIST_LIST_ORDER' => 'برنامه ریز ها:',
    'LBL_LIST_NAME' => 'برنامه ریز:',
    'LBL_LIST_RANGE' => 'محدوده:',
    'LBL_LIST_STATUS' => 'وضعیت',
    'LBL_LIST_TITLE' => 'لیست برنامه ریزی ها :',
// human readable:
    'LBL_SUN' => 'یکشنبه',
    'LBL_MON' => 'دوشنبه',
    'LBL_TUE' => 'سه‌شنبه',
...
// Labels
    ...
    'LBL_DATE_TIME_END' => 'تاریخ و زمان پایان',
    'LBL_DATE_TIME_START' => 'تاریخ و زمان ارسال',
    'LBL_INTERVAL' => 'فاصله',
    'LBL_JOB' => 'کار',
    'LBL_JOB_URL' => 'URL کار',
    'LBL_LAST_RUN' => 'Last Successful Run',
    'LBL_MODULE_NAME' => 'SuiteCRM Scheduler',
    'LBL_MODULE_TITLE' => 'برنامه‌ریز',
    'LBL_NAME' => 'نام کار',
    'LBL_NEVER' => 'هرگز',
    'LBL_NEW_FORM_TITLE' => 'برنا مه ریزی مجدد جدید',
    'LBL_PERENNIAL' => 'perpetual',
    'LBL_SEARCH_FORM_TITLE' => 'Scheduler Search',
    'LBL_SCHEDULER' => 'برنامه ریز:',
    'LBL_STATUS' => 'وضعیت',
    'LBL_TIME_FROM' => 'Active From',
    'LBL_TIME_TO' => 'فعال است به',
    ...
    'LBL_BASIC_OPTIONS' => 'راه اندازی اولیه',
    'LBL_ADV_OPTIONS' => 'تنظیمات پیشرفته',
    'LBL_TOGGLE_ADV' => 'نمایش تنظیمات پیشرفته',
    'LBL_TOGGLE_BASIC' => 'Show Basic Options',
// Links
    'LNK_LIST_SCHEDULER' => 'برنامه‌ریز',
    'LNK_NEW_SCHEDULER' => 'ایجاد زمانبندی',
// Messages
...
//jobstrings
    ...
    'LBL_RUNMASSEMAILCAMPAIGN' => 'اجرای شبانه کمپین ایمیل انبوه',
    'LBL_POLLMONITOREDINBOXESFORBOUNCEDCAMPAIGNEMAILS' => 'اجرای فرایند شبانه Bounced ایمیل های کمپین',
    'LBL_PRUNEDATABASE' => 'هرس کردن پایگاه داده را در 1 ماه',
    'LBL_TRIMTRACKER' => 'آلو ردیاب جداول',
