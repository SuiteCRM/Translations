...
$mod_strings = [
    ...
    // Email opt-in labels
    'LBL_OPT_IN' => 'عضویت',
    'LBL_OPT_IN_PENDING_EMAIL_NOT_SENT' => 'در انتظار تایید عضویت، تایید عضویت ارسال نشده است',
    'LBL_OPT_IN_PENDING_EMAIL_SENT' => 'در انتظار تایید عضویت، تایید عضویت ارسال شد',
