...
$mod_strings = array(
    ...
    'LBL_DELETED' => 'حذف شده',
    'LBL_NAME' => 'نام کلید مصرف کننده',
    'LBL_CREATED_USER' => 'کاربر ایجاد کننده',
    'LBL_MODIFIED_USER' => 'کاربر ویرایش کننده',
    'LBL_LIST_NAME' => 'نام کلید',
    'LBL_LIST_FORM_TITLE' => 'کلید های OAuth',
    'LBL_MODULE_NAME' => 'کلید های OAuth',
    'LBL_MODULE_TITLE' => 'کلید های OAuth',
    'LNK_NEW_RECORD' => 'ایجاد کلید OAuth',
    'LNK_LIST' => 'مشاهده کلیدهای OAuth',
    'LBL_TOKENS' => 'نشانه',
);
