...
$mod_strings = array(
    'LBL_ALL_MODULES' => 'Всички записи',//rost fix
    ...
    'LBL_REMOVE_BUTTON_LABEL' => 'Изтрий',
    'LBL_GROUP' => 'Group:',
    'LBL_MODULE' => 'Module:',
    ...
    'LBL_CONFIRM_END' => 'маркиран(и) запис(и)?',
    ...
    'LBL_ERROR_EXPORT_WHERE_CHANGED' => 'Неуспешна модификация заради промяна на условието за филтриране. Моля опитате пак.',
