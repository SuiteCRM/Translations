...
$mod_strings = array(
    ...
    'LBL_SYSOPTS_2' => 'Какъв тип на база данни ще използвате за SuiteCRM, който предстои да инсталирате?',
    'LBL_SYSOPTS_DB' => 'Задайте тип на базата данни',
    'LBL_SYSOPTS_DB_TITLE' => 'Тип на база данни',
    'LBL_SYSOPTS_ERRS_TITLE' => 'Моля отстранете следните грешки преди да продължите:',
    'ERR_DB_VERSION_FAILURE' => 'Невъзможна е проверка на версията на базата с данни.',
    ...
    'LBL_CONFIRM_DB_TYPE' => 'Тип на база данни',
    'LBL_CONFIRM_NOT' => 'not',
    ...
    'LBL_DBCONF_COLLATION' => 'Сравняване',
    'LBL_DBCONF_CHARSET' => 'Знаков набор',
    ...
    'LBL_DISABLED_HELP_1' => 'За помощ при инсталиране, моле посетете SuiteCRM',
    ...
    'LBL_WELCOME' => 'Добре дошли в SuiteCRM',
