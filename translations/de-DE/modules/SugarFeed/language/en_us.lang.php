...
$mod_strings = array(
    ...
    'LBL_TIME_AGO' => 'zuvor',
// Activity stream
    'CREATED_CONTACT' => 'hat einen <b>NEUEN</b> {0} erstellt', // For fusional (inflected) languages: used in the sentence "Administrator created a new contact"
    'CREATED_OPPORTUNITY' => 'hat einen <b>NEUEN</b> {0} erstellt', // For fusional (inflected) languages: used in the sentence "Administrator created a new opportunity"
    'CREATED_CASE' => 'hat einen <b>NEUEN</b> {0} erstellt', // For fusional (inflected) languages: used in the sentence "Administrator created a new case"
    'CREATED_LEAD' => 'hat einen <b>NEUEN</b> {0} erstellt', // For fusional (inflected) languages: used in sentence "Administrator created a new lead"
    'FOR' => 'für', // Activity stream for cases
    'FOR_AMOUNT' => 'für Betrag', // Activity stream for cases
