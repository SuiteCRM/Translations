...
$mod_strings = array(
    ...
    'LNK_NEW_CALL' => 'Novo telefonema',
    'LNK_NEW_EMAIL' => 'Novo Email',
    'LNK_NEW_MEETING' => 'Nova reunião',
    'LNK_NEW_TASK' => 'Criar tarefa',
    'NTC_DELETE_CONFIRMATION' => 'Tem a certeza de que pretende eliminar este registo? Qualquer registo que utilize esta moeda será convertido, ao ser acedido, para a moeda predefinida do sistema. Poderá ser melhor alterar a situação para inativa.',
    'LBL_BELOW_MIN' => 'O rácio de conversão tem de ser superior a zero',
    'currency_status_dom' =>
        array(
            'Active' => 'Ativo',
            'Inactive' => 'Inativo',
