...
$mod_strings = array(
    ...
    'ERR_CHECKSYS_CONFIG_NOT_WRITABLE' => 'O ficheiro de configuração existe, mas não é editável. Por favor, tome as medidas necessárias para tornar o ficheiro editável.',
    'ERR_CHECKSYS_CONFIG_NOT_FOUND' => 'O seu ficheiro config.php não existe. Será criado na instalação.',
    'ERR_CHECKSYS_CONFIG_OVERRIDE_NOT_WRITABLE' => 'O ficheiro de sobreposição à configuração existe, mas não é editável. Por favor, tome as medidas necessárias para tornar o ficheiro editável. ',
    'ERR_CHECKSYS_CUSTOM_NOT_WRITABLE' => 'A pasta personalizada Custom existe, mas não é editável. Por favor, tome as medidas necessárias para tornar a pasta editável.',
    'ERR_CHECKSYS_FILES_NOT_WRITABLE' => "Os ficheiros ou pastas acima listados não são editáveis, estão em falta ou não puderam ser criados. Por favor, tome as medidas necessárias para tornar as pastas editáveis.",
    'ERR_CHECKSYS_LOGS_NOT_WRITABLE' => 'A pasta de LOGS não é editável atualmente',
    'ERR_CHECKSYS_CACHE_NOT_WRITABLE' => 'A pasta de CACHE não é editável atualmente',
    'ERR_CHECKSYS_EXTENSIONS_NOT_WRITABLE' => 'A pasta Extensions não é editável atualmente',
    'ERR_CHECKSYS_SECRETS_NOT_WRITABLE' => 'A pasta config/secrets não é editável atualmente',
    'ERR_CHECKSYS_ENV_NOT_WRITABLE' => 'O ficheiro .env ou a pasta em que está colocado não são editáveis.',
    ...
    'ERR_DB_LOGIN_FAILURE_SHORT' => 'Erro de ligação à base de dados. O nome da base de dados, porta, nome do utilizador e/ou senha indicados são inválidos.',
    ...
    'ERR_PERFORM_CONFIG_PHP_4' => 'Alerta: Não foi possível editar o ficheiro config.php. Por favor, assegure-se de que ele existe.',
    ...
    'ERR_SESSION_DIRECTORY' => 'O diretório de sessão indicado não é um diretório válido.',
    ...
    'ERR_UPLOAD_MAX_FILESIZE' => 'A sua configuração PHP deve ser alterada para permitir o carregamento de ficheiros com pelo menos 6MB.',
    ...
    'LBL_CANCEL' => 'Cancelar',
    'LBL_ACCEPT' => 'Aceito',
    'LBL_CHECKSYS_LEGACY_CACHE' => 'Subpastas de Cache Legacy — Editáveis',
    'LBL_CHECKSYS_CACHE' => 'Subpastas de Cache editáveis',
    'LBL_CHECKSYS_EXTENSIONS' => 'Pasta Extensions — Editável',
    'LBL_CHECKSYS_SECRETS' => 'Pasta Config/Secrets — Editável',
    'LBL_CHECKSYS_LOGS' => 'Pasta Log — Editável',
    ...
    'LBL_CHECKSYS_DATA' => 'Subpastas de dados editáveis',
    ...
    'LBL_CHECKSYS_PHP_INI' => 'Localização do seu ficheiro de configuração php (php.ini)',
    'LBL_CHECKSYS_PHP_OK' => 'OK (ver',
    'LBL_CHECKSYS_PHPVER' => 'Versão PHP',
    'LBL_CHECKSYS_IISVER' => 'Versão IIS',
    'LBL_CHECKSYS_JSON' => 'Análise sintática JSON',
    'LBL_CHECKSYS_RECHECK' => 'Verificar de novo',
    ...
    'LBL_CHECKSYS_INTL_EXTENSIONS' => 'Intl — Existe em extensões',
    'LBL_CHECKSYS_JSON_EXTENSIONS' => 'Json — Existe em extensões',
    'LBL_CHECKSYS_GD_EXTENSIONS' => 'GD — Existe em extensões',
    'LBL_CHECKSYS_OPENSSL_EXTENSIONS' => 'OpenSSL — Existe em extensões',
    'LBL_CHECKSYS_ZIP_EXTENSIONS' => 'Zip — Existe em extensões',
    'LBL_CHECKSYS_PDO_MYSQL_EXTENSIONS' => 'PDO MySQL — Existe em extensões',
    'LBL_CHECKSYS_CURL_EXTENSIONS' => 'cURL — Existe em extensões',
    'LBL_CHECKSYS_MBSTRING_EXTENSIONS' => 'Strings MB — Existe em extensões',
    'LBL_CHECKSYS_MYSQLI_EXTENSIONS' => 'MySQLi — Existe em extensões',
    'LBL_CHECKSYS_SOAP_EXTENSIONS' => 'Soap — Existe em extensões',
    'LBL_CHECKSYS_XML_EXTENSIONS' => 'XML — Existe em extensões',
    'LBL_CHECKSYS_IMAP_EXTENSIONS' => 'IMAP — Existe em extensões (opcional)',
    'LBL_CHECKSYS_LDAP_EXTENSIONS' => 'LDAP — Existe em extensões (opcional)',
    'LBL_PHP_CHECKS' => 'Verificações de PHP',
    'LBL_SERVER_CHECKS' => 'Verificações de Servidor',
    'LBL_PERMISSION_CHECKS' => 'Verificação de permissões',
    'LBL_CHECK_FAILED' => 'Falha na verificação: ',
    'ERR_CHECKSYS_INTL' => 'A extensão Intl não está instalada. Por favor, entre em contacto com o seu administrador de sistema',
    'ERR_CHECKSYS_JSON' => 'A extensão JSON não está instalada. Por favor, entre em contacto com o seu administrador de sistema.',
    'ERR_CHECKSYS_GD' => 'A extensão GD não está instalada. Por favor, entre em contacto com o seu administrador de sistema.',
    'ERR_CHECKSYS_OPENSSL' => 'A extensão OpenSSL não está instalada. Por favor, entre em contacto com o seu administrador de sistema.',
    'ERR_CHECKSYS_PDO_MYSQL' => 'A extensão PDO MySQL não está instalada. Por favor, entre em contacto com o seu administrador de sistema.',
    'ERR_CHECKSYS_MYSQLI' => 'A extensão MySQLi não está instalada. Por favor, entre em contacto com o seu administrador de sistema.',
    'ERR_CHECKSYS_SOAP' => 'A extensão Soap não está instalada. Por favor, entre em contacto com o seu administrador de sistema.',
    ...
    'LBL_UNWRITABLE_SUB_DIR' => 'Existem algumas subpastas que não são editáveis. Por favor, tome as medidas necessárias para tornar editáveis as pastas em causa ',
    'LBL_REFER_TO_LOGS' => 'Existe um problema numa das suas verificações de pré-instalação. Por favor, consulte o ficheiro install.log',
    'LBL_NOT_A_VALID_SUITECRM_PAGE' => 'O título SuiteCRM não pôde ser encontrado. Esta não é uma página SuiteCRM válida.',
    'LBL_NOT_COOKIE_OR_TOKEN' => 'Não foi possível encontrar Cookies nem um Token válido. Por favor, consulte o ficheiro install.log para obter mais informações.',
    'LBL_CURL_JSON_ERROR' => 'O resultado da chamada Curl para a página Graphql estava vazio.',
    'LBL_UNABLE_TO_FIND_SYSTEM_CONFIGS' => 'Não foi possível obter as configurações do sistema na página Graphql. Por favor, consulte o ficheiro install.log para obter mais informações.',
    'LBL_CURL_REQUEST_MAIN_PAGE' => 'Pedido Curl na página principal',
    'LBL_CURL_REQUEST_API_PAGE' => 'Pedido Curl na API',
    'LBL_ERROR_DETAILS' => 'Detalhes do erro',
    'LBL_ERROR' => 'Erro:',
    'LBL_WARNING_DETAILS' => 'Detalhes do alerta',
    'LBL_WARNING' => 'Alerta',
    'LBL_SYSTEM_CHECKS' => 'VERIFICAÇÕES DO SISTEMA',
    'LBL_CRON_INSTRUCTIONS_1' => 'Para executar o agendador SuiteCRM, edite o seu ficheiro crontab de utilizadores do servidor web com este comando:',
    'LBL_CRON_INSTRUCTIONS_2' => 'e adicione a seguinte linha no Crontab:',
    'LBL_CRON_INSTRUCTIONS_3' => 'Deve fazer isto apenas depois da instalação estar concluída.',
    'LBL_CRON_CONFIGURATION' => 'CONFIGURAÇÃO DE CRON',
    'LBL_SETUP_CRONTAB' => 'Para configurar o Crontab',
    'LBL_ROUTE_ACCESS_CHECK' => 'VERIFICAÇÃO DE ACESSO DE ROTA',
    'LBL_PHP_MEM_1' => 'O seu limite de memória PHP é ',
    'LBL_PHP_MEM_2' => '. Tem de ser no mínimo de ',
    'LBL_PHP_MEM_3' => 'M para continuar.',
    'LBL_CLOSE' => 'Fechar',
    'LBL_THREE' => '3',
    ...
    'LBL_DBCONF_DB_PORT' => 'Porta da base de dados',
    ...
    'LBL_DISABLED_DESCRIPTION_2' => 'Após efetuar esta alteração, pode clicar no botão abaixo "Iniciar" para começar a sua instalação. Após concluir a instalação, deverá alterar o valor de \'installer_locked\' para \'true\'',
    'LBL_DISABLED_DESCRIPTION_3' => 'Após ter efetuado esta alteração, por favor, revisite / recarregue esta página para continuar.',
    ...
    'LBL_APP_NOT_INSTALLED' => 'SuiteCRM não está instalado. O ponto de entrada precisa de um SuiteCRM instalado. Por favor, instale-o primeiro.',
    ...
    'LBL_SILENT_INSTALL_SUCCESS' => 'SuiteCRM instalado com sucesso.',
    'LBL_SILENT_INSTALL_FAILED' => 'Instalação do SuiteCRM falhou.',
    ...
    'LBL_REG_CONF_3' => 'Obrigado por se registar. Clique no botão Concluir para aceder ao SuiteCRM. É necessário autenticar-se pela primeira vez utilizando o nome de utilizador "admin" e a senha que inseriu no passo 2.',
    ...
    'LBL_SITECFG_CUSTOM_SESSION' => 'Utilizar um diretório personalizado de sessão para o CRM',
    ...
    'LBL_PRE_INSTALL_REQ' => 'Requisitos de pré-instalação',
...
$contact_user_link_guid',
    ...
    'LBL_SYS_CHECK_WARNING' => 'Ignorar alertas de verificação do sistema',
    'LBL_PROCEED' => 'Continuar',
    'LBL_RECHECK' => 'Re-verificar',
    'LBL_CONFIG' => 'Configuração',
    'LBL_VALIDATION_ERRORS' => 'Existem erros de validação. Não é possível executar a ação.'
);
