...
$mod_strings = array(
    ...
    'LBL_SYSOPTS_ERRS_TITLE' => '在继续执行前请先修复以下错误：',
    ...
    'ERR_CHECKSYS' => '在兼容性检查过程中检测到错误，需要采取适当的步骤解决下面列出的问题，然后点击 "重新检查" 按钮或者尝试重新安装。',
    'ERR_CHECKSYS_CALL_TIME' => '允许通话时间出入证引用已开启 (这应该在 php.ini中设置为关闭)',
    ...
    'ERR_CHECKSYS_CONFIG_NOT_WRITABLE' => '文件只读，请配置可写入权限。',
    'ERR_CHECKSYS_CONFIG_NOT_FOUND' => '您的 config.php 不存在。将在安装时创建。',
    'ERR_CHECKSYS_CONFIG_OVERRIDE_NOT_WRITABLE' => '配置覆盖文件存在，但不可写。请采取必要步骤使文件可写。 ',
    'ERR_CHECKSYS_CUSTOM_NOT_WRITABLE' => '自定义目录存在，但不可写。请采取必要步骤使文件可写。',
    'ERR_CHECKSYS_FILES_NOT_WRITABLE' => "上面列出的文件或目录不可写或缺失，无法创建。 请采取必要步骤使目录可以写入。",
    'ERR_CHECKSYS_LOGS_NOT_WRITABLE' => '日志目录当前不可写',
    'ERR_CHECKSYS_CACHE_NOT_WRITABLE' => '缓存目录当前不可写',
    'ERR_CHECKSYS_EXTENSIONS_NOT_WRITABLE' => '缓存目录当前不可写',
    'ERR_CHECKSYS_SECRETS_NOT_WRITABLE' => '缓存目录当前不可写',
    'ERR_CHECKSYS_ENV_NOT_WRITABLE' => '.env 文件或它所在的目录不可写。',
    'ERR_CHECKSYS_JSON_NOT_AVAILABLE' => "找不到与 JSON 解析库相关联的 SuiteCRM 应用程序所需的函数。 您可能需要在手机中取消对扩展的评论。 ni 文件或使用正确的二进制文件重新编译，取决于您的 PHP 版本。详情请参阅您的 PHP 手册。",
    ...
    'ERR_DB_EXISTS_WITH_CONFIG' => '数据库已存在的配置数据。要使用所选的数据库进行安装，请重新运行安装程序并选择：“删除并重新创建现有 SuiteCRM 表？”如果需要更新系统，请在管理控制台中使用更新向导。请参阅升级文档：<a href="https://docs.suitecrm.com/admin/installation-guide/upgrading/" target="_new">这里</a>.',
    ...
    'ERR_DB_LOGIN_FAILURE_SHORT' => '数据库连接错误：提供的数据库主机名、端口、用户名或密码无效。',
    ...
    'ERR_PERFORM_NO_TCPIP' => '<b>无法检测到互联网连接。</b>当连接到互联网时，请访问 <a href="https://www.suitecrm.com/">https://www.suitecrm.com</a> 注册。我们很高兴您能告知我们关于您使用 SuiteCRM 的计划及相关情况，以确保我们总能为您的业务提供最适合的产品。',
    ...
    'LBL_CANCEL' => '取消',
    'LBL_ACCEPT' => '我接受',
    'LBL_CHECKSYS_LEGACY_CACHE' => '可写入旧版缓存子目录',
    'LBL_CHECKSYS_CACHE' => 'cache 子目录可写',
    'LBL_CHECKSYS_EXTENSIONS' => '可写扩展目录',
    'LBL_CHECKSYS_SECRETS' => '可写扩展目录',
    'LBL_CHECKSYS_LOGS' => '可写日志目录',
    ...
    'LBL_CHECKSYS_ENV' => '可写 .env',
    'LBL_CHECKSYS_FIX_FILES' => '请修复下列文件或目录：',
    'LBL_CHECKSYS_FIX_MODULE_FILES' => '请修复下列文件或目录：',
    'LBL_CHECKSYS_UPLOAD' => 'upload 目录可写',
    'LBL_CHECKSYS_INTL_EXTENSIONS' => '扩展中的Intl 扩展',
    'LBL_CHECKSYS_JSON_EXTENSIONS' => '扩展中的 Json 扩展',
    'LBL_CHECKSYS_GD_EXTENSIONS' => '扩展中的 Json 扩展',
    'LBL_CHECKSYS_OPENSSL_EXTENSIONS' => '扩展中的 OpenSSL 扩展',
    'LBL_CHECKSYS_ZIP_EXTENSIONS' => '扩展中的Zip 扩展',
    'LBL_CHECKSYS_PDO_MYSQL_EXTENSIONS' => '扩展中的 PDO MySQL 扩展',
    'LBL_CHECKSYS_CURL_EXTENSIONS' => '扩展中的 cURL 扩展',
    'LBL_CHECKSYS_MBSTRING_EXTENSIONS' => '扩展中MB 字符串已存在',
    'LBL_CHECKSYS_MYSQLI_EXTENSIONS' => 'MySQLi 扩展扩展',
    'LBL_CHECKSYS_SOAP_EXTENSIONS' => '',
    'LBL_CHECKSYS_XML_EXTENSIONS' => '',
    'LBL_CHECKSYS_IMAP_EXTENSIONS' => '扩展中IMAP 已经存在(可选)',
    'LBL_CHECKSYS_LDAP_EXTENSIONS' => '扩展中LDAP扩展(可选)',
    'LBL_PHP_CHECKS' => 'PHP 检查',
    'LBL_SERVER_CHECKS' => '服务器检查',
    'LBL_PERMISSION_CHECKS' => '权限检查',
    'LBL_CHECK_FAILED' => '检查失败： ',
    'ERR_CHECKSYS_INTL' => '请联系管理员，安装Intl扩展。',
    'ERR_CHECKSYS_JSON' => '请联系管理员，启用JSON扩展组件。',
    'ERR_CHECKSYS_GD' => '扩展GD 未启用，请联系您的系统管理员。',
    'ERR_CHECKSYS_OPENSSL' => '请联系管理员，启用OpenSSL组件。',
    'ERR_CHECKSYS_PDO_MYSQL' => '扩展 PDO MySQL 未启用，请联系您的系统管理员。',
    'ERR_CHECKSYS_MYSQLI' => '扩展MySQLi未启用，请与系统管理员联系。',
    'ERR_CHECKSYS_SOAP' => '扩展Soap 未启用，请联系您的系统管理员。',
    'ERR_SUHOSIN' => '上传流被 Suhosin 阻断，请将 "upload" 添加到 suhosin.executor.include.whitelist 白名单中（详细信息请查看 suitecrm.log）',
    'LBL_UNWRITABLE_SUB_DIR' => '有些子目录是不可写的。请采取必要措施使目录可写 ',
    'LBL_REFER_TO_LOGS' => '在您的安装前检查中有一个问题，请参阅install.log',
    'LBL_NOT_A_VALID_SUITECRM_PAGE' => '找不到 SuiteCRM 标题。这不是一个有效的 SuiteCRM 页面。',
    'LBL_NOT_COOKIE_OR_TOKEN' => '找不到 cookie，未找到有效的令牌。请参阅install.log 获取更多信息。',
    'LBL_CURL_JSON_ERROR' => '对graphql页面的curl调用结果为空。',
    'LBL_UNABLE_TO_FIND_SYSTEM_CONFIGS' => '无法检索到 Graphql 页面上的系统配置。请参阅install.log 获取更多信息。',
    'LBL_CURL_REQUEST_MAIN_PAGE' => '主页上的Curl请求',
    'LBL_CURL_REQUEST_API_PAGE' => '主页上的Curl请求',
    'LBL_ERROR_DETAILS' => '错误详细信息',
    'LBL_ERROR' => '错误',
    'LBL_WARNING_DETAILS' => '警告信息',
    'LBL_WARNING' => '警告',
    'LBL_SYSTEM_CHECKS' => '系统检查',
    'LBL_CRON_INSTRUCTIONS_1' => '配置运行 SuiteCRM 的任务计划程序，需要使用此命令编辑 Web 服务器用户的 crontab 文件：',
    'LBL_CRON_INSTRUCTIONS_2' => '并将以下行添加到crontab文件：',
    'LBL_CRON_INSTRUCTIONS_3' => '您应该在安装完成后来做这些。',
    'LBL_CRON_CONFIGURATION' => 'CRON确认',
    'LBL_SETUP_CRONTAB' => 'Linux Crontab 设置',
    'LBL_ROUTE_ACCESS_CHECK' => '路由访问检查',
    'LBL_PHP_MEM_1' => '您的 PHP 内存限制 ',
    'LBL_PHP_MEM_2' => '。这必须至少为 ',
    'LBL_PHP_MEM_3' => 'M',
    'LBL_CLOSE' => '关闭日期',
    'LBL_THREE' => '3',
    ...
    'LBL_DISABLED_DESCRIPTION_3' => '此更改完成后，请重新查看/重新加载此页面以继续。',
    ...
    'LBL_APP_NOT_INSTALLED' => '未安装 SuiteCRM 。入口点需要安装 SuiteCRM，请先安装。',
    ...
    'LBL_SILENT_INSTALL_SUCCESS' => 'SuiteCRM 已成功安装。',
    'LBL_SILENT_INSTALL_FAILED' => 'SuiteCRM 安装失败。',
    ...
    'LBL_SITECFG_SUITE_UP_DIRECTIONS' => '启用此功能后，您的系统会定期发送有关安装匿名统计到 SuiteCRM Inc.，将帮助我们了解使用模式和完善产品。当新版本或更新可用时，管理员将收到更新通知。',
    'LBL_SITECFG_SUITE_UP' => '自动检查更新',
...
$contact_user_link_guid',
    ...
    'two_factor_auth_email' => array(
        'subject' => '双重认证验证码',
        'type' => '系统',
        'description' => "此模板用于向用户发送双因素身份验证的验证码。",
        'body' => '<div><table border=\\"0\\" cellspacing=\\"0\\" cellpadding=\\"0\\" width="550" align=\\"\\&quot;\\&quot;center\\&quot;\\&quot;\\"><tbody><tr><td colspan=\\"2\\"><p>双重认证验证码是 <b>$code</b>.</p>  </td>         </tr><tr><td colspan=\\"2\\"></td>         </tr> </tbody></table> </div>',
        'txt_body' =>
            '双重认证码是$code.',
        'name' => '进行双重认证的邮箱',
    ),
    ...
    'CURRENT_LOGO_HELP' => '这个图标显示在 SuiteCRM登录界面的中心。',
    ...
    'ERR_UPLOAD_FILE_UPLOAD_ERR_INI_SIZE' => '上传文件大小超出了php.ini 文件中变量 upload_max_filesize 指定的值。',
    'ERR_UPLOAD_FILE_UPLOAD_ERR_FORM_SIZE' => '上传文件大小超出了 HTML 表单中变量 MAX_FILE_SIZE 指定的值。',
    'ERR_UPLOAD_FILE_UPLOAD_ERR_PARTIAL' => '文件只有部分被上传。',
    'ERR_UPLOAD_FILE_UPLOAD_ERR_NO_FILE' => '文件未上传。',
    'ERR_UPLOAD_FILE_UPLOAD_ERR_NO_TMP_DIR' => '缺少临时文件夹。',
    'ERR_UPLOAD_FILE_UPLOAD_ERR_CANT_WRITE' => '文件写入磁盘失败。',
    ...
    'LBL_OLD_PHP_MSG' => '推荐安装 SuiteCRM 的 PHP 版本是 %s <br />所需的最低 PHP 版本是 %s<br />您正在使用 PHP 版本是 %s， EOL： <a href="http://php.net/eol.php">http://php.net/eol.php</a>。<br />请考虑升级您的 PHP 版本。 ',
    ...
    'LBL_DBCONFIG_MSG2' => 'Web 服务器或数据库服务器的主机名称，例如：www.mydomain.com。如果是本地安装的数据库，建议填写 localhost 不要填写127.0.0.1。',
    ...
    'LBL_SYS_CHECK_WARNING' => '忽略系统检查警告',
    'LBL_PROCEED' => '继续',
    'LBL_RECHECK' => '重新检查',
    'LBL_CONFIG' => '配置',
    'LBL_VALIDATION_ERRORS' => '存在验证错误，无法执行操作。'
);
