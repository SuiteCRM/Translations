...
$mod_strings = array(
    ...
    'LBL_PUSH_CONTACTS_BUTTON_LABEL' => 'رابطوں کو کاپی کریں',
    'LBL_PUSH_CONTACTS_BUTTON_TITLE' => 'نقل کریں...',
    ...
    'LNK_IMPORT_ACCOUNTS' => 'اکاؤنٹس درآمد کریں',
    'MSG_DUPLICATE' => 'اکاؤنٹ ریکارڈ آپ نے جو بنایا ہے ہوسکتا ہے شاید ایک ہم شکل اکاؤنٹ کا ریکارڈ ہے جو پہلے ہی موجود ہے. اسی طرح کے نام ظاہر کرنے والے اکاؤنٹ ریکارڈ ذیل میں درج ہیں.<br> نیا اکاؤنٹ بنانے کے لئے اکاؤنٹ بنائیں پر کلک کریں، یا نیچے درج ذیل موجودہ اکاؤنٹ کو منتخب کریں.',
    'MSG_SHOW_DUPLICATES' => 'اکاؤنٹ ریکارڈ آپ نے جو بنایا ہے ہوسکتا ہے شاید ایک ہم شکل اکاؤنٹ کا ریکارڈ ہے جو پہلے ہی موجود ہے. اسی طرح کے نام ظاہر کرنے والے اکاؤنٹ ریکارڈ ذیل میں درج ہیں.<br> اس نئے اکاؤنٹ کو جاری رکھنے کے لئے محفوظ کریں پر کلک کریں، یا اکاؤنٹ بناۂے بغیر ماڈیول پر واپس جانے کیلئے منسوخ کریں پر کلک کریں.',
