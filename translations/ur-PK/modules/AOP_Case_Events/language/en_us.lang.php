...
$mod_strings = array(
    ...
    'LBL_REMOVE' => 'ہٹا دیں',
    'LBL_LIST_FORM_TITLE' => 'کیس تقریبات کی فہرست',
    'LBL_MODULE_NAME' => 'کیس تقریبات',
    'LBL_MODULE_TITLE' => 'کیس تقریبات',
    'LBL_HOMEPAGE_TITLE' => 'میرے کیس کی تقریبات',
    'LNK_NEW_RECORD' => 'کیس تقریبات بنائیں',
    'LNK_LIST' => 'کیس تقریبات دیکھیں',
    'LBL_SEARCH_FORM_TITLE' => 'کیس تقریبات تلاش کریں',
    'LBL_HISTORY_SUBPANEL_TITLE' => 'تاریخ دیکھیں',
    'LBL_ACTIVITIES_SUBPANEL_TITLE' => 'سرگرمیاں',
    'LBL_NEW_FORM_TITLE' => 'نئے کیس تقریبات',
