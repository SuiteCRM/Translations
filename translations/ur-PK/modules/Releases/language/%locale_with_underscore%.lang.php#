...
$mod_strings = array(
    ...
    'ERR_DELETE_RECORD' => 'آپ کے پاس مخصوص نمبر ہونا چاہیے ترک مٹانے کے لیے.',
    'NTC_STATUS' => 'اپنے درجہ کو بے حرکت مٹھائی ترک سے ڈراپ ڈاؤن فہرست میں سے',
    'NTC_LIST_ORDER' => 'اس کی رہائی میں ظاہر ہوں گے یہ حکم رہائی کے ڈراپ ڈاؤن فہرست میں سیٹ کریں',
    'release_status_dom' =>
        array(
            'Active' => 'فعال ہے',
