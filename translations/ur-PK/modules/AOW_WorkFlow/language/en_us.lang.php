...
$mod_strings = array(
    ...
    'LBL_LIST_NAME' => 'نام',
    'LBL_LIST_FORM_TITLE' => 'کام فلو کی فہرست',
    'LBL_MODULE_NAME' => 'کام فلو',
    'LBL_MODULE_TITLE' => 'کام فلو',
    'LBL_HOMEPAGE_TITLE' => 'میرا کام بہاؤ',
    'LNK_NEW_RECORD' => 'کام فلوبنائیں',
    'LNK_LIST' => 'ورک فلو دیکھیں',
    'LNK_PROCESSED_LIST' => 'پروسیسنگ آڈٹ دیکھیں',
    'LBL_SEARCH_FORM_TITLE' => 'کام کے لئے تلاش کریں',
    'LBL_HISTORY_SUBPANEL_TITLE' => 'تاریخ دیکھیں',
    'LBL_ACTIVITIES_SUBPANEL_TITLE' => 'سرگرمیاں',
    'LBL_NEW_FORM_TITLE' => 'نیا کام فلو',
    'LBL_FLOW_MODULE' => 'ورک فلو ماڈیول',
    'LBL_STATUS' => 'حیثیت',
    'LBL_FLOW_RUN_ON' => 'بھاگو',
    'LBL_CONDITION_LINES' => 'شرائط',
    'LBL_ADD_CONDITION' => 'شرط شامل کریں',
    'LBL_ACTION_LINES' => 'کسی چیز پر رد عمل دینا',
    'LBL_ADD_ACTION' => 'ایکشن شامل کریں',
    'LBL_MULTIPLE_RUNS' => 'بار بار چلتا ہے',
    'LBL_RUN_WHEN' => 'بهاگنا',
