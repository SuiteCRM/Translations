...
$mod_strings = array(
    ...
    'LBL_EMAIL_RECIPIENTS' => 'ای میل وصول کنندگان:',
    'NTC_DELETE_CONFIRMATION' => 'کیا آپ واقعی یہ ریکارڈ ختم کرنا چاہتے ہیں؟',
    'NTC_SNOOZE_CONFIRMATION' => 'Are you sure you want to snooze?',
    'LBL_LIST_FORM_TITLE' => 'شیڈول شدہ رپورٹ کی فہرست',
    'LBL_MODULE_NAME' => 'شیڈول رپورٹ',
    'LBL_MODULE_TITLE' => 'شیڈول رپورٹ',
    'LBL_HOMEPAGE_TITLE' => 'میری شیڈول رپورٹ',
    'LNK_NEW_RECORD' => 'شیڈول شدہ رپورٹ بنائیں',
    'LNK_LIST' => 'شیڈول شدہ رپورٹ دیکھیں',
    'LBL_SEARCH_FORM_TITLE' => 'تلاش شیڈول رپورٹ',
    'LBL_HISTORY_SUBPANEL_TITLE' => 'تاریخ دیکھیں',
    'LBL_NEW_FORM_TITLE' => 'نئی شیڈول شدہ رپورٹ',
    'LBL_SCHEDULE' => 'شیڈول',
    'LBL_AOR_REPORT_NAME' => 'شکایت کرنا',
    'LBL_SCHEDULED_REPORTS_INFORMATION' => 'شیڈول رپورٹ',
    'LBL_LAST_RUN' => 'آخری رن',
    'LBL_STATUS' => 'حیثیت',
);
