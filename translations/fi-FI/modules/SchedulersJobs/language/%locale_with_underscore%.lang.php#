...
$mod_strings = array(
    ...
    'LBL_RETRY_COUNT' => 'Uudelleenyrityksien enimmäismäärä',
    'LBL_FAIL_COUNT' => 'Virheet',
    'LBL_INTERVAL' => 'Lyhin aikaväli yritysten välillä',
    'LBL_CLIENT' => 'Owning client',
    'LBL_PERCENT' => 'Prosenttia valmiina',
// Errors
    'ERR_CALL' => "Ei voi kutsua toimintoa: %s",
    'ERR_CURL' => "CURL puuttuu - ei voi suorittaa URL-töitä",
    'ERR_FAILED' => "Unexpected failure, please check PHP logs and sugarcrm.log",
    'ERR_PHP' => "%s [%d]: %s %s rivillä %d",
    'ERR_NOUSER' => "No User ID specified for the job",
    'ERR_NOSUCHUSER' => "%s käyttäjätunnusta ei löydy",
