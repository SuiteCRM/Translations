...
$mod_strings = array(
    'LBL_CONSKEY' => 'Käyttäjätunnus',
    'LBL_CONSSECRET' => 'Käyttäjän salasana',
    ...
    'LBL_NAME' => 'Käyttäjätunnus',
    'LBL_CREATED_USER' => 'Tekijä',
    'LBL_MODIFIED_USER' => 'Muokkaaja',
    'LBL_LIST_NAME' => 'Key Name',
    'LBL_LIST_FORM_TITLE' => 'OAuth käyttöavaimet',
    'LBL_MODULE_NAME' => 'OAuth käyttöavaimet',
    'LBL_MODULE_TITLE' => 'OAuth käyttöavaimet',
    'LNK_NEW_RECORD' => 'Luo OAuth käyttöavain',
    'LNK_LIST' => 'Katso OAuth käyttöavaimet',
    'LBL_TOKENS' => 'Tokens',
);
