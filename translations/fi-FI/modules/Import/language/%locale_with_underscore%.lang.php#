...
$mod_strings = array(
    'LBL_RECORDS_SKIPPED_DUE_TO_ERROR' => 'Tietueita ei tuotu tapahtuneen virheen vuoksi.',
    'LBL_UPDATE_SUCCESSFULLY' => 'Tietueet päivitetty onnistuneesti',
    'LBL_SUCCESSFULLY_IMPORTED' => 'Tietueet luotu onnistuneesti',
    'LBL_STEP_4_TITLE' => 'Askel 4: tuo tiedosto',
    'LBL_STEP_5_TITLE' => 'Askel 5: Tarkastele tuotuja tietueita',
    'LBL_CUSTOM_ENCLOSURE' => 'Kenttien erotinmerkki:',
    'LBL_ERROR_UNABLE_TO_PUBLISH' => 'Ei voida julkaista. Samalla nimellä on jo julkaistu tuotu tiedosto (There is another published Import map by the same name).',
    'LBL_ERROR_UNABLE_TO_UNPUBLISH' => 'Unable to un-publish a map owned by another user. You own an Import map by the same name.',
    'LBL_ERROR_IMPORTS_NOT_SET_UP' => 'Tuonti ei ole asetettu mahdolliseksi tämän tyypin moduulissa',
    'LBL_IMPORT_TYPE' => 'Tuonnin toimenpiteet',
    'LBL_IMPORT_BUTTON' => 'Luo tietueet',
    'LBL_UPDATE_BUTTON' => 'Luo ja päivitä tietueet',
    ...
    'LBL_UPDATE_BUTTON_HELP' => 'Tämän vaihtoehdon avulla voit päivittää aiemmin luotuja tietueita. Tuontitiedoston tiedot etsitään aiemmin luotujen tietueiden tunnusten perusteella tuontitiedostossa.',
    'LBL_ERROR_INVALID_BOOL' => 'Virheellinen kyllä/ei (boolean) arvo',
    'LBL_IMPORT_ERROR' => 'Tuontivirheet:',
    'LBL_ERROR' => 'Virhe',
    ...
    'LBL_ID_EXISTS_ALREADY' => 'ID löytyy jo tästä taulusta',
    'LBL_ASSIGNED_USER' => 'Jos käyttäjää ei ole, käytä nykyistä',
    ...
    'LNK_DUPLICATE_LIST' => 'Lataa duplikaattien lista',
    'LNK_ERROR_LIST' => 'Lataa virhelista',
    ...
    'LBL_IMPORT_FIELDDEF_DATE' => 'Pvm',
    'LBL_IMPORT_FIELDDEF_ASSIGNED_USER_NAME' => 'Käyttäjänimi tai tunnus',
    'LBL_IMPORT_FIELDDEF_BOOL' => '\'0\' or \'1\'',
    'LBL_IMPORT_FIELDDEF_ENUM' => 'Lista',
    'LBL_IMPORT_FIELDDEF_EMAIL' => 'Ensisijainen sähköposti',
    ...
    'LBL_IMPORT_RECORDS_TO' => 'Vastaanottaja',
    ...
    'LBL_EXTERNAL_ASSIGNED_TOOLTIP' => 'Uusien tietueiden kohdistamiseen muille käyttäjälle kuin itsellesi, käytä Oletusarvo saraketta valitaksesi toisen käyttäjän.',
