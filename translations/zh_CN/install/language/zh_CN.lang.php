...
$mod_strings = array(
    ...
    'ERR_CHECKSYS_MBSTRING' => 'SuiteCRM 应用程序所需的 PHP 多字节字符串扩展 (mbstring) 函数未找到。通常，mbstring 模块在 PHP 中默认是不开启的，必须在构建 PHP 时通过 --enable-mbstring 参数激活。请参阅 PHP 手册以获取关于如何启用 mbstring 支持的更多信息。',
    ...
    'ERR_CHECKSYS_ROOT_NOT_WRITABLE' => '根目录当前不可写。您将无法继续安装。',
    ...
    'ERR_PERFORM_NO_TCPIP_SIMPLE' => '我们无法检测到互联网连接。',
    ...
    'LBL_CHECKSYS_OK' => 'OK',
    'LBL_CHECKSYS_PHP_INI' => 'PHP 配置文件的位置(php.ini)',
...
$contact_user_link_guid',
    ...
    'LBL_DBCONF_TITLE_USER_INFO_LABEL' => '用户',
