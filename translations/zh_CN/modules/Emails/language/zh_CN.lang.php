...
$mod_strings = array(
    ...
    'LBL_CONFIRM_DELETE_EMAIL' => '您确定要删除这封邮件吗？',
    ...
    'LBL_LIST_DATE' => '日期',
    'LBL_LIST_DATE_SENT_RECEIVED' => '发送/接收的日期',
    ...
    'LBL_BUTTON_DELETE_IMAP' => '从 IMAP 删除',
    'LBL_CASES_SUBPANEL_TITLE' => '客户反馈',
    'LBL_INBOUND_TITLE' => '邮件接收账户',
    'LBL_INTENT' => '目的',
    'LBL_MESSAGE_ID' => '消息ID',
    ...
    'LBL_QUICK_CREATE_SUCCESS1' => '已成功创建。',
    'LBL_QUICK_CREATE_SUCCESS2' => '单击 "确定" 查看新记录。',
    'LBL_QUICK_CREATE_SUCCESS3' => '单击 "取消" 返回到电子邮件。',
    ...
    'LBL_CONFIRM_OPT_IN_SENT_DATE' => '确认参加的电子邮件已发送',
    'LBL_CONFIRM_OPT_IN_FAIL_DATE' => '确认邮件失败',
    ...
    'ERR_FIELD_FROM_IS_NOT_SET' => '未设置 "From" 字段。',
    'ERR_FIELD_FROM_IS_EMPTY' => '“From”字段为空',
    'ERR_FIELD_FROM_IS_INVALID' => '"From" 字段无效。',
    'ERR_FIELD_FROM_ADDR_IS_NOT_SET' => '“From”地址未设置.',
    'ERR_FIELD_FROM_ADDR_IS_EMPTY' => '“From”地址为空',
    'ERR_FIELD_FROM_ADDR_IS_INVALID' => '"From" 地址无效。',
    'ERR_FIELD_FROMNAME_IS_NOT_SET' => '未设置 "From" 名称。',
    'ERR_FIELD_FROMNAME_IS_EMPTY' => '“From”名称为空',
    'ERR_FIELD_FROMNAME_IS_INVALID' => '“From”名称是无效的',
    'ERR_FIELD_FROM_NAME_IS_NOT_SET' => '未设置 "From" 名称。',
    'ERR_FIELD_FROM_NAME_IS_EMPTY' => '“From”名称为空',
    'ERR_FIELD_FROM_NAME_IS_INVALID' => '“From”名称是无效的',
    'ERR_FIELD_FROM_ADDR_NAME_IS_NOT_SET' => '“From”地址和名称对未设置',
    'ERR_FIELD_FROM_ADDR_NAME_IS_EMPTY' => '“From”地址和名称对为空',
    'ERR_FIELD_FROM_ADDR_NAME_IS_INVALID' => '“From”地址和名称对无效',
    'ERR_FIELD_FROM_ADDR_NAME_DOESNT_MATCH_REGEX' => '“From”地址和名称对格式不对，使用"from@emailaddress.org <Name of Person>" 这样的格式。',
    'ERR_FIELD_FROM_ADDR_NAME_INVALID_NAME_PART' => '地址和名称对中名称无效',
    'ERR_FIELD_FROM_ADDR_NAME_INVALID_EMAIL_PART' => '地址和名称对中邮箱地址无效',
    'ERR_FIELD_FROM_ADDR_NAME_INVALID_EMAIL_PART_TO_FIELD_FROM' => '“From”地址和名称对与from名称或邮件地址不匹配',
    'ERR_FIELD_FROM_ADDR_NAME_INVALID_EMAIL_PART_TO_FIELD_FROM_ADDR' => '“From”地址和名称对与from邮件地址不匹配',
    'ERR_FIELD_FROM_ADDR_NAME_INVALID_EMAIL_PART_TO_FIELD_FROMNAME' => '“From”地址和名称对与from名称不匹配',
    'ERR_FIELD_FROM_ADDR_NAME_INVALID_EMAIL_PART_TO_FIELD_FROM_NAME' => '“From”地址和名称对与from名称不匹配',
