...
$mod_strings = array(
    ...
    'LBL_MODULE_TITLE' => '合并记录',
    'LBL_SEARCH_FORM_TITLE' => '搜索',
    'LBL_LIST_FORM_TITLE' => '合并记录列表',

    'LBL_LBL_MERGE_RECORDS_STEP_1' => '搜索记录与合并',
    'LBL_AVAIL_FIELDS' => '可用的字段',
    'LBL_FILTER_COND' => '筛选条件',
    'LBL_MERGE_VALUE_OVER' => '合并值为',

    'LBL_NEXT_STEP_TITLE' => '转到下一步',
    ...
    'LBL_PROCEED' => '是否继续？',
    'LBL_STEP1_DIRECTIONS' => '查找可能的重复记录。如果发现可能重复的记录，您可以选择与当前记录合并。',
);
