...
$mod_strings = array(
    ...
    'LBL_NAME' => '系统名称',
    'LBL_PROSPECT_INFORMATION' => '客户信息', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
    ...
    'LBL_DEFAULT_SUBPANEL_TITLE' => '查看目标',
