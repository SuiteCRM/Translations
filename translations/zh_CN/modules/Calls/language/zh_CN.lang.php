...
$mod_strings = array(
    ...
    'LBL_ADD_BUTTON' => '添加',
    'LBL_DEFAULT_SUBPANEL_TITLE' => '查看电话',
    ...
    'LBL_CALL_INFORMATION' => '客户信息', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
    'LBL_REMOVE' => '移除',
