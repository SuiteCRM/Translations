...
$mod_strings = array(
    ...
    'LBL_RESOLUTION_BUTTON' => '附加信息',
    'LBL_SUGGESTION_BOX_STATUS' => '状态',
    'LBL_SUGGESTION_BOX_TITLE' => '名称',
    ...
    'LBL_CASE_INFORMATION' => '客户信息', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
