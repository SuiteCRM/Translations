...
//POPUP HELP
    ...
    'LBL_POPHELP_IMPORTABLE' => '<b>是</b>: 该字段将包含在导入操作中。<br><b>无</b>: 此字段将不包含在导入中。<br><b>必需</b>: 在任何导入中必须提供字段的值。',
    'LBL_POPHELP_IMAGE_WIDTH' => '输入一个以像素为单位的宽度值。<br>上传的图片将被缩放到这个宽度。',
    'LBL_POPHELP_IMAGE_HEIGHT' => '输入一个以像素为单位的高度值。<br>上传的图片将被缩放到这个高度。',
    'LBL_POPHELP_DUPLICATE_MERGE' => '<b>启用</b>：该字段将显示在“合并重复”功能中，但不可用于“查找重复”功能中的筛选条件。<br><b>禁用</b>：该字段不显示在“合并重复”功能中，也不可用于“查找重复”功能中的筛选条件。<br><b>筛选</b>：该字段将显示在“合并重复”功能中，也可用于“查找重复”功能中的筛选条件。<br><b>默认筛选</b>：该字段将显示在“合并重复”功能中，并用于“查找重复”功能中的默认筛选条件。<br><b>仅筛选</b>：该字段不显示在“合并重复”功能中，但可用于“查找重复”功能中的筛选条件。',
