...
$mod_strings = array(
    ...
    'LBL_DATE_TIME' => '日期/时间',
    'LBL_DATE' => '日期',
    'LBL_DEFAULT_SUBPANEL_TITLE' => '查看会议',
    'LBL_DESCRIPTION' => '说明',
    'LBL_DIRECTION' => '方向',
    ...
    'LBL_MEETING_INFORMATION' => '客户信息', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
    ...
    'LBL_GSYNC_LASTSYNC' => '最近的Google Sync Timestamp',
);
