...
//       it is the key for the default opportunity_relationship_type_dom value
    'opportunity_relationship_type_default_key' => '主要决策者',
...
$app_strings = array(
    'LBL_SEARCH_RESULTS_TITLE' => '错误',
    'ERR_SEARCH_INVALID_QUERY' => '搜索出错。输入的搜索内容格式可能不对。',
    'ERR_SEARCH_NO_RESULTS' => '没有符合您的搜索条件的结果。尝试扩大搜索范围。',
    'LBL_SEARCH_PERFORMED_IN' => '在下列范围搜索',
    'LBL_EMAIL_CODE' => '邮件验证码：',
    'LBL_SEND' => '发送',
    'LBL_SEND_BUTTON_TITLE' => '发送',
    'LBL_LOGOUT' => '注销',
    'LBL_LOGOUT_SUCCESS' => '成功登出',
    'LBL_LOGGED_OUT_MESSAGE' => '您已注销',
    'LBL_LOGIN_AGAIN' => '重新登录 ',
    'LBL_TOUR_NEXT' => '下一步',
    'LBL_TOUR_SKIP' => '跳过',
    'LBL_TOUR_BACK' => '返回',
    ...
    'LBL_OAUTH_CONNECTION_NOT_SET' => '请设置外部 OAuth 连接。',
    'LBL_EMAIL_PASSWORD_NOT_SET' => '警告：没有设置密码。',
    'LBL_EMAIL_WARNING_MISSING_CREDS' => '警告：缺少凭据',
    ...
    'LBL_EMAIL_ADDRESS_BOOK_FILTER' => '搜索',
    ...
    'LBL_EMAIL_ADDRESS_OPT_IN' => '您已确认用您的电子邮件地址参加：',
    'LBL_EMAIL_ADDRESS_OPT_IN_ERR' => '无法确认电子邮件地址',
    'LBL_EMAIL_ARCHIVE_TO_SUITE' => '导入',
    ...
    'LBL_EMAIL_EMPTY_MSG' => '没有可显示的邮件。',
    'LBL_EMAIL_EMPTY_ADDR_MSG' => '没有可显示的邮箱地址。',
    ...
    'LBL_EMAIL_ERROR_GENERAL_TITLE' => '出现一个错误',
    ...
    'LBL_EMAIL_FROM' => '发件人地址',
    'LBL_EMAIL_GROUP' => '组',
    'LBL_EMAIL_UPPER_CASE_GROUP' => '分组',
    ...
    'LBL_EMAIL_SETTINGS_ACCOUNTS' => '邮件接收账户',
    ...
    'LBL_EMAIL_TEST_SEE_FULL_SMTP_LOG' => '请参阅完整的 SMTP 日志',
    ...
    'LBL_EMAIL_ERROR_PREPEND' => '出现一个邮件问题：',
    ...
    'LBL_EMAIL_SUITE_FOLDER' => 'SuiteCRM 文件夹',
    'LBL_EMAIL_TEMPLATE_EDIT_PLAIN_TEXT' => '邮件模板的正文为空',
    'LBL_EMAIL_TEMPLATES' => '选择模板',
    'LBL_EMAIL_TO' => '收件人',
    'LBL_EMAIL_VIEW' => '查看',
    ...
    'ERR_UNAUTHORIZED_PAGE_ACCESS' => '您无权查看此页面。请联系您的系统管理员。',
    'ERR_UNAUTHORIZED_PAGE_ACCESS_TO_HOME_PAGE' => '您无权查看此页面。重定向到主页...',
    ...
    'LBL_CHARSET' => 'UTF-8',
    'LBL_CHARTS' => '图表',
    'LBL_QUICK_CHARTS' => '快速图表',
    'LBL_QUICK_HISTORY' => '时间线',
    'LBL_CHECKALL' => '全选',
    'LBL_CITY' => '城市',
    ...
    'LBL_CLOSE_AND_CREATE_BUTTON_TITLE' => '关闭并创建',
    ...
    'LBL_LAST_VIEWED_NO_RESULT' => '无最近查看的项目',
    'LBL_LEADS' => '潜在客户',
    'LBL_LESS' => '少于',
    'LBL_CAMPAIGN' => '营销活动',
    'LBL_CAMPAIGNS' => '营销活动',
    ...
    'LBL_IN_EVERYWHERE' => '在任意地方',
    'LBL_LIST_ACCOUNT_NAME' => '客户名称',
    'LBL_LIST_ASSIGNED_USER' => '用户名',
    ...
    'LBL_CANCEL' => '取消',
    'LBL_SNOOZE' => '暂停',
    'LBL_SNOOZE_INLINE_CONFIRM' => '暂停？ ({{preferences.snooze_alert_timer|enum:snooze_alert_timer_simple}})',
    'LBL_DISMISS' => '关闭',
    ...
    'LBL_ALERT_DISMISS_ERROR' => '尝试关闭提醒时出错',
    'LBL_ALERT_DISMISS_ALL_SUCCESS' => '提醒已关闭',
    'LBL_DISMISS_ALL' => '全部关闭',
    'LBL_VERIFY' => '验证',
    'LBL_RESEND' => '重新发送',
    'LBL_RECORD_DOES_NOT_EXIST' => '检索记录时出错。此记录可能已被删除，或者您没有权限。',
    'LBL_PROFILE' => '个人配置',
    'LBL_PROFILE_EDIT' => '编辑资料',
    'LBL_MAILMERGE' => '邮件合并',
    'LBL_MASS_UPDATE' => '批量更新',
    'LBL_NO_MASS_UPDATE_FIELDS_AVAILABLE' => '没有支持批量更新操作的字段',
    'LBL_OPT_OUT_FLAG_PRIMARY' => '选择退出主邮件',
    'LBL_OPT_IN_FLAG_PRIMARY' => '参加用的邮箱',
    'LBL_MEETINGS' => '查看会议',
    ...
    'LBL_FILTER' => '搜索',
    'LBL_CLEAR_FILTER' => '清除筛选器',
    'LBL_FILTER_MODULES' => '过滤模块',
    'LBL_SEARCH' => '搜索',
    'LBL_SEARCH_ALT' => '',
    'LBL_SEARCH_MORE' => '更多',
    ...
    'LBL_ACCESSKEY_CLEAR_FILE_TITLE' => '清除列表',
    'LBL_ACCESSKEY_CLEAR_FILE_LABEL' => '清除列表',
    ...
    'LBL_ACCESSKEY_CLEAR_ACCOUNTS_TITLE' => '清除帐户',
    'LBL_ACCESSKEY_CLEAR_ACCOUNTS_LABEL' => '清除帐户',
    ...
    'NTC_TEMPLATES_IS_USED' => '以下模板用于邮件营销记录，确认是否删除这些模版？' . PHP_EOL,
    ...
    'NTC_DELETE_SELECTED_RECORDS' => ' 已选的记录？',
    ...
    'ERROR_JS_ALERT_SYSTEM_CLASS' => '系统设置',
    ...
    'LBL_MAX_DASHLETS_REACHED' => '您组件的个数已经达到管理员设置的上限。请先移除一个现有的，再添加新的组件。',
    'LBL_ADDING_DASHLET' => '正在添加组件...',
    'LBL_ADDED_DASHLET' => 'Dashlet 已添加',
    'LBL_REMOVE_DASHLET_CONFIRM' => '您确定要移除此 Dashlet ？',
    'LBL_REMOVING_DASHLET' => '正在移除组件...',
    ...
    'LBL_RELOAD_PAGE' => '请重新<a href="javascript:window.location.reload()">刷新页面</a>来使用此组件。',
    'LBL_ADD_DASHLETS' => '添加组件',
    ...
    'ERR_MISSING_MAPPING_ENTRY_FORM_MODULE' => '错误：模块缺少映射入口。',
...
“5.在程序里的行动目录中点击导入选项，选择上传文件。”',
    ...
    'ERR_NOTIFICATIONS_MARK_AS_READ' => '试图标记通知为已读时出错',
    'ERR_FIELD_LOGIC_BACKEND_CALCULATION' => '尝试获取值时出错',
    ...
    'LBL_BULK_ACTION_BUTTON_LABEL_MOBILE' => '动作',
    'LBL_TOO_FEW_SELECTED' => '所选记录数目无效，您最少要选择 {min} 项。',
    'LBL_TOO_MANY_SELECTED' => '所选记录数目无效，您最多可选择 {max} 项。',
    'LBL_SELECT_ALL_NOT_ALLOWED' => '选择所有记录不可用于此操作。请选择单个记录。',
    'LBL_MISSING_HANDLER_DATA' => '意外错误。响应中缺少批处理数据',
    'LBL_MISSING_HANDLER' => '意外错误。未定义批处理程序',
    'LBL_MISSING_HANDLER_DATA_ROUTE' => '意外错误。缺少批处理路径',
    'LBL_ACTION_ERROR' => '调用操作时发生意外错误',
    'LBL_BULK_ACTION_ERROR' => '调用批处理操作时发生意外错误',
    'LBL_BULK_ACTION_DELETE_SUCCESS' => '记录成功删除',
    'LBL_BULK_ACTION_MASS_UPDATE_CONFIRMATION' => '你确定要更新这些选定的记录的吗?',
    'LBL_BULK_ACTION_MASS_UPDATE_SUCCESS' => '所有记录已被成功更新',
    'LBL_BULK_ACTION_MASS_UPDATE_PARTIAL_SUCCESS' => '部分成功。部分记录未更新。请检查日志',
    'LBL_BULK_ACTION_MASS_UPDATE_NO_FIELDS' => '没有要更新的字段',
    'LBL_BULK_ACTION_MASS_UPDATE_NO_RECORDS' => '没有要更新的记录',
    'LBL_BULK_ACTION_MASS_UPDATE_NO_ACLS' => '权限不足，不允许保存操作',
    'LBL_UNEXPECTED_ERROR' => '意外错误。无法执行操作。',
    'LBL_RECORD_DELETE_SUCCESS' => '记录删除成功',
    'LBL_RECORD_DELETE_ALL_SUCCESS' => '记录成功删除',
    'LBL_RECORD_SNOOZE_SUCCESS' => '通知免打扰',
    'LBL_ERROR_SAVING' => '保存记录时出错',
    ...
    'LBL_TYPE' => '类型',
    'LBL_DATE_START' => '开始日期',
    'LBL_SEND_DATE' => '发送日期/时间',
    'LBL_SCHEDULE_BUTTON_LABEL' => '任务计划',
    ...
    'ANNUAL_REVENUE_BY_ACCOUNTS' => '按客户年收入',
    'PIPELINE_BY_SALES_STAGE' => '销售阶段管道',
    'LEADS_BY_SOURCE' => '按潜在客户来源',
    'LEADS_BY_STATUS' => '潜在客户状态',
    'ACCOUNT_TYPES_PER_MONTH' => '按月度新客户',

    'ERR_CONNECTOR_NOT_ARRAY' => '连接器中的 {0} 配置不正确或无法使用。',
    'ERR_SUHOSIN' => '',
    'ERR_BAD_RESPONSE_FROM_SERVER' => '服务器未正确响应',
    'LBL_ACCOUNT_PRODUCT_QUOTE_LINK' => '报价',
    'LBL_ACCOUNT_PRODUCT_SALE_PRICE' => '成交单价',
    ...
    'LBL_COLUMN_CHOOSER' => '列选择器',
    'LBL_SAVE_CHANGES_BUTTON_TITLE' => '保存更改',
    'LBL_DISPLAYED' => '已显示',
    'LBL_HIDDEN' => '已隐藏',
    'ERR_EMPTY_COLUMNS_LIST' => '至少需要一个元素',

    'LBL_FILTER_HEADER_TITLE' => '搜索',

    'LBL_CATEGORY' => '类别',
    'LBL_LIST_CATEGORY' => '类别',
    'ERR_FACTOR_TPL_INVALID' => '验证消息无效，请联系管理员',
    'LBL_SUBTHEMES' => '样式',
    ...
    'LBL_CONFIRM_DISREGARD_EMAIL_TITLE' => '退出撰写对话框',
    'LBL_CONFIRM_DISREGARD_EMAIL_BODY' => '通过离开撰写对话框, 所有输入的信息都将丢失, 您想继续吗？',
    'LBL_CONFIRM_APPLY_EMAIL_TEMPLATE_TITLE' => '应用邮件模板',
    'LBL_CONFIRM_APPLY_EMAIL_TEMPLATE_BODY' => '此操作将覆盖邮件正文和主题，是否继续？',

    'LBL_CONFIRM_OPT_IN_TITLE' => '确认参与',
    'LBL_OPT_IN_TITLE' => '选择参加',
    'LBL_CONFIRM_OPT_IN_DATE' => '确认参与日期',
    'LBL_CONFIRM_OPT_IN_SENT_DATE' => '确认参与邮件发送日期',
    'LBL_CONFIRM_OPT_IN_FAIL_DATE' => '确认参与失败日期',
    'LBL_CONFIRM_OPT_IN_TOKEN' => '确认选择参加标记',
    'ERR_OPT_IN_TPL_NOT_SET' => '3153904197@qq.com',
    'ERR_OPT_IN_RELATION_INCORRECT' => '选择参与需要与客户/联系人/潜在顾客/目标相关的电子邮件地址',

    'LBL_SECURITYGROUP_NONINHERITABLE' => '不可继承的组',
    ...
    'LBL_SEND_CONFIRM_OPT_IN_EMAIL' => '发送关于确认选择参加的电子邮件',
    'LBL_CONFIRM_OPT_IN_ONLY_FOR_PERSON' => '确认选择只接受客户/联系人/潜在顾客/潜在客户的邮件',
    'LBL_CONFIRM_OPT_IN_IS_DISABLED' => '确认选择接受邮件选项已经关闭，请在邮箱设置的开通确认参加选项或联系您的管理员',
    'LBL_CONTACT_HAS_NO_PRIMARY_EMAIL' => '因为联系人没添加主要电子邮件地址，无法确认选择接受邮件',
    'LBL_CONFIRM_EMAIL_SENDING_FAILED' => '确认选择接受邮件失败',
    'LBL_CONFIRM_EMAIL_SENT' => '成功确认选择接受邮件',
    ...
    'LBL_COLUMN_SELECTOR_DISPLAYED_COLS' => '已显示',
    'LBL_COLUMN_SELECTOR_HIDDEN_COLS' => '隐藏',
    'LBL_COLUMN_SELECTOR_CLOSE_BUTTON' => '关闭',
    'LBL_COLUMN_SELECTOR_SAVE_BUTTON' => '保存更改',
    'LBL_COLUMN_SELECTOR_MODAL_TITLE' => '选择列',
...
$app_list_strings['moduleList']['EmailAddresses'] = 'Email 地址';
...
$app_list_strings['moduleList']['AOK_Knowledge_Base_Categories'] = '知识库类别';
...
$app_list_strings['moduleList']['FP_events'] = '会展';
...
//aop
$app_list_strings['case_state_default_key'] = '打开';
...
$app_list_strings['aor_operator_list']['Starts_With'] = '开始为';
...
$app_list_strings['aor_function_list']['COUNT'] = '分数';
...
$app_list_strings['aor_total_options']['COUNT'] = '分数';
$app_list_strings['aor_total_options']['SUM'] = '求和';
...
$app_list_strings['aor_email_type_list']['Specify User'] = '用户名';
...
$app_list_strings['date_time_period_list']['today'] = '查看日历';
...
$app_list_strings['contract_status_list']['In Progress'] = '正在执行';
...
$app_list_strings['aow_operator_list']['Starts_With'] = '开始为';
...
$app_list_strings['aow_process_status_list']['Pending'] = '待审';
...
$app_list_strings['aow_date_type_list']['week'] = '星期';
...
$app_list_strings['aow_date_options']['today'] = '查看日历';
...
$app_list_strings['aow_email_type_list']['Specify User'] = '用户名';
...
$app_list_strings['marker_image_list']['company'] = '客户名称';
$app_list_strings['marker_image_list']['conference'] = '研讨会';
...
$app_strings['LBL_RESCHEDULE_LABEL'] = '电话重排';
...
$app_strings['LBL_RESCHEDULE_PANEL'] = '电话重排';
...
$app_list_strings['moduleList']['ExternalOAuthConnection'] = '外部 OAuth 连接';
$app_list_strings['moduleList']['ExternalOAuthProvider'] = '外部 OAuth 提供程序';

//social
$app_strings['FACEBOOK_USER_C'] = 'Facebook';
$app_strings['TWITTER_USER_C'] = 'Twitter';
$app_strings['LBL_PANEL_SOCIAL_FEED'] = '社交动态';

$app_strings['LBL_SUBPANEL_FILTER_LABEL'] = '搜索';

$app_strings['LBL_COLLECTION_TYPE'] = '类型';

$app_strings['LBL_ADD_TAB'] = '添加';
$app_strings['LBL_EDIT_TAB'] = '编辑标签';
$app_strings['LBL_SUITE_DASHBOARD'] = '看板';
...
$app_strings['LBL_SUITE_DASHBOARD_ACTIONS'] = '操作';
...
$app_list_strings['moduleList']['SurveyResponses'] = '调查答复';
$app_list_strings['moduleList']['Surveys'] = '调查问卷';
$app_list_strings['moduleList']['SurveyQuestionResponses'] = '调查问卷的回复';
$app_list_strings['moduleList']['SurveyQuestions'] = '调查问卷';
$app_list_strings['moduleList']['SurveyQuestionOptions'] = '调查问卷选项';
$app_list_strings['survey_status_list']['Draft'] = '草稿';
$app_list_strings['survey_status_list']['Public'] = '公共';
$app_list_strings['survey_status_list']['Closed'] = '已关闭';
$app_list_strings['surveys_question_type']['Text'] = '文本';
$app_list_strings['surveys_question_type']['Textbox'] = '文本框';
$app_list_strings['surveys_question_type']['Checkbox'] = '复选框';
$app_list_strings['surveys_question_type']['Radio'] = '单选';
$app_list_strings['surveys_question_type']['Dropdown'] = '下拉列表';
$app_list_strings['surveys_question_type']['Multiselect'] = '多选';
$app_list_strings['surveys_question_type']['Matrix'] = '矩阵';
$app_list_strings['surveys_question_type']['DateTime'] = '日期时间';
$app_list_strings['surveys_question_type']['Date'] = '日期';
$app_list_strings['surveys_question_type']['Scale'] = '刻度';
$app_list_strings['surveys_question_type']['Rating'] = '评分';
$app_list_strings['surveys_matrix_options'][0] = '满意';
$app_list_strings['surveys_matrix_options'][1] = '一般';
$app_list_strings['surveys_matrix_options'][2] = '不满意';

$app_strings['LBL_OPT_IN_PENDING_EMAIL_NOT_SENT'] = '待定确认选择参加，参加证实未发送';
$app_strings['LBL_OPT_IN_PENDING_EMAIL_FAILED'] = '确认选择参加接受邮件失败';
$app_strings['LBL_OPT_IN_PENDING_EMAIL_SENT'] = '待定确认选择参加，参加证实已发送';
$app_strings['LBL_OPT_IN'] = '已确认参加';
$app_strings['LBL_OPT_IN_CONFIRMED'] = '确认选择参加';
$app_strings['LBL_OPT_IN_OPT_OUT'] = '选择退出';
$app_strings['LBL_OPT_IN_INVALID'] = '无效';

/** @see SugarEmailAddress */
$app_list_strings['email_settings_opt_in_dom'] = array(
    'not-opt-in' => '已禁用',
    'opt-in' => '选择参加',
    'confirmed-opt-in' => '确认参与'
);
...
$app_strings['RESPONSE_SEND_CONFIRM_OPT_IN_EMAIL'] = '已经将确认选择参加接受邮件的邮箱地址 %s 添加的邮件队列 ';
$app_strings['RESPONSE_SEND_CONFIRM_OPT_IN_EMAIL_NOT_OPT_IN'] = '因为 %s 电子邮箱没选择参加，所以无法发送邮件到该邮件地址 ';
$app_strings['RESPONSE_SEND_CONFIRM_OPT_IN_EMAIL_MISSING_EMAIL_ADDRESS_ID'] = '%s 电子邮件地址没有有效 id';

$app_strings['ERR_TWO_FACTOR_FAILED'] = '双重认证失败';
$app_strings['ERR_TWO_FACTOR_CODE_SENT'] = '双重认证码已发';
$app_strings['ERR_TWO_FACTOR_CODE_FAILED'] = '发送双重认证码失败';
$app_strings['LBL_THANKS_FOR_SUBMITTING'] = '感谢提交你的情况!';

$app_strings['ERR_IP_CHANGE'] = '由于您的 IP 地址有大更改而终止了您的会话';
$app_strings['ERR_RETURN'] = '返回首页';
...
$app_list_strings['search_controllers'] = [
    'Search' => '搜索 (新)',
    'UnifiedSearch' => '全局统一搜索 (遗留)'
];


$app_strings['LBL_DEFAULT_API_ERROR_TITLE'] = 'JSON API 错误';
$app_strings['LBL_DEFAULT_API_ERROR_DETAIL'] = '出现 JSON API 错误';
$app_strings['LBL_API_EXCEPTION_DETAIL'] = 'Api 版本: 8';
$app_strings['LBL_BAD_REQUEST_EXCEPTION_DETAIL'] = '请确保填写所需的字段';
$app_strings['LBL_EMPTY_BODY_EXCEPTION_DETAIL'] = 'Json API 要求请求的正文为 JSON';
$app_strings['LBL_INVALID_JSON_API_REQUEST_EXCEPTION_DETAIL'] = '无法验证 Json Api 有效负载请求';
$app_strings['LBL_INVALID_JSON_API_RESPONSE_EXCEPTION_DETAIL'] = '无法验证 Json Api 有效负载响应';
$app_strings['LBL_MODULE_NOT_FOUND_EXCEPTION_DETAIL'] = 'Json API 找不到资源';
$app_strings['LBL_NOT_ACCEPTABLE_EXCEPTION_DETAIL'] = 'Json api 要求 "接受" 标头是应用程序/vnd. api + json';
$app_strings['LBL_UNSUPPORTED_MEDIA_TYPE_EXCEPTION_DETAIL'] = 'Json api 要求 "接受" 标头是应用程序/vnd. api + json';

$app_strings['MSG_BROWSER_NOTIFICATIONS_ENABLED'] = '此浏览器已开启桌面通知。';
$app_strings['MSG_BROWSER_NOTIFICATIONS_DISABLED'] = '此浏览器禁用桌面通知。请在浏览器设置开启选项。';
$app_strings['MSG_BROWSER_NOTIFICATIONS_UNSUPPORTED'] = '此浏览器不支持桌面通知。';

$app_strings['LBL_GOOGLE_SYNC_ERR'] = '谷歌同步-错误';
$app_strings['LBL_THERE_WAS_AN_ERR'] = '出现了错误： ';
$app_strings['LBL_CLICK_HERE'] = '单击此处';
$app_strings['LBL_TO_CONTINUE'] = ' 以继续。';
$app_strings['LBL_OPT_OUT'] = '退订';
$app_strings['LBL_INVALID_EMAIL'] = '无效';
$app_strings['LBL_PRIMARY'] = '主要';
$app_strings['LBL_EMAIL_ADDRESS'] = 'Email 地址';

$app_strings['IMAP_HANDLER_ERROR'] = '错误: {error}; key是: "{key}"。';
$app_strings['IMAP_HANDLER_SUCCESS'] = '好的: 测试设置更改为 "{key}"';
$app_strings['IMAP_HANDLER_ERROR_INVALID_REQUEST'] = '请求无效, 使用 "{var}"作为 值。';
$app_strings['IMAP_HANDLER_ERROR_UNKNOWN_BY_KEY'] = '发生未知错误, key "{key}"未保存。';
$app_strings['IMAP_HANDLER_ERROR_NO_TEST_SET'] = '测试设置不存在。';
$app_strings['IMAP_HANDLER_ERROR_NO_KEY'] = 'Key未找到';
$app_strings['IMAP_HANDLER_ERROR_KEY_SAVE'] = 'Key保存错误。';
$app_strings['IMAP_HANDLER_ERROR_UNKNOWN'] = '未知错误';
$app_strings['LBL_SEARCH_TITLE']                   = '搜索';
$app_strings['LBL_SEARCH_TEXT_FIELD_TITLE_ATTR']   = '输入搜索条件';
$app_strings['LBL_SEARCH_SUBMIT_FIELD_TITLE_ATTR'] = '搜索';
$app_strings['LBL_SEARCH_SUBMIT_FIELD_VALUE']      = '搜索';
$app_strings['LBL_SEARCH_QUERY']                   = '搜索条件： ';
$app_strings['LBL_SEARCH_RESULTS_PER_PAGE']        = 'Results per module: ';
$app_strings['LBL_SEARCH_ENGINE']                  = '搜索引擎： ';
$app_strings['LBL_SEARCH_TOTAL'] = '总数: ';
$app_strings['LBL_SEARCH_PREV'] = '上页';
$app_strings['LBL_SEARCH_NEXT'] = '下一步';
$app_strings['LBL_SEARCH_PAGE'] = '页面 ';
$app_strings['LBL_SEARCH_OF'] = ' 的 ';
$app_strings['LBL_INSIGHTS'] = '数据分析';
$app_strings['LBL_CHARTS'] = '图表';
$app_strings['LBL_CHART_NOT_FOUND'] = '未找到图表';
$app_strings['LBL_NO_DATA'] = '无数据';
$app_strings['LBL_ERROR_FETCHING_METADATA'] = '获取元数据时出错';
$app_strings['LBL_TOTAL'] = '总计';
$app_strings['LBL_ACTIONS'] = '动作';
$app_strings['LBL_SELECT_SUBPANEL_BANNER'] = '选择要查看的子面板';
$app_strings['LBL_SELECT_ITEM'] = '选择一项';
$app_strings['LBL_ITEMS_SELECTED'] = '已选项目';
$app_strings['LBL_WIDGET_NOT_FOUND'] = '部件未找到';
$app_strings['LBL_BAD_CONFIG'] = '配置不正确';
$app_strings['LBL_CONFIG_BAD_CONTEXT'] = '配置错误：上下文配置不正确';
$app_strings['LBL_CONFIG_NO_CONFIG'] = '配置错误：缺少配置';
$app_strings['LBL_CONFIG_NO_STATISTICS_KEY'] = '配置错误：缺少统计密钥';
$app_strings['LBL_STATISTIC_ERROR'] = '加载统计时出错';
$app_strings['LBL_STATISTIC_ERROR_DESC'] = '加载统计时出错';
$app_strings['LBL_STATISTIC_ERROR_DESC_TOOLTIP'] = '加载统计时出错。请联系您的管理员';
$app_strings['LBL_AVERAGE_CLOSED_WON_PER_YEAR'] = '年均赢得机会';
$app_strings['LBL_OPPORTUNITIES_TOTAL'] = '总商业机会值';
$app_strings['LBL_CASE_TOTAL_DAYS_OPEN'] = '总开放天数';
$app_strings['LBL_DAYS_OPEN'] = '开放天数';
$app_strings['LBL_DAYS_IN_SALE_STAGE'] = 'DAY(S) THIS OPPORTUNITY HAS BEEN AT THIS SALES STAGE';
$app_strings['LBL_STAT_DAYS'] = '天';
$app_strings['LBL_CLOSED_PER_YEAR'] = '按年关闭';
$app_strings['LBL_WAS_OPEN'] = '此案例已打开';
$app_strings['LBL_HAS_BEEN_OPEN'] = '此案例已打开';
$app_strings['LBL_NUMBER_OF_CASES_PER_ACCOUNT'] = '每客户案例数';
$app_strings['LBL_TOTAL_CASES_FOR_THIS_ACCOUNT'] = 'Total Cases For This Account';
$app_strings['LBL_NONE_OUTSTANDING'] = '无';
$app_strings['LBL_VALIDATION_ERROR_REQUIRED'] = '缺少必要字段：{{fields.field.label}}';
$app_strings['LBL_VALIDATION_ERROR_CURRENCY_FORMAT'] = "无效货币格式。期望格式：“{{context.expected}}”";
$app_strings['LBL_VALIDATION_ERROR_INT_FORMAT'] = "无效整数格式。期望格式：“{{context.expected}}”";
$app_strings['LBL_VALIDATION_ERROR_FLOAT_FORMAT'] = "无效浮点数格式。期望格式：“{{context.expected}}”";
$app_strings['LBL_VALIDATION_ERROR_DATE_FORMAT'] = "无效的日期格式。预期日期格式：'{{context.expected}}'";
$app_strings['LBL_VALIDATION_ERROR_DATETIME_FORMAT'] = "无效的日期时间格式。期望：'{{context.expected}}'";
...
$app_strings['LBL_VALIDATION_ERROR_EMAIL_FORMAT'] = "无效邮箱格式。期望格式：“{{context.expected}}”";
$app_strings['LBL_VALIDATION_ERROR_PHONE_FORMAT'] = "无效的电话号码格式。";
$app_strings['LBL_VALIDATION_ERROR_MIN'] = "无效值。值必须大于或等于 '{{context.min}}'";
$app_strings['LBL_VALIDATION_ERROR_MAX'] = "无效值。值必须小于或等于 '{{context.max}}'";
$app_strings['LBL_MULTIPLE_PRIMARY_EMAIL_VALIDATION_ERROR'] = "Only one Valid Email Address should be marked as primary";
$app_strings['LBL_DUPLICATE_EMAIL_VALIDATION_ERROR'] = "不允许重复的电子邮件地址";
...
$app_strings['LBL_VALIDATION_ERRORS'] = '存在验证错误，无法执行操作。';
$app_strings['LBL_LOADING_IN_PROGRESS'] = '计算目前正在进行，请稍等几分钟后再试。';
$app_strings['LBL_SELECT_EMAIL_FOR_TEST'] = 'Please Select Targets/ Users or Enter an Email';
$app_strings['LBL_TYPE_TO_SEARCH'] = '键入搜索内容...';
$app_strings['LBL_SEARCHING'] = '搜索中...';
$app_strings['LBL_NOT_FOUND'] = '未找到。';
$app_strings['LBL_SEARCH_ERROR'] = '搜索错误。';
$app_strings['LBL_FOUND'] = '找到';
$app_strings['LBL_GET_RECORD_LIST_ERROR'] = '获取记录时出错';
$app_strings['LBL_NUMBER_OF_RECORDS'] = '记录数';
...
$app_strings['LBL_CONTRACT_RENEWAL_TOOLTIP'] = '下次合同续订日期';
$app_strings['LBL_INVOICES_OVERDUE_TOOLTIP'] = '过期发票总数';
$app_strings['LBL_ACTIVITIES_NEXT_DATE_TOOLTIP'] = '下次联系日期';
$app_strings['LBL_CAMPAIGN_LAST_RECEIVED_TOOLTIP'] = '最近收到的宣传活动日期';
$app_strings['LBL_OPEN_CASES_COUNT_TOOLTIP'] = '未清总数';
$app_strings['LBL_EVENTS_LAST_DATE_TOOLTIP'] = '最近事件日期';
$app_strings['LBL_HISTORY_LAST_DATE_TOOLTIP'] = '最近联系日期';
$app_strings['LBL_OPPORTUNITIES_TOTAL_SUM_TOOLTIP'] = '商业机会总数';
$app_strings['LBL_QUOTES_EXPIRY_TOOLTIP'] = '下次报价到期日期';
$app_strings['LBL_DEFAULT_TOTAL_TOOLTIP'] = '总记录数';
$app_strings['LBL_CONTRACT_RENEWAL'] = '更新日期';
$app_strings['LBL_INVOICES_OVERDUE'] = '总逾期时间';
$app_strings['LBL_ACTIVITIES_NEXT_DATE'] = '下一活动日期';
$app_strings['LBL_CAMPAIGN_LAST_RECEIVED'] = '上次参与';
$app_strings['LBL_OPEN_CASES_COUNT'] = '未清';
$app_strings['LBL_EVENTS_LAST_DATE'] = '上次参与的活动';
$app_strings['LBL_HISTORY_LAST_DATE'] = '上次接触';
$app_strings['LBL_OPPORTUNITIES_TOTAL_SUM'] = '总值';
$app_strings['LBL_QUOTES_EXPIRY'] = '截止日期';
$app_strings['LBL_DEFAULT_TOTAL'] = '总计';
$app_strings['AOS_Contracts'] = '合同';
$app_strings['AOS_Quotes'] = '报价';
$app_strings['AOS_Invoices'] = '发票';
$app_strings['LBL_PHOTO'] = '照片';
$app_strings['LBL_CASE_UPDATES'] = '客户反馈更新';
$app_strings['LBL_CASE_UPDATE_SUBMITTED'] = '案例更新已提交';
...
$app_strings['LBL_CREATE'] = '创建';
$app_strings['LBL_CLEAR_FILTER'] = '清除筛选器';
$app_strings['LBL_QUICK_FILTERS'] = '快速过滤器';
$app_strings['LBL_SAVED_FILTER_SAVED'] = '过滤器保存成功';
$app_strings['LBL_FILTER_ID_NOT_DEFINED'] = '过滤器ID未定义';
$app_strings['LBL_GENERIC_CONFIRMATION'] = '您要继续操作吗？';
$app_strings['LBL_SHOW_MORE'] = '显示更多';
$app_strings['LBL_SHOW_LESS'] = '显示更少';
$app_strings['LBL_LOAD_MORE'] = '加载更多';
$app_strings['LBL_EMPTY'] = '-- Empty --';
$app_strings['LBL_OPERATOR'] = '运算符';
$app_strings['LBL_START'] = '开始';
$app_strings['LBL_END'] = '结束';
$app_strings['LBL_LINE_ITEMS_FIELD_CONFIG'] = '错误配置';


$app_strings['LBL_ACTION_SUCCESS'] = '操作成功';

$app_strings['LBL_YES'] = '是';
$app_strings['LBL_NO'] = '否';
...
$app_strings['LBL_LINK'] = '链接';
$app_strings['LBL_LINK_UNLINK'] = 'Link / Unlink';
$app_strings['LBL_SAVE'] = '保存';
$app_strings['LBL_UNLINK_RECORD'] = '断开记录关联';
$app_strings['LBL_EDIT_RECORD'] = '编辑记录';
$app_strings['LBL_UNLINK_RELATIONSHIP_CONFIRM'] = '您确定要取消关联此记录吗？只有联接关系被取消。记录不会被删除。';
$app_strings['LBL_UNLINK_RELATIONSHIP_SUCCESS'] = '记录已成功取消关联。';
$app_strings['LBL_UNLINK_RELATIONSHIP_FAILED'] = '取消关联此记录时出错。';
...
$app_strings['LBL_LINK_RELATIONSHIP_SUCCESS'] = '关联成功。';
$app_strings['LBL_LINK_RELATIONSHIP_FAILED'] = '关联时出现错误。';
$app_strings['LBL_MODULE_NOT_FOUND'] = '找不到模块。';
$app_strings['LBL_RECORD_NOT_FOUND'] = '无法加载记录';
$app_strings['LBL_RELATIONSHIP_LOAD_ERROR'] = '无法加载关系';
$app_strings['LBL_NOT_LINKED'] = '无法取消关联，记录未关联';
$app_strings['LBL_ACCESS_DENIED'] = '拒绝访问';
$app_strings['LBL_ADD_RECORDS_TO_TARGET_LIST_SUCCESS'] = '记录已成功添加到目标列表。';
$app_strings['LBL_ADD_RECORDS_TO_TARGET_LIST_FAILED'] = '添加记录到目标列表时出错。';
$app_strings['LBL_ADD_CONTACTS_TO_TARGET_LIST_SUCCESS'] = '联系人已成功添加到目标列表。';
$app_strings['LBL_ADD_CONTACTS_TO_TARGET_LIST_FAILED'] = '添加联系人到目标列表时出错。';
$app_strings['LBL_CHANGED_TO_TEXT'] = '变更为';
$app_strings['LBL_RECORD_CHANGED'] = '记录已更新';
$app_strings['LBL_CREATE'] = "创建";
$app_strings['LBL_USE_ADVANCED_SEARCH'] = '使用高级搜索';
$app_strings['LBL_USE_BASIC_SEARCH'] = '使用基本搜索';
$app_strings['LBL_NO_MODULE_SELECTED'] = '没有选择模块';
$app_strings['LBL_CLOSE_MENU'] = '关闭菜单';
$app_strings['LOGIN_INCORRECT'] = '登录信息不正确，请重试。';
$app_strings['LOGIN_TOO_MANY_FAILED'] = '登录失败次数过多，请稍后再试。';

// PDF Engines
$app_strings['LBL_LEGACY_MPDF_ENGINE'] = '旧的 MPDF 引擎';
$app_strings['LBL_TCPDF_ENGINE'] = 'TCPDF 引擎';


$app_strings['ERR_INVALID_FILE_NAME'] = '无效的文件名：';
$app_strings['LBL_LOGGER_VALID_FILENAME_CHARACTERS'] = '名称只能是字母数字字符，加上\'.\'、\'-\'和\'_\'。';
$app_strings['LBL_LOGGER_INVALID_FILENAME'] = '无效的导入文件名';

$app_strings['LBL_PASSWORD_SET_NEW_VALUE_TO_RESET'] = '密码设置。输入值以设置新密码。';
$app_strings['LBL_VALUE_SET_PLACEHOLDER'] = '值设置。输入新值以覆盖当前值。';

$app_strings['ERR_IMAP_OAUTH_CONNECTION_ERROR'] = '无法使用 OAuth 登录与接收邮件服务器连接。连接： ';
$app_strings['WARN_OAUTH_TOKEN_SESSION_EXPIRED'] = '您的 IMAP OAuth 会话已过期，请重新登录： ';
...
$app_strings['LBL_OPTIONAL'] = '可选';
$app_strings['LBL_OPTIONAL_CONNECTION_STRING'] = '可选。设置连接字符串';
$app_strings['LBL_OUTBOUND_ACCOUNT'] = '发送账号';
$app_strings['LBL_INBOUND_ACCOUNT'] = '接收账号';
$app_strings['LBL_SYSTEM_ACCOUNT'] = '系统账号';
$app_strings['LBL_FROM_SYSTEM'] = '从系统发送';
$app_strings['LBL_SIGNATURE'] = '签名';
$app_strings['LBL_NEW_NOTIFICATION'] = "您有 {{context.unread}} 条新通知";
$app_strings['LBL_NOTIFICATION_ITEM_DATE'] = '预期：{{fields.date_start.value}}';
$app_strings['LBL_NOTIFICATION_ITEM_DATE_ENTERED'] = '通知：{{fields.snooze.value}}';
$app_strings['LBL_QUICK_ACTIONS'] = '快捷操作';
$app_strings['LBL_RELATIONSHIPS'] = '关联关系';
$app_strings['LBL_SHOW_CC'] = 'Show Cc';
$app_strings['LBL_SHOW_BCC'] = 'Show Bcc';
$app_strings['LBL_CC'] = '抄送';
$app_strings['LBL_BCC'] = '密送';
$app_strings['LNK_NEW_EMAIL'] = '创建邮件';
...
$app_strings['LBL_RELATED_TO'] = '关联到';
...
$app_strings['LBL_NORMAL'] = '普通';
$app_strings['LBL_LARGE'] = 'Large';
$app_strings['LBL_HUGE'] = 'Huge';
$app_strings['LBL_DEFAULT'] = '默认';
$app_strings['LBL_APPLY'] = '应用';
...
$app_strings['LBL_BOLD'] = '粗体';
$app_strings['LBL_ITALIC'] = '斜体';
...
$app_strings['LBL_QUOTE'] = '报价';
$app_strings['LBL_UNQUOTE'] = 'Unquote';
$app_strings['LBL_ALIGN_LEFT'] = '向左';
$app_strings['LBL_ALIGN_CENTER'] = 'Center';
$app_strings['LBL_ALIGN_RIGHT'] = '向右';
...
$app_strings['LBL_ALL'] = '全选';
$app_strings['LBL_EVERY'] = '间隔';
$app_strings['LBL_ON_THE'] = '于';
$app_strings['LBL_RANGE'] = '到';
$app_strings['LBL_FROM'] = '发件人地址';
$app_strings['LBL_AND'] = '和';
$app_strings['LBL_MINS'] = '分';
$app_strings['LBL_MINUTES'] = '分钟';
$app_strings['LBL_HOUR'] = '小时';
$app_strings['LBL_HOUR_SING'] = ' 小时';
$app_strings['LBL_OFTEN'] = '每分钟';
$app_strings['LBL_MIN_MARK'] = '分';
$app_strings['LBL_INBOUND_EMAIL'] = '邮件接收账户';
...
$app_strings['LBL_CAMPAIGN_SETTINGS'] = '设置';
...
$app_strings['LBL_UNSUBSCRIBE'] = '退订';
