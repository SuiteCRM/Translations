...
$mod_strings = array(
    'ERR_NO_OPPS' => 'Боломжийн график харахын тулд Боломж оруулна уу.',
    'LBL_ALL_OPPORTUNITIES' => 'Бүх боломжуудын мөнгөн дүн нь',
    'LBL_CHART_TYPE' => 'Диаграмын төрөл:',
    'LBL_CREATED_ON' => 'Сүүлд үүссэн огноо',
    'LBL_CLOSE_DATE_START' => 'Хаагдах огноо -с:',
    'LBL_CLOSE_DATE_END' => 'Expected Close Date - To:',
    'LBL_DATE_END' => 'Дуусах огноо:',
    'LBL_DATE_RANGE_TO' => 'хаашаа',
    ...
    'LBL_LEAD_SOURCE_OTHER' => 'Бусад',
    'LBL_LEAD_SOURCES' => 'Lead Sources:',
    'LBL_MODULE_NAME' => 'Хянах самбар',
    ...
    'LBL_OPPS_WORTH' => 'боломжуудын үнэ',
    ...
    'LBL_SALES_STAGE_FORM_TITLE' => 'Борлуулалтын хоолой, борлуулалтын шатаар',
    ...
    'LBL_CHART_OUTCOME_BY_MONTH' => 'Үр дүн, сараар',
