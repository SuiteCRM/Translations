...
$mod_strings = array(
    ...
    'ERR_BAD_LOGIN_PASSWORD' => 'Нэр эсвэл нууц үг буруу',
    ...
    'LBL_CLOSE_POPUP' => 'Цонхыг хаах',
    'LBL_CREATE_TEMPLATE' => 'Үүсгэх',
    'LBL_DELETE_SEEN' => 'Delete Read Emails After Import',
    'LBL_EDIT_TEMPLATE' => 'Засах',
    'LBL_EMAIL_OPTIONS' => 'Email Handling Options',
    'LBL_EMAIL_BOUNCE_OPTIONS' => 'Очоогүй мэйл удирдах тохиргоо',
    ...
    'LBL_FIND_SSL_WARN' => '<br>SSL шалгах цаг авч магад. Тэвчээртэй хүлээнэ үү.<br>',
    ...
    'LBL_FROM_NAME' => 'Илгээгчийн (From) нэр',
    'LBL_GROUP_QUEUE' => 'Групт хуваарилах',
    'LBL_HOME' => 'Нүүр',
    'LBL_LIST_MAILBOX_TYPE' => 'Мэйлын хэрэглээ',
    'LBL_LIST_NAME' => 'Нэр:',
    'LBL_LIST_GLOBAL_PERSONAL' => 'Төрөл',
    'LBL_LIST_SERVER_URL' => 'Мэйл сервер',
    ...
    'LBL_MAILBOX_SSL' => 'SSL ашиглах',
    'LBL_MAILBOX_TYPE' => 'Боломжтой үйлдэл',
    'LBL_DISTRIBUTION_METHOD' => 'Түгээх аргачлал',
    'LBL_CREATE_CASE_REPLY_TEMPLATE' => 'Шинэ кэйсын Автомат-хариултын загвар',
    ...
    'LBL_MAILBOX' => 'Хянагдаж буй хавтас',
    'LBL_TRASH_FOLDER' => 'Устгасан',
    'LBL_SENT_FOLDER' => 'Илгээсэн',
    'LBL_SELECT' => 'Сонгох',
    ...
    'LBL_MAX_AUTO_REPLIES' => 'Автомат хариултын тоо',
    ...
    'LBL_CREATE_CASE' => 'Мэйлээс кейс үүгэх',
    ...
    'LBL_TEST_WAIT_MESSAGE' => 'Түр хүлээнэ үү...',
    'LBL_WARN_IMAP_TITLE' => 'IMAP мэйл авах хаалттай',
    'LBL_WARN_IMAP' => 'Анхааруулга:',
    ...
    'LNK_LIST_OUTBOUND_EMAILS' => 'Мэйл илгээх Аккаунт',
    'LNK_LIST_SCHEDULER' => 'Төлөвлөгч',
    'LNK_SEED_QUEUES' => 'Seed Queues From Teams',
    'LBL_GROUPFOLDER_ID' => 'Групын хавтасны Id',
    ...
    'LBL_STATUS_ACTIVE' => 'Идэвхитэй',
    'LBL_STATUS_INACTIVE' => 'Идэвхигүй',
    'LBL_IS_PERSONAL' => 'Хувийн',
    'LBL_IS_GROUP' => 'групп',
    'LBL_ENABLE_AUTO_IMPORT' => 'Автоматаар мэйлүүдийг импортло',
    ...
    'LBL_SERVICE' => 'Үйлчилгээ',
    'LBL_STORED_OPTIONS' => 'Хадгалсан тохиргоонууд',
    'LBL_GROUP_ID' => 'Групын ID',
    ...
    'LBL_DISTRIB_METHOD' => 'Түгээх аргачлал',
    ...
    'LBL_IS_DEFAULT' => 'Өгөгдмөл',
    'LBL_SIGNATURE' => 'Гарын үсэг',

    'LBL_OWNER_NAME' => 'Эзэмшигч',
