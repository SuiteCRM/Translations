...
$mod_strings = array(
    ...
    'LBL_ERROR_INVALID_FLOAT' => 'Оруулсан бутархай тоо буруу байна',
    ...
    'LBL_MODULE_NAME' => 'Импортлох',
    'LBL_TRY_AGAIN' => 'Дахин оролдоно уу',
    ...
    'ERR_MISSING_REQUIRED_FIELDS' => 'Заавал бөглөх талбар дутуу:',
    'ERR_SELECT_FILE' => 'Оруулах файлаа сонгоно уу.',
    'LBL_SELECT_FILE' => 'Файл сонголт:',
    ...
    'LBL_IMPORT_FIELDDEF_DATE' => 'Огноо',
    'LBL_IMPORT_FIELDDEF_ASSIGNED_USER_NAME' => 'User Name or ID',
    'LBL_IMPORT_FIELDDEF_BOOL' => '\'0\' or \'1\'',
    'LBL_IMPORT_FIELDDEF_ENUM' => 'Жагсаалт',
    'LBL_IMPORT_FIELDDEF_EMAIL' => 'Мэйл хаяг',
