...
$mod_strings = array(
    ...
    'ERR_CHECKSYS_NOT_WRITABLE' => 'Анхаар: Бичих боломжгүй',
    ...
    'LBL_DB_UNAVAILABLE' => 'Датабааз олдсонгүй',
    ...
    'LBL_CHECKSYS_OVERRIDE_CONFIG' => 'Тохиргоог давах',
    ...
    'ERR_DB_EXISTS_NOT' => 'Заасөн бааз олдсонгүй.',
    ...
    'ERR_DB_EXISTS' => 'Заасан бааз байна - ижил нэрээр шинэ бааз үүсгэх боломжгүй.',
    ...
    'ERR_DB_HOSTNAME' => 'Хостын нэр хоосон байж болохгүй.',
    'ERR_DB_INVALID' => 'Баазын буруу төрөл сонгосон байна.',
    ...
    'LBL_UPLOAD_MAX_FILESIZE_TITLE' => 'Оруулах файлын хэмжээ',
    ...
    'LBL_CHECKSYS_OK' => 'ОК',
    'LBL_CHECKSYS_PHP_INI' => 'Таны PHP тохиргоо файлын (php.ini) байрлал:',
    ...
    'LBL_CLOSE' => 'Хаах',
    'LBL_THREE' => '3',
    'LBL_CONFIRM_BE_CREATED' => 'үүсгэх болно',
    'LBL_CONFIRM_DB_TYPE' => 'Баазын төрөл',
    'LBL_CONFIRM_NOT' => 'үгүй',
    'LBL_CONFIRM_TITLE' => 'Тохиргоог зөвшөөрөх',
    'LBL_CONFIRM_WILL' => 'болно',
    'LBL_DBCONF_DB_DROP' => 'Drop Tables',
    'LBL_DBCONF_DB_NAME' => 'Баазын нэр',
    'LBL_DBCONF_DB_PORT' => 'Database Port',
    'LBL_DBCONF_DB_PASSWORD' => 'SuiteCRM баазын хэрэглэгчийн нууц үг',
    'LBL_DBCONF_DB_PASSWORD2' => 'SuiteCRM баазын хэрэглэгчийн нууц үг дахин оруул',
    'LBL_DBCONF_DB_USER' => 'SuiteCRM баазын хэрэглэгч',
    'LBL_DBCONF_SUITE_DB_USER' => 'SuiteCRM баазын хэрэглэгч',
    'LBL_DBCONF_DB_ADMIN_USER' => 'Баазын админы нэр',
    'LBL_DBCONF_DB_ADMIN_PASSWORD' => 'Баазын админ нууц үг',
    'LBL_DBCONF_COLLATION' => 'Collation',
    'LBL_DBCONF_CHARSET' => 'Мэйлын Үсгийг сан (Character set) тохиргоо',
    ...
    'LBL_DBCONF_HOST_NAME' => 'Хостын нэр',
    ...
    'LBL_DBCONF_TITLE_PSWD_INFO_LABEL' => 'Нууц үг',
    ...
    'LBL_LICENSE_ACCEPTANCE' => 'Лицензийг зөвшөөрөл',
    ...
    'LBL_CREATE_CACHE' => 'Суулгахаар бэлдэж байна...',
    'LBL_LICENSE_REDIRECT' => 'Redirecting in ',
    'LBL_LICENSE_I_ACCEPT' => 'Би Зөвшөөрнө',
    'LBL_LICENSE_PRINTABLE' => ' Хэвлэх ',
    'LBL_PRINT_SUMM' => 'Дүн нэгтгэл хэвлэх',
    'LBL_LICENSE_TITLE_2' => 'SuiteCRM-ийн Лиценз',
    'LBL_LICENSE' => 'LICENSE',

    'LBL_LOCALE_NAME_FIRST' => 'ӨөрийнНэр',
    'LBL_LOCALE_NAME_LAST' => 'ЭцгийНэр',
    'LBL_LOCALE_NAME_SALUTATION' => 'Доктор.',

    'LBL_ML_ACTION' => 'Үйлдэл',
    'LBL_ML_DESCRIPTION' => 'Тайлбар',
    'LBL_ML_INSTALLED' => 'Суусан огноо',
    'LBL_ML_NAME' => 'Нэр',
    'LBL_ML_PUBLISHED' => 'Нийтэлсэн огноо',
    'LBL_ML_TYPE' => 'Төрөл',
    'LBL_ML_UNINSTALLABLE' => 'Арилгах боломжтой (Uninstallable)',
    'LBL_ML_VERSION' => 'Хувилбар',
    ...
    'LBL_NEXT' => 'Дараахи',
    'LBL_NO' => 'Үгүй',
    'LBL_PERFORM_ADMIN_PASSWORD' => 'Системийн админы нууц үг тохируулах',
    'LBL_PERFORM_CONFIG_PHP' => 'SuiteCRM тохиргоо файл үүсгэж байна',
    'LBL_PERFORM_CREATE_DB_1' => '<b>Бааз үүсгэж байна</b> ',
    'LBL_PERFORM_CREATE_DB_2' => ' <b>-д</b> ',
    'LBL_PERFORM_CREATE_DB_USER' => 'Баазын хэрэглэгч, нууц үг үүсгэж байна...',
    'LBL_PERFORM_CREATE_DEFAULT' => 'SuiteCRM-ийн суурь өгөгдлийг үүсгэж байна',
    'LBL_PERFORM_DEFAULT_SCHEDULER' => 'Үндсэн хуваарьт ажлыг үүсгэж байна (scheduler jobs)',
    'LBL_PERFORM_DEFAULT_USERS' => 'Үндсэн хэрэглэгчдийг үүсгэж байна',
    'LBL_PERFORM_DEMO_DATA' => 'Баазад Демо өгөгдөл хийж байна (хэсэг удаж магад, түр хүлээнэ үү)',
    'LBL_PERFORM_DONE' => 'бэлэн<br>',
    'LBL_PERFORM_FINISH' => 'Дуусгах',
    'LBL_PERFORM_OUTRO_1' => 'SuiteCRM-ийн тохиргоо ',
    'LBL_PERFORM_OUTRO_2' => ' дуусслаа!',
    'LBL_PERFORM_OUTRO_3' => 'Нийт цаг: ',
    'LBL_PERFORM_OUTRO_4' => ' секунд.',
    'LBL_PERFORM_OUTRO_5' => 'Ашигласан санах ойн: ',
    'LBL_PERFORM_OUTRO_6' => ' байт.',
    'LBL_PERFORM_SUCCESS' => 'Амжилттай!',
    'LBL_PERFORM_TABLES' => 'Creating SuiteCRM application tables, audit tables and relationship metadata',
    'LBL_PERFORM_TITLE' => 'Суулгаж эхлэх',
    'LBL_PRINT' => 'Хэвлэмэл',
    ...
    'LBL_REG_TITLE' => 'Бүртгүүлэх',

    'LBL_REQUIRED' => '* Шаардах талбар',

    'LBL_SITECFG_ADMIN_Name' => 'SuiteCRM Application Admin Name',
    'LBL_SITECFG_ADMIN_PASS_2' => 'SuiteCRM админ хэрэглэгчийн нууц үг дахин оруул',
    'LBL_SITECFG_ADMIN_PASS' => 'SuiteCRM админ хэрэглэгчийн нууц үг',
    ...
    'LBL_STEP' => 'Алхам',
    'LBL_TITLE_WELCOME' => 'SuiteCRM-д тавтай морилно уу ',
    'LBL_WELCOME' => 'SuiteCRM-д тавтай морилно уу',
    ...
    'advanced_password_new_account_email' => array(
        ...
        'type' => 'систем',
        'description' => 'Админ системийн хэрэглэгчид шинэ нууц үг илгээхэд энэ загвар ашиглагдана.',
        'body' => '<div><table border=\\"0\\" cellspacing=\\"0\\" cellpadding=\\"0\\" width="550" align=\\"\\&quot;\\&quot;center\\&quot;\\&quot;\\"><tbody><tr><td colspan=\\"2\\"><p>Энэ таны систем нэвтрэх нэр, түр нууц үг болно:</p><p>Нэвтрэх нэр : $contact_user_user_name </p><p>Нууц үг : $contact_user_user_hash </p><br><p>$config_site_url</p><br><p>Дээрхи нууц үгээр нэвтэрсний дараа, та өөрийн сонгосон шинэ үгээр нууц үгээ солих шаардлагатай.</p>   </td>         </tr><tr><td colspan=\\"2\\"></td>         </tr> </tbody></table> </div>',
        'txt_body' =>
            '
Таны нэвтрэх нэр, түр нууц үг:
Нэвтрэх нэр : $contact_user_user_name
Нууц үг : $contact_user_user_hash

$config_site_url

Та дээрхи нууц үгээр нэвтэрч орсны дараа нууц үгээ шинээр солих шаардлагатай.',
        'name' => 'Системээс нууц үг үүсгэж илгээх мэйл',
    ),
    'advanced_password_forgot_password_email' => array(
        'subject' => 'Нэвтрэх нууц үг солих',
        'type' => 'систем',
        'description' => "Системийн хэрэглэгч өөрөө шинээр нууц үг авахад энэ загвар ашиглагдана.",
        'body' => '<div><table border=\\"0\\" cellspacing=\\"0\\" cellpadding=\\"0\\" width="550" align=\\"\\&quot;\\&quot;center\\&quot;\\&quot;\\"><tbody><tr><td colspan=\\"2\\"><p>Та саяхан $contact_user_pwd_last_changed нууц үгээ сэргээж авах хүсэлт гаргасан байна. </p><p>Та доорхи линк дээр дарж нууц үгээ сэргээж авна уу:</p><p> $contact_user_link_guid </p>  </td>         </tr><tr><td colspan=\\"2\\"></td>         </tr> </tbody></table> </div>',
        'txt_body' =>
            '
Та саяхан $contact_user_pwd_last_changed нууц үгээ сэргээж авах хүсэлт гаргасан байна. 

Та доорхи линк дарж нууц үгээ сэргээж авна уу:

$contact_user_link_guid',
        'name' => 'Нууц үг сэргээх мэйл',
    ),


    'two_factor_auth_email' => array(
        'subject' => 'Хос хүчин зүйлт баталгаажуулалтын код',
        'type' => 'систем',
        'description' => "This template is used to send a user a code for Two Factor Authentication.",
        'body' => '<div><table border=\\"0\\" cellspacing=\\"0\\" cellpadding=\\"0\\" width="550" align=\\"\\&quot;\\&quot;center\\&quot;\\&quot;\\"><tbody><tr><td colspan=\\"2\\"><p>Хос хүчин зүйлт баталгаажуулалтын код <b>$code</b>.</p>  </td>         </tr><tr><td colspan=\\"2\\"></td>         </tr> </tbody></table> </div>',
        'txt_body' =>
            'Хос хүчин зүйлт баталгаажуулалтын код $code.',
        'name' => 'Хос хүчин зүйлт баталгаажуулалтын мэйл',
    ),

    // SMTP settings

    'LBL_FROM_NAME' => '"Хэнээс" (From) нэр:',
    ...
    'LBL_LOCALE_TITLE' => 'Системийн орон нутгийн тохиргоо',
    ...
    'LBL_CURRENCY_ISO4217' => 'Вальютийн код (ISO 4217, Ж: MNT)',
    ...
    'ERR_ADMIN_EMAIL' => 'Админы мэйл хаяг буруу байна.',
    'ERR_SITE_URL' => 'Сайтын URL заавал шаардлагатай.',
    ...
    'STAT_INSTALL_FINISH' => 'Install дуусав...',
    'STAT_INSTALL_FINISH_LOGIN' => 'Installation process finished, <a href="%s">please log in...</a>',
    'LBL_LICENCE_TOOLTIP' => 'Лицензийн нөхцөлийг зөвшөөрөх ёстой',

    'LBL_MORE_OPTIONS_TITLE' => 'Бусад боломжууд',
    'LBL_START' => '',
    'LBL_DB_CONN_ERR' => 'Баазын алдаа',
    'LBL_OLD_PHP' => 'Хуучин PHP хувилбар байна!',
