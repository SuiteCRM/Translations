...
$mod_strings = array(
    ...
    'LBL_SELECT_DELEGATES_CONTACTS' => 'Контакттар',
    ...
    'LBL_MANAGE_ACCEPTANCES_ACCEPTED' => 'Кабыл алуу',
    ...
    'LBL_FP_EVENTS_CONTACTS_FROM_CONTACTS_TITLE' => 'Контакттар',
