...
$mod_strings = array(
    ...
    'LBL_DEFAULT_SUBPANEL_TITLE' => 'Колдонуучулар',
    ...
    'LBL_LIST_FORM_TITLE' => 'Колдонуучулар',
    ...
    'LBL_MODULE_NAME' => 'Колдонуучулар',
    'LBL_MODULE_TITLE' => 'Users: Home',
    'LBL_NAME' => 'Full Name',
    'LBL_SIGNATURE_NAME' => 'Аты',
...
<img src=include/images/suitecrm_login.png style="margin-right: 5px;">
    ...
    'LBL_LIST_BUG' => 'Каталар',
    'LBL_LIST_CASE' => 'Кайрылуу',
    'LBL_LIST_CONTACT' => 'Контакттар',
    'LBL_LIST_LEAD' => 'Leads',
    'LBL_LIST_TASK' => 'Тапшырмалар',
