...
$app_strings = array(
    'LBL_SEARCH_RESULTS_TITLE' => 'Výsledky',
    'ERR_SEARCH_INVALID_QUERY' => 'Při vyhledávání došlo k chybě. Syntaxe vašeho dotazu nemusí být správná.',
    ...
    'LBL_LOGOUT' => 'Odhlásit',
    'LBL_LOGOUT_SUCCESS' => 'Odhlášení bylo úspěšné',
    'LBL_LOGGED_OUT_MESSAGE' => 'Byli jste odhlášeni',
    ...
    'LBL_EMAIL_FOLDERS' => SugarThemeRegistry::current()->getImage('icon_email_folder', 'align=absmiddle border=0', null, null, '.gif', '') . 'Složky',
    ...
    'ERR_UNAUTHORIZED_PAGE_ACCESS' => 'Nemáte oprávnění k zobrazení této stránky. Obraťte se na správce systému.',
    'ERR_UNAUTHORIZED_PAGE_ACCESS_TO_HOME_PAGE' => 'Nemáte oprávnění k zobrazení této stránky. Přesměrování na domovskou stránku...',
    ...
    'LBL_CHARSET' => 'UTF-8',
    'LBL_CHARTS' => 'Grafy',
    'LBL_QUICK_CHARTS' => 'Rychlé grafy',
    'LBL_QUICK_HISTORY' => 'Časová osa',
    ...
    'LBL_CURRENT_USER_FILTER' => 'Mé položky',
    'LBL_CURRENCY' => 'Měna:',
    ...
    'LBL_LOG_ENTRIES_LEAD_TITLE' => 'Vytvořené Iniciativy',
    ...
    'LBL_RECORD_DOES_NOT_EXIST' => 'Chyba při otvírání záznamu. Záznam může být smazán nebo nemáte oprávnění k prohlížení.',
    'LBL_PROFILE' => 'Profil',
    ...
    'LBL_BASIC_FILTER' => 'Základní filtr',
    'LBL_QUICK' => 'Rychlý',
    ...
    'NTC_DELETE_SELECTED_RECORDS' => ' vybrané záznamy?',
...
"5. Klepněte v aplikaci na možnost Import v nabídce Akce a vyberte soubor k nahrání"
   ',
    ...
    'LBL_BULK_ACTION_BUTTON_LABEL' => 'Hromadná akce',
    'LBL_BULK_ACTION_BUTTON_LABEL_MOBILE' => 'Akce',
    'LBL_TOO_FEW_SELECTED' => 'Neplatný počet vybraných záznamů. Musíte vybrat minimálně {min} záznamů.',
    'LBL_TOO_MANY_SELECTED' => 'Neplatný počet vybraných záznamů. Musíte vybrat maximálně {max} záznamů.',
    'LBL_SELECT_ALL_NOT_ALLOWED' => 'Výběr všech záznamů není k dispozici pro tuto akci. Vyberte prosím jednotlivé záznamy.',
    'LBL_MISSING_HANDLER_DATA' => 'Neočekávaná chyba. Chybí hromadná data zpracovatele z odpovědi',
    'LBL_MISSING_HANDLER' => 'Neočekávaná chyba. Není definován žádný handler pro vybranou hromadnou akci',
    'LBL_MISSING_HANDLER_DATA_ROUTE' => 'Neočekávaná chyba. Chybí hromadná akce',
    'LBL_ACTION_ERROR' => 'Neočekávaná chyba při volání akce',
    'LBL_BULK_ACTION_ERROR' => 'Neočekávaná chyba při volání hromadné akce',
    'LBL_BULK_ACTION_DELETE_SUCCESS' => 'Záznam(my) byly úspěšně odstraněny',
    'LBL_BULK_ACTION_MASS_UPDATE_CONFIRMATION' => 'Opravdu chcete aktualizovat vybraný záznam(y)?',
    'LBL_BULK_ACTION_MASS_UPDATE_SUCCESS' => 'Všechny záznamy byly úspěšně aktualizovány',
    'LBL_BULK_ACTION_MASS_UPDATE_PARTIAL_SUCCESS' => 'Částečný úspěch. Některé záznamy nebyly aktualizovány. Zkontrolujte protokol',
    'LBL_BULK_ACTION_MASS_UPDATE_NO_FIELDS' => 'Žádná pole k aktualizaci',
    'LBL_BULK_ACTION_MASS_UPDATE_NO_RECORDS' => 'Žádné záznamy k aktualizaci',
    'LBL_BULK_ACTION_MASS_UPDATE_NO_ACLS' => 'Nedostatečná oprávnění, uložení není povoleno',
    'LBL_UNEXPECTED_ERROR' => 'Neočekávaná chyba. Není možné provést akci.',
    'LBL_RECORD_DELETE_SUCCESS' => 'Záznam byl úspěšně odstraněn',
    'LBL_RECORD_DELETE_ALL_SUCCESS' => 'Records deleted successfully',
    'LBL_RECORD_SNOOZE_SUCCESS' => 'Notification Snoozed',
    'LBL_ERROR_SAVING' => 'Při ukládání záznamu došlo k chybě',
    ...
    'ANNUAL_REVENUE_BY_ACCOUNTS' => 'Roční příjmy podle účtů',
    'PIPELINE_BY_SALES_STAGE' => 'Na cestě dle fáze prodeje',
    'LEADS_BY_SOURCE' => 'Iniciativy podle zdroje',
    'LEADS_BY_STATUS' => 'Iniciativy podle stavu',
    'ACCOUNT_TYPES_PER_MONTH' => 'Nové účty podle měsíce',
    ...
    'LBL_SUITE_DESC1' => 'SuiteCRM vytvořilo a sestavilo <a href="https://salesagility.com"> SalesAgility</a>. Program je poskytován tak, jak je, bez záruky. Licencován pod AGPLv3.',
    ...
    'LBL_SUITE_DESC3' => 'SuiteCRM je ochranná známka společnosti SalesAgility Ltd. Všechny ostatní názvy společností a produktů mohou být ochrannými známkami příslušných společností, s nimiž jsou spojeny.',
    ...
    'LBL_PROSPECT_LIST_NAME' => 'Seznam skupin cílů',

    //List View Column Selector Modal
    'LBL_COLUMN_SELECTOR_DISPLAYED_COLS' => 'ZOBRAZENO',
    'LBL_COLUMN_SELECTOR_HIDDEN_COLS' => 'SKRYTO',
    'LBL_COLUMN_SELECTOR_CLOSE_BUTTON' => 'Zavřít',
    'LBL_COLUMN_SELECTOR_SAVE_BUTTON' => 'Uložit změny',
    'LBL_COLUMN_SELECTOR_MODAL_TITLE' => 'Vybrat sloupce',
...
$app_list_strings['fp_event_status_dom']['Declined'] = 'Odmítnuté';
...
$app_list_strings['aos_quotes_type_dom']['Other'] = 'Jiné';
...
$app_list_strings['aos_invoices_type_dom']['Other'] = 'Jiné';
...
$app_list_strings['moduleList']['SurveyResponses'] = 'Odpovědi na dotazník';
$app_list_strings['moduleList']['Surveys'] = 'Dotazníky';
$app_list_strings['moduleList']['SurveyQuestionResponses'] = 'Odpovědi na otázku dotazníku';
$app_list_strings['moduleList']['SurveyQuestions'] = 'Otázky dotazníku';
...
$app_strings['LBL_GOOGLE_SYNC_ERR'] = 'SuiteCRM Google Sync - CHYBA';
...
$app_strings['LBL_INVALID_EMAIL'] = 'Neplatné';
$app_strings['LBL_PRIMARY'] = 'Primární';
$app_strings['LBL_EMAIL_ADDRESS'] = 'Emailová adresa';
...
$app_strings['LBL_INSIGHTS'] = 'Přehledy';
$app_strings['LBL_CHARTS'] = 'Grafy';
$app_strings['LBL_CHART_NOT_FOUND'] = 'Graf nebyl nalezen';
$app_strings['LBL_NO_DATA'] = 'Žádná data';
$app_strings['LBL_ERROR_FETCHING_METADATA'] = 'Při načítání metadat došlo k chybě';
$app_strings['LBL_TOTAL'] = 'Celkem';
$app_strings['LBL_ACTIONS'] = 'Akce';
$app_strings['LBL_SELECT_SUBPANEL_BANNER'] = 'Vyberte, které subpanely mají být zobrazeny';
$app_strings['LBL_SELECT_ITEM'] = 'Vyberte položku';
$app_strings['LBL_ITEMS_SELECTED'] = 'items selected';
$app_strings['LBL_WIDGET_NOT_FOUND'] = 'Widget nebyl nalezen';
$app_strings['LBL_BAD_CONFIG'] = 'Nesprávná konfigurace';
$app_strings['LBL_CONFIG_BAD_CONTEXT'] = 'Nesprávná konfigurace: kontext není správně nakonfigurován';
$app_strings['LBL_CONFIG_NO_CONFIG'] = 'Nesprávná konfigurace: chybí konfigurace';
$app_strings['LBL_CONFIG_NO_STATISTICS_KEY'] = 'Nesprávná konfigurace: chybí statistický klíč';
$app_strings['LBL_STATISTIC_ERROR'] = 'Chyba při načítání statistiky';
$app_strings['LBL_STATISTIC_ERROR_DESC'] = 'Chyba při načítání statistiky';
$app_strings['LBL_STATISTIC_ERROR_DESC_TOOLTIP'] = 'Chyba při načítání statistik. Obraťte se na správce';
$app_strings['LBL_AVERAGE_CLOSED_WON_PER_YEAR'] = 'Průměrný počet vyhraných Příležitostí za rok';
$app_strings['LBL_OPPORTUNITIES_TOTAL'] = 'Celková hodnota Příležitostí';
$app_strings['LBL_CASE_TOTAL_DAYS_OPEN'] = 'Celkový počet dnů otevření';
$app_strings['LBL_DAYS_OPEN'] = 'Dnů otevřeno';
$app_strings['LBL_DAYS_IN_SALE_STAGE'] = 'DAY(S) THIS OPPORTUNITY HAS BEEN AT THIS SALES STAGE';
$app_strings['LBL_STAT_DAYS'] = 'Dnů(í)';
$app_strings['LBL_CLOSED_PER_YEAR'] = 'Uzavřené za rok';
$app_strings['LBL_WAS_OPEN'] = 'Tento případ byl otevřen';
$app_strings['LBL_HAS_BEEN_OPEN'] = 'Tento případ byl otevřen';
$app_strings['LBL_NUMBER_OF_CASES_PER_ACCOUNT'] = 'Počet případů na účet';
$app_strings['LBL_TOTAL_CASES_FOR_THIS_ACCOUNT'] = 'Total Cases For This Account';
$app_strings['LBL_NONE_OUTSTANDING'] = 'Žádný';
$app_strings['LBL_VALIDATION_ERROR_REQUIRED'] = 'Chybí povinné pole: {{fields.field.label}}';
$app_strings['LBL_VALIDATION_ERROR_CURRENCY_FORMAT'] = "Neplatný formát měny. Očekáváno: '{{context.expected}}'";
$app_strings['LBL_VALIDATION_ERROR_INT_FORMAT'] = "Neplatný int formát. Očekáváno: '{{context.expected}}'";
$app_strings['LBL_VALIDATION_ERROR_FLOAT_FORMAT'] = "Neplatný float formát. Očekáváno: '{{context.expected}}'";
$app_strings['LBL_VALIDATION_ERROR_DATE_FORMAT'] = "Neplatný formát času. Očekáváno: '{{context.expected}}'";
$app_strings['LBL_VALIDATION_ERROR_DATETIME_FORMAT'] = "Neplatný formát času. Očekáváno: '{{context.expected}}'";
...
$app_strings['LBL_VALIDATION_ERROR_EMAIL_FORMAT'] = "Neplatný formát e-mailu. Očekáváno: '{{context.expected}}'";
$app_strings['LBL_VALIDATION_ERROR_PHONE_FORMAT'] = "Neplatný formát telefonu.";
$app_strings['LBL_VALIDATION_ERROR_MIN'] = "Neplatná hodnota. Hodnota musí být větší nebo rovna '{{context.min}}'";
$app_strings['LBL_VALIDATION_ERROR_MAX'] = "Neplatná hodnota. Hodnota musí být menší nebo rovna '{{context.max}}'";
$app_strings['LBL_MULTIPLE_PRIMARY_EMAIL_VALIDATION_ERROR'] = "Only one Valid Email Address should be marked as primary";
$app_strings['LBL_DUPLICATE_EMAIL_VALIDATION_ERROR'] = "Duplicitní e-mailové adresy nejsou povoleny";
...
$app_strings['LBL_VALIDATION_ERRORS'] = 'Došlo k chybám při ověření, nelze provést akci.';
...
$app_strings['LBL_TYPE_TO_SEARCH'] = 'Zadejte hledaný text...';
$app_strings['LBL_SEARCHING'] = 'hledání...';
$app_strings['LBL_NOT_FOUND'] = 'Nenalezeno.';
$app_strings['LBL_SEARCH_ERROR'] = 'Chyba vyhledávání.';
$app_strings['LBL_FOUND'] = 'Nalezeno';
$app_strings['LBL_GET_RECORD_LIST_ERROR'] = 'Při načítání záznamů došlo k chybě';
$app_strings['LBL_NUMBER_OF_RECORDS'] = 'Počet záznamů';
...
$app_strings['LBL_CONTRACT_RENEWAL_TOOLTIP'] = 'Datum příští obnovy smlouvy';
$app_strings['LBL_INVOICES_OVERDUE_TOOLTIP'] = 'Celkový počet faktur po splatnosti';
$app_strings['LBL_ACTIVITIES_NEXT_DATE_TOOLTIP'] = 'Datum další interakce';
$app_strings['LBL_CAMPAIGN_LAST_RECEIVED_TOOLTIP'] = 'Datum poslední Kampaně přijato';
$app_strings['LBL_OPEN_CASES_COUNT_TOOLTIP'] = 'Celkový počet otevřených případů';
$app_strings['LBL_EVENTS_LAST_DATE_TOOLTIP'] = 'Datum poslední události';
$app_strings['LBL_HISTORY_LAST_DATE_TOOLTIP'] = 'Datum poslední interakce';
$app_strings['LBL_OPPORTUNITIES_TOTAL_SUM_TOOLTIP'] = 'Celkový souhrn příležitostí';
$app_strings['LBL_QUOTES_EXPIRY_TOOLTIP'] = 'Datum vypršení další cenové nabídky';
$app_strings['LBL_DEFAULT_TOTAL_TOOLTIP'] = 'Celkový počet záznamů';
$app_strings['LBL_CONTRACT_RENEWAL'] = 'Datum obnovení';
$app_strings['LBL_INVOICES_OVERDUE'] = 'Celkem po splatnosti';
$app_strings['LBL_ACTIVITIES_NEXT_DATE'] = 'Next Activity Date';
$app_strings['LBL_CAMPAIGN_LAST_RECEIVED'] = 'Last Participated';
$app_strings['LBL_OPEN_CASES_COUNT'] = 'Otevřené případy';
$app_strings['LBL_EVENTS_LAST_DATE'] = 'Účastnil se poslední akce';
$app_strings['LBL_HISTORY_LAST_DATE'] = 'Poslední Touchpoint';
$app_strings['LBL_OPPORTUNITIES_TOTAL_SUM'] = 'Celková hodnota';
$app_strings['LBL_QUOTES_EXPIRY'] = 'Next Expiration Date';
$app_strings['LBL_DEFAULT_TOTAL'] = 'Celkem';
$app_strings['AOS_Contracts'] = 'Kontrakty';
$app_strings['AOS_Quotes'] = 'Nabídky';
$app_strings['AOS_Invoices'] = 'Faktury';
$app_strings['LBL_PHOTO'] = 'Fotka';
$app_strings['LBL_CASE_UPDATES'] = 'Aktualizace případu';
$app_strings['LBL_CASE_UPDATE_SUBMITTED'] = 'Aktualizace případu odeslána';
...
$app_strings['LBL_CREATE'] = 'Přidat';
$app_strings['LBL_CLEAR_FILTER'] = 'Smazat filtr';
$app_strings['LBL_QUICK_FILTERS'] = 'Quick Filters';
$app_strings['LBL_SAVED_FILTER_SAVED'] = 'Filtr byl úspěšně uložen';
$app_strings['LBL_FILTER_ID_NOT_DEFINED'] = 'Id filtru není definováno';
$app_strings['LBL_GENERIC_CONFIRMATION'] = 'Chcete s touto akcí pokračovat?';
$app_strings['LBL_SHOW_MORE'] = 'Ukázat více';
$app_strings['LBL_SHOW_LESS'] = 'Ukázat méně';
$app_strings['LBL_LOAD_MORE'] = 'Načíst více';
$app_strings['LBL_EMPTY'] = '-- Empty --';
$app_strings['LBL_OPERATOR'] = 'Operátor';
$app_strings['LBL_START'] = 'Začátek';
$app_strings['LBL_END'] = 'Konec';
$app_strings['LBL_LINE_ITEMS_FIELD_CONFIG'] = 'Chybná konfigurace';


$app_strings['LBL_ACTION_SUCCESS'] = 'Akce byla úspěšná';

$app_strings['LBL_YES'] = 'Ano';
$app_strings['LBL_NO'] = 'Ne';

$app_list_strings['sort_order'] = [];
$app_list_strings['sort_order']['asc'] = 'Vzestupně';
$app_list_strings['sort_order']['desc'] = 'Sestupně';

// Labels used by subpanel unlink relationship process
$app_strings['LBL_LINK'] = 'Odkaz';
$app_strings['LBL_LINK_UNLINK'] = 'Link / Unlink';
$app_strings['LBL_SAVE'] = 'Uložit';
$app_strings['LBL_UNLINK_RECORD'] = 'Odpojit záznam';
$app_strings['LBL_EDIT_RECORD'] = 'Upravit záznam';
$app_strings['LBL_UNLINK_RELATIONSHIP_CONFIRM'] = 'Opravdu chcete odpojit tento záznam? Pouze vztah bude odpojen. Záznam nebude smazán.';
$app_strings['LBL_UNLINK_RELATIONSHIP_SUCCESS'] = 'Záznam byl úspěšně odpojen.';
$app_strings['LBL_UNLINK_RELATIONSHIP_FAILED'] = 'Při propojení této provazby došlo k chybě.';
...
$app_strings['LBL_LINK_RELATIONSHIP_SUCCESS'] = 'Provazba byla úspěšně propojena.';
$app_strings['LBL_LINK_RELATIONSHIP_FAILED'] = 'Při propojení této provazby došlo k chybě.';
$app_strings['LBL_MODULE_NOT_FOUND'] = 'Modul nebyl nalezen.';
$app_strings['LBL_RECORD_NOT_FOUND'] = 'Záznam nelze načíst';
$app_strings['LBL_RELATIONSHIP_LOAD_ERROR'] = 'Provazbu nelze načíst';
$app_strings['LBL_NOT_LINKED'] = 'Nelze odpojit. Záznamy nejsou propojeny';
$app_strings['LBL_ACCESS_DENIED'] = 'Přístup zamítnut';
$app_strings['LBL_ADD_RECORDS_TO_TARGET_LIST_SUCCESS'] = 'Záznamy úspěšně přidány do cílového seznamu.';
$app_strings['LBL_ADD_RECORDS_TO_TARGET_LIST_FAILED'] = 'Při přidávání záznamů do cílového seznamu došlo k chybě.';
$app_strings['LBL_ADD_CONTACTS_TO_TARGET_LIST_SUCCESS'] = 'Kontakty byly úspěšně přidány do seznamu cílů.';
$app_strings['LBL_ADD_CONTACTS_TO_TARGET_LIST_FAILED'] = 'Při přidávání kontaktů do cílového seznamu došlo k chybě.';
$app_strings['LBL_CHANGED_TO_TEXT'] = 'změněno na';
$app_strings['LBL_RECORD_CHANGED'] = 'Záznam aktualizován';
$app_strings['LBL_CREATE'] = "Přidat";
...
$app_strings['LBL_NO_MODULE_SELECTED'] = 'Nebyl vybrán žádný modul';
$app_strings['LBL_CLOSE_MENU'] = 'Zavřít menu';
$app_strings['LOGIN_INCORRECT'] = 'Přihlašovací údaje jsou nesprávné, zkuste to prosím znovu.';
$app_strings['LOGIN_TOO_MANY_FAILED'] = 'Příliš mnoho neúspěšných pokusů o přihlášení. Zkuste to prosím později.';
...
$app_strings['LBL_RELATIONSHIPS'] = 'Vztahy';
$app_strings['LBL_SHOW_CC'] = 'Show Cc';
$app_strings['LBL_SHOW_BCC'] = 'Show Bcc';
$app_strings['LBL_CC'] = 'Kopie';
$app_strings['LBL_BCC'] = 'Skrytá kopie';
$app_strings['LNK_NEW_EMAIL'] = 'Nový Email';
...
$app_strings['LBL_RELATED_TO'] = 'Odpovídat čemu';
...
$app_strings['LBL_MEDIUM'] = 'Střední';
$app_strings['LBL_NORMAL'] = 'Normální';
$app_strings['LBL_LARGE'] = 'Large';
$app_strings['LBL_HUGE'] = 'Huge';
$app_strings['LBL_DEFAULT'] = 'Výchozí';
$app_strings['LBL_APPLY'] = 'Použít';
...
$app_strings['LBL_QUOTE'] = 'Nabídka';
$app_strings['LBL_UNQUOTE'] = 'Unquote';
$app_strings['LBL_ALIGN_LEFT'] = 'Vlevo';
$app_strings['LBL_ALIGN_CENTER'] = 'Center';
$app_strings['LBL_ALIGN_RIGHT'] = 'Vpravo';
...
// Day and Time labels
$app_strings['LBL_SUN'] = 'Neděle';
$app_strings['LBL_MON'] = 'Pondělí';
$app_strings['LBL_TUE'] = 'Úterý';
$app_strings['LBL_WED'] = 'Středa';
$app_strings['LBL_THU'] = 'Čtvrtek';
$app_strings['LBL_FRI'] = 'Pátek';
$app_strings['LBL_SAT'] = 'Sobota';
$app_strings['LBL_ALL'] = 'Každý den';
$app_strings['LBL_EVERY'] = 'Každý';
$app_strings['LBL_ON_THE'] = 'Na';
$app_strings['LBL_RANGE'] = 'k';
$app_strings['LBL_FROM'] = 'Odesílatel';
$app_strings['LBL_AND'] = 'a';
$app_strings['LBL_MINS'] = 'Minuty';
$app_strings['LBL_MINUTES'] = 'minuty';
$app_strings['LBL_HOUR'] = 'hodiny';
$app_strings['LBL_HOUR_SING'] = 'hodina';
$app_strings['LBL_OFTEN'] = 'Tak často jak je možné.';
$app_strings['LBL_MIN_MARK'] = 'značka minuty';
$app_strings['LBL_INBOUND_EMAIL'] = 'Doručená pošta';
...
$app_strings['LBL_CAMPAIGN_SETTINGS'] = 'Nastavení';
...
$app_strings['LBL_INACTIVE'] = 'Neaktivní';
