...
$mod_strings = array(
    ...
    'ERR_CHECKSYS_PHP_INVALID_VER' => 'Vaše verze PHP není SuiteCRM podporována. Musíte nainstalovat verzi, která je kompatibilní se SuiteCRM. Zkontrolujte, prosím, podporované verze PHP v tabulce kompatibility v poznámkách k vydání. Vaše verze je ',
    ...
    'ERR_CHECKSYS_CONFIG_NOT_WRITABLE' => 'Konfigurační soubor existuje, ale není zapisovatelný. Proveďte prosím potřebné kroky k tomu, aby byl soubor zapisovatelný.',
    'ERR_CHECKSYS_CONFIG_NOT_FOUND' => 'Váš config.php neexistuje. Bude vytvořen při instalaci.',
    'ERR_CHECKSYS_CONFIG_OVERRIDE_NOT_WRITABLE' => 'Soubor pro přepsání konfigurace existuje, ale není zapisovatelný. Proveďte prosím nezbytné kroky, aby byl soubor zapisovatelný. ',
    ...
    'ERR_CHECKSYS_FILES_NOT_WRITABLE' => "Soubory nebo adresáře uvedené výše nejsou zapisovatelné nebo chybí a nelze je vytvořit. Udělejte prosím potřebné kroky k umožnění zápisu do adresářů.",
    'ERR_CHECKSYS_LOGS_NOT_WRITABLE' => 'Adresář logů momentálně není zapisovatelný',
    'ERR_CHECKSYS_CACHE_NOT_WRITABLE' => 'Adresář mezipaměti momentálně není zapisovatelný',
    'ERR_CHECKSYS_EXTENSIONS_NOT_WRITABLE' => 'Adresář rozšíření momentálně není zapisovatelný',
    'ERR_CHECKSYS_ROOT_NOT_WRITABLE' => 'The Root Directory is currently not writable. You will not be able to proceed with install.',
    'ERR_CHECKSYS_SECRETS_NOT_WRITABLE' => 'Adresář config/secrets momentálně není zapisovatelný',
    'ERR_CHECKSYS_ENV_NOT_WRITABLE' => 'Soubor .env nebo adresář, ve kterém je umístěn, není zapisovatelný.',
    ...
    'ERR_UW_NO_UPDATE_RECORD' => 'Nelze nalézt instalační záznam',
    ...
    'ERROR_VERSION_INCOMPATIBLE' => 'Nahraný soubor není kompatibilní s touto verzí SuiteCRM: ',
    ...
    'LBL_INCOMPATIBLE_PHP_VERSION' => 'Je vyžadováno PHP verze 5 nebo vyšší.',
    ...
    'LBL_BACKWARD_COMPATIBILITY_ON' => 'Režim zpětné kompatibility PHP je zapnutý. Nastavte zend.ze1_compatibility_mode na Off pro pokračování',
...
$contact_user_link_guid',
    ...
    'LBL_ALLOW_DEFAULT_SELECTION' => 'Umožnit uživatelům používat tento účet pro odchozí email:',
    'LBL_ALLOW_DEFAULT_SELECTION_HELP' => 'Je-li vybrána tato možnost, budou moci všichni uživatelé posílat e-maily pomocí stejného odchozího emailového účtu, který slouží k odesílání systémových upozornění a výstrah. Pokud tato možnost není vybrána, mohou uživatelé dále používat server pro odchozí poštu, ale musí zadat vlastní přihlašovací údaje.',
    ...
    'NEW_LOGO_HELP' => 'Formát souboru s obrázkem může být buď .png nebo .jpg. Maximální výška je 170px, a maximální šířka je 450px. Jakýkoliv obrázek větší v libovolném směru bude zmenšen na tyto maximální rozměry.',
    ...
    'LBL_WIZARD_LOCALE_DESC' => 'Určete, jak chcete zobrazit data v SuiteCRM, s ohledem na vaši geografickou polohu. Zde zadané nastavení bude použité jako výchozí. Uživatelé budou moci nastavit vlastní.',
    ...
    'LBL_DECIMAL_SEP' => 'Oddělovač desetin:',
    ...
    'ERR_UPLOAD_FILE_UPLOAD_ERR_NO_FILE' => 'Nebyl nahrán žádný soubor.',
    'ERR_UPLOAD_FILE_UPLOAD_ERR_NO_TMP_DIR' => 'Chybí dočasná složka.',
    'ERR_UPLOAD_FILE_UPLOAD_ERR_CANT_WRITE' => 'Nepodařilo se zapsat soubor na disk.',
