...
$mod_strings = array(
    ...
    'LBL_OVERVIEW' => 'Informacije o Partnerju', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
    ...
    'LBL_MEETING_TYPE' => 'Sestanki',
    'LBL_CALL_TYPE' => 'Klici',
    'LBL_EMAIL_TYPE' => 'E-pošta',
    'LBL_NOTE_TYPE' => 'Opomba',
    ...
    'LBL_NEW_TASK_BUTTON_TITLE' => 'Ustvari nalogo',
    'LBL_NEW_TASK_BUTTON_LABEL' => 'Ustvari nalogo',
    'LBL_SCHEDULE_MEETING_BUTTON_TITLE' => 'Načrtuj sestanek',
    ...
    'LBL_NEW_NOTE_BUTTON_LABEL' => 'Ustvari opombo ali priponko',
    ...
    'LBL_LIST_LAST_MODIFIED' => 'Zadnje spremenjeno',
    ...
    'LBL_DEFAULT_SUBPANEL_TITLE' => 'Odprte aktivnosti',
    'LBL_LIST_ASSIGNED_TO_NAME' => 'Dodeljeno uporabniku',

    'LBL_ACCEPT' => 'Sprejmem' /*for 508 compliance fix*/,
);
