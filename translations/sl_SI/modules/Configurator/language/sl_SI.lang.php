...
$mod_strings = array(
    ...
    'ADVANCED' => 'Napredno',
    'DEFAULT_CURRENCY_ISO4217' => 'ISO 4217 denarna koda',
    'DEFAULT_CURRENCY_NAME' => 'Ime denarne valute',
    'DEFAULT_CURRENCY_SYMBOL' => 'Denarni simbol',
    'DEFAULT_DATE_FORMAT' => 'Prednastavljen datumski zapis',
    'DEFAULT_DECIMAL_SEP' => 'Decimalni simbol',
    'DEFAULT_LANGUAGE' => 'Prednastavljen jezik',
    'DEFAULT_SYSTEM_SETTINGS' => 'Uporabniška maska',
    'DEFAULT_THEME' => 'prednastavljena tema',
    'DEFAULT_TIME_FORMAT' => 'Prednastavljen časovni format',

    'DISPLAY_RESPONSE_TIME' => 'Prikaži strežniški odzivni čas',

    'IMAGES' => 'Logotipi',
    'LBL_ALLOW_USER_TABS' => 'Dovoli uporabnikom, da skrijejo zavihke',
    'LBL_CONFIGURE_SETTINGS_TITLE' => 'Sistemske nastavitve',
    'LBL_LOGVIEW' => 'Ogled dnevnika',
    ...
    'LBL_MODULE_FAVICON' => 'Prikaži ikono module kot favicon',
    'LBL_MODULE_FAVICON_HELP' => 'Prikaže ikono module kot favicon, namesto ikono teme, v naslovni vrstici brskalnika',
    'LBL_MODULE_NAME' => 'Sistemske nastavitve',
    'LBL_MODULE_ID' => 'Konfigurator',
    'LBL_MODULE_TITLE' => 'Uporabniška maska',
    'LBL_NOTIFY_FROMADDRESS' => '&quot;Od&quot; naslov:',
    'LBL_NOTIFY_SUBJECT' => 'Zadeva:',

    'LBL_PROXY_AUTH' => 'Avthentikacija?',
    'LBL_PROXY_HOST' => 'Proxy',
    'LBL_PROXY_ON_DESC' => 'Nastavi naslov proxy strežnika in avtentikacijske nastavitve',
    'LBL_PROXY_ON' => 'Uporabi proxy strežnik?',
    'LBL_PROXY_PASSWORD' => 'Geslo',
    'LBL_PROXY_PORT' => 'Vrata',
    'LBL_PROXY_TITLE' => 'Proxy Nastavitve',
    'LBL_PROXY_USERNAME' => 'Uporabniško ime',
    'LBL_RESTORE_BUTTON_LABEL' => 'Povrni',
    'LBL_SYSTEM_SETTINGS' => 'Sistemske nastavitve',
    ...
    'LIST_ENTRIES_PER_LISTVIEW' => 'Predmetov na stran v Listview pogledu',
    'LIST_ENTRIES_PER_SUBPANEL' => 'Subpanel predmetov na stan',
    'LOG_MEMORY_USAGE' => 'Beleži uporabo memorije v log datoteki',
    'LOG_SLOW_QUERIES' => 'Beleži počasne querije',
    ...
    'UPLOAD_MAX_SIZE' => 'Največja upload velikost',
    'VERIFY_CLIENT_IP' => 'Validiraj uporabnikov IP naslov',
    ...
    'LBL_LDAP_TITLE' => 'LDAP avtentikacija',
    'LBL_LDAP_LEGACY_WARNING' => 'LDAP opozorilo',
    'LBL_LDAP_LEGACY_WARNING_MORE' => 'Ta LDAP konfiguracija bo uporabljena samo za prijavo API v4. Za prijavo z LDAP v SuiteCRM, dodajte potrebne parametre v datoteko .env.local. Več informacij je na voljo v poglavju o LDAP konfiguraciji v dokumentaciji.',
    'LBL_LDAP_ENABLE' => 'Omogoči LDAP',
    'LBL_LDAP_SERVER_HOSTNAME' => 'Strežnik:',
    'LBL_LDAP_SERVER_PORT' => 'Številka vrat:',
    'LBL_LDAP_ADMIN_USER' => 'Ime uporabnika:',
    'LBL_LDAP_ADMIN_USER_DESC' => 'Used to search for the LDAP user. This may need to be fully qualified.',
    'LBL_LDAP_ADMIN_PASSWORD' => 'Geslo:',
    'LBL_LDAP_AUTHENTICATION' => 'Avtentikacija:',
    ...
    'LBL_LDAP_GROUP_NAME' => 'Ime skupine:',
    ...
    'LBL_LOGGER_DEFAULT_DATE_FORMAT' => 'Prednastavljen datumski zapis',
...
// Wizard
    ...
    'LBL_WIZARD_TITLE' => 'Administratorski čarovnik',
    ...
    'LBL_WIZARD_CONTINUE_BUTTON' => 'Nadaljuj',
    'LBL_WIZARD_FINISH_TITLE' => 'Onsona konfiguracija sistema je končana',
    ...
    'LBL_DELETE' => 'Briši' /*for 508 compliance fix*/,
