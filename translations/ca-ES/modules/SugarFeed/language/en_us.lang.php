...
$mod_strings = array(
    ...
    'LBL_TIME_AGO' => 'fa',
// Activity stream
    'CREATED_CONTACT' => 'creat un <b>NOU</b> {0}', // For fusional (inflected) languages: used in the sentence "Administrator created a new contact"
    'CREATED_OPPORTUNITY' => 'creat un <b>NOU</b> {0}', // For fusional (inflected) languages: used in the sentence "Administrator created a new opportunity"
    'CREATED_CASE' => 'creat un <b>NOU</b> {0}', // For fusional (inflected) languages: used in the sentence "Administrator created a new case"
    'CREATED_LEAD' => 'creat un <b>NOU</b> {0}', // For fusional (inflected) languages: used in sentence "Administrator created a new lead"
