...
$mod_strings = array(
    ...
    'LBL_TIME_AGO' => 'առաջ',
// Activity stream
    'CREATED_CONTACT' => 'ստեղծվել է <b>նոր</b> {0}', // For fusional (inflected) languages: used in the sentence "Administrator created a new contact"
    'CREATED_OPPORTUNITY' => 'ստեղծվել է <b>նոր</b> {0}', // For fusional (inflected) languages: used in the sentence "Administrator created a new opportunity"
    'CREATED_CASE' => 'ստեղծվել է <b>նոր</b> {0}', // For fusional (inflected) languages: used in the sentence "Administrator created a new case"
    'CREATED_LEAD' => 'ստեղծվել է <b>նոր</b> {0}', // For fusional (inflected) languages: used in sentence "Administrator created a new lead"
