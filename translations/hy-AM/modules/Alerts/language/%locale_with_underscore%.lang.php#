...
$mod_strings = array(
    ...
    'LBL_REMOVE' => 'Հեռացնել',
    'LBL_LIST_FORM_TITLE' => 'Ծանուցումների ցուցակ',
    'LBL_MODULE_NAME' => 'Ծանուցումներ',
    'LBL_MODULE_TITLE' => 'Ծանուցումներ',
    'LBL_HOMEPAGE_TITLE' => 'Իմ ծանուցումները',
    'LNK_NEW_RECORD' => 'Ստեղծել ծանուցում',
    'LNK_LIST' => 'Ծանուցումներ',
    'LBL_SEARCH_FORM_TITLE' => 'Որոնել ծանուցումներ',
    'LBL_HISTORY_SUBPANEL_TITLE' => 'Դիտել պատմությունը',
    'LBL_ACTIVITIES_SUBPANEL_TITLE' => 'Գործունեություն',
    'LBL_NEW_FORM_TITLE' => 'Նոր ծանուցում',
    'LBL_IS_READ' => 'կարդացվում է',
