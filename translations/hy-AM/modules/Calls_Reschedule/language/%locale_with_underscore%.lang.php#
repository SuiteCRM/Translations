...
$mod_strings = array(
    ...
    'LBL_REMOVE' => 'Հեռացնել',
    'LBL_LIST_FORM_TITLE' => 'Վերապլանավորման ցուցակ',
    'LBL_MODULE_NAME' => 'Վերապլանավորել',
    'LBL_MODULE_TITLE' => 'Վերապլանավորել',
    'LBL_HOMEPAGE_TITLE' => 'Իմ վերապլանավորումը',
    'LNK_NEW_RECORD' => 'Ստեղծել վերապլանավորում',
    'LNK_LIST' => 'Դիտել վերապլանավորումը',
    'LBL_SEARCH_FORM_TITLE' => 'Որոնել վերապլանավորում',
    'LBL_HISTORY_SUBPANEL_TITLE' => 'Դիտել պատմությունը',
    'LBL_ACTIVITIES_SUBPANEL_TITLE' => 'Գործունեություն',
    'LBL_NEW_FORM_TITLE' => 'Նոր վերապլանավորում',
    'LBL_REASON' => 'Պատճառ',
    'LBL_CALLS' => 'Զանգեր',
);
