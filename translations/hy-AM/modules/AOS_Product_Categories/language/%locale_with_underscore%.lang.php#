...
$mod_strings = array(
    ...
    'LBL_REMOVE' => 'Հեռացնել',
    'LBL_LIST_FORM_TITLE' => 'Ապրանքի կատեգորիաների ցանկ',
    'LBL_MODULE_NAME' => 'Ապրանքի կատեգորիաներ',
    'LBL_MODULE_TITLE' => 'Ապրանքի կատեգորիաներ',
    'LBL_HOMEPAGE_TITLE' => 'Իմ ապրանքի կատեգորիաները',
    'LNK_NEW_RECORD' => 'Ստեղծել ապրանքի կատեգորիաներ',
    'LNK_LIST' => 'Դիտել ապրանքի կատեգորիաները',
    'LBL_SEARCH_FORM_TITLE' => 'Որոնել ապրանքի կատեգորիաները',
    'LBL_HISTORY_SUBPANEL_TITLE' => 'Դիտել պատմությունը',
    'LBL_ACTIVITIES_SUBPANEL_TITLE' => 'Գործունեություն',
    'LBL_NEW_FORM_TITLE' => 'Նոր ապրանքի կատեգորիաներ',
    'LBL_PARENT_CATEGORY' => 'Ծնողական կատեգորիա',
    'LBL_IS_PARENT' => "Ծնողական կատեգորիա",
    'LBL_SUB_CATEGORIES' => "Ենթակատեգորիաներ",
    'LBL_PRODUCT_CATEGORYS_NAME' => "Ծնողական կատեգորիա",
    'LBL_PARENT_CATEGORY_ID' => "Ծնողական կատեգորիա ID",
