...
$mod_strings = array(
    ...
    'LBL_NAME' => 'Անվանում',
    'LBL_MODULE_NAME' => 'Գործընթացի գործողություններ',
    'LBL_MODULE_TITLE' => 'Գործընթացի գործողություններ',
    'LBL_AOW_WORKFLOW_ID' => 'AOW_Գործընթացի ID',
    'LBL_ACTION' => 'Գործողություն',
    'LBL_PARAMETERS' => 'Պարամետր',
    'LBL_SELECT_ACTION' => 'Ընտրել գործողությունը',
    'LBL_CREATE_EMAIL_TEMPLATE' => 'Ստեղծել',
    'LBL_RECORD_TYPE' => 'Գրառման տեսակ',
    'LBL_SENDEMAIL' => 'Ուղարկել էլ-նամակ',
    'LBL_CREATERECORD' => 'Create Record',
    'LBL_MODIFYRECORD' => 'Modify Record',
    'LBL_ADD_FIELD' => 'Ավելացնել դաշտ',
    'LBL_ADD_RELATIONSHIP' => 'Ավելացնել հարաբերությունները',
    'LBL_EDIT_EMAIL_TEMPLATE' => 'Խմբագրել',
    'LBL_EMAIL' => 'Էլ-փոստ',
    'LBL_EMAIL_TEMPLATE' => 'Էլ-փոստի ձևանմուշ',
    'LBL_SETAPPROVAL' => 'Set Approval',
    'LBL_RELATE_WORKFLOW' => 'Միացեք Workflow մոդուլին',
    'LBL_INDIVIDUAL_EMAILS' => 'Ուղարկել անհատականապես բոլոր նշված էլ-հասցեներով',
    'LBL_COMPUTEFIELD' => 'Calculate Fields',
    'LBL_COMPUTEFIELD_PARAMETERS' => 'Պարամետր',
    ...
    'LBL_COMPUTEFIELD_FORMULA' => 'Բանաձև',
