...
$mod_strings = array(
    'LBL_CONSKEY' => 'Օգտագործողի բանալի',
    'LBL_CONSSECRET' => 'Սպառողի գաղտնիությունը',
