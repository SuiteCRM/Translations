...
$mod_strings = array(
    ...
    'LBL_DB_UNAVAILABLE' => 'Տվյալների շտեմարանն անհասանելի է:',
    ...
    'ERR_DB_EXISTS_WITH_CONFIG' => 'Տվյալների շտեմարանն արդեն առկա է՝ կարգավորման տվյալներով հանդերձ:  Ընտրված շտեմարանով տեղադրում իրականացնելու համար խնդրում ենք վերսկսել տեղադրումը և ընտրել "Ջնջել և վերաստեղծե՞լ SuiteCRM-ի գոյություն ունեցող աղյուսակները:"  Թարմացումներ(բարելավումներ) կիրառելու համար օգտվեգ Կառավարման Վահանակի Թարմացման օգնականից: Խնդրում ենք կարդալ բարելավման մասին տեղեկատվությունը <a href="https://docs.suitecrm.com/admin/installation-guide/upgrading/" target="_new">այստեղ</a>.',
    ...
    'ERR_DB_HOSTNAME' => 'Հանգույցի անվանումը չի կարող դատարկ լինել։',
    'ERR_DB_INVALID' => 'Ընտրված տվյալների բազայի տեսակը անվավեր է։',
    ...
    'ERR_DB_NAME' => 'Տվյալների բազային անվանումը չի կարող դատարկ լինել։',
    'ERR_DB_MYSQL_DB_NAME_INVALID' => "Տվյալների բազային անվանումը չի կարող պարունակել '\\', '/', կամ '.'",
    ...
    'ERR_NO_DIRECT_SCRIPT' => 'Հնարավոր չէ անմիջապես մշակել սքրիփթը։',
    ...
    'ERR_PERFORM_CONFIG_PHP_1' => 'Հնարավոր չէ գրանցել <span class=stop>config.php</span> ֆայլը։',
    'ERR_PERFORM_CONFIG_PHP_2' => 'Դուք կարող եք շարունակել այս տեղադրումը, ձեռքով ստեղծելով config.php ֆայլը և պատճենելով ստորև բերված կարգավորման տեղեկատվությունը config.php ֆայլում: Սակայն պետք է ստեղծեք config.php ֆայլը նախքան հաջորդ քայլին անցնելը։',
    'ERR_PERFORM_CONFIG_PHP_3' => 'Դուք չե՞ք մոռացել ստեղծել config.php ֆայլը։',
    'ERR_PERFORM_CONFIG_PHP_4' => 'Զգուշացում. Հնարավոր չէ գրանցել  config.php ֆայլը: Համոզվեք, որ այն գոյություն ունի։',
    ...
    'ERR_SESSION_DIRECTORY_NOT_EXISTS' => 'Սեսիայի ֆայլապանակների համար նշված է սխալ պանակների կատալոգ։',
    'ERR_SESSION_DIRECTORY' => 'Սեսիայի ֆայլապանակների համար նշված պանակների կատալոգը անհասանելի է գրառման համար:',
    'ERR_SESSION_PATH' => 'Եթե ցանկանում եք նշել ձեր սեփական թղթապանակը, պետք է նշեք դրան անցնելու ուղին:   ',
    'ERR_SI_NO_CONFIG' => 'Դուք չեք ներառել config_si.php ֆայլը արմատային թղթապանակում կամ config.php ֆայլում չեք սահմանել $sugar_config_si փոփոխականը: ',
    'ERR_SITE_GUID' => 'Եթե ցանկանում եք նշել դիմումը, որպես ձեր սեփական, պահանջվում է ID-ն։',
    ...
    'LBL_CHECKSYS_CACHE' => 'Cashe պանակի ենթակատալոգներ',
    ...
    'LBL_CHECKSYS_CONFIG' => 'SuiteCRM-ի կարգավորման config.php ֆալյը հասանելի է գրառում կատարելու համար',
    'LBL_CHECKSYS_CURL' => 'cURL մոդուլ',
    'LBL_CHECKSYS_CUSTOM' => 'Հարմարեցված պանակների կատալոգը գրառման համար հասանելի չէ',
    'LBL_CHECKSYS_DATA' => 'Տվյալների ենթակատալոգները գրառելի են',
    'LBL_CHECKSYS_IMAP' => 'IMAP մոդուլ',
    ...
    'LBL_CHECKSYS_MODULE' => 'Գրառելի մոդուլների ենթակատալոգներ և ֆայլեր',
    'LBL_CHECKSYS_NOT_AVAILABLE' => 'Անհասանելի',
    'LBL_CHECKSYS_OK' => 'OK',
    'LBL_CHECKSYS_PHP_INI' => 'Location of your PHP configuration file (php.ini)',
    'LBL_CHECKSYS_PHP_OK' => 'OK (տարբերակը ',
    'LBL_CHECKSYS_PHPVER' => 'PHP Տարբերակ',
    'LBL_CHECKSYS_IISVER' => 'IIS Version',
    'LBL_CHECKSYS_JSON' => 'JSON Parsing',
    'LBL_CHECKSYS_RECHECK' => 'Ստուգել',
    'LBL_CHECKSYS_STATUS' => 'Կարգավիճակ',
    'LBL_CHECKSYS_TITLE' => 'Համակարգային պահանջների ստուգում',
    ...
    'LBL_SETUP_CRONTAB' => 'Կարգաբերել Crontab ֆայլը',
    ...
    'LBL_DBCONF_COLLATION' => 'Համեմատում',
    'LBL_DBCONF_CHARSET' => 'Նիշերի հավաքածու',
    'LBL_DBCONF_ADV_DB_CFG_TITLE' => 'Advanced Database Configuration',
    'LBL_DBCONF_DEMO_DATA' => 'Լրացնե՞լ տվյալների բազայի հետ ցուցադրական տվյալները:',
    'LBL_DBCONF_DEMO_DATA_TITLE' => 'Choose Demo Data',
    'LBL_DBCONF_HOST_NAME' => 'Սերվերի անվանումը',
    ...
    'LBL_DISABLED_DESCRIPTION' => 'Տեղադրող ծրագիրը արդեն մի անգամ օգտագործվել է։ Անվտանգության համար հնարավոր չէ օգտագործել երկրորդ անգամ։ Եթե դուք համոզված եք, որ տեղադրող ծրագիրը օգտագործելու եք երկրորդ անգամ, խնդրում ենք բացեք ձեր config.php ֆայլը գտնել (կամ ավելացնել) \'installer_locked\' անունով փոփոխական, և նրա արժեքը դնել  ՛false՛:  Տողը պետք է լինի այսպես․',
    'LBL_DISABLED_HELP_1' => 'Ներբեռնման օգնությունից օգտվելու համար, խնդրում ենք մուտք գործել SuiteCRM',
    ...
    'LBL_DISABLED_TITLE_2' => 'SuiteCRM տեղադրումը անջատված է',
    'LBL_HELP' => 'Օգնություն',
    'LBL_INSTALL' => 'Տեղադրել',
    ...
    'LBL_LANG_BUTTON_COMMIT' => 'Տեղադրել',
    'LBL_LANG_BUTTON_REMOVE' => 'Հեռացնել',
    'LBL_LANG_BUTTON_UNINSTALL' => 'Ապատեղադրել',
    'LBL_LANG_BUTTON_UPLOAD' => 'Վերբեռնել',
    ...
    'LBL_LICENSE_ACCEPTANCE' => 'Լիցենզիայի ընդունում',
    ...
    'LBL_LICENSE_PRINTABLE' => ' Տպելու տարբերակը ',
    'LBL_PRINT_SUMM' => 'Print Summary',
    'LBL_LICENSE_TITLE_2' => 'SuiteCRM լիցենզիա',
    'LBL_LICENSE' => 'LICENSE',
    ...
    'LBL_NEXT' => 'Հաջորդ',
    'LBL_NO' => 'Ոչ',
    'LBL_PERFORM_ADMIN_PASSWORD' => 'Մուտքագրել համակարգի ադմինիստրատորի գաղտնաբառը',
    'LBL_PERFORM_CONFIG_PHP' => 'SuiteCRM կարգավորման ֆայլի ստեղծում',
    'LBL_PERFORM_CREATE_DB_1' => '<b>Creating the database</b> ',
    'LBL_PERFORM_CREATE_DB_2' => ' <b>on</b> ',
    'LBL_PERFORM_CREATE_DB_USER' => 'Ստեղծվում է տվյալների բազայից օգտվողի օգտանունը և գաղտնաբառը...',
    'LBL_PERFORM_CREATE_DEFAULT' => 'SuiteCRM-ի ստանդարտ տվյալների ստեղծում',
    'LBL_PERFORM_DEFAULT_SCHEDULER' => 'Ստեղծվում է լռելյայն պլանավորողի առաջադրանքներ',
    'LBL_PERFORM_DEFAULT_USERS' => 'Ստանդարտ օգտվողների ստեղծում',
    'LBL_PERFORM_DEMO_DATA' => 'Populating the database tables with demo data (this may take a little while)',
    'LBL_PERFORM_DONE' => 'կատարված է<br>',
    'LBL_PERFORM_FINISH' => 'Վերջ',
    'LBL_PERFORM_OUTRO_1' => 'SuiteCRM- տեղադրում ',
    'LBL_PERFORM_OUTRO_2' => ' is now complete!',
    'LBL_PERFORM_OUTRO_3' => 'Ընդհանուր ժամանակը․ ',
    'LBL_PERFORM_OUTRO_4' => ' վարկյան․',
    'LBL_PERFORM_OUTRO_5' => 'Մոտավորապես հիշողություն է օգտագործված․ ',
    'LBL_PERFORM_OUTRO_6' => ' բայթ։',
    'LBL_PERFORM_SUCCESS' => 'Տեղադրումը հաջող է կատարվել։',
    'LBL_PERFORM_TABLES' => 'Creating SuiteCRM application tables, audit tables and relationship metadata',
    'LBL_PERFORM_TITLE' => 'Կատարել տեղադրումը',
    'LBL_PRINT' => 'Տպել',
    ...
    'LBL_REG_CONF_3' => 'Շնորհակալություն գրանցվելու համար։ Որպեսզի մուտք անեք SuiteCRM սեղմեք "ավարտ" կոճակը։ Առաջին անգամ մուտք գործելու համար ձեզ անհրաժեշտ է ձեր "մուտքանունը" և "գաղտնաբառը", որոնք դուք մուտքագրելեք քայլ 2-ի ժամանակ։',
    ...
    'LBL_SITECFG_CUSTOM_ID' => 'Տրամադրել Ձեր սեփական դիմումի ID- ն',
    ...
    'LBL_STEP' => 'Քայլ',
    'LBL_TITLE_WELCOME' => 'Բարի գալուստ SuiteCRM ',
    'LBL_WELCOME' => 'Բարի գալուստ SuiteCRM',
    ...
    'LBL_WELCOME_SETUP_WIZARD' => 'Տեղադրման օգնական',
    ...
    'LBL_YOUR_PHP_VERSION' => '(ձեր ընթացիկ php տարբերակն է՝',
...
$contact_user_link_guid',
    ...
    'COMPANY_LOGO_UPLOAD_BTN' => 'Վերբեռնել',
    ...
    'ERR_UPLOAD_FILE_UPLOAD_ERR_INI_SIZE' => 'Ներբեռնված ֆայլի չափը գերազանցում է upload_max_filesize directive in php.ini պարամետրում նշված մեծությունը: ',
    'ERR_UPLOAD_FILE_UPLOAD_ERR_FORM_SIZE' => 'Ներբեռնվող ֆայլի չափը գերազանցում է այն մեծությունը, որը նշված է HTML ձևի MAX_FILE_SIZE պարամետրում:',
    'ERR_UPLOAD_FILE_UPLOAD_ERR_PARTIAL' => 'Ներբեռնվող ֆայլը միայն մասնակիորեն է ներբեռնված:',
    'ERR_UPLOAD_FILE_UPLOAD_ERR_NO_FILE' => 'Ոչ մի ֆայլ չի բեռնվել:',
    'ERR_UPLOAD_FILE_UPLOAD_ERR_NO_TMP_DIR' => 'Բացակայում է ժամանակավոր ֆայլերի պանակը:',
    'ERR_UPLOAD_FILE_UPLOAD_ERR_CANT_WRITE' => 'Չհաջողվեց ֆայլը սկավառակի վրա գրանցել:',
    ...
    'LBL_DBCONFIG_MSG2_LABEL' => 'Սերվերի անվանումը',
