...
$mod_strings = array(
    ...
    'LBL_DEFAULT_SUBPANEL_TITLE' => 'Akosile',
    'LBL_DESCRIPTION' => 'Akosile',
    ...
    'LBL_NOTE_INFORMATION' => 'Isonisoki', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
