...
$mod_strings = array(
    ...
    'LBL_ADVANCED_TYPE' => 'Iru To ti ni ilọsiwaju',
    'LBL_SYSOPTS_2' => 'Iru iru ipamọ data yoo lo fun apeere SuiteCRM ti o fẹ lati fi sori ẹrọ?',
    'LBL_SYSOPTS_DB' => 'Pato iruwe data',
    'LBL_SYSOPTS_DB_TITLE' => 'Iru ipilẹ data',
    'LBL_SYSOPTS_ERRS_TITLE' => 'Jowo tunasise yi se ki oto tesiwaju:',
    'ERR_DB_VERSION_FAILURE' => 'Ko le ṣayẹwo iwe ikede data.',
    'DEFAULT_CHARSET' => 'UTF-8',
    'ERR_ADMIN_USER_NAME_BLANK' => 'Pese awọn orukọ olumulo fun awọn SuiteCRM admin olumulo. ',
    'ERR_ADMIN_PASS_BLANK' => 'Pese ọrọ igbaniwọle fun Olumulo olumulo SuiteCRCRM. ',

    'ERR_CHECKSYS' => 'A ti ri awọn aṣiṣe lakoko wiwa ibamu. Ni ibere fun fifi sori SuiteCRM rẹ lati ṣiṣẹ daradara, jọwọ gbe awọn igbesẹ to dara lati koju awọn oran ti o wa ni isalẹ ati boya tẹ bọtini atunyẹwo, tabi gbiyanju lati fi sori ẹrọ lẹẹkansi.',
    'ERR_CHECKSYS_CALL_TIME' => 'Gba aago ipe akoko silẹ apejuwe jẹ Lori (eyi ni a gbọdọ ṣeto si Pipa ni php.ini)',
    'ERR_CHECKSYS_CURL' => 'A ko ri: Skedula SuiteCRM yoo sise pelu sise ti o lopin.',
    'ERR_CHECKSYS_IMAP' => 'Ko ri: aman ti o n lo si Imeeli ati Awọn Ipolongo (Imeeli) nilo awọn ile-iwe IMAP. Bẹni kii ṣe iṣẹ.',
    'ERR_CHECKSYS_MEM_LIMIT_1' => ' (Ṣeto eyi si ',
    'ERR_CHECKSYS_MEM_LIMIT_2' => 'M tabi o tobi julọ ninu faili php.ini rẹ)',
    'ERR_CHECKSYS_NOT_WRITABLE' => 'Ikilo: Ko se Ko',
    'ERR_CHECKSYS_PHP_INVALID_VER' => 'Aṣeyọri ti PHP ko ni atilẹyin nipasẹ SuiteCRM. Iwọ yoo nilo lati fi sori ẹrọ kan ti o jẹ ibaramu pẹlu ohun elo SuiteCRM. Jọwọ kan si alakoso ibamu ni Awọn akọsilẹ akọsilẹ fun awọn ẹya PHP ti o ni atilẹyin. Ikede rẹ jẹ ',
    'ERR_CHECKSYS_IIS_INVALID_VER' => 'Ikede rẹ ti IIS ko ni atilẹyin nipasẹ SuiteCRM. Iwọ yoo nilo lati fi sori ẹrọ kan ti o jẹ ibaramu pẹlu ohun elo SuiteCRM. Jowo kan si alakaamu ibamu ni awọn Akọsilẹ Akọsilẹ fun Awọn IIS Iwọn ti o ni atilẹyin. Ikede rẹ jẹ ',
    'ERR_CHECKSYS_FASTCGI' => 'A wa pe o ko ni lilo aworan kikọ oluṣakoso faili FastCGI fun PHP. Iwọ yoo nilo lati fi sori ẹrọ / tunto ẹyà ti o ni ibamu pẹlu ohun elo SuiteCRM. Jowo kan si alakoso ibamu ni awọn Akọsilẹ Akọsilẹ fun awọn ẹya ti o ni atilẹyin. Jọwọ wo <a href="http://www.iis.net/php/" target="_blank"> http://www.iis.net/php/ </a> fun awọn alaye ',
    'ERR_CHECKSYS_FASTCGI_LOGGING' => 'Fun iriri ti o dara julọ nipa lilo IIS / FastCGI sapi, ṣeto fastcgi.logging si 0 ninu faili php.ini rẹ.',
    'LBL_DB_UNAVAILABLE' => 'Aaye data ko si',
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'A ko ri Support Alailowaya aaye. Jọwọ rii daju pe o ni awọn awakọ ti o yẹ fun ọkan ninu awọn aaye data Imọlẹ atẹle wọnyi: MySQL tabi MS SQLServer. O le nilo lati ṣe itupalẹ igbimọ ni faili php.ini, tabi ṣe atunṣe pẹlu faili alakomeji ọtun, ti o da lori ikede PHP rẹ. Jowo tọka si Afowoyi PHP rẹ fun alaye diẹ sii lori bi o ṣe le ṣe atilẹyin aaye data.',
    'LBL_CHECKSYS_XML_NOT_AVAILABLE' => 'Awọn iṣẹ ti o ni nkan ṣe pẹlu XML Parser Awọn Iwe-ikawe ti a nilo nipasẹ ohun elo SuiteCRM ko ri. O le nilo lati ṣe itupalẹ igbimọ ni faili php.ini, tabi ṣe atunṣe pẹlu faili alakomeji ọtun, ti o da lori ikede PHP rẹ. Jowo tọka si Afowoyi PHP fun alaye siwaju sii.',
    'ERR_CHECKSYS_MBSTRING' => 'Awọn iṣẹ ti o ni nkan ṣe pẹlu awọn gbolohun ọpọlọpọ Multiplete PHP extension (mbstring) ti o nilo nipa ohun elo SuiteCRM ko ri. <br/><br/> Ni gbogbogbo, a ko ṣe atunṣe module ti o ni ibẹrẹ ni aifọwọyi ni PHP ati pe o gbọdọ muu ṣiṣẹ pẹlu - -agbajade-ọna nigbati a ṣe itumọ PHP alakomeji. Jowo tọka si Afowoyi PHP rẹ fun alaye diẹ sii lori bi a ṣe le ṣe atilẹyin atilẹyin ọja.',
    'ERR_CHECKSYS_CONFIG_NOT_WRITABLE' => 'Ọna faili tun wa ṣugbọn kii ṣe akọsilẹ. Jowo mu awọn igbesẹ pataki lati ṣe ki iwe naa kọwe. Ti o da lori ilana eto rẹ, eyi le beere pe ki o yi awọn igbanilaaye naa pada nipa lilo chmod 766, tabi lati tẹ ọtun lati tẹ orukọ lati wọle si awọn ohun ini ati ki o yanki aṣayan nikan ti a ka.',
    'ERR_CHECKSYS_CONFIG_OVERRIDE_NOT_WRITABLE' => 'Faili iṣakoso ti iṣakoso ti wa ṣugbọn kii ṣe akọsilẹ. Jowo mu awọn igbesẹ pataki lati ṣe ki iwe naa kọwe. Ti o da lori ilana eto rẹ, eyi le beere pe ki o yi awọn igbanilaaye naa pada nipa lilo chmod 766, tabi lati tẹ ọtun lati tẹ orukọ lati wọle si awọn ohun ini ati ki o yanki aṣayan nikan ti a ka.',
    'ERR_CHECKSYS_CUSTOM_NOT_WRITABLE' => 'Itọsọna Aṣa ti wa ṣugbọn kii ṣe akọsilẹ. O le ni lati yi awọn igbanilaaye pada si ori rẹ (chmod 766) tabi tẹ ọtun lori rẹ ki o si yanki aṣayan nikan ti a ka, ti o da lori Eto Iseto rẹ. Jọwọ mu awọn igbesẹ ti a nilo lati ṣe ki iwe naa kọwe.',
    'ERR_CHECKSYS_FILES_NOT_WRITABLE' => "Awọn faili tabi awọn ilana ti a ṣe akojọ rẹ si isalẹ kii ṣe akọsilẹ tabi sonu ati pe a ko le ṣẹda. Ti o da lori ọna ṣiṣe ẹrọ rẹ, atunṣe eyi le beere pe ki o yi awọn igbanilaaye pada lori awọn faili tabi igbimọ ẹbi (chmod 755), tabi lati tẹ ẹtun lori itọsọna ẹda ki o si ṣayẹwo aṣayan aṣayan 'ka nikan' ati ki o lo o si gbogbo awọn folda.",
    ...
    'LBL_CHECKSYS_OVERRIDE_CONFIG' => 'Ṣiṣeto atokuro',
    'ERR_CHECKSYS_SAFE_MODE' => 'Ipo ailewu wa Lori (o le fẹ lati mu ni php.ini)',
    'ERR_CHECKSYS_ZLIB' => 'Igbesoke ZLib ko ri: SuiteCRPC n ṣaapọ awọn anfani iponju nla pẹlu asọtẹlẹ titẹ.',
    'ERR_CHECKSYS_ZIP' => 'Iranlọwọ support ZIP ko ri: SuiteCRC nilo atilẹyin ZIP lati ṣe atunṣe awọn faili ti a ni irẹwẹsi.',
    'ERR_CHECKSYS_PCRE' => 'Iwe-iṣẹ ti PCRE ko ri: SuiteCRM nilo iwe-ikawe PCRE lati le ṣe igbasilẹ ọna Perl ti ọna kika deede.',
    'ERR_CHECKSYS_PCRE_VER' => 'Iwe-ikede ile-iwe CRE: SuiteCRM nilo iwe-ikawe PCRE 7.0 tabi loke lati ṣe igbasilẹ ọna Perl ti ọna kika deede.',
    'ERR_DB_ADMIN' => 'Olumulo olumulo ipamọ data ti a pese ti ati / tabi ọrọigbaniwọle jẹ alailẹgbẹ, ati asopọ si database ko le fi idi mulẹ. Jọwọ tẹ orukọ olumulo ati ọrọigbaniwọle kan to wulo. (Aṣiṣe: ',
    'ERR_DB_ADMIN_MSSQL' => 'Olumulo olumulo ipamọ data ti a pese ti ati / tabi ọrọigbaniwọle jẹ alailẹgbẹ, ati asopọ si database ko le fi idi mulẹ. Jọwọ tẹ orukọ olumulo ati ọrọigbaniwọle kan to wulo.',
    'ERR_DB_EXISTS_NOT' => 'Awọn pàtó ibi ipamọ data ko ni tẹlẹ.',
    'ERR_DB_EXISTS_WITH_CONFIG' => 'Data ti wa tẹlẹ pẹlu tito data. Lati ṣiṣe fifi sori ẹrọ pẹlu ibi ipamọ data ti a yàn, jọwọ tun ṣe igbasilẹ ti fi sori ẹrọ ati yan: "Gbọ ati ki o tun ṣajọ awọn tabili SuiteCRM tẹlẹ?". Lati igbesoke, lo Oluṣeto igbesoke ni Igbimọ Admin. Jọwọ ka awọn iwe igbesoke ti o wa <a href="https://docs.suitecrm.com/admin/installation-guide/upgrading/" target="_new">Nibi</a>.',
    'ERR_DB_EXISTS' => 'Orukọ aaye data ti a ti pese tẹlẹ wa - ko le ṣẹda ẹlomiran pẹlu orukọ kanna.',
    'ERR_DB_EXISTS_PROCEED' => 'Orukọ aaye data ti a ti pese tẹlẹ wa. O le <br>1. lu bọtini ti o pada ki o yan orukọ titun database kan <br>2. tẹ tókàn ki o tẹsiwaju ṣugbọn gbogbo awọn tabili to wa tẹlẹ lori aaye data yii yoo silẹ. <strong> Eyi tumọ si awọn tabili rẹ ati data ti yoo fẹ kuro. </strong>',
    'ERR_DB_HOSTNAME' => 'Oruko hosti ko le je ofifo.',
    'ERR_DB_INVALID' => 'Iru databasi ti ko wulo ni won yan.',
    'ERR_DB_LOGIN_FAILURE' => 'Alabojuto ipamọ data ti a pese, orukọ olumulo, ati / tabi ọrọ igbaniwọle jẹ alailẹgbẹ, ati asopọ si database ko le fi idi mulẹ. Jowo tẹ ami-iṣẹ ti o wulo, orukọ olumulo ati ọrọigbaniwọle',
    'ERR_DB_LOGIN_FAILURE_MYSQL' => 'Alabojuto ipamọ data ti a pese, orukọ olumulo, ati / tabi ọrọ igbaniwọle jẹ alailẹgbẹ, ati asopọ si database ko le fi idi mulẹ. Jowo tẹ ami-iṣẹ ti o wulo, orukọ olumulo ati ọrọigbaniwọle',
    'ERR_DB_LOGIN_FAILURE_MSSQL' => 'Alabojuto ipamọ data ti a pese, orukọ olumulo, ati / tabi ọrọ igbaniwọle jẹ alailẹgbẹ, ati asopọ si database ko le fi idi mulẹ. Jowo tẹ ami-iṣẹ ti o wulo, orukọ olumulo ati ọrọigbaniwọle',
    'ERR_DB_MYSQL_VERSION' => 'Ti ikede MySQL rẹ (%s) ko ni atilẹyin nipasẹ SuiteCRM. Iwọ yoo nilo lati fi sori ẹrọ kan ti o jẹ ibaramu pẹlu ohun elo SuiteCRM. Jọwọ kan si alakoso ibamu ni Awọn akọsilẹ Akọsilẹ fun awọn ẹya MySQL ti a ṣe atilẹyin.',
    'ERR_DB_NAME' => 'Oruko databasi ko le wa ni ofifo.',
    'ERR_DB_MYSQL_DB_NAME_INVALID' => "Oruko databasi ko le ni '\\', '/' tabi '.'",
    'ERR_DB_MSSQL_DB_NAME_INVALID' => "Orukọ data ko le bẹrẹ pẹlu nọmba kan, '#', tabi '@' ko si ni aaye kan, '\"', ''\", '*', '/', '\\', '?', ':', '<', '>', '&', '!', tabi '-'",
    'ERR_DB_OCI8_DB_NAME_INVALID' => "Orukọ data le nikan ni awọn ohun alphanumeric ati awọn aami '#', '_' tabi '$'",
    'ERR_DB_PASSWORD' => 'Awọn ọrọ igbaniwọle ti a pese fun aláfikún Suite database naa ko baramu. Jọwọ tun-tẹ awọn ọrọ igbaniwọle kanna ni awọn aaye igbaniwọle.',
    'ERR_DB_PRIV_USER' => 'Pese orukọ olumulo olupin data kan. Awọn olumulo ti beere fun ni ibẹrẹ asopọ si awọnibi ipamọ data.',
    'ERR_DB_USER_EXISTS' => 'Orukọ olumulo fun olumulo data database Suite wa tẹlẹ - ko le ṣẹda ẹlomiran pẹlu orukọ kanna. Jọwọ tẹ orukọ olumulo titun sii.',
    'ERR_DB_USER' => 'Tẹ orukọ olumulo kan sii fun SuiteCRM aláṣẹ data.',
    'ERR_DBCONF_VALIDATION' => 'Jowo tunasise yi se ki oto tesiwaju:',
    'ERR_DBCONF_PASSWORD_MISMATCH' => 'Awọn ọrọ igbaniwọle ti a pese fun olumulo olumulo data database ko baramu. Jọwọ tun-tẹ awọn ọrọ igbaniwọle kanna ni awọn aaye igbaniwọle.',
    'ERR_ERROR_GENERAL' => 'A pade awon asise won yi:',
    ...
    'ERR_PERFORM_CONFIG_PHP_1' => 'Ko le ko si faili <span class=stop>config.php</span>.',
    'ERR_PERFORM_CONFIG_PHP_2' => 'O le tesiwaju instaltionu yi nipa siseda faili config.php ati lile iseto alaye ni isale sinu faili config.php. Sibesibe, o<strong>gbodo</strong>seda faili ti config.php ki o to tesiwaju si igbese ti o tele.',
    'ERR_PERFORM_CONFIG_PHP_3' => 'Se o ranti lati seda faili config.php?',
    'ERR_PERFORM_CONFIG_PHP_4' => 'Ikilo: Ko le ko si faili config.php. Jowo ri daju pe o wa.',
    'ERR_PERFORM_HTACCESS_1' => 'Ko le ko si ti ',
    'ERR_PERFORM_HTACCESS_2' => ' faili.',
    'ERR_PERFORM_HTACCESS_3' => 'Ti o ba fe da aabo faili logi re lati je ki won ma le wole nipase browsa, seda faili .htcaccess kan ninu logi igbasile re pelu ila:',
    ...
    'ERR_SESSION_DIRECTORY_NOT_EXISTS' => 'Igbasile sessionu ti o fi kale ko ki n se igbasile ti o wulo.',
    'ERR_SESSION_DIRECTORY' => 'Igbasile sessionu ti o fi kale ko ki n se igbasile ti o se ko.',
    'ERR_SESSION_PATH' => 'Ona sessionu se koko ti o ba wun e lati yan ti re.',
    ...
    'ERR_SITE_GUID' => 'O nilo Application ID ti o ba fe yan ti re.',
    ...
    'LBL_CHECKSYS_CONFIG' => 'Faili Configurationu SuiteCRM ti o se ko (config.php)',
    ...
    'LBL_CHECKSYS_RECHECK' => 'Tun-wo',
    'LBL_CHECKSYS_STATUS' => 'Ipo',
    ...
    'LBL_CONFIRM_DB_TYPE' => 'Iru ipilẹ data',
    'LBL_CONFIRM_NOT' => 'kii ṣe',
    'LBL_CONFIRM_TITLE' => 'Jẹrisi Awọn eto',
    'LBL_CONFIRM_WILL' => 'yoo',
    ...
    'LBL_DBCONF_TITLE_PSWD_INFO_LABEL' => 'Pasiwodu',
    'LBL_DISABLED_DESCRIPTION_2' => 'Leyin ti a se iyipada yii, o le te botini "Bere" ni isale lati bere instalationu re.
<i>Lehin instalationu ba ti pari, o ma fe lati yi iya pada fun \'installa_locked\' si \'otito\'.</i>',
    'LBL_DISABLED_DESCRIPTION' => 'Installa yen ti sise ni ekan. Gegebi odiwon ailewu, a ti disabu re lati sise ni ekeji. Ti o ba da e loju wipe o fe ko sise leekansi, jowo losi faili config.php ki osi wa (tabi fikun) variabu kan ti a pe ni \'installer_locked\' ki o si seto re si \'iro\'. Ila yen gbodo ri bayi:',
    'LBL_DISABLED_HELP_1' => 'Fun iranlowo instalationu, jowo losi SuiteCRM',
    'LBL_DISABLED_HELP_LNK' => 'https://community.suitecrm.com',
    'LBL_DISABLED_HELP_2' => 'atileyin awon forumu',
    'LBL_DISABLED_TITLE_2' => 'A ti disabu Installationu SuiteCRM',
    'LBL_HELP' => 'Iranlowo',
    'LBL_INSTALL' => 'Install',
    ...
    'LBL_LICENSE_I_ACCEPT' => 'Mo Gba',
    'LBL_LICENSE_PRINTABLE' => ' Printable View ',
    'LBL_PRINT_SUMM' => 'Print Summary',
    'LBL_LICENSE_TITLE_2' => 'SuiteCRM License',

    'LBL_LOCALE_NAME_FIRST' => 'Dafidi',
    'LBL_LOCALE_NAME_LAST' => 'Livingstone',
    'LBL_LOCALE_NAME_SALUTATION' => 'Dokita.',

    'LBL_ML_ACTION' => 'Ise',
    'LBL_ML_DESCRIPTION' => 'Apejuwe',
    ...
    'LBL_PERFORM_CONFIG_PHP' => 'Siseda faili configurationu SuiteCRM',
    'LBL_PERFORM_CREATE_DB_1' => '<b>Creating the database</b> ',
    'LBL_PERFORM_CREATE_DB_2' => ' <b>on</b> ',
    'LBL_PERFORM_CREATE_DB_USER' => 'Siseda oruko onilo Databasi ati pasiwodu...',
    'LBL_PERFORM_CREATE_DEFAULT' => 'Siseda data SuiteCRM ti defaulti',
    ...
    'LBL_REG_CONF_3' => 'O se wipe o regista. Te botini Pari lati wole si SuiteCrm. O ma nilo lati wole sun igba akoko nipa lilo oruko onilo "alamojuto" ati pasiwodu ti o te ni igbese keji.',
    ...
    'LBL_SITECFG_CUSTOM_ID' => 'Pese Applicationu ID ti re',
    ...
    'LBL_SITECFG_CUSTOM_LOG' => 'Lo Igbasile iwe Ipamo ti Customu',
    ...
    'LBL_SITECFG_SESSION_PATH' => 'Ona si Sessionu Igbasile<br>(gbodo se kiko)',
    ...
    'LBL_SITECFG_TITLE' => 'Configurationu Saiti',
    ...
    'LBL_STEP' => 'Igbese',
    'LBL_TITLE_WELCOME' => 'Kaabo si SuiteCRM ',
...
$contact_user_link_guid',
    ...
    'LBL_DBCONF_TITLE_USER_INFO_LABEL' => 'Olumulo',
