...
$mod_strings = array(
    ...
    'ERR_CHECKSYS_CONFIG_NOT_WRITABLE' => 'El archivo de configuración existe pero no tiene permisos de escritura. Por favor, tome los pasos necesarios para que el archivo sea escribible.',
    'ERR_CHECKSYS_CONFIG_NOT_FOUND' => 'Tu archivo config.php no existe. Esto se creará al instalar.',
    'ERR_CHECKSYS_CONFIG_OVERRIDE_NOT_WRITABLE' => 'El archivo de configuración existe pero no tiene permisos de escritura. Por favor, tome los pasos necesarios para que el archivo sea escribible. ',
    'ERR_CHECKSYS_CUSTOM_NOT_WRITABLE' => 'El directorio personalizado existe pero no tiene permisos de escritura. Por favor, tome los pasos necesarios para que el archivo sea escribible.',
    'ERR_CHECKSYS_FILES_NOT_WRITABLE' => "Los archivos o directorios listados arriba no son escribibles o faltan y no se pueden crear. Por favor, tome los pasos necesarios para que los directorios sean escribibles.",
    'ERR_CHECKSYS_LOGS_NOT_WRITABLE' => 'El directorio de registros no tiene permisos de escritura',
    'ERR_CHECKSYS_CACHE_NOT_WRITABLE' => 'El directorio de caché no tiene permisos de escritura',
    'ERR_CHECKSYS_EXTENSIONS_NOT_WRITABLE' => 'El directorio de extensiones no tiene permisos de escritura',
    'ERR_CHECKSYS_SECRETS_NOT_WRITABLE' => 'El directorio config/secrets no tiene permisos de escritura',
    'ERR_CHECKSYS_ENV_NOT_WRITABLE' => 'El archivo .env o el directorio en el que se encuentra no tiene permisos de escritura.',
    ...
    'LBL_CANCEL' => 'Cancelar',
    'LBL_ACCEPT' => 'Aceptar',
    'LBL_CHECKSYS_LEGACY_CACHE' => 'Sub-Directorios de Caché Legado Escribible',
    'LBL_CHECKSYS_CACHE' => 'Subdirectorios de Caché Escribibles',
    'LBL_CHECKSYS_EXTENSIONS' => 'Directorio de extensiones escribibles',
    'LBL_CHECKSYS_SECRETS' => 'Directorio de configuración y secretos editables',
    'LBL_CHECKSYS_LOGS' => 'Directorio de registros escribibles',
    ...
    'LBL_CHECKSYS_ENV' => 'Escribible .env',
    ...
    'LBL_CHECKSYS_INTL_EXTENSIONS' => 'Intl existe en extensiones',
    'LBL_CHECKSYS_JSON_EXTENSIONS' => 'Json existe en extensiones',
    'LBL_CHECKSYS_GD_EXTENSIONS' => 'GD existe en extensiones',
    'LBL_CHECKSYS_OPENSSL_EXTENSIONS' => 'OpenSSL existe en extensiones',
    'LBL_CHECKSYS_ZIP_EXTENSIONS' => 'El Zip existe en las extensiones',
    'LBL_CHECKSYS_PDO_MYSQL_EXTENSIONS' => 'PDO MySQL existe en extensiones',
    'LBL_CHECKSYS_CURL_EXTENSIONS' => 'cURL existe en extensiones',
    'LBL_CHECKSYS_MBSTRING_EXTENSIONS' => 'MB Strings existen en las extensiones',
    'LBL_CHECKSYS_MYSQLI_EXTENSIONS' => 'MySQLi existe en extensiones',
    'LBL_CHECKSYS_SOAP_EXTENSIONS' => 'Soap existe en las extensiones',
    'LBL_CHECKSYS_XML_EXTENSIONS' => 'XML existe en extensiones',
    'LBL_CHECKSYS_IMAP_EXTENSIONS' => 'IMAP existe en extensiones (opcional)',
    'LBL_CHECKSYS_LDAP_EXTENSIONS' => 'LDAP existe en extensiones (opcional)',
    'LBL_PHP_CHECKS' => 'PHP Comprobacion Correcta',
    'LBL_SERVER_CHECKS' => 'SERVER Comprobacion Correcta',
    'LBL_PERMISSION_CHECKS' => 'Permisos Comprobacion Correcta',
    'LBL_CHECK_FAILED' => 'Comprobación Fallida: ',
    'ERR_CHECKSYS_INTL' => 'La extensión Intl no está instalada, póngase en contacto con el administrador del sistema',
    'ERR_CHECKSYS_JSON' => 'La extensión JSON no está habilitada, póngase en contacto con el administrador del sistema.',
    'ERR_CHECKSYS_GD' => 'La extensión GD no está habilitada, póngase en contacto con el administrador del sistema.',
    'ERR_CHECKSYS_OPENSSL' => 'La extensión OpenSSL no está habilitada, póngase en contacto con el administrador del sistema.',
    'ERR_CHECKSYS_PDO_MYSQL' => 'La extensión PDO MySQL no está habilitada, póngase en contacto con el administrador del sistema.',
    'ERR_CHECKSYS_MYSQLI' => 'La extensión MySQLi no está habilitada, póngase en contacto con el administrador del sistema.',
    'ERR_CHECKSYS_SOAP' => 'La extensión Soap no está habilitado, por favor contacte a su administrador del sistema.',
    ...
    'LBL_UNWRITABLE_SUB_DIR' => 'Hay algunos subdirectorios que no pueden escribirse. Por favor, tome los pasos necesarios para que los directorios sean escribibles ',
    'LBL_REFER_TO_LOGS' => 'Ha habido un problema en una de sus comprobaciones de preinstalación, por favor consulte install.log',
    'LBL_NOT_A_VALID_SUITECRM_PAGE' => 'No se puede encontrar el título de SuiteCRM. Esto no es una página válida de SuiteCRM.',
    'LBL_NOT_COOKIE_OR_TOKEN' => 'No se han encontrado cookies, token no válido. Por favor, consulte install.log para más información.',
    'LBL_CURL_JSON_ERROR' => 'El resultado de la llamada curl a la página graphql estaba vacío.',
    'LBL_UNABLE_TO_FIND_SYSTEM_CONFIGS' => 'No se puede recuperar la configuración del sistema en la página Graphql. Por favor, consulte install.log para más información.',
    'LBL_CURL_REQUEST_MAIN_PAGE' => 'Solicitud de curl en la página principal',
    'LBL_CURL_REQUEST_API_PAGE' => 'Solicitud de curl en Api',
    'LBL_ERROR_DETAILS' => 'Detalles del error',
    'LBL_ERROR' => 'Error:',
    'LBL_WARNING_DETAILS' => 'Detalles de advertencia',
    'LBL_WARNING' => 'Advertencia',
    'LBL_SYSTEM_CHECKS' => 'Comprobación del Sistema Correcta',
    'LBL_CRON_INSTRUCTIONS_1' => 'Para ejecutar los Programadores de SuiteCRM, edite el archivo crontab de los usuarios de su servidor web con este comando:',
    'LBL_CRON_INSTRUCTIONS_2' => 'y añadir la siguiente línea al archivo crontab:',
    'LBL_CRON_INSTRUCTIONS_3' => 'Usted debería hacer esto una vez que la instalación ha finalizado.',
    'LBL_CRON_CONFIGURATION' => 'CONFIGURACIÓN CRON',
    'LBL_SETUP_CRONTAB' => 'Para configurar Crontab',
    'LBL_ROUTE_ACCESS_CHECK' => 'VERIFICACIÓN RUTA DE ACCESO',
    'LBL_PHP_MEM_1' => 'Su límite de memoria PHP es ',
    'LBL_PHP_MEM_2' => '. Esto debe ser un mínimo de ',
    ...
    'LBL_DISABLED_DESCRIPTION_3' => 'Después de que este cambio haya sido realizado, por favor vuelva a visitar/volver a cargar esta página para continuar.',
    ...
    'LBL_PRE_INSTALL_REQ' => 'Requisitos de preinstalación',
