...
$mod_strings = array(
    ...
    'LBL_MEETINGS' => 'JUNTAS', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
    ...
    'LBL_EMAILS' => 'CORREOS', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
    ...
    'LBL_LIST_DATE' => 'Fecha',
    'LBL_LIST_CLOSE' => 'Fecha de cierre',
    'LBL_SUBJECT' => 'Asunto:',
    'LBL_STATUS' => 'Estado:',
    'LBL_LOCATION' => 'Lugar:',
