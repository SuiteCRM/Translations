...
$mod_strings = array(
    ...
    'LNK_NEW_MAIL_MERGE' => 'Hòa trộn Mail',
    ...
    'LBL_DOCUMENT_INFORMATION' => 'Thông tin Khách hàng', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
