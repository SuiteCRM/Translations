...
$mod_strings = array(
    'LBL_CONSKEY' => 'පාරිභෝගික කී',
    'LBL_CONSSECRET' => 'පාරිභෝගික රහස්',
    ...
    'LBL_DELETED' => ' මකා දමන',
    'LBL_NAME' => 'පාරිභෝගික කී නම',
    'LBL_CREATED_USER' => 'පරිශීලක විසින් නිර්මාණය කරන',
    'LBL_MODIFIED_USER' => 'පරිශීලක වන විට නවීකරණය කරන ලද',
    'LBL_LIST_NAME' => 'ප්රධාන නම',
    'LBL_LIST_FORM_TITLE' => 'OAuth යතුරු',
    'LBL_MODULE_NAME' => 'OAuth යතුරු',
    'LBL_MODULE_TITLE' => 'OAuth යතුරු',
    'LNK_NEW_RECORD' => 'OAuth කී සාදන්න',
    'LNK_LIST' => 'දැක්ම OAuth යතුරු',
    'LBL_TOKENS' => 'තිළිණ',
);
