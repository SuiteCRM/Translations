...
$mod_strings = array(
    ...
    'LBL_LIST_FORM_TITLE' => 'දැනුම මූලික ලැයිස්තුව',
    'LBL_MODULE_NAME' => 'දැනුම මූලික',
    'LBL_MODULE_TITLE' => 'දැනුම මූලික',
    'LBL_HOMEPAGE_TITLE' => 'මගේ දැනුම මූලික',
    'LNK_NEW_RECORD' => 'දැනුම මූලික සාදන්න',
    'LNK_LIST' => 'දැක්ම දැනුම මූලික',
    'LBL_SEARCH_FORM_TITLE' => 'සොයන්න දැනුම මූලික',
    'LBL_HISTORY_SUBPANEL_TITLE' => ' දැක්ම ඉතිහාසය',
    'LBL_ACTIVITIES_SUBPANEL_TITLE' => 'ක්‍රියාකාරකම්',
    'LBL_NEW_FORM_TITLE' => 'නව දැනුම මූලික',
    'LBL_STATUS' => 'තත්වය',
    'LBL_REVISION' => 'සංශෝධනය',
    'LBL_AUTHOR_USER_ID' => 'කතෘ (අදාළ පරිශීලක ID)',
    'LBL_AUTHOR' => 'කර්තෘ',
    'LBL_APPROVER_USER_ID' => 'Approver (අදාළ පරිශීලක ID)',
    'LBL_APPROVER' => 'Approver',
);

$mod_strings['LBL_AOK_KB_CATEGORIES_TITLE'] = 'ප්රවර්ග';
