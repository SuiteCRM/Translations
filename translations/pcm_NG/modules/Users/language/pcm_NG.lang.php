...
$mod_strings = array(
    'ERR_NO_2FACTOR_EMAIL_TMPL' => 'E no set two-factor email template, Abeg change settings for password management page. ',
    'ERR_NO_2FACTOR_EMAIL_TMPL_CODE' => 'Two-factor email template suppose contain $code at least.
',
    ...
    'LBL_DELETE_GROUP_CONFIRM' => 'U dey sure say u wan delete dis Group User? Press OK make e delete de User record.<br/>After u don press OK, dey go give u ability to reassign records wey don dey assign to de Group User to another user.',
    'LNK_IMPORT_USERS' => 'Import Users',
    'ERR_DELETE_RECORD' => 'E get specific record number before person fit comot the account.',
    'ERR_EMAIL_INCORRECT' => 'Put email address so that u go fit create and send de password.',
    'ERR_EMAIL_NO_OPTS' => 'E no fit find optimum settings for Inbound Email.',
    'ERR_ENTER_CONFIRMATION_PASSWORD' => 'Abeg put your password confirmation.',
    'ERR_ENTER_NEW_PASSWORD' => 'Abeg put your new password.',
    'ERR_ENTER_OLD_PASSWORD' => 'Abeg put your password wey u dey use now.',
    'ERR_IE_FAILURE1' => '[Press here make e return]',
    'ERR_IE_FAILURE2' => 'Problem bin dey wen e dey connect to Email Account. Abeg press your settings and try again.',
    ...
    'LBL_DATE_FORMAT' => 'How Date go show',
    'LBL_DEFAULT_SUBPANEL_TITLE' => 'Users dem',
    ...
    'LBL_EXPORT_DELIMITER' => 'Make you Export Delimiter',
    ...
    'LBL_CREATED_BY_NAME' => 'Person wey create am', //bug 48978
    'LBL_MODIFIED_BY_ID' => 'Modified By ID',
    'LBL_MODULE_NAME' => 'Users dem',
    'LBL_MODULE_TITLE' => 'Users: Home',
    'LBL_NAME' => 'Full Name',
    'LBL_SIGNATURE_NAME' => 'Wetin be your name',
...
// PROJECT RESOURCES STRINGS
    'LBL_RESOURCE_NAME' => 'Wetin be your name',
...
<img src=include/images/suitecrm_login.png style="margin-right: 5px;">
    ...
    'LBL_DATE_SENT' => 'Date wey dem send am:',
    ...
    'LBL_LIST_DATE_SENT' => 'Date wey you send am',
