...
$mod_strings = array(
    ...
    'LBL_EMAIL_RECIPIENTS' => '받는 사람 이메일:',
    'NTC_DELETE_CONFIRMATION' => '해당 레코드를 정말 삭제하시겠습니까?',
    'LBL_LIST_FORM_TITLE' => '예약된 보고서 목록',
    'LBL_MODULE_NAME' => '예약된 보고서',
    'LBL_MODULE_TITLE' => '예약된 보고서',
    'LBL_HOMEPAGE_TITLE' => '내 예약된 보고서',
    'LNK_NEW_RECORD' => '예약된 보고서 만들기',
    'LNK_LIST' => '예약된 보고서 보기',
    'LBL_SEARCH_FORM_TITLE' => '예약된 보고서 검색',
    'LBL_HISTORY_SUBPANEL_TITLE' => '이력 표시',
    'LBL_NEW_FORM_TITLE' => '새 예약된 보고서',
    'LBL_SCHEDULE' => '스케쥴',
    'LBL_AOR_REPORT_NAME' => '보고서',
    'LBL_SCHEDULED_REPORTS_INFORMATION' => '예약된 보고서',
    'LBL_LAST_RUN' => '마지막 실행',
    'LBL_STATUS' => '상태',
);
