...
$mod_strings = array(
    ...
    'LBL_EDIT_BUTTON' => '편집',
    'LBL_REMOVE' => '삭제',
    'LBL_LIST_FORM_TITLE' => '사례 업데이트 목록',
    'LBL_MODULE_NAME' => '사례 업데이트',
    'LBL_MODULE_TITLE' => '사례 업데이트',
    'LBL_HOMEPAGE_TITLE' => '내 사례 업데이트',
    'LNK_NEW_RECORD' => '사례 업데이트 생성',
    'LNK_LIST' => '사례 업데이트 보기',
    'LBL_SEARCH_FORM_TITLE' => '사례 업데이트 검색',
    'LBL_HISTORY_SUBPANEL_TITLE' => '이력 표시',
    'LBL_ACTIVITIES_SUBPANEL_TITLE' => '영업활동',
    'LBL_NEW_FORM_TITLE' => '신규 사례 업데이트',
    'LBL_CASE_NAME' => '사례',
    'LBL_CONTACT_NAME' => '연락처',
    'LBL_INTERNAL' => '내부 업데이트',
    'LBL_AOP_CASE_ATTACHMENTS' => '첨부 파일: ',
);
