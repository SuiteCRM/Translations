...
$mod_strings = array(
    ...
    'LBL_SYSOPTS_DB_TITLE' => '데이터베이스 타입',
    'LBL_SYSOPTS_ERRS_TITLE' => '계속 진행하기 전에 다음의 에러(들)을 수정해주십시오.',
    ...
    'ERR_DBCONF_VALIDATION' => '계속 진행하기 전에 다음의 에러(들)을 수정해주십시오.',
    ...
    'ERR_LOG_DIRECTORY_NOT_EXISTS' => '제공된 로그 디렉토리가 유효한 디렉토리가 아닙니다.',
    'ERR_LOG_DIRECTORY_NOT_WRITABLE' => '제공된 로그 디렉터리는 쓰기 가능한 디렉터리가 아닙니다.',
    ...
    'ERR_PERFORM_CONFIG_PHP_1' => '<span class=stop>config.php</span>파일을 쓸 수 없습니다.',
    ...
    'ERR_PERFORM_CONFIG_PHP_4' => '경고:  config.php 파일을  쓸 수 없습니다.  존재하는지 확인해보세요.',
    'ERR_PERFORM_HTACCESS_1' => '쓸 수 없습니다. ',
    'ERR_PERFORM_HTACCESS_2' => ' 파일.',
    'ERR_PERFORM_HTACCESS_3' => '브라우저를 통해 접근할 수 있는 로그파일을 보안하려면 라인 로그 디렉토리의 .htaccess file을 열어보세요.',
    ...
    'LBL_CHECKSYS_CACHE' => '쓸 수 있는 Cache Sub-Directories',
    ...
    'LBL_DISABLED_DESCRIPTION' => '설치 프로그램이 이미 실행되었습니다. 안전을 위해서 두번째의 설치는 실행되지 않았습니다. 재설치를 희망한다면, config.php 파일내의 \'installer_locked\' 변수 값을 \'false\'로 변경하십시오. :',
    'LBL_DISABLED_HELP_1' => '설치에 어려움을 겪으신다면, SuiteCRM 을 방문해 주시기 바랍니다.',
    ...
    'LBL_PERFORM_CREATE_DB_USER' => '데이터베이스 사용자 이름 및 암호 만들기',
    ...
    'LBL_PERFORM_OUTRO_5' => '대략 사용된 메모리: ',
    ...
    'LBL_SITECFG_CUSTOM_SESSION' => 'SuiteCRM의 사용자 지정 세션 디렉토리 사용',
...
이 옵션을 선택 하지 않을 경우는 사용자의 메일 계정을 사용하여 알림 및 경고를 보냅니다',
    ...
    'LBL_VALIDATION_ERRORS' => '유효성 검사 오류가 있어 작업을 수행할 수 없습니다.'
);
