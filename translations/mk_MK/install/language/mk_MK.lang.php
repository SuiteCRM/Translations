...
$mod_strings = array(
    ...
    'LBL_DBCONF_TITLE_PSWD_INFO_LABEL' => 'Лозинка',
    ...
    'LBL_LANG_BUTTON_COMMIT' => 'Инсталирај',
    'LBL_LANG_BUTTON_REMOVE' => 'Отстрани',
    'LBL_LANG_BUTTON_UNINSTALL' => 'Одинсталирај',
    ...
    'LBL_ML_ACTION' => 'Акција',
    'LBL_ML_DESCRIPTION' => 'Опис',
    'LBL_ML_INSTALLED' => 'Датум на инсталација',
    'LBL_ML_NAME' => 'Име',
    'LBL_ML_PUBLISHED' => 'Дата на објава',
    'LBL_ML_TYPE' => 'Тип',
    'LBL_ML_UNINSTALLABLE' => 'Може да се одинсталира',
    'LBL_ML_VERSION' => 'Верзија',
...
After you log in using the above password, you may be required to reset the password to one of your own choice.',
        'name' => 'Системски-генерирана Е-Мејл лозинка',
    ),
...
$contact_user_link_guid',
    ...
    'LBL_LOCALE_TITLE' => 'Локални системски опции',
    ...
    'LBL_NUMBER_GROUPING_SEP' => 'Сепаратор на 1000-ки:',
    'LBL_DECIMAL_SEP' => 'Децимален симбол:',
    'LBL_NAME_FORMAT' => 'Формат на Име:',
    ...
    'LBL_INSTALL_PROCESS' => 'Инсталирај...',
    ...
    'LBL_START' => '',
    'LBL_DB_CONN_ERR' => 'Грешка во базата',
