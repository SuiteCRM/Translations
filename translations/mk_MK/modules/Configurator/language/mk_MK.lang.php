...
$mod_strings = array(
    ...
    'DEFAULT_SYSTEM_SETTINGS' => 'Кориснички интерфејс',
    'DEFAULT_THEME' => 'Стандардна тема',
    ...
    'LBL_MODULE_TITLE' => 'Кориснички интерфејс',
    'LBL_NOTIFY_FROMADDRESS' => '"From" Address:',
    'LBL_NOTIFY_SUBJECT' => 'Е-Мејл Назив:',

    'LBL_PROXY_AUTH' => 'Автентикација?',
    'LBL_PROXY_HOST' => 'Proxy Host',
    'LBL_PROXY_ON_DESC' => 'Configure proxy server address and authentication settings',
    'LBL_PROXY_ON' => 'Use proxy server?',
    'LBL_PROXY_PASSWORD' => 'Лозинка',
    'LBL_PROXY_PORT' => 'Порта',
    'LBL_PROXY_TITLE' => 'Proxy Settings',
    'LBL_PROXY_USERNAME' => 'Име на корисник',
    'LBL_RESTORE_BUTTON_LABEL' => 'Врати',
    ...
    'LBL_LDAP_GROUP_MEMBERSHIP' => 'Членство на Групата:',
    'LBL_LDAP_GROUP_MEMBERSHIP_DESC' => 'Корисникот мора да биде член на одредена група',
    'LBL_LDAP_GROUP_USER_ATTR' => 'Атрибути на Корисникот:',
    ...
    'LBL_LDAP_GROUP_ATTR' => 'Атрибути на Групата:',
    ...
    'LBL_LDAP_GROUP_NAME' => 'Име на Група:',
...
// Wizard
    ...
    'LBL_LOADING' => 'Φόρτωση...' /*for 508 compliance fix*/,
    'LBL_DELETE' => 'Избриши' /*for 508 compliance fix*/,
    'LBL_WELCOME' => 'Добредојде' /*for 508 compliance fix*/,
