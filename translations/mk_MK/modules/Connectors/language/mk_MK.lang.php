...
$mod_strings = array(
    ...
    'LBL_ADMINISTRATION_MAIN' => 'Подесување на конектор',
    'LBL_AVAILABLE' => 'Достапно',
    'LBL_BACK' => '< Назад',
    'LBL_CONFIRM_CONTINUE_SAVE' => 'Некои задолжителни полиња се празни. Ќе продолжите да ги зачувате промените?',
    'LBL_CONNECTOR_FIELDS' => 'Полиња на конектор',
    'LBL_DATA' => 'Податоци',
    'LBL_DEFAULT' => 'Стандардно',
    'LBL_DISABLED' => 'Исклучено',
    ...
    'LBL_INFO_INLINE' => 'Инфо' /*for 508 compliance fix*/,
