...
$mod_strings = array(
    ...
    'LBL_LIST_FORM_TITLE' => 'Листа на Фактури',
    'LBL_MODULE_NAME' => 'Фактури',
    'LBL_MODULE_TITLE' => 'Фактури: Домашна страна',
    'LBL_HOMEPAGE_TITLE' => 'Мои Фактури',
    'LNK_NEW_RECORD' => 'Нова Фактура',
    'LNK_LIST' => 'Погледни Фактури',
    'LBL_SEARCH_FORM_TITLE' => 'Пребарај Фактури',
    ...
    'LBL_INVOICE_NUMBER' => 'Број на Фактура',
    'LBL_OPPORTUNITY' => 'Име на можност за продажба',
    'LBL_TEMPLATE_DDOWN_C' => 'Темплејти за Фактури',
    ...
    'LBL_QUOTE_DATE' => 'Датум на Понуда',
    'LBL_INVOICE_DATE' => 'Датум на Фактура',
    'LBL_DUE_DATE' => 'Доспева на',
    'LBL_STATUS' => 'Статус',
    ...
    'LBL_EMAIL_INVOICE' => 'Прати Фактура на Е-Мејл',
    'LBL_LIST_NUM' => 'Број',
    'LBL_PDF_NAME' => 'Фактура',
    'LBL_EMAIL_NAME' => 'Фактура за',
    'LBL_NO_TEMPLATE' => 'ГРЕШКА\nНе е пронајден темплејт за фактури. Ако немате креирано темплејт за фактури, одберете PDF Темплејти и креирајте нов',
