...
$mod_strings = array(
    'LBL_MODULE_NAME' => 'Продажба',
    'LBL_MODULE_TITLE' => 'Продажба: Домашна страна',
    'LBL_SEARCH_FORM_TITLE' => 'Пребарувај во продажба',
    'LBL_LIST_FORM_TITLE' => 'Листа на продажба',
    'LBL_NAME' => 'Име на продажба',
    'LBL_LIST_SALE_NAME' => 'Име',
    'LBL_LIST_ACCOUNT_NAME' => 'Име на сметка',
    'LBL_LIST_AMOUNT' => 'Износ',
    'LBL_LIST_DATE_CLOSED' => 'Затвори',
    'LBL_LIST_SALE_STAGE' => 'Фаза на продажба',
    ...
    'LBL_DEFAULT_SUBPANEL_TITLE' => 'Продажба',
