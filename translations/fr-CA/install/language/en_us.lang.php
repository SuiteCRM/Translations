...
$mod_strings = array(
    ...
    'ERR_CHECKSYS_CONFIG_NOT_WRITABLE' => 'Le fichier de configuration existe mais n\'est pas accessible en écriture. Veuillez prendre les mesures nécessaires pour rendre le fichier accessible en écriture.',
    'ERR_CHECKSYS_CONFIG_NOT_FOUND' => 'Votre fichier config.php n\'existe pas. Il sera créé à l\'installation.',
    'ERR_CHECKSYS_CONFIG_OVERRIDE_NOT_WRITABLE' => 'Le fichier de remplacement de configuration config_override.php existe mais n\'est pas accessible en écriture. Veuillez prendre les mesures nécessaires pour rendre le fichier accessible en écriture. ',
    'ERR_CHECKSYS_CUSTOM_NOT_WRITABLE' => 'Le répertoire personnalisé custom existe mais n\'est pas accessible en écriture. Veuillez prendre les mesures nécessaires pour le rendre accessible en écriture.',
    'ERR_CHECKSYS_FILES_NOT_WRITABLE' => "Les fichiers ou répertoires listés ci-dessus ne sont pas accessibles en écriture ou sont manquants et ne peuvent pas être créés. Veuillez prendre les mesures nécessaires pour rendre les répertoires accessibles en écriture.",
    'ERR_CHECKSYS_LOGS_NOT_WRITABLE' => 'Le répertoire des Logs n\'est actuellement pas accessible en écriture',
    'ERR_CHECKSYS_CACHE_NOT_WRITABLE' => 'Le répertoire de cache n\'est actuellement pas accessible en écriture',
    'ERR_CHECKSYS_EXTENSIONS_NOT_WRITABLE' => 'Le répertoire des extensions n\'est actuellement pas accessible en écriture',
    'ERR_CHECKSYS_SECRETS_NOT_WRITABLE' => 'Le répertoire config/secrets n\'est actuellement pas accessible en écriture',
    'ERR_CHECKSYS_ENV_NOT_WRITABLE' => 'Le fichier .env ou le répertoire dans lequel il se trouve n\'est pas accessible en écriture.',
    ...
    'ERR_PERFORM_NO_TCPIP' => '<b>Nu am putut detecta o conexiune de internet.</b> Cand nu aveti o conexiune va rugam vizitati <a href="https://www.suitecrm.com/">https://www.suitecrm.com/</a> pentru a inregistra SuiteCRM. Lasandu-ne sa stim cate putin din cum planuieste compania dumneavoastra sa foloseasca SuiteCRM putem fi siguri ca mereu livram aplicatia corespunzatoare nevoilor dumneavoastra.',
    ...
    'LBL_CHECKSYS_LEGACY_CACHE' => 'Sous-répertoires de l\'ancien cache accessibles en écriture',
    'LBL_CHECKSYS_CACHE' => 'Dossier Cache accessible en écriture',
    'LBL_CHECKSYS_EXTENSIONS' => 'Répertoire des extensions accessible en écriture',
    'LBL_CHECKSYS_SECRETS' => 'Le répertoire de configuration et des secrets est accessible en écriture',
    'LBL_CHECKSYS_LOGS' => 'Le répertoire des logs est accessible en écriture',
...
',
    ...
    'LBL_CHECKSYS_ENV' => 'Le fichier .env est accessible en écriture',
    ...
    'LBL_CHECKSYS_INTL_EXTENSIONS' => 'Intl existe dans les extensions',
    'LBL_CHECKSYS_JSON_EXTENSIONS' => 'Json existe dans les extensions',
    'LBL_CHECKSYS_GD_EXTENSIONS' => 'GD existe dans les extensions',
    'LBL_CHECKSYS_OPENSSL_EXTENSIONS' => 'OpenSSL existe dans les extensions',
    'LBL_CHECKSYS_ZIP_EXTENSIONS' => 'Zip existe dans les extensions',
    'LBL_CHECKSYS_PDO_MYSQL_EXTENSIONS' => 'PDO MySQL existe dans les extensions',
    'LBL_CHECKSYS_CURL_EXTENSIONS' => 'cURL existe dans les extensions',
    'LBL_CHECKSYS_MBSTRING_EXTENSIONS' => 'MB Strings existe dans les extensions',
    'LBL_CHECKSYS_MYSQLI_EXTENSIONS' => 'MySQLi existe dans les extensions',
    'LBL_CHECKSYS_SOAP_EXTENSIONS' => 'Soap existe dans les extensions',
    'LBL_CHECKSYS_XML_EXTENSIONS' => 'XML existe dans les extensions',
    'LBL_CHECKSYS_IMAP_EXTENSIONS' => 'IMAP existe dans les extensions (facultatif)',
    'LBL_CHECKSYS_LDAP_EXTENSIONS' => 'LDAP existe dans les extensions (facultatif)',
    'LBL_PHP_CHECKS' => 'VÉRIFICATIONS PHP',
    'LBL_SERVER_CHECKS' => 'VÉRIFICATIONS DU SERVEUR',
    'LBL_PERMISSION_CHECKS' => 'VÉRIFICATIONS DES PERMISSIONS',
    'LBL_CHECK_FAILED' => 'Échec de la vérification : ',
    'ERR_CHECKSYS_INTL' => 'L\'extension Intl n\'est pas installée, veuillez contacter votre administrateur système',
    'ERR_CHECKSYS_JSON' => 'L\'extension JSON n\'est pas activée, veuillez contacter votre administrateur système.',
    'ERR_CHECKSYS_GD' => 'L\'extension GD n\'est pas activée, veuillez contacter votre administrateur système.',
    'ERR_CHECKSYS_OPENSSL' => 'L\'extension OpenSSL n\'est pas activée, veuillez contacter votre administrateur système.',
    'ERR_CHECKSYS_PDO_MYSQL' => 'L\'extension PDO MySQL n\'est pas activée, veuillez contacter votre administrateur système.',
    'ERR_CHECKSYS_MYSQLI' => 'L\'extension MySQLi n\'est pas activée, veuillez contacter votre administrateur système.',
    'ERR_CHECKSYS_SOAP' => 'L\'extension Soap n\'est pas activée, veuillez contacter votre administrateur système.',
    ...
    'LBL_UNWRITABLE_SUB_DIR' => 'Il y a des sous-répertoires qui ne sont pas accessibles en écriture. Veuillez prendre les mesures nécessaires pour rendre les répertoires accessibles en écriture ',
    'LBL_REFER_TO_LOGS' => 'Il y a eu un problème lors de l\'une des vérifications de pré-installation, veuillez consulter le fichier install.log',
    'LBL_NOT_A_VALID_SUITECRM_PAGE' => 'Le titre SuiteCRM est introuvable. Ce n\'est pas une page SuiteCRM valide.',
    'LBL_NOT_COOKIE_OR_TOKEN' => 'Impossible de trouver des cookies, aucun jeton valide trouvé. Veuillez consulter le fichier install.log pour plus d\'informations.',
    'LBL_CURL_JSON_ERROR' => 'Le résultat de l\'appel curl à la page graphql est vide.',
    'LBL_UNABLE_TO_FIND_SYSTEM_CONFIGS' => 'Impossible de récupérer les configurations système depuis la page Graphql. Veuillez consulter le fichier install.log pour plus d\'informations.',
    'LBL_CURL_REQUEST_MAIN_PAGE' => 'Requête curl sur la page principale',
    'LBL_CURL_REQUEST_API_PAGE' => 'Requête curl sur l\'API',
    'LBL_ERROR_DETAILS' => 'Détails de l\'erreur',
    'LBL_ERROR' => 'Erreur',
    'LBL_WARNING_DETAILS' => 'Détails de l\'avertissement',
    'LBL_WARNING' => 'Attention',
    'LBL_SYSTEM_CHECKS' => 'VÉRIFICATIONS SYSTÈME',
    'LBL_CRON_INSTRUCTIONS_1' => 'Afin d\'exécuter les planificateurs SuiteCRM, modifiez le fichier crontab des utilisateurs de votre serveur web avec cette commande :',
    'LBL_CRON_INSTRUCTIONS_2' => 'et ajoutez la ligne suivante au fichier crontab :',
    'LBL_CRON_INSTRUCTIONS_3' => 'Vous devriez le faire seulement après la fin de l\'installation.',
    'LBL_CRON_CONFIGURATION' => 'CRON CONFIGURATION',
    'LBL_SETUP_CRONTAB' => 'Pour configurer la Crontab',
    'LBL_ROUTE_ACCESS_CHECK' => 'VÉRIFICATION DE LA ROUTE D\'ACCÈS',
    'LBL_PHP_MEM_1' => 'Votre limite de mémoire PHP : ',
    'LBL_PHP_MEM_2' => '. - Cela doit être un minimum de ',
    'LBL_PHP_MEM_3' => 'M pour continuer.',
    'LBL_CLOSE' => 'Fermé',
    'LBL_THREE' => '3',
    ...
    'LBL_DISABLED_DESCRIPTION_3' => 'Une fois ce changement effectué, veuillez revisiter / recharger cette page pour continuer.',
    ...
    'LBL_PRE_INSTALL_REQ' => 'Pré-requis avant l\'installation',
