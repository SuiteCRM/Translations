...
$mod_strings = array(
    ...
    'LBL_SYSOPTS_ERRS_TITLE' => 'Pakiusap ayusin ang mga sumusunod na mga mali bako magpatuloy:',
    ...
    'ERR_CHECKSYS_CURL' => 'Hindi natagpuan: Ang SuiteCRM Scheduler ay tatakbo sa limitadong pag-andar.',
    ...
    'ERR_CHECKSYS_MEM_LIMIT_2' => 'M o mas-malaki sa iyong php.ini na file)',
    ...
    'ERR_DBCONF_VALIDATION' => 'Pakiusap ayusin ang mga sumusunod na mga mali bako magpatuloy:',
    ...
    'ERR_LOG_DIRECTORY_NOT_EXISTS' => 'Direktoryo ng log na ibinigay ay hindi isang balidong direktoryo.',
    'ERR_LOG_DIRECTORY_NOT_WRITABLE' => 'Direktoryo ng log na ibinigay ay hindi balidong direktoryo.',
    ...
    'ERR_PERFORM_CONFIG_PHP_1' => 'Hindi maisulat ang mga file <span class=stop>config.php</span>.',
    'ERR_PERFORM_CONFIG_PHP_2' => 'Ikaw ay maaaring mag papatuloy sa pag-install ng manu-manong paglikha ng file ng config.php at idikit ang mga impormasyon ng kumpigurasyon sa ibaba sa config.php. Gayunpaman, ikaw ay<strong> maaring</strong> lumikha ng config.php file bago ka magpatuloy sa susunod na hakbang.',
    'ERR_PERFORM_CONFIG_PHP_3' => 'Natatandaan mo na lumikha ng file ng config.ph?',
    'ERR_PERFORM_CONFIG_PHP_4' => 'Babala: Maaaring hindi isulat sa config.php file. Siguraduhin na ito ay umiiral.',
    'ERR_PERFORM_HTACCESS_1' => 'Hindi pweding sumulat sa mga ',
    'ERR_PERFORM_HTACCESS_2' => ' file.',
    'ERR_PERFORM_HTACCESS_3' => 'Kung nais mong maging ligtas ang iyong log file mula sa pagiging pagkaka-access gamit ang browser, lumikha ng mga file ng .htaccess sa iyong direktoryo ng log kasama ang mga linya:',
    ...
    'ERR_SESSION_DIRECTORY' => 'Sesyon ng direktoryo na ibinigay ay hindi balidong direktoryo.',
    ...
    'ERR_SITE_GUID' => 'Aplikasyon sa ID ay kinakailangan kung nais mong tukuyin ang iyong sarili.',
    ...
    'LBL_CRON_INSTRUCTIONS_3' => 'Dapat mong gawin ito lamang pagkatapos ng pag-install ay natapos na.',
    'LBL_CRON_CONFIGURATION' => 'CRON CONFIGURATION',
    'LBL_SETUP_CRONTAB' => 'Upang mag-setup ng Crontab',
    ...
    'LBL_DBCONF_TITLE' => 'Pagsasaayos ng database',
    ...
    'LBL_DISABLED_DESCRIPTION' => 'Ang mga installer ay isang beses gumana. Bilang isang pamantayan ng kaligtasan, ito ay naging hindi gumana mula sa pangalawang pagkakataon. Kung ito ay ganap na sigurado gusto mo bang ipatakbo itong muli ang mga ito, pakiusap pumunta sa inyong mga file ng config.php at mahanap (o magdagdag) isang variable ay tinatawag na \'installer_locked\' at itakda ito sa \'false\'. Ang linya dapat kagaya nito:',
    'LBL_DISABLED_HELP_1' => 'Para sa tulong ng pag-install, Paki-bisitahin ang SuiteCRM',
    'LBL_DISABLED_HELP_LNK' => 'https://community.suitecrm.com',
    'LBL_DISABLED_HELP_2' => 'ang suporta sa mga porum',
    ...
    'LBL_NEXT' => 'Susunod',
    'LBL_NO' => 'Hindi',
    'LBL_PERFORM_ADMIN_PASSWORD' => 'Setting ng site admin password',
    'LBL_PERFORM_CONFIG_PHP' => 'Paglikha ng SuiteCRM kompigurasyon na dokumento',
    'LBL_PERFORM_CREATE_DB_1' => '<b>Paglikha ng mga database</b> ',
    'LBL_PERFORM_CREATE_DB_2' => ' <b>sa</b> ',
    'LBL_PERFORM_CREATE_DB_USER' => 'Lumikha ng database username at password...',
    'LBL_PERFORM_CREATE_DEFAULT' => 'Lumikha ng default sa SuiteCRM data',
    'LBL_PERFORM_DEFAULT_SCHEDULER' => 'Paglikha ng default Scheduler sa trabaho',
    'LBL_PERFORM_DEFAULT_USERS' => 'Paglikha ng default users',
    ...
    'LBL_PERFORM_OUTRO_4' => ' segundo.',
    'LBL_PERFORM_OUTRO_5' => 'Humigit-kumulang ng memorya na ginagamit: ',
    'LBL_PERFORM_OUTRO_6' => ' mga bytes.',
    'LBL_PERFORM_SUCCESS' => 'Tagupay!',
    ...
    'LBL_REG_CONF_3' => 'Salamat sa pagrerehistro. i-click and Finish button upang mag login sa SuiteCRM. Ikaw ay kinakailangan na mag login para sa unang pagkakataon gamit ang username "admin" at ang password na ipinasok mo sa step 2.',
    ...
    'LBL_SITECFG_APP_ID' => 'Mga aplikasyon',
    ...
    'LBL_SITECFG_CUSTOM_LOG' => 'Gumamit ng isang pasadyang log diktatoryo',
    ...
    'LBL_STEP' => 'Hakbang',
    'LBL_TITLE_WELCOME' => 'Maligayang Pagdating sa SuiteCRM ',
    'LBL_WELCOME' => 'Maligayang pagdating sa SuiteCRM',
