...
$mod_strings = [
    ...
    // Email opt-in labels
    'LBL_OPT_IN' => 'Sa Opt',
    'LBL_OPT_IN_PENDING_EMAIL_NOT_SENT' => 'Kumpirmahin ang opt in Na Nakabinbin. Kumpirmahin ang pag-opt in hindi ipinadala',
    'LBL_OPT_IN_PENDING_EMAIL_SENT' => 'Ang opt in Kumpirmahin ang Nakabinbin, Kumpirmahin ang opt in na ipinadala',
    'LBL_OPT_IN_CONFIRMED' => 'Ang sumang-ayon sa',
    ...
    'LBL_SYNC_STATUS_IN_PROGRESS' => 'Isinasagawa',
    'LBL_SYNC_STATUS_SUCCESS' => 'Tagumpay',
    'LBL_SYNC_STATUS_WARNING' => 'Babala',
    'LBL_SYNC_STATUS_ERROR' => 'Mali',
