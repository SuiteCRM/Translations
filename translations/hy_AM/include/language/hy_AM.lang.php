...
//e.g. auf Deutsch 'Contacts'=>'Contakten',
    ...
    'moduleList' => array(
        ...
        'Queues' => 'Հերթեր',
        'EmailMarketing' => 'Էլ․փոստով տարածում ',
...
//prospect list type dom
    ...
    'campainglog_activity_type_dom' => array(
        ...
        'viewed' => 'Դիտված հաղորդագրություն',
        'removed' => 'Չգրել',
...
$app_strings = array(
    ...
    'LBL_EMAIL_FOLDERS' => SugarThemeRegistry::current()->getImage('icon_email_folder', 'align=absmiddle border=0', null, null, '.gif', '') . 'Պանակներ',
...
::;::',
    ...
    'ERR_DELETE_RECORD' => 'Կոնտակտը հեռացնելու համար դուք պետք է նշեք գրառման համարը:',
    ...
    'LBL_QUICK_HISTORY' => 'Ժամանակացույց',
    ...
    'LBL_CURRENT_USER_FILTER' => 'Իմ գործերը',
    ...
    'LBL_LOG_ENTRIES_VIEWED_TITLE' => 'Դիտված հաղորդագրություն',
    'LBL_LOG_ENTRIES_REMOVED_TITLE' => 'Չգրել',
    ...
    'LBL_RECORD_DOES_NOT_EXIST' => 'Գրարման առբերման սխալ։ Այս գրառումը կամ ջնջվել է, կամ էլ դուք լիազորված չէք դիտելու այն։',
    'LBL_PROFILE' => 'Պրոֆիլ',
    ...
    'LBL_ADDING_DASHLET' => 'Ավելացնել SuiteCRM-ի դաշլետը․․․',
    'LBL_ADDED_DASHLET' => 'SuiteCRM-ի դաշլետը ավելացված է',
...
5. Սկսել ներմուծման գործընթացը մոդուլի ցանկից, և ընտրել պահպանած այս պահին ֆայլը պարզապես որպես տվյալների աղբյուր բեռնելու համար
   ',
    ...
    'PIPELINE_BY_SALES_STAGE' => 'Իրացման գործընթացի փուլերը',
...
$app_strings['LBL_INVALID_EMAIL'] = 'Սխալ';
$app_strings['LBL_PRIMARY'] = 'Հիմնական';
$app_strings['LBL_EMAIL_ADDRESS'] = 'էլ-փոստի հասցե';
...
$app_strings['LBL_CHARTS'] = 'Գրաֆիկներ';
$app_strings['LBL_CHART_NOT_FOUND'] = 'Chart not found';
$app_strings['LBL_NO_DATA'] = 'Տվյալները բացակայում են';
$app_strings['LBL_ERROR_FETCHING_METADATA'] = 'Error occurred while fetching metadata';
$app_strings['LBL_TOTAL'] = 'Ընդամենը';
$app_strings['LBL_ACTIONS'] = 'Գործողություններ';
...
$app_strings['LBL_NONE_OUTSTANDING'] = 'Ոչ ոք';
...
$app_strings['LBL_DEFAULT_TOTAL'] = 'Ընդամենը';
$app_strings['AOS_Contracts'] = 'Պայմանագրեր';
$app_strings['AOS_Quotes'] = 'Առաջարկներ';
$app_strings['AOS_Invoices'] = 'Հաշիվ-ապրանքագիր';
$app_strings['LBL_PHOTO'] = 'Լուսանկար';
$app_strings['LBL_CASE_UPDATES'] = 'Գործի նորություներ';
...
$app_strings['LBL_CREATE'] = 'Ստեղծել';
...
$app_strings['LBL_OPERATOR'] = 'Օպերատոր';
$app_strings['LBL_START'] = 'Մեկնարկ';
$app_strings['LBL_END'] = 'Ավարտել';
$app_strings['LBL_LINE_ITEMS_FIELD_CONFIG'] = 'Bad config';


$app_strings['LBL_ACTION_SUCCESS'] = 'Action successful';

$app_strings['LBL_YES'] = 'Այո';
$app_strings['LBL_NO'] = 'Ոչ';

$app_list_strings['sort_order'] = [];
$app_list_strings['sort_order']['asc'] = 'Բարձրացող';
$app_list_strings['sort_order']['desc'] = 'Վայրընթաց';

// Labels used by subpanel unlink relationship process
$app_strings['LBL_LINK'] = 'Կապ';
$app_strings['LBL_LINK_UNLINK'] = 'Link / Unlink';
$app_strings['LBL_SAVE'] = 'Պահպանել';
...
$app_strings['LBL_RELATIONSHIPS'] = 'Հարաբերություններ';
$app_strings['LBL_SHOW_CC'] = 'Show Cc';
$app_strings['LBL_SHOW_BCC'] = 'Show Bcc';
$app_strings['LBL_CC'] = 'Կրկնօրինակ';
$app_strings['LBL_BCC'] = 'Չերևացող կրկնօրինակ';
$app_strings['LNK_NEW_EMAIL'] = 'Նոր էլ-փոստ';
...
$app_strings['LBL_RELATED_TO'] = 'Առնչվում է';
...
$app_strings['LBL_MEDIUM'] = 'Միջին';
$app_strings['LBL_NORMAL'] = 'Սովորական';
$app_strings['LBL_LARGE'] = 'Large';
$app_strings['LBL_HUGE'] = 'Huge';
$app_strings['LBL_DEFAULT'] = 'Լռելյայն ';
$app_strings['LBL_APPLY'] = 'Կիրառել';
...
$app_strings['LBL_QUOTE'] = 'Առաջարկ';
$app_strings['LBL_UNQUOTE'] = 'Unquote';
$app_strings['LBL_ALIGN_LEFT'] = 'Ձախ';
$app_strings['LBL_ALIGN_CENTER'] = 'Center';
$app_strings['LBL_ALIGN_RIGHT'] = 'Աջ';
...
// Day and Time labels
$app_strings['LBL_SUN'] = 'Կիրակի';
$app_strings['LBL_MON'] = 'Երկուշաբթի';
$app_strings['LBL_TUE'] = 'Երեքշաբթի';
$app_strings['LBL_WED'] = 'Չորեքշաբթի';
$app_strings['LBL_THU'] = 'Հինգշաբթի';
$app_strings['LBL_FRI'] = 'Ուրբաթ';
$app_strings['LBL_SAT'] = 'Շաբաթ';
$app_strings['LBL_ALL'] = 'Ամեն օր';
$app_strings['LBL_EVERY'] = 'Յուրաքանչյուր';
$app_strings['LBL_ON_THE'] = 'Վրա';
$app_strings['LBL_RANGE'] = 'դեպի';
$app_strings['LBL_FROM'] = 'Ումից';
$app_strings['LBL_AND'] = 'և';
$app_strings['LBL_MINS'] = 'ր';
$app_strings['LBL_MINUTES'] = ' րոպե ';
$app_strings['LBL_HOUR'] = 'ժամեր';
$app_strings['LBL_HOUR_SING'] = 'ժամ';
$app_strings['LBL_OFTEN'] = 'Այնքան հաճախ ինչքան հնարավոր է:';
$app_strings['LBL_MIN_MARK'] = ' րոպե անց';
$app_strings['LBL_INBOUND_EMAIL'] = 'Մտից էլ․նամակ';
...
$app_strings['LBL_CAMPAIGN_SETTINGS'] = 'Կարգավորումներ';
...
$app_strings['LBL_INACTIVE'] = 'Ակտիվ չէ';
...
$app_strings['LBL_UPLOAD'] = 'Վերբեռնել';
