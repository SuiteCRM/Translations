...
$mod_strings = array(
    ...
    'LBL_HIDEOPTIONS' => 'Թաքցնել ընտրանքները' /*for 508 compliance fix*/,
    ...
    'help' => array(
        ...
        'module' => array(
            ...
            'viewlayoutsbtn' => 'Սեղմեք <b>Դիտել մակետները</b> մոդուլի մակետները դիտելու համար, ինչպես նաև հարմարեցնել դաշտի կարգավորումը մակետների ներսում։',
            ...
            'savebtn' => 'Սեղմեք <b>Պահպանել</b> կոճակը, տվյալ մոդուլի հետ առնչվող բոլոր մուտքագրված փոփոխությունները պահպանելու համար։',
            'type_basic' => '<b>Հիմնական</b> ձևանմուշը ապահովում է հիմնական դաշտերը, ինչպես օրինակ՝ Անունը, Կատարող, Թիմ, Ստեղծման ամսաթիվ և Նկարագրություն դաշտերը։',
        ...
        ,
            ...
            'historyDefault' => 'Սեղմեք կոճակը<b>Վերականգնել լռելյան</b>վերադարձնել նրա նախնական տեսքին։',
            'Hidden' => '<b>Hidden</b> fields do not appear in the subpanel.',
            'Default' => '<b>Լռելյայն</b> դաշտերը ցուցադրվում են սուբպանելում։',
        ...
        'layoutEditor' => array(
            'defaultdetailview' => '<b>Մակետի</b> տարածքը պարունակում է դաշտեր, որոնք ներկայումս ցուցադրվում են<b>Մանրամասն դիտել</b>շրջանակներում։<br/><br/><b>Գործիքների արկղը</b> պարունակում է <b>Թափոնարկղ</b>, դաշտեր և մակետի էլեմենտներ, որոնք կարող են ավելացվել մակետին։<br><br>Մակետի փոփոխությունները կատարեք, տեղափոխելով էլեմենտները և դաշտերը, ինչպես <b>Գործիքների արկղի</b> և <b>Մակետի</b> միջև, այլ նաև հենց մակետի շրջանակներում։<br><br>Դաշտը մակետից հեռացնելու համար տեղափոխեք այն <b>Թափոնարկղ</b>։ Հեռացված դաշտը հասանելի կլինի "Գործիքների արկղի" շրջանակներում, եթե այն նորից ավելացնել մակետի մեջ:',
            'defaultquickcreate' => '<b>Մակետի</b> տարածքը պարունակում է դաշտեր, որոնք ներկայումս ցուցադրվում են<b>Արագ մուտք</b>ձևադաշտով։<br><br>Արագ մուտքի ձևը հայտնվում է մոդուլի ենթավահանակների մեջ, երբ դուք սեղմում եք "Ստեղծել" կոճակը:.<br/><br/><b>Գործիքների արկղը</b> պարունակում է <b>Թափոնարկղ</b>, դաշտեր և մակետի էլեմենտներ, որոնք կարող են ավելացվել մակետին։<br><br>Մակետի փոփոխությունները կատարեք, տեղափոխելով էլեմենտները և դաշտերը, ինչպես <b>Գործիքների արկղի</b> և <b>Մակետի</b> միջև, այլ նաև հենց մակետի շրջանակներում։<br><br>Դաշտը մակետից հեռացնելու համար տեղափոխեք այն <b>Թափոնարկղ</b>։ Հեռացված դաշտը հասանելի կլինի "Գործիքների արկղի" շրջանակներում, եթե այն նորից ավելացնել մակետի մեջ:',
            //this default will be used for edit view
            'default' => '<b>Մակետի</b> տարածքը պարունակում է դաշտեր, որոնք ներկայումս ցուցադրվում են <b>Խմբագրման դիտում</b>ձևում.<br/><br/><b>Գործիքների արկղը</b> պարունակում է <b>Թափոնարկղ</b>, դաշտեր և մակետի էլեմենտներ, որոնք կարող են ավելացվել մակետին։<br><br>Մակետի փոփոխությունները կատարեք, տեղափոխելով էլեմենտները և դաշտերը, ինչպես <b>Գործիքների արկղի</b> և <b>Մակետի</b> միջև, այլ նաև հենց մակետի շրջանակներում։<br><br>Դաշտը մակետից հեռացնելու համար տեղափոխեք այն <b>Թափոնարկղ</b>։ Հեռացված դաշտը հասանելի կլինի "Գործիքների արկղի" շրջանակներում, եթե այն նորից ավելացնել մակետի մեջ:',
            'saveBtn' => 'Վերջին պահպանածից հետո արված փոփոխությունները պահպանելու համար սեղմեք <b>Պահպանել</b> կոճակը։<br><br>Այդ փոփոխությունները չեն ցուցադրվի մոդուլում այնքան ժամանակ, մինչև դուք չհրատարակեք պահպանված փոփոխությունները:',
            'historyBtn' => 'Click <b>View History</b> to view and restore a previously saved layout from the history.<br><br><b>Restore</b> within <b>View History</b> restores the field placement within previously saved layouts. To change field labels, click the Edit icon next to each field.',
            'historyDefault' => 'Click <b>Restore Default</b> to restore a view to its original layout.<br><br><b>Restore Default</b> only restores the field placement within the original layout. To change field labels, click the Edit icon next to each field.',
            'publishBtn' => 'Սեղմեք <b>Պահպանել և տեղադրել</b> վերջին պահպանածից հետո արված փոփոխությունները պահպանելու համար, և տեղադրել<br> մակետի փոփոխությունները։<br><br>Տեղադրելուց հետո փոփոխությունները անմիջապես կցուցադրվեն մոդուլի մեջ։',
            ...
            'delete' => 'Տեղափոխել և թողնել ցանկացած էլեմենտ այստեղ, որպեսզի վերականգնել այն մակետից։',
        ...
        'studioWizard' => array(
            'mainHelp' => 'Բարի գալուստ <b>Նախագծողի գործիքներ</b> դաշտ։ <br/><br/> Օգտագործեք այստեղ գտնվող գործիքները ստեղծելու և կառավարելու ստանդարտ և մասնավոր մոդուլների և դաշտերի համար։',
            ...
            'layoutsBtn' => 'Խմբագրել այլ <b>Մակետներ</b>։ Մակետները ունեն տարբեր մոդուլների դաշտեր։<br><br>Դուք կարող եք որոշել, թե որ դաշտերն են, և ինչպես են դրանք կարգավորում յուրաքանչյուր մակետում։',
            ...
            'layoutsHelp' => 'Ընտրել <b>Մակետ</b> խմբագրելու համար։',
            ...
            'addLayoutHelp' => "Օգտագործողների խմբերի մակետ ստեղծելու համար ընտրեք համապատասխան Խումբ և պատճենահանման համար մակետ։",
            ...
            'Layouts' => 'Հարմարեցնել <b>Մակետները</b> SuiteCRM պորտալի մոդուլներին։',
		...
		<b>Delete:</b> Remove this module from the convert layout.<br/><br/>',
            ...
            'editDropDownBtn' => 'Խմբագրել գլոբալ ներքև բացվող մենյու',
            'addDropDownBtn' => 'Ավելացնել նոր գլոբալ ներքև բացվող մենյու',
        ),
        'fieldsHelp' => array(
    ...
    'assistantHelp' => array(
        ...
        'main' => array(
            'welcome' => 'Օգտագործեք <b>Նախագծողի գործիքներ</b> ստեղծելու և կառավարելու ստանդարտ և օգտագործվող մոդուլների և դաշտերի համար։ <br/><br/> Ծրագրի մոդուլները կառավարելու համար սեղմեք <b>Ստուդիա</b>կոճակը։ <br/><br/> օգտագործվող մոդուլները ստեղծելու համար սեղմեք <b>Մոդուլ կառուցող</b>կոճակը։',
        ...
        'layoutEditor' => array(
            ...
            'publishBtn' => 'Սեղմեք այս կոճակին մակետը տեղադրելու համար։ Դա նշանակում է, որ այս մակետը անմիջապես հասանելի կլինի այս մոդուլի այլ օգտագործողների համար։',
        ...
        'dropdownEditor' => array(
            'default' => 'There are two columns displayed to the left. The right-hand column, labeled Current Layout or Layout Preview, is where you change the module layout. The left-hand column, entitled Toolbox, contains useful elements and tools for use when editing the layout. <br/><br/>If the layout area is titled Current Layout then you are working on a copy of the layout currently used by the module for display.<br/><br/>If it is titled Layout Preview then you are working on a copy created earlier by a click on the Save button, that might have already been changed from the version seen by users of this module.',
            'dropdownaddbtn' => 'Սեղմելով այս կոճակը կավելացնա նոր տող ներքև բացվող մենյուի մեջ։',
...
//HOME
    'LBL_HOME_EDIT_DROPDOWNS' => 'Ներքև բացվող մենյուի խմբագիր',

//STUDIO2
    'LBL_MODULEBUILDER' => 'Մոդուլի կառուցող',
    'LBL_STUDIO' => 'Ստուդիա',
    'LBL_DROPDOWNEDITOR' => 'Ներքև բացվող մենյուի խմբագիր',
    'LBL_DEVELOPER_TOOLS' => 'Նախագծողի գործիքներ',
    'LBL_SUITEPORTAL' => 'SuiteCRM պորտալի խմբագիր',
    ...
    'LBL_CURRENT_LAYOUT' => 'Մակետ',
    'LBL_CURRENCY' => 'Արտարժույթ',
    'LBL_DASHLET' => 'SuiteCRM-ի դաշլետ',
    ...
    'LBL_DASHLETSEARCHVIEW' => 'SuiteCRM-ի դաշլետի որոնում',
    ...
    'LBL_FILLER' => '(ազատ դաշտ)',
    'LBL_FIELDS' => 'Դաշտեր',
    'LBL_FAILED_TO_SAVE' => 'Failed To Save',
    'LBL_FAILED_PUBLISHED' => 'Failed to Publish',
    'LBL_HOMEPAGE_PREFIX' => 'My',
    'LBL_LAYOUT_PREVIEW' => 'Մակետի նախադիտում',
    'LBL_LAYOUTS' => 'Մակետներ',
    ...
    'LBL_SUBPANEL_TITLE' => 'Վերնագիր․',
    'LBL_SEARCH_FORMS' => 'Որոնում',
    'LBL_SEARCH' => 'Որոնում',
    'LBL_SEARCH_BUTTON' => 'Որոնում',
    'LBL_FILTER' => 'Որոնում',
    'LBL_TOOLBOX' => 'Գործիքներ',
    'LBL_QUICKCREATE' => 'Արագ ստեղծել',
    'LBL_EDIT_DROPDOWNS' => 'Խմբագրել գլոբալ ներքև բացվող մենյու',
    'LBL_ADD_DROPDOWN' => 'Ավելացնել նոր գլոբալ ներքև բացվող մենյու',
    'LBL_BLANK' => '-բլանկ-',
    'LBL_TAB_ORDER' => 'Tab Order',
    'LBL_TABDEF_TYPE' => 'Տեսակի ցուցադրում',
    ...
    'LBL_DROPDOWN_TITLE_NAME' => 'Անվանում',
    'LBL_DROPDOWN_LANGUAGE' => 'Լեզու',
    'LBL_DROPDOWN_ITEMS' => 'Ցուցակի տարրեր',
    'LBL_DROPDOWN_ITEM_NAME' => 'Նյութի անվանումը',
    'LBL_DROPDOWN_ITEM_LABEL' => 'Ցուցադրել պիտակ',
    ...
    'LBL_COPY_FROM_EDITVIEW' => 'Պատճենել խմբագրման դիտումից',
    ...
    'LBL_DROPDOWN_KEY_EXISTS' => 'Բանալին արդեն գոյություն ունի ցանկում',
    'LBL_NO_SAVE_ACTION' => 'Այս դիտումով չեր կարող գտնել պահպանված գործողությունը',
...
//RELATIONSHIPS
    ...
    'LBL_RELATIONSHIPS' => 'Հարաբերություններ',
    'LBL_RELATIONSHIP_EDIT' => 'Edit Relationship',
    'LBL_REL_NAME' => 'Անվանում',
    'LBL_REL_LABEL' => 'Պիտակ',
    'LBL_REL_TYPE' => 'Տիպ',
    'LBL_RHS_MODULE' => 'Կապված է մոդուլին',
    'LBL_NO_RELS' => 'Հարաբերություններ չկան',
    'LBL_RELATIONSHIP_ROLE_ENTRIES' => 'Optional Condition',
    'LBL_RELATIONSHIP_ROLE_COLUMN' => 'Սյուն',
    'LBL_RELATIONSHIP_ROLE_VALUE' => 'Արժեք',
...
//STUDIO QUESTIONS
    ...
    'LBL_QUESTION_LAYOUT' => 'Ընտրել մակետը խմբագրելու համար։',
    ...
    'LBL_QUESTION_DASHLET' => 'Ընտրել դաշլետը դասավորությունը խմբագրելու համար։',
...
//SECTION
    'LBL_SECTION_EDLABELS' => 'Խմբագրել պիտակները',
    'LBL_SECTION_PACKAGES' => 'Packages',
    'LBL_SECTION_PACKAGE' => 'Package',
    'LBL_SECTION_MODULES' => 'Մոդուլներ',
    'LBL_SECTION_DROPDOWNS' => 'Ներքև բացվող մենյուներ',
    'LBL_SECTION_PROPERTIES' => 'Properties',
    'LBL_SECTION_DROPDOWNED' => 'Խմբագրել ներքև բացվող մենյուն',
    'LBL_SECTION_HELP' => 'Օգնություն',
    'LBL_SECTION_MAIN' => 'Main',
    'LBL_SECTION_FIELDEDITOR' => 'Edit Field',
    'LBL_SECTION_DEPLOY' => 'Deploy',
    'LBL_SECTION_MODULE' => 'Մոդուլ',
//WIZARDS

//LIST VIEW EDITOR
    'LBL_DEFAULT' => 'Լռելյայն ',
    'LBL_HIDDEN' => 'Hidden',
    ...
    'LBL_LISTVIEW_EDIT' => 'Ցուցակի խմբագիր',

//Manager Backups History
    'LBL_MB_PREVIEW' => 'Նախնական դիտում',
    'LBL_MB_RESTORE' => 'Վերականգնել',
    'LBL_MB_DELETE' => 'Ջնջել',
    'LBL_MB_DEFAULT_LAYOUT' => 'Ընդունված մակետ',
...
//BUTTONS
    ...
    'LBL_BTN_ADDFIELD' => 'Ավելացնել դաշտ',
    'LBL_BTN_ADDDROPDOWN' => 'Ավելացնել ներքև բացվող մենյու',
    'LBL_BTN_SORT_ASCENDING' => 'Վերընթացիկ դասավորում',
    'LBL_BTN_SORT_DESCENDING' => 'Վայրընթացիկ դասավորում',
    'LBL_BTN_EDLABELS' => 'Խմբագրել պիտակները',
    'LBL_BTN_UNDO' => 'Չեղարկել',
    'LBL_BTN_REDO' => 'Կրկնել',
    'LBL_BTN_ADDCUSTOMFIELD' => 'Ավելացնել հարմարեցված դաշտ',
    'LBL_BTN_EXPORT' => 'Export Customizations',
    'LBL_BTN_DUPLICATE' => 'Դուբլիկատ',
    'LBL_BTN_PUBLISH' => 'Հրապարակում',
    'LBL_BTN_DEPLOY' => 'Deploy',
    'LBL_BTN_EXP' => 'Արտահանել',
    'LBL_BTN_DELETE' => 'Ջնջել',
    'LBL_BTN_VIEW_LAYOUTS' => 'Դիտել մակետները',
    'LBL_BTN_VIEW_FIELDS' => 'Դիտել դաշտերը',
    'LBL_BTN_VIEW_RELATIONSHIPS' => 'Կապերի դիտում',
    'LBL_BTN_ADD_RELATIONSHIP' => 'Ավելացնել հարաբերությունները',
    'LBL_BTN_RENAME_MODULE' => 'Change Module Name',
//TABS


//ERRORS
    'ERROR_ALREADY_EXISTS' => 'Սխալ. Դաշտը արդեն գոյություն ունի',
    'ERROR_INVALID_KEY_VALUE' => "Error: Invalid Key Value: [']",
    'ERROR_NO_HISTORY' => 'No history files found',
    'ERROR_MINIMUM_FIELDS' => 'The layout must contain at least one field',
    'ERROR_GENERIC_TITLE' => 'Սխալ է տեղի ունեցել',
    'ERROR_REQUIRED_FIELDS' => 'Համոզվա՞ծ եք, որ ցանկանում եք շարունակել։ Հետևյալ պարտադիր դաշտերը բացակայում են մակետում․  ',
...
//PACKAGE AND MODULE BUILDER
    ...
    'LBL_LIST' => 'Ցուցակ',
    'LBL_VIEW' => 'Դիտում',
    'LBL_HISTORY' => 'Դիտել պատմությունը',
    'LBL_RESTORE_DEFAULT' => 'Restore Default',
    'LBL_ACTIVITIES' => 'Գործունեություն',
    'LBL_NEW' => 'Նոր',
...
//AJAX STATUS
    ...
    'LBL_AJAX_LOADING' => 'Բեռնում ․․․․․',
    'LBL_AJAX_DELETING' => 'Deleting...',
    'LBL_AJAX_BUILDPROGRESS' => 'Կատարման ընթացքում է․․․',
    'LBL_AJAX_DEPLOYPROGRESS' => 'Տեղադրման ընթացքում է․․․',

    'LBL_AJAX_RESPONSE_TITLE' => 'Արդյունք',
    'LBL_AJAX_RESPONSE_MESSAGE' => 'This operation is completed successfully',
    'LBL_AJAX_LOADING_TITLE' => 'Ընթացքի մեջ է',
    'LBL_AJAX_LOADING_MESSAGE' => 'Սպասեք խնդրում ենք, բեռնվում է․․․',
...
//CONFIRM
    ...
    'LBL_CONFIRM_LOWER_LENGTH' => 'Տվյալները կարող են կրճատված լինեն և այդ գործողությունը չի կարելի ետարկել։ Դուք վստա՞հ եք, որ ցանկանում եք շարունակել։',
...
//Revert Module labels
    'LBL_RESET' => 'Վերականգնել',
    'LBL_RESET_MODULE' => 'Վերականգնել մոդուլը',
    'LBL_REMOVE_CUSTOM' => 'Remove Customizations',
    'LBL_CLEAR_RELATIONSHIPS' => 'Clear Relationships',
    'LBL_RESET_LABELS' => 'Վերականգնել տարբերանշանները',
    'LBL_RESET_LAYOUTS' => 'Վերակայել մակետը"',
    ...
    'fieldTypes' => array(
        'varchar' => 'TextField',
        'int' => 'Ամբողջ թվի արժեք',
        'float' => 'Float',
        'bool' => 'Checkbox',
        'enum' => 'Ներքև բացվող մենյու',
        'dynamicenum' => 'Փոփոխվող ներքև բացվող մենյու',
        ...
        'url' => 'URL հասցե',
        'iframe' => 'IFrame',
        'datetimecombo' => 'Ամսաթվի ժամանակը',
        'decimal' => 'Decimal',
        'image' => 'Պատկեր',
        'wysiwyg' => 'WYSIWYG',
    ),
    ...
    'LBL_RELATED_FIELD_ID_NAME_LABEL' => '{0} (առնչվող {1} ID)',
);
