...
$mod_strings = array(
    'LBL_MODULE_NAME' => 'Միավորել գրառումները',
    'LBL_MODULE_TITLE' => 'Միավորել գրառումները․ Գլխավոր',
    'LBL_SEARCH_FORM_TITLE' => 'Միավորման որոնում',
    ...
    'LBL_NEXT_STEP_TITLE' => 'Անցնել հաջորդ քայլին',
    'LBL_NEXT_STEP_BUTTON_LABEL' => 'Հաջորդ քայլը >',
    ...
    'LBL_PROCEED' => 'Շարունակե՞լ։',
    'LBL_STEP1_DIRECTIONS' => 'Որոնել հնարավոր կրկնօրինակ գրառումները։ Եթե ​​հնարավոր է կրկնօրինակների որոնում, դուք կարող եք ընտրել գրառումները, որոնք միաձուլվել են ընթացիկ գրառման հետ։',
);
