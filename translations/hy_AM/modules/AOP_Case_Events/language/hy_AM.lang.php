...
$mod_strings = array(
    ...
    'LBL_REMOVE' => 'Հեռացնել',
    'LBL_LIST_FORM_TITLE' => 'Գործի իրադարձությունների ցանկ',
    'LBL_MODULE_NAME' => 'Գործի իրադարձություններ',
    'LBL_MODULE_TITLE' => 'Գործի իրադարձություններ',
    'LBL_HOMEPAGE_TITLE' => 'Իմ գործի իրադարձությունները',
    'LNK_NEW_RECORD' => 'Ստեղծել գործի իրադարձությունը',
    'LNK_LIST' => 'Դիտել գործի իրադարձությունները',
    'LBL_SEARCH_FORM_TITLE' => 'Որոնել գործի իրադարձությունները',
    'LBL_HISTORY_SUBPANEL_TITLE' => 'Դիտել պատմությունը',
    'LBL_ACTIVITIES_SUBPANEL_TITLE' => 'Գործունեություն',
    'LBL_NEW_FORM_TITLE' => 'Նոր գործի իրադարձություններ',
    'LBL_CASE_NAME' => 'Գործ',
);
