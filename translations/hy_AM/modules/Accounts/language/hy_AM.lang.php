...
$mod_strings = array(
    ...
    'LBL_DEFAULT' => 'Դիտումներ',
    // END Dashlet Categories

    'ERR_DELETE_RECORD' => 'Որպեսզի հեռացնել հաշիվը դուք պետք է նշեք գրառման համարը:',
    'LBL_ACCOUNT_INFORMATION' => 'Հիմնական ինֆորմացիա', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
    'LBL_ACCOUNT_NAME' => 'Հաշվի անունը․',
    'LBL_ACCOUNT' => 'Պատվիրատու․',
    ...
    'LBL_HOMEPAGE_TITLE' => 'Իմ հաշիվները',
    ...
    'LBL_LIST_ACCOUNT_NAME' => 'Անվանում',
    'LBL_LIST_CITY' => 'Քաղաք',
    'LBL_LIST_CONTACT_NAME' => 'Կոնտակտ անվանում',
    'LBL_LIST_EMAIL_ADDRESS' => 'էլ-փոստի հասցե',
    'LBL_LIST_FORM_TITLE' => 'Հաշվի ցուցակ',
    'LBL_LIST_PHONE' => 'Հեռ.',
    'LBL_LIST_STATE' => 'Մարզ',
    'LBL_MEMBER_OF' => 'Անդամակից է․',
    'LBL_MEMBER_ORG_SUBPANEL_TITLE' => 'Անդամ կազմակերպություններ',
    'LBL_MODULE_NAME' => 'Հաշիվներ',
    'LBL_MODULE_TITLE' => 'Հաշիվներ․ Գլխավոր',
    'LBL_MODULE_ID' => 'Հաշիվներ',
    'LBL_NAME' => 'Անվանում․',
    'LBL_NEW_FORM_TITLE' => 'Նոր հաշիվ',
    ...
    'LBL_PUSH_CONTACTS_BUTTON_LABEL' => 'Կրկնօրինակ կոնտակտի համար',
    'LBL_PUSH_CONTACTS_BUTTON_TITLE' => 'Պատճենել...',
    'LBL_RATING' => 'Գնահատական․',
    'LBL_SAVE_ACCOUNT' => 'Պահպանել հաշիվը',
    'LBL_SEARCH_FORM_TITLE' => 'Հաշվի փնտրում',
    'LBL_SHIPPING_ADDRESS_CITY' => 'Առաքման քաղաք.',
    'LBL_SHIPPING_ADDRESS_COUNTRY' => 'Առաքման երկիրը:',
    ...
    'LNK_IMPORT_ACCOUNTS' => 'Ներմուծել հաշիվներ',
    ...
    // SNIP
    'LBL_PRODUCTS_SERVICES_PURCHASED_SUBPANEL_TITLE' => 'Գնված ապրանքներ և ծառայություններ',
