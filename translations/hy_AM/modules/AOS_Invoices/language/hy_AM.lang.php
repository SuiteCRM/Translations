...
$mod_strings = array(
    ...
    'LBL_LIST_FORM_TITLE' => 'Հաշիվների ցուցակ',
    'LBL_MODULE_NAME' => 'Հաշիվ-ապրանքագիր',
    'LBL_MODULE_TITLE' => 'Հաշիվ-ապրանքագրեր. Գլխավոր',
    'LBL_HOMEPAGE_TITLE' => 'Իմ հաշիվ-ապրանքագրերը',
    'LNK_NEW_RECORD' => 'Ստեղծել հաշիվ-ապրանքագիր',
    'LNK_LIST' => 'Հաշիվ-ապրանքագրերի դիտում',
    'LBL_SEARCH_FORM_TITLE' => 'Հաշիվ-ապրանքագրերի փնտրում',
    'LBL_HISTORY_SUBPANEL_TITLE' => 'Դիտել պատմությունը',
    'LBL_NEW_FORM_TITLE' => 'Նոր հաշիվ-ապրանքագիր',
    ...
    'LBL_INVOICE_NUMBER' => 'Հաշիվ-ապրանքագրի համարը',
    'LBL_OPPORTUNITY' => 'Գործարքի անվանում',
    'LBL_TEMPLATE_DDOWN_C' => 'Հաշիվ-ապրանքագրերի ձևանմուշներ',
    ...
    'LBL_INVOICE_DATE' => 'Հաշիվ-ապրանքագրի ամսաթիվը',
    'LBL_DUE_DATE' => 'Կատարման ամսաթիվը',
    ...
    'LBL_EMAIL_INVOICE' => 'Հաշիվ-ապրանքագիրը ուղարկել էլ-փոստով',
    'LBL_LIST_NUM' => 'Համ․',
    'LBL_PDF_NAME' => 'Հաշիվ-ապրանքագիր',
    'LBL_EMAIL_NAME' => 'Հաշիվ-ապրանքագրի համար',
    'LBL_NO_TEMPLATE' => 'Սխալ\nՈչ մի ձևանմուշ գտնված չէ։ Եթե դուք չեք ստեղծել հաշիվ-ապրանքագրի ձևանմուշ, բացեք PDF ձևանմուշների մոդուլը և ստեղծեք անհրաժեշտ ձևանմուշը',
