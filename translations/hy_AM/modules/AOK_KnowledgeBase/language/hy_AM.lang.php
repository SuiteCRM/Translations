...
$mod_strings = array(
    ...
    'LBL_REMOVE' => 'Հեռացնել',
    'LBL_LIST_FORM_TITLE' => 'Գիտելիքների բազաի ցանկ',
    'LBL_MODULE_NAME' => 'Գիտելիքների բազա',
    'LBL_MODULE_TITLE' => 'Գիտելիքների բազա',
    'LBL_HOMEPAGE_TITLE' => 'Իմ Գիտելիքների բազան',
    'LNK_NEW_RECORD' => 'Ստեղծել Գիտելիքների բազան',
    'LNK_LIST' => 'Դիտել Գիտելիքների բազան',
    'LBL_SEARCH_FORM_TITLE' => 'Որոնել Գիտելիքների բազան',
    'LBL_HISTORY_SUBPANEL_TITLE' => 'Դիտել պատմությունը',
    'LBL_ACTIVITIES_SUBPANEL_TITLE' => 'Գործունեություն',
    'LBL_NEW_FORM_TITLE' => 'Նոր Գիտելիքների բազա',
    'LBL_STATUS' => 'Կարգավիճակ',
    'LBL_REVISION' => 'Տարբերակ',
    'LBL_AUTHOR_USER_ID' => 'Հեղինակ (ID)',
    'LBL_AUTHOR' => 'Հեղինակ',
    'LBL_APPROVER_USER_ID' => 'Հաստատող (ID)',
    'LBL_APPROVER' => 'Հաստատող',
);

$mod_strings['LBL_AOK_KB_CATEGORIES_TITLE'] = 'Կատեգորիաներ';
