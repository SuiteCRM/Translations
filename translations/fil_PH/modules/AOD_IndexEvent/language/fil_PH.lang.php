...
$mod_strings = array(
    ...
    'LBL_LIST_FORM_TITLE' => 'Listahan ng pangyayari',
    'LBL_MODULE_NAME' => 'Ang Indeks ng mga kaganapan',
    'LBL_MODULE_TITLE' => 'Ang Indeks ng mga kaganapan',
    'LBL_HOMEPAGE_TITLE' => 'Ang aking index event',
    'LNK_NEW_RECORD' => 'Gumawa ng index event',
    'LNK_LIST' => 'I-view ang index event',
    'LBL_SEARCH_FORM_TITLE' => 'Mag-search ng index event',
    'LBL_HISTORY_SUBPANEL_TITLE' => 'Tingnan ang kasaysayan',
    'LBL_ACTIVITIES_SUBPANEL_TITLE' => 'Mga ginagawa',
    'LBL_NEW_FORM_TITLE' => 'Bagong Index event',
    'LBL_ERROR' => 'Mali',
    'LBL_SUCCESS' => 'Tagumpay',
    'LBL_RECORD_MODULE' => 'Tagumpay',

    'LBL_RECORD_ID' => 'ID ng rekord',
);
