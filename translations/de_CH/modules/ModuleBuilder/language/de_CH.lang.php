...
$mod_strings = array(
    ...
    'help' => array(
        ...
        ,
            ...
            'historyBtn' => 'Klicken Sie auf <b>Verlaufansicht</b> um ein zuvor gespeichertes Layout aus dem Verlauf aufzurufen und wiederherzustellen.',
            'historyDefault' => 'Klicken Sie auf <b>Standardeinstellungen wiederherstellen</b> , um die Ansicht des ursprünglichen Layouts wiederherzustellen.',
        ...
        ,
            ...
            'historyBtn' => 'Click <b>View History</b> to view and restore a previously saved layout from the history.<br><br><b>Restore</b> within <b>View History</b> restores the field placement within previously saved layouts. To change field labels, click the Edit icon next to each field.',
            'historyDefault' => 'Click <b>Restore Default</b> to restore a view to its original layout.<br><br><b>Restore Default</b> only restores the field placement within the original layout. To change field labels, click the Edit icon next to each field.',
            'Default' => '<b>Standardfelder</b> werden in der Suche angezeigt.'
        ),
        'layoutEditor' => array(
        ...
        'exportcustom' => array(
            ...
            'name' => 'Dies ist der <b>Name</b> des Pakets. Dieser Name wird während der Installation angezeigt.',
            'author' => 'Dies ist der <b>Author</b>, der während der Installation als der Name der Entität angezeigt wird, die das Paket erstellt hat. Der Autor kann entweder eine Person oder ein Unternehmen sein.',
            'description' => 'Hier ist die <b>Beschreibung</b> eingetragen, die auch bei der Installation angezeigt wird.',
        ),
        'studioWizard' => array(
            ...
            'sugarPortalBtn' => 'Verwenden Sie den <b>SuiteCRM Portal Editor</b> um das SuiteCRM Portal zu verwalten und anzupassen.',
            ...
            'mbHelp' => '<b>Willkommen beim Module erstellen".</b>Mit der Funktion Module erstellen erstellen Sie neue Pakete, die benutzerdefinierte Module enthalten – basierend auf standardmäßigen oder personalisierten Objekten.',
...
//STUDIO2
    ...
    'LBL_FILTER' => 'Filter',
    'LBL_TOOLBOX' => 'Toolbox',
    'LBL_QUICKCREATE' => 'Schnelles Erstellen',
...
//POPUP HELP
    ...
    'LBL_POPHELP_IMPORTABLE' => '<b>Ja</b>: Das Feld wird in einen Importvorgang aufgenommen.<br><b>Nr.</b>: Das Feld wird nicht in einen Import aufgenommen.<br><b>Benötigt</b>: Ein Wert für das Feld muss bei jedem Import angegeben werden.',
    'LBL_POPHELP_IMAGE_WIDTH' => 'Geben Sie eine Anzahl für Breite ein, wie in Pixeln gemessen.<br> Das hochgeladene Bild wird auf diese Breite skaliert.',
    'LBL_POPHELP_IMAGE_HEIGHT' => 'Geben Sie eine Zahl für die Höhe ein, wie in Pixeln gemessen.<br> Das hochgeladene Bild wird auf diese Höhe skaliert.',
    'LBL_POPHELP_DUPLICATE_MERGE' => '<b>Aktiviert</b>: Das Feld wird in der Funktion Merge Duplikate erscheinen, aber nicht verfügbar für die Filterbedingungen in der Funktion "Duplikate finden".<br><b>Deaktiviert</b>: Das Feld wird nicht in der Funktion Merge Duplikate angezeigt, und wird nicht für die Filterbedingungen in der Funktion "Duplikate finden" verfügbar sein.<br><b>Filter</b>: Das Feld wird in der Funktion Merge Duplikate angezeigt, und steht für die Filterbedingungen in der Funktion Suche Duplikate zur Verfügung.<br><b>Standardfilter</b>: Das Feld wird in der Funktion Zusammenführen von Duplikaten angezeigt, und wird standardmäßig für die Filterbedingungen in der Funktion Suche Duplikate verwendet.<br><b>Nur Filter</b>: Das Feld wird in der Funktion Zusammenführen nicht angezeigt, aber verfügbar für die Filterbedingungen in der Funktion Suche Duplikate sein.',
...
//Revert Module labels
    ...
    'fieldTypes' => array(
        ...
        'phone' => 'Telefon',
        'currency' => 'Currency',
        'html' => 'Nur HTML lesen (veraltet, TextBlock verwenden)',
        'radioenum' => 'Radio',
        'relate' => 'Verknüpfen',
        'address' => 'Address',
        'text' => 'Textfläche',
