...
$mod_strings = array(
    ...
    'LBL_BUTTON_CANCEL' => 'Abbrechen [Alt+X]',
    ...
    'LBL_UW_COMMIT_ADD_TASK_DESC_2' => 'Folgende files manuel zusammen fügen: ' . PHP_EOL,
    ...
    'LBL_UW_PREFLIGHT_FILES_DESC' => 'Die unten angeführten Dateien wurden verändert. Entfernen Sie die Markierung bei Positionen die einen manuellen Abgleich erfordern. <i><Gefundene Änderungen an Layouts werden automatisch deaktiviert"',
    ...
    'LBL_UW_TITLE_CANCEL' => 'Abbrechen [Alt+X]',
    ...
    'ERROR_VERSION_INCOMPATIBLE' => 'Die hochgeladene Datei ist nicht mit dieser Version von SuiteCRM kompatibel: ',
    'ERROR_PHP_VERSION_INCOMPATIBLE' => 'Die hochgeladene Datei ist nicht mit dieser PHP-Version kompatibel: ',
    'ERROR_SUITECRM_VERSION_INCOMPATIBLE' => 'Die hochgeladene Datei ist nicht mit dieser Version von SuiteCRM kompatibel: ',
    ...
    'ERR_UW_PHP_FILE_ERRORS' => array(
        1 => 'Die hochgeladene Datei ist grösser als upload_max_filesize in php.ini.',
        2 => 'Die hochgeladene Datei ist grösser als die MAX_FILE_SIZE Direktive, die im HTML Fomular angegeben wurde.',
