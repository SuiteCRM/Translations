...
// Activity stream
    'CREATED_CONTACT' => 'a creat un <b>NOU</b> {0}', // For fusional (inflected) languages: used in the sentence "Administrator created a new contact"
    'CREATED_OPPORTUNITY' => 'a creat un <b>NOU</b> {0}', // For fusional (inflected) languages: used in the sentence "Administrator created a new opportunity"
    'CREATED_CASE' => 'a creat un <b>NOU</b> {0}', // For fusional (inflected) languages: used in the sentence "Administrator created a new case"
    'CREATED_LEAD' => 'a creat un <b>NOU</b> {0}', // For fusional (inflected) languages: used in sentence "Administrator created a new lead"
