...
$mod_strings = array(
    ...
    'LBL_SYSOPTS_ERRS_TITLE' => 'Vă rugăm corectați următoarele erori înainte de a continua:',
    ...
    'ERR_CHECKSYS_CURL' => 'Nu s-a găsit: În acest caz, Planificatorul din SuiteCRM are funcționalitate limitată.',
    ...
    'ERR_CHECKSYS_CONFIG_NOT_WRITABLE' => 'Fișierul de configurare există, dar nu poate fi scris. Vă rugăm să urmați pașii necesari pentru ca fișierul să poată fi scris.',
    'ERR_CHECKSYS_CONFIG_NOT_FOUND' => 'Fișierul dvs. config.php nu există. Acesta va fi creat la instalare.',
    'ERR_CHECKSYS_CONFIG_OVERRIDE_NOT_WRITABLE' => 'Fișierul de configurare există dar nu poate fi scris. Vă rugăm să luați măsurile necesare pentru a face fișierul inscriptibil. ',
    'ERR_CHECKSYS_CUSTOM_NOT_WRITABLE' => 'Directorul Personalizat exista, dar nu poate fi scris. Vă rugăm luați măsurile necesare pentru ca fișierul să poată fi scris.',
    'ERR_CHECKSYS_FILES_NOT_WRITABLE' => "Fișierele sau directoarele listate mai sus nu pot fi scrise sau lipsesc și nu pot fi create. Vă rugăm să luați măsurile necesare pentru a face directoarele inscriptibile.",
    'ERR_CHECKSYS_LOGS_NOT_WRITABLE' => 'Directorul de jurnale nu este în prezent inscriptibil',
    'ERR_CHECKSYS_CACHE_NOT_WRITABLE' => 'Directorul cache nu este în prezent inscriptibil',
    'ERR_CHECKSYS_EXTENSIONS_NOT_WRITABLE' => 'Directorul de extensii nu este în prezent inscriptibil',
    'ERR_CHECKSYS_SECRETS_NOT_WRITABLE' => 'Directorul config/secrets nu poate fi scris momentan',
    'ERR_CHECKSYS_ENV_NOT_WRITABLE' => 'Fișierul .env sau directorul în care se află nu poate fi scris.',
    ...
    'ERR_DB_INVALID' => 'Tip de bază de date invalid selectat.',
    'ERR_DB_LOGIN_FAILURE_SHORT' => 'Eroare de conectare la baza de date: Numele gazdei, portul, numele de utilizator și/sau parola bazei de date furnizate sunt invalide.',
    ...
    'ERR_DB_MYSQL_DB_NAME_INVALID' => "Numele bazei de date nu poate conține '\\', '/', sau '.'",
    ...
    'ERR_DBCONF_VALIDATION' => 'Vă rugăm corectați următoarele erori înainte de a continua:',
    ...
    'ERR_ERROR_GENERAL' => 'Au apărut următoarele erori:',
    ...
    'ERR_LOG_DIRECTORY_NOT_EXISTS' => 'Directorul furnizat pentru log nu este un director valid.',
    ...
    'ERR_PERFORM_CONFIG_PHP_1' => 'Nu se poate scrie in fișierul <span class=stop>config.php</span>.',
    'ERR_PERFORM_CONFIG_PHP_2' => 'Puteți continua această instalare creând manual fișierul config.php și lipind informațiile de configurare de mai jos în fișierul config.php. Cu toate acestea, <strong>trebuie</strong> să creați fișierul config.php înainte de a continua către următorul pas.',
    'ERR_PERFORM_CONFIG_PHP_3' => 'V-ați amintit să creați fișierul config.php?',
    'ERR_PERFORM_CONFIG_PHP_4' => 'Atenție: Nu se poate scrie în fișierul config.php. Te rog să te asiguri ca exista.',
    'ERR_PERFORM_HTACCESS_1' => 'Nu se poate scrie la ',
    'ERR_PERFORM_HTACCESS_2' => ' fișier.',
    'ERR_PERFORM_HTACCESS_3' => 'Dacă doriți să securizați fișierul de loguri pentru a nu fi accesibil din browser creați un fișier:',
    ...
    'ERR_SESSION_PATH' => 'Calea pentru sesiune este necesară dacă doriți să specificați o cale proprie.',
    'ERR_SI_NO_CONFIG' => 'Dacă nu ați inclus config_si.php în rădăcina documentului sau nu ați definit $sugar_config_si in config.php',
    'ERR_SITE_GUID' => 'ID-ul aplicației este necesar daca doriți sa specificați unul al dumneavoastră.',
    ...
    'ERR_UPLOAD_MAX_FILESIZE' => 'Configurația dumneavoastră PHP ar trebui modificata pentru a permite încărcarea fișierelor de cel puțin 6MB.',
    ...
    'LBL_CANCEL' => 'Anulați',
    'LBL_ACCEPT' => 'Accept',
    'LBL_CHECKSYS_LEGACY_CACHE' => 'Subdirectoare cache-ul scriu moștenit',
    'LBL_CHECKSYS_CACHE' => 'Directoare de cache in care se poate scrie',
    'LBL_CHECKSYS_EXTENSIONS' => 'Director e inscriptibil pentru extensii',
    'LBL_CHECKSYS_SECRETS' => 'Directorul Config/Secrets inscriptibil',
    'LBL_CHECKSYS_LOGS' => 'Directorul cu însemnări inscriptibile',
    ...
    'LBL_CHECKSYS_CONFIG' => 'Fișierul de configurare este inscriptibil în SuiteCRM (config.php)',
    ...
    'LBL_CHECKSYS_MEM_OK' => 'OK (Fără Limite)',
    'LBL_CHECKSYS_MEM_UNLIMITED' => 'OK (Nelimitat)',
    'LBL_CHECKSYS_MEM' => 'PHP Limita memorie',
    'LBL_CHECKSYS_MODULE' => 'Module in care se poate scrie, subdirectoare și fișiere',
    'LBL_CHECKSYS_NOT_AVAILABLE' => 'Nu Este Disponibil',
    'LBL_CHECKSYS_OK' => 'OK',
    'LBL_CHECKSYS_PHP_INI' => 'Locația fișierului de configurare PHP (php.ini)',
    'LBL_CHECKSYS_PHP_OK' => 'OK(versiunea ',
    'LBL_CHECKSYS_PHPVER' => 'Versiune PHP',
    'LBL_CHECKSYS_IISVER' => 'Versiunea IIS',
    'LBL_CHECKSYS_JSON' => 'Analiza și prelucrarea JSON',
    'LBL_CHECKSYS_RECHECK' => 'Reverificați',
    ...
    'LBL_CHECKSYS_ENV' => '.env care poate fi modificat',
    ...
    'LBL_CHECKSYS_INTL_EXTENSIONS' => 'Intl existent în extensii',
    'LBL_CHECKSYS_JSON_EXTENSIONS' => 'Extensiile suportă Json',
    'LBL_CHECKSYS_GD_EXTENSIONS' => 'GD se găsește în extensii',
    'LBL_CHECKSYS_OPENSSL_EXTENSIONS' => 'OpenSSL există în extensii',
    'LBL_CHECKSYS_ZIP_EXTENSIONS' => 'Zip există în extensii',
    'LBL_CHECKSYS_PDO_MYSQL_EXTENSIONS' => 'Extensiile includ fișiere PDO MySQL',
    'LBL_CHECKSYS_CURL_EXTENSIONS' => 'cURL existentă în extensii',
    'LBL_CHECKSYS_MBSTRING_EXTENSIONS' => 'Extensiile conțin șiruri de caractere MB',
    'LBL_CHECKSYS_MYSQLI_EXTENSIONS' => 'Extensiile includ MySQLi',
    'LBL_CHECKSYS_SOAP_EXTENSIONS' => 'Soap existentă în extensii',
    'LBL_CHECKSYS_XML_EXTENSIONS' => 'Extensiile conțin XML',
    'LBL_CHECKSYS_IMAP_EXTENSIONS' => 'IMAP există în extensii (opțional)',
    'LBL_CHECKSYS_LDAP_EXTENSIONS' => 'LDAP există în extensii (opțional)',
    'LBL_PHP_CHECKS' => 'Verificări PHP',
    'LBL_SERVER_CHECKS' => 'Verificări de server',
    'LBL_PERMISSION_CHECKS' => 'Verificări de acces',
    'LBL_CHECK_FAILED' => 'Verificare eșuată: ',
    'ERR_CHECKSYS_INTL' => 'Extensia Intl nu este instalată, vă rugăm să contactați administratorul de sistem',
    'ERR_CHECKSYS_JSON' => 'Extensia JSON nu este activată, vă rugăm să contactați administratorul de sistem.',
    'ERR_CHECKSYS_GD' => 'Extensia GD nu este activată, vă rugăm să contactați administratorul sistemului.',
    'ERR_CHECKSYS_OPENSSL' => 'Extensia OpenSSL nu este activată, vă rugăm să contactați administratorul de sistem.',
    'ERR_CHECKSYS_PDO_MYSQL' => 'Extensia PDO MySQL nu este activată, vă rugăm să contactați administratorul de sistem.',
    'ERR_CHECKSYS_MYSQLI' => 'Extensia MySQLi nu este activată, vă rugăm să contactați administratorul de sistem.',
    'ERR_CHECKSYS_SOAP' => 'Extensia Soap nu este activată. Vă rugăm să contactați administratorul de sistem.',
    ...
    'LBL_UNWRITABLE_SUB_DIR' => 'Există unele subdirectoare care nu pot fi scrise. Vă rugăm să luați măsurile necesare pentru a face directoarele inscriptibile ',
    'LBL_REFER_TO_LOGS' => 'A apărut o problemă în una dintre verificările de pre-instalare, vă rugăm să consultați install.log',
    'LBL_NOT_A_VALID_SUITECRM_PAGE' => 'Titlul SuiteCRM nu poate fi găsit. Aceasta nu este o pagina valida SuiteCRM.',
    'LBL_NOT_COOKIE_OR_TOKEN' => 'Nu s-au găsit cookie-uri, niciun Token valid nu am găsit. Vă rugăm să consultați install.log pentru mai multe informații.',
    'LBL_CURL_JSON_ERROR' => 'Rezultatul apelării curl către pagina graficului a fost nul.',
    'LBL_UNABLE_TO_FIND_SYSTEM_CONFIGS' => 'Nu s-au putut prelua Configurările de sistem pe Graphql pagină. Vă rugăm să consultați install.log pentru mai multe informații.',
    'LBL_CURL_REQUEST_MAIN_PAGE' => 'Solicitare Curl pe pagina principală',
    'LBL_CURL_REQUEST_API_PAGE' => 'Solicitare Curl pe Api',
    'LBL_ERROR_DETAILS' => 'Detalii despre eroare',
    'LBL_ERROR' => 'Eroare',
    'LBL_WARNING_DETAILS' => 'Detalii avertizare',
    'LBL_WARNING' => 'Avertisment',
    'LBL_SYSTEM_CHECKS' => 'VERIFICĂRI SISTEM',
    'LBL_CRON_INSTRUCTIONS_1' => 'Pentru a rula planificatorul SuiteCRM, editați fișierul crontab al utilizatorului serverului web cu următoarea comandă:',
    'LBL_CRON_INSTRUCTIONS_2' => 'și adaugă următoarea linie în fișierul crontab:',
    'LBL_CRON_INSTRUCTIONS_3' => 'Ar trebui să faceți acest lucru numai după ce s-a încheiat instalarea.',
    'LBL_CRON_CONFIGURATION' => 'CONFIGURARE CRON',
    'LBL_SETUP_CRONTAB' => 'Pentru a seta Crontab',
    'LBL_ROUTE_ACCESS_CHECK' => 'CONTROL ACCES LA TRASEU',
    'LBL_PHP_MEM_1' => 'Limita de memorie PHP este ',
    'LBL_PHP_MEM_2' => '. Acesta trebuie să fie un minim de ',
    'LBL_PHP_MEM_3' => 'M va continua.',
    'LBL_CLOSE' => 'Închide',
    'LBL_THREE' => '3',
    ...
    'LBL_DBCONF_DB_PORT' => 'Portul bazei de date',
    ...
    'LBL_DBCONF_DEMO_DATA' => 'Populați Bază Date cu Date Demo?',
    'LBL_DBCONF_DEMO_DATA_TITLE' => 'Alege Date Demo',
    'LBL_DBCONF_HOST_NAME' => 'Denumire Gazdă',
    ...
    'LBL_DISABLED_DESCRIPTION_2' => 'După ce aceasta schimbare a fost făcută, poți da clic pe butonul "Start" de mai jos pentru a începe instalarea. După ce instalarea este completă, veți dori să schimbați valoarea pentru \'installer_locked\' în \'true\'',
    'LBL_DISABLED_DESCRIPTION_3' => 'După ce această modificare a fost făcută, vă rugăm să reîncărcați această pagină pentru a continua.',
    'LBL_DISABLED_DESCRIPTION' => 'Programul de instalare a fost deja rulat o dată. Ca măsură de siguranță, acesta a fost dezactivat de la rularea a doua oară. Dacă sunteți absolut sigur că doriți să îl rulați din nou, vă rugăm să mergeți la fișierul config.php și să localizați (sau să adaugi) o variabilă numită \'installer_locked\' și să o setați la \'false\'. Linia ar trebui să arate astfel:',
    'LBL_DISABLED_HELP_1' => 'Pentru ajutor la instalare, vă rugăm vizitați site-ul celor de la SuiteCRM',
    'LBL_DISABLED_HELP_LNK' => 'https://community.suitecrm.com',
    'LBL_DISABLED_HELP_2' => 'Forumuri de asistență',
    'LBL_APP_NOT_INSTALLED' => 'SuiteCRM nu este instalat. Punctul de intrare are nevoie de un SuiteCRM instalat, vă rugăm să instalați mai întâi.',
    ...
    'LBL_SILENT_INSTALL_SUCCESS' => 'SuiteCRM a fost instalat cu succes.',
    'LBL_SILENT_INSTALL_FAILED' => 'Instalarea SuiteCRM a eșuat.',
    'LBL_LANG_UPLOAD' => 'Încarcă un pachet de limbă',
    'LBL_LICENSE_ACCEPTANCE' => 'Licență de acceptare',
    ...
    'LBL_PERFORM_CONFIG_PHP' => 'Creează fișierul de configurare SugarCRM',
    'LBL_PERFORM_CREATE_DB_1' => '<b>Se crează bază de date</b> ',
    'LBL_PERFORM_CREATE_DB_2' => ' <b>in</b> ',
    'LBL_PERFORM_CREATE_DB_USER' => 'Se creează numele de utilizator și parola bazei de date...',
    'LBL_PERFORM_CREATE_DEFAULT' => 'Creează date SuiteCRM implicite',
    'LBL_PERFORM_DEFAULT_SCHEDULER' => 'Crearea de programatoare implicite',
    ...
    'LBL_REG_CONF_3' => 'Vă mulțumim pentru înregistrare. Faceți clic pe butonul Finalizare pentru a vă conecta la SuiteCRM. Va trebui să vă conectați pentru prima dată utilizând numele de utilizator „admin” și parola pe care ați introdus-o la pasul 2.',
    'LBL_REG_TITLE' => 'Înregistrare',

    'LBL_REQUIRED' => '* Câmp necesar',
    ...
    'LBL_SITECFG_CUSTOM_ID' => 'Furnizați propriul ID al aplicației',
    ...
    'LBL_SITECFG_CUSTOM_LOG' => 'Folosiți un Director pentru Loguri Personalizat',
    ...
    'LBL_SITECFG_CUSTOM_SESSION' => 'Folosiți un director personalizat pentru sesiuni',
    'LBL_SITECFG_FIX_ERRORS' => '<b>Vă rugăm să corectați următoarele erori înainte de a continua:</b>',
    'LBL_SITECFG_LOG_DIR' => 'Director Loguri',
    'LBL_SITECFG_SESSION_PATH' => 'Calea către directorul de sesiuni<br>(trebuie să se poată scrie în director)',
    ...
    'LBL_PRE_INSTALL_REQ' => 'Cerințe pre-instalare',
    ...
    'LBL_WELCOME' => 'Bun venit la SuiteCRM',
    ...
    'LBL_WELCOME_SETUP_WIZARD' => 'Setări Wizard',
...
$contact_user_link_guid',
    ...
    'LBL_DBCONFIG_MSG2_LABEL' => 'Denumire Gazdă',
    ...
    'LBL_SYS_CHECK_WARNING' => 'Ignoră avertismentele de verificare sistem',
    'LBL_PROCEED' => 'CONTINUĂ',
    'LBL_RECHECK' => 'REVERIFICĂ',
    'LBL_CONFIG' => 'CONFIGURAȚIE',
    'LBL_VALIDATION_ERRORS' => 'Există erori de validare, nu se poate efectua operațiunea.'
);
