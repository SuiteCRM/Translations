...
$app_strings = array(
    ...
    'LBL_LOGOUT' => '로그아웃',
    'LBL_LOGOUT_SUCCESS' => '로그아웃 성공',
    'LBL_LOGGED_OUT_MESSAGE' => '로그아웃되었습니다',
    'LBL_LOGIN_AGAIN' => '다시 로그인 하기 ',
    'LBL_TOUR_NEXT' => '다음',
    'LBL_TOUR_SKIP' => '생략',
    'LBL_TOUR_BACK' => '이전',
    ...
    'LBL_EMAIL_ACCOUNTS_SMTPDEFAULT' => '기본값 ',
    ...
    'LBL_EMAIL_ADDRESS_BOOK_FILTER' => '검색',
    ...
    'LBL_EMAIL_FOLDERS' => SugarThemeRegistry::current()->getImage('icon_email_folder', 'align=absmiddle border=0', null, null, '.gif', '') . '폴더',
    ...
    'ERR_UNAUTHORIZED_PAGE_ACCESS' => '이 페이지를 볼 권한이 없습니다. 시스템 관리자에게 문의해 주세요.',
    'ERR_UNAUTHORIZED_PAGE_ACCESS_TO_HOME_PAGE' => '이 페이지를 볼 수 있는 권한이 없습니다. 홈 페이지로 리디렉션됩니다...',
    ...
    'LBL_ADD_TO_PROSPECT_LIST_BUTTON_LABEL' => '타겟 목록 추가',
    ...
    'LBL_IMPORT_VCARD_BUTTON_LABEL' => 'vCard에서작성',
    'LBL_IMPORT_VCARD_BUTTON_TITLE' => 'vCard에서작성',
    'LBL_VIEW_BUTTON' => '표시',
    ...
    'LBL_EXPORT' => '내보내기',
    'LBL_FAVORITES_FILTER' => '나의 즐겨찾기',
    'LBL_GO_BUTTON_LABEL' => '이동',
    'LBL_HIDE' => '숨김 ',
    'LBL_HISTORY' => '이력',
    'LBL_NEW' => '신규',
    'LBL_ID' => 'ID',
    ...
    'LBL_LAST_VIEWED_NO_RESULT' => '최근에 본 항목 없음',
    'LBL_LEADS' => '가망고객',
    'LBL_LESS' => '간단히',
    'LBL_CAMPAIGN' => '캠페인:',
    'LBL_CAMPAIGNS' => '캠페인',
    ...
    'LBL_COPY' => '복사',
    'LBL_CANCEL' => '취소',
    'LBL_SNOOZE' => '나중에 다시 알림',
    'LBL_SNOOZE_INLINE_CONFIRM' => '나중에 다시알림? ({{preferences.snooze_alert_timer|enum:snooze_alert_timer_simple}})',
    'LBL_DISMISS' => '알림 해제',
    ...
    'LBL_ALERT_DISMISS_ERROR' => '알림을 해제하는 동안 오류가 발생했습니다.',
    'LBL_ALERT_DISMISS_ALL_SUCCESS' => '알림이 성공적으로 해제되었습니다',
    'LBL_DISMISS_ALL' => '모두 해제',
    'LBL_VERIFY' => '확인',
    'LBL_RESEND' => '재전송',
    'LBL_RECORD_DOES_NOT_EXIST' => '레코드를 검색 하는 중 오류가 발생 했습니다. 이 레코드는 삭제되거나 볼 수 있는 권한이 없어질 수 있습니다.',
    'LBL_PROFILE' => '프로필',
    'LBL_PROFILE_EDIT' => '프로필 편집',
    'LBL_MAILMERGE' => '메일 병합',
    ...
    'LBL_PRIMARY_ADDRESS_STREET_2' => '메인 주소 주소2:',
    'LBL_PRIMARY_ADDRESS_STREET_3' => '메인주소 주소3:',
    'LBL_PRIMARY_ADDRESS_STREET' => '메인 주소 주소:',
    'LBL_PRIMARY_ADDRESS' => '메인 주소:',

    'LBL_PROSPECTS' => '잠재고객',
    'LBL_PRODUCTS' => '제품',
    'LBL_PROJECT_TASKS' => '프로젝트 업무',
    'LBL_PROJECTS' => '프로젝트',
    'LBL_QUOTES' => '견적',
    ...
    'LBL_FILTER' => '검색',
    'LBL_CLEAR_FILTER' => '필터 초기화',
    'LBL_FILTER_MODULES' => '필터 모듈',
    'LBL_SEARCH' => '검색',
    'LBL_SEARCH_ALT' => '',
    'LBL_SEARCH_MORE' => '더보기 ',
...
IE의 호환성 보기 지원 되지 않는 브라우저입니다.',
    ...
    'LBL_PROCESSING_REQUEST' => '처리 중…',
    'LBL_REQUEST_PROCESSED' => '완료',
    'LBL_AJAX_FAILURE' => 'Ajax 실패',
    'LBL_MERGE_DUPLICATES' => '합병',
    ...
    'MSG_JS_ALERT_MTG_REMINDER_CALL' => '호출',
    ...
    'LBL_CREATE_CASE' => '신규사례작성',
    'LBL_CREATE_NOTE' => '노트작성',
    'LBL_CREATE_OPPORTUNITY' => '영업기회 작성',
    'LBL_SCHEDULE_CALL' => '콜스케쥴작성',
    'LBL_SCHEDULE_MEETING' => '미팅스케쥴작성',
    ...
    // fastcgi checks
    'LBL_FASTCGI_LOGGING' => 'IIS/FastCGI sapi을 최적으로 사용하기 위해서, php.ini file 안에 fastcgi.logging 값을 0으로 설정하세요.',
...
"5. 응용 프로그램의 작업 메뉴에서 가져오기 옵션을 클릭하고 업로드할 파일을 선택"   ',
    ...
    'ERR_NOTIFICATIONS_MARK_AS_READ' => '알림을 읽음으로 표시하려는 도중에 오류가 발생하였습니다',
    'ERR_FIELD_LOGIC_BACKEND_CALCULATION' => '값을 가져오는 중 오류가 발생했습니다.',
    'LBL_ALT_SORT_DESC' => '내림차순 정렬',
    'LBL_ALT_SORT_ASC' => '오름차순 정렬',
    'LBL_ALT_SORT' => '정렬',
    'LBL_ALT_SHOW_OPTIONS' => '옵션 표시',
...
신규 생성을 계속 하려면 저장을 누르시고 {0}, 모듈로 돌아가려면 취소를 눌러주세요. {0}',
    ...
    'LBL_DUPLICATE_BUTTON_LABEL' => '복사하기',
    'LBL_DUPLICATE_BUTTON_TITLE' => '복사하기',
    'LBL_DISABLE_USER_2FA' => 'Disable 2FA',
    'LBL_DELETE_BUTTON_KEY' => 'D',
    'LBL_DELETE_BUTTON_LABEL' => '삭제',
    'LBL_DELETE_BUTTON_TITLE' => '삭제',
    'LBL_BULK_ACTION_BUTTON_LABEL' => '일괄 작업',
    'LBL_BULK_ACTION_BUTTON_LABEL_MOBILE' => '액션',
    'LBL_TOO_FEW_SELECTED' => '선택한 레코드 수가 잘못되었습니다. 최소 {min} 개의 레코드를 선택해야 합니다.',
    'LBL_TOO_MANY_SELECTED' => '선택한 레코드 수가 잘못되었습니다. 최대 {max} 개의 레코드를 선택해야 합니다.',
    'LBL_SELECT_ALL_NOT_ALLOWED' => '이 작업에는 모든 레코드를 선택할 수 없습니다. 개별 레코드를 선택해 주세요.',
    'LBL_MISSING_HANDLER_DATA' => '예기치 않은 오류. 응답에 따르면 대량 작업 핸들러 데이터가 누락되었습니다.',
    'LBL_MISSING_HANDLER' => '예기치 않은 오류. 대량 선택 작업에 ​​대해 정의된 핸들러가 없습니다.',
    'LBL_MISSING_HANDLER_DATA_ROUTE' => '예기치 않은 오류. 대량 작업 경로가 누락되었습니다.',
    'LBL_ACTION_ERROR' => '작업을 호출할 때 예기치 않은 오류가 발생했습니다.',
    'LBL_BULK_ACTION_ERROR' => '대량 작업을 호출할 때 예기치 않은 오류가 발생했습니다.',
    'LBL_BULK_ACTION_DELETE_SUCCESS' => '레코드가 성공적으로 삭제되었습니다.',
    'LBL_BULK_ACTION_MASS_UPDATE_CONFIRMATION' => '선택한 레코드를 업데이트하시겠습니까?',
    'LBL_BULK_ACTION_MASS_UPDATE_SUCCESS' => '레코드가 성공적으로 삭제되었습니다.',
    'LBL_BULK_ACTION_MASS_UPDATE_PARTIAL_SUCCESS' => '부분적인 성공. 일부 기록이 업데이트되지 않았습니다. 로그를 확인해주세요',
    'LBL_BULK_ACTION_MASS_UPDATE_NO_FIELDS' => '업데이트할 필드가 없습니다.',
    'LBL_BULK_ACTION_MASS_UPDATE_NO_RECORDS' => '업데이트할 레코드가 없습니다.',
    'LBL_BULK_ACTION_MASS_UPDATE_NO_ACLS' => '권한이 부족하여 저장 작업이 허용되지 않습니다.',
    'LBL_UNEXPECTED_ERROR' => '예기치 않은 오류. 작업을 수행할 수 없습니다.',
    'LBL_RECORD_DELETE_SUCCESS' => '레코드가 성공적으로 삭제되었습니다.',
    'LBL_RECORD_DELETE_ALL_SUCCESS' => '레코드가 성공적으로 삭제되었습니다.',
    'LBL_RECORD_SNOOZE_SUCCESS' => '알림이 일시 중지되었습니다.',
    'LBL_ERROR_SAVING' => '레코드를 저장하는 중 오류가 발생했습니다.',
    ...
    'ANNUAL_REVENUE_BY_ACCOUNTS' => '고객사별 연간 수익',
    'PIPELINE_BY_SALES_STAGE' => '판매 단계 파이프라인',
    'LEADS_BY_SOURCE' => '출처별 잠재 고객',
    'LEADS_BY_STATUS' => '상태별 잠재 고객',
    'ACCOUNT_TYPES_PER_MONTH' => '월별 새로운 고객',
    ...
    'LBL_SUITE_DESC1' => 'SuiteCRM은 <a href="https://salesagility.com"> SalesAgility</a>로 작성 및 재조립되었습니다. 프로그램은 AGPLv3 라이선스하에 있으며 워런티 없이 제공되어 집니다.',
    'LBL_SUITE_DESC2' => '이 프로그램은 프리웨어입니다. 재배포하거나 GNU Affero General Public License version 3 하에서 수정할 수 있습니다.',
    'LBL_SUITE_DESC3' => 'SuiteCRM는 SalesAgility 회사의 상표입니다. 다른 모든 회사 및 제품명은 해당 회사의 상표일 수 있습니다.',
    ...
    'LBL_PROSPECT_LIST_NAME' => '타겟 목록',

    //List View Column Selector Modal
    'LBL_COLUMN_SELECTOR_DISPLAYED_COLS' => '표시됨',
    'LBL_COLUMN_SELECTOR_HIDDEN_COLS' => '숨김',
    'LBL_COLUMN_SELECTOR_CLOSE_BUTTON' => '종료',
    'LBL_COLUMN_SELECTOR_SAVE_BUTTON' => '변경 저장하기',
    'LBL_COLUMN_SELECTOR_MODAL_TITLE' => '열 선택',
...
$app_list_strings['aok_status_list']['Draft'] = '임시 보관';
...
$app_list_strings['fp_event_status_dom']['Accepted'] = '접수완료';
...
$app_list_strings['aor_date_type_list']['hour'] = '시';
...
$app_list_strings['aor_scheduled_report_schedule_types']['monthly'] = '월';
...
$app_list_strings['date_time_period_list']['last_month'] = '지난 달';
$app_list_strings['date_time_period_list']['this_month'] = '이번 달';
...
$app_strings['LBL_CRON_MONTHLY'] = '월';
...
$app_list_strings['quote_stage_dom']['Draft'] = '임시 보관';
...
$app_list_strings['aow_date_type_list']['hour'] = '시';
...
$app_list_strings['duration_unit_dom']['Hours'] = '시';
...
$app_list_strings['marker_image_list']['administration'] = '관리자';
...
$app_strings['LBL_SUBPANEL_FILTER_LABEL'] = '검색';
...
$app_list_strings['survey_status_list']['Draft'] = '임시 보관';
...
$app_list_strings['surveys_question_type']['Radio'] = '라디오광고';
...
$app_strings['LBL_OPT_IN_INVALID'] = '무효';
...
$app_strings['LBL_GOOGLE_SYNC_ERR'] = 'SuiteCRM 구글 동기화 - 오류';
$app_strings['LBL_THERE_WAS_AN_ERR'] = '오류가 발생했습니다: ';
$app_strings['LBL_CLICK_HERE'] = '여기를 클릭';
$app_strings['LBL_TO_CONTINUE'] = ' 계속하기.';
$app_strings['LBL_OPT_OUT'] = '수신거부';
$app_strings['LBL_INVALID_EMAIL'] = '무효';
$app_strings['LBL_PRIMARY'] = '메인';
$app_strings['LBL_EMAIL_ADDRESS'] = '이메일 주소';
...
$app_strings['LBL_INSIGHTS'] = '인사이트';
$app_strings['LBL_CHARTS'] = '챠트';
$app_strings['LBL_CHART_NOT_FOUND'] = '차트를 찾을 수 없습니다.';
$app_strings['LBL_NO_DATA'] = '데이터 없음';
$app_strings['LBL_ERROR_FETCHING_METADATA'] = '메타데이터를 가져오는 도중 오류가 발생했습니다.';
$app_strings['LBL_TOTAL'] = '합계';
$app_strings['LBL_ACTIONS'] = '작업';
$app_strings['LBL_SELECT_SUBPANEL_BANNER'] = '확인할 서브패널을 선택하세요';
$app_strings['LBL_SELECT_ITEM'] = '목록에서 선택';
$app_strings['LBL_ITEMS_SELECTED'] = '선택된 항목';
$app_strings['LBL_WIDGET_NOT_FOUND'] = '위젯을 찾을 수 없습니다';
$app_strings['LBL_BAD_CONFIG'] = '잘못된 구성';
$app_strings['LBL_CONFIG_BAD_CONTEXT'] = '잘못된 구성: 컨텍스트가 올바르게 구성되지 않았습니다.';
$app_strings['LBL_CONFIG_NO_CONFIG'] = '잘못된 구성: 구성이 누락되었습니다';
$app_strings['LBL_CONFIG_NO_STATISTICS_KEY'] = '잘못된 구성: 통계 키가 누락되었습니다.';
$app_strings['LBL_STATISTIC_ERROR'] = '통계를 불러오는 중 오류가 발생했습니다.';
$app_strings['LBL_STATISTIC_ERROR_DESC'] = '통계를 불러오는 중 오류가 발생했습니다.';
$app_strings['LBL_STATISTIC_ERROR_DESC_TOOLTIP'] = '통계를 불러오는 중 오류가 발생했습니다. 관리자에게 문의해 주세요.';
$app_strings['LBL_AVERAGE_CLOSED_WON_PER_YEAR'] = '연간 평균 수주 기회';
$app_strings['LBL_OPPORTUNITIES_TOTAL'] = '총 기회 가치';
$app_strings['LBL_CASE_TOTAL_DAYS_OPEN'] = '총 개장일';
$app_strings['LBL_DAYS_OPEN'] = '개장일';
$app_strings['LBL_DAYS_IN_SALE_STAGE'] = 'DAY(S) THIS OPPORTUNITY HAS BEEN AT THIS SALES STAGE';
$app_strings['LBL_STAT_DAYS'] = '일';
$app_strings['LBL_CLOSED_PER_YEAR'] = '연간 휴무일';
$app_strings['LBL_WAS_OPEN'] = '이 케이스는 다음과 같은 상황에 시행되었습니다.';
$app_strings['LBL_HAS_BEEN_OPEN'] = '이 케이스는 다음과 같은 상황 동안 시행되었습니다.';
$app_strings['LBL_NUMBER_OF_CASES_PER_ACCOUNT'] = '계정 당 케이스의 수';
$app_strings['LBL_TOTAL_CASES_FOR_THIS_ACCOUNT'] = 'Total Cases For This Account';
$app_strings['LBL_NONE_OUTSTANDING'] = '미사용';
$app_strings['LBL_VALIDATION_ERROR_REQUIRED'] = '필수 입력 필드가 누락되었습니다: {{fields.field.label}}';
$app_strings['LBL_VALIDATION_ERROR_CURRENCY_FORMAT'] = "통화 형식이 잘못되었습니다. 예상 형식: '{{context.expected}}'";
$app_strings['LBL_VALIDATION_ERROR_INT_FORMAT'] = "정수 형식이 잘못되었습니다. 예상 형식: '{{context.expected}}'";
$app_strings['LBL_VALIDATION_ERROR_FLOAT_FORMAT'] = "부동 소수점 형식이 잘못되었습니다. 예상 형식: '{{context.expected}}'";
$app_strings['LBL_VALIDATION_ERROR_DATE_FORMAT'] = "유효하지 않은 날짜 형식입니다. 예상 형식: '{{context.expected}}'";
$app_strings['LBL_VALIDATION_ERROR_DATETIME_FORMAT'] = "유효하지 않은 날짜 및 시간 형식입니다. 예상 형식: '{{context.expected}}'";
...
$app_strings['LBL_VALIDATION_ERROR_EMAIL_FORMAT'] = "유효하지 않은 이메일 형식입니다. 예상 형식: '{{context.expected}}'";
$app_strings['LBL_VALIDATION_ERROR_PHONE_FORMAT'] = "유효하지 않은 전화번호 형식";
$app_strings['LBL_VALIDATION_ERROR_MIN'] = "유효하지 않은 값입니다. 값은 '{{context.min}}' 이상이어야 합니다.";
$app_strings['LBL_VALIDATION_ERROR_MAX'] = "유효하지 않은 값입니다. 값은 '{{context.max}}' 이하여야 합니다.";
$app_strings['LBL_MULTIPLE_PRIMARY_EMAIL_VALIDATION_ERROR'] = "Only one Valid Email Address should be marked as primary";
$app_strings['LBL_DUPLICATE_EMAIL_VALIDATION_ERROR'] = "중복된 이메일 주소는 허용되지 않습니다.";
...
$app_strings['LBL_VALIDATION_ERRORS'] = '유효성 검사 오류가 있어 작업을 수행할 수 없습니다.';
$app_strings['LBL_LOADING_IN_PROGRESS'] = '계산이 진행 중입니다. 잠시 기다렸다가 다시 시도해 주세요.';
$app_strings['LBL_SELECT_EMAIL_FOR_TEST'] = 'Please Select Targets/ Users or Enter an Email';
$app_strings['LBL_TYPE_TO_SEARCH'] = '검색어를 입력하세요...';
$app_strings['LBL_SEARCHING'] = '검색 중...';
$app_strings['LBL_NOT_FOUND'] = '검색 결과가 없습니다.';
$app_strings['LBL_SEARCH_ERROR'] = '검색 오류';
$app_strings['LBL_FOUND'] = '검색 결과';
$app_strings['LBL_GET_RECORD_LIST_ERROR'] = '레코드를 검색하는 동안 오류가 발생했습니다';
$app_strings['LBL_NUMBER_OF_RECORDS'] = '레코드의 수';
...
$app_strings['LBL_CONTRACT_RENEWAL_TOOLTIP'] = '다음 계약 갱신 날짜';
$app_strings['LBL_INVOICES_OVERDUE_TOOLTIP'] = '연체된 총 송장 수';
$app_strings['LBL_ACTIVITIES_NEXT_DATE_TOOLTIP'] = '다음 상호작용 날짜';
$app_strings['LBL_CAMPAIGN_LAST_RECEIVED_TOOLTIP'] = '가장 최근에 받은 캠페인 날짜';
$app_strings['LBL_OPEN_CASES_COUNT_TOOLTIP'] = '진행 중인 총 케이스 수';
$app_strings['LBL_EVENTS_LAST_DATE_TOOLTIP'] = '가장 최근 이벤트 날짜';
$app_strings['LBL_HISTORY_LAST_DATE_TOOLTIP'] = '가장 최근 상호작용 날짜';
$app_strings['LBL_OPPORTUNITIES_TOTAL_SUM_TOOLTIP'] = '가능한 경우의 총액';
$app_strings['LBL_QUOTES_EXPIRY_TOOLTIP'] = '다음 견적 만료 날짜';
$app_strings['LBL_DEFAULT_TOTAL_TOOLTIP'] = '총 레코드 수';
$app_strings['LBL_CONTRACT_RENEWAL'] = '갱신 날짜';
$app_strings['LBL_INVOICES_OVERDUE'] = '연체 총액';
$app_strings['LBL_ACTIVITIES_NEXT_DATE'] = '다음 활동 날짜';
$app_strings['LBL_CAMPAIGN_LAST_RECEIVED'] = '최종 참여';
$app_strings['LBL_OPEN_CASES_COUNT'] = '진행 중인 케이스';
$app_strings['LBL_EVENTS_LAST_DATE'] = '마지막으로 관심을 가진 이벤트';
$app_strings['LBL_HISTORY_LAST_DATE'] = '마지막 터치포인트';
$app_strings['LBL_OPPORTUNITIES_TOTAL_SUM'] = '총액';
$app_strings['LBL_QUOTES_EXPIRY'] = '다음 만료 날짜';
$app_strings['LBL_DEFAULT_TOTAL'] = '합계';
$app_strings['AOS_Contracts'] = '계약';
$app_strings['AOS_Quotes'] = '견적';
$app_strings['AOS_Invoices'] = '송장';
$app_strings['LBL_PHOTO'] = '사진';
$app_strings['LBL_CASE_UPDATES'] = '사례 업데이트';
$app_strings['LBL_CASE_UPDATE_SUBMITTED'] = '케이스 업데이트가 제출되었습니다';
...
$app_strings['LBL_CREATE'] = '작성';
$app_strings['LBL_CLEAR_FILTER'] = '필터 초기화';
$app_strings['LBL_QUICK_FILTERS'] = '빠른 필터';
$app_strings['LBL_SAVED_FILTER_SAVED'] = '필터가 성공적으로 저장되었습니다';
$app_strings['LBL_FILTER_ID_NOT_DEFINED'] = '필터가 정의되지 않았습니다';
$app_strings['LBL_GENERIC_CONFIRMATION'] = '작업을 진행하시겠습니까?';
$app_strings['LBL_SHOW_MORE'] = '더 보기';
$app_strings['LBL_SHOW_LESS'] = '간단히 보기';
$app_strings['LBL_LOAD_MORE'] = '더 불러오기';
$app_strings['LBL_EMPTY'] = '-- 비어있습니다 --';
$app_strings['LBL_OPERATOR'] = '운영자';
$app_strings['LBL_START'] = '최초';
$app_strings['LBL_END'] = '최후';
$app_strings['LBL_LINE_ITEMS_FIELD_CONFIG'] = '구성 오류';


$app_strings['LBL_ACTION_SUCCESS'] = '작업 성공';

$app_strings['LBL_YES'] = '예';
$app_strings['LBL_NO'] = '아니오';

$app_list_strings['sort_order'] = [];
$app_list_strings['sort_order']['asc'] = '오름차순';
$app_list_strings['sort_order']['desc'] = '내림차순';

// Labels used by subpanel unlink relationship process
$app_strings['LBL_LINK'] = '링크';
$app_strings['LBL_LINK_UNLINK'] = 'Link / Unlink';
$app_strings['LBL_SAVE'] = '저장';
$app_strings['LBL_UNLINK_RECORD'] = '레코드 링크 해제';
$app_strings['LBL_EDIT_RECORD'] = '레코드 편집';
$app_strings['LBL_UNLINK_RELATIONSHIP_CONFIRM'] = '이 기록의 연결을 해제하시겠습니까? 관계만 해제되고, 기록은 삭제되지 않습니다.';
$app_strings['LBL_UNLINK_RELATIONSHIP_SUCCESS'] = '레코드가 성공적으로 연결 해제되었습니다.';
$app_strings['LBL_UNLINK_RELATIONSHIP_FAILED'] = '이 레코드의 연결을 해제하는 중 오류가 발생하였습니다.';
...
$app_strings['LBL_LINK_RELATIONSHIP_SUCCESS'] = '관계가 성공적으로 연결되었습니다.';
$app_strings['LBL_LINK_RELATIONSHIP_FAILED'] = '이 관계를 연결하는 중 오류가 발생하였습니다.';
$app_strings['LBL_MODULE_NOT_FOUND'] = '모듈을 찾을 수 없습니다.';
$app_strings['LBL_RECORD_NOT_FOUND'] = '레코드를 로드할 수 없습니다.';
$app_strings['LBL_RELATIONSHIP_LOAD_ERROR'] = '관계를 로드할 수 없습니다.';
$app_strings['LBL_NOT_LINKED'] = '링크 해제를 할 수 없습니다. 레코드가 연결되어 있지 않습니다.';
$app_strings['LBL_ACCESS_DENIED'] = '접근 거부';
$app_strings['LBL_ADD_RECORDS_TO_TARGET_LIST_SUCCESS'] = '레코드가 타겟 목록에 성공적으로 추가되었습니다.';
$app_strings['LBL_ADD_RECORDS_TO_TARGET_LIST_FAILED'] = '타겟 목록에 레코드를 추가하는 도중 오류가 발생했습니다.';
$app_strings['LBL_ADD_CONTACTS_TO_TARGET_LIST_SUCCESS'] = '타겟 목록에 연락처가 성공적으로 추가되었습니다.';
$app_strings['LBL_ADD_CONTACTS_TO_TARGET_LIST_FAILED'] = '타겟 목록에 연락처를 추가하는 도중 오류가 발생했습니다.';
$app_strings['LBL_CHANGED_TO_TEXT'] = '다음으로 변경';
$app_strings['LBL_RECORD_CHANGED'] = '레코드가 업데이트되었습니다.';
$app_strings['LBL_CREATE'] = "작성";
$app_strings['LBL_USE_ADVANCED_SEARCH'] = '고급 검색 사용';
$app_strings['LBL_USE_BASIC_SEARCH'] = '기본 검색 사용';
$app_strings['LBL_NO_MODULE_SELECTED'] = '모듈이 선택되지 않았습니다.';
$app_strings['LBL_CLOSE_MENU'] = '메뉴 닫기';
$app_strings['LOGIN_INCORRECT'] = '로그인 자격 증명이 잘못되었습니다. 다시 시도해 주세요.';
$app_strings['LOGIN_TOO_MANY_FAILED'] = '로그인 시도가 너무 많이 실패했습니다. 나중에 다시 시도해 주세요.';
...
$app_strings['LBL_NEW_NOTIFICATION'] = "{{context.unread}} 개의 새 알림이 있습니다";
$app_strings['LBL_NOTIFICATION_ITEM_DATE'] = '기한: {{fields.date_start.value}}';
$app_strings['LBL_NOTIFICATION_ITEM_DATE_ENTERED'] = '알림: {{fields.snooze.value}}';
$app_strings['LBL_QUICK_ACTIONS'] = '빠른 동작';
$app_strings['LBL_RELATIONSHIPS'] = '관계';
$app_strings['LBL_SHOW_CC'] = 'Show Cc';
$app_strings['LBL_SHOW_BCC'] = 'Show Bcc';
$app_strings['LBL_CC'] = '참조';
$app_strings['LBL_BCC'] = '숨은 참조';
$app_strings['LNK_NEW_EMAIL'] = '새로운 이메일';
...
$app_strings['LBL_MEDIUM'] = '중간';
$app_strings['LBL_NORMAL'] = '일반';
$app_strings['LBL_LARGE'] = 'Large';
$app_strings['LBL_HUGE'] = 'Huge';
$app_strings['LBL_DEFAULT'] = '기본값 ';
$app_strings['LBL_APPLY'] = '적용';
...
$app_strings['LBL_QUOTE'] = '견적';
$app_strings['LBL_UNQUOTE'] = 'Unquote';
$app_strings['LBL_ALIGN_LEFT'] = '왼쪽으로';
$app_strings['LBL_ALIGN_CENTER'] = 'Center';
$app_strings['LBL_ALIGN_RIGHT'] = '오른쪽';
...
// Day and Time labels
$app_strings['LBL_SUN'] = '일요일';
$app_strings['LBL_MON'] = '월요일';
$app_strings['LBL_TUE'] = '화요일';
$app_strings['LBL_WED'] = '수요일';
$app_strings['LBL_THU'] = '목요일';
$app_strings['LBL_FRI'] = '금요일';
$app_strings['LBL_SAT'] = '토요일';
$app_strings['LBL_ALL'] = '매일';
$app_strings['LBL_EVERY'] = '모든';
$app_strings['LBL_ON_THE'] = 'On the';
$app_strings['LBL_RANGE'] = '받는 사람';
$app_strings['LBL_FROM'] = '발신자';
$app_strings['LBL_AND'] = '그리고';
$app_strings['LBL_MINS'] = '분';
$app_strings['LBL_MINUTES'] = '분';
$app_strings['LBL_HOUR'] = '시간';
$app_strings['LBL_HOUR_SING'] = '시간';
$app_strings['LBL_OFTEN'] = '가능한 한 자주';
$app_strings['LBL_MIN_MARK'] = '분 표시';
$app_strings['LBL_INBOUND_EMAIL'] = '수신 이메일';
...
$app_strings['LBL_CAMPAIGN_SETTINGS'] = '설정';
