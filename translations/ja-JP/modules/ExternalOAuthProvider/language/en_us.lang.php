...
$mod_strings = [
    ...
    'LBL_REFRESH_TOKEN_REQUEST_OPTIONS' => 'トークン要求オプションのリフレッシュ',

    'LBL_ACCESS_TOKEN_MAPPING' => 'アクセストークンマッピング',
    'LBL_EXPIRES_IN_MAPPING' => 'マッピングで期限切れ',
    'LBL_REFRESH_TOKEN_MAPPING' => 'トークンマッピングのリフレッシュ',
    'LBL_TOKEN_TYPE_MAPPING' => 'トークンタイプのマッピング',
    ...
    'LNK_LIST_CREATE_NEW_PERSONAL' => '新しい個人プロバイダー',
    'LNK_LIST_CREATE_NEW_GROUP' => '新規グループプロバイダー',
    'LNK_LIST_INBOUND_EMAILS' => '受信メールアカウント',
