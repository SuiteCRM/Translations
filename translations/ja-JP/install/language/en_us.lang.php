...
$mod_strings = array(
    ...
    'ERR_CHECKSYS_CONFIG_NOT_WRITABLE' => 'configファイルは存在しますが、書き込み可能ではありません。ファイルを書き込み可能にするために必要な処理を実行してください。',
    'ERR_CHECKSYS_CONFIG_NOT_FOUND' => 'config.phpが存在しません。インストール時に作成されます。',
    'ERR_CHECKSYS_CONFIG_OVERRIDE_NOT_WRITABLE' => 'config overrideファイルは存在しますが、書き込み可能ではありません。ファイルを書き込み可能にするために必要な処理を実行してください。',
    'ERR_CHECKSYS_CUSTOM_NOT_WRITABLE' => 'Customディレクトリは存在しますが、書き込み可能ではありません。ファイルを書き込み可能にするために必要な手順を実行してください。',
    'ERR_CHECKSYS_FILES_NOT_WRITABLE' => "上記のファイルまたはディレクトリは書き込み可能ではないため、作成できません。 ディレクトリを書き込み可能にするために必要な処理を実行してください。",
    'ERR_CHECKSYS_LOGS_NOT_WRITABLE' => 'Logsディレクトリは現在書き込み不可です',
    'ERR_CHECKSYS_CACHE_NOT_WRITABLE' => 'Cacheディレクトリは現在書き込み不可です',
    'ERR_CHECKSYS_EXTENSIONS_NOT_WRITABLE' => 'Extensionsディレクトリは現在書き込み不可です',
    'ERR_CHECKSYS_SECRETS_NOT_WRITABLE' => 'config/secrets ディレクトリは現在書き込み可能ではありません',
    'ERR_CHECKSYS_ENV_NOT_WRITABLE' => '.env ファイルまたはディレクトリが書き込み不可です',
    ...
    'ERR_DB_LOGIN_FAILURE_SHORT' => 'データベース接続エラー: 指定されたデータベースホスト名、ポート、ユーザー名、および/またはパスワードが無効です。',
    ...
    'LBL_CANCEL' => 'キャンセル',
    'LBL_ACCEPT' => '同意します',
    'LBL_CHECKSYS_LEGACY_CACHE' => 'レガシーキャッシュサブディレクトリへの書き込み',
    'LBL_CHECKSYS_CACHE' => 'Cacheサブディレクトリへの書き込み',
    'LBL_CHECKSYS_EXTENSIONS' => 'Extensionsディレクトリへの書き込み',
    'LBL_CHECKSYS_SECRETS' => 'Config/Secretsディレクトリへの書き込み',
    'LBL_CHECKSYS_LOGS' => 'ログディレクトリへの書き込み',
    ...
    'LBL_CHECKSYS_INTL_EXTENSIONS' => 'ExtensionにIntlが存在',
    'LBL_CHECKSYS_JSON_EXTENSIONS' => 'ExtensionにJsonが存在',
    'LBL_CHECKSYS_GD_EXTENSIONS' => 'ExtensionにGDが存在',
    'LBL_CHECKSYS_OPENSSL_EXTENSIONS' => 'ExtensionにOpenSSLが存在',
    'LBL_CHECKSYS_ZIP_EXTENSIONS' => 'ExtensionにZipが存在',
    'LBL_CHECKSYS_PDO_MYSQL_EXTENSIONS' => 'ExtensionにPDO MySQLが存在',
    'LBL_CHECKSYS_CURL_EXTENSIONS' => 'ExtensionにcURLが存在',
    'LBL_CHECKSYS_MBSTRING_EXTENSIONS' => 'ExtensionにMbstringが存在',
    'LBL_CHECKSYS_MYSQLI_EXTENSIONS' => 'ExtensionにMySQLiが存在',
    'LBL_CHECKSYS_SOAP_EXTENSIONS' => 'ExtensionにSoapが存在',
    'LBL_CHECKSYS_XML_EXTENSIONS' => 'ExtensionにXMLが存在',
    'LBL_CHECKSYS_IMAP_EXTENSIONS' => 'ExtensionにIMAPが存在（オプション）
',
    'LBL_CHECKSYS_LDAP_EXTENSIONS' => 'ExtensionにLDAPが存在（オプション）',
    ...
    'ERR_CHECKSYS_INTL' => 'ExtensionにIntlがインストールされていません。システム管理者にお問い合わせください。',
    'ERR_CHECKSYS_JSON' => 'JSONが有効ではありません。システム管理者にお問い合わせください。',
    'ERR_CHECKSYS_GD' => 'GDが有効ではありません。システム管理者にお問い合わせください。',
    'ERR_CHECKSYS_OPENSSL' => 'OpenSSLが有効ではありません。システム管理者にお問い合わせください。',
    'ERR_CHECKSYS_PDO_MYSQL' => 'PDO MySQLが有効ではありません。システム管理者にお問い合わせください。',
    'ERR_CHECKSYS_MYSQLI' => 'MySQLiが有効ではありません。システム管理者にお問い合わせください。',
    'ERR_CHECKSYS_SOAP' => 'Soapが有効ではありません。システム管理者にお問い合わせください。',
    ...
    'LBL_UNWRITABLE_SUB_DIR' => '書き込み不可のサブディレクトリがあります。ディレクトリを書き込み可能にするために必要な処理を実行してください。 ',
    'LBL_REFER_TO_LOGS' => 'プリインストールチェックで問題が発生しました。install.log を参照してください。',
    'LBL_NOT_A_VALID_SUITECRM_PAGE' => 'SuiteCRMのタイトルが見つかりません。これは有効なSuiteCRMページではありません。',
    'LBL_NOT_COOKIE_OR_TOKEN' => 'クッキーが見つかりません。有効なトークンが見つかりません。詳細については install.log を参照してください。',
    'LBL_CURL_JSON_ERROR' => 'graphql ページへの curl の呼び出し結果は空です。',
    'LBL_UNABLE_TO_FIND_SYSTEM_CONFIGS' => 'Graphqlページでシステム設定を取得できません。詳細についてはinstall.logを参照してください。',
    'LBL_CURL_REQUEST_MAIN_PAGE' => 'メインページでのCurlリクエスト',
    'LBL_CURL_REQUEST_API_PAGE' => 'ApiでのCurlリクエスト',
    'LBL_ERROR_DETAILS' => 'エラーの詳細',
    'LBL_ERROR' => 'エラー:',
    'LBL_WARNING_DETAILS' => '警告の詳細',
    'LBL_WARNING' => '注意',
    'LBL_SYSTEM_CHECKS' => 'システムチェック',
    'LBL_CRON_INSTRUCTIONS_1' => 'SuiteCRM スケジューラを実行するには、ウェブサーバのユーザ用のcrontabファイルをコマンド ',
    'LBL_CRON_INSTRUCTIONS_2' => 'で編集し、以下の行をcrontabファイルに追加します:',
    'LBL_CRON_INSTRUCTIONS_3' => 'インストールの終了後にのみこれを行う必要があります。',
    'LBL_CRON_CONFIGURATION' => 'CRON設定',
    'LBL_SETUP_CRONTAB' => 'Crontab設定方法',
    'LBL_ROUTE_ACCESS_CHECK' => 'ルートアクセスチェック',
    'LBL_PHP_MEM_1' => 'PHP Memory Limit: ',
    'LBL_PHP_MEM_2' => ', 必要なメモリ: ',
    'LBL_PHP_MEM_3' => 'M',
    'LBL_CLOSE' => '閉じる',
    'LBL_THREE' => '3',
    ...
    'LBL_APP_NOT_INSTALLED' => 'SuiteCRMがインストールされていません。エントリーポイントは インストールしたSuiteCRM が必要です。最初にインストールしてください。',
    ...
    'LBL_SILENT_INSTALL_SUCCESS' => 'SuiteCRMは正常にインストールされました。',
    'LBL_SILENT_INSTALL_FAILED' => 'SuiteCRM のインストールに失敗しました。',
    ...
    'LBL_PRE_INSTALL_REQ' => 'プリインストール要件',
    'LBL_HIDDEN' => '<i>（非表示）</i>',
    'LBL_STEP1' => '手順 1 / 2 - インストール前の要件',
    'LBL_STEP2' => '手順 2 / 2 - 設定',
    'LBL_STEP' => 'ステップ',
    'LBL_TITLE_WELCOME' => 'SuiteCRMへようこそ',
    'LBL_WELCOME' => 'Ameyo-J x SuiteCRMへようこそ',
...
$contact_user_link_guid',
    ...
    'LBL_SYS_CHECK_WARNING' => 'システムチェック警告を無視',
    'LBL_PROCEED' => '進行中',
    'LBL_RECHECK' => '再チェック',
    'LBL_CONFIG' => '構成',
    'LBL_VALIDATION_ERRORS' => 'バリデーションエラーのためアクションを実行できません。'
);
