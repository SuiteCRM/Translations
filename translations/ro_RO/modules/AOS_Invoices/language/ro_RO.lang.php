...
$mod_strings = array(
    ...
    'ERR_DELETE_RECORD' => 'Un număr de înregistrare trebuie specificat pentru a șterge această organizație.',
    'LBL_ACCOUNT_NAME' => 'Titlu',
    ...
    'LBL_ACCOUNT_INFORMATION' => 'Prezentare generală',
    'LBL_CITY' => 'Oraș:',
    ...
    'LBL_SAVE_ACCOUNT' => 'Salvează contul',
    'LBL_SHIPPING_ADDRESS_CITY' => 'Oraș de livrare:',
    'LBL_SHIPPING_ADDRESS_COUNTRY' => 'Livrare - Țară:',
    'LBL_SHIPPING_ADDRESS_POSTALCODE' => 'Cod poștal de livrare:',
    ...
    'MSG_DUPLICATE' => 'Crearea acestui cont poate crea un alt cont duplicat. Puteți selecta un cont din lista de mai jos sau puteți face clic pe Salvare pentru a continua să creați un cont nou cu datele introduse anterior.',
    'MSG_SHOW_DUPLICATES' => 'Crearea acestui cont poate crea un alt cont duplicat. Puteți fie să faceți clic pe Salvare pentru a continua să creați acest nou cont cu datele introduse anterior, fie să faceți clic pe Anulare.',
    'NTC_DELETE_CONFIRMATION' => 'Sunteți sigur ca doriți sa ștergeți aceasta înregistrare?',
    'LBL_LIST_FORM_TITLE' => 'Listă Facturi',
    'LBL_MODULE_NAME' => 'Facturi',
    'LBL_MODULE_TITLE' => 'Facturi: Start',
    'LBL_HOMEPAGE_TITLE' => 'Facturile Mele',
    'LNK_NEW_RECORD' => 'Creare Factură',
    'LNK_LIST' => 'Vizualizați Facturile',
    'LBL_SEARCH_FORM_TITLE' => 'Caută Facturi',
    'LBL_HISTORY_SUBPANEL_TITLE' => 'Vezi istoric',
    'LBL_NEW_FORM_TITLE' => 'Factură nouă',
    'LBL_TERMS_C' => 'Termeni',
    'LBL_APPROVAL_ISSUE' => 'Probleme de aprobare',
    'LBL_APPROVAL_STATUS' => 'Status Aprobare',
    'LBL_BILLING_ACCOUNT' => 'Cont',
    'LBL_BILLING_CONTACT' => 'Contat',
    'LBL_EXPIRATION' => 'Valabil Până La',
    'LBL_INVOICE_NUMBER' => 'Număr Factură',
    'LBL_OPPORTUNITY' => 'Nume oportunitate',
    'LBL_TEMPLATE_DDOWN_C' => 'Șabloane de facturare',
    'LBL_STAGE' => 'Etapa Ofertei',
    'LBL_TERM' => 'Termeni de Plată',
    'LBL_SUBTOTAL_AMOUNT' => 'Subtotal',
    'LBL_DISCOUNT_AMOUNT' => 'Reducere',
    'LBL_TAX_AMOUNT' => 'Taxa',
    'LBL_SHIPPING_AMOUNT' => 'Livrare',
    'LBL_TOTAL_AMT' => 'Total',
    'VALUE' => 'Titlu',
    'LBL_EMAIL_ADDRESSES' => 'Adrese de email',
    'LBL_LINE_ITEMS' => 'Rând de elemente',
    'LBL_GRAND_TOTAL' => 'Grand Total',
    'LBL_QUOTE_NUMBER' => 'Număr ofertă',
    'LBL_QUOTE_DATE' => 'Dată ofertei',
    'LBL_INVOICE_DATE' => 'Data facturii',
    'LBL_DUE_DATE' => 'Dată Limită',
    'LBL_STATUS' => 'Status',
    'LBL_INVOICE_STATUS' => 'Status Factură',
    ...
    'LBL_VAT' => 'Taxa', //VAT
    'LBL_VAT_AMT' => 'Valoare impozit', //VAT
    ...
    'LBL_REMOVE_PRODUCT_LINE' => 'Elimină',
    'LBL_PRINT_AS_PDF' => 'Tipărește în PDF',
    'LBL_EMAIL_INVOICE' => 'Factură prin e-mail',
    'LBL_LIST_NUM' => 'Număr',
    'LBL_PDF_NAME' => 'Factură',
    'LBL_EMAIL_NAME' => 'Factură pentru',
    'LBL_NO_TEMPLATE' => 'EROARE\nNiciun șablon găsit. Dacă nu ați creat un șablon de factură, accesați modulul de șabloane PDF și creați unul',
    'LBL_SUBTOTAL_TAX_AMOUNT' => 'Subtotal + TVA',//pre shipping
    ...
    'LBL_IMPORT_LINE_ITEMS' => 'Importă elementele pe rând',
    ...
    'LBL_INVOICE_TO' => 'Factură către',
    'LBL_AOS_LINE_ITEM_GROUPS' => 'Grupuri de elemente in linie',
    'LBL_AOS_PRODUCT_QUOTES' => 'Oferte de Produs',
    'LBL_AOS_QUOTES_AOS_INVOICES' => 'Oferte: Facturi',
);
