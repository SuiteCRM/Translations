...
$mod_strings = array(
    ...
    'LBL_ACCOUNT_INFORMATION' => 'Vedere Generală', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
    ...
    'LBL_MODULE_NAME' => 'Companii',
    'LBL_MODULE_TITLE' => 'Conturi: Acasă',
    'LBL_MODULE_ID' => 'Companii',
    'LBL_NAME' => 'Nume',
