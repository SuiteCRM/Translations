...
$mod_strings = array(
    'LBL_MODULE_NAME' => 'Defecte',
    'LBL_MODULE_TITLE' => 'Defecte: Start',
    'LBL_MODULE_ID' => 'Defecte',
    ...
    'LBL_BUG_INFORMATION' => 'Informații prospect', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
