...
//e.g. auf Deutsch 'Contacts'=>'Contakten',
    ...
    'moduleList' => array(
        ...
        'ACLRoles' => 'Roluri',
        'InboundEmail' => 'Intrare conturi de email',
        'Releases' => 'Versiuni',
        'Prospects' => 'Ținte',
...
//       it is the key for the default case_relationship_type_dom value
    ...
    'snooze_alert_timer' => array(
        60 => 'Amână timp de 1 minut',
        300 => 'Amână timp de 2 minute',
        600 => 'Amână timp de 10 minute',
        900 => 'Amână timp de 15 minute',
        1800 => 'Amână timp de 30 minute',
        3600 => 'Amână timp de o ora',
        7200 => 'Amână timp de 2 ore',
        10800 => 'Amână timp de 3 ore',
        18000 => 'Amână timp de 5 ore',
        86400 => 'Amână timp de o zi',
    ),
    ...
    'document_template_type_dom' => array(
        '' => '',
        'mailmerge' => 'Îmbinare corespondență',
        'eula' => 'EULA',
        'nda' => 'NDA',
        'license' => 'Licențiat',
    ),
...
$app_strings = array(
    'LBL_SEARCH_RESULTS_TITLE' => 'Rezultate',
    'ERR_SEARCH_INVALID_QUERY' => 'A apărut o eroare la efectuarea căutării. Sintaxa interogării ar putea să nu fie validă.',
    ...
    'LBL_LOGOUT_SUCCESS' => 'Deconectare cu succes',
    'LBL_LOGGED_OUT_MESSAGE' => 'A-ți fost de-logat',
    'LBL_LOGIN_AGAIN' => 'Pentru a vă reconecta ',
    'LBL_TOUR_NEXT' => 'Următor',
    'LBL_TOUR_SKIP' => 'Omiteți',
    ...
    'LBL_ID_FF_REMOVE' => 'Elimină', /*for 508 compliance fix*/
    ...
    'DEFAULT' => 'Elementar',
    'LBL_SORT' => 'Sortează',
    'LBL_EMAIL_SMTP_SSL_OR_TLS' => 'Activează SMTP prin SSL sau TLS?',
    ...
    'ERR_TIMEOUT' => "Eroare la expirarea timpului limită",
    ...
    'LBL_EMAIL_ASSIGNMENT' => 'Atribuire',
    ...
    'LBL_EMAIL_DELETE_ERROR_DESC' => 'Nu aveți acces la această zonă. Contactați administratorul site-ului dacă sunteți de părere că ar trebui să aveți acces.',
    ...
    'LBL_EMAIL_FOLDERS' => SugarThemeRegistry::current()->getImage('icon_email_folder', 'align=absmiddle border=0', null, null, '.gif', '') . 'Directoare',
    ...
    'LBL_EMAIL_FORWARD' => 'Redirecționare',
    'LBL_EMAIL_DELIMITER' => '::;::',
    ...
    'ERR_UNAUTHORIZED_PAGE_ACCESS' => 'Nu sunteți autorizat să vizualizați această pagină. Contactați administratorul de sistem.',
    'ERR_UNAUTHORIZED_PAGE_ACCESS_TO_HOME_PAGE' => 'Nu sunteți autorizat să vizualizați această pagină. Se redirecționează către pagina de start...',
    ...
    'ERR_NO_SINGLE_QUOTE' => 'Nu se pot folosi ghilimele unice pentru ',
    ...
    'LBL_SUBMIT_BUTTON_LABEL' => 'Trimiteți',
    'LBL_CASE' => 'Caz',
    'LBL_CASES' => 'Cazuri',
    'LBL_CHANGE_PASSWORD' => 'Schimbați parola',
    'LBL_CHARSET' => 'UTF-8',
    'LBL_CHARTS' => 'Grafice',
    'LBL_QUICK_CHARTS' => 'Grafice Rapide',
    'LBL_QUICK_HISTORY' => 'Cronologie',
    ...
    'LBL_OPEN_ITEMS' => 'Deschide Elemente',
    ...
    'LBL_CREATED_BY' => 'Creată de',
    'LBL_CREATED_USER' => 'Creat de utilizator',
    'LBL_CREATED' => 'Creat de',
    'LBL_CURRENT_USER_FILTER' => 'Articolele mele',
    'LBL_CURRENCY' => 'Monedă:',
    ...
    'LBL_LAST_VIEWED_NO_RESULT' => 'Nici-un articol vizualizat recent',
    'LBL_LEADS' => 'Conversii',
    'LBL_LESS' => 'mai puțin',
    ...
    'LBL_LOG_ENTRIES_LINK_TITLE' => 'Faceți clic pe link',
    'LBL_LOG_ENTRIES_VIEWED_TITLE' => 'Mesaj vizualizat',
    'LBL_LOG_ENTRIES_REMOVED_TITLE' => 'A renunțat',
    'LBL_LOG_ENTRIES_LEAD_TITLE' => 'Conversii create',
    'LBL_CAMPAIGN_LEAD_SUBPANEL_TITLE' => 'Conversii, piste',
    'LBL_OPPORTUNITY_SUBPANEL_TITLE' => 'Oportunități',
    ...
    'LBL_CANCEL' => 'Anulați',
    'LBL_SNOOZE' => 'Amână',
    'LBL_SNOOZE_INLINE_CONFIRM' => 'Amânare? ({{preferences.snooze_alert_timer|enum:snooze_alert_timer_simple}})',
    'LBL_DISMISS' => 'Renunță',
    ...
    'LBL_ALERT_DISMISS_ERROR' => 'A apărut o eroare în momentul anulării alertei',
    'LBL_ALERT_DISMISS_ALL_SUCCESS' => 'Alertele s-au dezactivat cu succes',
    'LBL_DISMISS_ALL' => 'Respinge tot',
    'LBL_VERIFY' => 'Verificați',
    'LBL_RESEND' => 'Retrimite',
    'LBL_RECORD_DOES_NOT_EXIST' => 'Eroare de acces la înregistrare. Aceasta este ștearsa sau nu sunteți autorizat să o accesați.',
    'LBL_PROFILE' => 'Profil',
    'LBL_PROFILE_EDIT' => 'Editează profil',
    ...
    'LBL_FILTER' => 'Filtru',
    'LBL_CLEAR_FILTER' => 'Șterge filtrul',
    'LBL_FILTER_MODULES' => 'Filtru module',
    'LBL_SEARCH' => 'Caută',
    'LBL_SEARCH_ALT' => '',
    ...
    'LBL_SELECT_BUTTON_TITLE' => 'Selectează',
    ...
    'LBL_TABGROUP_ACTIVITIES' => 'Activități',
    ...
    'LBL_BASIC_FILTER' => 'Filtru de bază',
    'LBL_QUICK' => 'Repede',
    ...
    'NTC_SNOOZE_CONFIRMATION' => 'Sunteți sigur că doriți să amânați?',
    ...
    'LBL_CREATE_NOTE' => 'Creați Notă',
    'LBL_CREATE_OPPORTUNITY' => 'Creează oportunitate',
    'LBL_SCHEDULE_CALL' => 'Nou apel',
    'LBL_SCHEDULE_MEETING' => 'Programați Întâlnire',
    'LBL_CREATE_TASK' => 'Creare Sarcină',
    //web to lead
    ...
    'LBL_TRAINING' => 'Forum-ul comunității',
    'ERR_MSSQL_DB_CONTEXT' => 'Schimbat context baza de date',
    'ERR_MSSQL_WARNING' => 'Avertisment:',
    ...
    'LBL_DASHLET_CONFIGURE_MY_ITEMS_ONLY' => 'Doar articolele mele',
    'LBL_DASHLET_CONFIGURE_TITLE' => 'Titlu',
    'LBL_DASHLET_CONFIGURE_DISPLAY_ROWS' => 'Afișează rânduri',
    ...
    'LBL_ADDING_DASHLET' => 'Adăugare Dashlet...',
    'LBL_ADDED_DASHLET' => 'Dashlet adăugat în SuiteCRM',
    'LBL_REMOVE_DASHLET_CONFIRM' => 'Sigur doriți sa ștergeți acest Dashlet?',
    'LBL_REMOVING_DASHLET' => 'Se înlătură din SugarCRM un Dashlet...',
    'LBL_REMOVED_DASHLET' => 'Dashlet eliminat din SuiteCRM',
...
"5. Faceți clic pe opțiunea Import din meniul Acțiuni din aplicație și alegeți fișierul pentru a încărca"   ',
    ...
    'ERR_NOTIFICATIONS_MARK_AS_READ' => 'Eroare la încercarea de a marca notificările ca fiind citite',
    'ERR_FIELD_LOGIC_BACKEND_CALCULATION' => 'Eroare la încercarea de a obține valoarea',
    'LBL_ALT_SORT_DESC' => 'Sortați descrescător',
    'LBL_ALT_SORT_ASC' => 'Sortați crescător',
    'LBL_ALT_SORT' => 'Sortează',
    'LBL_ALT_SHOW_OPTIONS' => 'Arată opțiuni',
    'LBL_ALT_HIDE_OPTIONS' => 'Ascunde opțiunile',
    ...
    'LBL_BULK_ACTION_BUTTON_LABEL' => 'Acțiune în masă',
    'LBL_BULK_ACTION_BUTTON_LABEL_MOBILE' => 'Acţiune',
    'LBL_TOO_FEW_SELECTED' => 'Număr invalid de înregistrări selectate. Trebuie să selectați un minim de înregistrări {min}.',
    'LBL_TOO_MANY_SELECTED' => 'Număr nevalid de înregistrări selectate. Trebuie să selectați un maxim de înregistrări {max}.',
    'LBL_SELECT_ALL_NOT_ALLOWED' => 'Selectarea tuturor înregistrărilor nu este disponibilă pentru această acțiune. Vă rugăm să selectați înregistrările individuale.',
    'LBL_MISSING_HANDLER_DATA' => 'Eroare neașteptată. Lipsesc datele gestionarului de acțiuni din răspuns',
    'LBL_MISSING_HANDLER' => 'Eroare neașteptată. Nici un manipulator definit pentru acțiunea în masă selectată',
    'LBL_MISSING_HANDLER_DATA_ROUTE' => 'Eroare neașteptată. Lipsește ruta de acțiune în masă',
    'LBL_ACTION_ERROR' => 'Eroare neașteptată la solicitarea acțiunii',
    'LBL_BULK_ACTION_ERROR' => 'Eroare neașteptată la apelarea Acțiune în bloc',
    'LBL_BULK_ACTION_DELETE_SUCCESS' => 'Înregistrarea a fost ștearsă cu succes ()',
    'LBL_BULK_ACTION_MASS_UPDATE_CONFIRMATION' => 'Sunteți sigur că doriți să ștergeți copia (copiile) de rezervă selectate?',
    'LBL_BULK_ACTION_MASS_UPDATE_SUCCESS' => 'Înregistrare (sau înregistrările) ștearsă cu succes',
    'LBL_BULK_ACTION_MASS_UPDATE_PARTIAL_SUCCESS' => 'Reușita este parțială. Unele înregistrări nu au fost actualizate. Vă rugăm să verificați jurnalul',
    'LBL_BULK_ACTION_MASS_UPDATE_NO_FIELDS' => 'Niciun câmp de actualizat',
    'LBL_BULK_ACTION_MASS_UPDATE_NO_RECORDS' => 'Nu există înregistrări de actualizat',
    'LBL_BULK_ACTION_MASS_UPDATE_NO_ACLS' => 'Privilegiu insuficient, salvarea acțiunii nu este permisă',
    'LBL_UNEXPECTED_ERROR' => 'Eroare neașteptată. Nu se poate efectua acțiunea.',
    'LBL_RECORD_DELETE_SUCCESS' => 'Înregistrare ștearsa cu succes',
    'LBL_RECORD_DELETE_ALL_SUCCESS' => 'Înregistrări șterse cu succes',
    'LBL_RECORD_SNOOZE_SUCCESS' => 'Notificare amânată',
    'LBL_ERROR_SAVING' => 'A apărut o eroare la salvarea înregistrării',
    ...
    'ANNUAL_REVENUE_BY_ACCOUNTS' => 'Venituri anuale pe Conturi',
    'PIPELINE_BY_SALES_STAGE' => 'Conducta pe stadiu vânzări',
    'LEADS_BY_SOURCE' => 'Conversii după sursă',
    'LEADS_BY_STATUS' => 'Conversie după stare',
    'ACCOUNT_TYPES_PER_MONTH' => 'Conturi noi pe lună',
    ...
    'LBL_SUITE_DESC1' => 'SuiteCRM a fost scris și asamblat de <a href="https://salesagility.com"> SalesAgility </a>. Programul este furnizat ca atare, fără garanție. Licențiată în conformitate cu AGPLv3.',
    ...
    'LBL_SUITE_DESC3' => 'SuiteCRM este o marcă înregistrată a SalesAgility Ltd. Toate celelalte nume de companii și produse pot fi mărci comerciale ale companiilor respective cu care sunt asociate.',
    ...
    'LBL_PROSPECT_LIST_NAME' => 'Lista de ținte',

    //List View Column Selector Modal
    'LBL_COLUMN_SELECTOR_DISPLAYED_COLS' => 'DISPONIBIL',
    'LBL_COLUMN_SELECTOR_HIDDEN_COLS' => 'ASCUNS',
    'LBL_COLUMN_SELECTOR_CLOSE_BUTTON' => 'Închide',
    'LBL_COLUMN_SELECTOR_SAVE_BUTTON' => 'Salvați Schimbări',
    'LBL_COLUMN_SELECTOR_MODAL_TITLE' => 'Alege Coloane',
    ...
    'LBL_ENABLE' => 'Activează',
    'LBL_ENABLED' => 'Activat',
    'LBL_DISABLE' => 'Dezactivează',
...
$app_list_strings['date_time_period_list']['today'] = 'Astăzi';
...
$app_list_strings['moduleList']['AOS_Line_Item_Groups'] = 'Grupuri de elemente in linie';
...
$app_list_strings['moduleList']['SurveyQuestionResponses'] = 'Răspunsuri la întrebarea sondajului';
$app_list_strings['moduleList']['SurveyQuestions'] = 'Întrebări Sondaj';
...
$app_strings['LBL_GOOGLE_SYNC_ERR'] = 'Eroare la sincronizarea SuiteCRM cu Google';
...
$app_strings['LBL_OPT_OUT'] = 'Renunță';
$app_strings['LBL_INVALID_EMAIL'] = 'Invalid';
$app_strings['LBL_PRIMARY'] = 'Primar';
$app_strings['LBL_EMAIL_ADDRESS'] = 'Adresă Email';
...
$app_strings['LBL_INSIGHTS'] = 'Perspectivă';
$app_strings['LBL_CHARTS'] = 'Grafice';
$app_strings['LBL_CHART_NOT_FOUND'] = 'Graficul nu a fost găsit';
$app_strings['LBL_NO_DATA'] = 'Nu există date';
$app_strings['LBL_ERROR_FETCHING_METADATA'] = 'A apărut o eroare la preluarea metadatelor';
$app_strings['LBL_TOTAL'] = 'Total';
$app_strings['LBL_ACTIONS'] = 'Acțiune';
$app_strings['LBL_SELECT_SUBPANEL_BANNER'] = 'Selectați sub-panourile pe care le doriți vizibile';
$app_strings['LBL_SELECT_ITEM'] = 'Selectați un element';
$app_strings['LBL_ITEMS_SELECTED'] = 'articole selectate';
$app_strings['LBL_WIDGET_NOT_FOUND'] = 'Widget negăsit';
$app_strings['LBL_BAD_CONFIG'] = 'Configurare incorectă';
$app_strings['LBL_CONFIG_BAD_CONTEXT'] = 'Configurare incorecta: contextul nu este configurat corect';
$app_strings['LBL_CONFIG_NO_CONFIG'] = 'Configurare incorecta: lipsește configurația';
$app_strings['LBL_CONFIG_NO_STATISTICS_KEY'] = 'Configurare incorecta: cheie statistică lipsă';
$app_strings['LBL_STATISTIC_ERROR'] = 'Eroare la încărcarea statisticilor';
$app_strings['LBL_STATISTIC_ERROR_DESC'] = 'Eroare la încărcarea statisticilor';
$app_strings['LBL_STATISTIC_ERROR_DESC_TOOLTIP'] = 'Eroare la încărcarea statisticilor. Vă rugăm să contactați administratorul';
$app_strings['LBL_AVERAGE_CLOSED_WON_PER_YEAR'] = 'Număr mediu de oportunități câștigate pe an';
$app_strings['LBL_OPPORTUNITIES_TOTAL'] = 'Valoarea cumulată a oportunităților';
$app_strings['LBL_CASE_TOTAL_DAYS_OPEN'] = 'Număr total de zile lucrătoare';
$app_strings['LBL_DAYS_OPEN'] = 'Zile lucrătoare';
$app_strings['LBL_DAYS_IN_SALE_STAGE'] = 'DAY(S) THIS OPPORTUNITY HAS BEEN AT THIS SALES STAGE';
$app_strings['LBL_STAT_DAYS'] = 'Zi (zile)';
$app_strings['LBL_CLOSED_PER_YEAR'] = 'Închise pe an';
$app_strings['LBL_WAS_OPEN'] = 'Acest caz a fost deschis pentru';
$app_strings['LBL_HAS_BEEN_OPEN'] = 'Acest caz a fost deschis pentru';
$app_strings['LBL_NUMBER_OF_CASES_PER_ACCOUNT'] = 'Numărul de cazuri pe Cont';
$app_strings['LBL_TOTAL_CASES_FOR_THIS_ACCOUNT'] = 'Total Cases For This Account';
$app_strings['LBL_NONE_OUTSTANDING'] = 'Niciun';
$app_strings['LBL_VALIDATION_ERROR_REQUIRED'] = 'Lipsește câmpul obligatoriu: {{fields.field.label}}';
$app_strings['LBL_VALIDATION_ERROR_CURRENCY_FORMAT'] = "Format monedă invalid. Formatul este: '{{context.expected}}'";
$app_strings['LBL_VALIDATION_ERROR_INT_FORMAT'] = "Format întreg invalid. Formatul este: '{{context.expected}}'";
$app_strings['LBL_VALIDATION_ERROR_FLOAT_FORMAT'] = "Format de număr zecimal nevalid. Se aștepta: '{{context.expected}}'";
$app_strings['LBL_VALIDATION_ERROR_DATE_FORMAT'] = "Format de dată nevalid. Așteptat: '{{context.expected}}'";
$app_strings['LBL_VALIDATION_ERROR_DATETIME_FORMAT'] = "Format dată nevalid. Așteptat: '{{context.expected}}'";
...
$app_strings['LBL_VALIDATION_ERROR_EMAIL_FORMAT'] = "Format nevalid de e-mail. Așteptat: '{{context.expected}}'";
$app_strings['LBL_VALIDATION_ERROR_PHONE_FORMAT'] = "Număr de telefon invalid.";
$app_strings['LBL_VALIDATION_ERROR_MIN'] = "Valoare invalidă. Valoarea trebuie să fie mai mare sau egală cu '{{context.min}}'";
$app_strings['LBL_VALIDATION_ERROR_MAX'] = "Valoare invalidă. Valoarea trebuie să fie mai mică sau egală cu '{{context.max}}'";
$app_strings['LBL_MULTIPLE_PRIMARY_EMAIL_VALIDATION_ERROR'] = "Only one Valid Email Address should be marked as primary";
$app_strings['LBL_DUPLICATE_EMAIL_VALIDATION_ERROR'] = "Duplicat adresele de e-mail nu sunt permise";
...
$app_strings['LBL_VALIDATION_ERRORS'] = 'Există erori de validare, nu se poate efectua operațiunea.';
$app_strings['LBL_LOADING_IN_PROGRESS'] = 'Calculul este în desfășurare, te rugăm să aștepți câteva momente înainte de a încerca din nou.';
$app_strings['LBL_SELECT_EMAIL_FOR_TEST'] = 'Please Select Targets/ Users or Enter an Email';
$app_strings['LBL_TYPE_TO_SEARCH'] = 'Tastați pentru a căuta...';
$app_strings['LBL_SEARCHING'] = 'se caută...';
$app_strings['LBL_NOT_FOUND'] = 'Negăsit.';
$app_strings['LBL_SEARCH_ERROR'] = 'Eroare de căutare.';
$app_strings['LBL_FOUND'] = 'Găsit';
$app_strings['LBL_GET_RECORD_LIST_ERROR'] = 'A apărut o eroare în timpul recuperării înregistrărilor';
$app_strings['LBL_NUMBER_OF_RECORDS'] = 'Numărul de înregistrări';
...
$app_strings['LBL_CONTRACT_RENEWAL_TOOLTIP'] = 'Data reînnoirii contractului';
$app_strings['LBL_INVOICES_OVERDUE_TOOLTIP'] = 'Numărul total de facturi restante';
$app_strings['LBL_ACTIVITIES_NEXT_DATE_TOOLTIP'] = 'Data următoarei interacțiuni';
$app_strings['LBL_CAMPAIGN_LAST_RECEIVED_TOOLTIP'] = 'Data celei mai recente campanii primite';
$app_strings['LBL_OPEN_CASES_COUNT_TOOLTIP'] = 'Numărul total de cazuri deschise';
$app_strings['LBL_EVENTS_LAST_DATE_TOOLTIP'] = 'Data celui mai recent eveniment';
$app_strings['LBL_HISTORY_LAST_DATE_TOOLTIP'] = 'Data celei mai recente interacțiuni';
$app_strings['LBL_OPPORTUNITIES_TOTAL_SUM_TOOLTIP'] = 'Suma Totală a Oportunităților';
$app_strings['LBL_QUOTES_EXPIRY_TOOLTIP'] = 'Data expirării următoarei oferte';
$app_strings['LBL_DEFAULT_TOTAL_TOOLTIP'] = 'Numărul total de înregistrări';
$app_strings['LBL_CONTRACT_RENEWAL'] = 'Dată reînnoire';
$app_strings['LBL_INVOICES_OVERDUE'] = 'Total restante';
$app_strings['LBL_ACTIVITIES_NEXT_DATE'] = 'Data următoarei activități';
$app_strings['LBL_CAMPAIGN_LAST_RECEIVED'] = 'Ultima Participare';
$app_strings['LBL_OPEN_CASES_COUNT'] = 'Cazuri deschise';
$app_strings['LBL_EVENTS_LAST_DATE'] = 'Ultimul eveniment la care am participat';
$app_strings['LBL_HISTORY_LAST_DATE'] = 'Ultima interacțiune';
$app_strings['LBL_OPPORTUNITIES_TOTAL_SUM'] = 'Valoare totală';
$app_strings['LBL_QUOTES_EXPIRY'] = 'Data expirării';
$app_strings['LBL_DEFAULT_TOTAL'] = 'Total';
$app_strings['AOS_Contracts'] = 'Contracte';
$app_strings['AOS_Quotes'] = 'Oferte';
$app_strings['AOS_Invoices'] = 'Facturi';
$app_strings['LBL_PHOTO'] = 'Fotografie';
$app_strings['LBL_CASE_UPDATES'] = 'Actualizări de cazuri';
$app_strings['LBL_CASE_UPDATE_SUBMITTED'] = 'Cazul a fost actualizat';
...
$app_strings['LBL_CREATE'] = 'Creați';
$app_strings['LBL_CLEAR_FILTER'] = 'Șterge filtrul';
$app_strings['LBL_QUICK_FILTERS'] = 'Filtru rapid';
$app_strings['LBL_SAVED_FILTER_SAVED'] = 'Varianta mai detaliată';
$app_strings['LBL_FILTER_ID_NOT_DEFINED'] = 'ID filtru nedefinit';
$app_strings['LBL_GENERIC_CONFIRMATION'] = 'Vrei să continui cu acțiunea?';
$app_strings['LBL_SHOW_MORE'] = 'Arată mai mult';
$app_strings['LBL_SHOW_LESS'] = 'Arată mai puțin';
$app_strings['LBL_LOAD_MORE'] = 'Încarcă mai mult';
$app_strings['LBL_EMPTY'] = '-- gol --';
$app_strings['LBL_OPERATOR'] = 'Operator';
$app_strings['LBL_START'] = 'Început';
$app_strings['LBL_END'] = 'Sfârșit';
$app_strings['LBL_LINE_ITEMS_FIELD_CONFIG'] = 'Configurare greșită';


$app_strings['LBL_ACTION_SUCCESS'] = 'Acțiune finalizată cu succes';

$app_strings['LBL_YES'] = 'Da';
$app_strings['LBL_NO'] = 'Nu';

$app_list_strings['sort_order'] = [];
$app_list_strings['sort_order']['asc'] = 'Ascendent';
$app_list_strings['sort_order']['desc'] = 'Descendent';

// Labels used by subpanel unlink relationship process
$app_strings['LBL_LINK'] = 'Legătură';
$app_strings['LBL_LINK_UNLINK'] = 'Link / Unlink';
$app_strings['LBL_SAVE'] = 'Salvează';
$app_strings['LBL_UNLINK_RECORD'] = 'Deconectare înregistrare';
$app_strings['LBL_EDIT_RECORD'] = 'Editare înregistrare';
$app_strings['LBL_UNLINK_RELATIONSHIP_CONFIRM'] = 'Ești sigur că vrei să desfaci link-ul acestei înregistrări? Numai relația va fi desfăcută. Înregistrarea nu va fi ștearsă.';
$app_strings['LBL_UNLINK_RELATIONSHIP_SUCCESS'] = 'Înregistrare deconectată cu succes.';
$app_strings['LBL_UNLINK_RELATIONSHIP_FAILED'] = 'S-a produs o eroare la ștergerea legăturii cu această înregistrare.';
...
$app_strings['LBL_LINK_RELATIONSHIP_SUCCESS'] = 'Relația a fost legată cu succes.';
$app_strings['LBL_LINK_RELATIONSHIP_FAILED'] = 'A apărut o eroare la asocierea acestei relații.';
$app_strings['LBL_MODULE_NOT_FOUND'] = 'Modulul nu a fost găsit.';
$app_strings['LBL_RECORD_NOT_FOUND'] = 'Imposibil de încărcat înregistrarea';
$app_strings['LBL_RELATIONSHIP_LOAD_ERROR'] = 'Imposibil de încărcat relația';
$app_strings['LBL_NOT_LINKED'] = 'Imposibil de deconectat. Înregistrările nu sunt legate';
$app_strings['LBL_ACCESS_DENIED'] = 'Acces interzis';
$app_strings['LBL_ADD_RECORDS_TO_TARGET_LIST_SUCCESS'] = 'Înregistrările au fost adăugate cu succes la lista de destinație.';
$app_strings['LBL_ADD_RECORDS_TO_TARGET_LIST_FAILED'] = 'A apărut o eroare la adăugarea înregistrărilor în lista de destinație.';
$app_strings['LBL_ADD_CONTACTS_TO_TARGET_LIST_SUCCESS'] = 'Contacte adăugate cu succes la lista de țintă.';
$app_strings['LBL_ADD_CONTACTS_TO_TARGET_LIST_FAILED'] = 'A apărut o eroare la adăugarea contactelor în lista de destinație.';
$app_strings['LBL_CHANGED_TO_TEXT'] = 'a fost schimbat în';
$app_strings['LBL_RECORD_CHANGED'] = 'Înregistrare actualizată';
$app_strings['LBL_CREATE'] = "Creați";
$app_strings['LBL_USE_ADVANCED_SEARCH'] = 'Folosiți căutare avansată';
$app_strings['LBL_USE_BASIC_SEARCH'] = 'Folosește căutarea de bază';
$app_strings['LBL_NO_MODULE_SELECTED'] = 'Niciun modul selectat';
$app_strings['LBL_CLOSE_MENU'] = 'Închide meniul';
$app_strings['LOGIN_INCORRECT'] = 'Acreditările de autentificare sunt incorecte, vă rugăm să reîncercați.';
$app_strings['LOGIN_TOO_MANY_FAILED'] = 'Prea multe încercări de conectare nereușite, încercați mai târziu.';
...
$app_strings['LBL_NEW_NOTIFICATION'] = "Aveți {{context.unread}} notificări noi";
$app_strings['LBL_NOTIFICATION_ITEM_DATE'] = 'Scadent: {{fields.date_start.value}}';
$app_strings['LBL_NOTIFICATION_ITEM_DATE_ENTERED'] = 'Notificare: {{fields.snooze.value}}';
$app_strings['LBL_QUICK_ACTIONS'] = 'Acțiuni rapide';
$app_strings['LBL_RELATIONSHIPS'] = 'Relatii';
$app_strings['LBL_SHOW_CC'] = 'Show Cc';
$app_strings['LBL_SHOW_BCC'] = 'Show Bcc';
$app_strings['LBL_CC'] = 'Cc';
$app_strings['LBL_BCC'] = 'Bcc';
$app_strings['LNK_NEW_EMAIL'] = 'Email Nou';
...
$app_strings['LBL_RELATED_TO'] = 'Asociat de';
...
$app_strings['LBL_MEDIUM'] = 'Medie';
$app_strings['LBL_NORMAL'] = 'Normal';
$app_strings['LBL_LARGE'] = 'Large';
$app_strings['LBL_HUGE'] = 'Huge';
$app_strings['LBL_DEFAULT'] = 'Implicit';
$app_strings['LBL_APPLY'] = 'Aplică';
...
$app_strings['LBL_BOLD'] = 'Îngroșat';
$app_strings['LBL_ITALIC'] = 'Înclinat';
...
$app_strings['LBL_QUOTE'] = 'Ofertă';
$app_strings['LBL_UNQUOTE'] = 'Unquote';
$app_strings['LBL_ALIGN_LEFT'] = 'Stânga';
$app_strings['LBL_ALIGN_CENTER'] = 'Center';
$app_strings['LBL_ALIGN_RIGHT'] = 'Dreapta';
...
// Day and Time labels
$app_strings['LBL_SUN'] = 'Duminică';
$app_strings['LBL_MON'] = 'Luni';
$app_strings['LBL_TUE'] = 'Marți';
$app_strings['LBL_WED'] = 'Miercuri';
$app_strings['LBL_THU'] = 'Joi';
$app_strings['LBL_FRI'] = 'Vineri';
$app_strings['LBL_SAT'] = 'Sâmbătă';
$app_strings['LBL_ALL'] = 'In fiecare zi';
$app_strings['LBL_EVERY'] = 'La fiecare';
$app_strings['LBL_ON_THE'] = 'Pe';
$app_strings['LBL_RANGE'] = 'până la';
$app_strings['LBL_FROM'] = 'Expeditor';
$app_strings['LBL_AND'] = 'și';
$app_strings['LBL_MINS'] = 'Min';
$app_strings['LBL_MINUTES'] = 'minute';
$app_strings['LBL_HOUR'] = 'ore';
$app_strings['LBL_HOUR_SING'] = 'oră';
$app_strings['LBL_OFTEN'] = 'Cât se poate de des.';
$app_strings['LBL_MIN_MARK'] = 'marcaj minut';
$app_strings['LBL_INBOUND_EMAIL'] = 'E-mail de intrare';
...
$app_strings['LBL_CAMPAIGN_SETTINGS'] = 'Setări';
...
$app_strings['LBL_INACTIVE'] = 'Inactiv';
...
$app_strings['LBL_UPLOAD'] = 'Încărcați';
