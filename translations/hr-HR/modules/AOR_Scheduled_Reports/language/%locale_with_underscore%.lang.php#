...
$mod_strings = array(
    ...
    'LBL_EMAIL_RECIPIENTS' => 'Primatelji e-pošte:',
    'NTC_DELETE_CONFIRMATION' => 'Jeste li sigurni želite li izbrisati ovaj zapis?',
    'LBL_LIST_FORM_TITLE' => 'Lista planiranih izvještaja',
    'LBL_MODULE_NAME' => 'Planirani izvještaji',
    'LBL_MODULE_TITLE' => 'Planirani izvještaji',
    'LBL_HOMEPAGE_TITLE' => 'Moji planirani izvještaji',
    'LNK_NEW_RECORD' => 'Kreiraj planirane izvještaje',
    'LNK_LIST' => 'Pregledaj planirane izvještaje',
    'LBL_SEARCH_FORM_TITLE' => 'Pretraživanje planiranih izvještaja',
    'LBL_HISTORY_SUBPANEL_TITLE' => 'Pregledaj Povijest',
    'LBL_NEW_FORM_TITLE' => 'Novi planirani izvještaji',
    'LBL_SCHEDULE' => 'Raspored',
    'LBL_AOR_REPORT_NAME' => 'Izvještaji',
    'LBL_SCHEDULED_REPORTS_INFORMATION' => 'Planirani izvještaji',
    'LBL_LAST_RUN' => 'Posljednje pokretanje',
    'LBL_STATUS' => 'Status',
);
