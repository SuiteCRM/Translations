...
$mod_strings = array(
    ...
    'LBL_INVITEE' => 'Informadors Directes',
    ...
    'LBL_NAME' => 'Nom:',
    'LBL_PROSPECT_INFORMATION' => 'Visió general del compte', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
    ...
    'LBL_CAMPAIGN_LIST_SUBPANEL_TITLE' => 'Registre de Campanya',
