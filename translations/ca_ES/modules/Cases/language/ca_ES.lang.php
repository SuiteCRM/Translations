...
$mod_strings = array(
    ...
    'LBL_SUGGESTION_BOX_TITLE' => 'Càrrec',
    ...
    'LBL_CASE_INFORMATION' => 'Visió general del compte', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
