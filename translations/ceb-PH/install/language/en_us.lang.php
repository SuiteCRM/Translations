...
$mod_strings = array(
    ...
    'LBL_SYSOPTS_DB_TITLE' => 'Database Klae',
    'LBL_SYSOPTS_ERRS_TITLE' => 'Palihug kog fix sa mga nag sunod nga mga mali usa ka mo proceed:',
    ...
    'ERR_CHECKSYS_CURL' => 'Wala na kit-an: SuiteCRM Scheduler kay ni dagan na og gamay nga aberya.',
    ...
    'ERR_CHECKSYS_MEM_LIMIT_2' => 'M or dako na imong php.ini file)',
    ...
    'ERR_DB_HOSTNAME' => 'Pangalan sa Host dili dapat blangkohan.',
    'ERR_DB_INVALID' => 'Inbalid database gusto ma pili.',
    ...
    'ERR_DB_NAME' => 'Database pangalan dili ma blankohan.',
    'ERR_DB_MYSQL_DB_NAME_INVALID' => "Database pangalan dili contain a;\\',',' or'.'",
    ...
    'ERR_DBCONF_VALIDATION' => 'Palihug kog fix sa mga nag sunod nga mga mali usa ka mo proceed:',
    ...
    'ERR_ERROR_GENERAL' => 'Ang mga sunod mali asa ma inkawnter:',
    ...
    'ERR_LOG_DIRECTORY_NOT_EXISTS' => 'Log directory provided na dili balid directory.',
    'ERR_LOG_DIRECTORY_NOT_WRITABLE' => 'Log directory provide na dili masulat directory.',
    'ERR_NO_DIRECT_SCRIPT' => 'Dili siya ma able ma prosiso ang script dayun.',
    ...
    'ERR_PERFORM_CONFIG_PHP_1' => 'Dili pwede ma sulatan ang <span class=stop>condig.php</span>file.',
    'ERR_PERFORM_CONFIG_PHP_2' => 'Pwede nimo ma sugdan ang ge instal pamaagi sa manual na buhaton sa config.php file og pasting ang pag konfigura sa ubos paingon sa config.php file. Busa, ikaw<strong> maayung</strong>mag padayun sa sunod na step.',
    'ERR_PERFORM_CONFIG_PHP_3' => 'Nakahinumdom baka na nag buhat og config.php file?',
    'ERR_PERFORM_CONFIG_PHP_4' => 'Pahibalo: Dili pwede mag sulat sa config.php file. Palihug og panigurado nga naa.',
    'ERR_PERFORM_HTACCESS_1' => 'Dili pwede maka sulat sa ',
    'ERR_PERFORM_HTACCESS_2' => ' file.',
    'ERR_PERFORM_HTACCESS_3' => 'Og gusto ka na ma secure imong log file gikan sa accesible via browser, pag buhat og . htaccess file saimong log directory apil ang linya:',
    ...
    'ERR_SESSION_DIRECTORY_NOT_EXISTS' => 'Session directory provided kay dili valid ang directory.',
    'ERR_SESSION_DIRECTORY' => 'Session directory provided kay dili masulatan ang directory.',
    'ERR_SESSION_PATH' => 'Ang Session path kay kailangan og gusto ka ma specified imong kaugalingon.',
    'ERR_SI_NO_CONFIG' => 'Wala nimo ge apil ang config_si.php sa document root, o wala nimo ge klaro $sugar_config_si sa config.php',
    'ERR_SITE_GUID' => 'Ang application ID kay kailangan og imong gusto ma klaro saimong kaugalingon.',
    ...
    'LBL_CHECKSYS_CACHE' => 'Masulatan ang Cache Sub-Directories',
    ...
    'LBL_CHECKSYS_COMPONENT' => 'Mga Komponent',
    'LBL_CHECKSYS_CONFIG' => 'Masulatan SuiteCRM Configuration File (config.php)',
    'LBL_CHECKSYS_CURL' => 'cURL Modyol',
    'LBL_CHECKSYS_CUSTOM' => 'Mamahimong Suwatan nga Kustom nga Direktoryo',
    'LBL_CHECKSYS_DATA' => 'Masulatan ang Data Baylo-Directories',
    'LBL_CHECKSYS_IMAP' => 'IMAP Modyol',
    'LBL_CHECKSYS_FASTCGI' => 'FastCGI',
    'LBL_CHECKSYS_MBSTRING' => 'Modyul sa mga String sa MB',
    'LBL_CHECKSYS_MEM_OK' => 'Sige (walay Undangay)',
    'LBL_CHECKSYS_MEM_UNLIMITED' => 'Sige (Walayhurotay)',
    'LBL_CHECKSYS_MEM' => 'Utlanan sa Memorya sa PHP',
    'LBL_CHECKSYS_MODULE' => 'Masulatan ang Modules Baylo-Directories og Files',
    'LBL_CHECKSYS_NOT_AVAILABLE' => 'Walay Available',
    ...
    'LBL_CHECKSYS_RECHECK' => 'Ipa balik og check',
    'LBL_CHECKSYS_STATUS' => 'Stado',
    'LBL_CHECKSYS_TITLE' => 'Sistem Ipa check og pwede naba',
    ...
    'LBL_CRON_INSTRUCTIONS_3' => 'Imo kining buhaton lamang inig nahuman na ang paginstall.',
    'LBL_CRON_CONFIGURATION' => 'CRON CONFIGURATION',
    'LBL_SETUP_CRONTAB' => 'Para pagSetup sa Crontab',
    ...
    'LBL_CLOSE' => 'Sirado',
    'LBL_THREE' => '3',
    'LBL_CONFIRM_BE_CREATED' => 'nag buhat',
    'LBL_CONFIRM_DB_TYPE' => 'Database Klae',
    'LBL_CONFIRM_NOT' => 'dili',
    'LBL_CONFIRM_TITLE' => 'Kompirma mga setting',
    'LBL_CONFIRM_WILL' => 'pwede',
    'LBL_DBCONF_DB_DROP' => 'Mga Lamesa sa Gihulog',
    'LBL_DBCONF_DB_NAME' => 'Database Pangalan',
    ...
    'LBL_DBCONF_DEMO_DATA' => 'Kadaghanan sa Database apil ang Demo Data?',
    ...
    'LBL_DBCONF_TITLE' => 'Database Pag tugot',
    ...
    'LBL_DISABLED_DESCRIPTION' => 'Ang tig instal kay ready na mag dagan og kausa. Para ligtas ang sukod, na disabled najud gikan sa pag dagan og pila lang ka segundo oras. Og ikaw kay sigurado na eh padagan og balik. palihug adto saimong config.php file og pangita (o plusi) a variable tawag \' installer_locked\' og eh set og \'false;. Ang linya dapat makita sama ani:',
    'LBL_DISABLED_HELP_1' => 'Para sa installation tabang, palihug ko visit sa SuiteCRM',
    ...
    'LBL_DISABLED_TITLE_2' => 'SuiteCRM i-install na ulila najud',
    ...
    'LBL_LICENSE_ACCEPTANCE' => 'Lisenya Pag dawat',
    ...
    'LBL_LICENSE_I_ACCEPT' => 'Dawat',
    'LBL_LICENSE_PRINTABLE' => ' Printable Makita ',
    'LBL_PRINT_SUMM' => 'Ipatik ang Gilangkoban',
    'LBL_LICENSE_TITLE_2' => 'SuiteCRM lisensya',
    'LBL_LICENSE' => 'LICENSE',
    ...
    'LBL_NEXT' => 'Sunod',
    'LBL_NO' => 'Dili',
    'LBL_PERFORM_ADMIN_PASSWORD' => 'Setting makita admin password',
    'LBL_PERFORM_CONFIG_PHP' => 'Magbuhat og SuiteCRM kompermaston file',
    'LBL_PERFORM_CREATE_DB_1' => '<b>Naghimo sa database</b> ',
    'LBL_PERFORM_CREATE_DB_2' => ' <b>sa</b> ',
    'LBL_PERFORM_CREATE_DB_USER' => 'Mag buhat og Database nga username og pasword...',
    'LBL_PERFORM_CREATE_DEFAULT' => 'Magbuhat og default SuiteCRM data',
    'LBL_PERFORM_DEFAULT_SCHEDULER' => 'Nag buhat og default scheduler mga trabahoun',
    'LBL_PERFORM_DEFAULT_USERS' => 'Nag buhat og defauls tinghulamay',
    ...
    'LBL_PERFORM_OUTRO_3' => 'Tanan oras: ',
    'LBL_PERFORM_OUTRO_4' => ' mga segundo.',
    'LBL_PERFORM_OUTRO_5' => 'Hapit-hapit nagamit ang memory: ',
    'LBL_PERFORM_OUTRO_6' => ' bytes.',
    'LBL_PERFORM_SUCCESS' => 'Kalampusan!',
    ...
    'LBL_PERFORM_TITLE' => 'Pakita sa Setup',
    'LBL_PRINT' => 'Print',
    ...
    'LBL_REG_CONF_3' => 'Salamat kaayo nga na register. Tusloka ni og Humana button para maka sulod naka sa SuiteCRM. Kailang paka maka log in og kausa gamit imong username "admin" og password na naka apil na in step 2.',
    'LBL_REG_TITLE' => 'Pa register',

    'LBL_REQUIRED' => '* Apil ang field',
    ...
    'LBL_SITECFG_CUSTOM_ID' => 'Naa kay kaugalingong Application ID',
    ...
    'LBL_SITECFG_CUSTOM_LOG' => 'Gamita ang Custom log Directory',
    ...
    'LBL_SITECFG_SESSION_PATH' => 'Agihan para sa Sesion Directory<br>(dapat siya masulat)',
...
<ul><li>Ang administrador sa database kay gikinahanglang makahimo og mga lamesa ug mga tiggamit ug makasuwat ngadto sa database.</li><li>Mamahimo nimong gikinahanglan ang
    ...
    'LBL_WELCOME_SETUP_WIZARD' => 'Mag set up og Wizard',
...
$contact_user_link_guid',
    ...
    'LBL_DBCONFIG_MSG3_LABEL' => 'Database Pangalan',
