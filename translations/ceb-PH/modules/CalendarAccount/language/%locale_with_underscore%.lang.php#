...
$mod_strings = [
    ...
    // Email opt-in labels
    'LBL_OPT_IN' => 'Opt sa sud',
    'LBL_OPT_IN_PENDING_EMAIL_NOT_SENT' => 'Naghulat sa kompirmasyon sa opt in, Wala napadala ang kompirmasyon sa opt in',
    'LBL_OPT_IN_PENDING_EMAIL_SENT' => 'Naghulat sa kopirmasyon sa opt in, Napadala na ang kompirmasyon sa opt in',
    ...
    'LBL_SYNC_STATUS_IN_PROGRESS' => 'Ge prosiso',
    'LBL_SYNC_STATUS_SUCCESS' => 'Kalampusan',
    'LBL_SYNC_STATUS_WARNING' => 'Pasidaan',
    'LBL_SYNC_STATUS_ERROR' => 'Dili Mao',
