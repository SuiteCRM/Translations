...
$mod_strings = array(
    ...
    'LBL_SYSOPTS_ERRS_TITLE' => 'Los de volgende fouten op alvorens verder te gaan:',
    ...
    'ERR_CHECKSYS_MEM_LIMIT_2' => 'M of lager in je php.ini bestand)',
    ...
    'LBL_REFER_TO_LOGS' => 'Er is een probleem opgetreden bij een van uw pre-installatie controles, raadpleeg de install.log',
    'LBL_NOT_A_VALID_SUITECRM_PAGE' => 'De SuiteCRM titel kan niet worden gevonden. Dit is geen geldige SuiteCRM pagina.',
    'LBL_NOT_COOKIE_OR_TOKEN' => 'Kan cookies niet vinden, geen geldige token gevonden. Raadpleeg het install.log voor meer informatie.',
    'LBL_CURL_JSON_ERROR' => 'Het resultaat van de curl call naar de grafische pagina was leeg.',
    'LBL_UNABLE_TO_FIND_SYSTEM_CONFIGS' => 'Niet in staat om de systeemconfiguratie op te halen op de Graphql pagina. Raadpleeg de install.log voor meer informatie.',
    ...
    'LBL_DISABLED_DESCRIPTION' => 'De installatie is al een keer uitgevoerd. Als veiligheidsmaatregel, is het niet mogelijk de installatie voor een tweede keer uit te voeren. Als u het zeker weer dat u opnieuw de installatie wilt starten, gaat u naar uw config.php bestand en zoek (of voeg toe) een variabele genaamd \'installer_locked\' en zet deze op \'false\'. De regel moet er als volgt uitzien:',
    'LBL_DISABLED_HELP_1' => 'Voor installatie hulp, bezoek de SuiteCRM',
    ...
    'LBL_LICENSE_I_ACCEPT' => 'Accepteer',
    ...
    'LBL_PERFORM_CREATE_DEFAULT' => 'Creëren van standaard SuiteCRM gegevens...',
    ...
    'LBL_SITECFG_CUSTOM_SESSION' => 'Gebruik een eigen sessiemap voor SuiteCRM.',
    ...
    'LBL_SITECFG_URL' => 'URL van de SuiteCRM installatie',
