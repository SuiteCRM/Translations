...
$mod_strings = array(
    ...
    'LBL_SYSOPTS_ERRS_TITLE' => 'يرجى إصلاح الأخطاء التالية قبل متابعة:',
    ...
    'ERR_CHECKSYS_CONFIG_NOT_WRITABLE' => 'ملف التكوين موجود ولكن غير قابل للكتابة. الرجاء اتخاذ الخطوات اللازمة لجعل الملف قابل للكتابة.',
    'ERR_CHECKSYS_CONFIG_NOT_FOUND' => 'Config.php غير موجود. سيتم إنشاء هذا عند التثبيت.',
    'ERR_CHECKSYS_CONFIG_OVERRIDE_NOT_WRITABLE' => 'مِلَفّ التكوين موجود ولكن غير قابل للكتابة. الرجاء اتخاذ الخطوات اللازمة لجعل المِلَفّ قابل للكتابة.',
    'ERR_CHECKSYS_CUSTOM_NOT_WRITABLE' => 'الدليل المخصص موجود ولكن غير قابل للكتابة. يرجى اتخاذ الخطوات اللازمة لجعل المِلَفّ قابل للكتابة.',
    'ERR_CHECKSYS_FILES_NOT_WRITABLE' => "الملفات أو الحافظات المذكورة أعلاه غير قابلة للكتابة أو مفقودة ولا يمكن إنشاؤها. يرجى اتخاذ الخطوات اللازمة لجعل الأدلة قابلة للكتابة.",
    'ERR_CHECKSYS_LOGS_NOT_WRITABLE' => 'دليل السجلات غير قابل للكتابة حاليا',
    'ERR_CHECKSYS_CACHE_NOT_WRITABLE' => 'دليل ذاكرة التخزين المؤقت غير قابل للكتابة حاليا',
    'ERR_CHECKSYS_EXTENSIONS_NOT_WRITABLE' => 'دليل الملحقات غير قابل للكتابة حاليا',
    'ERR_CHECKSYS_SECRETS_NOT_WRITABLE' => 'دليل الإعداد/الأسرار غير قابل للكتابة حاليا',
    'ERR_CHECKSYS_ENV_NOT_WRITABLE' => 'مِلَفّ .env أو الحافظة التي تحتوي عليه غير قابل للكتابة.',
    ...
    'LBL_CANCEL' => 'إلغاء',
    'LBL_ACCEPT' => 'موافق',
    'LBL_CHECKSYS_LEGACY_CACHE' => 'دلائل ذاكرة التخزين المؤقت القديمة',
    'LBL_CHECKSYS_CACHE' => 'ذاكرة التخزين المؤقتة (Cache) الخاصة بالمجلد الفرعي قابلة للكتابة',
    'LBL_CHECKSYS_EXTENSIONS' => 'دليل الملحقات القابلة للكتابة',
    'LBL_CHECKSYS_SECRETS' => 'حافظة اعدادات/الأسرار قابلة للكتابة',
    'LBL_CHECKSYS_LOGS' => 'دليل سجل الكتابة',
    ...
    'LBL_CHECKSYS_ENV' => 'قابل للكتابة .env',
    ...
    'LBL_CHECKSYS_INTL_EXTENSIONS' => 'Intl موجود في الملحقات',
    'LBL_CHECKSYS_JSON_EXTENSIONS' => 'Json موجود في الملحقات',
    'LBL_CHECKSYS_GD_EXTENSIONS' => 'GD موجود في ملحقات',
    'LBL_CHECKSYS_OPENSSL_EXTENSIONS' => 'OpenSSL موجود في الملحقات',
    'LBL_CHECKSYS_ZIP_EXTENSIONS' => 'Zip موجود في الملحقات',
    'LBL_CHECKSYS_PDO_MYSQL_EXTENSIONS' => 'PDO MySQL موجود بالملحقات',
    'LBL_CHECKSYS_CURL_EXTENSIONS' => 'curl موجود بالملحقات',
    'LBL_CHECKSYS_MBSTRING_EXTENSIONS' => 'MB strings موجود بالملحقات',
    'LBL_CHECKSYS_MYSQLI_EXTENSIONS' => 'MySQLi موجود بالملحقات',
    'LBL_CHECKSYS_SOAP_EXTENSIONS' => 'Soap موجود بالملحقات',
    'LBL_CHECKSYS_XML_EXTENSIONS' => 'XML موجود بالملحقات',
    'LBL_CHECKSYS_IMAP_EXTENSIONS' => 'IMAP موجود بالملحقات',
    'LBL_CHECKSYS_LDAP_EXTENSIONS' => 'LDAP موجود بالملحقات',
    'LBL_PHP_CHECKS' => 'تدقيق PHP',
    'LBL_SERVER_CHECKS' => 'تدقيق الخادم',
    'LBL_PERMISSION_CHECKS' => 'تدقيق الصلاحيات',
    'LBL_CHECK_FAILED' => 'فشل التدقيق: ',
    'ERR_CHECKSYS_INTL' => 'لم يتم تثبيت الإضافة Intl ، يرجى الاتصال بمسؤول النظام الخاص بك',
    'ERR_CHECKSYS_JSON' => 'لم يتم تمكين ملحق JSON، الرجاء الاتصال بمدير النظام.',
    'ERR_CHECKSYS_GD' => 'لم يتم تمكين ملحق GD، الرجاء الاتصال بمدير النظام.',
    'ERR_CHECKSYS_OPENSSL' => 'لم يتم تمكين ملحق OpenSSL ، يرجى الاتصال بمدير النظام.',
    'ERR_CHECKSYS_PDO_MYSQL' => 'لم يتم تمكين ملحق PDO MySQL، يرجى الاتصال بمدير النظام.',
    'ERR_CHECKSYS_MYSQLI' => 'لم يتم تمكين ملحق MySQLi ، يرجى الاتصال بمدير النظام.',
    'ERR_CHECKSYS_SOAP' => 'لم يتم تمكين ملحق Soap، يرجى الاتصال بمسؤول النظام.',
    ...
    'LBL_UNWRITABLE_SUB_DIR' => 'هناك بعض الدلائل الفرعية غير قابلة للكتابة. يرجى اتخاذ الخطوات اللازمة لجعل الدلائل قابلة للكتابة ',
    'LBL_REFER_TO_LOGS' => 'حدثت مشكلة في أحد عمليات التحقق السابقة للتثبيت الخاصة بك، يرجى الرجوع إلى install.log',
    'LBL_NOT_A_VALID_SUITECRM_PAGE' => 'لا يمكن العثور على عنوان SuiteCRM. هذه ليست صفحة SuiteCRM صالحة.',
    'LBL_NOT_COOKIE_OR_TOKEN' => 'لا يمكن العثور على ملفات تعريف الارتباط، لا يوجد رمز صالح. الرجاء الرجوع إلى install.log لمزيد من المعلومات.',
    'LBL_CURL_JSON_ERROR' => 'وكانت نتيجة استدعاء Curl إلى صفحة الرسم البياني فارغة.',
    'LBL_UNABLE_TO_FIND_SYSTEM_CONFIGS' => 'غير قادر على استرداد إعدادات النظام على صفحة Graphql. الرجاء الرجوع إلى install.log لمزيد من المعلومات.',
    'LBL_CURL_REQUEST_MAIN_PAGE' => 'طلب Curl في الصفحة الرئيسية',
    'LBL_CURL_REQUEST_API_PAGE' => 'طلب Curl في Api',
    'LBL_ERROR_DETAILS' => 'تفاصيل الخطأ',
    'LBL_ERROR' => 'خطأ',
    'LBL_WARNING_DETAILS' => 'تفاصيل التحذير',
    'LBL_WARNING' => 'تحذير',
    'LBL_SYSTEM_CHECKS' => 'مراجعة النظام',
    'LBL_CRON_INSTRUCTIONS_1' => 'من أجل تشغيل جدولة SuiteCRM ، قم بتعديل ملف سيرفر الويب الخاص بك مستخدمي crontab مع هذا الأمر:',
    'LBL_CRON_INSTRUCTIONS_2' => 'وإضافة السطر التالي إلى ملف الـ crontab:',
    'LBL_CRON_INSTRUCTIONS_3' => 'يجب عليك القيام بذلك فقط بعد انتهاء التثبيت.',
    'LBL_CRON_CONFIGURATION' => 'اعدادات CRON',
    'LBL_SETUP_CRONTAB' => 'لإعداد نظام جدولة العمليات (Crontab)',
    'LBL_ROUTE_ACCESS_CHECK' => 'التحقق من الوصول إلى المسار',
    'LBL_PHP_MEM_1' => 'حد ذاكرة PHP الخاص بك هو ',
    'LBL_PHP_MEM_2' => '. يجب أن يكون هذا الحد الأدنى ',
    'LBL_PHP_MEM_3' => 'M للمتابعة.',
    'LBL_CLOSE' => 'إغلاق',
    'LBL_THREE' => '٣',
    ...
    'LBL_DISABLED_DESCRIPTION_3' => 'بعد إجراء هذا التغيير، يرجى مراجعة / إعادة تحميل هذه الصفحة للمتابعة.',
    ...
    'LBL_PRE_INSTALL_REQ' => 'متطلبات ما قبل التثبيت',
    'LBL_HIDDEN' => '<i>(مخفي)</i>',
