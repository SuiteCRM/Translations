...
$mod_strings = array(
    ...
    'LBL_MODULE_TITLE' => 'دمج السجلات: الرئيسية',
    'LBL_SEARCH_FORM_TITLE' => 'بحث الدمج',
    ...
    'LBL_NEXT_STEP_TITLE' => 'الانتقال إلى الخطوة التالية',
    ...
    'LBL_PROCEED' => 'متابعة؟',
    'LBL_STEP1_DIRECTIONS' => 'البحث عن سجلات مكررة محتملة. إذا تم العثور على احتمالات تكرار، يمكنك تحديد أي السجلات يتم دمجها مع السجل الحالي.',
);
