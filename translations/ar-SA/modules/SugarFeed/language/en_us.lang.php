...
$mod_strings = array(
    ...
    'LBL_TIME_AGO' => 'مضت',
// Activity stream
    'CREATED_CONTACT' => 'أنشأ {0} <b>جديد</b>', // For fusional (inflected) languages: used in the sentence "Administrator created a new contact"
    'CREATED_OPPORTUNITY' => 'أنشأ {0} <b>جديد</b>', // For fusional (inflected) languages: used in the sentence "Administrator created a new opportunity"
    'CREATED_CASE' => 'أنشأ {0} <b>جديد</b>', // For fusional (inflected) languages: used in the sentence "Administrator created a new case"
    'CREATED_LEAD' => 'أنشأ {0} <b>جديد</b>', // For fusional (inflected) languages: used in sentence "Administrator created a new lead"
