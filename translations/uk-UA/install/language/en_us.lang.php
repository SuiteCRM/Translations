...
$mod_strings = array(
    ...
    'LBL_SYSOPTS_ERRS_TITLE' => 'Будь ласка, виправте наступні помилки:',
    ...
    'ERR_CHECKSYS_CONFIG_NOT_WRITABLE' => 'Файл конфігурації існує, але він не доступний для запису. Будь ласка, виконайте необхідні кроки для того, щоб зробити його доступним для запису.',
    'ERR_CHECKSYS_CONFIG_NOT_FOUND' => 'Ваш файл config.php не існує. Він буде створений при установці.',
    'ERR_CHECKSYS_CONFIG_OVERRIDE_NOT_WRITABLE' => 'Файл перевизначення конфігурації існує, але він не доступний для запису. Будь ласка, виконайте необхідні кроки для того, щоб зробити його доступним для запису. ',
    'ERR_CHECKSYS_CUSTOM_NOT_WRITABLE' => 'Користувацька тека існує, але не доступна для запису. Будь ласка, виконайте необхідні кроки для того, щоб зробити її доступною для запису.',
    'ERR_CHECKSYS_FILES_NOT_WRITABLE' => "Перераховані файли або теки не доступні для запису, не існують або не можуть бути створені. Будь ласка, виконайте необхідні кроки для того, щоб зробити теки доступними для запису.",
    'ERR_CHECKSYS_LOGS_NOT_WRITABLE' => 'Тека файлів з журналами в даний час не доступна для запису',
    'ERR_CHECKSYS_CACHE_NOT_WRITABLE' => 'Тека кешу наразі не доступна для запису',
    'ERR_CHECKSYS_EXTENSIONS_NOT_WRITABLE' => 'Тека розширень наразі не доступна для запису',
    'ERR_CHECKSYS_SECRETS_NOT_WRITABLE' => 'Тека config/secrets в даний час недоступна для запису',
    'ERR_CHECKSYS_ENV_NOT_WRITABLE' => 'Файл .env або тека з ним недоступні для запису.',
    ...
    'ERR_DB_LOGIN_FAILURE_SHORT' => 'Помилка з\'єднання бази даних, зазначене ім\'я сервера, ім\'я користувача або пароль неправильні.',
    ...
    'LBL_ACCEPT' => 'Приймаю',
    'LBL_CHECKSYS_LEGACY_CACHE' => 'Доступні для запису дочірні теки кешу',
    'LBL_CHECKSYS_CACHE' => 'Доступні для запису підпапки папки Cache.',
    'LBL_CHECKSYS_EXTENSIONS' => 'Доступна для запису тека розширень',
    'LBL_CHECKSYS_SECRETS' => 'Доступна для запису тека Config/Secrets',
    'LBL_CHECKSYS_LOGS' => 'Доступна для запису тека файлів з журналами',
    ...
    'LBL_CHECKSYS_ENV' => 'Доступний для запису файл .env',
    ...
    'LBL_CHECKSYS_INTL_EXTENSIONS' => 'Модуль розширення Intl',
    'LBL_CHECKSYS_JSON_EXTENSIONS' => 'Модуль розширення Json',
    'LBL_CHECKSYS_GD_EXTENSIONS' => 'Модуль розширення GD',
    'LBL_CHECKSYS_OPENSSL_EXTENSIONS' => 'Модуль розширення OpenSSL',
    'LBL_CHECKSYS_ZIP_EXTENSIONS' => 'Модуль розширення Zip',
    'LBL_CHECKSYS_PDO_MYSQL_EXTENSIONS' => 'Модуль розширення PDO MySQL',
    'LBL_CHECKSYS_CURL_EXTENSIONS' => 'Модуль розширення cURL',
    'LBL_CHECKSYS_MBSTRING_EXTENSIONS' => 'Модуль розширення MB Strings',
    'LBL_CHECKSYS_MYSQLI_EXTENSIONS' => 'Модуль розширення MySQLi',
    'LBL_CHECKSYS_SOAP_EXTENSIONS' => 'Модуль розширення Soap',
    'LBL_CHECKSYS_XML_EXTENSIONS' => 'Модуль розширення XML',
    'LBL_CHECKSYS_IMAP_EXTENSIONS' => 'Модуль розширення IMAP (необов\'язковий)',
    'LBL_CHECKSYS_LDAP_EXTENSIONS' => 'Модуль розширення LDAP (необов\'язковий)',
    'LBL_PHP_CHECKS' => 'ПЕРЕВІРКИ PHP',
    'LBL_SERVER_CHECKS' => 'ПЕРЕВІРКИ СЕРВЕРА',
    'LBL_PERMISSION_CHECKS' => 'ПЕРЕВІРКИ ДОЗВОЛІВ',
    'LBL_CHECK_FAILED' => 'Перевірка не пройшла: ',
    'ERR_CHECKSYS_INTL' => 'Модуль розширення Intl не встановлено. Будь ласка, зверніться до вашого системного адміністратора',
    'ERR_CHECKSYS_JSON' => 'Модуль розширення JSON не встановлено. Будь ласка, зверніться до системного адміністратора.',
    'ERR_CHECKSYS_GD' => 'Модуль розширення GD не встановлено. Будь ласка, зверніться до системного адміністратора.',
    'ERR_CHECKSYS_OPENSSL' => 'Модуль розширення OpenSSL не встановлено. Будь ласка, зверніться до системного адміністратора.',
    'ERR_CHECKSYS_PDO_MYSQL' => 'Модуль розширення PDO MySQL не встановлено. Будь ласка, зверніться до системного адміністратора.',
    'ERR_CHECKSYS_MYSQLI' => 'Модуль розширення MySQLi не встановлено. Будь ласка, зверніться до системного адміністратора.',
    'ERR_CHECKSYS_SOAP' => 'Модуль розширення Soap не встановлено. Будь ласка, зверніться до системного адміністратора.',
    ...
    'LBL_UNWRITABLE_SUB_DIR' => 'Є деякі вкладені теки, які не доступні для запису. Будь ласка, виконайте необхідні кроки для того, щоб зробити теки доступними для запису ',
    'LBL_REFER_TO_LOGS' => 'Виникла проблема з попередніми перевірками, будь ласка, зверніться до журналу install.log',
    'LBL_NOT_A_VALID_SUITECRM_PAGE' => 'Не вдалося знайти назву SuiteCRM. Ця сторінка не є припустимою сторінкою SuiteCRM.',
    'LBL_NOT_COOKIE_OR_TOKEN' => 'Не вдалося знайти куки, відсутній дійсний маркер авторизації. Будь ласка, зверніться до журналу install.log за додатковою інформацією.',
    'LBL_CURL_JSON_ERROR' => 'Результат виклику curl на сторінку graphql був порожній.',
    'LBL_UNABLE_TO_FIND_SYSTEM_CONFIGS' => 'Не вдалося отримати Системні Конфігурації на сторінці Graphql. Будь ласка, зверніться до журналу install.log за додатковою інформацією.',
    'LBL_CURL_REQUEST_MAIN_PAGE' => 'Запит Curl на головній сторінці',
    'LBL_CURL_REQUEST_API_PAGE' => 'Запит на Curl до Api',
    'LBL_ERROR_DETAILS' => 'Відомості про помилку',
    'LBL_ERROR' => 'Помилка',
    'LBL_WARNING_DETAILS' => 'Деталі попередження',
    'LBL_WARNING' => 'Попередження',
    'LBL_SYSTEM_CHECKS' => 'ПЕРЕВІРКА СИСТЕМИ',
    'LBL_CRON_INSTRUCTIONS_1' => 'Для того, щоб запустити Планувальник SuiteCRM, віредагуйте файл користувача crontab на веб-сервері і додайте таку команду:',
    'LBL_CRON_INSTRUCTIONS_2' => 'додайте наступний рядок до файлу crontab:',
    'LBL_CRON_INSTRUCTIONS_3' => 'Слід зробити це лише після завершення встановлення.',
    'LBL_CRON_CONFIGURATION' => 'НАЛАШТУВАННЯ CRON',
    'LBL_SETUP_CRONTAB' => 'Налаштування сrontab',
    'LBL_ROUTE_ACCESS_CHECK' => 'ПЕРЕВІРКА ДОЗВОЛУ ДО ФАЙЛОВИХ ШЛЯХІВ',
    'LBL_PHP_MEM_1' => 'Обмеження пам`яті PHP ',
    'LBL_PHP_MEM_2' => '. Має бути мінімум ',
    'LBL_PHP_MEM_3' => 'мегабайт для продовження.',
    'LBL_CLOSE' => 'Закрити',
    'LBL_THREE' => '3',
    ...
    'LBL_DBCONF_DB_PORT' => 'Порт бази даних',
    ...
    'LBL_DISABLED_DESCRIPTION_2' => 'Після того, як всі зміни були зроблені, ви можете натиснути на кнопку "Пуск" для початку процесу установки. По закінченні установки, потрібно відключити установник, для цього змініть значення "installer_locked" на true',
    'LBL_DISABLED_DESCRIPTION_3' => 'Після цієї зміни, будь ласка, перезайдіть або перезавантажте цю сторінку, аби продовжити.',
    ...
    'LBL_APP_NOT_INSTALLED' => 'SuiteCRM не встановлено. В точці входу має бути встановлена копія SuiteCRM, будь ласка, спочатку виконайте встановлення.',
    ...
    'LBL_SILENT_INSTALL_SUCCESS' => 'SuiteCRM успішно встановлено.',
    'LBL_SILENT_INSTALL_FAILED' => 'Не вдалося встановити SuiteCRM.',
    ...
    'LBL_PRE_INSTALL_REQ' => 'Попередні вимоги до встановлення',
    ...
    'LBL_WELCOME' => 'Ласкаво просимо в SuiteCRM',
...
$contact_user_link_guid',
    ...
    'LBL_SYS_CHECK_WARNING' => 'Ігнорувати попередження перевірки системи',
    'LBL_PROCEED' => 'ПРОДОВЖИТИ',
    'LBL_RECHECK' => 'ПОВТОРНА ПЕРЕВІРКА',
    'LBL_CONFIG' => 'НАЛАШТУВАННЯ',
    'LBL_VALIDATION_ERRORS' => 'При перевірці були знайдені помилки, дію не вдалося виконати.'
);
