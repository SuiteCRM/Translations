...
$mod_strings = array(
    ...
    'LBL_NEXT_STEP_TITLE' => 'Наступний крок',
    ...
    'LBL_PROCEED' => 'Виконати об&#039;єднання?',
    'LBL_STEP1_DIRECTIONS' => 'Пошук дублюючих записів. Ви зможете вказати записи, які об&#039;єднаються з поточним записом.',
);
