...
$mod_strings = array(
    ...
    'LBL_REMOVE' => 'Видалити',
    'LBL_LIST_FORM_TITLE' => 'Список уподобань',
    'LBL_MODULE_NAME' => 'Обране',
    'LBL_MODULE_TITLE' => 'Обране',
    'LBL_HOMEPAGE_TITLE' => 'Мої вподобання',
    'LNK_NEW_RECORD' => 'Створити уподобання',
    'LNK_LIST' => 'Переглянути вподобання',
    'LBL_SEARCH_FORM_TITLE' => 'Пошук уподобань',
    'LBL_HISTORY_SUBPANEL_TITLE' => 'Історія',
    'LBL_ACTIVITIES_SUBPANEL_TITLE' => 'Заходи',
    'LBL_NEW_FORM_TITLE' => 'Нове улюблене',
    'LBL_MARK_FAVORITE' => 'Позначити як улюблене',
    'LBL_UNMARK_FAVORITE' => 'Зняти позначку',
);
