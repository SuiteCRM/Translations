...
$mod_strings = array(
    ...
    'LBL_ADDITIONAL_INFO' => 'Прийняте рішення',
    ...
    'LBL_MODULE_TITLE' => 'База знань',
    'LBL_HOMEPAGE_TITLE' => 'Моя база знань',
    'LNK_NEW_RECORD' => 'Створити базу знань',
    'LNK_LIST' => 'Перегляд бази знань',
    'LBL_SEARCH_FORM_TITLE' => 'Пошук в базі знань',
    'LBL_HISTORY_SUBPANEL_TITLE' => 'Історія',
    'LBL_ACTIVITIES_SUBPANEL_TITLE' => 'Заходи',
    'LBL_NEW_FORM_TITLE' => 'Нова база знань',
    'LBL_STATUS' => 'Статус',
    'LBL_REVISION' => 'Ревізія',
    'LBL_AUTHOR_USER_ID' => 'Автор (ID пов\'язаного Користувача)',
    'LBL_AUTHOR' => 'Автор',
    'LBL_APPROVER_USER_ID' => 'Затверджувач (ID пов’язаного Користувача)',
    'LBL_APPROVER' => 'Затверджуюча особа',
);

$mod_strings['LBL_AOK_KB_CATEGORIES_TITLE'] = 'Категорії';
