...
$app_strings = array(
    ...
    'LBL_LAST_VIEWED_NO_RESULT' => 'Тут буде перелік нещодавно переглянутих елементів, а зараз тут порожньо',
...
$app_strings['LBL_SEARCH_RESULTS_PER_PAGE']        = 'Результатів на сторінку: ';
...
$app_strings['LBL_DAYS_IN_SALE_STAGE'] = 'Ця Можливість була в цій стадії продажів протягом';
...
$app_strings['LBL_TOTAL_CASES_FOR_THIS_ACCOUNT'] = 'Загальна кількість Звернень для цього Контрагенту: ';
...
$app_strings['LBL_MULTIPLE_PRIMARY_EMAIL_VALIDATION_ERROR'] = "Тільки одна адреса електронної пошти може бути позначена як основна";
$app_strings['LBL_DUPLICATE_EMAIL_VALIDATION_ERROR'] = "Не можна використовувати адресу електронної пошти одну й ту саму двічі";
$app_strings['LBL_NO_PRIMARY_EMAIL_VALIDATION_ERROR'] = "Одна адреса електронної пошти обов'язково має бути позначена як основна";
...
$app_strings['LBL_EMPTY'] = '-- Тут нічого немає -- ';
$app_strings['LBL_OPERATOR'] = 'Оператор';
$app_strings['LBL_START'] = 'Початок';
