...
//e.g. auf Deutsch 'Contacts'=>'Contakten',
    ...
    'moduleList' => array(
        ...
        'ACLRoles' => 'Roolit',
        'InboundEmail' => 'Saapuvan Sähköpostin Tilit',
        'Releases' => 'Versiot',
...
//       it is the key for the default case_relationship_type_dom value
    ...
    'snooze_alert_timer' => array(
        60 => 'Torkku 1 minuutiksi',
        300 => 'Torkku 5 minuutiksi',
        600 => 'Torkku 10 minuutiksi',
        900 => 'Torkku 15 minuutiksi',
        1800 => 'Torkku 30 minuutiksi',
        3600 => 'Torkku 1 tunniksi',
        7200 => 'Torkku 2 tunniksi',
        10800 => 'Torkku 3 tunniksi',
        18000 => 'Torkku 5 tunniksi',
        86400 => 'Torkku 1 päiväksi',
    ),
    ...
    'user_factor_auth_interface_dom' => array(
        'FactorAuthEmailCode' => 'Sähköpostin koodi',
    ),
    ...
    'dom_outbound_email_account_types' => [
        'user' => 'Henkilökohtainen',
        'group' => 'Ryhmä',
        'system' => 'Järjestelmä',
        'system-override' => 'Järjestelmän Ohitus',
    ],
    ...
    'dom_email_errors' => array(
        1 => 'Valitse vain yksi käyttäjä, kun määrität suoraan kohteita.',
        2 => 'Sinun tulee määrittää vain tarkistetut kohteet kun kohdistat suoraan kohteita.',
    ),
    ...
    'document_template_type_dom' => array(
        '' => '',
        'mailmerge' => 'Sulauta sähköpostiin',
...
//prospect list type dom
    ...
    'date_range_search_dom' => array(
        ...
        'greater_than' => '&nbsp;',
        'less_than' => 'Ennen',
        'last_7_days' => 'viimeiset 7 pväivää',
        'next_7_days' => 'seuraavat 7 pväivää',
...
$app_strings = array(
    'LBL_SEARCH_RESULTS_TITLE' => 'Tulokset',
    'ERR_SEARCH_INVALID_QUERY' => 'Hakua suorittaessa tapahtui virhe. Haun muotoilu ei välttämättä ole kelvollinen.',
    'ERR_SEARCH_NO_RESULTS' => 'Hakuehtojasi vastaavia tuloksia ei löytynyt. Yritä laajentaa hakuasi.',
    'LBL_SEARCH_PERFORMED_IN' => 'Haku suoritettu',
    'LBL_EMAIL_CODE' => 'Sähköpostikoodi:',
    'LBL_SEND' => 'Lähetä',
    'LBL_SEND_BUTTON_TITLE' => 'Lähetä',
    'LBL_LOGOUT' => 'Kirjaudu ulos',
    'LBL_LOGOUT_SUCCESS' => 'Uloskirjautuminen onnistui',
    'LBL_LOGGED_OUT_MESSAGE' => 'Olet kirjautunut ulos',
    'LBL_LOGIN_AGAIN' => 'Kirjaudu uudelleen ',
    ...
    'LBL_ID_FF_VCARD' => 'Käyntikortti', /*for 508 compliance fix*/
    ...
    'LBL_NO_ACTION' => 'Ei toimintoa tällä nimellä: %s',
    ...
    'LBL_OAUTH_CONNECTION_NOT_SET' => 'Aseta ulkoinen OAuth yhteys.',
    'LBL_EMAIL_PASSWORD_NOT_SET' => 'Varoitus: Salasanaa ei ole asetettu.',
    'LBL_EMAIL_WARNING_MISSING_CREDS' => 'Varoitus: Puuttuvat käyttäjätiedot',
    ...
    'LBL_EMAIL_ADDRESS_BOOK_FILTER' => 'Hae',
    ...
    'LBL_EMAIL_ARCHIVE_TO_SUITE' => 'Tuo SuiteCRM:ään',
    ...
    'LBL_EMAIL_QC_BUGS' => 'Bugien seuranta',
    ...
    'LBL_EMAIL_SETTINGS_FROM_NAME' => 'Lähettäjä -nimi',
    ...
    'LBL_EMAIL_ERROR_PREPEND' => 'Tapahtui sähköpostivirhe:',
    ...
    'LBL_EMAIL_SUITE_FOLDER' => 'SuiteCRM kansiot',
    ...
    'ERR_UNAUTHORIZED_PAGE_ACCESS' => 'Sinulla ei ole oikeutta tarkastella tätä sivua. Ota yhteyttä järjestelmänvalvojaan.',
    'ERR_UNAUTHORIZED_PAGE_ACCESS_TO_HOME_PAGE' => 'Sinulla ei ole oikeutta tarkastella tätä sivua. Uudelleenohjaus etusivulle...',
    ...
    'ERR_NO_DB' => 'Tietokantaan ei saatu yhteyttä. Ole hyvä ja katso suitecrm.log lisätietoja varten (0).',
    ...
    'LBL_CHARSET' => 'UTF-8',
    'LBL_CHARTS' => 'Kuvaajat',
    'LBL_QUICK_CHARTS' => 'Pikakaaviot',
    'LBL_QUICK_HISTORY' => 'Aikajana',
    ...
    'LBL_COMPOSE_EMAIL_BUTTON_LABEL' => 'Luo viesti',
    ...
    'LBL_LAST_VIEWED_NO_RESULT' => 'Ei äskettäin katsottuja kohteita',
    'LBL_LEADS' => 'Liidit',
    'LBL_LESS' => 'vähemmän',
    ...
    'LBL_LOG_ENTRIES_REMOVED_TITLE' => 'Estä lähetys',
    ...
    'LBL_CANCEL' => 'Peruuta',
    'LBL_SNOOZE' => 'Torkku',
    'LBL_SNOOZE_INLINE_CONFIRM' => 'Torkku? ({{preferences.snooze_alert_timer|enum:snooze_alert_timer_simple}})',
    'LBL_DISMISS' => 'Hylkää',
    'LBL_DISMISS_INLINE_CONFIRM' => 'Ohita?',
    'LBL_DISMISS_ALL_INLINE_CONFIRM' => 'Hylkää Kaikki?',
    'NTC_DISMISS_CONFIRMATION' => 'Oletko varma, että haluat hylätä tämän hälytyksen?',
    'NTC_DISMISS_ALL_CONFIRMATION' => 'Oletko varma, että haluat hylätä kaikki hälytykset?',
    'LBL_ALERT_DISMISS_SUCCESS' => 'Hälytys lopetettu onnistuneesti',
    'LBL_ALERT_DISMISS_ERROR' => 'Virhe hälytyksen hylkäämisessä',
    'LBL_ALERT_DISMISS_ALL_SUCCESS' => 'Hälytykset hylätty onnistuneesti',
    'LBL_DISMISS_ALL' => 'Hylkää kaikki',
    'LBL_VERIFY' => 'Vahvista',
    'LBL_RESEND' => 'Lähetä uudestaan',
    'LBL_RECORD_DOES_NOT_EXIST' => 'Virhe haettaessa tietuetta.  Tietue voi olla poistettu tai sinulla ei ole oikeuksia tarkastella tietuetta.',
    'LBL_PROFILE' => 'Profiili',
    'LBL_PROFILE_EDIT' => 'Muokkaa profiilia',
    ...
    'LBL_OPPORTUNITY_NAME' => 'Myyntimahdollisuus',
    'LBL_OPPORTUNITY' => 'Myyntimahdollisuus',
    'LBL_OR' => 'TAI',
    'LBL_PANEL_OVERVIEW' => 'Tietoja asiakkaasta',
    'LBL_PANEL_ASSIGNMENT' => 'MUUT',
    'LBL_PANEL_ADVANCED' => 'LISÄÄ TIETOA',
    ...
    'LBL_REMOVE' => 'Poista',
    'LBL_REPORTS_TO' => 'Raportoi käyttäjälle',
    'LBL_REQUIRED_SYMBOL' => '*',
    ...
    'LBL_FILTER' => 'Hae',
    'LBL_CLEAR_FILTER' => 'Tyhjennä Suodatin',
    'LBL_FILTER_MODULES' => 'Suodata Moduulit',
    'LBL_SEARCH' => 'Etsi',
    'LBL_SEARCH_ALT' => '',
    ...
    'LBL_ACCESSKEY_CLEAR_ACCOUNTS_TITLE' => 'Tyhjennä tili',
    'LBL_ACCESSKEY_CLEAR_ACCOUNTS_LABEL' => 'Tyhjennä tili',
    ...
    'LBL_ACCESSKEY_CLEAR_CONTACTS_TITLE' => 'Tyhjennä yhteystieto',
    'LBL_ACCESSKEY_CLEAR_CONTACTS_LABEL' => 'Tyhjennä yhteystieto',
    ...
    'LBL_TASKS' => 'Katso tehtäviä',
    'LBL_THOUSANDS_SYMBOL' => 'K',
    'LBL_TRACK_EMAIL_BUTTON_LABEL' => 'Arkistoi viesti',
    ...
    'NTC_TEMPLATES_IS_USED' => 'Seuraavia malleja käytetään sähköpostimarkkinointitietueissa. Oletko varma että haluat poistaa ne?' . PHP_EOL,
    ...
    'LBL_SAVING_LAYOUT' => 'Tallennetaan asetelmaa...',
    ...
    'ERROR_JS_ALERT_SYSTEM_CLASS' => 'Järjestelmä',
    ...
    'LBL_SCHEDULE_MEETING' => 'Ajoita kokous',
    ...
    'LBL_DASHLET_CONFIGURE_TITLE' => 'Nimi',
    'LBL_DASHLET_CONFIGURE_DISPLAY_ROWS' => 'Näytä rivit',

    // MySugar status strings
    'LBL_MAX_DASHLETS_REACHED' => 'SuiteCRM-paneelien enimmäismäärä on saavutettu. Poista jokin paneeli lisätäksesi uuden.',
    ...
    'LBL_DATE_LAST_ACTION' => 'Viimeisen tapahtuman pvm',
...
"5. Klikkaa sovelluksen toiminnot-valikosta tuonti-vaihtoehto ja valitse ladattava tiedosto"
   ',
    ...
    'ERR_NOTIFICATIONS_MARK_AS_READ' => 'Virhe ilmoitettaessa ilmoituksia luetuksi',
    'ERR_FIELD_LOGIC_BACKEND_CALCULATION' => 'Arvon hakemisessa tapahtui virhe',
    ...
    'LBL_BULK_ACTION_BUTTON_LABEL' => 'Massatoiminnot',
    'LBL_BULK_ACTION_BUTTON_LABEL_MOBILE' => 'Toiminto',
    'LBL_TOO_FEW_SELECTED' => 'Virheellinen määrä tietueita. Sinun on valittava vähintään {min} tietuetta.',
    'LBL_TOO_MANY_SELECTED' => 'Virheellinen määrä tietueita. Sinun on valittava enintään {max} tietuetta.',
    'LBL_SELECT_ALL_NOT_ALLOWED' => 'Kaikkien tietueiden valitseminen ei ole käytettävissä tälle toiminnalle. Valitse yksittäisiä tietueita.',
    'LBL_MISSING_HANDLER_DATA' => 'Odottamaton virhe. Puuttuvat massatoiminnan käsittelijän tiedot vastauksesta',
    'LBL_MISSING_HANDLER' => 'Odottamaton virhe. Käsittelyä ei ole määritelty valittuun massatoimintoon',
    'LBL_MISSING_HANDLER_DATA_ROUTE' => 'Odottamaton virhe. Puuttuva massatoimintareitti',
    'LBL_ACTION_ERROR' => 'Odottamaton virhe toimintoa suorittaessa',
    'LBL_BULK_ACTION_ERROR' => 'Odottamaton virhe kutsuttaessa massatoimintoa',
    'LBL_BULK_ACTION_DELETE_SUCCESS' => 'Tietueet poistettu onnistuneesti',
    'LBL_BULK_ACTION_MASS_UPDATE_CONFIRMATION' => 'Oletko varma, että haluat päivittää valitut tietueet?',
    'LBL_BULK_ACTION_MASS_UPDATE_SUCCESS' => 'Kaikki tietueet päivitetty onnistuneesti',
    'LBL_BULK_ACTION_MASS_UPDATE_PARTIAL_SUCCESS' => 'Osittain onnistunut. Joitakin tietueita ei päivitetty. Tarkista loki',
    'LBL_BULK_ACTION_MASS_UPDATE_NO_FIELDS' => 'Ei päivitettäviä kenttiä',
    'LBL_BULK_ACTION_MASS_UPDATE_NO_RECORDS' => 'Ei päivityksiä',
    'LBL_BULK_ACTION_MASS_UPDATE_NO_ACLS' => 'Riittämätön etuoikeus, tallennustoiminto ei ole sallittu',
    'LBL_UNEXPECTED_ERROR' => 'Odottamaton virhe. Toiminnon suorittaminen epäonnistui.',
    'LBL_RECORD_DELETE_SUCCESS' => 'Tietue poistettu onnistuneesti',
    'LBL_RECORD_DELETE_ALL_SUCCESS' => 'Tietueet poistettu onnistuneesti',
    'LBL_RECORD_SNOOZE_SUCCESS' => 'Ilmoitus torkutettu',
    'LBL_ERROR_SAVING' => 'Tapahtui virhe tietuetta tallennettaessa',
    ...
    'LBL_SEND_DATE' => 'Lähetetty pvm',
    'LBL_SCHEDULE_BUTTON_LABEL' => 'Ajoita',
    ...
    'ANNUAL_REVENUE_BY_ACCOUNTS' => 'Vuotuiset tulot tilettäin',
    'PIPELINE_BY_SALES_STAGE' => 'Myyntiputki vaiheen mukaan',
    'LEADS_BY_SOURCE' => 'Liidit lähteen Mukaan',
    'LEADS_BY_STATUS' => 'Liidit tilan Mukaan',
    'ACCOUNT_TYPES_PER_MONTH' => 'Uudet tilit kuukausittain',
    ...
    'LBL_ACCOUNT_PRODUCT_SALE_PRICE' => 'Hinta',
    ...
    'LBL_FILTER_HEADER_TITLE' => 'Hae',

    'LBL_CATEGORY' => 'Tuotekategoria',
    'LBL_LIST_CATEGORY' => 'Tuotekategoria',
    ...
    'LBL_SUBTHEME_OPTIONS_NOON' => 'Puolipäivä',
    ...
    'LBL_CONFIRM_DISREGARD_EMAIL_TITLE' => 'Poistu kirjoitusikkunasta',
    'LBL_CONFIRM_DISREGARD_EMAIL_BODY' => 'Poistumalla kirjoitusikkunasta kaikki syötetyt tiedot menetetään, haluatko jatkaa?',
    ...
    'LBL_SUITE_DESC3' => 'SuiteCRM on SalesAgility Ltd: n tavaramerkki. Kaikki muut yritykset ja tuotenimet voivat olla niiden yritysten tavaramerkkejä, joihin ne ovat sidoksissa.',
    ...
    'LBL_CONFIRM_OPT_IN_IS_DISABLED' => 'Vahvistettu Opt In sähköpostin lähetys on poistettu käytöstä, ota käyttöön vahvistettu Opt In optio sähköpostiasetuksista tai ota yhteyttä järjestelmänvalvojaan.',
    'LBL_CONTACT_HAS_NO_PRIMARY_EMAIL' => 'Vahvistus Opt In sähköpostin lähettämisessä ei ole mahdollista, koska yhteyshenkilöllä ei ole ensisijaista sähköpostiosoitetta',
    ...
    'LBL_SEND_TEST_EMAIL' => 'Lähetä testi viesti',
    ...
    'LBL_PROSPECT_LIST_NAME' => 'Prospektilistat',

    //List View Column Selector Modal
    'LBL_COLUMN_SELECTOR_DISPLAYED_COLS' => 'NÄYTETTY',
    'LBL_COLUMN_SELECTOR_HIDDEN_COLS' => 'PIILOTETTU',
    'LBL_COLUMN_SELECTOR_CLOSE_BUTTON' => 'Sulje',
    'LBL_COLUMN_SELECTOR_SAVE_BUTTON' => 'Tallenna muutokset',
    'LBL_COLUMN_SELECTOR_MODAL_TITLE' => 'Valitse sarakkeet',
...
$app_list_strings['moduleList']['AOK_Knowledge_Base_Categories'] = 'Tietämyskanta - Kategoriat';
...
//aop
$app_list_strings['case_state_default_key'] = 'Avaa';
...
$app_list_strings['case_status_dom'] =
    array(
        'Open_New' => 'Uusi',
        'Open_Assigned' => 'Vastuuhenkilö valittu',
...
$app_list_strings['dom_email_distribution_for_auto_create'] = array(
    'AOPDefault' => 'Järjestelmän oletus',
...
$app_list_strings['aor_format_options']['m-d-Y'] = 'k-p-V';
...
$app_list_strings['aor_chart_types']['stacked_bar'] = 'Pinottu palkki';
$app_list_strings['aor_chart_types']['grouped_bar'] = 'Ryhmitetty palkki';
...
$app_list_strings['aor_email_type_list']['Email Address'] = 'Sähköposti';
$app_list_strings['aor_email_type_list']['Specify User'] = 'Vastuuhenkilö';
...
$app_list_strings['moduleList']['AOS_PDF_Templates'] = 'PDF - Mallit';
$app_list_strings['moduleList']['AOS_Product_Categories'] = 'Tuotteet ja kategoriat';
...
$app_list_strings['aos_quotes_type_dom']['Partner'] = 'Partneri';
$app_list_strings['aos_quotes_type_dom']['Press'] = 'Lehdistä';
...
$app_list_strings['aos_invoices_type_dom']['Partner'] = 'Partneri';
$app_list_strings['aos_invoices_type_dom']['Press'] = 'Lehdistä';
...
$app_list_strings['aow_date_type_list']['year'] = 'Vuotta';
...
$app_list_strings['aow_email_type_list']['Email Address'] = 'Sähköposti';
...
$app_list_strings['aow_email_type_list']['Specify User'] = 'Vastuuhenkilö';
...
//gant
$app_list_strings['moduleList']['AM_ProjectTemplates'] = 'Projektimallit';
...
$app_strings['LBL_DETAIL_BUTTON_LABEL'] = 'Näytä tiedot';
...
$app_list_strings['moduleList']['jjwg_Markers'] = 'Kartta - Merkinnät';
$app_list_strings['moduleList']['jjwg_Areas'] = 'Kartta - Alueet';
$app_list_strings['moduleList']['jjwg_Address_Cache'] = 'Kartta - Osoitteen Välimuisti';
...
//SecurityGroups
$app_list_strings['moduleList']['SecurityGroups'] = 'Security Suite -hallinta';
$app_strings['LBL_SECURITYGROUP'] = 'Turvaryhmä';
$app_strings['LBL_ROLE'] = 'Rooli';

$app_list_strings['moduleList']['OutboundEmailAccounts'] = 'Lähtevien sähköpostien tilit';
$app_list_strings['moduleList']['ExternalOAuthConnection'] = 'Ulkoinen OAuth-yhteys';
$app_list_strings['moduleList']['ExternalOAuthProvider'] = 'Ulkoinen OAuth-palveluntarjoaja';
...
$app_list_strings['moduleList']['TemplateEditor'] = 'Mallin osan muokkain';
$app_strings['LBL_CONFIRM_CANCEL_INLINE_EDITING'] = "Olet klikannut pois muokattavasta kentästä tallentamatta sitä. Napsauta ok, jos olet valmis menettämään muutoksesi tai peruuta, jos haluat jatkaa muokkausta";
$app_strings['LBL_LOADING_ERROR_INLINE_EDITING'] = "Kentän lataamisessa tapahtui virhe. Istuntosi on ehkä aikakatkaistu. Kirjaudu sisään uudelleen korjataksesi tämän";
...
$app_list_strings['moduleList']['Surveys'] = 'Kyselyt';
$app_list_strings['moduleList']['SurveyQuestionResponses'] = 'Kyselyn vastaukset';
$app_list_strings['moduleList']['SurveyQuestions'] = 'Kyselyn kysymykset';
$app_list_strings['moduleList']['SurveyQuestionOptions'] = 'Kyselyn asetukset';
...
$app_list_strings['surveys_question_type']['Textbox'] = 'Tekstilaatikko';
$app_list_strings['surveys_question_type']['Checkbox'] = 'Valintaruutu';
$app_list_strings['surveys_question_type']['Radio'] = 'Radio';
$app_list_strings['surveys_question_type']['Dropdown'] = 'Pudotusvalikko';
$app_list_strings['surveys_question_type']['Multiselect'] = 'Monivalinta';
$app_list_strings['surveys_question_type']['Matrix'] = 'Matrix';
$app_list_strings['surveys_question_type']['DateTime'] = 'Päivämäärä ja aika';
$app_list_strings['surveys_question_type']['Date'] = 'Pvm';
$app_list_strings['surveys_question_type']['Scale'] = 'Asteikko';
$app_list_strings['surveys_question_type']['Rating'] = 'Luokitus';
$app_list_strings['surveys_matrix_options'][0] = 'Tyytyväinen';
$app_list_strings['surveys_matrix_options'][1] = 'En tyytyväinen enkä tyytymätön';
$app_list_strings['surveys_matrix_options'][2] = 'Tyytymätön';

$app_strings['LBL_OPT_IN_PENDING_EMAIL_NOT_SENT'] = 'Odottaa hyväksynnän vahvistusta; vahvistussähköpostia ei ole lähetetty';
$app_strings['LBL_OPT_IN_PENDING_EMAIL_FAILED'] = 'Vahvista valinta epäonnistui sähköpostin lähetyksessä';
...
$app_strings['LBL_OPT_IN_CONFIRMED'] = 'Vahvistettu asetus';
$app_strings['LBL_OPT_IN_OPT_OUT'] = 'Estä lähetys';
$app_strings['LBL_OPT_IN_INVALID'] = 'Viallinen';
...
$app_list_strings['email_confirmed_opt_in_dom'] = array(
    'not-opt-in' => 'Ei vahvistettu',
    'opt-in' => 'Hyväksyntä',
    'confirmed-opt-in' => 'Vahvistettu hyväksyntä'
);

$app_strings['RESPONSE_SEND_CONFIRM_OPT_IN_EMAIL'] = 'Sähköpostin vahvistusvalinnat on lisätty sähköpostijonoon %s -sähköpostiosoitteen tai -osoitteiden osalta. ';
$app_strings['RESPONSE_SEND_CONFIRM_OPT_IN_EMAIL_NOT_OPT_IN'] = 'Sähköpostia ei voitu lähettää %s sähköpostiosoitteeseen, koska ne eivät ole valittuna. ';
$app_strings['RESPONSE_SEND_CONFIRM_OPT_IN_EMAIL_MISSING_EMAIL_ADDRESS_ID'] = '%s -sähköpostiosoitteella ei ole kelvollista tunnusta. ';

$app_strings['ERR_TWO_FACTOR_FAILED'] = 'Kaksivaiheinen todennus epäonnistui';
$app_strings['ERR_TWO_FACTOR_CODE_SENT'] = 'Kaksivaiheisen todennuksen koodi on lähetetty.';
$app_strings['ERR_TWO_FACTOR_CODE_FAILED'] = 'Kaksivaiheisen todennuksen koodia ei voitu lähettää.';
$app_strings['LBL_THANKS_FOR_SUBMITTING'] = 'Kiitos, että ilmoitit kiinnostuksestasi.';

$app_strings['ERR_IP_CHANGE'] = 'Istuntosi keskeytettiin, koska IP-osoitteesi on muuttunut merkittävästi';
$app_strings['ERR_RETURN'] = 'Palaa kotiin';


$app_list_strings['oauth2_grant_type_dom'] = array(
    'password' => 'Salasanan myöntäminen',
    'client_credentials' => 'Asiakkaan tunnistetiedot',
    'implicit' => 'Ehdoton',
    'authorization_code' => 'Valtuutuksen koodi'
);
...
$app_list_strings['search_controllers'] = [
    'Search' => 'Haku (uusi)',
    'UnifiedSearch' => 'Globaali yhdistetty haku (legacy)'
];


$app_strings['LBL_DEFAULT_API_ERROR_TITLE'] = 'JSON API -virhe';
$app_strings['LBL_DEFAULT_API_ERROR_DETAIL'] = 'Tapahtui JSON API -virhe.';
$app_strings['LBL_API_EXCEPTION_DETAIL'] = 'API-versio: 8';
$app_strings['LBL_BAD_REQUEST_EXCEPTION_DETAIL'] = 'Varmista, että täytät tarvittavat kentät';
$app_strings['LBL_EMPTY_BODY_EXCEPTION_DETAIL'] = 'Json API odottaa pyynnön olevan JSON';
$app_strings['LBL_INVALID_JSON_API_REQUEST_EXCEPTION_DETAIL'] = 'Ei voitu vahvistaa Json API -latauspyyntöä';
$app_strings['LBL_INVALID_JSON_API_RESPONSE_EXCEPTION_DETAIL'] = 'Ei voitu vahvistaa Json API -latausvastausta';
$app_strings['LBL_MODULE_NOT_FOUND_EXCEPTION_DETAIL'] = 'Json API ei löydä resurssia';
$app_strings['LBL_NOT_ACCEPTABLE_EXCEPTION_DETAIL'] = 'Json API odottaa "Hyväksy"-otsikon olevan sovellus/vnd.api+json';
...
$app_strings['LBL_CLICK_HERE'] = 'Klikkaa tästä';
$app_strings['LBL_TO_CONTINUE'] = ' jatkaaksesi.';
$app_strings['LBL_OPT_OUT'] = 'Hyväksynnän peruutus';
$app_strings['LBL_INVALID_EMAIL'] = 'Viallinen';
$app_strings['LBL_PRIMARY'] = 'Ensisijainen';
$app_strings['LBL_EMAIL_ADDRESS'] = 'Sähköpostiosoite';
...
$app_strings['LBL_SEARCH_TITLE']                   = 'Etsi';
$app_strings['LBL_SEARCH_TEXT_FIELD_TITLE_ATTR']   = 'Input Search Criteria';
$app_strings['LBL_SEARCH_SUBMIT_FIELD_TITLE_ATTR'] = 'Etsi';
$app_strings['LBL_SEARCH_SUBMIT_FIELD_VALUE']      = 'Etsi';
...
$app_strings['LBL_SEARCH_PREV'] = 'Edellinen';
$app_strings['LBL_SEARCH_NEXT'] = 'Seuraava';
$app_strings['LBL_SEARCH_PAGE'] = 'Sivu ';
$app_strings['LBL_SEARCH_OF'] = ' / ';
$app_strings['LBL_INSIGHTS'] = 'Insights';
$app_strings['LBL_CHARTS'] = 'Kuvaajat';
$app_strings['LBL_CHART_NOT_FOUND'] = 'Chart not found';
$app_strings['LBL_NO_DATA'] = 'Ei tietueita';
$app_strings['LBL_ERROR_FETCHING_METADATA'] = 'Error occurred while fetching metadata';
$app_strings['LBL_TOTAL'] = 'Summa';
$app_strings['LBL_ACTIONS'] = 'Toiminnot';
$app_strings['LBL_SELECT_SUBPANEL_BANNER'] = 'Select which subpanels to view';
$app_strings['LBL_SELECT_ITEM'] = 'Valitse kohde';
$app_strings['LBL_ITEMS_SELECTED'] = 'kohdetta valittu';
$app_strings['LBL_WIDGET_NOT_FOUND'] = 'Widgetiä ei löydy';
$app_strings['LBL_BAD_CONFIG'] = 'Virheellinen määritys';
...
$app_strings['LBL_STATISTIC_ERROR'] = 'Virhe tilastoja ladattaessa';
$app_strings['LBL_STATISTIC_ERROR_DESC'] = 'Virhe tilastoja ladattaessa';
$app_strings['LBL_STATISTIC_ERROR_DESC_TOOLTIP'] = 'Virhe tilastojen latauksessa. Ota yhteyttä järjestelmänvalvojaan';
$app_strings['LBL_AVERAGE_CLOSED_WON_PER_YEAR'] = 'Average Won Opportunity Per Year';
$app_strings['LBL_OPPORTUNITIES_TOTAL'] = 'Myyntimahdollisuuden kokonaisarvo';
$app_strings['LBL_CASE_TOTAL_DAYS_OPEN'] = 'Päiviä avoimena yhteensä';
$app_strings['LBL_DAYS_OPEN'] = 'Päiviä avoimena';
$app_strings['LBL_DAYS_IN_SALE_STAGE'] = 'DAY(S) THIS OPPORTUNITY HAS BEEN AT THIS SALES STAGE';
$app_strings['LBL_STAT_DAYS'] = 'Päivä(ä)';
$app_strings['LBL_CLOSED_PER_YEAR'] = 'Suljettu per vuosi';
$app_strings['LBL_WAS_OPEN'] = 'Tämä palvelupyyntö oli avoimena';
$app_strings['LBL_HAS_BEEN_OPEN'] = 'Tämä palvelupyyntö on ollut avoimena';
$app_strings['LBL_NUMBER_OF_CASES_PER_ACCOUNT'] = 'Palvelupyyntöjen lukumäärä tiliä kohden';
$app_strings['LBL_TOTAL_CASES_FOR_THIS_ACCOUNT'] = 'Total Cases For This Account';
$app_strings['LBL_NONE_OUTSTANDING'] = 'Ei mitään';
$app_strings['LBL_VALIDATION_ERROR_REQUIRED'] = 'Pakollinen kenttä puuttuu: {{fields.field.label}}';
$app_strings['LBL_VALIDATION_ERROR_CURRENCY_FORMAT'] = "Virheellinen valuuttamuoto. Odotettu: '{{context.expected}}'";
$app_strings['LBL_VALIDATION_ERROR_INT_FORMAT'] = "Virheellinen numeromuoto. Odotettu: '{{context.expected}}'";
...
$app_strings['LBL_VALIDATION_ERROR_PHONE_FORMAT'] = "Puhelinnumeron muoto on virheellinen.";
...
$app_strings['LBL_GET_RECORD_LIST_ERROR'] = 'Tapahtui virhe tietueita noudettaessa';
$app_strings['LBL_NUMBER_OF_RECORDS'] = 'Tietueiden määrä';
...
$app_strings['LBL_CONTRACT_RENEWAL_TOOLTIP'] = 'Seuraava sopimuksen uusimispäivä';
$app_strings['LBL_INVOICES_OVERDUE_TOOLTIP'] = 'Erääntyneiden laskujen kokonaismäärä';
$app_strings['LBL_ACTIVITIES_NEXT_DATE_TOOLTIP'] = 'Seuraavan vuorovaikutuksen päivämäärä';
$app_strings['LBL_CAMPAIGN_LAST_RECEIVED_TOOLTIP'] = 'Date of the most recent Campaign received';
$app_strings['LBL_OPEN_CASES_COUNT_TOOLTIP'] = 'Avointen palvelupyyntöjen kokonaismäärä';
$app_strings['LBL_EVENTS_LAST_DATE_TOOLTIP'] = 'Viimeisimmän tapahtuman päivämäärä';
$app_strings['LBL_HISTORY_LAST_DATE_TOOLTIP'] = 'Viimeisimmän vuorovaikutuksen päivämäärä';
$app_strings['LBL_OPPORTUNITIES_TOTAL_SUM_TOOLTIP'] = 'Myyntimahdollisuuksien summa yhteensä';
$app_strings['LBL_QUOTES_EXPIRY_TOOLTIP'] = 'Seuraava tarjouksen päättymispäivämäärä';
$app_strings['LBL_DEFAULT_TOTAL_TOOLTIP'] = 'Tietueiden kokonaismäärä';
$app_strings['LBL_CONTRACT_RENEWAL'] = 'Uusimispäivämäärä';
$app_strings['LBL_INVOICES_OVERDUE'] = 'Myöhässä yhteensä';
$app_strings['LBL_ACTIVITIES_NEXT_DATE'] = 'Seuraavan toiminnan päivämäärä';
$app_strings['LBL_CAMPAIGN_LAST_RECEIVED'] = 'Viimeksi osallistunut';
$app_strings['LBL_OPEN_CASES_COUNT'] = 'Avoimet palvelupyynnöt';
$app_strings['LBL_EVENTS_LAST_DATE'] = 'Viimeisin tapahtumaan osallistuminen';
$app_strings['LBL_HISTORY_LAST_DATE'] = 'Last Touchpoint';
$app_strings['LBL_OPPORTUNITIES_TOTAL_SUM'] = 'Arvo yhteensä';
$app_strings['LBL_QUOTES_EXPIRY'] = 'Seuraava vanhenemispäivämäärä';
$app_strings['LBL_DEFAULT_TOTAL'] = 'Summa';
$app_strings['AOS_Contracts'] = 'Sopimukset';
$app_strings['AOS_Quotes'] = 'Tarjoukset';
$app_strings['AOS_Invoices'] = 'Laskut';
$app_strings['LBL_PHOTO'] = 'Kuva';
$app_strings['LBL_CASE_UPDATES'] = 'Palvelupyynnön päivitykset';
$app_strings['LBL_CASE_UPDATE_SUBMITTED'] = 'Palvelupyynnön päivitys lähetetty';
...
$app_strings['LBL_CREATE'] = 'Luo uusi';
$app_strings['LBL_CLEAR_FILTER'] = 'Tyhjennä Suodatin';
$app_strings['LBL_QUICK_FILTERS'] = 'Quick Filters';
$app_strings['LBL_SAVED_FILTER_SAVED'] = 'Suodatin tallennettu onnistuneesti';
$app_strings['LBL_FILTER_ID_NOT_DEFINED'] = 'Suodattimen tunnusta ei ole määritetty';
$app_strings['LBL_GENERIC_CONFIRMATION'] = 'Haluatko jatkaa eteenpäin tällä toiminnolla?';
$app_strings['LBL_SHOW_MORE'] = 'Näytä enemmän';
$app_strings['LBL_SHOW_LESS'] = 'Näytä vähemmän';
$app_strings['LBL_LOAD_MORE'] = 'Lataa enemmän';
$app_strings['LBL_EMPTY'] = '-- Empty --';
$app_strings['LBL_OPERATOR'] = 'Operaattori';
$app_strings['LBL_START'] = 'Aloita';
$app_strings['LBL_END'] = 'Toisto loppuu';
$app_strings['LBL_LINE_ITEMS_FIELD_CONFIG'] = 'Virheellinen asetus';


$app_strings['LBL_ACTION_SUCCESS'] = 'Toiminto onnistui';

$app_strings['LBL_YES'] = 'Kyllä';
$app_strings['LBL_NO'] = 'Ei';

$app_list_strings['sort_order'] = [];
$app_list_strings['sort_order']['asc'] = 'Nouseva';
$app_list_strings['sort_order']['desc'] = 'Laskeva';

// Labels used by subpanel unlink relationship process
$app_strings['LBL_LINK'] = 'Linkki';
$app_strings['LBL_LINK_UNLINK'] = 'Link / Unlink';
$app_strings['LBL_SAVE'] = 'Tallenna';
$app_strings['LBL_UNLINK_RECORD'] = 'Poista tietueen yhteys';
$app_strings['LBL_EDIT_RECORD'] = 'Muokkaa tietuetta';
$app_strings['LBL_UNLINK_RELATIONSHIP_CONFIRM'] = 'Oletko varma että haluat poistaa yhteyden tästä tietueesta? Vain yhteys tietuesuhteeseen poistetaan. Tietuetta ei poisteta.';
$app_strings['LBL_UNLINK_RELATIONSHIP_SUCCESS'] = 'Tietueen yhteys poistettu onnistuneesti.';
$app_strings['LBL_UNLINK_RELATIONSHIP_FAILED'] = 'Tapahtui virhe tietueen yhteyden poistamisessa.';
...
$app_strings['LBL_LINK_RELATIONSHIP_SUCCESS'] = 'Suhde yhdistetty onnistuneesti.';
$app_strings['LBL_LINK_RELATIONSHIP_FAILED'] = 'Tapahtui virhe tämän suhteen yhdistämisessä.';
$app_strings['LBL_MODULE_NOT_FOUND'] = 'Moduulia ei löytynyt.';
$app_strings['LBL_RECORD_NOT_FOUND'] = 'Tietuetta ei voi ladata';
$app_strings['LBL_RELATIONSHIP_LOAD_ERROR'] = 'Suhdetta ei voi ladata';
$app_strings['LBL_NOT_LINKED'] = 'Ei voi poistaa yhteyttä. Tietueita ei ole yhdistetty';
$app_strings['LBL_ACCESS_DENIED'] = 'Pääsy estetty';
...
$app_strings['LBL_CHANGED_TO_TEXT'] = 'muutettu muotoon';
$app_strings['LBL_RECORD_CHANGED'] = 'Tietue päivitetty';
$app_strings['LBL_CREATE'] = "Luo uusi";
$app_strings['LBL_USE_ADVANCED_SEARCH'] = 'Käytä edistynyttä hakua';
...
$app_strings['LBL_KEY'] = 'Avain';
$app_strings['LBL_VALUE'] = 'Arvo';
...
$app_strings['LBL_SIGNATURE'] = 'Allekirjoitus';
...
$app_strings['LBL_CC'] = 'Kopio';
$app_strings['LBL_BCC'] = 'Piilokopio';
$app_strings['LNK_NEW_EMAIL'] = 'Uusi sähköposti';
...
$app_strings['LBL_RELATED_TO'] = 'Liittyen';
...
$app_strings['LBL_MEDIUM'] = 'Normaali';
$app_strings['LBL_NORMAL'] = 'Normaali';
$app_strings['LBL_LARGE'] = 'Large';
$app_strings['LBL_HUGE'] = 'Huge';
$app_strings['LBL_DEFAULT'] = 'Oletus ';
$app_strings['LBL_APPLY'] = 'Hyväksy';
...
$app_strings['LBL_QUOTE'] = 'Tarjous';
$app_strings['LBL_UNQUOTE'] = 'Unquote';
$app_strings['LBL_ALIGN_LEFT'] = 'Vasen';
$app_strings['LBL_ALIGN_CENTER'] = 'Center';
$app_strings['LBL_ALIGN_RIGHT'] = 'Oikea';
...
// Day and Time labels
$app_strings['LBL_SUN'] = 'Sunnuntai';
$app_strings['LBL_MON'] = 'Maanantai';
$app_strings['LBL_TUE'] = 'Tiistai';
$app_strings['LBL_WED'] = 'Keskiviikko';
$app_strings['LBL_THU'] = 'Torstai';
$app_strings['LBL_FRI'] = 'Perjantai';
$app_strings['LBL_SAT'] = 'Lauantai';
$app_strings['LBL_ALL'] = 'Joka päivä';
$app_strings['LBL_EVERY'] = 'Kuinka usein?';
$app_strings['LBL_ON_THE'] = 'Ajankohtana';
$app_strings['LBL_RANGE'] = ' - ';
$app_strings['LBL_FROM'] = 'Lähettäjä';
$app_strings['LBL_AND'] = 'ja';
$app_strings['LBL_MINS'] = 'Minuutti';
$app_strings['LBL_MINUTES'] = 'minuttia';
$app_strings['LBL_HOUR'] = 'tuntia';
$app_strings['LBL_HOUR_SING'] = 'tunti';
$app_strings['LBL_OFTEN'] = 'Niin usein kuin mahdollista.';
$app_strings['LBL_MIN_MARK'] = 'minuuttimerkki';
$app_strings['LBL_INBOUND_EMAIL'] = 'Saapuneet sähköpostit';
...
$app_strings['LBL_CAMPAIGN_SETTINGS'] = 'Asetukset';
...
$app_strings['LBL_INACTIVE'] = 'Ei aktiivinen';
