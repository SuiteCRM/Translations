...
$mod_strings = array(
    'ERR_UW_CANNOT_DETERMINE_GROUP' => 'Ryhmää ei voitu päätellä',
    'ERR_UW_CANNOT_DETERMINE_USER' => 'Omistajaa ei voitu päätellä',
    'ERR_UW_CONFIG_WRITE' => 'Versioinformaation päivitys config.php tiedostoon ei onnistunut.',
    'ERR_UW_CONFIG' => 'Määrittele config.php:n käyttöoikeudet siten että tiedosto on kirjoitettavissa, ja lataa tämä sivu uudelleen.',
    'ERR_UW_DIR_NOT_WRITABLE' => 'Hakemistoon ei voi kirjoittaa',
    'ERR_UW_FILE_NOT_COPIED' => 'Tiedostoa ei kopioitu',
    'ERR_UW_FILE_NOT_DELETED' => 'Paketin poistamisessa sattui ongelma.',
    'ERR_UW_FILE_NOT_READABLE' => 'Tiedostoa ei voitu lukea.',
    'ERR_UW_FILE_NOT_WRITABLE' => 'Tiedosta ei voi siirtää tai korjoittaa kohteeseen',
    'ERR_UW_FLAVOR_2' => 'Upgrade Flavor: ',
    'ERR_UW_FLAVOR' => 'SuiteCRM System Flavor: ',
    'ERR_UW_LOG_FILE_UNWRITABLE' => './upgradeWizard.log ei voitu luoda/kirjoittanut.  Korjaa SuiteCRM-hakemiston oikeudet.',
    'ERR_UW_MBSTRING_FUNC_OVERLOAD' => 'mbstring.func_overload arvoksi valittu suurempi kuin 1.  Muuta tämä tiedostossa php.ini ja uudelleenkäynnistä www-palvelin.',
    'ERR_UW_NO_FILE_UPLOADED' => 'Määritä tiedosto ja yritä uudelleen!',
    'ERR_UW_NO_FILES' => 'Virhe, tiedostoja ei löytynyt tarkastettavaksi.',
    ...
    'ERR_UW_UPLOAD_ERR' => 'Tiedoston lataus ei onnistunut. Yritä uudelleen!<br>' . PHP_EOL,
    ...
    'LBL_BUTTON_DELETE' => 'Poista paketti',
    'LBL_BUTTON_DONE' => 'Valmis',
    'LBL_BUTTON_EXIT' => 'Poistu',
    'LBL_BUTTON_NEXT' => 'Seuraaava >',
    ...
    'ERR_CHECKSYS_PHP_INVALID_VER' => 'SuiteCRM ei tue PHP-versiotasi. Asenna SuiteCRM -yhteensopiva versio. Tarkista yhteensopivuus julkaisutiedoista (Release Notes)',
    ...
    'ERROR_SUITECRM_VERSION_INCOMPATIBLE' => 'Lataamasi tiedosto ei ole yhteensopiva tämän SuiteCRM:n version kanssa.',
    ...
    'ERR_UW_PHP_FILE_ERRORS' => array(
        1 => 'Ladattu tiedosto ylittää php.ini -tiedoston upload_max_filesize -määrityksen',
