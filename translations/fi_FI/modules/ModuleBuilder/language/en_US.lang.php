...
$mod_strings = array(
    ...
    'help' => array(
        'package' => array(
            ...
            'modify' => '<b>Paketin</b> ominaisuudet ja mahdolliset toiminnat näkyvät tässä. <br><br>Voit muokata paketin <b>nimeä</b>, <b>tekijää</b> ja <b>kuvausta</b>, sekä katsoa ja muokata kaikkia paketin moduuleita. <br><br> Valitse <b>uusi moduuli</b> luodaksesi pakettiin uuden moduulin. <br><br>Jos pakkaus sisältää vähintään yhden moduulin, voit <b>julkaista</b> ja <b>ottaa käyttöön</b> paketin sekä <b>viedä</b> pakettiin tehdyt muokkaukset.',
            'name' => 'Tämä on paketin <b>nimi</b>. <br/> <br/>Nimen on oltava aakkosnumeerinen, alkaa kirjaimella ja se ei saa sisältää välilyöntejä. (Esimerkki: HR_Management)',
            'author' => 'Tämä on <b>tekijä</b>, joka näkyy asennuksen aikana paketin luoneen nimenä. <br><br>Tekijä voi olla henkilö tai yritys.',
            'description' => 'Tämä on asennuksen aikana näkyvä <b>Kuvaus</b> paketista.',
            'publishbtn' => 'Valitse <b>Julkaise</b> tallentaaksesi kaikki syötetyt tiedot ja luodaksesi .zip-tiedoston, joka on asennettavissa oleva versio paketista. <br><br>Käytä <b>moduulin lataajaa</b> ladataksesi .zip-tiedoston ja asentaaksesi paketin.',
            'deploybtn' => 'Valitse <b>Ota käyttöön</b> tallentaaksesi kaikki syötetyt tiedot ja asentaaksesi paketin sekä siihen liitetyt moduulit.',
            ...
            'deletebtn' => 'Valitsemalla <b>Poista</b> voit poistaa tämän paketin ja kaikki siihen liittyvät tiedostot.',
            'savebtn' => 'Tallenna kaikki pakettiin liitetyt tiedot valitsemalla <b>Tallenna</b>',
            ...
            'new_module' => 'Valitse <b>Uusi moduuli</b> luoda uuden moduulin tähän pakettiin.',
            ...
            'readme' => 'Voit lisätä <b>lue minut</b> tekstin tähän pakettiin. <br><br>Lue minut on luettavissa paketin asennuksen aikana.',
        ...
        'module' => array(
            ...
            'assignable' => 'Tämän valinnan avulla moduulin tietue kohdistetaan valitulle käyttäjälle.',
        ...
        'studioWizard' => array(
            ...
            'addLayoutHelp' => "Valitse turvaryhmä ja lähtökohdaksi valittava asettelu.",
    ...
    'assistantHelp' => array(
        ...
        'module' => array(
            ...
            'create' => 'Valitessasi haluamaasi <b>Tyyppi</b> moduulin lajia jonka haluat luoda, pidä mielessä minkä tyyppisiä kenttiä haluat moduulin sisältävän. <br/><br/>Kunkin moduulin malli sisältää joukon kenttiä jotka liittyvät kuvattuun moduuliin.<br/><br/><b>Vakio</b> - Sisältää vakiokenttiä, kuten Nimi, Kohdistettu käyttäjälle, Ryhmä, Luontipäivä ja Kuvaus kentät.<br/><br/> <b>Yritys</b> - Sisältää organisaatiohin kohdistettuja kenttiä, kuten Yrityksen Nimi, Toimiala ja Laskutusosoite. Käytä pohjana luodaksesi moduuleita jotka ovat samankaltaisia kuin Tilit-moduuli.<br/><br/> <b>Henkilö</b> - Sisältää yksilökohtaisia kenttiä, kuten Puhuttelusana, Virkanimike, Nimi, Osoite ja Puhelinnumero. Käytä pohjana luodaksesi moduuleita jotka ovat samankaltaisia kuin vakio Yhteyshenkilöt ja Liidit moduulit.<br/><br/><b>Ongelma</b> - Sisältää tapaus- ja virhekohtaisia kenttiä, kuten Järjestysnumero, Tila, Tärkeys ja Kuvaus. Käytä tätä pohjana luodaksesi moduuleita jotka ovat samankaltaisia kuin vakio Tapaukset ja Ohjelmavirheet moduulit.<br/><br/>Huomioi: Moduulin luomisen jälkeen, voit muokata pohjan kenttien nimikkeitä, sekä luoda omia kenttiä joita lisätä moduuliin.',
...
//HOME
    'LBL_HOME_EDIT_DROPDOWNS' => 'Pudotusvalikkojen muokkaus',

//STUDIO2
    'LBL_MODULEBUILDER' => 'Module Builder',
    'LBL_STUDIO' => 'Studio',
    'LBL_DROPDOWNEDITOR' => 'Pudotusvalikkojen muokkaus',
    'LBL_DEVELOPER_TOOLS' => 'Studio',
    'LBL_SUITEPORTAL' => 'SuiteCRM Portal Editor',
    'LBL_PACKAGE_LIST' => 'Pakkauslista',
    'LBL_HOME' => 'Etusivu',
    'LBL_NONE' => '-None-',
    ...
    'LBL_EDIT' => 'Muokkaa',
    'LBL_EDIT_LAYOUT' => 'Muuta layoutia',
    ...
    'LBL_SEARCH_FORMS' => 'Suodata',
    'LBL_SEARCH' => 'Etsi',
    'LBL_SEARCH_BUTTON' => 'Etsi',
    'LBL_FILTER' => 'Suodata',
    'LBL_TOOLBOX' => 'Työkalulaatikko',
    'LBL_QUICKCREATE' => 'Luo',
    ...
    'LBL_DROPDOWN_ITEM_LABEL' => 'Näytä otsikko',
...
//SECTION
    'LBL_SECTION_EDLABELS' => 'Muokkaa kentä selitettä',
...
//BUTTONS
    ...
    'LBL_BTN_VIEW_RELATIONSHIPS' => 'Tarkastele relaatioita',
    'LBL_BTN_ADD_RELATIONSHIP' => 'Lisää relaatio',
    'LBL_BTN_RENAME_MODULE' => 'Muuta moduulin nimeä',
//TABS
...
//Revert Module labels
    ...
    'fieldTypes' => array(
        ...
        'bool' => 'Valintaruutu',
        'enum' => 'DropDown',
        'dynamicenum' => 'Dynaaminen pudotusvalikko',
